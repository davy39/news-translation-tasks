...
co_authors: []
series: null
date: '2021-05-24T21:30:43.000Z'
originalURL: https://freecodecamp.org/news/how-to-use-small-sustainable-habits-to-get-your-first-dev-job
coverImage: https://www.freecodecamp.org/news/content/images/2021/05/FCC-Article-Cover--1-.png
tags:
- name: Habit Building
  slug: habit-building
- name: Job Hunting
...
seo_title: null
seo_desc: 'By Kenny Rogers

  Achieving a big goal like transitioning into a new career can be extremely challenging
  and overwhelming.

  The amount of information isn''t the problem. We have access to more information
  than we ever have. The problem is knowing how to ...'
---
...
![Image](https://www.freecodecamp.org/news/content/images/2021/05/image-55.png)
...
This one is pretty self-explanatory. You need to grow your development skills if you want to be a developer. The key here is to make sure you [don't get stuck in tutorial hell forever](https://www.freecodecamp.org/news/how-to-learn-from-coding-tutorials-and-avoid-tutorial-hell/).
...
Finally we have networking. Although there is some networking included in our online presence component because of interacting with other people, the [networking we want to focus on here is more direct](https://www.freecodecamp.org/news/networking-for-aspiring-developers/).
