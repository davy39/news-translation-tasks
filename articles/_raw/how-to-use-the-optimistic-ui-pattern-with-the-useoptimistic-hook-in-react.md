...
This article is also available as a video tutorial as part of the [15 Days of React Design Patterns](https://www.youtube.com/playlist?list=PLIJrr73KDmRyQVT__uFZvaVfWPdfyMFHC) [initiative](https://www.youtube.com/playlist?list=PLIJrr73KDmRyQVT__uFZvaVfWPdfyMFHC). Please check it out.
...
2. [How Does it Work Under the Hood?](#heading-how-does-it-work-under-the-hood)
    
3. [How to Build an Optimistic Like Button](#heading-how-to-build-an-optimistic-like-button)
    
4. [The Pitfalls and Anti-Patterns](#heading-the-pitfalls-and-anti-patterns)
    
5. [15 Days of React Design Patterns](#heading-15-days-of-react-design-patterns)
    
6. [Before We End...](#heading-before-we-end)
...
* An [async call](https://www.youtube.com/watch?v=WQdCffdPPKI) (request) is made to the server.
...
![Without an Optimistic Update](https://cdn.hashnode.com/res/hashnode/image/upload/v1765334108586/aabd3f16-b175-4b1d-ae33-94f33e1b894a.png align="center")
...
![With an Optimistic Update](https://cdn.hashnode.com/res/hashnode/image/upload/v1765334174203/e8bef9ba-28b6-45e0-8f22-0fc1468e3219.png align="center")
...
![Anatomy](https://cdn.hashnode.com/res/hashnode/image/upload/v1765434835916/249e71eb-bba6-4b98-951a-feb397dc36e2.png align="center")
...
The transitions are part of React’s concurrency model that helps us improve the performance of React applications. If you are interested in learning various performance optimisation techniques, [here is a two-part guide for you](https://www.youtube.com/watch?v=G8Mk6lsSOcw).
...
I have some great news for you: after my *40 days of the JavaScript* initiative, I have now started a brand new initiative called [15 Days of React Design Patterns](https://www.youtube.com/playlist?list=PLIJrr73KDmRyQVT__uFZvaVfWPdfyMFHC).
...
That’s all! I hope you found this article insightful. You can find all the source code used in this tutorial on the [tapaScript GitHub](https://github.com/tapascript/15-days-of-react-design-patterns/tree/main/day-08).

[Let’s connect:](https://github.com/tapascript/15-days-of-react-design-patterns/tree/main/day-03/compound-components-patterns)

* Subscribe to my [YouTube Channel](https://www.youtube.com/tapasadhikary?sub_confirmation=1).
    
* Grab the [React Hooks Cheatsheet](https://www.tapascript.io/books/react-hooks-cheatsheet).
