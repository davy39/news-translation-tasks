...
* [What are Synchronous and Asynchronous Code?](#heading-what-are-synchronous-and-asynchronous-code)
    
* [What Concurrency and Parallelism Mean](#heading-what-concurrency-and-parallelism-mean)
    
    * [Concurrency in Node.js](#heading-concurrency-in-nodejs)
        
    * [Parallelism in Node.js](#heading-parallelism-in-nodejs)
        
* [What is the Event Loop?](#heading-what-is-the-event-loop)
    
* [The Phases of the Event Loop](#heading-the-phases-of-the-event-loop)
...
Node or Web APIs process asynchronous code. When the code comes in, it’s processed here and then placed in the callback queue for the event loop to pick up and take to the call stack. But there are some asynchronous tasks that are prioritized. These are known as microtasks, such as [promises](https://www.freecodecamp.org/news/guide-to-javascript-promises/).
