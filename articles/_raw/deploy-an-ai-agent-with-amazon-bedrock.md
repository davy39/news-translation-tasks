...
* [Step 1: Set Up AWS CLI](#heading-step-1-set-up-aws-cli)
    
* [Step 2: Install and Create Your Agent](#heading-step-2-install-and-create-your-agent)
    
    * [Create a requirements.txt file](#heading-create-a-requirementstxt-file)
        
    * [Breaking Down the Code](#heading-breaking-down-the-code)
        
* [Step 3: Test the Agent Locally](#heading-step-3-test-the-agent-locally)
    
* [Step 4: Deploy to AgentCore Runtime](#heading-step-4-deploy-to-agentcore-runtime)
    
* [Step 5: Invoke the Agent with AWS SDK](#heading-step-5-invoke-the-agent-with-aws-sdk)
    
* [Step 6: Clean Up](#heading-step-6-clean-up)
    
* [Common Issues](#heading-common-issues)
...
First, install the AWS CLI if you do not already have it. On Linux or macOS: [AWS CLI setup guide](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html).

Next, [configure](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html) a profile with AWS SSO:
