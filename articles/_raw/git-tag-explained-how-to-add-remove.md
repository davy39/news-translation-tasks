---
title: 'Git Tag Explained: How to List, Create, Remove, and Show Tags in Git'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
* Git documentation: [Documentation](https://git-scm.com/docs/git-tag)
...
You can use `git checkout` to checkout to a tag like you would normally do. But you need to keep in mind that this would result a _detached HEAD_ state.
