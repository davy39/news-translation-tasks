...
* A Langbase account – [Sign up](http://langbase.com/signup) if you haven’t already.
    
* Basic knowledge of [LLMs](https://www.freecodecamp.org/news/how-to-start-building-projects-with-llms/), [AI agents](https://www.freecodecamp.org/news/how-ai-agents-can-supercharge-language-models-handbook/), and [RAG (retrieval-augmented generation)](https://www.freecodecamp.org/news/learn-rag-fundamentals-and-advanced-techniques/).
    

### **Here’s what I’ll cover:**

* [Prompt engineering fundamentals](#heading-prompt-engineering-fundamentals)
    
* [Tips and tricks for effective prompt design](#heading-tips-and-tricks-for-effective-prompt-design)
    
* [Langbase pipe agent prompts](#heading-langbase-pipe-agent-prompts)
    
* [How to prompt engineer your AI agent](#heading-how-to-prompt-engineer-your-ai-agent)
    
* [Fine-tune LLM model’s response parameters](#heading-fine-tune-llm-models-response-parameters)
...
* Define the output format (JSON, XML, plain text).
    ...
    * *Example: "Respond in JSON format with 'answer' and 'source' fields."*
        
* Decide if extra context is needed.
    
    * *Example: "Use this document as reference: \[URL\]."*
        
* Set constraints on length, tone, or structure.
    
    * *Example: "Limit response to 50 words, use a friendly tone."*
...
To learn how to use these three prompts with the UI using Langbase AI studio, you’ll find clear and concise instructions in this [guide](https://langbase.com/docs/features/prompt). It explains exactly where to go/what to click to write these prompts.

Let’s learn how to create an AI agent Pipe using the Langbase AI studio:

### Step 1: Create a Pipe agent

After logging into your Langbase account, you can always go to [`pipe.new`](http://pipe.new) to create a new Pipe.
...
![Creating a new Pipe](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/guides/build-performant-rag/create-pipe-dark.jpg align="left")
...
2. Select Pipe level keys. Choose any LLM. For example, you can use `OpenAI` (for GPT) or any other 250+ **supported models** on Langbase.
...
![Add an LLM API Key](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/llm-keys-dark.jpg align="left")
...
![Build your pipe: Configuiring the LLM model](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/model-dark.jpg align="left")
...
![Build your pipe: Configuiring the Pipe meta settings](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/meta-dark.jpg align="left")
...
![Prompt design: System Instructions](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/system-prompt-dark.jpg align="left")

**Prompt: User Message**

Now let's add a user message. Click on the `USER` button to add a new message. You can add this: `How to request payment API?`.

![Prompt design: Adding a user message](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/user-prompt-dark.jpg align="left")
...
![Prompt design: Adding Variables](https://raw.githubusercontent.com/LangbaseInc/docs-images/refs/heads/main/pipe/quickstart/updated/variables-dark.jpg align="left")
...
You can learn more about creating a pipe agent using the Langbase SDK [here.](https://langbase.com/docs/sdk/pipe/create)
...
![RAG prompt](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcxZ-2ydsO9AoNFxGGLnLXalLgm6s4mr6TvJPGclnCGf9vIC1FM-nibFRUQLUfKLZMLq-HSUWF-gOkWY9JO5kdiVsCgW8ZCxS_Z5sL7bWVSVlKTq77qt8Q5d4rlqpooPlR4ARyAjQ?key=Q-k-bEK6x7APjPtDCPcYSPKJ align="left")

You can learn how to build RAG by following this step-by-step [guide.](https://langbase.com/docs/guides/rag)
...
Langbase AI studio has a separate section that lets you define safety prompts inside a Pipe agent. For instance, do not answer questions outside of the given context.
...
![Safety prompts](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc2pQ9a1xgRcow-Pit-Ay1O9W7G49DLx7jkFHlwtNLTCOu1PAUnO55IoBgW2dc0F1A6lo2FSTOSe_Lq020YcsNjBSrIhIBn4msooMh2nw0MMAYq6LHRaw0jSNMaMNjHoixcjIwDmg?key=Q-k-bEK6x7APjPtDCPcYSPKJ align="left")

Learn how to define safety instructions for any LLM inside a pipe [here.](https://langbase.com/docs/features/safety)

## How to Fine-Tune the LLM’s Response Parameters

Now that you know the techniques to design strong prompts for your Pipe agents, let's take this further by adjusting model parameters like temperature, maximum tokens, top\_p, and others to refine how the model responds to user queries.
...
* **JSON\_mode:** Ensures the model will always output valid JSON.
    
* **Temperature:** Control how creative the LLM is with the outputs.
    
* **Max\_tokens:** Specifies the maximum number of tokens that can be generated in the output.
...
* **Top\_p:** Generate tokens until the cumulative probability exceeds the chosen threshold.
    

![Fine-tune LLM model’s response parameters](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe2h29LWOzyHlHJ5fzPDIBpkJhHcsZYUXvtaBki-IYWEWrE0wrTGDFL-_VIcBsqqtjvb8OTr7_FHayhMlfdE5PXyJfFvqgSuSBPfh5QEU_AllCQg1MNsoYe-DZ-04g4zmxPE_PwyQ?key=Q-k-bEK6x7APjPtDCPcYSPKJ align="left")

## Wrapping Up

Building effective serverless AI agents becomes easier if you use these prompt engineering techniques. You can give it a try by creating your own Pipe agent by visiting [pipe.new](http://pipe.new).
