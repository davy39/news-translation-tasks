---
title: How to Stay Productive All Day – Coding and Scheduling Tips for Programmers
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2021-02-09T19:20:12.000Z'
originalURL: https://freecodecamp.org/news/how-to-stay-productive-all-day-coding-and-scheduling-tips-for-programmers
coverImage: https://www.freecodecamp.org/news/content/images/2021/02/nick-article-image.jpg
tags:
- name: coding
  slug: coding
- name: Productivity
...
seo_title: null
seo_desc: 'By Nick Bull

  I''ve been coding wrong my whole life.

  I thought it was okay to just sit down at my desk, open my laptop, take a task from
  my to-do list, and code it until I felt tired.

  But in reality, this style of work always killed my productivity lev...'
---
...
But in reality, this style of work always killed my productivity levels after 2-4 hours of coding. I felt so tired that I didn't want to do anything except different low energy tasks (_like code review_).
...
![sheduled.jpg](https://cdn.hashnode.com/res/hashnode/image/upload/v1608378643183/3ZswRiq7N.jpeg)

_I’m using a whiteboard to constantly remind myself of what I should do at the exact moment._

I always neglected to create a schedule.

_“I know what and when I should do!”_ I told myself.

But in reality, I always forgot to do my daily activities (_even when I'd built up a habit of doing them_).
...
But many times I would have breakfast in the morning for an hour, forgetting to take the time to read. Even if I kept in mind that I had to read for 30 minutes every morning. I _overdid_ one activity (breakfast) and stole time from another activity (reading).
...
> _“If you waste resources trying to decide when or where to work, you’ll impede your capacity to do the work.” – [Guardian](https://www.theguardian.com/science/2013/oct/05/daily-rituals-creative-minds-mason-currey)_
...
It guarantees that I will do only essential things (_most of the time_).

My to-do list is simple: I use a plain paper notebook to make it and [Notion](https://www.notion.so/) as a digital copy (_I use Notion for everything, but that's for another article_)

![todo.jpg](https://cdn.hashnode.com/res/hashnode/image/upload/v1608378601645/oaEOZMMy4.jpeg)

![to do 2.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1608378595485/nFdvJ9q3s.png)

When I create my to-do list I create it in the evening for the next day.

Why?

When you plan your day in the morning, you are thinking about every task that needs to be done that day. This is fine when the task is clear and simple and you know what to do (like _“code review last commit by John”_). 
...
And in addition to the fact that such tasks take time to research, there is a chance that you will fall into the trap of your thinking process (_when you start imagining results, details, processes, and other various things related to the task, and you spend 5, 10, 15, or even more minutes on it_).
...
1. Open laptop.
2. Open Code editor (_VSCode_).
3. Pick a task.
4. Code until I feel tired.
5. Take a break (_spending time on social media_).
...
* Hydrating.
* Light workout.
* Walking (_without headphones_).
* Breathing (_box breathing, Wim Hof method_).

After I learned about effective breaks, my workday became almost perfect - 52 minutes of work (_45 minutes often in a flow state, because I need 10 minutes to reach it_) and 17 minutes of an effective break that gives me energy.
...
I would set a timer for 52 minutes, start to work, get into a flow state, and then BAM! A new notification would pop up. And I would be like, _“What’s in there?”_
...
I never paid attention to it until I started to deep dive into the personal development field (_I wish I'd started earlier_).

Now, when I work I turn off all notifications, tell people to not bother me, put on my headphones (_if I work in a noisy environment_), close all the browser tabs that are not related to the task, and **do everything I can to avoid distractions during my working hours.**
...
[It’s a myth.](https://health.clevelandclinic.org/science-clear-multitasking-doesnt-work/)
...
You can use my productivity system to successfully do any kind of job, not just coding. _But use it wisely._
...
[Join 1,300+ developers here.](https://nickbulljs.com/)
