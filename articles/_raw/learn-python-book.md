---
title: Learn Python Programming – Everything You Need to Know (Free Book)
subtitle: ''
author: Fatos Morina
co_authors: []
series: null
...
* [Operators in Python](#heading-operators-in-python)
    
* [Data types in Python](#heading-data-types-in-python)
    
* [Tuples in Python](#heading-tuples-in-python)
    
* [Dictionaries in Python](#heading-dictionaries-in-python-key-value-data-structures)
    
* [Sets in Python](#heading-sets-in-python)
    
* [Type Conversions in Python](#heading-type-conversions-in-python)
    
* [Control Flow in Python](#heading-control-flow-in-python)
...
* [Importing in Python](#heading-importing-in-python)
    
* [How to Handle Exceptions in Python](#heading-how-to-handle-exceptions-in-python)
    
* [User Input in Python](#heading-user-input-in-python)
    
* [Get the PDF version of the book](#heading-get-the-book-as-a-pdf)
...
In this case, *favorite\_bike* is an object that is created from the class *Bicycle*. It gets all the functionalities and attributes of the class Bicycle.
