...
[**Load Testing HAProxy (Part-1)**](https://medium.com/@sachinmalhotra/load-testing-haproxy-part-1-f7d64500b75d)  
[_Load Testing ? HAProxy ? If all this seems greek to you, don’t worry. I will provide inline links to read up on what…_medium.com](https://medium.com/@sachinmalhotra/load-testing-haproxy-part-1-f7d64500b75d)[**Load Testing HAProxy (Part 2)**](https://medium.com/@sachinmalhotra/load-testing-haproxy-part-2-4c8677780df6)  
[_This is the second part in the 3 part series on performance testing of the famous TCP load balancer and reverse proxy…_medium.com](https://medium.com/@sachinmalhotra/load-testing-haproxy-part-2-4c8677780df6)
...
[**how to modify the nodejs request default timeout time?**](http://stackoverflow.com/questions/23925284/how-to-modify-the-nodejs-request-default-timeout-time)  
[_I was using nodejs request, the default timeout of nodejs http is 120000 ms, but it is not enough for me, while my…_stackoverflow.com](http://stackoverflow.com/questions/23925284/how-to-modify-the-nodejs-request-default-timeout-time)[**HTTP | Node.js v7.8.0 Documentation**](https://nodejs.org/api/http.html#http_server_settimeout_msecs_callback)  
[_The HTTP interfaces in Node.js are designed to support many features of the protocol which have been traditionally…_nodejs.org](https://nodejs.org/api/http.html#http_server_settimeout_msecs_callback)
...
[**Use HAProxy to load balance 300k concurrent tcp socket connections: Port Exhaustion, Keep-alive and…**](https://www.linangran.com/?p=547)  
[_I'm trying to build up a push system recently. To increase the scalability of the system, the best practice is to make…_www.linangran.com](https://www.linangran.com/?p=547)
...
A special shout out to [Dheeraj Kumar Sidana](https://www.freecodecamp.org/news/how-we-fine-tuned-haproxy-to-achieve-2-000-000-concurrent-ssl-connections-d017e61a4d27/undefined) who helped us all the way through this and without whose help we would not have been able to reach any meaningful results. :)
