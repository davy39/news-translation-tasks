...
co_authors: []
series: null
date: '2025-04-22T13:42:54.933Z'
originalURL: https://freecodecamp.org/news/how-to-write-a-good-conference-talk-proposal
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1745329255973/f4fbb77f-8cab-4c29-bdd0-2791037bc6fd.png
tags:
- name: conference
  slug: conference
- name: 'speaking '
...
- name: JavaScript
  slug: javascript
seo_title: null
seo_desc: When conferences organize events, they seek knowledgeable speakers to share
  insights that educate, inspire, and engage attendees. They discover and select speakers
  through a Call for Proposals (CFP), an open invitation for experts to submit talk
  idea...
---
...
* [Understanding the CFP Criteria](#understanding-the-cfp-criteria)
    
* [Key Components of a CFP Submission](#key-components-of-a-cfp-submission)
    
* [How to Choose the Right Topic](#heading-how-to-choose-the-right-topic-theme)
    
* [How to Craft a Strong Title and Abstract](#heading-how-to-craft-a-strong-title-and-abstract)
    
* [How to Structure the Proposal](#heading-how-to-structure-the-proposal)
    
* [Submission Best Practices](#submission-best-practices)
    
* [Where to Find CFP Opportunities](#where-to-find-cfp-opportunities)
...
* PHPDAY ITALY ‘25: [Securing PHP Applications with Zero Trust Principles](https://www.phpday.it/talks_speakers/#Securing-PHP-Applications-with-Zero-Trust-Principles)
    
* API SPECIFICATION CONFERENCE ‘21: [ABC of GRAPHQL](https://apispecs21.sched.com/event/lMMS/abc-of-graphql-alabi-deborah-sule-balogun-olanrewaju-g)
...
* [**Sessionize**](https://sessionize.com/) – A widely used platform where conferences post CFPs, allowing speakers to submit proposals easily.
    
* [**PaperCall.io**](https://www.papercall.io/) – A hub for discovering CFPs across different industries, including tech and open-source events.
