...
Let's import a font from Google Font. Head over to [https://fonts.google.com/](https://fonts.google.com/) to pick one.
...
_Click the plus button to create a new project_
...
_Read table after deleting one field_
