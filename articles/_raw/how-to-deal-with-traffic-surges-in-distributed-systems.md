...
1. [What is traffic in the context of distributed systems](#heading-what-is-traffic-in-the-context-of-distributed-systems)?
2. [Why can traffic surges be problematic?](#heading-why-can-traffic-surges-be-problematic) 
3. [Ways to deal with high traffic loads](#heading-ways-to-deal-with-high-traffic-loads)
4. [Exponential Backoff and Retries](#heading-exponential-backoff-and-retries)
...
_A single retry request can lead to an exponential number of retries in other parts of a distributed system_
