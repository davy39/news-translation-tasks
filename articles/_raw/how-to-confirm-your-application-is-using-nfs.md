---
title: Network File System – How to Confirm Your Application is Using NFS
subtitle: ''
...
I was tasked recently to find which of our processes was accessing an NFS share. During this process, I found that some tools are better adapted than others for the task.
...
Please note that this is not a full tutorial on NFS. For that, please take a look at the following [tutorial](https://www.redhat.com/sysadmin/getting-started-nfs).
...
I passed the `-b` option to lsof to avoid it from getting stuck, in case the [NFS handle is stale](https://access.redhat.com/solutions/2674).
...
Is there a different way? Time to move on to the next tool, [tshark](https://www.wireshark.org/docs/man-pages/tshark.html) and see how to use a network capture to confirm access to the share.
...
The code for the scripts used on this tutorial can be obtained from my [GitHub repository: SpyOnNfs](https://github.com/josevnz/tutorials/tree/main/docs/SpyOnNfs).
