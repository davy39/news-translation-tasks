...
* [What is a Buffer, and How Does it Work?](#heading-what-is-a-buffer-and-how-does-it-work)
    
* [What is a Buffer Overflow?](#heading-what-is-a-buffer-overflow)
    
* [Common Causes of Buffer Overflows and Corruption](#heading-common-causes-of-buffer-overflows-and-corruption)
    
* [Consequences of Buffer Overflows](#heading-consequences-of-buffer-overflows)
    
* [How to Debug Buffer Overflows](#heading-how-to-debug-buffer-overflows)
    
* [How to Prevent Buffer Overflows](#heading-how-to-prevent-buffer-overflows)
...
![Figure 1: A visual of the memory layout](https://cdn.hashnode.com/res/hashnode/image/upload/v1739064875727/1e01992d-4d9d-42fb-b971-6f4e92452c22.png align="center")
...
![Figure 2: Steps to debug a buffer overflow](https://cdn.hashnode.com/res/hashnode/image/upload/v1739065828677/74322607-5997-4275-87d0-b3d0acf54373.png align="center")
