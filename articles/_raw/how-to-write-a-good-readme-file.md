...
co_authors: []
series: null
date: '2021-12-08T22:59:00.000Z'
originalURL: https://freecodecamp.org/news/how-to-write-a-good-readme-file
coverImage: https://www.freecodecamp.org/news/content/images/2021/04/uide-to-writting-a-good-readme-file--1-.png
tags:
- name: Collaboration
  slug: collaboration
- name: documentation
...
seo_title: null
seo_desc: "When I was first introduced to GitHub, I had no idea what it was or what\
  \ it could do. Between you and me, I created the account because I was told every\
  \ developer should have one where they push their code. \nFor the longest time as\
  \ a beginner I did n..."
---
...
So my interest in what a README was grew, and I decided to try and add one in my projects, too. I won't lie – I did it in a hurry without any knowledge of how it should be done. And honestly it wasn't great at all. Check it out [HERE](https://github.com/larymak/ToDo-list-App/tree/v1.0).

And that was how it stayed for a period of time. But with practice and continuous learning I was able to change to some better documentation like [THIS](https://github.com/larymak/Python-project-Scripts), which improved engagement with the project and helped other devs get involved. 
...
For instance, my earlier shared example of my [first project](https://github.com/larymak/ToDo-list-App/tree/v1.0) does not have a good README. And even though the project was amazing, it would've been hard for a beginner to understand exactly what was expected when they cloned my repo. Who knows maybe it could've even been a coded virus. 
