...
Before getting on with the tutorial and showing you how it works, let me briefly describe what you can do with [TF Watcher](https://github.com/Rishit-dagli/TF-Watcher), an open-source project we will use to monitor our ML jobs:
...
To monitor your Machine Learning jobs on mobile devices, you need to install the `tf-watcher` Python package. This is an open-source Python package that I built, and you can find the source code in [this GitHub repo](https://github.com/Rishit-dagli/TF-Watcher). 
...
You can add as many metrics as you need. You can also use TensorFlow's [built-in metrics](https://www.tensorflow.org/api_docs/python/tf/keras/metrics) or add your own custom metric, too.
...
Go to [https://www.tfwatcher.tech/](https://www.tfwatcher.tech/) and enter the unique ID you created above. This is a PWA which means you can also install this on your mobile devices and use it as a native android app, too.

![Image](https://www.freecodecamp.org/news/content/images/2021/08/image-80.png)
_Install the web app_
