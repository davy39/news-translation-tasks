...
* [Exploring the project files](#heading-exploring-the-project-files)
    ...
    * [The layout.tsx file](#heading-the-layouttsx-file)
        
    * [The page.tsx file](#heading-the-pagetsx-file)
        
    * [The hooks/useOpenAI.ts file](#heading-the-hooksuseopenaits-file)
        
    * [The package.json file](#heading-the-packagejson-file)
        
* [How to Get Your OpenAI API Keys](#heading-how-to-get-your-openai-api-keys)
...
* [Vulnerability two: DOS or DDOS attacks](#heading-vulnerability-two-dos-and-ddos-attacks)
    ...
    * [Vercel and Cloudflare DDOS protection](#heading-vercel-and-cloudflare-ddos-protection)
        
    * [Vercel security features](#heading-vercel-security-features)
        
* [Vulnerability 3: No authentication and authorization](#heading-vulnerability-3-no-authentication-and-authorization)
    
* [Optimizing the code](#heading-optimizing-the-code)
...
* A basic knowledge of writing [Next.js](https://nextjs.org) code
    
* A code editor (like VSCode) for writing and editing the project’s source code.
    
* [Git](https://git-scm.com) and [GitHub](https://github.com) account for version control, continuous integration, and authentication.
    
* A [Vercel](https://vercel.com) account to host the project.
    
* An [OpenAI Developer](https://platform.openai.com) account to get your API key.
    

## Getting Started

First, you need to clone this [GitHub repository](https://github.com/Gidthecoder/nextjs-ai).
