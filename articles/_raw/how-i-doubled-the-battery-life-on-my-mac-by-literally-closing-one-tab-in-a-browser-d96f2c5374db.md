---
title: How I doubled the battery life on my Mac by literally closing one tab in a
  browser
subtitle: ''
author: freeCodeCamp
co_authors: []
...
There is one not-so-well known tool in Chrome, that allows you to analyse how much resources the **individual tabs consume**. It is called **Task Manager** and you can find it in **Menu > More Tools > Task M**anager.

![Image](https://cdn-media-1.freecodecamp.org/images/1*TZVAsQTukJ-e8fKjSfJrdQ.png)
_Where to find Task Manager in Chrome_
...
_Tab XE.com is sooooooo CPU intensive (the tab was inactive when I created the screenshot)_
...
_You might follow me on [Twitter](https://twitter.com/primozcigler), but we both know Twitter is very noisy. So you can [leave me your email](http://eepurl.com/bLlBLj) and I will occasionally send you stuff I find useful._
