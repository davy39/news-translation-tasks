...
## Table of Contents
- [How to Make an SVG File](#heading-how-to-make-an-svg-file)
  - [How to Make an SVG with Image Editing Programs](#heading-how-to-make-an-svg-with-image-editing-programs) 
  - [How to Make an SVG with XML ](#heading-how-to-make-an-svg-with-xml)
- [What is an SVG File Used for?](#heading-what-is-an-svg-file-used-for)
- [How to Open an SVG File ](#heading-how-to-open-an-svg-file)
- [How do I Convert an SVG File to an Image?](#heading-how-do-i-convert-an-svg-file-to-an-image)
