...
2. [What is Git](#heading-what-is-git)?
    
    * [Git vs GitHub](#heading-git-vs-github)
        
3. [Git Architecture – Local and Remote](#heading-git-architecture-local-and-remote)
    
4. [How to Install Git on Your Computer](#heading-how-to-install-git-on-your-computer)
    
5. [How to Create a Project and Initialize a Local Repository](#heading-how-to-create-a-project-and-install-a-local-repository)
    
6. [How to Create a Remote Repository on GitHub and Clone It](#heading-how-to-create-a-remote-repository-on-github-and-clone-it)
    
7. [How to Track Changes with `git status`](#heading-how-to-track-changes-with-git-status)
    
8. [How to Move Changes to the Staging Area with `git add`](#heading-how-to-move-changes-to-the-staging-agrea-with-git-add)
    
9. [How to Save Work Permanently with `git commit` (and Configure Git)](#heading-how-to-save-work-permanently-with-git-commit-and-configure-git)
    
10. [How to Delete and Restore Files with `git rm` and `git reset`](#heading-how-to-delete-and-restore-files-with-git-rm-and-git-reset)
    
11. [How to View Commit History with `git log`](#heading-how-to-view-commit-history-with-git-log)
    
12. [Branching and Merging in Git](#heading-branching-and-merging-in-git)
    
    * [Understanding Merge Conflicts](#heading-understanding-merge-conflicts)
        
13. [How to Navigate History with `git checkout` and Compare Commits with `git diff`](#heading-how-to-navigate-history-with-git-checkout-and-compare-commits-with-git-diff)
    
14. [How to Work with Remotes: `git push`, `git fetch`, and `git pull`](#heading-how-to-work-with-remotes-git-push-git-fetch-and-git-pull)
    
    * [Example – `git push`](#heading-example-git-push)
        
    * [Example – Pushing Other Branches](#heading-example-pushing-other-branches)
        
    * [Example – `git fetch`](#heading-example-git-fetch)
        
    * [Example – `git pull`](#heading-example-git-pull)
        
15. [How to Undo Local Changes with `git restore`](#heading-how-to-undo-local-changes-with-git-restore)
    
16. [How to Temporarily Shelve Work with `git stash`](#heading-how-to-temporarily-shelve-staged-work-with-git-stash)
    
17. [How to Undo Commits Safely with `git revert`](#heading-how-to-undo-commits-safely-with-git-revert)
    
18. [How to Keep History Clean with `git rebase`](#heading-how-to-keep-history-clean-with-git-rebase)
    
19. [How to Collaborate on GitHub with Pull Requests](#heading-how-to-collaborate-on-github-with-pull-requests)
    
20. [Git & GitHub – Concise Summary](#heading-git-amp-github-concise-summary)
    
    * [Git vs GitHub](#heading-git-vs-github)
        
    * [Core Git Architecture & Workflow](#heading-core-git-architecture-amp-workflow)
        
    * [Getting Started](#heading-getting-started)
        
    * [Seeing & Moving Changes](#heading-seeing-amp-moving-changes)
        
    * [Deleting, Restoring & Undoing](#heading-deleting-restoring-amp-undoing)
        
    * [Branching, Merging & Conflicts](#heading-branching-merging-amp-conflicts)
        
    * [Navigating & Comparing History](#heading-navigating-amp-comparing-history)
        
    * [Working with Remotes (GitHub)](#heading-working-with-remotes-github)
        
    * [Temporarily Shelving Work with git stash](#heading-temporarily-shelving-work-with-git-stash-1)
        
    * [Keeping History Clean with git rebase](#heading-keeping-history-clean-with-git-rebase-1)
        
    * [Collaboration with Pull Requests (PRs)](#heading-collaboration-with-pull-requests-prs)
        
    * [Big Picture Takeaways](#heading-big-picture-takeaways)
        
21. [Final Words](#heading-final-words)
...
![Git Architecture](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442130301/fa1908c2-c2ef-4a07-86dc-1d7d12b13a21.gif align="left")
...
For Mac users, when you select the macOS option, you’ll also find instructions on how to install Git using [Homebrew](https://brew.sh/). Just follow those steps, and your installation will be done in no time.
...
![Open Git Bash from inside any folder](https://cdn.hashnode.com/res/hashnode/image/upload/v1765568453563/43d574fe-ba17-4a8a-b7ae-ec0fa71d84eb.jpeg align="center")

You can also open it by searching for **Git Bash** from the Start menu.

![Opening Git Bash from Start Menu](https://cdn.hashnode.com/res/hashnode/image/upload/v1765568550303/8e54b211-475b-4774-bbf6-6b76674d8fcf.png align="center")
...
![Git Bash Terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1765567732235/e6edfc98-778b-47be-a70e-97821fa243c1.png align="center")
...
![Finder Open Git One Folder](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442159140/ff01dfea-fe75-4b27-9a91-8133cd538f1f.gif align="left")
...
![Git Init and Hidden .git Folder](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442184486/d3a47514-cf80-4401-ae98-cb96b8924464.png align="left")
...
![GitHub New Repository with Two Files](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442212397/732bc0ff-60e4-4d43-a863-b1760453ec80.gif align="left")
...
![Cloning GitHub Repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442236567/d4ad9633-897c-421b-979f-121c77573078.gif align="left")
...
![Git Status Showing Modified Files](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442263827/d48beb32-1dcf-4dc6-81df-a64adced52c1.gif align="left")
...
![Git Add All and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442889338/448d6a6e-df96-4e74-be07-13d285f3ca5f.png align="left")
...
![Git Reset and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442910152/1b8a64da-813c-4925-846f-0a0b5527aa76.gif align="left")
...
![Git Add A and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442932087/5eb27c66-5fee-4d87-bc11-2fee381e9288.png align="left")
...
![Git Add Dot and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765442982841/bb3acfb7-b236-4230-8fd8-f48ef9c69093.png align="left")
...
![Git Add Dot Inside Folder and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443005193/c5d8a16e-d85d-431c-a56a-2a79326980fb.gif align="left")
...
![Git Add Asterisk and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443030396/e69e74ab-9980-48f4-bf94-dd1fe525faea.png align="left")
...
![Git Add Txt Files and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443054715/07804ce7-1389-41bf-a48a-f2e83c3c3456.gif align="left")
...
![Git Commit Error - Please Tell Me Who You Are](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443087625/11b0ecda-49e6-48e6-9171-4b3ec11f4478.png align="left")
...
![Git Commit Successful](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443109452/9960deef-7e54-46f0-b0a2-328ab52a2b4a.png align="left")
...
![Git Rm and Status](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443133023/f9d77e54-9829-4ff2-bd45-9e91b520bef0.gif align="left")
...
![Git Reset Hard](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443156544/ba29878e-c5b8-48a8-8110-d7f80bc9d5be.gif align="left")
...
![Git Log Showing Commit History](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443180087/c4acc03d-e2a2-424e-b6e7-30b7cec94ddd.gif align="left")
...
![Git Branching and Merging](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443203531/fa09c9c1-c1e6-4617-bc35-8d16c7902b4d.gif align="left")
...
![Git Branch Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443230339/361868df-dc2f-4b01-8773-5a6b16fb721f.png align="left")
...
![Git Create New Branch](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443248217/e70e516a-1601-401e-a02a-6a25d020b97a.png align="left")
...
![Git Switch Branches and Isolated Changes](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443271077/5e9a82df-941f-4692-8eb9-56da9e784085.gif align="left")
...
![Git Merge Main into Development](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443302835/c0510bc0-f03f-4203-9d51-b2bac312af5a.png align="left")
...
![Git Merge Conflict Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443321837/154fb298-dd45-496f-b1c9-cc68c6b228c2.gif align="left")
...
![Git Merge Conflict Error](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443344910/2991cf21-6397-45cb-aa96-70467a1244f8.png align="left")
...
![Git Merge Conflict Markers](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443365329/94fbc5e8-2cca-4423-b4ab-4f90898ea9c0.gif align="left")
...
![Git Merge Staging into Main](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443386891/5b346d56-073a-4e58-a34c-736e2a25ba23.gif align="left")
...
![Git Checkout Previous Commit](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443408851/61803cda-c1d2-4b19-a298-bf569e3e36f8.gif align="left")
...
![Git Push Fetch Pull](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443429569/e3d2882f-ad8e-4766-aa02-45633a983932.gif align="left")
...
![Git Push Main Branch](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443452657/0e0d3603-bc38-4ec0-9517-687dbf83c393.gif align="left")
...
![Git Push Other Branches](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443476135/9243730d-5d93-48aa-9d32-27ced9d8a762.gif align="left")
...
![Git Fetch and Merge](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443499165/ff4f6389-ad36-434e-a2b2-8c321160607a.gif align="left")
...
![Git Pull Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443520831/0c438637-75f5-4743-a2d7-38cea3cd0d2e.gif align="left")
...
![Git Restore Single File](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443545767/6e1bb71b-4228-40f5-bcec-23d094254355.gif align="left")
...
![Git Stash Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443582135/733a4f46-6c92-4902-8c45-97cdcd55990f.gif align="left")
...
![Git Checkout Development Branch with Uncommitted Changes](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443604514/8d70a915-8cac-49c8-8776-f4db7ed37bb5.png align="left")
...
![Git Stash Use Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443623961/17568e8b-ba41-4020-b7f2-00a9ae690a9c.gif align="left")
...
![Git Stash List Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443645465/12d2c1f3-a529-4d36-aa55-2ff459a20b2c.gif align="left")
...
![Git Stash Drop Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443664000/db9707b8-d32b-451c-8bd8-a0c992ef4f78.gif align="left")
...
![Git Stash Pop Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443683035/cdd67489-7797-4cce-a0de-a10506244460.gif align="left")
...
![Git Stash Apply Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443701166/3df82aab-14d7-461a-8ee6-320609d3fdcb.gif align="left")
...
![Git Revert Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443720093/f7506aa8-e16b-4566-a0c8-f497e195b783.gif align="left")
...
![Git Revert Specific Commit](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443740518/c8ef43d8-78e8-4afe-8424-5a24d0987640.gif align="left")
...
![Git Rebase Command](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443759550/d074c631-1e65-4ef3-a007-e2d7665eccd7.gif align="left")
...
![Git Rebase Main into Feature](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443782936/9dbfa229-e02a-40f3-8f91-14fcbf4c858e.gif align="left")
...
![Git Rebase Warning](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443802090/97b145e9-7b86-4106-99fe-683ef8d5025b.gif align="left")
...
![GitHub Pull Request](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443820127/5ea7b5ce-a06d-42d3-88d7-da5e818210dc.gif align="left")
...
![Pull Request Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1765443840494/12e57fd1-64fb-412d-913d-599edebf1132.gif align="left")
...
If you found the information here valuable, feel free to share it with others who might benefit from it. I’d really appreciate your thoughts – mention me on X [@sumit\_analyzen](https://x.com/sumit_analyzen) or on Facebook [@sumit.analyzen](https://www.facebook.com/sumit.analyzen), [watch](https://www.youtube.com/@logicBaseLabs) my coding tutorials, or simply [connect with me](https://www.linkedin.com/in/sumitanalyzen/) on LinkedIn. You can also checkout my official website [sumitsaha.me](https://www.sumitsaha.me/) for more details about me.
