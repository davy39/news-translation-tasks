...
When people hear about Next.js, they often think of [server-side rendering](https://www.freecodecamp.org/news/server-side-rendering-javascript/), React-powered frontends, or SEO-optimised static websites. But there's more to this powerful framework than just front-end development.
...
* [Installation & Setup](#heading-installation-amp-setup)
    
* [How to Build a REST API](#heading-how-to-build-a-rest-api)
    
* [How to Test the API](#heading-how-to-test-the-api)
    
* [How to Deploy to Sevalla](#heading-how-to-deploy-to-sevalla)
...
[Next.js](https://nextjs.org/) is an open-source React framework built by Vercel. It enables developers to build server-rendered and statically generated web applications.
...
Let’s install Next.js. Make sure you have [Node.js](https://nodejs.org/en) and NPM installed on your system, and that they’re the latest version.
...
![Next.js API setup](https://cdn.hashnode.com/res/hashnode/image/upload/v1753245601007/61b34b8f-0426-4bf1-80ed-315f97e18d8a.png align="center")
...
![Route Structure](https://cdn.hashnode.com/res/hashnode/image/upload/v1753419862976/1ac6e871-6837-44e9-a02e-4e8d37ac4c76.png align="center")
...
We will have an empty array inside the /app/users.json. You can find all the code here [in this repository](https://github.com/manishmshiva/nextjs-api).
...
You can go to [http://localhost:3000/users](http://localhost:3000/users) and can see an empty array since we have not pushed any user information.
...
![New user creation](https://cdn.hashnode.com/res/hashnode/image/upload/v1753336220369/11fceed9-6b2e-45f7-a5f9-2159d85e3cfb.png align="center")

We will use [Postman](https://www.postman.com/downloads/) to simulate requests to the API and ensure that the API behaves as expected.
...
2. POST /users: create a new user. Under “body”, choose “raw” and select “JSON”. This is the data we will be sending the api. The JSON body would be
...
Make sure you have the code committed to GitHub or [fork my repository](https://github.com/manishmshiva/nextjs-api) for this project. If you are new to Sevalla, you can sign up using your GitHub account to enable direct deploys from your GitHub account. Every time you push code to your project, Sevalla will auto-pull and deploy your app to the cloud.

Once you [login](https://app.sevalla.com/login) to Sevalla, click on “Applications”. Now let’s create an app.

![Sevalla App interface](https://cdn.hashnode.com/res/hashnode/image/upload/v1753420176622/a96c398e-18bc-42c2-917a-ba6a4f9ed585.png align="center")
...
![Connect Repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1753420351315/cc8b072b-fda8-43d5-a56b-9e3dd623523d.png align="center")
...
![Sevalla usage tier](https://cdn.hashnode.com/res/hashnode/image/upload/v1753420434828/71cb0e8e-832a-4077-b493-6928c874eb4b.png align="center")
...
![Application deployment](https://cdn.hashnode.com/res/hashnode/image/upload/v1753424002440/8dc98179-15f2-4178-b285-23f0f475bc66.png align="center")
...
Sevalla also provides resources like Object storage, database, cache, and so on, which are out of scope for this tutorial. But it lets you monitor, manage, and scale your application without the need for a system administrator. That’s the beauty of PaaS systems. Here is a detailed comparison of [VPS vs PaaS systems](https://www.freecodecamp.org/news/vps-vs-paas-how-to-choose-a-hosting-solution/) for application hosting.
...
Hope you enjoyed this article. I ll see you soon with another one. [Connect with me on LinkedIn](https://manishshivanandhan.com/) or [visit my website](https://linkedin.com/in/manishmshiva).
