---
title: How to build real-time applications using WebSockets with AWS API Gateway and
  Lambda
subtitle: ''
author: freeCodeCamp
co_authors: []
...
I took the above code from this [article](https://hackernoon.com/websockets-api-gateway-9d4aca493d39). The functionality of this code is to automatically create the Callback URL for our API and send the POST request.
