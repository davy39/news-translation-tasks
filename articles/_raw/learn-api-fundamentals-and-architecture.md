...
* [What is an API?](#heading-what-is-an-api)
    ...
    * [How Do APIs Work?](#heading-how-do-apis-work)
        
    * [Why Are APIs Important?](#heading-why-are-apis-important)
        
* [Types of APIs](#heading-types-of-apis)
    
    * [Open APIs](#heading-open-apis)
        
    * [Partner APIs](#heading-partner-apis)
        
    * [Internal APIs](#heading-internal-apis)
        
    * [Composite APIs](#heading-composite-apis)
        
* [Types of API Architecture](#heading-types-of-api-architecture)
    
    * [REST APIs](#heading-rest-apis)
        
    * [SOAP APIs](#heading-soap-apis)
        
    * [GraphQL APIs](#heading-graphql-apis)
        
    * [gRPC APIs](#heading-grpc-apis)
        
* [How to Choose an API Architecture](#heading-how-to-choose-an-api-architecture)
    
* [Conclusion and Future Trends](#heading-conclusion-and-future-trends)
...
![Diagram from shiksha.com illustrating how an API works.](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeho5OxXyKdS_-Sam70CtbZIH6y1wFMH3r21I0ZeNDVFNqoY0Jr2Lk5u_FfsiIas6LEnMPjRbQticIaDZi0iCF93Zj-JpxjZzXrwEGtdS_vIopXEUtNG5mvVHnVpf5vvhZGHw4Q?key=2qCWq-hs7d172uM7WbtEHg_B align="left")
...
* [TradeWatch](https://tradewatch.io/) – Real-time financial market data
    
* [SerpAPI’s Search API](http://serpapi.com) – Real-time Google SERP API
    
* [TwitterApi.io](http://twitterapi.io) – Access real-time and historical data
    
* [Instagram Post Generator](https://instagram-posts-generator.vercel.app/) – Generate posts with templates from popular IG pages
...
The Schema defines the data types (`Product`, `Query`, `Mutation`) and specifies the available queries (`product`, `products`), and mutations (`createProduct`, `updateProductInventory`). It uses the [GraphQL type system](https://graphql.org/learn/schema/) (String, Int, Float, ID, \[ \], !)
