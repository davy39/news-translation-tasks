...
_Demonstration of callback hell and pyramid_
...
_Able to inspect the internal properties of a promise_
...
_A settled promise is either fulfilled or rejected_
...
_The executor and consumer functions_
...
_Output of the promise chain call_
...
If you are here and have read through most of the lines above, congratulations! You should now have a better grip of JavaScript Promises. All the examples used in this article are in this [GitHub repository](https://github.com/atapas/js-promise-example). 
