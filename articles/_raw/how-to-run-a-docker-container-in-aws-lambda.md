...
* [Prerequisite/ Requirements](#heading-prerequisite-requirements)
    
* [Serverless with AWS Lambda](#heading-serverless-with-aws-lambda)
    
* [How to Build, Run, and Test a Container Locally](#heading-how-to-build-run-and-test-a-container-locally)
    
* [How to Push Your Image to Amazon Elastic Container Registry (ECR)](#heading-how-to-push-your-image-to-amazon-elastic-container-registry-ecr)
    
* [How to Deploy Your Docker Image to Lambda](#heading-how-to-deploy-your-docker-image-to-lambda)
...
* Python virtual environment managers [such as uv](https://github.com/astral-sh/uv) (optional)
...
You can find the project that you’ll be using here in this [GitHub repository](https://github.com/Agnes4Him/freecodecamp-lambda-docker).
...
![Running docker build command on the terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1766415846066/f128b7fc-f3a0-4770-b361-3f27c36a6ec4.png align="center")

![Output of docker images command showing a list of all existing images](https://cdn.hashnode.com/res/hashnode/image/upload/v1766415895836/d4653144-51b2-437d-8d73-4aaa42651206.png align="center")
...
![Showing docker run command in interactive mode](https://cdn.hashnode.com/res/hashnode/image/upload/v1766416250857/62584a3c-bf5e-4cd9-b8d5-fc6734c50075.png align="center")
...
![Testing that the running docker container is working by running test.py file](https://cdn.hashnode.com/res/hashnode/image/upload/v1766419713310/1ebc3435-3826-46fb-93f3-4218c367e280.png align="center")

You should see the desired response on the terminal.

![Docker container logs in real time](https://cdn.hashnode.com/res/hashnode/image/upload/v1766419866358/8f0c2867-64c6-4b16-a5a7-5a0eedf9470f.png align="center")
...
![Image of Amazon ECR showing the repository created earlier](https://cdn.hashnode.com/res/hashnode/image/upload/v1766420761622/5a18e41b-be41-4660-8d6c-59b12aebb4de.jpeg align="center")

![Image of the docker image pushed to the existing ECR repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1766420810814/9f65af4b-a509-45e3-be8f-0bed08cfe6b2.png align="center")
...
![AWS Lambda Console](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421062231/19bae74d-a6d5-4e73-8cca-102be40be214.png align="center")

Select `Container Image` and go ahead to search for the ECR repository you created.

![Select ECR repository to create a Lambda function](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421207358/25ae6eb2-1b1b-43c7-86dc-6dcd512ddc81.jpeg align="center")

Next, select the image:

![Select the existing Docker image from ECR](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421335963/ab7d9103-0ea6-4e25-be8c-139344acb5c5.png align="center")

Leave other configurations as default and click create.

![Hit the Create button to create a Lambda function](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421506518/2f6e631a-a0c7-4f20-966f-2ef87f91bfb7.jpeg align="center")

Navigate to the function after creating.

![The newly created Lambda function dashboard/ overview](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421673261/71c60ac4-35e7-4458-b4a7-1be2440b9e16.jpeg align="center")
...
![Create a new test instance to test the Lambda function](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421769909/008473e4-bb28-4fdd-8c5b-7e1f3489a3a0.png align="center")

![The output of testing Lambda function](https://cdn.hashnode.com/res/hashnode/image/upload/v1766421889043/86f6dbe6-be94-4dca-973e-9e7b68064ff3.png align="center")
