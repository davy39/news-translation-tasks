...
* [Understand the Arrow Functions in PHP](#understand-the-arrow-functions-in-php)
    
* [The Difference Between Arrow Functions and Anonymous Functions in PHP](#the-difference-between-arrow-functions-and-anonymous-functions-in-php)
    
    * [1\. Syntax](#1-syntax)
        
    * [2\. Variable Scope (Lexical Scope)](#2-variable-scope-lexical-scope)
        
    * [3\. Readability and Brevity](#3-readability-and-brevity)
        
* [How to Return Arrow Functions from Other Functions](#how-to-return-arrow-functions-from-other-functions)
    
* [How to Use Arrow Functions in Your Code?](#how-to-use-arrow-functions-in-your-code)
    
    * [Use the Arrow Function within `array_map()`](#use-the-arrow-function-within-array_map)
        
    * [Use the Arrow Function with `array_filter()`](#use-the-arrow-function-with-array_filter)
        
    * [Use the arrow function with `array_reduce()`](#use-the-arrow-function-with-array_reduce)
        
    * [Nest arrow functions in PHP](#nest-arrow-functions-in-php)
...
The [PHP arrow function](https://flatcoding.com/tutorials/php/arrow-functions/) is a shorthand syntax. It defines an anonymous function and is designed for simple operations and expressions.
...
Let’s move on to the following section to take a look at the difference between arrow functions and [anonymous functions in PHP](https://flatcoding.com/tutorials/php-programming/php-anonymous-functions/).
...
* [PHP docs on arrow functions](https://www.php.net/manual/en/functions.arrow.php)
    
* [Flatcoding blog](https://flatcoding.com/) where I publish many other tutorials
