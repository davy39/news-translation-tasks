...
The [Wordle](https://www.nytimes.com/games/wordle/index.html) phenomenon from a few years back inspired developers worldwide to create their own word games. It inspired me to conceive and build a game, too. ‘[Word Zearch](https://markm208.github.io/wordZearch/)’ combines elements of [Boggle](https://en.wikipedia.org/wiki/Boggle) and word search puzzles into a web-based game where players find words on a board.
...
Learn how to implement a [Trie (prefix tree)](https://www.freecodecamp.org/news/how-to-validate-user-input-with-automated-trie-visualization/) for fast word validation. This data structure is the foundation of the game's performance.
