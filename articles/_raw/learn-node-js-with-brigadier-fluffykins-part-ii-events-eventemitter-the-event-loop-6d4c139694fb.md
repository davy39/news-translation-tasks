---
title: 'Learn Node.js with Brigadier Fluffykins Part II: Events, EventEmitter and
  the Event Loop'
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_Brigadier Fluffykins likes to pretend he’s Jules Winfield._
...
_Call Stack — Last in, first out._
...
_If JavaScript was synchronous._
...
_**Left:** Call Stack. **Top Right:** Web API. **Bottom Right:** Queue. **Brigadier Fluffykins is the Event Loop.**_
