...
1. [Syntax of the `sort` method](#syntax)
2. [Sort list items in ascending order](#ascending)
3. [Sort list items in descending order](#descending)
4. [Sort list items using the `key` argument](#key)
5. [The differences between `sort()` and `sorted()`](#differences)
    1. [When to use `sort()` and `sorted()`](#usage)

## The `sort()` Method - A Syntax Overview <a name="syntax"></a>
...
## How to Sort List Items in Ascending Order Using the `sort()` Method <a name="ascending"></a>
...
## How to Sort List Items in Descending Order Using the `sort()` Method <a name="descending"></a>
...
## How to Sort List Items Using the `key` parameter with the `sort()` Method <a name="key"></a>
...
- and not define a function name like you did with the `def` function. Lambda functions are also called *anonymous* functions.  
...
## The Differences between `sort()` and `sorted()` <a name="differences"></a>
...
### When to Use `sort()` and `sorted()` <a name="usage"></a>
