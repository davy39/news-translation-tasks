...
I needed to log in to AWS. But my main email address was rejected. Apparently I'd done this in the past and the account had been irreversibly deleted. 
...
Add whatever email you choose and enter where you'd like it to be forwarded to. I'll have **hi@sieis.com** forwarded to my main Gmail address.
...
_Email sent to Alias and forwarded to main Gmail_
...
On the next screen, you'll need to change the **SMTP server** to smtp.gmail.com, the **username** to your Gmail username, and then paste in the **16 digit password** you generated from Google Security in the steps above.
