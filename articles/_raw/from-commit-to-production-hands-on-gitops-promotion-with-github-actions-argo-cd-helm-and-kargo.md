---
title: 'From Commit to Production: Hands-On GitOps Promotion with GitHub Actions,
  Argo CD, Helm, and Kargo'
subtitle: ''
...
That’s when I discovered **Craftista**, a project maintained by [Gourav Shah](https://www.linkedin.com/in/gouravshah/). This wasn’t just another training repo. As described in its documentation:
...
* [Prerequisites and What You’ll Learn](#heading-prerequisites-and-what-youll-learn)
    
* [Topics Outside the Scope of This Guide](#heading-topics-outside-the-scope-of-this-guide)
    
* [What is GitOps?](#heading-what-is-gitops)
    
    * [Core Principles of GitOps](#heading-core-principles-of-gitops)
        
* [Tools We Are Using in This Guide](#heading-tools-we-are-using-in-this-guide)
...
* [How to Structure Repositories for Microservice Applications](#heading-how-to-structure-repositories-for-microservice-applications)
    
    * [Why a Polyrepo Fits My Microservice-Service App](#heading-why-a-polyrepo-fits-my-microservice-service-app)
        
    * [Git Branching is Anti Pattern to GitOps Principles](#heading-git-branching-is-anti-pattern-to-gitops-principles)
        
* [How to Organize Kubernetes Manifests for GitOps](#heading-how-to-organize-kubernetes-manifests-for-gitops)
    
    * [Argo CD Folders](#heading-argo-cd-folders)
        
    * [2\. Argo CD Application Manifests (by Environment)](#heading-2-argo-cd-application-manifests-by-environment)
        
    * [Env Folders](#heading-env-folders)
        
    * [Kargo Folders](#heading-kargo-folders)
        
* [How to Deploy and Promote Your Craftista Microservices Application](#heading-how-to-deploy-and-promote-your-craftista-microservices-application)
    
    * [Prerequisites](#heading-prerequisites)
        
    * [1\. Start Minikube](#heading-1-start-minikube)
        
    * [2\. Install Argo CD](#heading-2-install-argo-cd)
        
    * [3\. Access the Argo CD UI](#heading-3-access-the-argo-cd-ui)
        
    * [4\. Define a “Craftista” Argo CD Project](#heading-4-define-a-craftista-argo-cd-project)
        
    * [5\. Deploy the Development Environment](#heading-5-deploy-the-development-environment)
        
    * [6\. Manual Promotion (Staging & Prod)](#heading-6-manual-promotion-staging-amp-prod)
        
    * [7\. Automated Promotion with Kargo](#heading-7-automated-promotion-with-kargo)
        
* [Further Reading & Resources](#heading-further-reading-amp-resources)
...
![Tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1748886977153/8d7eb087-8161-431b-b48f-c67d724909b9.png align="center")
...
![ArgoCD Flow](https://cdn.hashnode.com/res/hashnode/image/upload/v1748345707461/f7484475-8867-48af-a36e-e97d68683a45.png align="left")
...
![Kargo (Source: Akuity Blog)](https://cdn.hashnode.com/res/hashnode/image/upload/v1748373053736/6c015e27-b47b-486a-bb6a-e581b0f29a30.webp align="left")
...
![Kargo Components](https://cdn.hashnode.com/res/hashnode/image/upload/v1748373806449/00c7a2e5-48af-43b9-b9fc-9463b55c1abb.png align="left")
...
![Kargo and Argo CD Comparison ](https://cdn.hashnode.com/res/hashnode/image/upload/v1748474195349/8e615222-067e-4958-aa8c-19a9f44e4d74.png align="left")
...
My example application consists of 4 microservices ([frontend](https://github.com/nitheeshp-irl/microservice-frontend), [recommendation](https://github.com/nitheeshp-irl/microservice-recommendation), [catalogues](https://github.com/nitheeshp-irl/microservice-catalogue), and [voting](https://github.com/nitheeshp-irl/microservice-voting)). Designing your repository structure is very important to start your project. There is a lot of debate between monorepo and multi-service repo.
...
Many teams default to “[**GitFlow**](https://medium.com/novai-devops-101/understanding-gitflow-a-simple-guide-to-git-branching-strategy-4f079c12edb9)”-style branching – creating long-lived branches for `dev`, `staging`, `prod`, and more. But in a true GitOps workflow, **Git is your control plane**, and “environments” shouldn’t live as branches.
...
[This repo](https://github.com/nitheeshp-irl/microservice-helmcharts) shows how you can keep ArgoCD application manifests, environment-specific values, Kargo promotion tasks, Helm charts for each microservice, and CI/CD workflows all in one place. It is organized so that:
...
![ArgoCD Dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1748558624685/9f0d5725-cc8a-4e37-851c-d4ab2870bafc.png align="center")
...
![Kargo DashBoard](https://cdn.hashnode.com/res/hashnode/image/upload/v1748689354529/3759ec0c-7db4-42a8-9f01-f0792dfec895.png align="center")
...
* [Argo CD Documentat](https://argo-cd.readthedocs.io/)[ion](https://argo-cd.readthedocs.io/)
...
* [Craftista Repo](https://github.com/craftista/craftista)
