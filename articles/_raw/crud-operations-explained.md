...
## What We'll Cover
- [What is CRUD?](#heading-what-is-crud)
- [What is the `CREATE` Operation and How Does it Work? ](#heading-what-is-the-create-operation-and-how-does-it-work)
- [What is the `READ` Operation and How Does it Work?](#heading-what-is-the-read-operation-and-how-does-it-work)
- [What is the `UPDATE` Operation and How Does it Work?](#whatisupdateoperationandhowdoesitwork)
- [What is the `DELETE` Operation and How Does it Work?](#heading-what-is-the-delete-operation-and-how-does-it-work) 
...
To learn how you can make your own CRUD app, check out [this tutorial](https://www.freecodecamp.org/news/learn-crud-operations-in-javascript-by-building-todo-app/) by Joy Shaheb of freeCodeCamp.
