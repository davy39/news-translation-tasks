...
SQL is everywhere these days. Whether you're [learning backend development](https://www.boot.dev/), data engineering, DevOps, or data science, SQL is a skill you'll want in your toolbelt.
...
1. Try the interactive version of this [SQL course](https://boot.dev/learn/learn-gsql) on [Boot.dev](https://boot.dev/), complete with coding challenges and projects
...
* [Chapter 2: SQL Tables](#heading-chapter-2-sql-tables)
* [Chapter 3: Constraints](#heading-chapter-3-constraints)
* [Chapter 4: CRUD Operations](#heading-chapter-4-crud-operations-in-sql)
* [Chapter 5: Basic SQL Queries](#heading-chapter-5-basic-sql-queries)
* [Chapter 6: How to Structure Return Data in SQL](#heading-chapter-6-how-to-structure-return-data-in-sql)
* [Chapter 7: How to Perform Aggregations in SQL](#heading-chapter-7-how-to-perform-aggregations-in-sql)
* [Chapter 8: SQL Subqueries](#heading-chapter-8-sql-subqueries)
* [Chapter 9: Database Normalization](#heading-chapter-9-database-normalization)
* [Chapter 10: How to Join Tables in SQL](#heading-chapter-10-how-to-join-tables-in-sql)
* [Chapter 11: Database Performance](#heading-chapter-11-database-performance)

## Chapter 1: Introduction

Structured Query Language, or [SQL](https://www.freecodecamp.org/news/what-is-sql-database-definition-for-beginners/), is the primary programming language used to manage and interact with [relational databases](https://cloud.google.com/learn/what-is-a-relational-database). SQL can perform various operations such as creating, updating, reading, and deleting records within a database.
...
Again, in this course we will be working with SQLite, a lightweight and simple database. For most [backend](https://blog.boot.dev/backend/do-backend-devs-need-sql/) web servers, PostgreSQL is a more production-ready option, but SQLite is great for learning and for small systems.
...
SQL as a language can support many different data types. But the datatypes that your database management system ([DBMS](https://en.wikipedia.org/wiki/Database#:~:text=A%20database%20management%20system%20(DBMS))) supports will vary depending on the specific database you're using.
...
Here's a [list of SQL Features](https://www.sqlite.org/omitted.html) SQLite does not implement in case you're curious.
...
Manually `INSERT`ing every single record in a database would be an *extremely* time-consuming task! Working with raw SQL as we are now is not super common when designing [backend systems](https://blog.boot.dev/backend/do-backend-devs-need-sql/).

When working with SQL within a software system, like a backend web application, you'll typically have access to a programming language such as [Go](https://boot.dev/learn/learn-golang) or [Python](https://boot.dev/learn/learn-python). 
...
If you're interested in doing the interactive coding assignments and quizzes for this course, you can check out the [Learn SQL Course](https://www.boot.dev/learn/learn-sql) course over on [Boot.dev](https://www.boot.dev/)
...
[Lane's Podcast: Backend Banter](https://www.backendbanter.fm/)
[Lane on Twitter](https://twitter.com/wagslane)
[Lane on YouTube](https://www.youtube.com/@bootdotdev)
