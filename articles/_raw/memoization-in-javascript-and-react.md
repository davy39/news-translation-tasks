...
* [What is memoization](#heading-what-is-memoization)
    
* [How does memoization work](#heading-how-does-memoization-work)
    
* [JavaScript memoization example](#heading-javascript-memoization-example)
    
* [React memoization example](#heading-react-memoization-example)
    
    * [Pure components](#heading-pure-components)
        
    * [PureComponent class](#heading-purecomponent-class)
        
    * [Memo higher order component](#heading-memo-higher-order-component)
        
    * [When to use the useCallback hook](#heading-when-to-use-the-usecallback-hook)
        
    * [When to use the useMemo hook](#heading-when-to-use-the-usememo-hook)
        
    * [When to memoize](#heading-when-to-memoize)
        
* [Roundup](#heading-round-up)
