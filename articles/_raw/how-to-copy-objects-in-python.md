...
1. [What is the Copy Module in Python?](#heading-what-is-the-copy-module-in-python)
    
    * [Why Can’t We Just Use the Assignment Operator?](#heading-why-cant-we-just-use-the-assignment-operator)
        
2. [How to Properly Copy Objects in Python](#heading-how-to-properly-copy-objects-in-python)
    
3. [More About Copying Objects in Python](#heading-more-about-copying-objects-in-python)
