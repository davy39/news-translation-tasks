...
- [What is IndexNow?](#heading-what-is-indexnow)
    * [How Does it Work?](#heading-how-does-it-work)
- [Steps](#steps)
   * [Prerequisites](#heading-prerequisites)
   * [High Level Steps](#heading-high-level-steps)
   * [How to Prove Ownership of the Host](#heading-how-to-prove-ownership-of-the-host)
   * [How to Create a Script to Get All URLs from Your Sitemap](#heading-how-to-create-a-script-to-get-all-urls-from-your-sitemap)
   * [How to Call the IndexNow API](#heading-how-to-call-the-indexnow-api)
- [Next Steps and Improvements](#heading-next-steps-and-improvements)
- [Conclusion](#heading-conclusion)
- [Links and References](#heading-links-and-references)

## What is IndexNow?

[IndexNow](https://www.indexnow.org/) is a protocol that drastically reduces indexing time. Here's how it's defined on their website:

> IndexNow is an easy way for websites owners to instantly inform search engines about latest content changes on their website. In its simplest form, IndexNow is a simple ping so that search engines know that a URL and its content has been added, updated, or deleted, allowing search engines to quickly reflect this change in their search results.([Source: IndexNow Home](https://www.indexnow.org/))
...
Go to the [`IndexNow`](https://www.bing.com/indexnow/getstarted) [page](https://www.bing.com/indexnow/getstarted) for Bing. Since there is no direct integration for Next.js, scroll down to the section of [manual integration](https://www.bing.com/indexnow/getstarted#implementation).
...
That is, opening [https://localhost:3000/f34f184d10c049ef99aa7637cdc4ef04.txt](https://localhost:3000/f34f184d10c049ef99aa7637cdc4ef04.txt) should give a response with text "f34f184d10c049ef99aa7637cdc4ef04" on your browser.
...
* [indexnow-submitter NPM module](https://www.npmjs.com/package/indexnow-submitter)
* [indexnow-submitter release announcement](https://wewake.dev/posts/introducing-indexnow-submitter-fast-search-engine-indexing/) 
