...
First, go to the [Google Cloud Console](https://console.cloud.google.com/). Create a new project or select an existing one.
...
Now you’ll initialize the `auth` variable with [OAuth 2.0 credentials](https://developers.google.com/identity/protocols/oauth2), which authenticates access to the Docs API.
