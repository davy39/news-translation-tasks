...
![Karpathy's message on how to become an expert at a thing](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441366598/07d24597-c31d-45b5-a99c-fbb485ce3459.png align="left")
...
1. [What Should Be Your First Project?](#heading-what-should-be-your-first-project)
    
2. [Project #1: YouTube Video Summarizer](#heading-project-1-summarise-youtube-videos)
    
    * [Setup and Requirements](#heading-setup-and-requirements)
        
    * [Introduction to Document Loaders](#heading-introduction-to-document-loaders)
        
    * [Processing YouTube Transcripts](#heading-processing-youtube-transcripts)
        
    * [Using LangChain for Summarization](#heading-using-langchain-for-summarization)
        
    * [Deploying the Summarizer on WhatsApp](#heading-deploying-the-summarizer-on-whatsapp)
        
    * [Creating a Flask API](#heading-creating-a-flask-api)
        
    * [Connecting with Twilio for WhatsApp integration](#heading-connecting-with-twilio-for-whatsapp-integration)
        
3. [Project #2 preview: Multi-purpose Customer Service Bot](#heading-project-2-build-a-bot-that-can-handle-different-types-of-user-queries)
    
4. [Project #3 preview: RAG-Powered Support Bot](#heading-project-3-rag-powered-support-bot)
...
![Wiplane's project on building Youtube summariser whatsapp chatbot](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441993970/d318b7d9-37d5-4e93-a862-4d8c6e23886b.png align="left")
...
![LangChain supports different types of document loaders](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441974919/e979be2a-c1d8-4936-aa45-58d909855ace.png align="left")
...
![Youtube video transcript from the youtube loader](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441916343/b834abbf-f4d5-4464-a421-257ef95fcbd1.png align="left")
...
![summary response from simple LLM chain](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441806141/be122b5b-6774-46be-92ab-1f9e651b5045.png align="left")
...
![Structure summary display using Markdown function ](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441776170/98223339-03d2-483c-84ef-9400d2eb33f2.png align="left")
...
![Establishing connection between youtube and flask server using Twilio](https://cdn.hashnode.com/res/hashnode/image/upload/v1727421384448/cd7f0f37-f25b-4b46-a4a9-0bcd5bf0f0fd.png align="center")
...
![Configure twilio sandbox settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1727422495235/4a60a190-2d57-4726-be7c-1e062c4528e5.png align="center")

Now, we can start testing our WhatsApp bot:

![Summariser chatbot screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1727422721636/339fd977-6b63-4f57-ba40-e677c32e1814.png align="center")
...
![Wiplane's project 2 - Airline customer support to handle different types of queries](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441691086/54bcc4a9-8e04-4509-a361-ee4eb15bca08.png align="left")
...
![Wiplane's project 3 - RAG powered support bot](https://cdn.hashnode.com/res/hashnode/image/upload/v1727441686023/fe55ec78-96dd-42bd-aeae-ceaad24aae44.png align="left")

These 3 projects will get you started so you can continue experimenting and learning more about AI engineering.

[![Wiplane's 3 project course on building LLM powered whatsapp chatbots](https://cdn.hashnode.com/res/hashnode/image/upload/v1727306395800/82bf4b68-a79b-4f40-b4fe-61f99fa445ab.png align="center")](https://www.wiplane.com/whatsapp-chatbot)
