...
_Relative positioning with Top_
...
And if we use Top, Bottom, Left, or Right with Absolute, it will arrange the element according to the parent container, _with the condition that the parent container must also be absolute-positioned._ 
...
**Row** is used to arrange items horizontally.
...
**Column** arranges items vertically, like this:
...
**Center** sets the elements to the horizontal center of the page.

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-43-23.png)

**Flex Start** positions element at the start of the page.

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-44-15.png)

**Flex End** sets the element to the end of the page. 

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-44-40.png)

**Space Around** arranges the items evenly but with spaces between them. The spaces will be equal among all the elements inside a flex-box container, but not outside them.
...
**Space Between** maximizes the spaces between child elements (it's a Justify Content Property).

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-45-54.png)

**Space Evenly** distributes equal spaces between the child elements and the space outside the FlexBox container.
...
**Center** sets the elements to the center of the page, vertically.

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-47-26.png)

**Flex Start** is the same as the Justify Content to Center, but it arranges elements vertically. In our case, the elements will be at the top left corner of the screen.

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-05-05-48-12.png)

**Flex End** is the same as Flex Start, but this will align-items to the bottom left corner of the screen.
...
These Flexbox properties can also be used together. For example, if we want to arrange the items in the very center, we can use both **align-items: center** and **justify-content: center.**

![Image](https://www.freecodecamp.org/news/content/images/2021/03/Screenshot-2021-03-07-16-31-13.png)

You can [find the code on Github](https://github.com/nishant-666/CSS-Positioning-and-Flexbox) if you want to experiment some more.
