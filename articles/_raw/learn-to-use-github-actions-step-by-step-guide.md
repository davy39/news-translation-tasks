...
[GitHub Actions](https://docs.github.com/en/actions) are one of the most helpful features of GitHub. Actions help you automate, build, test, and deploy your app from your GitHub. They also help you perform code reviews and tests, manage branches, triage issues, and more.
...
1. [Prerequisites](https://preview.freecodecamp.org/66dac163d514d27826eb3bef#heading-prerequisites)
    
2. [Key GitHub Actions Concepts](https://preview.freecodecamp.org/66dac163d514d27826eb3bef#heading-key-github-actions-concepts)
    
3. [How to Create a GitHub Action in Your Repository](#heading-how-to-create-a-github-action-in-your-repository)
    
    * [Create a GitHub Action Using the GitHub UI](#heading-create-a-github-action-using-the-github-ui)
        
    * [Create a GitHub Action Locally with Your IDE](#heading-create-a-github-action-locally-with-your-ide)
        
4. [GitHub Actions Syntax](#heading-github-actions-syntax)
    
5. [GitHub Actions Examples](#heading-github-actions-examples)
    
6. [Conclusion](https://preview.freecodecamp.org/66dac163d514d27826eb3bef#heading-conclusion)
    

## Prerequisites

To get the most out of this article, you should have at least a basic knowledge of how to use GitHub and YAML. If you don't know GitHub fundamentals, check out [this in-depth tutorial on Git and GitHub](https://www.freecodecamp.org/news/guide-to-git-github-for-beginners-and-experienced-devs/). And [here’s an introduction to YAML](https://www.freecodecamp.org/news/what-is-yaml-the-yml-file-format/).
...
![Describing the different event types in GitHub](https://cdn.hashnode.com/res/hashnode/image/upload/v1736342712858/866f61a7-4750-45bf-82ea-d4e9535069a4.png align="center")
...
The `push`, `release`, and `pull_request` events are the most common events. To read more about events, you can [check out the GitHub documentation](https://docs.github.com/en/actions/writing-workflows/choosing-when-your-workflow-runs/events-that-trigger-workflows#about-events-that-trigger-workflows).
...
![GitHub repository where you want to create your action](https://cdn.hashnode.com/res/hashnode/image/upload/v1736510921442/e4b338f5-c928-4aba-953d-0df5adee0bd3.png align="center")
...
![Create the GitHub Action](https://cdn.hashnode.com/res/hashnode/image/upload/v1736511145120/79fc5a4a-26b9-4f41-bc7b-1c976ff47663.png align="center")
...
![Select the github workflow in github](https://cdn.hashnode.com/res/hashnode/image/upload/v1736511580215/48ed1bb6-bc25-43fd-bf3d-2ac9f945f3eb.png align="center")
...
![Edit and create your Action in Github.](https://cdn.hashnode.com/res/hashnode/image/upload/v1736858011259/267d62ad-f41b-449e-b0dd-dab3a9251ba1.png align="center")
...
![Create an action locally using your IDE.](https://cdn.hashnode.com/res/hashnode/image/upload/v1736935606919/aa187277-118a-4990-b240-684ced2f8a55.png align="center")
...
13. `uses`: With the `uses` option, you can run reusable units of code or other packages. You usually use it to run a GitHub package published by another developer on the [GitHub marketplace](https://github.com/marketplace). Most package developers use JavaScript or Docker container files.
...
For advanced GitHub Action syntax, you can [check out the Github documentation](https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions).
...
The [`vimtor/action-zip@v1.2`](https://github.com/marketplace/actions/easy-zip-files) extension or package converts files into a zip folder. The `actions/upload-artifact@v4` package uploads artifacts during a workflow run.

![Upload the artifact in Github Action.](https://cdn.hashnode.com/res/hashnode/image/upload/v1736875426358/0b918abf-317d-407c-a179-50693604deb7.png align="center")
...
The `actions/configure-pages@v5` package helps you configure GitHub Pages and allows you to gather metadata about your website. For more detail, refer to the [configure-pages action](https://github.com/marketplace/actions/configure-github-pages) documentation.

The `actions/upload-pages-artifact@v3` package helps you to package and upload artifacts that can be deployed to [GitHub Pages.](https://pages.github.com/)

The `actions/deploy-pages@v4` package is used to [deploy your website](https://github.com/actions/deploy-pages) to GitHub Pages.
...
I have published an in-depth article on freeCodeCamp on [how to use the Act CLI tool](https://www.freecodecamp.org/news/how-to-run-github-actions-locally/) if you want to read more about that.
