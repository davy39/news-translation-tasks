...
🔗 [**You can find the code examples on GitHub**](https://github.com/balapriyac/python-basics/tree/main/parsing-json).
...
1. [Understanding JSON Structure and Basic Parsing](#heading-understanding-json-structure-and-basic-parsing)
    
2. [How to Work with Nested JSON Objects](#heading-how-to-work-with-nested-json-objects)
    
3. [How to Parse JSON Arrays](#heading-how-to-parse-json-arrays)
    
4. [How to Read JSON from Files](#heading-how-to-read-json-from-files)
    
5. [How to Handle JSON Parsing Errors](#heading-how-to-handle-json-parsing-errors)
...
You can also use list comprehensions to filter the parsed data, creating a new list containing only products where the "in\_stock" value is `True`.
