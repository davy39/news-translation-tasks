...
subtitle: Scripts make the Nmap tool more powerful than it already is. Let’s learn
  how to work with a few of them.
...
Let’s do a quick scan and see what we can find. We can use the URL [scanme.nmap.org](http://scanme.nmap.org) to try out a scan. Nmap allows us to use this server to practice scans.

![Nmap sample scan](https://miro.medium.com/v2/resize:fit:1050/1*daqo4BGtxBZdWF2TLCxQHw.png align="left")

As you can see, we have found some open ports and services. These act as entry points for further analysis or exploitation.

Nmap is usually the first tool that ethical hackers learn. [Here is a full tutorial if you want to learn more about Nma](https://www.stealthsecurity.sh/p/nmap-tutorial)[p.](https://www.stealthsecurity.sh/p/nmap-tutorial)
...
![http-enum sample response](https://cdn.hashnode.com/res/hashnode/image/upload/v1730379312717/5e6300c2-0030-4400-b998-e395c0b69a4f.png align="left")
...
![smb-os-discovery sample result](https://cdn.hashnode.com/res/hashnode/image/upload/v1730444262829/c8f76aee-d0a6-4203-b572-17df1272211c.png align="left")
...
![http-headers sample response](https://cdn.hashnode.com/res/hashnode/image/upload/v1730380306638/703870e4-de5b-4858-b1b2-20634a8598a9.png align="left")
...
![ssh-brute sample response](https://cdn.hashnode.com/res/hashnode/image/upload/v1730811335746/c6f6ad27-37d7-467d-8f5c-cd71a37aff0f.jpeg align="left")
...
![dns-brute script](https://cdn.hashnode.com/res/hashnode/image/upload/v1730379500675/c8c646c3-1d76-440a-8092-6ce26f9aa127.png align="left")
...
**To learn how to build a career in Cybersecurity, check out** [***The Hacker’s Han***](https://book.stealthsecurity.sh/?utm_source=www.stealthsecurity.sh&utm_medium=newsletter&utm_campaign=top-cybersecurity-certifications-you-should-know-about)[***dbook*. To practice ha**](https://book.stealthsecurity.sh/?utm_source=www.stealthsecurity.sh&utm_medium=newsletter&utm_campaign=top-cybersecurity-certifications-you-should-know-about)**cking real systems and get help from other hackers, join** [***The Hacker’***](https://www.skool.com/hackershub?utm_source=www.stealthsecurity.sh&utm_medium=newsletter&utm_campaign=top-cybersecurity-certifications-you-should-know-about)[***s Hub*.**](https://www.skool.com/hackershub?utm_source=www.stealthsecurity.sh&utm_medium=newsletter&utm_campaign=top-cybersecurity-certifications-you-should-know-about)
