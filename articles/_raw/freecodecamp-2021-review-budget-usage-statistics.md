---
title: Developers Spent 2.1 Billion Minutes (4,000 years) Using freeCodeCamp in 2021
  + Other Year-End Facts
subtitle: ''
author: Quincy Larson
co_authors: []
series: null
date: '2021-11-19T05:29:54.000Z'
originalURL: https://freecodecamp.org/news/freecodecamp-2021-review-budget-usage-statistics
coverImage: https://www.freecodecamp.org/news/content/images/2021/11/luca-bravo-zAjdgNXsMeg-unsplash.jpg
tags:
- name: community
  slug: community
- name: freeCodeCamp.org
  slug: freecodecamp
seo_title: null
seo_desc: '2021 has been a big year for the global freeCodeCamp community. In this
  article, I will share some of the milestones we hit this year.

  But first, let''s look at some metrics to drive home the scale at which the freeCodeCamp
  community is now operating....'
---
...
![Image](https://www.freecodecamp.org/news/content/images/2021/11/freeCodeCamp_historic_usage_-_Google_Sheets-6.png)
_A table showing growth of freeCodeCamp.org community over the past 7 years (exact data in table below)_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/11/CkY--mUUoAE2est.jpeg)
_The closet office in my San Francisco Bay Area area apartment where I coded the first lines of the freeCodeCamp open source codebase back in October 2014. Update: I now have an entire room to work in. With a window._

At our current level of operational efficiency, **[every dollar you donate to freeCodeCamp](https://www.freecodecamp.org/news/how-to-donate-to-free-code-camp/) provides nearly 50 hours of learning for people around the world.**
...
(By the way, thanks to the 7,398 kind people who support freeCodeCamp with monthly donation of $5. If you aren't donating yet, here are some ways you can [join these awesome supporters](https://www.freecodecamp.org/news/how-to-donate-to-free-code-camp/).)
...
![Image](https://www.freecodecamp.org/news/content/images/2021/11/_99___freeCodeCamp__People___LinkedIn.png)
_LinkedIn's breakdown of where freeCodeCamp alumni live and which companies they work for. Note that both Upwork and Fiverr are freelancing platforms, indicating these alumni probably run their own development consultancy. Large accounting firms are also well-represented here, along with major tech companies._
...
_You can click the "Add this certification to my LinkedIn profile" button below your certifications._
...
_The 10 verified certifications you can earn if you can power through our lengthy, no-nonsense curriculum._
...
This year we published a Relational Database Certification that you can do right inside your computer's code editor. This will teach you key Linux, Git, SQL, and Postgres concepts and command line inputs. And we will soon make this available in-browser on freeCodeCamp.org. For now, you can [install the entire certification and all its projects using Docker](https://www.freecodecamp.org/news/how-to-run-freecodecamps-relational-databases-curriculum-using-docker-vscode-and-coderoad/).
...
In the coming months, we will start pushing these to production one-by-one as they are ready. You can [read about this curriculum expansion and view the planning documents to see what we'll cover here](https://www.freecodecamp.org/news/building-a-data-science-curriculum-with-advanced-math-and-machine-learning/).

%[https://twitter.com/ossia/status/1415658657950232580]
...
%[https://twitter.com/ossia/status/1455590293785518086]

## Pillar #2: freeCodeCamp Publication usage grew 34% in 2021

![Image](https://www.freecodecamp.org/news/content/images/2021/11/freeCodeCamp_Programming_Tutorials__Python__JavaScript__Git___More_--.png)
_Some of the tutorials we have published today on freeCodeCamp's publication_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/11/Users_-_The_freeCodeCamp_Forum.png)
_A screenshot of the freeCodeCamp forum leaderboard for the past year. People often give a heart to other people who help them solve their programming questions. Kind of like Stack Overflow or Quora. The main distinction is that with the freeCodeCamp forum, we seek to be friendly and inclusive above all else._

## Pillar #4: The freeCodeCamp Community YouTube Channel

![Image](https://www.freecodecamp.org/news/content/images/2021/11/freeCodeCamp_org_-_YouTube.png)
_A screenshot of the freeCodeCamp community YouTube channel_
...
* [12 Beginner Python Projects](https://www.freecodecamp.org/news/learn-how-to-build-12-python-projects-in-one-course/) taught by MIT grad student Kylie Ying
* [How to Code Your Own Discord Bot in Python and Host it for Free](https://www.freecodecamp.org/news/create-a-discord-bot-with-python/) by prolific freeCodeCamp teacher Beau Carnes
* [Algorithmic Trading with Python](https://www.freecodecamp.org/news/algorithmic-trading-using-python-course/) by developer and Chartered Financial Analyst Nick McCullum

Come to think of it, these three courses have something in common. Can you spot it?

![Image](https://www.freecodecamp.org/news/content/images/2021/11/Mugatu_So_Hot_Right_Now_Meme_Generator_-_Imgflip_--.png)
_I made a silly meme. Python. So hot right now. Python. (Image from 2001 comedy Zoolander.)_
...
And if you're curious, here's [our most recent 990](https://freecodecamp.s3.amazonaws.com/freeCodeCamp+2019+f990.pdf). This is, essentially, an annual report that nonprofits file with the US government.
...
If you want to support an extremely donation-efficient nonprofit, [here are several ways you can do that – whichever works easiest for you.](https://www.freecodecamp.org/news/how-to-donate-to-free-code-camp/)
...
You can also make one time donations if you prefer. Again, [whichever way works best for you](https://www.freecodecamp.org/news/how-to-donate-to-free-code-camp/).
...
![Image](https://www.freecodecamp.org/news/content/images/2021/11/IMG_8145_HEIC.png)
_Me with the kids: Jocelyn and Quentin. They'll learn to code when they feel ready :)_
