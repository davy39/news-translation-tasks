---
title: Web Scraping in JavaScript – How to Use Puppeteer to Scrape Web Pages
subtitle: ''
author: Gaël Thomas
co_authors: []
series: null
...
_Quotes to Scrape homepage loaded by our initial script_
...
_Browser inspector with the first quote `&lt;div&gt;` selected_

![Image](https://www.freecodecamp.org/news/content/images/2023/01/image-355.png)
_An example of how each quote is rendered in the HTML_
...
_After running the `document.querySelector` instruction in the browser inspector, we have the first quote as an output (like on Puppeteer)_
...
_"Next" button at the Quotes to Scrape page bottom_
...
_An example of how the "Next" button is rendered in the HTML_
...
_Quotes to Scrape second page loaded after clicking the "Next" button_
