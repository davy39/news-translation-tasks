...
_☞ If you like my article, please **don’t forget to click ❤ to recommend** it to others._

_Also, to be notified about my new articles and stories, follow me on [Medium](https://medium.com/@suhas_chatekar) and [Twitter](https://twitter.com/suhas_chatekar). You can find me on [LinkedIn](https://www.linkedin.com/in/chatekar) as well. Cheers!_
...
[_One of the characteristics of a good REST API is that it uses the standard HTTP methods in a way they are supposed to…_medium.com](https://medium.com/@suhas_chatekar/why-you-should-use-the-recommended-http-methods-in-your-rest-apis-981359828bf7)[**Visualising complex APIs using API Map**](https://medium.com/@suhas_chatekar/visualising-complex-apis-using-api-map-f09f617acb32)  
[_A picture is worth a thousand words…_medium.com](https://medium.com/@suhas_chatekar/visualising-complex-apis-using-api-map-f09f617acb32)
