...
_The difference between GitHub and Git_
...
_Remote repository and local repositories_
...
_Working directory, repository, staging area, and commit history_
...
_Adding a file to our project_
...
_Our file is in the working directory_
...
_Adding a file to the staging area_
...
_Our file is in the staging area_
...
_We have made our first commit_
...
_Showing the master branch in our .git folder_
...
_Showing the master branch pointing to our commit_
...
_Showing our commit history and the master branch pointing to our latest commit_
...
_Git Learning Journey, online course teaching Git version control by Anna Skoulikari_
