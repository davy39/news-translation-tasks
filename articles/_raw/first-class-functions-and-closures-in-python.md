---
title: First-Class Functions, Higher-Order Functions, and Closures in Python – Explained
  with Code Examples
subtitle: ''
author: Samyak Jain
co_authors: []
...
1. [First-Class Functions](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#first-class-functions)  
– [Assigning Functions to Variables](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#assigning-functions-to-variables)  
– [Passing Functions as Arguments](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#passing-functions-as-arguments)  
– [Returning Functions from Other Functions](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#returning-functions-from-other-functions)
2. [Higher-Order Functions](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#higher-order-functions)  
– [Lambda Functions](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#lambda-functions)  
– [Higher-Order Function that Takes a Function as an Argument](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#example-a-higher-order-function-that-takes-a-function-as-an-argument-first-class-function-)  
– [Higher-Order Function that Returns Another Function](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#example-a-higher-order-function-that-returns-another-function-first-class-function-)
3. [Closures](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#closures)  
– [Basic Closure (Basic Nested Function with Immediate Execution)](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#basic-nested-function-with-immediate-execution)  
– [Returning the Inner Function](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#returning-the-inner-function)  
– [Using Closures with Parameters](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#using-closures-with-parameters)
4. [Real-World Applications](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#real-world-applications-of-closures)
...
* In our "[Passing Functions as Arguments](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#passing-functions-as-arguments)" example, `map_function` is a higher-order function because it takes a function (`double`) as an argument.
* In our "[Returning Functions from Other Functions](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/#returning-functions-from-other-functions)" example, `create_multiplier` is a higher-order function because it returns another function (`multiplier`) as a result.
...
For a more in-depth understanding of lambda functions, you can check this tutorial [here](https://www.freecodecamp.org/news/p/8926a586-a677-442f-8fa9-6ba325286250/).
...
In Python, closures can be used to maintain state in graphical user interface (GUI) applications, such as those created with [Tkinter](https://github.com/theSamyak/Tkinter-V3).
...
You can read [this article on Decorators](https://www.freecodecamp.org/news/decorators-in-python-tutorial/) to learn more about them if you'd like.
