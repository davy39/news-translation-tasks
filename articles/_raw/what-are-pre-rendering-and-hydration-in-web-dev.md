...
Have you ever wondered how Frameworks like [**Next.js**](https://nextjs.org/), [**Gatsby.js**](https://www.gatsbyjs.com/), and [**Remix**](https://remix.run/) work?
...
1. [Web Development in the Past: Traditional Server-Side Rendering](#heading-web-development-in-the-past-traditional-server-side-rendering)
    
    * [The Downside of Traditional Server-Side Rendering](#heading-the-downside-of-traditional-server-side-rendering)
        
2. [Traditional Server-Side Rendering vs. Single-Page Applications](#heading-traditional-server-side-rendering-vs-single-page-applications)
    
    * [What is a Single Page Application (SPA)?](#heading-what-is-a-single-page-application-spa)
        
    * [Single Page Application Flow](#heading-single-page-application-flow)
        
3. [Entering a New World with Pre-Rendering and Hydration](#heading-entering-a-new-world-with-pre-rendering-and-hydration)
    
    * [Why is Pre-Rendering Important?](#heading-why-is-pre-rendering-important)
        
    * [What is Server Side Rendering?](#heading-what-is-server-side-rendering)
        
    * [What is Static Site Generation (SSG)?](#heading-what-is-static-site-generation)
        
    * [What is Hydration?](#heading-what-is-hydration)
        
    * [What is Reconciliation?](#heading-what-is-reconciliation)
        
    * [Pre-rendering and Hydration in Action](#heading-pre-rendering-and-hydration-in-action)
        
    * [A Mental Model for Hydration](#heading-a-mental-model-for-hydration)
        
    * [Potential Errors when working with Pre-rendering and Hydration Frameworks](#heading-potential-errors-when-working-with-pre-rendering-and-hydration)
        
4. [How does it relate to frameworks like Gatsby.js, Next.js, and Remix?](#heading-how-does-it-relate-to-frameworks-like-gatsbyjs-nextjs-and-remix)
    
5. [Moving Forward](#heading-moving-forward)
    
6. [Conclusion](#heading-moving-forward)
    

## Web Development in the Past: Traditional Server-Side Rendering

Back in the days of traditional server-side rendering, rendering and interactivity were separated. We used server-side languages like [**Node.js**](https://nodejs.org/en), [**PHP**](https://www.php.net/), [**Java**](https://www.java.com/en/), and [**Ruby on Rails**](https://rubyonrails.org/).

Within our servers, we created **views** using templating languages like [**JSP**](https://en.wikipedia.org/wiki/Jakarta_Server_Pages) and [**EJS**](https://ejs.co/). Views are HTML pages, and you could inject JavaScript or Java inside them to add functionality, dynamic data retrieved from database queries, and interactive segments with languages like [**JQuery**](https://jquery.com/).
...
* **Global Reach**: A **Dynamic CDN** was needed to cache your dynamic files. CDNs are better suited for static content, but companies like Cloudflare created [**Cloudflare-Workers**](https://www.cloudflare.com/products/cloudflare-workers/) to help with the process.
...
> ![Single Page Application React Flow. (Source: How NextJS REALLY Works: https://youtu.be/d2yNsZd5PMs?si=RmnywZJEAuurseQm)](https://cdn.hashnode.com/res/hashnode/image/upload/v1725392287290/04dba828-9903-4ca6-bf8e-0c0d875d587b.png?auto=compress,format&format=webp align="left")
...
![Single Page Application JavaScript Disabled Test.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725392877108/d5a2eb1c-f784-4879-b02f-8c340d405c9c.gif?auto=format,compress&gif-q=60&format=webm align="left")
...
![Pre-rendering flow.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725392958385/eaee78cb-736c-4d49-8fb7-c9cb098d3652.png?auto=compress,format&format=webp align="left")
...
Based on the changes found, **React is not going to update the entire UI**. Instead, it will **select which elements need to be updated.** This [**article**](https://www.educative.io/answers/what-is-the-concept-of-reconciliation-in-react) helped me understand Reconciliation.
...
Here is a gif where I disable JavaScript on my Portfolio. I created my portfolio using [**Gatsby**](https://www.gatsbyjs.com/) a static-site-generation framework (it also has server-side rendering capabilities):

![Portfolio JavaScript Disabled Test.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725554638438/698fd854-e828-44cd-996a-e01b154803d1.gif?auto=format,compress&gif-q=60&format=webm align="left")
...
![Mismatch text content from server and client hydration error.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725555403697/ebb398ec-cd58-4b9a-aa63-c43a9b511eeb.png?auto=compress,format&format=webp align="left")
...
![Different server html generated.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725555472118/d76c7ad0-92ab-4b77-92ea-b3d9d6a3b4fe.png?auto=compress,format&format=webp align="left")

**The client's response below:**

![Different client html generated.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725555518535/af27855d-d362-44e3-8007-b01fde1d2455.png?auto=compress,format&format=webp align="left")
...
![Cannot use client-side properties hydration error.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725555844562/443c435c-308a-4422-b184-b2f321672519.png?auto=compress,format&format=webp align="left")

The Network Tab shows us the server's response. It is an empty `<div>` tag.

**The server's response below:**

![Different server html generated.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725555958286/aeeaa522-3266-4b60-856d-d0cd3bf4d9c9.png?auto=compress,format&format=webp align="left")

But the client loads HTML that says "This p tag will appear".

**The client's response below:**

![Different client html generated.](https://cdn.hashnode.com/res/hashnode/image/upload/v1725556187527/173bf82a-1754-4835-9921-adea0f2e864a.png?auto=compress,format&format=webp align="left")

This demo was inspired by [**Deeecode The Web**](https://www.youtube.com/@deeecode) in [**Why Do HYDRATION ERRORS Exist? And how to solve them**](https://youtu.be/7UOyuEHYmSE?si=Ql8z5D_pAryvTyFf). He gives a great explanation of why Hydration Errors occur. I recommend watching it!
...
> ![Pre-rendering and Single Page Application combined flow. (Source: How NextJS REALLY Works)](https://cdn.hashnode.com/res/hashnode/image/upload/v1725556321232/7d8629fd-b528-4cd7-9bc2-7de0bf1ab630.png?auto=compress,format&format=webp align="left")
...
Next.js first implemented these concepts with the [Pages Router](https://nextjs.org/docs/pages). Pages Router was great and introduced the world to functions like `getServerSideProps`, `getStaticPaths`, and `getStaticProps` to implement Static-Site Generation and Server-Side Rendering.
...
>     
>     [(Source: Making Sense of React Server Components)](https://www.joshwcomeau.com/react/server-components/)
>     

The React team saw this too and created a new paradigm called [React Server Components (RSC)](https://react.dev/reference/rsc/server-components). To implement RSC, the Vercel team created the [App Router](https://nextjs.org/docs/app). App Router still uses the concepts of pre-rendering and hydration, but it no longer uses `getStaticProps`, `getStaticPaths`, and `getServerSideProps`. It uses RSC and other great App Router features to implement better web applications. I recommend taking a look at App Router when you get a chance.
...
* GitHub Repo: [**https://github.com/salvillalon45/the-nextjs-pagesrouter-guide**](https://github.com/salvillalon45/the-nextjs-pagesrouter-guide)
...
* [**What is Hydration**](https://youtu.be/R-BKadZWYnQ?si=imNFJL36knSPdF7S)**?** by Builder
...
* [**How NextJS REALLY Works**](https://youtu.be/d2yNsZd5PMs?si=UZYKHUrajdXQd1y4&t=1) by Theo Browne
