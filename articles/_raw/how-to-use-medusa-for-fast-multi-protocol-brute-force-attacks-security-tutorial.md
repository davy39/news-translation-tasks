...
[Medusa](https://www.kali.org/tools/medusa/) is an open-source command-line tool designed for fast brute-force password cracking. It supports many protocols, such as FTP, SSH, HTTP, and others.
...
![Medusa help menu](https://cdn.hashnode.com/res/hashnode/image/upload/v1727713805524/86b3bfa0-de7e-470d-8482-310a3aa5f37a.png align="center")
...
Hope this tutorial helped you understand how to use Medusa. For more articles on Cybersecurity, join our free newsletter [Stealth Security](https://www.stealthsecurity.sh/). To work with Medusa and other tools using hands-on labs, check out our private community [The Hacker’s Hub](https://www.skool.com/hackershub).
