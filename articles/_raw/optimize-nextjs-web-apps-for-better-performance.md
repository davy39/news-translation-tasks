...
* [Building a Performant Application](#heading-building-a-performant-app)
    
* [How to Optimize Your Applications](#heading-how-to-optimize-your-applications)
    
* [Key Techniques To Optimize Performance](#heading-key-techniques-to-optimize-performance)
    
    * [Using The Next.js Image Component](#heading-1-using-the-nextjs-image-component)
        
    * [Optimizing Third-Party Scripts with the Next.js Script Component](#heading-2-optimizing-third-party-scripts-with-the-nextjs-script-component)
        
    * [Remove Unused Packages/Dependencies](#heading-3-remove-unused-packagesdependencies)
        
    * [Caching and Incremental Static Regeneration (ISR)](#heading-4-caching-and-incremental-static-regeneration-isr)
        
    * [Caching Frequently Used Content](#heading-caching-frequently-used-content)
        
    * [Font Optimization With next/font](#heading-5-font-optimization-with-nextfont)
        
    * [Lazy Loading And Code Splitting](#heading-6-lazy-loading-and-code-splitting)
        
    * [Lazy Loading in Next.js](#heading-lazy-loading-in-nextjs)
        
    * [Code Splitting](#heading-code-splitting)
...
![Example result of running npm run build](https://cdn.hashnode.com/res/hashnode/image/upload/v1734639730677/cfd1f858-a9df-4e6c-af28-454857309156.png align="center")

### Using `@next/bundle-analyzer`

The [bundle analyzer](https://www.npmjs.com/package/@next/bundle-analyzer) is a package provided by Next.js to analyze the size of JavaScript bundles by providing a visual representation of the application’s module and dependencies. Here’s how to use the package:
...
For a step-by-step guide on how to use the bundle analyzer effectively, check out this detailed [video tutorial](https://www.youtube.com/watch?v=EIGmcxwbbZw)
...
![image of the performance tab on chrome browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1735616911745/e5f09934-df99-40fc-b194-a292a21a4517.png align="center")
...
By leveraging the Next.js `Script` component, you can prevent scripts from blocking critical rendering, reducing load times and improve [Time to Interactive](https://developer.mozilla.org/en-US/docs/Glossary/Time_to_interactive) (TTI).
...
The [depcheck](https://www.npmjs.com/package/depcheck) tool is a great way to identify and remove unused dependencies from your project. It analyzes your `package.json` and the project files to find unused dependencies, unused devDependencies, and missing dependencies.
...
For a deeper dive into caching and its role in web performance, check out this insightful [freeCodeCamp article on Caching vs. Content Delivery Networks](https://www.freecodecamp.org/news/caching-vs-content-delivery-network/).
...
* [Next.Js Documentation](https://nextjs.org/docs/pages/building-your-application/optimizing)
    
* [Caching-vs-content-delivery-network](https://www.freecodecamp.org/news/caching-vs-content-delivery-network/)
    
* [Using next/bundle-analyzer](https://www.youtube.com/watch?v=EIGmcxwbbZw)
