...
1. [First, Why is Authentication So Important?](#heading-first-why-is-authentication-so-important)
    
2. [Symmetric Key Encryption](#heading-symmetric-key-encryption)
    
3. [Asymmetric Key Encryption](#heading-asymmetric-key-encryption)
    
4. [Cryptographic Hash Functions](#heading-cryptographic-hash-functions)
    
5. [Digital Signatures](#heading-digital-signatures)
    
6. [How SSH Authentication Works](#heading-how-ssh-authentication-works)
    
7. [Wrapping it All Up](#heading-wrapping-it-all-up)
...
One of the earliest methods, likely used by ancient Greek rulers and possibly later the Romans, involved using a cylindrical wooden rod called a [**Scytale**](https://en.wikipedia.org/wiki/Scytale).
...
![A scytale with leather strip wounded and a message written on it.](https://cdn.hashnode.com/res/hashnode/image/upload/v1734514827027/b4945c3a-64d4-458b-a410-f23b1a08d9ef.png align="center")
...
![Encryption with scytale as key.](https://cdn.hashnode.com/res/hashnode/image/upload/v1734519516607/75c926a3-faec-402a-8bcd-122039f47a01.png align="center")

The decryption process will look like this:

![Decryption with scytale as key.](https://cdn.hashnode.com/res/hashnode/image/upload/v1734519525487/de096889-332c-4482-b2df-b28ce609a8a6.png align="center")
...
![Public key can be shared with everyone. But the private key must be kept secret.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735200860039/7aca8ffa-c33a-44e5-ab1a-181492ebefd8.png align="center")
...
![Illustration of public and private key mathematically linked with each other.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735120077350/b90901c8-b55c-428a-8eb4-1b8ffa65fa06.png align="center")
...
![SHA-256 calculation of "freeCodeCamp.org"](https://cdn.hashnode.com/res/hashnode/image/upload/v1735030835833/201640c6-13b4-4b2b-9be3-88e245269bd1.png align="center")
...
![An illustration showing alice and bob's computers far away from each other and alice's bank account number.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735042150046/034d26c5-b33d-4b82-aeb8-173e47cd8e8e.png align="center")
...
![Process of digital signature generation.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735041977880/35313148-8820-42d7-b122-3ddf0cbaa723.png align="center")
...
![Process of signature verification.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735043216695/256f7707-3f40-433f-9b00-c11b27ef01e8.png align="center")
...
If you have not setup SSH authentication with GitHub, then after completing this article you can follow [GitHub’s detailed documentation on how to do it](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account). For now, please stay here till the end.
...
![Showing my public key from my terminal.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735035539565/1f837d9b-9717-44fa-a5e0-5801276113df.png align="center")

The above image shows my public key. I have this public key uploaded to my GitHub profile:

![Showing my GitHub profile settings where my public key is uploaded for SSH authentication with GitHub.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735035898284/1ef9133a-895b-4847-a7ac-6157fdcc3143.png align="center")
...
![The illustration of SSH authentication process between client and GitHub server.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735053545173/6fb293f1-f90a-4b64-b026-082d8676afae.png align="center")
...
![A xkcd comic depicting Cueball thinking to share his private key. A dangerous move!](https://cdn.hashnode.com/res/hashnode/image/upload/v1735120630613/e9a8bbba-3cc4-43e7-8369-865ab377fb87.png align="center")

The above image is from the popular [xkcd comic](https://xkcd.com/1553/). The character there (named Cueball) is thinking about revealing his private key. I hope now you know why it’s bad to reveal your private key.
...
I put useful ideas and resources on my Twitter. [**You should follow me there.**](https://twitter.com/vkwebdev) I will respect your time.
