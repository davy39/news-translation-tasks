...
* [Project Description](#heading-project-description)
    
* [Why Would I Need a Wheel of Names?](#heading-why-would-i-need-a-wheel-of-names)
    
* [The Plan for the App](#heading-the-plan-for-the-app)
    
    * [Application Features](#heading-application-features)
        
    * [The Tech Stack](#heading-the-tech-stack)
        
* [Let’s Build the App](#heading-lets-build-the-app)
    
    * [Project Structure](#heading-project-structure)
        
    * [How to Build the Components](#heading-how-to-build-the-components)
        
* [How to Deploy the App to Vercel](#heading-how-to-deploy-the-app-to-vercel)
...
![The wheel in Wheel of Fortune displaying the different dollar amounts/prizes contestants can get](https://cdn.hashnode.com/res/hashnode/image/upload/v1729622283461/8fde5307-eadd-4b4a-8f39-fe8e47478bd3.png align="center")
...
If you want to skip the reading, [here](https://github.com/mihailgaberov/Wheel-of-Names) 💁 is the GitHub repository with a detailed [README](https://github.com/mihailgaberov/Wheel-of-Names/blob/main/README.md) 🙌. [Here](https://wheel-of-names-three.vercel.app/) you can see the live demo.
...
![Wheel of Names app - initial empty state](https://cdn.hashnode.com/res/hashnode/image/upload/v1729578916704/0634a255-99a3-4a9c-8d64-6468cd732d40.png align="center")

![Wheel of Names app - adding question](https://cdn.hashnode.com/res/hashnode/image/upload/v1729578959007/33b8c9a5-73d0-4c61-bdad-1006107358a8.png align="center")

![Wheel of Names app - adding participants](https://cdn.hashnode.com/res/hashnode/image/upload/v1729578989621/fa954e01-52be-4e60-8a01-27a7a2b12a70.png align="center")
...
![Project Structure](https://cdn.hashnode.com/res/hashnode/image/upload/v1729579163492/2b406e15-c8f6-4533-9a93-4c6e7b1435f4.png align="center")
...
I used Vercel for this deployment because it offers a fast, free, and easy way to deploy web apps. If you'd like a more detailed guide on how to deploy with Vercel, check out my [previous tutorial](https://www.mihailgaberov.com/build-a-real-time-order-book-application-with-react-and-websockets) for step-by-step instructions.
