---
title: How to make your React app fully functional, fully reactive, and able to handle
  all those crazy…
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_Redux-cycles is both declarative and reactive_
...
_Two programmers after localizing side effectful code ([source](https://www.pexels.com/photo/sunset-beach-people-sunrise-40815/" rel="noopener" target="_blank" title="))_
...
_Checkout [Nick Balestra](http://nick.balestra.ch/talk/redux-cycles/" rel="noopener" target="_blank" title="">these redux-cycles slides</a> by <a href="undefined" rel="noopener" target="_blank" title=")_
...
_Drivers allow you to handle side effects in a pure way._
...
_Reactive loop between your app and the outside world_
...
_Redux-cycles is a combination of Redux and Cycle.js_
...
_How different drivers interact with each other_
...
_A marble diagram. Each arrow represents a stream. Each circle is a value emitted on that stream._
...
Special thanks to [Gosha Arinich](https://www.freecodecamp.org/news/how-to-make-your-react-app-fully-functional-fully-reactive-and-able-to-handle-all-those-crazy-e5da8e7dac10/undefined) and [Nick Balestra](https://www.freecodecamp.org/news/how-to-make-your-react-app-fully-functional-fully-reactive-and-able-to-handle-all-those-crazy-e5da8e7dac10/undefined) for maintaining the project along with myself, and to [Nick Johnstone](https://twitter.com/widdnz) for proof reading this article.
