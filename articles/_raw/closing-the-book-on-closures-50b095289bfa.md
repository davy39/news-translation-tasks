...
You’ll notice right away that our function, **sayGreeting,** returns another function. I can do this in JavaScript because functions are considered **_first-class,_** which means that they can be passed around just like other data types such as a number, string, or boolean. This can make for some interesting syntax:
...
If you guessed “Hello William”, you’re right. Go ahead and give yourself a pat on the back. Now, let’s take a closer look into _why._
...
You’ll see in the console that the variable **sayHello** is an anonymous function, and within its scope there is a C**losure** with a **name:value** pair,
