...
* [Python2 for loop documentation](https://docs.python.org/2.7/tutorial/controlflow.html#for-statements)
* [Python3 for loop documentation](https://docs.python.org/3/tutorial/controlflow.html#for-statements)
