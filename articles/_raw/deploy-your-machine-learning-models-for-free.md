---
title: How to Deploy a Machine Learning Model for Free – 7 ML Model Deployment Cloud
  Platforms
subtitle: ''
author: freeCodeCamp
co_authors: []
...
If you have been learning machine learning, you might have seen this challenge in online tutorials or books. You can find [the source code here](https://github.com/Davisy/Model-Deployment-by-using-Flask) if you are interested.
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/man-5723449_1920.jpg)
...
[Algorithmia](https://algorithmia.com/) is a MLOps (machine learning operations) tool founded by [Diego Oppenheimer](https://www.linkedin.com/in/doppenheimer/) and [Kenny Daniel](https://www.linkedin.com/in/kennydaniel) that provides a simple and faster way to deploy your machine learning model into production.

![Image](https://www.freecodecamp.org/news/content/images/2021/02/Algorithmia.png)
_Algorithmia_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/supported-programming-languages.PNG)
_Supported Programming languages_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/pythonAnywhere.PNG)
_PythonAnywhere_
...
* [How to deploy and host a Machine Learning model](https://medium.com/@kaustuv.kunal/how-to-deploy-and-host-machine-learning-model-de8cfe4de9c5)
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/1_H_nSB0PYTzIxnG9GhNU5vg.jpeg)
_Heroku_
...
The good thing about Heroku is that it makes it easy to create, deploy and manage your app. You can do this right from the command line using the [Heroku CLI](https://devcenter.heroku.com/articles/heroku-cli) (available for Windows, Linux, and Mac users).
...
* [Create and Deploy your First Flask App using Python and Heroku](https://www.kdnuggets.com/2020/09/flask-app-using-python-heroku.html)

> " As [VentureBeat](https://venturebeat.com/2019/07/19/why-do-87-of-data-science-projects-never-make-it-into-production/) reports, around 90 percent of machine learning models never make it into production. In other words, only one in ten of a data scientist’s workdays actually end up producing something useful for the company." - Rhea Moutafis
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/gcp.png)
_Google Cloud_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/google-AI-platform.png)
_Google Cloud AI Platform services_
...
To learn more about the Google AI platform, you can check the platform's website [here](https://cloud.google.com/ai-platform).
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/appengine.png)
_Google App Engine_
...
To learn more about it, you can visit the platform [here](https://cloud.google.com/appengine).
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/1_MeXs5Ot8X49Fn1vE_13ukA.png)
_Google Cloud Functions_

All functions created and hosted on Google Cloud Functions will be executed in the cloud when needed. You can call cloud functions to your application by using different [triggers](https://cloud.google.com/functions/docs/calling). The most common way is using HTTP calls.
...
* [How to Go from Zero to Hero with Google Cloud Platform](https://www.freecodecamp.org/news/google-cloud-platform-from-zero-to-hero/)
* [How to Deploy Fast.ai models to Google Cloud Functions for Predictions](https://jianjye.medium.com/how-to-deploy-fast-ai-models-to-google-cloud-functions-for-predictions-e3d73d71546b)
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/1_I39WMuYsU_2BgGAgAePCuw.png)
_Microsoft Azure Functions_

> "You focus on the pieces of code that matter most to you, and Azure Functions handles the rest." [Azure function page](https://docs.microsoft.com/en-us/azure/azure-functions/?WT.mc_id=ignite-event-toanglin).
...
* [Azure Functions for ML](https://medium.com/microsoftazure/azure-functions-for-ml-4440bee58621)
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/1_w3p_NfmQOrnGEN39pTC38g.jpeg)
_AWS Lambda_
...
![Image](https://www.freecodecamp.org/news/content/images/2021/02/aws-lambda-how-it-works.png)
_How AWS Lambda Deployment works_
...
* [Lessons from deploying machine learning models on AWS Lambda](https://www.freecodecamp.org/news/what-we-learned-by-serving-machine-learning-models-using-aws-lambda-c70b303404a1/)
* [Deploying machine learning models as serverless APIs](https://aws.amazon.com/blogs/machine-learning/deploying-machine-learning-models-as-serverless-apis/)
...
Yes, you can convert your model by using the [m2cgen](https://github.com/BayesWitnesses/m2cgen) Python library developed by [Bayes' Witnesses](https://github.com/BayesWitnesses). m2cgen (Model 2 Code Generator) is a simple Python library that converts a trained machine learning model into different programming languages
...
To learn more about this library, I recommend that you read my [read my guide to mc2gen here](https://www.freecodecamp.org/news/transform-machine-learning-models-into-native-code-with-zero-dependencies/). I explained how to use the library and then convert a trained machine learning model into three different programming languages and then make a prediction.
...
If you learned something new or enjoyed reading this article, please share it so that others can see it. Until then, see you in the next post! You can also find me on Twitter [@Davis_McDavid](https://twitter.com/Davis_McDavid).
