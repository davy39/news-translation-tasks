---
title: React Hooks for Beginners – Learn to Use the useState Hook in 10 Minutes
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_values are functions, and functions are values_
...
_The Anatomy of the useState hook_
...
_Dogs and Cats Counter (Handling Multiple State Variables)_
...
_State is asynchronous (it's batched and updated with a delay)_
...
_Mutating state in a functional way_
