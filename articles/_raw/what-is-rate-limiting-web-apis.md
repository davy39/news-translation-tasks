---
title: What is Rate Limiting? Exploring the Role of Rate Limiting in Protecting Web
  APIs from Attacks
subtitle: ''
author: Oluwatobi
co_authors: []
...
1. [What is Rate Limitin](#heading-what-is-rate-limiting)[g?](#heading-what-is-rate-limiting)
    
2. [Importance of Rate Limiting](#heading-importance-of-rate-limiting)
    
3. [Adoption and Usage of Rate-Limiting by Popular Sites](#heading-adoption-and-usage-of-rate-limiting-by-popular-sites)
    
4. [Other Real life Use-cases of API Rate Limiting](#heading-other-real-life-use-cases-of-api-rate-limiting)
    
5. [How Does Rate Limiting Work?](#heading-how-does-rate-limiting-work)
    
6. [Examples of Rate Limiting Algorithms](#heading-examples-of-rate-limiting-algorithms)
    
7. [Rate Limiting Best Practices](#heading-rate-limiting-best-practices)
