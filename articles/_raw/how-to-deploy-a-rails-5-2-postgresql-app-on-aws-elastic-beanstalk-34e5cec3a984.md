---
title: How to deploy a Rails 5.2 PostgreSQL app on AWS Elastic Beanstalk
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
It’s official, using [Heroku](https://heroku.com/) for all my Rails projects so far has spoiled me rotten. After receiving some AWS credits thanks to a pitch competition, I decided to deploy my latest project on [Elastic Beanstalk](https://aws.amazon.com/elasticbeanstalk/) ([AWS](https://aws.amazon.com/)’ Heroku competitor). All I have to say is that I miss Heroku.
...
We will use the terminal in this tutorial. Let’s begin with installing the “Elastic Beanstalk Command Line Interface.” Here is how to do it on macOS using [Homebrew](https://brew.sh/):
...
Then the EB CLI will ask you a few questions to initialize the Elastic Beanstalk application. The initialization part is straightforward. If you get stuck anywhere you can check out the [“Configure the EB CLI”](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-configuration.html) page from the documentation.
...
If you like this article, [follow me on Twitter](https://twitter.com/evrimfeyyaz) or [sign up to my newsletter](https://evrim.us12.list-manage.com/subscribe/post?u=7d6b207df0db42f6bfcff3322&id=70b8425aa4) to get notified when I write new articles. I write about software and startups.
...
_Originally published at [evrim.io](https://evrim.io/deploying-a-rails-52-postgresql-app-on-aws-elastic-beanstalk/) on November 28, 2018._
