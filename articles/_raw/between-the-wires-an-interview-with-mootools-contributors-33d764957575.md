...
_Sebastian Markbåge (left), Christoph Pojer (middle), Tom Occhino (right)_
...
_Tom (left) and Valerio (right), the original author of the MooTools library_
