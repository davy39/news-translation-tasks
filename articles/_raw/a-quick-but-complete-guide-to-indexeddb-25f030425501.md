...
> Interested in learning JavaScript? Get my JavaScript ebook at [jshandbook.com](https://jshandbook.com/)
...
- [**Cookies**](https://flaviocopes.com/cookies/): can host a very small amount of strings
- [**Web Storage**](https://flaviocopes.com/web-storage-api/) (or DOM Storage), a term that commonly identifies localStorage and  sessionStorage, two key/value stores. sessionStorage, does not retain data, which is cleared when the session ends, while localStorage keeps the data across sessions
...
Since the advent of [Promises](https://flaviocopes.com/javascript-promises) in ES6, and the subsequent move of APIs to using promises, the IndexedDB API seems a bit _old school_.
...
> Interested in learning JavaScript? Get my JavaScript book at [jshandbook.com](https://jshandbook.com/)
