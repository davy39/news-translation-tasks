...
* [CSS Grid Architecture](#heading-css-grid-architecture)
* [CSS Grid Chart](#heading-css-grid-chart)
* [Grid Parent Properties](#heading-css-grid-parent-properties)
   * [grid-template-columns](#heading-the-grid-template-columns-property)
   * [grid-template-rows](#heading-the-grid-template-rows-property)
   * [grid-template-areas](#heading-the-grid-template-areas-property-1)
   * [How to create column and row gaps in Grid](#heading-the-column-gap-property)
   * [How to justify items and align items with Grid](#heading-the-justify-items-property)
   * [How to justify content and align-content with Grid](#heading-the-justify-content-property)
* [Child Properties in CSS Grid](#heading-css-grid-child-properties)
   * [grid-column : start/end](#heading-the-grid-column-startend-properties)
   * [grid-row : start/end](#heading-the-grid-row-startend-properties)
   * [grid-area](#heading-the-grid-area-property)
   * [justify-self || align-self](#heading-the-justify-self-property)
* [Shorthand for Grid](#heading-shorthand-for-css-grid-properties)
...
By the way, here's a CheatSheet I made for [Flexbox](https://www.freecodecamp.org/news/css-flexbox-tutorial-with-cheatsheet/) if you want to learn more about that.
...
_Grid column &amp; row -&gt; start &amp; end points_
...
First, we need to set up [grid-template-areas](#heading-the-grid-template-areas-property-1) ☝️ Once we've done that, we have to specify the names used in parent class inside the children classes, like this:👇
...
* [Unicorns](https://www.flaticon.com/packs/unicorn-4)
