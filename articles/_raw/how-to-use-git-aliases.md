...
There are 2 types of aliases: [Git aliases](https://git-scm.com/book/en/v2/Git-Basics-Git-Aliases) and shell aliases, controlled by bash, zsh, etc. Let's start with Git aliases.
...
Aliases live in the section `[alias]`. They are available in your terminal as Git options the same way `add`, `commit` and other options work. Let's see how to add an alias, step-by-step:
...
![git graph example in the Tailwind CSS repository](https://leonardofaria.net/wp-content/uploads/2020/10/git-graph.jpg)
...
![git ll example in the Tailwind CSS repository](https://leonardofaria.net/wp-content/uploads/2020/10/git-ll.jpg)
...
You can read more articles like this on [my blog](https://leonardofaria.net). If you like this content, you can follow me on [Twitter](https://twitter.com/leozera) and [GitHub](https://github.com/leonardofaria). 

Cover photo by [Yancy Min/Unsplash](https://unsplash.com/photos/842ofHC6MaI)
