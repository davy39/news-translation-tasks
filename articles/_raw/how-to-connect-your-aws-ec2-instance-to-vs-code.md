...
If you need a basic introduction to cloud computing, here’s a beginner-friendly tutorial for you: [**What is Cloud Computing? A Guide for Beginners.**](https://www.freecodecamp.org/news/cloud-computing-guide-for-beginners/)
...
* [What is an AWS EC2 Instance?](#heading-what-is-an-aws-ec2-instance)
    
* [Why Connect Your AWS EC2 Instance to VS Code?](#heading-why-connect-your-aws-ec2-instance-to-vs-code)
    
* [How to Launch and Connect Your AWS EC2 Instance to VS Code](#heading-how-to-launch-and-connect-your-aws-ec2-instance-to-vs-code)
    
    * [Step 1: Create an AWS EC2 Instance](#heading-step-1-create-an-aws-ec2-instance)
        
    * [Step 2: Connect the AWS EC2 Instance to Your Code Editor](#heading-step-2-connect-the-aws-ec2-instance-to-your-code-editor)
        
    * [Step 3: Install the Programming Language](#heading-step-3-install-the-programming-language)
        
    * [Step 4: Open a Remote Window](#heading-open-a-remote-window)
        
    * [Step 5: Access Your Project Folder](#heading-step-5-access-your-project-folder)
...
![Searching for EC2 on AWS Console](https://cdn.hashnode.com/res/hashnode/image/upload/v1736016609765/f784db8e-46cc-4e03-abc0-7bdea9b1c668.png align="center")
...
![creating an EC2 instance](https://cdn.hashnode.com/res/hashnode/image/upload/v1736174305817/e8d9d8dd-f09d-4bca-a838-42ee55607fa5.gif align="center")

Launched instance running:

![Launched Instance](https://cdn.hashnode.com/res/hashnode/image/upload/v1736174700999/b729de98-bd8f-496f-9486-3079d87fb4de.png align="center")
...
![pasting the command on the terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1736021541861/048a9411-2348-48dc-8a6e-04d51dbd347d.png align="center")

Running this command above updates the file permissions. So with this, you can work with your remote server.

![the output of the command pasted](https://cdn.hashnode.com/res/hashnode/image/upload/v1736021649692/118c75cf-30b4-474c-b726-142c2b4326e9.png align="left")
...
![connecting via ssh](https://cdn.hashnode.com/res/hashnode/image/upload/v1742153348953/a68f32fc-7578-4904-9b2e-e63a353e84a0.gif align="center")
...
![Installing the template](https://cdn.hashnode.com/res/hashnode/image/upload/v1742122446716/7c51b3a2-6a8c-463d-817c-9630488a803d.png align="center")
...
![double arrow at the left](https://cdn.hashnode.com/res/hashnode/image/upload/v1736073016500/cb3a4d44-3ae5-4ccb-9006-c592c0be30f7.png align="center")

When you click on it, it opens a modal window for you.

![connect to the host](https://cdn.hashnode.com/res/hashnode/image/upload/v1736073334686/a24d115c-9da3-4b46-80be-a75d73a189ab.gif align="center")
...
![adding ssh host](https://cdn.hashnode.com/res/hashnode/image/upload/v1736073802080/45dbc209-0b4c-41a2-83eb-3fa05a8eff20.gif align="center")

Input your SSH command to configure the host.

![image of SSH connection command](https://cdn.hashnode.com/res/hashnode/image/upload/v1736078262849/b09d017e-cbd3-476e-9641-63dc41e34d83.png align="center")
...
![place to press for the configuration file](https://cdn.hashnode.com/res/hashnode/image/upload/v1736083806867/e158ee79-67d3-41c8-bb63-870caab0033b.png align="center")

Here’s a GIF view of the image above:

![a gif view of how to open your configuration file](https://cdn.hashnode.com/res/hashnode/image/upload/v1736083586490/7520a325-376d-42a8-905d-2e22770498de.gif align="center")

Here’s the configuration file:

![config file](https://cdn.hashnode.com/res/hashnode/image/upload/v1736084278100/6e71324f-6b47-4a2a-b7a1-89c1be10c39b.png align="center")

Go back to your editor and click on that double arrow again. This will automatically open a new window.

![Re-opening a new window](https://cdn.hashnode.com/res/hashnode/image/upload/v1736086002267/53e4edd8-afe2-4652-90ab-56bc90f80405.gif align="center")

If your editor displays the IPv4 DNS address, your VS Code is successfully connected to the EC2 instance.

![connection to the remote server](https://cdn.hashnode.com/res/hashnode/image/upload/v1736086479299/e399f86c-e236-4efc-8d4d-a7055139d01e.png align="left")
...
![access remote folder](https://cdn.hashnode.com/res/hashnode/image/upload/v1736087503207/7fb21fcb-939e-4f17-83d2-93a6e0e3ee68.png align="center")

Clicking on this button opens a modal box for you to select your folder, which was created by the Maven template:

![accessing the folder](https://cdn.hashnode.com/res/hashnode/image/upload/v1742134089654/77104e69-4c7a-4b59-812d-423167079f24.gif align="center")

To access the template file, click the “src” folder. This takes you to the `index.jsp` file.

![template automatically created for you](https://cdn.hashnode.com/res/hashnode/image/upload/v1742135158716/4cfedc15-1c2e-4d60-b9f6-fe04c300dfa0.png align="left")
