---
title: What is Debugging? How to Debug Your Code for Beginners
subtitle: ''
author: German Cocca
co_authors: []
series: null
...
* [How Debugging Started](#heading-how-debugging-started)
    
* [Why Should You Learn About Debugging?](#heading-why-should-you-learn-about-debugging)
    
* [How to Debug Your Code](#heading-how-to-debug-your-code)
    
* [How to Get in a Debugging Mindset](#heading-how-to-get-in-a-debugging-mindset)
    
    * [Pay Attention to Error Messages](#heading-pay-attention-to-error-messages)
        
    * [Google Things](#heading-google-things)
        
    * [Explain Your Logic to Another Person or a Duck](#heading-explain-your-logic-to-another-person-or-a-duck)
        
    * [Narrow Down Your Problem and Understand Where the Error is Generated](#narrowdownyourproblemandunderstandwheretheerrorisgenerated)
        
    * [Take a Break and Think about Something Else](#heading-take-a-break-and-think-about-something-else)
        
    * [Look for Help](#heading-look-for-help)
        
    * [Make Sure the Bug is Dead](#heading-make-sure-the-bug-is-dead)
        
    * [Write Clean Code](#heading-write-clean-code)
        
        * [Write DRY code](#heading-write-dry-code)
            
        * [Write simple code when possible](#heading-write-simple-code-when-possible)
            
        * [Use the SOLID principles](#heading-use-the-solid-principles)
            
* [Technical Debugging Tools](#heading-technical-debugging-tools)
    
    * [How TypeScript Helps Write Clean Code](#heading-how-typescript-helps-write-clean-code)
        
    * [How to Use Console.log to Debug Code](#heading-how-to-use-consolelog-to-debug-code)
        
    * [How to Use Visual Studio Debugger](#heading-how-to-use-visual-studio-debugger)
        
    * [Chrome Debugger](#heading-chrome-debugger)
...
The words "*bug*" and "*debugging*" in software are popularly attributed to [Admiral Grace Hopper](https://es.wikipedia.org/wiki/Grace_Murray_Hopper). A true legend, she wrote the first compiler that ever existed.
