...
> **_Note:_** _Hooks are functions that let you “hook into” React state and lifecycle features from function components. **Hooks don’t work inside React classes** — they let you use React without classes._
...
[_A JavaScript library for building user interfaces_reactjs.org](https://reactjs.org/docs/hooks-overview.html)
