...
* [A Supabase project](https://supabase.com/) to follow along.
...
_A flowchart depicting the user authentication process_
...
_A sequence diagram showing session management in a client-server architecture_
...
* Using standard authentication frameworks like OAuth 2.0.

There are certain compliances that your system should consider when handling sensitive user data beyond specific authentication information. This is even more so if operating in certain countries or handling enterprise applications. These compliances include:
...
The first step is to set up your [Supabase project](https://app.supabase.com/)'s auth settings. You can enable the exact authentication methods you want to use via the settings. There are three ways you can start using Supabase auth in your project:
...
* [An indepth explanation of OAuth](https://www.upguard.com/blog/oauth#:~:text=OAuth%201.0%20has%20a%20consumer,resource%20server%2C%20and%20resource%20owner.)
* [Supabase security](https://supabase.com/security)
* [Supabase docs on authentication](https://supabase.com/docs/guides/auth)
* [Auth UI docs page](https://supabase.com/docs/guides/auth/auth-helpers/auth-ui)
* [Supabase on auth helpers and SSR](https://supabase.com/docs/guides/auth/auth-helpers)
* [On SSO, SAML and enterprise auth](https://supabase.com/docs/guides/auth/sso/auth-sso-saml)
