...
1. [Project Overview](#heading-project-overview)
    
2. [Project Setup](#heading-project-setup)
    
3. [API Keys: Storage and Retrieval](#heading-api-keys-storage-and-retrieval)
    
4. [How to Make Your First API Call](#heading-how-to-make-your-first-api-call)
    
5. [How to Build the Shiny App](#heading-how-to-build-the-shiny-app)
...
![The R Shiny weather app demo](https://cdn.hashnode.com/res/hashnode/image/upload/v1733341336823/dd605385-5531-43c5-924d-dde24b38846b.gif align="center")
...
![Weather Update API Flow](https://cdn.hashnode.com/res/hashnode/image/upload/v1733172415724/c4f884f6-b583-4f13-b0f8-eb564ab6531f.png align="center")
...
![project folder structure](https://cdn.hashnode.com/res/hashnode/image/upload/v1733166096334/93e004da-4449-4cb4-8ddd-d3082e5687d8.png align="center")
...
![A sample response to the geocoding API](https://cdn.hashnode.com/res/hashnode/image/upload/v1733342454801/feed01b2-a7a1-4c69-8297-2dcfdc8ec39f.png align="center")
...
![semantic page layout demo](https://cdn.hashnode.com/res/hashnode/image/upload/v1733137762676/12d5695c-2ed7-4606-8267-44243c2bee57.png align="center")
...
You can find the complete code for the project [here](https://github.com/elabongaatuo/R-weather-app).
