...
2. The far stage  
When the forest is the furthest possible, it has the `Light Mountains` color and `0 alpha`  
 As it’s moving closer, it emerges by increasing `alpha` up to `depth == 1.0`
