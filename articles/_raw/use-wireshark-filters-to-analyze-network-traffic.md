...
* [How to Start Wireshark and Analyze Network Traffic](#heading-how-to-start-wireshark-and-analyze-network-traffic)
    
* [How to Work with Network Capture Files](#heading-how-to-work-with-network-capture-files)
    
* [Understanding the Wireshark Interface](#heading-understanding-the-wireshark-interface)
    
* [Understanding and Applying Basic Display Filters](#heading-understanding-and-applying-basic-display-filters)
    
* [Advanced Filtering Techniques](#heading-advanced-filtering-techniques)
    
* [Analyzing Security-Related Traffic](#heading-analyzing-security-related-traffic)
    
* [Analyzing Sample Traffic and Generating New Traffic](#heading-analyzing-sample-traffic-and-generating-new-traffic)
    

## **Prerequisites**

Before we start, you'll need to know **Linux Basic Syntax.** You can learn it through this [Linux Skill Tree](https://labex.io/skilltrees/linux).

Don't worry if you're new to [**Wireshark**](https://labex.io/skilltrees/wireshark) – I’ll explain everything as we go.
...
![Wireshark Main Interface Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385586635/78f76c20-c8d0-48d2-bdb7-17ff3f5fc261.png align="center")
...
![Wireshark Open File Screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385612148/dbeb3d39-db15-4363-a499-e8b527b43d84.png align="center")
...
![Wireshark Interface](https://cdn.hashnode.com/res/hashnode/image/upload/v1743386808927/2225da6c-a652-4886-bd7d-f3c94586c688.jpeg align="center")
...
![Wireshark Filter Toolbar Location](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385642595/018e9680-1c29-4168-9d60-975464722447.png align="center")
...
![Wireshark HTTP Filter Output](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385678124/1dff7e49-13c5-439e-aeca-82b461b8727b.png align="center")
...
![Wireshark IP Address Filter Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385707141/8719b584-9498-4ecb-bf67-d354906626e0.png align="center")
...
![Example of combined filter in Wireshark](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385736030/8230d965-e822-4341-afa5-35239fbb6975.png align="center")
...
![Wireshark HTTP Host Filter](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385773497/36b7bc2e-b7e9-4b68-9dc7-82e429c5ea01.png align="center")
...
![Wireshark Password Filter Example](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385793822/024b4482-0b5d-4b20-985c-6263bd7f48d6.png align="center")
...
![Wireshark Clear-Text Cred Filter](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385832534/4c38654f-8ff0-4bc3-8bc6-0dd1161dc0f1.png align="center")
...
![Wireshark HTTP User Agent Filter](https://cdn.hashnode.com/res/hashnode/image/upload/v1743385858895/3feb916b-39ac-4ced-ab76-8597186cbbf0.png align="center")
...
> To practice the operations from this tutorial, try the interactive hands-on lab: [Analyze Network Traffic with Wireshark Display Filters](https://labex.io/labs/wireshark-analyze-network-traffic-with-wireshark-display-filters-415944?course=quick-start-with-wireshark)
