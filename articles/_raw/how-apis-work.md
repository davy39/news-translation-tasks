...
![Unsplash search example](https://www.freecodecamp.org/news/content/images/2022/12/unsplash-1.png)
...
If you want to learn more about how to design APIs, [here's a full book for you to get started](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/).

And you can learn more about [types of APIs, testing tools, and documentation here](https://www.freecodecamp.org/news/what-is-an-api-and-how-to-test-it/).

Here's a tutorial that'll [teach you all about REST APIs](https://www.freecodecamp.org/news/rest-api-tutorial-rest-client-rest-service-and-api-calls-explained-with-code-examples/).

And here's a [Fetch API cheatsheet](https://www.freecodecamp.org/news/fetch-api-cheatsheet/) to get you started learning about Fetch.
