---
title: How to Build a QR Code Generator for URLs with Node.js, Next.js, and Azure
  Blob Storage
subtitle: ''
...
Before you begin you'll need an active [Azure](https://azure.microsoft.com/en-us/get-started/azure-portal) account and subscription to create an Azure blob storage.

## **Table of Contents**

1. [What is a QR Code](#heading-what-is-a-qr-code)?
    
2. [How to Set Up Azure Blob Storage](#heading-how-to-set-up-azure-blob-storage)
    
3. [Node.js QR Code](#heading-nodejs-qr-code)
    
4. [Code Overview](#code-overwiew)
    
5. [How to Connect the Frontend Application](#heading-how-to-connect-the-frontend-application)
    
6. [Next.js Code Walkthrough](#heading-nextjs-code-walkthrough)
    
7. [How to Start the Application Locally](#heading-how-to-start-the-application-locally)
...
According to [Investopedia](https://www.investopedia.com/terms/q/quick-response-qr-code.asp), a Quick Response (QR) code functions as a specialized barcode, scannable by digital devices, that stores data within a grid of square pixels.
...
[Azure Blob Storage](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-blobs-overview) is a cloud-based storage service provided by Microsoft Azure. It is part of the Azure Storage suite, which also includes services such as Azure Files, Azure Queues, and Azure Tables.
...
First, you need to install `Node.js` and `npm` on your computer. Go to the [Node.js](https://nodejs.org/) website and download the version for your computer if you don't have it already.
...
Next, go to this GitHub [link](https://github.com/ayowilfred95/azure-qr-code-generator.git) to fork the project and then clone it to your preferred directory on your computer.

![Image](https://www.freecodecamp.org/news/content/images/2024/05/Screenshot-2024-05-07-at-17.26.39--2-.jpeg align="left")

*Github Repository Project*

Once you've cloned the project repository, open the project with your code editor. I'm using [VS Code](https://code.visualstudio.com/download). You'll notice that the project has of two folders: `server` and `frontend`. You'll start by navigating to the `server` folder by typing `cd server` in your terminal and then press `Enter`.
...
* It sends a POST request to the server (`http://localhost:8000/generate-qr`) with the input URL using the [Axios](https://axios-http.com/docs/intro) library.
...
To start the application, simply run `npm run dev` as shown below. If all goes well, you'll observe the message [`http://localhost:3000`](http://localhost:3000) printed in your console.

![Image](https://www.freecodecamp.org/news/content/images/2024/05/Screenshot-2024-05-08-at-15.18.18.png align="left")

*Application ready to start*

Open your browser and paste the URL [`http://localhost:3000`](http://localhost:3000). The browser should render the application and look exactly as shown below.

![Image](https://www.freecodecamp.org/news/content/images/2024/05/Screenshot-2024-05-09-at-11.32.04.png align="left")

*Application running in Browser*

Paste in the URL of a website – either your portfolio website or any website you wish to generate a QR code for. I pasted my portfolio website URL, [`https://wilfred-portfolio.vercel.app/`](https://wilfred-portfolio.vercel.app/), into the URL box. See the result below:
