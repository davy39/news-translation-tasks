...
1. [What is Traceloop?](#heading-what-is-traceloop)
    
2. [How Traceloop Works](#heading-how-traceloop-works)
    
3. [How to Set Up Traceloop](#heading-how-to-set-up-traceloop)
    
4. [Your First Trace: Hands-On Tutorial](#heading-your-first-trace-hands-on-tutorial)
    
5. [Step-by-Step Debugging Walkthrough](#heading-step-by-step-debugging-walkthrough)
    
6. [Real-World Debugging Scenarios](#heading-real-world-debugging-scenarios)
    
7. [Best Practices](#heading-best-practices)
...
Before we can start tracing system calls, we need to set up Traceloop in your Kubernetes environment. Traceloop is part of the [Inspektor Gadget](https://inspektor-gadget.io/) ecosystem, which provides flexibility in how you use it.
...
Alternatively, you can also deploy using [Helm](https://inspektor-gadget.io/docs/v0.43.0/reference/install-kubernetes/#installation-with-the-helm-chart).
...
* **SYSCALL**: The actual system call made (openat, write, exit\_group)
...
**PS:** Have any questions about Traceloop or want to share your debugging challenges? The Inspektor Gadget team and community hang out in the [#inspektor-gadget](https://kubernetes.slack.com/archives/CSYL75LF6) channel on Kubernetes Slack. It's a great place to get help from the engineers who built these tools, share experiences, and maybe even contribute to making the ecosystem even better.  
  
You can also connect with me on [LinkedIn](https://www.linkedin.com/in/emidowojo/) if you’d like to stay in touch. If you made it to the end of this tutorial, thanks for reading!
