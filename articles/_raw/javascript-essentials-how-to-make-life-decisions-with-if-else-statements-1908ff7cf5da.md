...
1. Greater than (`&`gt;) or greater or equal t`o` (>=)
2. Smaller than (`&`lt;) or smaller or equal t`o` (<=)
...
(Oh, by the way, if you liked this article, I’d appreciate it if you could [share it](http://twitter.com/share?text=What%20determines%20if%20a%20condition%20is%20true%20or%20false%3F%0A%0A1.%20comparison%20operators.%0A2.%20Truthy%2Ffalsy%20values%0A%0ABy%20%40zellwk%20?%20&url=https://zellwk.com/blog/js-if-else/&hashtags=). ?)

_Originally published at [zellwk.com](https://zellwk.com/blog/js-if-else/)._
