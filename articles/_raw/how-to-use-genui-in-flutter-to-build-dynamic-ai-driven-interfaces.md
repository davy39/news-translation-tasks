...
3. [Mapping GenUI Components to the Christmas Card App](#heading-mapping-genui-components-to-the-christmas-card-app)
    ...
    * [1\. GenUiConversation in the Christmas Card App](#heading-1-genuiconversation-in-the-christmas-card-app)
        
    * [2\. Catalog as the Design Constraint](#heading-2-catalog-as-the-design-constraint)
        
    * [3\. DataModel as the Heart of Personalization](#heading-3-datamodel-as-the-heart-of-personalization)
        
    * [4\. ContentGenerator as the AI Gateway](#heading-4-contentgenerator-as-the-ai-gateway)
        
    * [5\. A2uiMessage as Intent, Not UI](#heading-5-a2uimessage-as-intent-not-ui)
        
4. [Why This Architecture Works](#heading-why-this-architecture-works)
    
5. [Project Overview: What We’re Building](#heading-project-overview-what-were-building)
    
6. [Project Structure](#heading-project-structure)
    
    * [Step 1: Create a New Flutter Project](#heading-step-1-create-a-new-flutter-project)
        
    * [Step 2: Configure Your Agent Provider](#heading-step-2-configure-your-agent-provider)
        
    * [Step 3: Add Dependencies](#heading-step-3-add-dependencies)
        
    * [Step 4: Get a Google Gemini API Key](#heading-step-4-get-a-google-gemini-api-key)
        
    * [Step 5: App Entry Point (main.dart)](#heading-step-5-app-entry-point-maindart)
        
    * [The Root App Widget](#heading-the-root-app-widget)
        
    * [Step 6: The Logic Controller (Stateful Screen)](#heading-step-6-the-logic-controller-stateful-screen)
        
    * [Step 7: Initializing GenUI and Firebase](#heading-step-7-initializing-genui-and-firebase)
        
    * [Step: 8 Sending a Dynamic Prompt to the AI](#heading-step-8-sending-a-dynamic-prompt-to-the-ai)
        
7. [Building the View](#heading-building-the-view)
    
    * [Folder: lib/screen/data/](#heading-folder-libscreendata)
        
    * [Folder: lib/extensions/](#heading-folder-libextensions)
        
    * [Folder: lib/screen/components/](#heading-folder-libscreencomponents)
        
8. [Adding Your Own Widgets to the GenUI Catalog](#heading-adding-your-own-widgets-to-the-genui-catalog)
    
    * [Why Add a Custom Widget?](#heading-why-add-a-custom-widget)
        
    * [Step 1: Adding json\_schema\_builder](#heading-step-1-adding-jsonschemabuilder)
        
    * [Step 2: Defining the Holiday Card Schema](#heading-step-2-defining-the-holiday-card-schema)
        
    * [Step 3: Creating the CatalogItem](#heading-step-3-creating-the-catalogitem)
        
    * [Step 4: Registering the Widget in Your App](#heading-step-4-registering-the-widget-in-your-app)
        
    * [Step 5: Teaching the AI to Use the Widget](#heading-step-5-teaching-the-ai-to-use-the-widget)
        
    * [How This Fits into Your Existing Screen](#heading-how-this-fits-into-your-existing-screen)
...
3. **Google AI Studio API key:** We will be using Google's Gemini model. You’ll need to get a free API key from [Google AI Studio](https://aistudio.google.com/).
...
2. [Enable the Gemini API](https://firebase.google.com/docs/gemini-in-firebase/set-up-gemini) for that pro[j](https://pub.dev/packages/genui#2-configure-your-agent-provider)ect.
    
3. Follow the first three steps in [Firebase's Flutter Setup](https://firebase.google.com/docs/flutter/setup) to add Firebase to your app.
...
![App Screenshot 1 - Entry](https://cdn.hashnode.com/res/hashnode/image/upload/v1766152202325/f14bf403-1b72-4e71-b6de-e0966cd51da2.png align="center")

![App Screenshot 2 - Error State](https://cdn.hashnode.com/res/hashnode/image/upload/v1766155136764/bd14dd42-43cd-4897-a881-274376258935.png align="center")

![App Screenshot 3 - Color Choosing](https://cdn.hashnode.com/res/hashnode/image/upload/v1766152181735/adc30203-f4ce-4228-9d52-4edc15c62731.png align="center")

![App Screenshot 4 - Loading State](https://cdn.hashnode.com/res/hashnode/image/upload/v1766157240628/e31a49db-4143-4e70-9d69-e63a81e722d0.png align="center")

![App Screenshot 1 - Successfuly showing the christmas card](https://cdn.hashnode.com/res/hashnode/image/upload/v1766157250344/64938d48-e73f-405f-8050-c20dfc6ecd6a.png align="center")
...
As an early adopter, you are on the cutting edge of AI-Generated User Interfaces. Your explorations and feedback will help shape the future of how we build apps in the era of generative intelligence. You can find the [complete project on Github here](https://github.com/Atuoha/christmas-card-genui-flutter).

## References

1. Flutter Team. *GenUI: Build AI-powered user interfaces in Flutter*. GitHub repository.  
    Available at: [https://github.com/flutter/genui/](https://github.com/flutter/genui/)
    
2. Flutter Documentation. *Getting started with GenUI*.  
    Available at: [https://docs.flutter.dev/ai/genui/get-started](https://docs.flutter.dev/ai/genui/get-started)
    
3. Dart & Flutter Ecosystem. *genui package*. pub.dev.  
    Available at: [https://pub.dev/packages/genui](https://pub.dev/packages/genui)
    
4. Dart & Flutter Ecosystem. *genui\_firebase\_ai package*. pub.dev.  
    Available at: [https://pub.dev/packages/genui\_firebase\_ai](https://pub.dev/packages/genui_firebase_ai)
