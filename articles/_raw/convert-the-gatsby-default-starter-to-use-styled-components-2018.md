---
title: Convert the Gatsby default starter to use styled-components
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
In this example we're going to use the Gatsby default starter you get with [CodeSandbox](https://codesandbox.io) and add in styled-components, so first up, open a [new CodeSandbox](https://codesandbox.io/s/) and select Gatsby from the SERVER TEMPLATES.
