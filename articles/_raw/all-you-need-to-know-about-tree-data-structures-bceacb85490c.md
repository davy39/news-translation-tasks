...
_A company’s structure is an example of a hierarchy_
...
* **DFS** “is an algorithm for traversing or searching tree data structure. One starts at the root and explores as far as possible along each branch before backtracking.” _— [Wikipedia](https://en.wikipedia.org/wiki/Depth-first_search)_
* **BFS** “is an algorithm for traversing or searching tree data structure. It starts at the tree root and explores the neighbor nodes first, before moving to the next level neighbors.” _— [Wikipedia](https://en.wikipedia.org/wiki/Breadth-first_search)_
...
* [Binary Tree Implementation](https://github.com/leandrotk/algorithms/blob/master/computer_science/data_structures/binary_tree/binary_tree.py) and [Tests](https://github.com/leandrotk/algorithms/blob/master/computer_science/data_structures/binary_tree/test_binary_tree.py) by [**TK**](https://www.freecodecamp.org/news/all-you-need-to-know-about-tree-data-structures-bceacb85490c/undefined)
...
* [Binary Search Tree](http://www.algolist.net/Data_structures/Binary_search_tree/Removal) Remove Node Algorithm by **Algolist**
