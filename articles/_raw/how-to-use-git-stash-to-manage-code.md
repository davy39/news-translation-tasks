...
In this article, you’ll learn all about the [git stash](https://git-scm.com/docs/git-stash) command and why it’s important to stash your code. By the end of this article, you will have firsthand knowledge of how to use the `git stash` command in your projects.

### Here’s what we’ll cover:

1. [Why do we stash?](#heading-why-do-we-stash)
    
2. [Pros and cons of using git stash](#heading-pros-and-cons-of-using-git-stash)
    
3. [How to create a stash in Git (step-by-step guide)](#heading-how-to-create-a-stash-in-git-step-by-step-guide)
    
4. [Other git stash commands like list, apply, and pop](#heading-other-git-stash-commands-like-list-apply-and-pop)
    
5. [How to handle multiple stashes in your project](#heading-how-to-handle-multiple-stashes-in-your-project)
    
6. [Real use cases for git stash](#heading-real-use-cases-for-git-stash)
...
[Git](https://git-scm.com/book/en/v2/Getting-Started-What-is-Git%3F) has provided us with the stash command, which makes our lives easier. The `git stash` command helps you save a draft of your current task, temporarily giving you time to attend to your new task without losing your progress on the previous task.
...
![Image of How Git Stash Works](https://hackmd.io/_uploads/S1x5zSPhR.gif align="left")
...
Create a file you want to work on, maybe an `index.html` file or a `style.css` file. Initialize `git` in your project by running the command `git init`. Add the file to the Git tracking stage by running `git add .` Then at this point, if you make any modifications and would like to come back later to complete it, you can run:
...
![Visual Representation of How to Create a stash](https://hackmd.io/_uploads/HJg8cHDh0.gif align="left")
...
![Multiple stashes with the Same messages](https://hackmd.io/_uploads/BkVtICNIA.png align="left")
...
![Multiple stashes with the different messages](https://hackmd.io/_uploads/HJH3IRNLA.png align="left")
