...
_Network represented with a graph_
...
This algorithm was created and published by [Dr. Edsger W. Dijkstra](https://en.wikipedia.org/wiki/Edsger_W._Dijkstra), a brilliant Dutch computer scientist and software engineer. 
...
**I really hope you liked my article and found it helpful.** Now you know how Dijkstra's Algorithm works behind the scenes. Follow me on Twitter [@EstefaniaCassN](https://twitter.com/EstefaniaCassN) and [check out my online courses](https://www.udemy.com/user/estefania-cn/). 
