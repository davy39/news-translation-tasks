---
title: How to Build a Dropbox-like Distributed File Storage System Using MinIO and
  gRPC
subtitle: ''
...
* [Step 2: Setting Up MinIO Distributed Storage Nodes](#heading-step-2-setting-up-minio-distributed-storage-nodes)
    
* [Step 3: Defining the gRPC Protocol](#heading-step-3-defining-the-grpc-protocol)
    
* [Step 4: Implementing the gRPC Server](#heading-step-4-implementing-the-grpc-server)
    
* [Step 5: Creating the Client](#heading-step-5-creating-the-client)
    
* [Step 6: Running the System](#heading-step-6-running-the-system)
