---
title: TypeScript for React Developers – Why TypeScript is Useful and How it Works
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
- [Why Use ESLint, Prettier, and Husky?](#heading-why-use-eslint-prettier-and-husky)
- [What is TypeScript?](#heading-what-is-typescript)
- [Why Bother Dealing with TS?](#heading-why-bother-dealing-with-ts)
- [How to Setup TypeScript](#heading-how-to-setup-typescript)
- [Sample Shopping List Project](#heading-sample-shopping-list-project)
  - [TypeScript Modules](#heading-typescript-modules)
  - [TypeScript Types](#heading-typescript-types)
    - [Inference in TypeScript](#heading-inference-in-typescript)
    - [`any` and `unknown` in TypeScript](#heading-any-and-unknown-in-typescript)
    - [Arrays in TypeScript](#heading-arrays-in-typescript)
    - [Objects in TypeScript](#heading-objects-in-typescript)
    - [Aliases in TypeScript](#heading-aliases-in-typescript)
  - [Functions in TypeScript](#heading-functions-in-typescript)
    - [Optional parameters in TypeScript](#heading-optional-parameters-in-typescript)
  - [TypeScript Enums](#heading-typescript-enums)
  - [TypeScript Generics](#heading-typescript-generics)
  - [Tuples in TypeScript](#heading-tuples-in-typescript)
  - [Classes in TypeScript](#heading-classes-in-typescript)
  - [Interfaces in TypeScript](#heading-interfaces-in-typescript)
  - [DOM Manipulation in TypeScript](#heading-dom-manipulation-in-typescript)
- [How to Combine React + TypeScript](#heading-how-to-combine-react-typescript)
  - [Setup](#heading-setup)
  - [Typing Component Props](#heading-typing-component-props)
    - [React Built-in Types](#heading-react-built-in-types)
    - [Return type of a React component](#heading-return-type-of-a-react-component)
    - [Combinations with Template Literals](#heading-combinations-with-template-literals)
    - [How to use `Exclude`](#heading-how-to-use-exclude)
    - [Custom HTML Components](#heading-custom-html-components)
  - [Typing Hooks](#heading-typing-hooks)
    - [useState hook](#heading-usestate-hook)
    - [useReducer hook](#heading-usereducer-hook)
    - [useContext](#heading-usecontext)
    - [useRef hook](#heading-useref-hook)
  - [Forwarding ref](#heading-forwarding-ref)
  - [How to Use TypeScript Generics in React](#heading-how-to-use-typescript-generics-in-react)
  - [Typing a Custom useFetch Hook](#heading-typing-a-custom-usefetch-hook)
...
TypeScript, Java, and a bunch of other languages have **static typing** that will define a type associated with a variable. The type will be checked during compile time. Once you define something to be a *string* or a *boolean* you can't change its type.
