...
* [What is Retrieval-Augmented Generation (RAG)?](#heading-what-is-retrieval-augmented-generation-rag)
    
* [What is Amazon Bedrock?](#heading-what-is-amazon-bedrock)
    
* [Getting Started: Access models on Bedrock](#heading-getting-started-access-models-on-bedrock)
    
* [Step 1: Upload Travel Policy Documents to the S3 Bucket](#heading-step-1-upload-travel-policy-documents-to-the-s3-bucket)
    
* [Step 2: Create a Knowledge base in Amazon Bedrock](#heading-step-2-create-a-knowledge-base-in-amazon-bedrock)
    
* [Step 3: Create an Amazon Lex Chatbot](#heading-step-3-create-an-amazon-lex-chatbot)
    
* [Step 4: Add a Welcome Intent to Your Chatbot](#heading-step-4-add-a-welcome-intent-to-your-chatbot)
    
* [Step 5: Build the Chatbot](#heading-step-5-build-the-chatbot)
    
* [Step 6: Adding Amazon QnAIntent](#heading-step-6-adding-amazon-qnaintent)
...
* Access to travel policy documents. You can download these from Google Drive [here](https://drive.google.com/file/d/1kyewU4eCFnaYS3wQ7Fyv22G3ycthbfJb/view).
...
*Marina Danilevsky*, *Senior Research Scientist at IBM*, in a [lecture](https://youtu.be/T-D1OfcDW1M?si=YFYcEeulZpXf9AXN), referred to RAG as a “framework” for helping LLMs be more accurate and up-to-date.
...
![Image of Amazon bedrock model catalog page](https://cdn.hashnode.com/res/hashnode/image/upload/v1764493545469/839771fb-c3aa-47d4-b1b9-60cd67ba26c5.png align="center")
...
To upload documents, navigate to the Amazon S3 page in your AWS console, then create a bucket. For more details on creating a bucket, refer to the [AWS documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-bucket-overview.html). Next, upload the downloaded document to the S3 bucket.
...
![image of successful Bedrock knowledge creation ](https://cdn.hashnode.com/res/hashnode/image/upload/v1764493716382/fd92d1d9-51ef-470f-bae9-b1cb636a260e.png align="center")
...
It's now time to create the chatbot. For this, we’ll use [Amazon Lex](https://aws.amazon.com/lex/).
...
![Image of Amazon Lex bot voices](https://cdn.hashnode.com/res/hashnode/image/upload/v1764493888022/29ad9758-c0b7-42f4-8308-8255137c4649.png align="center")
...
![Image of building bot](https://cdn.hashnode.com/res/hashnode/image/upload/v1764494047899/cac4a609-f551-4b3e-9714-1330da3e7908.png align="center")
...
![Image of interaction with bot](https://cdn.hashnode.com/res/hashnode/image/upload/v1764494109571/391fbcc9-b3b0-498c-85f9-43e28d12b58d.png align="center")
...
![Image of built-in intent](https://cdn.hashnode.com/res/hashnode/image/upload/v1764494196339/d28020cb-c3a2-4595-aae0-f02463d422a7.png align="center")
...
![Image of model and knowledge base config in Lex](https://cdn.hashnode.com/res/hashnode/image/upload/v1764494285444/9d49daed-02ed-44a6-a7e6-763611f3a214.png align="center")
...
![Image of AI implementation and interaction with Chabot, retrieving answers to queries from S3 via Bedrock knowledgebase](https://cdn.hashnode.com/res/hashnode/image/upload/v1764494425584/65ec0a99-e438-44d3-ad62-965d82200142.png align="center")
...
Want to add a proper web UI to your bot? Follow the step-by-step instructions in this [GitHub repository](https://github.com/aws-samples/aws-lex-web-ui).
