...
* [My Introduction to Cloud Native Technologies](#heading-my-introduction-to-cloud-native-technologies)
    
* [What is Observability?](#heading-what-is-observability)
    
* [Types of Observability Data](#heading-types-of-observability-data)
    
    * [1\. Metrics](#heading-1-metrics)
        
    * [2\. Logs](#heading-2-logs)
        
    * [3\. Traces](#heading-3-traces)
        
* [Observability Tools](#heading-observability-tools)
    
    * [Prometheus](#heading-prometheus)
        
    * [OpenTelemetry](#heading-opentelemetry)
        
* [What are OTLP Resource Attributes?](#heading-what-are-otlp-resource-attributes)
    
* [Importance of OTLP Resource Attributes](#heading-importance-of-otlp-resource-attributes)
    
* [How My Project Work Fits into All This](#heading-how-my-project-work-fits-into-all-this)
...
I recently got selected as a mentee for the Linux Foundation Mentorship to work on the [CNCF - Prometheus project](https://mentorship.lfx.linuxfoundation.org/project/36e3f336-ce78-4074-b833-012015eb59be). The project is UX-focused, and for the next few months, I'll be working with my mentors to understand how users expect to use OpenTelemetry Line Protocol (OTLP) Resource Attributes in Prometheus.
...
[Prometheus](https://prometheus.io/) is an open-source monitoring and alerting toolkit. It does two things:
...
[OpenTelemetry (OTel)](https://opentelemetry.io/) collects, processes, and exports observability data. Unlike Prometheus, which mainly focuses on metrics, OpenTelemetry provides a standardized way to instrument applications for all three types of observability data: logs, metrics, and traces.
...
For example, OpenTelemetry specifies that you should use `service.name` (not `app_name` or `service_id`) to identify your service. They've created these standardized naming conventions (called [semantic conventions](https://opentelemetry.io/docs/concepts/semantic-conventions/)) so that:
