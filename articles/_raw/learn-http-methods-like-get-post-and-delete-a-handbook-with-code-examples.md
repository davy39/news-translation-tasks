...
1. [GET Method](#heading-get-method)
    
2. [POST Method](#heading-post-method)
    
3. [PUT Method](#heading-put-method)
    
4. [PATCH Method](#heading-patch-method)
    
5. [DELETE Method](#heading-delete-method)
    
6. [HEAD Method](#heading-head-method)
    
7. [OPTIONS Method](#heading-options-method)
    
8. [TRACE Method](#heading-trace-method)
    
9. [CONNECT Method](#heading-connect-method)
...
In this example, the GET request is made to the URL [`https://api.example.com/products`](https://api.example.com/products) with a query parameter `category=shoes`, asking the server to return products in the shoes category.
...
* **Browser**: "Can I make this request to [`api.domainB.com`](http://api.domainB.com)?"
    
* **Server**: "Yes, you can use `GET` and `POST`, but only from [`domainA.com`](http://domainA.com) and with these headers."
