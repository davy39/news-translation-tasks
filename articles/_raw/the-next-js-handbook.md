---
title: The Next.js Handbook – Learn Next.js for Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
2. [The main features provided by Next.js](#heading-the-main-features-provided-by-nextjs)
3. [Next.js vs Gatsby vs `create-react-app`](#heading-nextjs-vs-gatsby-vs-create-react-app)
4. [How to install Next.js](#heading-how-to-install-nextjs)
5. [View source to confirm SSR is working](#heading-view-source-to-confirm-ssr-is-working)
6. [The app bundles](#heading-the-app-bundles)
7. [What's that icon in the bottom right?](#heading-whats-that-icon-on-the-bottom-right)
8. [Install the React DevTools](#heading-install-the-react-developer-tools)
9. [Other debugging techniques you can use](#heading-other-debugging-techniques-you-can-use)
10. [Adding a second page to the site](#heading-adding-a-second-page-to-the-site)
11. [Linking the two pages](#heading-linking-the-two-pages)
12. [Dynamic content with the router](#heading-dynamic-content-with-the-router)
13. [Prefetching](#heading-prefetching)
14. [Using the router to detect the active link](#heading-using-the-router-to-detect-the-active-link)
15. [Using `next/router`](#heading-using-nextrouter)
16. [Feed data to the components using `getInitialProps()`](#heading-feed-data-to-the-components-using-getinitialprops)
17. [CSS](#heading-css)
18. [Populating the head tag with custom tags](#heading-populating-the-head-tag-with-custom-tags)
19. [Adding a wrapper component](#heading-adding-a-wrapper-component)
20. [API routes](#heading-api-routes)
21. [Run code on the server side, or on the client side](#heading-run-code-only-on-the-server-side-or-client-side)
22. [Deploying the production version](#heading-deploying-the-production-version)
23. [Deploying on Now](#heading-deploying-on-now)
24. [Analyzing the app bundles](#heading-analyzing-the-app-bundles)
25. [Lazy loading modules](#heading-lazy-loading-modules)
26. [Where to go from here](#heading-where-to-go-from-here)
