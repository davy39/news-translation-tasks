---
title: 'The Open Source LLM Agent Handbook: How to Automate Complex Tasks with LangGraph
  and CrewAI'
subtitle: ''
...
1. [The Current State of LLM Agents](#heading-the-current-state-of-llm-agents)
    
    * [From Chatbots to Autonomous Agents](#heading-from-chatbots-to-autonomous-agents)
        
    * [What Can Agents Do Today?](#heading-what-can-agents-do-today)
        
    * [What's Available to Build With?](#heading-whats-available-to-build-with)
        
    * [Why Now Is the Best Time to Learn](#heading-why-now-is-the-best-time-to-learn)
        
2. [What Are LLM Agents and Why Are They a Big Deal?](#heading-what-are-llm-agents-and-why-are-they-a-big-deal)
    
    * [What Is an LLM?](#heading-what-is-an-llm)
        
    * [So, What’s an LLM Agent?](#heading-so-whats-an-llm-agent)
        
    * [Why Does This Matter?](#heading-why-does-this-matter)
        
3. [The Rise of Open-Source Agent Frameworks](#heading-the-rise-of-open-source-agent-frameworks)
    
    * [Popular Open-Source Agent Frameworks](#heading-popular-open-source-agent-frameworks)
        
    * [What These Tools Enable](#heading-what-these-tools-enable)
        
    * [Why Use a Framework Instead of Building from Scratch?](#heading-why-use-a-framework-instead-of-building-from-scratch)
        
4. [Core Concepts Behind Agent Design](#heading-core-concepts-behind-agent-design)
    
    * [The Agent Loop](#heading-the-agent-loop)
        
    * [Key Components of an Agent](#heading-key-components-of-an-agent)
        
    * [Multi-Agent Collaboration](#heading-multi-agent-collaboration)
        
5. [Project: Automate Your Daily Schedule from Emails](#heading-project-automate-your-daily-schedule-from-emails)
    
    * [What We’re Automating](#heading-what-were-automating)
        
    * [Step 1: Install the Required Tools](#heading-step-1-install-the-required-tools)
        
    * [Step 2: Define the Task](#heading-step-2-define-the-task)
        
    * [Step 3: Build the Workflow with LangGraph](#heading-step-3-build-the-workflow-with-langgraph)
        
6. [Multi-Agent Collaboration with CrewAI](#heading-multi-agent-collaboration-with-crewai)
    
    * [What Is CrewAI?](#heading-what-is-crewai)
        
    * [Sample Roles for the Email Summary Task](#heading-sample-roles-for-the-email-summary-task)
        
    * [Sample CrewAI Code](#heading-sample-crewai-code)
        
7. [What Actually Happens During Execution?](#heading-what-actually-happens-during-execution)
    
8. [Are LLM Agents Safe? What to Know About Security and Privacy](#heading-are-llm-agents-safe-what-to-know-about-security-and-privacy)
    
9. [Troubleshooting & Tips](#heading-troubleshooting-and-tips)
    
10. [Explore More Daily Automations](#heading-explore-more-daily-automations)
    
11. [What’s Next in Agent Technology?](#heading-whats-next-in-agent-technology)
    
12. [Final Summary](#heading-final-summary)
...
Grab the latest version of Python 3.9+ from the official website: [https://www.python.org/downloads/](https://www.python.org/downloads/)
...
VSCode is a fantastic, user-friendly code editor that works perfectly with Python. You can download it right here: [https://code.visualstudio.com/](https://code.visualstudio.com/).
...
This command sets an environment variable named OPENAI\_API\_KEY. Environment variables are a secure way for applications (like your Python script) to access sensitive information without hardcoding it directly into the code itself.
...
* **calendar\_summary\_agent(state: AgentState)**: This function is the "brain" of our agent. It:
...
* **builder.add\_node("calendar", calendar\_summary\_agent):** This line adds a named "node" to our graph. We're calling it "calendar", and we're linking it to our `calendar_summary_agent` function, meaning that function will be executed when this node is active.
    
* **builder.set\_entry\_point("calendar"):** This sets "calendar" as the very first step in our workflow. When we start the graph, execution will begin here.
    
* **builder.set\_finish\_point("calendar"):** This tells LangGraph that once the "calendar" node finishes its job, the entire graph process is complete.
...
* **Agent Definitions (extractor, prioritizer, formatter):**
    ...
    * allow\_delegation=False means these agents won't pass their assigned tasks to other agents (though this can be set to True for more complex delegation scenarios).
...
* **Task Definitions (extract\_task, prioritize\_task, format\_task):**
    ...
    * agent assigns this task to one of our defined agents (e.g., extractor for extract\_task).
        
    * context=\[...\] is a critical part of CrewAI's collaboration. It tells a task to use the *output* of a previous task as its *input*. For instance, prioritize\_task takes the extract\_task's output as its context.
        
    * expected\_output gives the agent an idea of what its result should look like, helping guide the LLM.
...
| **Resource** | **Link** |
| --- | --- |
| LangGraph Docs | [https://docs.langgraph.dev/](https://docs.langgraph.dev/) |
| CrewAI GitHub | [https://github.com/joaomdmoura/crewAI](https://github.com/joaomdmoura/crewAI) |
| LangChain Docs | [https://docs.langchain.com/docs/](https://docs.langchain.com/docs/) |
