...
_Apples plus human effort equals pie. Not to be confused with apple-human-pie, which is less appetizing._
...
_Adorable, slightly skewed apples just want to be loved/eaten._
...
_+1 for you if you saw that one coming._

_Thanks for reading! You can find more articles explaining coding concepts with food [on my blog](https://victoria.dev/verbose/)._
