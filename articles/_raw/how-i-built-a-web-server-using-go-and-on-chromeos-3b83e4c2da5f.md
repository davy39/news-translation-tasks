...
Go is also fast to compile and comes with all sorts of helpful packages available in the standard library, which is well-documented online. It’s been used in a number of [projects](https://en.wikipedia.org/wiki/Go_(programming_language)#Projects_using_Go), including some by household names such as Google, Dropbox, Soundcloud, Twitch and Uber.
...
_Medium’s homepage, as viewed in the Lynx browser running in Termux._
...
_Foreground: Mozilla Firefox for Android; Background: Lynx for Termux_
...
_Firefox appears a little more enthusiastic than Lynx…_
