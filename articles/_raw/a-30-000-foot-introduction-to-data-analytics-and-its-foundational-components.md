---
title: What is Data Analytics? A 30,000-Foot Intro to Key Data Analysis Concepts
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
2. Data can be a time series. An example is my test scores, wages earned in a period of time, or how companies measure and apply discounts throughout the year.
...
But for those that do, the payoffs are very large. When I started a website to help people work from home, I thought the odds of success were 10% at best.
...
Health products, wellness marketing programs, and exercise apps all use data analytics to optimize exercises for the human body based on data that we emit (think: heart rates, blood oxygen levels, sleep patterns). 
...
Low code workflow automation tools use data analytics for predictive experiences and enable developers of varied experience levels to create applications model-driven logic. Data modules are predefined. 

Much like with software, education is being transformed by data analytics. Online learning for schools and coding apps for kids rely on data analytics for risk management (when students fall behind) and content retention.

Think about how risk is priced.

Sampling is being used to change how insurance companies are pricing insurance policies. More financial institutions and insurance firms are using data analytics to assess credit quality, to price and market insurance contracts, and to automate client interaction.

Think about website design.

Whether or not you want to apply data analytics to build the next big thing, data analytics will help you measure what matters and turn data into actionable insights.

Think about agriculture.

High-tech plant growers such as JoyOrganics and TakeSpruce are using seed-to-sale cycle tracking to follow plants through stages from cultivation to harvest to extraction. 

Farmers are using data analytics to find signals for higher and uncorrelated returns and optimize growing.

Think about indoor air quality and natural language processing. 

Or the way in which CRM software is built, or how people communicate in real time. 
