...
_Hash table for storing phone books (from [Wikipedia](https://en.wikipedia.org/wiki/Hash_table))_
...
<small>Source from [Wikipedia](https://en.wikipedia.org/wiki/Hash_table)</small>
