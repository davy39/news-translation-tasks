...
* [What is TanStack Start?](#heading-what-is-tanstack-start)
    
* [What is TanStack DB (with RxDB Integration)?](#heading-what-is-tanstack-db-with-rxdb-integration)
    
* [Setting Up Our Project](#heading-setting-up-our-project)
    
* [Creating the Database Client](#heading-creating-the-database-client)
    
* [Understanding Local Persistence with RxDB](#heading-understanding-local-persistence-with-rxdb)
    
* [Creating a Todo Collection](#heading-creating-a-todo-collection)
    
* [Creating Our CRUD Actions](#heading-creating-our-crud-actions)
    
* [Creating the Frontend Page](#heading-creating-the-frontend-page)
    
* [How does TanStack Start Compare to Next.js and Remix?](#heading-how-does-tanstack-start-compare-to-nextjs-and-remix)
    
* [When Should You Use TanStack Start, Next.js, or Remix?](#heading-when-should-you-use-tanstack-start-nextjs-or-remix)
...
At the end, we’re also going to replace the existing `index.tsx` page with our own CRUD app codebase, while also keeping the demo routes in navigation so you can still explore them.

## Creating the Database Client

Up first is our `src/db/client.ts` file, so copy and paste the below code into the file:
...
Next.js recently released [version 16](https://nextjs.org/blog/next-16), which brought some new improvements and features which you can read about. It’s without a doubt the most well known and used React framework available right now.

Remix also has a lot going for it, recently held its [Remix Jam 2025 recap event](https://remix.run/blog/remix-jam-2025-recap) which you can also read and learn about.

TanStack Start, on the other hand, is built using the popular [Vite](https://vite.dev/) build tool which it uses for its development, workflow, and production builds alongside TanStack Router and other libraries.
