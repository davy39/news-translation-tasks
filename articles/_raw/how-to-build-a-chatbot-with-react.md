---
title: How to Build a Chatbot with React
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
Which morphed into a [npm package.](https://www.npmjs.com/package/react-chatbot-kit)

So let's build one together. If you want to take on this challenge on your own, you can go directly to the [documentation (which is actually a chatbot)](https://fredrikoseberg.github.io/react-chatbot-kit-docs/). Or, if you are a visual learner, [I created a tutorial on YouTube.](https://youtu.be/vTpk-PKZwTs)

Otherwise, let's go. I'm going to assume that you have Node installed, and access to the npx command. If not, [go get it here.](https://nodejs.org/)
...
We'll go deeper into this later. For now, [go here to get the boilerplate code to get started.](https://gist.github.com/FredrikOseberg/c1e8ec83ade6e89ca84882e33caf599c)
...
For now, we've only set up the bot to handle when someone clicks or types in JavaScript, but you can try to expand the other options on your own. [Here's a link to the repository](https://github.com/FredrikOseberg/fcc-chatbot-example).

All the code is on GitHub, so feel free to dive into [the react-chatbot-kit code or docs](https://github.com/FredrikOseberg/react-chatbot-kit).
...
If you want to improve as a developer, I encourage you to keep building. It truly is the only path forward. If you enjoyed this article, and would like to know when I post more content, you can [follow me on Twitter](https://twitter.com/foseberg).
