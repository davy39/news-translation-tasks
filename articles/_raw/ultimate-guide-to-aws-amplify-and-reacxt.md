...
If you want to read this article offline then you can [download it here](https://www.subscribepage.com/amplify_full_stack).
...
This is getting the file path from the song data (that was [stored in Dynamo](https://completecoding.io/amplify-database/)) and then using `Storage.get(songFilePath, { expires: 60 });` to get an access URL for the file. 
...
If you've liked this article (and accompanying videos) and want to help me out, then the best thing you can do is to subscribe to my [Youtube Channel](https://www.youtube.com/c/completecoding?sub_confirmation=1). I create weekly videos on AWS and Serverless to help you become a better developer. [Subscribe Here](https://www.youtube.com/c/completecoding?sub_confirmation=1)
