---
title: How to Build a Full-Stack Kanban Task Management App With TypeScript, Next.js,
...
In this in-depth tutorial, you'll learn how to build a full-stack Kanban task management app. Along the way, we'll explore the synergies between technologies like [`Next.js`](https://nextjs.org) (featuring a dive into the app router), [`Next-auth`](https://next-auth.js.org) for user authentication, and [Firebase](https://firebase.google.com/), a backend as a service platform to save user data in a database. 

We'll also cover how you can integrate Firebase Firestore with [`Redux Toolkit`](https://redux-toolkit.js.org/) which enables you to cache data you have retrieved from the database to improve performance. You will also learn how to manage state with Redux Toolkit.

To wrap it up, we will employ [`React-beautiful-dnd`](https://www.npmjs.com/package/react-beautiful-dnd), a library that effortlessly integrates drag-and-drop interactions into our Kanban boards to enhance the user experience.
...
1. [How To Implement Authentication With next-auth.js](#heading-how-to-implement-authentication-with-next-authjs)
2. [How to Configure the Redux Store](#heading-how-to-configure-the-redux-store)
3. [How to Create Your Kanban App Markup](#heading-how-to-create-your-kanban-app-markup)
4. [How to Configure Firebase Firestore](#heading-how-to-configure-firebase-firestore)
5. [How to Add Initial Data to the Firestore Database](#heading-how-to-add-initial-data-to-the-firestore-database)
6. [How to Use RTK Query to Fetch Data from Cloud Firestore](#heading-how-to-use-rtk-query-to-fetch-data-from-cloud-firestore)
7. [How to Fetch and Populate Data](#heading-how-to-fetch-and-populate-data)
    - [How to populate the navbar](#heading-how-to-populate-the-navbar)
    - [How to populate the sidebar](#heading-how-to-populate-the-sidebar)
    - [How to populate the BoardTasks component](#heading-how-to-populate-the-boardtasks-component)
8. [How to Implement CRUD Operations](#heading-how-to-implement-crud-operations)
    - [How to add and edit a board](#heading-how-to-add-and-edit-a-board)
    - [How to add and edit tasks](#heading-how-to-add-and-edit-tasks)
    - [How to delete boards and tasks](#heading-how-to-delete-boards-and-tasks)
9. [How to Implement Drag and Drop Functionality](#heading-how-to-implement-drag-and-drop-functionality)
...
With these steps, you have successfully integrated the Redux store into your application, and you are ready to create [slices](https://redux-toolkit.js.org/tutorials/quick-start#create-a-redux-state-slice) for your application.
...
To integrate Firestore into your application, you'll need to create a Firebase project using the [Firebase console](https://console.firebase.google.com/u/0/?_gl=1*1r24b4a*_ga*MTkyMjc0OTE3NC4xNjc4MDIwMDMw*_ga_CW55HF8NVT*MTcwMDMxMTAwNC4xNjUuMS4xNzAwMzExNDU0LjQ3LjAuMA..). Feel free to name the project according to your preference, but for the sake of this tutorial, let's name it "Kanban-app-tutorial."
...
First, we'll use the [`react-modal`](https://www.npmjs.com/package/react-modal)  library to create a custom modal component. This allows us to avoid building from scratch. 
...
It’s worth noting that [the react-beautiful-dnd library does not work inside the `StrictMode` wrapper](https://github.com/atlassian/react-beautiful-dnd/issues/2399#issuecomment-1111169234) which is [enabled by default in the app router](https://nextjs.org/docs/pages/api-reference/next-config-js/reactStrictMode). So we have to create a custom hook which will enable us use the `react-beautiful-dnd` library safely with `StrictMode`. 
...
If you want to see all the code, you can visit the project's GitHub repository [here](https://github.com/SiR-PENt/kanban-app-tutorial). Feel free to fork the project and open a PR if you feel the need for any improvements. If you’d also like to play around with the live site, you can find it [here](https://kanban-app-tutorial.vercel.app). 

If you'd also like to explore this project with more advanced features, like dark mode, sleeker UI design, and better functionalities, visit it [here](https://kanban-task-management-app-delta.vercel.app).
