---
title: How I landed offers from Microsoft, Amazon, and Twitter without an Ivy League
  degree
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2020-02-23T08:14:06.000Z'
originalURL: https://freecodecamp.org/news/how-i-landed-offers-from-microsoft-amazon-and-twitter-without-an-ivy-league-degree
coverImage: https://www.freecodecamp.org/news/content/images/2020/02/1_QuyFfwka5D5j7Z2IR4mcCQ.jpg
tags:
...
seo_desc: 'By Zhia Chong
  ...
  This is for those of you out there who are about to start your job search and who
  may be worried that you can’t land a top-tier tech job without a Stanford CS degree.
  Someone told you that you’re not good enough to get a job at Microsof...'
---
...
Read more about my courses [here](https://docs.google.com/document/d/1PeK69h4H82rwKjhactiE_sAIorCcZgXgXTY7k-nXpnE/edit?usp=sharing) to learn how I prepared.

You can read about my experiences after a year at Twitter [here](https://www.freecodecamp.org/news/what-ive-learned-in-1-year-at-twitter-65150f5d4af2/).
...
%[https://www.youtube.com/watch?v=83Reyvrs-VQ]
...
What I did next is something I’m particularly proud of. I wrote a simple Python script that scraped job listings on Craigslist with titles containing keywords from a list, and collected the emails in a spreadsheet. For the actual war story, you can read the article [here](https://www.freecodecamp.org/news/how-i-built-a-web-crawler-to-automate-my-job-search-f825fb5af718/).
...
![Image](https://www.freecodecamp.org/news/content/images/2020/02/linkedin-search.png)
_LinkedIn search_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/02/my-notebook.png)
_My notebook_

* **Keep a notebook** of the things you’ve learned. I use both [Evernote](http://evernote.com) and [OneNote](http://onenote.com) to keep track of things. OneNote for technical stuff/code, because I like that I can easily format the note any way I like. I use Evernote for essays/thoughts. The image above shows a note I keep on architecture and system designs.

![Image](https://www.freecodecamp.org/news/content/images/2020/02/evernote.png)
_Evernote for thoughts/tips_
...
Thanks for reading my story! You can find me on [Twitter](https://twitter.com/zhiachong) and [LinkedIn](https://www.linkedin.com/in/zhiachong/). I would love to connect and talk more about tech, startups, travel :D
