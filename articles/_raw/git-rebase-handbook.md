...
_A diverging history - `paul_branch` and `john_branch` diverged from `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The result of running `git merge paul_branch`: a new Merge Commit with two parents (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The result of running `git rebase john_branch`: the commits on `paul_branch` were "replayed" on top of `john_branch` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Running `git diff` to observe the patch introduced by "Commit 5" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The output of `git diff` - the patch introduced by "Commit 5" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Creating `my_branch` that branches from `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Using `cherry-pick` to apply the changes introduced in "Commit 5" onto `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_

Consider the log (output of `git lol`):

![Image](https://www.freecodecamp.org/news/content/images/2023/06/image-205.png)
_The output of `git lol` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The output of `git show HEAD` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Commit history before performing `git rebase` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after rebasing (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after rebasing and checking out `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The result of a fast-forward merge (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_"Undoing" the last merge operation (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_"Undoing" the rebase operation (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Visualizing the history after "undoing" the rebase operation (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_`git show HEAD` shows the patch introduced by "Commit 9" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_`git show HEAD~` (same as `git show HEAD~1`) shows the patch introduced by "Commit 8" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_`git show HEAD~2` shows the patch introduced by "Commit 7" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_`git rebase -i main` prompts you to select what to do with each commit (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Squashing "Commit 8" into "Commit 7" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Providing the commit message: `Commits 7+8` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_

And look at the history:

![Image](https://www.freecodecamp.org/news/content/images/2023/06/image-253.png)
_The history after the interactive rebase (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after the interactive rebase - visualized (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Creating `new_branch` that diverges from `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_

![Image](https://www.freecodecamp.org/news/content/images/2023/06/image-256.png)
_A clean history with `new_branch` that diverges from `main` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Adding the function `new_branch` to `code.py` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Added a docstring at the beginning of the file (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Added `@Author` to the docstring (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after introducing "Commit 12" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Visually, I want you to "push" "Commit 10" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history before and after the rebase, "Commit 10" has been "pushed" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_A new file, `1.py`, with `print('Hello world!')` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Creating `2.py` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Modifying `2.py` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after introducing "Commit 15" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Modifying `1.py` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after introducing "Commit 16" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_You want to move around "Commit 14" and "Commit 15" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The commit history after performing rebase (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Changing `'` into `"` in `code.py` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Adding the function `another_feature` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Changing `'__main__'` into `"__main__"` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The commit history after introducing "Commit 19" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_These are the commits I want to edit (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Using `rebase --onto` on a single branch (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Interactive rebase (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Interactive rebase - changing the order of commit and squashing (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Providing a commit message (Source: [Brief](https://youtu.be/3VFsitGUB3s))_

And now, see our beautiful history:

![Image](https://www.freecodecamp.org/news/content/images/2023/06/image-283.png)
_The resulting history (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Another commit history (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/06/image-284.png)
_The history again (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Rebasing with `--onto` results in a detached `HEAD` (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The current history, considering "Commit E" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The history after rebase (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_The patch introduced in "Commit 12" (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
...
_Comparing rebase and merge (Source: [Brief](https://youtu.be/3VFsitGUB3s))_
