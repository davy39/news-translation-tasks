...
More than ever, website data theft sustains a torrential stream of new class action lawsuits. Even with careful design and strong [internal security practices](https://www.flowlu.com/blog/productivity/growing-a-team-with-a-strong-focus-on-security-and-compliance/) like employee training and compliance protocols, [website data breaches](https://termly.io/resources/articles/biggest-data-breaches/) continue to escalate.
...
* [1\. Phishing and Social Engineering](#heading-1-phishing-and-social-engineering)
    
* [2\. SQL Injection, XSS, and CSRF](#heading-2-sql-injection-xss-and-csrf)
    
* [3\. Brute Force Password Attacks](#heading-3-brute-force-password-attacks)
    
* [4\. Malware and Malicious Scripts](#heading-malware-and-malicious-scripts)
    
* [5\. Man-in-the-Middle Attacks and Public Connections](#heading-5-man-in-the-middle-attacks-and-public-connections)
    
* [6\. Outdated Software and Old Plugins](#heading-6-outdated-software-and-old-plugins)
    
* [7\. APIs, Integrations, and Third-Party Attacks](#heading-7-apis-integrations-and-third-party-attacks)
    
* [Where the Dark Web Dumps Your Data](#heading-where-the-dark-web-dumps-your-data)
    
* [Defend Your Data](#heading-defend-your-data)
...
Enforce [multi-factor authentication](https://en.wikipedia.org/wiki/Multi-factor_authentication) across systems, so stolen passwords alone can’t unlock accounts.
...
* preload allows your domain to be included in browser preload lists for even stronger protection (requires submission to [hstspreload.org](https://hstspreload.org)).
...
You can generate the SRI hash using tools like [SRI Hash Generator](https://www.srihash.org/) or command-line tools like openssl.
