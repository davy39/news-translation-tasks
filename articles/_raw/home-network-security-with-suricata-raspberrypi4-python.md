---
title: Home Network Security – How to Use Suricata, RaspberryPI4, and Python to Make
  Your Network Safe
subtitle: ''
author: Jose Vicente Nunez
co_authors: []
series: null
date: '2022-04-19T00:23:10.000Z'
originalURL: https://freecodecamp.org/news/home-network-security-with-suricata-raspberrypi4-python
coverImage: https://www.freecodecamp.org/news/content/images/2022/04/pexels-george-becker-333837.jpg
tags:
- name: cybersecurity
  slug: cybersecurity
...
- name: Raspberry Pi
  slug: raspberry-pi
seo_title: null
seo_desc: 'In a previous article, I showed you how to secure your wireless home network
  using Kismet.

  Kismet is perfect for detecting anomalies and certain types of attack – but what
  if I want to analyze the traffic and look for abnormal patterns or patterns th...'
---
...
I used a good IDS in the past called [Snort V2](https://snort.org/), I'm aware than Snort 3 is out. But there is a [pretty clear warning](https://snort.org/documents/snort-supported-oss) about running it on a machine without much memory:
...
*Not exactly a reason to dislike it*, but I feel more confident when a vendor tells me than my OS is in their supported platform list. I do also have more recent experience setting up with the open source tool [Suricata,](https://suricata.io/download/) so I decided to give it a more serious try to keep tabs on my local network and alert me if any suspicious activity was detected.
...
* [Quick Installation](#heading-quick-installation)
    
* [Where you should connect your Raspberry Pi 4 with Suricata](#heading-where-you-should-connect-your-raspberrypi-4-with-suricata)
    
* [How to Set Up Suricata](#heading-how-to-set-up-suricata)
    
* [How to Tune Up Suricata](#heading-how-to-tune-up-suricata)
    
* [Making Sense of All the Alerts](#heading-making-sense-of-all-the-alerts)
    
* [What Did We Learn and What is Next?](#heading-what-did-we-learn-and-what-is-next)
...
We can tune Suricata using the [ET OPEN Ruleset](https://rules.emergingthreats.net/OPEN_download_instructions.html). Because threats change all the time, you need to automate [their download and updating](https://github.com/OISF/suricata-update#suricata-update).
...
[![asciicast](https://asciinema.org/a/487861.svg align="left")](https://asciinema.org/a/487861)

For our home network, we will download these rules once a day. A [simple Cron job](https://en.wikipedia.org/wiki/Cron) will do the trick:
...
[![asciicast](https://asciinema.org/a/487868.svg align="left")](https://asciinema.org/a/487868)
...
[![asciicast](https://asciinema.org/a/487979.svg align="left")](https://asciinema.org/a/487979)
...
The Suricata folks have [put together a nice page with examples](https://suricata.readthedocs.io/en/suricata-6.0.0/output/eve/eve-json-examplesjq.html) that you should check out.

## **How to test Suricata installation**

### **Tools of the trade: Wireshark, tcpreplay, and PCAP files**

We will use some traffic capture files, in [PCAP](https://tools.ietf.org/id/draft-gharris-opsawg-pcap-00.html) format. So what is a PCAP file?

> In the late 1980's, Van Jacobson, Steve McCanne, and others at the Network Research Group at Lawrence Berkeley National Laboratory developed the [tcpdump](https://www.tcpdump.org/) program to capture and dissect network traces.
> 
...
The best way to learn how the bad actors operate is to see their footprints. You should definitely head to [https://www.malware-traffic-analysis.net/](https://www.malware-traffic-analysis.net/) and download some samples, an even [better practice](https://www.malware-traffic-analysis.net/training-exercises.html) with their PCAP analysis exercises.
...
[![asciicast](https://asciinema.org/a/488000.svg align="left")](https://asciinema.org/a/488000)
...
Start by downloading [2022-02-23-traffic-analysis-exercise.pcap.zip](https://www.malware-traffic-analysis.net/2022/02/23/2022-02-23-traffic-analysis-exercise.pcap.zip) (the password is on the \[about page\](file:///home/josevnz/SuricataLog/)).
...
Will use a \[small wrapper\](file:///home/josevnz/SuricataLog/scripts/replay\_pcap\_file.sh) around `tcpreplay` to replay our PCAP file:
...
[![asciicast](https://asciinema.org/a/SH8bo3pjpvRt4H617GoHbPdoK.svg align="left")](https://asciinema.org/a/SH8bo3pjpvRt4H617GoHbPdoK)
...
[![asciicast](https://asciinema.org/a/488035.svg align="left")](https://asciinema.org/a/488035)
...
[![asciicast](https://asciinema.org/a/488166.svg align="left")](https://asciinema.org/a/488166)
...
You can leave your comments on the Git repository and report any bugs. But more important get Suricata, [get the code of this tutorial](https://github.com/josevnz/SuricataLog), and start securing your home wireless infrastructure in no time.
