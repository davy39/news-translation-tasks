...
* [What Are Design Patterns?](#heading-what-are-design-patterns)
    
* [Creational Design Patterns](#heading-creational-design-patterns)
    
    * [Singleton Pattern](#heading-singleton-pattern)
        
    * [Factory Method Pattern](#heading-factory-method-pattern)
        
    * [Abstract Factory Pattern](#heading-abstract-factory-pattern)
        
    * [Builder Pattern](#heading-builder-pattern)
        
    * [Prototype Pattern](#heading-prototype-pattern)
        
* [Structural Design Patterns](#heading-structural-design-patterns)
    
    * [Adapter Pattern](#heading-adapter-pattern)
        
    * [Decorator Pattern](#heading-decorator-pattern)
        
    * [Facade Pattern](#heading-facade-pattern)
        
    * [Proxy Pattern](#heading-proxy-pattern)
        
* [Behavioral Design Patterns](#heading-behavioral-design-patterns)
    
    * [Chain of Responsibility Pattern](#heading-chain-of-responsibility-pattern)
        
    * [Iterator Pattern](#heading-iterator-pattern)
...
Let's say, for example, that your application consults an API that returns [XML](https://www.freecodecamp.org/news/what-is-an-xml-file-how-to-open-xml-files-and-the-best-xml-viewers/) and sends that information to another API to process that information. But the processing API expects [JSON](https://www.freecodecamp.org/news/what-is-json-a-json-file-example/). You can't send the information as it's received since both interfaces are incompatible. You need to *adapt it* first. 😉
