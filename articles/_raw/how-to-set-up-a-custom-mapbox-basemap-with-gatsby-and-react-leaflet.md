---
title: How to set up a custom Mapbox basemap style with React Leaflet and Leaflet
  Gatsby Starter
subtitle: ''
author: Colby Fayock
co_authors: []
...
* [What is Mapbox?](#heading-what-is-mapbox)
* [Part 1: Creating a custom Mapbox style](#heading-part-1-creating-a-custom-mapbox-style)
* [Part 2: Adding a custom TileLayer to React Leaflet](#heading-part-2-adding-a-custom-tilelayer-to-react-leaflet)
* [Part 3: Adding a custom basemap to Gatsby Starter Leaflet](#heading-part-3-adding-a-custom-basemap-to-gatsby-starter-leaflet)
* [Securing your Mapbox key](#heading-securing-your-mapbox-key)
...
_Gatsby Starter Leaflet with Mapbox basemap_
...
_Coronavirus (COVID-19) custom map_
...
_Create a new style in Mapbox Studio_
...
_Select and customize a template for a new style in Mapbox Studio_
...
_Creating a new token in Mapbox_
...
_Create a new access token in Mapbox_
...
_Mapbox Static Tiles Maps API_
...
_Finding the Style URL in Mapbox Studio_
...
_React Leaflet with a Mapbox basemap_
...
_Gatsby Starter Leaflet with custom Mapbox basemap in browser_
