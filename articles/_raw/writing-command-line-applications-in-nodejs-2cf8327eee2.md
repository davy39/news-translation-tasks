...
Therefore, our first line is the [shebang](https://en.wikipedia.org/wiki/Shebang_(Unix)) expression:
...
Now, writing CLI apps with _commander_ is simple, and the documentation is great, but I struggled with a few concepts that I will attempt to clear up here.
...
* **_git commit -am <messa_**ge>
* **_git remote add origin <repo-u_**rl>
