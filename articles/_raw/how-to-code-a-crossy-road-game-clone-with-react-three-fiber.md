...
In this tutorial, you’ll learn how to create a clone of the mobile game Crossy Road with React Three Fiber. In a previous [tutorial](https://www.freecodecamp.org/news/how-to-code-a-crossy-road-game-clone-with-threejs/), I taught you how to build this game using Three.js and vanilla JavaScript. And here, you’ll learn how to make the same game with React Three Fiber instead.
...
This article is a shortened version of the Crossy Road tutorial from my site [JavaScriptGameTutorials.com](https://javascriptgametutorials.com/). The extended tutorial is also available as a video on [YouTube](https://www.youtube.com/watch?v=ccYrSACDNsw&ab_channel=HunorM%C3%A1rtonBorb%C3%A9ly).

## Table of Contents

1. [React Three Fiber vs Three.js](#heading-react-three-fiber-vs-threejs)
    
2. [How to Set Up the Game](#heading-how-to-set-up-the-game)
    
3. [How to Render a Map](#heading-how-to-render-a-map)
    
4. [How to Animate the Cars](#heading-how-to-animate-the-cars)
    
5. [How to Move the Player](#heading-how-to-move-the-player)
    
6. [Hit Detection](#heading-hit-detection)
...
![The player](https://cdn.hashnode.com/res/hashnode/image/upload/v1739804077435/9667f94f-5005-41f8-a6ed-faa6706f0be1.png align="left")
...
![Different light options](https://cdn.hashnode.com/res/hashnode/image/upload/v1739804142917/7b6a49e2-30df-40d8-bd4c-7ac1a2725931.png align="left")
...
![Perspective vs orthographic camera](https://cdn.hashnode.com/res/hashnode/image/upload/v1739800656673/d2643544-b44c-418e-a475-2844e6626dbb.png align="left")
...
![The coordinate system](https://cdn.hashnode.com/res/hashnode/image/upload/v1739803742848/d202d09f-1c1b-4246-be23-2a6f6af52423.png align="left")
...
![Ambient vs directional light](https://cdn.hashnode.com/res/hashnode/image/upload/v1739800781538/9e140ef9-4133-4151-9fc5-b629504259a8.png align="left")
...
![The directional light shines with parallel light rays](https://cdn.hashnode.com/res/hashnode/image/upload/v1739805160031/4742e1de-5dc0-4443-9716-af18581bfa1e.png align="left")
...
![The different row types](https://cdn.hashnode.com/res/hashnode/image/upload/v1739803813951/3796e0c0-6f02-4c82-979b-a5192d8c3b8c.png align="left")
...
![A row can be broken down into a tile](https://cdn.hashnode.com/res/hashnode/image/upload/v1739803829719/38318821-8496-43d1-9b1c-a5b36d78af14.png align="left")
...
![A forest row](https://cdn.hashnode.com/res/hashnode/image/upload/v1739806992172/139197f0-f2c1-4f11-aacf-f1fedeeaf9b0.png align="left")
...
![A tree](https://cdn.hashnode.com/res/hashnode/image/upload/v1739807310182/40cbb90b-0356-4db5-97bb-cdbe0c8e8cb8.png align="left")
...
![The car lane](https://cdn.hashnode.com/res/hashnode/image/upload/v1739807532566/1c9cfdc9-2c45-476c-9ada-09f7abf79328.png align="left")
...
![The Road component](https://cdn.hashnode.com/res/hashnode/image/upload/v1739807755293/e731a758-ac20-40f5-819b-82a5ae81e65f.png align="left")
...
![A car](https://cdn.hashnode.com/res/hashnode/image/upload/v1739807975022/dc04c3c1-de94-49fd-ad85-ade999c8862a.png align="left")
...
You can also find a more extended version of how to draw this car with textures [in this article](https://www.freecodecamp.org/news/three-js-tutorial/).
...
![The cars move in an infinite loop](https://cdn.hashnode.com/res/hashnode/image/upload/v1739808359961/eca84295-09d7-463a-8d29-e5f8069bb673.png align="left")
...
![The player movement](https://cdn.hashnode.com/res/hashnode/image/upload/v1739808997988/8adb70d2-bf5d-4e65-8ed9-29e8f297b487.png align="left")
...
![For the vertical movement we use a sine wave](https://cdn.hashnode.com/res/hashnode/image/upload/v1739810397620/89119f6e-ced5-4cdb-8254-96fbf66479ed.png align="left")
...
![Calculating where the player will end up](https://cdn.hashnode.com/res/hashnode/image/upload/v1739810555283/310afd32-6e5a-4143-bbe2-e0da558bd6d7.png align="left")
...
![Check if the player bumps into a tree](https://cdn.hashnode.com/res/hashnode/image/upload/v1739810684106/71c45122-b10c-4623-b575-184c1cf1fecb.png align="left")
...
![Calculating bounding boxes for hit detection](https://cdn.hashnode.com/res/hashnode/image/upload/v1739826639155/1497d588-bf60-4fdc-a185-a01a781beafb.png align="left")
...
You can find the extended tutorial with interactive demos on [JavaScriptGameTutorials.com](http://javascriptgametutorials.com/). There, we also cover how to add shadows and truck lanes and how to generate an infinite number of rows as the player moves forward. We also add UI elements for the controls and the score indicator, and we add a result screen with a button to reset the game.

Alternatively, you can find the extended tutorial on [YouTube](https://www.youtube.com/watch?v=ccYrSACDNsw&ab_channel=HunorM%C3%A1rtonBorb%C3%A9ly).
