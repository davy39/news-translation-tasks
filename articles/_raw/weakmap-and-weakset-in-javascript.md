...
1. [What is a WeakMap?](#heading-what-is-a-weakmap)  
– [Key Characteristics of WeakMap](#heading-key-characteristics-of-weakmap)
2. [How to Create a WeakMap using the `new WeakMap()` Constructor](#heading-how-to-create-a-weakmap-using-the-new-weakmap-constructor)
3. [Common Use Cases for WeakMap](#heading-common-use-cases-for-weakmap)
4. [Methods of WeakMap](#heading-methods-of-weakmap)
5. [What is a WeakSet?](#heading-what-is-a-weakset)  
– [Key Characteristics of WeakSet](#heading-key-characteristics-of-weakset)
6. [How to Create a WeakSet using the `new WeakSet()` constructor](#heading-how-to-create-a-weakset-using-the-new-weakset-constructor)
7. [Common Use Cases for WeakSet](#heading-common-use-cases-for-weakset)
8. [Methods of WeakSet](#heading-methods-of-weakset)
