...
* [The DNS Resolution Process](#heading-the-dns-resolution-process)
    
* [Finding the First DNS Server: Defaults, DHCP, and Manual Settings](#heading-finding-the-first-dns-server-defaults-dhcp-and-manual-settings)
    
* [How DNS Resolution Powers Your Application’s Network Requests](#heading-how-dns-resolution-powers-your-applications-network-requests)
    
    * [Valid IP Check](#heading-1-valid-ip-check)
        
    * [Application Cache Lookup](#heading-2-application-cache-lookup)
        
    * [Operating System Cache Check](#heading-3-operating-system-cache-check)
        
    * [Forwarding to Configured DNS Server](#heading-4-forwarding-to-configured-dns-server)
        
    * [Recursive Resolution Across Servers](#heading-5-recursive-resolution-across-servers)
        
* [Understanding the Role of the Recursive Resolver](#heading-understanding-the-role-of-the-recursive-resolver)
    
    * [Recursive Resolver and Root Name Server Interaction](#heading-recursive-resolver-and-root-name-server-interaction)
        
    * [Recursive Resolver and TLD Server Interaction](#heading-recursive-resolver-and-tld-server-interaction)
        
    * [Recursive Resolver and Authoritative Name Server Interaction](#heading-recursive-resolver-and-authoritative-name-server-interaction)
        
* [Domain Registrars and DNS Setup for New Domains](#heading-domain-registrars-and-dns-setup-for-new-domains)
    
    * [What Are Domain Registrars?](#heading-what-are-domain-registrars)
        
    * [What Happens in the DNS System When You Buy a New Domain?](#heading-what-happens-in-the-dns-system-when-you-buy-a-new-domain)
...
![DNS Resolution System Diagram](https://cdn.hashnode.com/res/hashnode/image/upload/v1746995157651/f0f9913b-a23a-4654-bea5-c9d8a8e4f7ca.png align="center")
...
![DNS Resolution Process in Action using dig tool](https://cdn.hashnode.com/res/hashnode/image/upload/v1747000331356/8735cac3-5a22-48c2-9691-62ed6d8fb885.png align="center")
