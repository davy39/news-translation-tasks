...
* [Components of Multi-Account Setup](#heading-components-of-multi-account-setup)
    
* [How to Automate a Multi-Account Strategy](#heading-how-to-automate-a-multi-account-strategy)
    
* [AWS Organization Structure](#heading-aws-organization-structure)
    
* [Deployment Architecture](#heading-deployment-architecture)
    
* [OverView of CI/CD Components](#heading-overview-of-cicd-components)
    
* [CI/CD Deployment Process Explained](#heading-cicd-deployment-process-explained)
    
* [How to Automate Landing Zone Creation](#heading-how-to-automate-landing-zone-creation)
    
* [How to Create an Organizational Unit](#heading-how-to-create-an-organizational-unit)
    
* [How to Automate Attaching Control Tower Control to the OU](#heading-how-to-automate-attaching-control-tower-control-to-the-ou)
...
* Enabled cross-account [security audits](https://docs.aws.amazon.com/general/latest/gr/aws-security-audit-guide.html) using IAM Identity Center.
...
The AWS Control Tower [`CreateLandingZone`](https://docs.aws.amazon.com/controltower/latest/APIReference/API_CreateLandingZone.html) API needs a landing zone version and a manifest file as input parameters. Below is an example **LandingZoneManifest.json** manifest.
...
You can find the full code here: [https://github.com/nitheeshp-irl/aws-landing-zone](https://github.com/nitheeshp-irl/aws-landing-zone).

## **How to Create an Organizational Unit**

When you run this code, different organizational units (OUs) are created according to the specifications in the [variable](https://github.com/nitheeshp-irl/aws-orgunits/blob/main/variables.auto.tfvars) file.
...
After creating the required objects, you can attach controls to the OU if you need them. Here is the [`main.tf`](https://github.com/nitheeshp-irl/controltower_controls/blob/main/main.tf) file:
...
* [Terraform Repo for Creating control tower controls](https://github.com/nitheeshp-irl/controltower_controls)
    
* [Terraform Module for creating Control Tower Controls](https://github.com/nitheeshp-irl/blog-terraform-modules/tree/main/awscontroltower-controls_module)
