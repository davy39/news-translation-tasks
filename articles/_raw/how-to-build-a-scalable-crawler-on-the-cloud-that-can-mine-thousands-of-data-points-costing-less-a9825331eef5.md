---
title: How I built a serverless web crawler to mine Vancouver real estate data at
  scale
subtitle: ''
author: freeCodeCamp
co_authors: []
...
Once you get used to the whole Lambda developing dance: `edit Python files locally` -&g`t; create a .zip pack`age `-> uploa`d that to replace your Lambda Functi`on -> Save` and Test, it gets better.
