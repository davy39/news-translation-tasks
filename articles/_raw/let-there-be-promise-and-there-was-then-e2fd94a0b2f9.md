...
If you imagine how this would be useful in a real app, think of database requests, or API calls: **Authorize** -&g**t; getAcc**ess **-> Make** a post
...
_The full function — and all its nested callbacks — is way too big for me to show here._
