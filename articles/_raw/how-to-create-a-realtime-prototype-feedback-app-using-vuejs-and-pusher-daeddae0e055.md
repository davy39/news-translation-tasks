...
> _? T**he***`*created**` a**nd***`*mounted**` m**ethods are hooks that are called automatically during the creation of the Vue component. You can** l[**earn about the Vue lifecycle here.**](https://alligator.io/vuejs/component-lifecycle)****_
...
> _? R**emember to replace theP**`USHER_ID,`**P**`USHER_KEY,`**P**`USHER_SECRET` a**ndP**`USHER_CLUSTER` w**ith the values from your Pusher application.**_
...
If you have questions or feedback, please leave them as a comment below. The source code to the application is available on [GitHub](https://github.com/neoighodaro/Design-Prototype-Feedback-Application).

_This post first appeared on the [Pusher blog](https://blog.pusher.com/create-realtime-prototype-feedback-app-using-vuejs-pusher/)._
