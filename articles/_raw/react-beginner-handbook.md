...
And you can [download this handbook in PDF / ePub / Mobi format for free](https://flaviocopes.com/page/react-handbook/).

## Summary of the handbook
- [How much JavaScript you need to know to use React](#heading-how-much-javascript-you-need-to-know-to-use-react)
- [Why should you learn React?](#heading-why-should-you-learn-react)
- [How to install React](#heading-how-to-install-react)
- [React Components](#heading-react-components)
- [Introduction to JSX](#heading-introduction-to-jsx)
- [Using JSX to compose a UI](#heading-using-jsx-to-compose-a-ui)
- [The difference between JSX and HTML](#heading-the-difference-between-jsx-and-html)
- [Embedding JavaScript in JSX](#heading-embedding-javascript-in-jsx)
- [Managing state in React](#heading-managing-state-in-react)
- [Component Props in React](#heading-component-props-in-react)
- [Data flow in a React application](#heading-data-flow-in-a-react-application)
- [Handling user events in React](#heading-handling-user-events-in-react)
- [Lifecycle events in a React component](#heading-lifecycle-events-in-a-react-component)
...
`create-react-app` created a file structure in the folder you told it to (`todolist` in this case), and initialized a [Git](https://flaviocopes.com/git/) repository.
...
Remember that you can [download this handbook in PDF / ePub / Mobi format for free](https://flaviocopes.com/page/react-handbook/) if you want.
