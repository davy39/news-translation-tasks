...
* [So, What Exactly is the Cloud?](#heading-so-what-exactly-is-the-cloud)
    
    * [A Fun Metaphor](#heading-a-fun-metaphor)
        
* [Types of Clouds](#heading-types-of-clouds)
    
* [Cloud Service Models (IAAS, PAAS, SAAS)](#heading-cloud-service-models-iaas-paas-saas)
    
* [What is AWS?](#heading-what-is-aws)
    
    * [Why Do People Love AWS?](#heading-why-do-people-love-aws)
        
    * [AWS Cloud Architecture](#heading-aws-cloud-architecture)
        
    * [Key Components of AWS Cloud Architecture](#heading-key-components-of-aws-cloud-architecture)
        
    * [Shared Responsibility Model](#heading-shared-responsibility-model)
        
* [AWS Regions, Availability Zones, Edge Locations & Local Zones](#heading-aws-regions-availability-zones-edge-locations-amp-local-zones)
    
    * [Latency](#heading-latency)
        
    * [Ways to Access AWS Services](#heading-ways-to-access-aws-services)
        
* [AWS Calculator](#heading-aws-calculator)
...
![Cloud Service Models](https://cdn.hashnode.com/res/hashnode/image/upload/v1729157009842/088adbfa-1766-4c57-8150-b6856316ba62.jpeg align="center")
...
![AWS Shared Responsibility](https://cdn.hashnode.com/res/hashnode/image/upload/v1729157534482/562b3616-5339-4ec8-8ca3-540fdc48d9a4.png align="center")
...
You can find latest numbers about regions, AZs, edge locations and local zones [here](https://aws.amazon.com/about-aws/global-infrastructure/?p=ngi&loc=1)
...
The AWS Pricing [Calculator](https://calculator.aws/#/addService) isn’t just a budgeting tool, it’s your cloud co-pilot, helping you explore the potential of AWS without the financial surprises. Whether you’re experimenting with a single EC2 instance or planning a multi-service, enterprise-scale setup, this calculator can break down costs, project your savings, and give you peace of mind with a well-rounded view of your expenses.
