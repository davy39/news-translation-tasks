---
title: How to use your .bashrc file to do twice as much with half the keystrokes
subtitle: ''
...
In my [recent post about setting up Ubuntu with Bash scripts](https://victoria.dev/verbose/how-to-set-up-a-fresh-ubuntu-desktop-using-only-dotfiles-and-bash-scripts/), I briefly alluded to the magic of `.bashrc`. This didn’t really do it justice, so here’s a quick post that offers a bit more detail about what the Bash configuration file can do.
