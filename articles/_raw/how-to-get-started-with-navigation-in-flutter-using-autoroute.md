...
2. [What We Will Build](#heading-what-we-will-build)
    
3. [Step 1: Setting Up the Project](#heading-step-1-setting-up-the-project)
    
4. [Step 2: Organizing the Project Structure](#heading-step-2-organizing-the-project-structure)
    
5. [Step 3: Defining Routes with AutoRoute](#heading-step-3-defining-routes-with-autoroute)
    
    * [Breaking it down](#heading-breaking-it-down)
        
    * [Why do this before screens?](#heading-why-do-this-before-screens)
        
6. [Step 4: Generating Route Files](#heading-step-4-generating-route-files)
    
7. [Step 5: Setting Up AutoRoute in main.dart](#heading-step-5-setting-up-autoroute-in-maindart)
    
    * [Key Points](#heading-key-points)
        
8. [Step 6: Creating Screens](#heading-step-6-creating-screens)
    
    * [screen1.dart](#heading-screen1dart)
        
    * [Breaking it down](#heading-breaking-it-down-1)
        
    * [Repeating for Other Screens](#heading-repeating-for-other-screens)
        
    * [Why is this important?](#heading-why-is-this-important)
        
9. [Step 7: Control Screen](#heading-step-7-control-screen)
    
    * [Step-by-Step Breakdown](#heading-step-by-step-breakdown)
        
    * [How It Works Together](#heading-how-it-works-together)
        
10. [Screenshots](#heading-screenshots)
    
11. [Best Practices When Using AutoRoute](#heading-best-practices-when-using-autoroute)
...
* Flutter SDK installed and configured ([Flutter installation guide](https://docs.flutter.dev/get-started/install)).
...
[AutoRoute on pub.dev](https://pub.dev/packages/auto_route)
