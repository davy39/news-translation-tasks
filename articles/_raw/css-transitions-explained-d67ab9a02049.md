...
The thing is, few things move linearly in life. That’s not how real objects move. Sometimes, we accelerate; sometimes, we decelerate. The `transition-timing-function` allows you to capture all of that.
...
See the Pen [CSS Transition Timing Functions](https://codepen.io/zellwk/pen/gGZqNo/) by Zell Liew ([@zellwk](https://codepen.io/zellwk)) on [CodePen](https://codepen.io/).
...
<iframe height="500" width="500" style="width: 100%;" scrolling="no" title="CSS Transition (different transition speeds when transitioning in and out)" src="//codepen.io/zellwk/embed/GOLLyR/?height=265&theme-id=0&default-tab=css,result" frameborder="no" allowtransparency="true" allowfullscreen="true">
...
If you loved this article, you’ll love learn [Learn JavaScript](https://zellwk.com/learnjs/) — a course that helps you learn to **build real components from scratch** with JavaScript.

(Oh, by the way, if you liked this article, I’d appreciate it if you could [share it](http://twitter.com/share?text=CSS%20Transitions%20explained%20by%20%40zellwk%20?%20&url=https://zellwk.com/blog/css-transitions/&hashtags=). )

_Originally published at [zellwk.com](https://zellwk.com/blog/css-transitions/)._
