...
Open Keychain Access on your Mac and go to the Certificates category in your System keychain. Once there, import the `rootCA.pem` using File > Import Items. Double click the imported certificate and change the “When using this certificate:” dropdown **to Always Tr**ust in the Trust section.
...
I hope you found this tutorial useful. If you’re not comfortable with running the commands given here by yourself, I’ve created a set of handy scripts you can run quickly to generate the certificates for you. More details can be found on the [GitHub repo](https://github.com/dakshshah96/local-cert-generator/).

_I love helping fellow web developers. Follow me on [Twitter](https://twitter.com/dakshshah96) and let me know if you have any suggestions or feedback. If you’d like to show your appreciation towards any of the work I’ve done, be it a blog post, an open source project or just a funny tweet, you can [buy me a cup of coffee](https://www.buymeacoffee.com/dakshshah96)._
