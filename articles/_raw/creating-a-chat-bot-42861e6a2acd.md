...
My initial goal was to build a [IBM Watson](http://www.ibm.com/smarterplanet/us/en/ibmwatson/) type clone; something that could parse input in some form and sort out candidates from a data source. Initially I looked at [DBPedia](http://dbpedia.org/About) and [YAGO](http://en.wikipedia.org/wiki/YAGO_(database)).
...
In 2014 I started to focus on the [Loebner Prize](https://en.wikipedia.org/wiki/Loebner_Prize), an annual competition in artificial intelligence that awards prizes to the chatterbot considered by the judges to be the most human-like.
...
_Conversation Model — [http://vimeo.com/43677920](http://vimeo.com/43677920" rel="noopener" target="_blank" title=")_
...
```
exports.doILikeUser = function(cap, cb) {
