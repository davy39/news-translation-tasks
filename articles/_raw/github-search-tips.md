---
title: GitHub Search Tips – How to Search Issues, Repos, and More Effectively on GitHub
subtitle: ''
...
1. **[is:issue is:open label:beginner](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Abeginner&type=issues)** - This particular query will list all projects with issues that are open and labeled `beginner`.
2. **[is:issue is:open label:easy](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Aeasy&type=issues)** - This will list all open issues that are labeled `easy`.
3. **[is:issue is:open label:first-timers-only](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Afirst-timers-only&type=issues)** - This lists all open issues that welcome first-timer contributions.
4. **[is:issue is:open label:good-first-bug](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Agood-first-bug&type=issues)** - This lists projects with open issues labeled `good-first-bug`, to attract contributors to work on them.
5. **[is:issue is:open label:"good first issue"](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22&type=issues)** - This will list all open issues with the label `good first issue`, meaning it is good for place for beginners to get started.
6. **[is:issue is:open label:starter](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Astarter&type=issues)** - This lists all open issues from across GitHub that are labeled `starte`r.
7. **[is:issue is:open label:up-for-grabs](https://github.com/search?q=is%3Aissue+is%3Aopen+label%3Aup-for-grabs&type=issues)** - This lists open issues that are ready to be worked on if you have the necessary skills.
8. **[no:project type:issue is:open](https://github.com/search?q=no%3Aproject+type%3Aissue+is%3Aopen&type=issues)** - This will list all open issues that are not assigned to a specific project.
9. **[no:milestone type:issue is:open](https://github.com/search?q=no%3Amilestone+type%3Aissue+is%3Aopen&type=issues)** - Many times, projects are tracked with milestones. But if you want to find issues that are not tracked, this search query will list those projects for you.
10. **[no:label type:issue is:open](https://github.com/search?q=no%3Alabel+type%3Aissue+is%3Aopen&type=issues)** - This lists all open issues that are not labeled.
11. **[is:issue is:open no:assignee](https://github.com/search?q=is%3Aissue+is%3Aopen+no%3Aassignee&type=issues)** - This shows all open issues that have not yet been assigned to a person.
...
To make it easier for you to find projects with right licenses you need to have a good understanding of licenses. You can read more about them [here](https://www.freecodecamp.org/news/how-open-source-licenses-work-and-how-to-add-them-to-your-projects-34310c3cf94/).
...
For additional resources and more search parameters, you can always refer to the [GitHub Docs](https://docs.github.com/en/search-github/searching-on-github) or make use of [Advanced GitHub Search](https://github.com/search/advanced?). These methods will always come in handy as they offer more filering options.
