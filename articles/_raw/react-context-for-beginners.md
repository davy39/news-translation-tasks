...
* [When should you use React context?](#heading-when-should-you-use-react-context)
* [What problems does React context solve?](#heading-what-problems-does-react-context-solve)
* [How do I use React context?](#heading-how-do-i-use-react-context)
* [What is the useContext hook?](#heading-what-is-the-usecontext-hook)
* [You may not need context](#heading-you-may-not-need-context)
* [Does React context replace Redux?](#heading-does-react-context-replace-redux)
* [React context caveats](#heading-react-context-caveats)
...
_What is the issue with this example?_
...
_Does all this sound confusing?_ It's simpler than you think.
...
_The benefit of the useContext hook is that it makes our components more concise and allows us to create our own custom hooks._
...
_In short: don't reach for context right away. See if you can better organize your components to avoid prop drilling._
...
However, if you are not also _updating_ state, but merely passing it down your component tree, you do not need a global state management library like Redux.

## React context caveats

_Why it is not possible to update the value that React context passes down?_
...
If you are passing down an object on your React context provider and any property on it updates, what happens? _Any component which consumes that context will re-render._
...
If you want an even more in-depth grasp of how to use React context to build amazing React projects, check out [The React Bootcamp](https://www.thereactbootcamp.com).
