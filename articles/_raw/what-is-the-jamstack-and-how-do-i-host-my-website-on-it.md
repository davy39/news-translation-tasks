...
* [What is this JAMstack?](#heading-what-is-this-jamstack)
* [That’s not to be confused with serverless](#heading-thats-not-to-be-confused-with-serverless)
* [What makes up the JAMstack?](#heading-what-makes-up-the-jamstack)
* [So what makes a JAMstack app so great?](#heading-so-what-makes-a-jamstack-app-so-great)
* [Is my website considered to be on the JAMstack?](#heading-is-my-website-considered-to-be-on-the-jamstack)
* [What are some examples of JAMstack?](#heading-what-are-some-examples-of-jamstack)
* [What are some tools I can use to build JAMstack sites or apps?](#heading-what-are-some-tools-i-can-use-to-build-jamstack-sites-or-apps)
...
_Bill and Ted play air guitars_
...
_"A Simple Component" example from [reactjs.org ](https://reactjs.org/)_
...
_Static output from Gatsby on AWS S3_
