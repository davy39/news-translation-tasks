...
* [What Are Git Aliases?](#heading-what-are-git-aliases)
    
* [How to Add Git Aliases Via the Global Git Configuration File (Recommended)](#heading-how-to-add-git-aliases-via-the-global-git-configuration-file-recommended)
    
    * [How to Set Your Preferred Git Editor](#heading-how-to-set-your-preferred-git-editor)
        
    * [How to Open the Git Config File](#heading-how-to-open-the-git-config-file)
        
    * [How to Add a Git Alias Via Your Config File](#heading-how-to-add-a-git-alias-via-your-config-file)
        
* [How to Add Aliases in the CLI](#heading-how-to-add-aliases-in-the-cli)
    
* [How to Create Custom Commands for More Complex Shortcuts](#heading-how-to-create-custom-commands-for-more-complex-shortcuts)
    
    * [How to Use Parameters in All Commands](#heading-how-to-use-parameters-in-all-commands)
        
* [Other Useful Aliases](#heading-other-useful-aliases)
...
As always if you want to chat about it, or hear about future articles you can follow me on [Twitter](https://x.com/grantdotdev).
