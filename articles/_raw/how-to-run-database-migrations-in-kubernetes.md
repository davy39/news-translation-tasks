...
* [The challenge of migrations in Kubernetes](#heading-the-challenge-of-migrations-in-kubernetes)
    
* [Popular migration tools for Golang](#heading-popular-migration-tools-for-golang)
    
* [Run migrations inside the application](#heading-run-migrations-inside-the-application)
    
* [Run migrations in initContainers](#heading-run-migrations-in-initcontainers)
    
* [Run migrations as a Kubernetes Job](#heading-run-migrations-as-a-kubernetes-job)
    
* [Helm hooks](#heading-helm-hooks)
    
* [Best practices for Kubernetes migrations](#heading-best-practices-for-kubernetes-migrations)
...
By using [initContainers](https://kubernetes.io/docs/concepts/workloads/pods/init-containers/) in your Kubernetes Deployment, it will run the migration before the main application container starts. This is a good first solution for when scaling is not a problem yet.
...
You could create a [Kubernetes Job](https://kubernetes.io/docs/concepts/workloads/controllers/job/) that runs your migrations, and trigger that job during the deployment process before rolling out the application.
...
If you use Helm, it has [hooks](https://helm.sh/docs/topics/charts_hooks/) that you can use for running migrations during chart installation/upgrade. You just define a pre-install or pre-upgrade hook in your Helm chart.
