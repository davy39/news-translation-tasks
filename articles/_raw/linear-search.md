...
* [How to implement quick sort](https://guide.freecodecamp.org/certifications/coding-interview-prep/algorithms/implement-quick-sort/)
* [Binary search algorithm](https://guide.freecodecamp.org/algorithms/search-algorithms/binary-search/)
* [Jump search algorithm](https://guide.freecodecamp.org/algorithms/search-algorithms/jump-search/)
* [Search algorithms explained with examples](https://www.freecodecamp.org/news/search-algorithms-explained-with-examples-in-java-python-and-c/)
* [Implement a binary search algorithm in Java without recursion](https://www.freecodecamp.org/news/how-to-implement-a-binary-search-algorithm-in-java-without-recursion-67d9337fd75f/)
* [More info on search algorithms](https://guide.freecodecamp.org/algorithms/search-algorithms)
