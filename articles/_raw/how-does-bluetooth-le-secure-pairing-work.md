...
* [In This Guide, You’ll Learn](#heading-in-this-guide-youll-learn)
    
* [Pairing vs Bonding](#heading-pairing-vs-bonding)
    
* [The Security Manager (SM)](#heading-the-security-manager-sm)
    
* [L2CAP Layer and Channels](#heading-l2cap-layer-and-channels)
    
* [Pairing Methods](#heading-pairing-methods)
    
* [Terminologies Explained](#heading-terminologies-explained)
    
* [The Three Phases of LE Secure Pairing](#heading-the-three-phases-of-le-secure-pairing)
    
* [Cryptographic Functions](#heading-cryptographic-functions)
    
* [AES-CMAC: The Workhorse Behind Secure Pairing](#heading-aes-cmac-the-workhorse-behind-secure-pairing)
    
* [Wireshark Example: Seeing It in Action](#heading-wireshark-example-seeing-it-in-action)
...
![Relationship of the Security Manager to the rest of the LE Bluetooth architecture](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7fafea4f7b.png align="left")
...
![Bluetooth pairing feature exchange | Bluetooth® Technology Website](https://www.bluetooth.com/wp-content/uploads/2016/03/screen-shot-03-25-16-at-0223-pm.png align="left")
...
![Bluetooth LE L2CAP Frame Generation and Decoding - MATLAB & Simulink](https://www.mathworks.com/help/examples/bluetooth/win64/BLEL2CAPExample_01.png align="left")
...
![AES Encryption: What is it & How Does it Safeguard your Data?](https://content.nordlayer.com/uploads/How_encryption_works_1400x580_59f8b2cf11.webp align="left")
...
![Elliptic Curve Diffie-Hellman Protocol Analysis](https://homecrew.dev/images/ecdh.png align="left")
...
![Pairing initiated by Central](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7faff6e22b.png align="left")
...
![Pairing Phase 2 – Public Key Exchange](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7faff8e6d3.png align="left")
...
![Pairing Phase 2, authentication stage 1, successful Numeric Comparison](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7faff955b1.png align="left")
...
![Long Term Key calculation](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7faffe707c.png align="left")
...
![Pairing Phase 2, authentication stage 2, DHKey checks](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7faffec8a1.png align="left")
...
So Phase 2 isn’t just one step. It’s a carefully choreographed dance: exchange public keys, prove the math with confirm/random values, derive usable keys, and then double-check everything with DHKey checks. Only after all of that do the devices feel confident enough to move into encryption and Phase 3.
...
In the diagrams, this part always comes after a marker for “Start Encryption.” That’s important — nothing sensitive moves until the channel is already locked down. From there, one or both devices hand over keys, depending on what they agreed to share back in Phase 1.

Think of this like handing your trusted friend not just your house key, but also the code to your garage and maybe your mailbox. Each credential unlocks a different part of your relationship, and because they’re exchanged securely, nobody else can copy them.

![Transport specfic key distribution](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-61/out/en/image/167f7fafff2255.png align="left")
...
* [Bluetooth Core Spec Vol 3, Part H: Security Manager](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-60/out/en/host/security-manager-specification.html)
    
* [AES-CMAC Standard (NIST SP 800-38B)](https://csrc.nist.gov/publications/detail/sp/800-38b/final)
    
* [Elliptic Curve Cryptography Primer](https://cryptobook.nakov.com/asymmetric-key-ciphers/elliptic-curve-cryptography-ecc)
