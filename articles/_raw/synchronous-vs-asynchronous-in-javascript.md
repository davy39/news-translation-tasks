...
_Lines of code organized into functions logically_
...
_A step-by-step flow shows the execution order_
...
_Event loop - see the step-by-step execution_
...
Do you want more such quizzes? [Head over to this repository](https://github.com/atapas/promise-interview-ready) to practice more exercises.

In case you are stuck or need any clarifications, my DM is always [open on Twitter](https://twitter.com/tapasadhikary).
