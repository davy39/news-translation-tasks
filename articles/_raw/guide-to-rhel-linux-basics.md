...
1. [A Little Backstory](#heading-a-little-backstory)
    
2. [What Makes Linux Special?](#heading-what-makes-linux-special)
    
3. [Why Red Hat Enterprise Linux?](#heading-why-red-hat-enterprise-linux)
    
4. [How to Set Up Your Practice Environment for Linux Commands](#heading-how-to-set-up-your-practice-environment-for-linux-commands)
    
5. [Introduction to Basic Linux Commands](#heading-introduction-to-basic-linux-commands)
...
If you want to explore the fascinating variety of Linux distros, you can check out this [Wikipedia page on Linux distributions](https://en.wikipedia.org/wiki/Linux_distribution) to see just how diverse the Linux ecosystem is.
...
* Install [VMware Workstation Player](https://blogs.vmware.com/workstation/2024/05/vmware-workstation-pro-now-available-free-for-personal-use.html) or [Oracle VirtualBox](https://www.virtualbox.org/wiki/Downloads?) on your computer.
...
Visit the [KillerCoda](https://killercoda.com/pawelpiwosz/course/linuxFundamentals) website and you will see scenario-based lessons.
