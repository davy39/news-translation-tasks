...
* [How does JavaScript execute programs?](#heading-how-does-javascript-execute-programs)
* [How JavaScript Parses/Compiles and Executes Code](#heading-how-javascript-parsescompiles-and-executes-code)
* [Understanding Syntax Error](#heading-syntax-error)
* [Understanding Variable/Function Hoisting](#heading-variablefunction-hoisting)
* [What is lexical scope](#heading-what-is-lexical-scope)?
...
_JS engine successfully finding a variable by going through each scope_
...
_JS engine throwing reference error_
...
_Understanding lexical scope with a coloring example_
