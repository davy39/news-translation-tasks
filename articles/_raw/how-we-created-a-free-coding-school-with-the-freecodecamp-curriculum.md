---
title: We Created a Local Free Coding School Using the freeCodeCamp Curriculum. Here's
  What We Learned.
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2020-06-09T01:53:17.000Z'
originalURL: https://freecodecamp.org/news/how-we-created-a-free-coding-school-with-the-freecodecamp-curriculum
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9a6b740569d1a4ca2582.jpg
tags:
- name: '2020'
  slug: '2020'
...
seo_desc: 'By Gwendolyn Faraday
  ...
  While this picture shows an in-person classroom, we have moved our school fully
  remote as a result of the COVID-19 situation.
...
This is why we created [freeCodeSchool Indy](https://freecodeschoolindy.com/). It's a free coding program based off of the freeCodeCamp curriculum where we guide students through part-time coding school programs for three months. 
...
[Here is our organization on Github](https://github.com/freecodeschoolindy). We are in the process of updating and open-sourcing our material as we go along.
...
We decided to whittle down the field by requiring people to show up for three pre-screening activities where they would complete some basic challenges, like [Code.org's Flappy Game](https://studio.code.org/flappy/1). This let us know which students were dedicated to showing up and got the number of people in line down to around 80. That was still too way too many for the space we had so had to do a random lottery to select the final students.
...
We also give them a link to the [freeCodeCamp code of conduct](https://www.freecodecamp.org/news/code-of-conduct/) because it's short, sweet, and to the point: be kind, understanding, etc.
...
Fortunately, I have a small following on [YouTube](https://www.youtube.com/c/FaradayAcademy), LinkedIn, and other platforms where I have been able to solicit volunteers and get some community interest in our program. 
...
![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screen-Shot-2020-06-08-at-10.10.27-PM.png)
_Discord screen sharing interface._
...
![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screen-Shot-2020-06-04-at-12.43.36-PM.png)
...
I want to give special thanks to [Jared Wilcurt](https://thejaredwilcurt.com/), Casssandra Bautista, Marianne Mckenzie, [The Indianapolis Public Library](https://www.indypl.org/), freeCodeCamp, and all of our wonderful volunteers – all of whom were crucial in putting this program together.
...
My Twitter: [@gwen_faraday](https://twitter.com/gwen_faraday)

My YouTube: [Faraday Academy](https://www.youtube.com/c/FaradayAcademy)

Program Website: [freecodeschoolindy.com](https://freecodeschoolindy.com/)
