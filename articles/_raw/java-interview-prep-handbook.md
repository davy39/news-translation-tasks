...
1. [What is Java?](#heading-1-what-is-java)
2. [What's the difference between the JDK, JRE, and JVM?](#heading-2-whats-the-difference-between-the-jdk-jre-and-jvm)
3. [How does the 'public static void main(String[] args)' method work?](#heading-3-how-does-the-public-static-void-mainstring-args-method-work)
4. [What is bytecode in Java?](#heading-4-what-is-bytecode-in-java)
5. [Differentiate between overloading and overriding](#heading-5-differentiate-between-overloading-and-overriding)
6. [What is the Java ClassLoader?](#heading-6-what-is-the-java-classloader)
7. [Can we override static methods in Java?](#heading-7-can-we-override-static-methods-in-java)
8. [How does the 'finally' block differ from the 'finalize' method in Java?](#heading-8-how-does-the-finally-block-differ-from-the-finalize-method-in-java)
9. [What is the difference between an abstract class and an interface?](#heading-9-what-is-the-difference-between-an-abstract-class-and-an-interface)
10. [Explain the concept of Java packages](#heading-10-explain-the-concept-of-java-packages)
11. [What are Java annotations?](#heading-11-what-are-java-annotations)
12. [How does multi-threading work in Java?](#heading-12-how-does-multi-threading-work-in-java)
13. [Use `throw` to raise an exception](#heading-13-use-throw-to-raise-an-exception)
14. [Use `throws` to declare exceptions](#heading-14-use-throws-to-declare-exceptions)
15. [What is the significance of the transient keyword?](#heading-15-what-is-the-significance-of-the-transient-keyword)
16. [How do you ensure thread safety in Java?](#heading-16-how-do-you-ensure-thread-safety-in-java)
17. [Explain the Singleton pattern](#heading-17-explain-the-singleton-pattern)
18. [What are Java Streams?](#heading-18-what-are-java-streams)
19. [What are the primary differences between ArrayList and LinkedList?](#heading-19-what-are-the-primary-differences-between-arraylist-and-linkedlist)
20. [How do HashSet, LinkedHashSet, and TreeSet differ?](#heading-20-how-do-hashset-linkedhashset-and-treeset-differ)
21. [Differentiate between HashMap and ConcurrentHashMap](#heading-21-differentiate-between-hashmap-and-concurrenthashmap)
22. [Describe the contract between hashCode() and equals() methods](#heading-22-describe-the-contract-between-the-hashcode-and-equals-methods)
23. [What is Java reflection?](#heading-23-what-is-java-reflection)
24. [How do you create a custom exception in Java?](#heading-24-how-do-you-create-a-custom-exception-in-java)
25. [What is the difference between a checked and unchecked exception?](#heading-25-what-is-the-difference-between-a-checked-and-unchecked-exception)
26. [What are generics? Why are they used?](#heading-26-what-are-generics-why-are-they-used)
27. [Explain the concept of Java Lambda Expressions](#heading-27-explain-the-concept-of-java-lambda-expressions)
28. [What is the diamond problem in inheritance?](#heading-28-what-is-the-diamond-problem-in-inheritance)
29. [Describe the difference between fail-fast and fail-safe iterators](#heading-29-describe-the-difference-between-fail-fast-and-fail-safe-iterators)
30. [What is type erasure in Java generics?](#heading-30-what-is-type-erasure-in-java-generics)
31. [Describe the differences between StringBuilder and StringBuffer](#heading-31-describe-the-differences-between-stringbuilder-and-stringbuffer)
32. [What is the volatile keyword in Java?](#heading-32-what-is-the-volatile-keyword-in-java)
33. [Explain the Java memory model](#heading-33-explain-the-java-memory-model)
34. [What is the purpose of the default keyword in interfaces?](#heading-34-what-is-the-purpose-of-the-default-keyword-in-interfaces)
35. [How does switch differ in Java 7 and Java 8?](#heading-35-how-does-switch-differ-in-java-7-and-java-8)
36. [Explain the concept of Autoboxing and Unboxing](#heading-36-explain-the-concept-of-autoboxing-and-unboxing)
37. [Describe the @FunctionalInterface annotation](#heading-37-describe-the-functionalinterface-annotation)
38. [How can you achieve immutability in Java?](#heading-38-how-can-you-achieve-immutability-in-java)
39. [What is the decorator pattern?](#heading-39-what-is-the-decorator-pattern)
40. [Explain the Java I/O streams](#heading-40-explain-java-io-streams)
41. [How does the garbage collector work in Java?](#heading-41-how-does-the-garbage-collector-work-in-java)
42. [What are the benefits of using Java NIO?](#heading-42-what-are-the-benefits-of-using-java-nio)
43. [Explain the Observer pattern](#heading-43-explain-the-observer-pattern)
44. [What is the purpose of Java's Optional?](#heading-44-explain-the-purpose-of-the-this-keyword)
45.  [Explain Java's try-with-resources](#heading-45-explain-javas-try-with-resources)
46. [Explain the difference between C++ and Java](#heading-46-explain-the-difference-between-c-and-java)
47. [What is polymorphism? Provide an example](#heading-47-what-is-polymorphism-provide-an-example)
48. [How can you avoid memory leaks in Java?](#heading-48-how-can-you-avoid-memory-leaks-in-java)
49. [Explain the purpose of Java's synchronized block](#heading-49-explain-the-purpose-of-javas-synchronized-block)
50. [Explain the concept of modules in Java](#50-explain-the-concept-of-modules-in-java-)
