...
* [What is i18n, and Why Use It?](#heading-what-is-i18n-and-why-use-it)
    
* [Let’s dive right in](#heading-lets-dive-right-in)
    
* [Step 1: How to Set Up the Project](#heading-step-1-how-to-set-up-the-project)
    
* [Step 2: How to Set Up Internationalization with i18next](#heading-step-2-how-to-set-up-internationalization-with-i18next)
    
* [Step 3: How to Build Components](#heading-step-3-how-to-build-components)
    
* [Step 4: Main App Component](#heading-step-4-main-app-component)
...
1. Basic Knowledge of React - You should understand how to create components, manage state, and use Hooks like `useState` and `useEffect`. If you’re new to React, I recommend starting with [the official React docs](https://react.dev/) [for a solid foundation](https://react.dev/).
...
3. Tailwind CSS - We'll use Tailwind CSS for styling. It's a utility-first CSS framework that helps you build modern, responsive designs without leaving your HTML. If you’re unfamiliar, check out [Tailwind's documentatio](https://tailwindcss.com/docs/installation)[n.](https://tailwindcss.com/docs/installation)
    
4. Node.js - Make sure Node.js is installed on your system to handle dependencies. You can download the latest version from [Node.js](https://nodejs.org/).
...
2. Localization Library: [react-i18next](https://www.i18next.com/)
    
3. Icons Library: [hero-icons](https://www.npmjs.com/package/heroicons)
...
![Image of React and Typescript installation](https://cdn.hashnode.com/res/hashnode/image/upload/v1733093238523/2d3ee169-bc99-4498-9779-b07067d5e5ee.png align="center")
...
Create an `i18n.tsx` file in the `src` folder and configure i18next:
...
Import this file into the `main.tsx` file:
...
In the `public/locales` directory, create subfolders for each language (for example, `en`, `fr`) and include `translation.json` files:
...
![Image of folder structure of translation files](https://cdn.hashnode.com/res/hashnode/image/upload/v1733095771585/21cbb0f9-e767-426e-8fc6-2bb4e7abc5ef.png align="center")

## Step 3: How to Build Components

Create a `components` folder in the `src` directory and add the following components:
...
![Image of the app running on localhost](https://cdn.hashnode.com/res/hashnode/image/upload/v1733099671232/67419cbe-ed58-4bb4-9e44-67de2ffa9be4.png align="center")

Check out the [live demo](https://multilingual-demo.vercel.app/) and the source code on [GitHub](https://github.com/timmy471/multilingual-demo)
