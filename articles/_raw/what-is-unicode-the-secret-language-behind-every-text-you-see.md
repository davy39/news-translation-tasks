...
co_authors: []
series: null
date: '2025-07-31T13:50:08.421Z'
originalURL: https://freecodecamp.org/news/what-is-unicode-the-secret-language-behind-every-text-you-see
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1753969659647/1f49bf21-9be3-4e60-861f-50c714d7ae87.png
tags:
...
- name: unicode
  slug: unicode
seo_title: null
seo_desc: "Have you ever sent a message with an emoji? Read a blog in another language?\
  \ Or copied some strange symbol from the internet? \nAll of these are possible because\
  \ of something called Unicode. \nUnicode is a powerful system that lets computers\
  \ understand..."
---
...
All of these are possible because of something called [**Unicode**](https://en.wikipedia.org/wiki/Unicode). 
...
* [The Problem Before Unicode](#heading-the-problem-before-unicode)
    
* [What Is Unicode?](#heading-what-is-unicode)
    
* [How Does Unicode Work](#heading-how-does-unicode-work)
    
    * [What Are Unicode Encodings?](#heading-what-are-unicode-encodings)
        
    * [Code Points, Characters, and Glyphs](#heading-code-points-characters-and-glyphs)
        
* [Unicode in Programming](#heading-unicode-in-programming)
    
* [Why Unicode Matters](#heading-why-unicode-matters)
...
For example, English text used [ASCII](https://en.wikipedia.org/wiki/ASCII), while others used ISO-8859, Shift-JIS, and more.
...
Unicode is a standard system that assigns a unique number, called a code point, to every character. It includes letters, numbers, emojis, symbols, and even [invisible control characters](https://invisible-characters.com/).
...
Take [Python](https://www.freecodecamp.org/news/an-animated-introduction-to-programming-with-python/), for instance. It natively supports Unicode strings:
...
In [JavaScript](https://www.freecodecamp.org/news/what-is-javascript-definition-of-js/), Unicode enables developers to use characters from virtually any script:
...
Behind the scenes, the [Unicode Consortium](https://www.unicode.org/consortium/consort.html), made up of industry giants like Google, Apple, and Microsoft, regularly updates the standard. They decide which new characters and emojis make it into our digital vocabulary. 
...
[Join my newsletter](https://blog.manishshivanandhan.com/) for a summary of my articles every Friday. You can also [connect with me on Linkedin](https://linkedin.com/in/manishmshiva).
