---
title: Responsive Web Design – How to Make a Website Look Good on Phones and Tablets
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
[According to Statistica](https://www.statista.com/statistics/275814/mobile-share-of-organic-search-engine-visits/), as of 2019, 61% of all Google search visits take place on a mobile device. In September of 2020 [Google will change its search algorithm](https://webmasters.googleblog.com/2020/03/announcing-mobile-first-indexing-for.html) to prioritize mobile friendly websites.
...
_Figure 1: Mobile flexbox grid example_

![Image](https://www.freecodecamp.org/news/content/images/2020/07/grid-desktop.png)
_Figure 2: Desktop flexbox grid example_
...
5. We establish [native lazy loading](https://web.dev/native-lazy-loading/) by utilizing the `loading="lazy"` attribute / value pair.
...
[This article provides a solid demonstration](https://css-tricks.com/fluid-width-video/) about how to achieve "fluid" width videos. Let's take a look at the code and break it down.
...
_Figure 3: Chrome DevTools mobile and tablet device emulation_
...
[Foo uses Lighthouse behind the scenes to monitor website performance and provides feedback for analysis](https://www.foo.software/lighthouse/). You can setup monitoring for both desktop and mobile devices to get continuous feedback about how responsive your website is. 
...
_Figure 4: Lighthouse report with mobile device emulation_
