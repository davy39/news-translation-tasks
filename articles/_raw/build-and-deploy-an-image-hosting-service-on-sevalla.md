...
In this article, we’ll build a complete image hosting service using [Node.js](https://nodejs.org/en) and Express, connect it to object storage, and finally, deploy the whole project to [Sevalla](https://sevalla.com/).
...
* [What is Object Storage?](#heading-what-is-object-storage)
    
* [What We Will Be Building](#heading-what-we-will-be-building)
    
* [How to Set Up the Project](#heading-how-to-set-up-the-project)
    
* [How to Create Your Object Storage](#heading-how-to-create-your-object-storage)
    
* [How to Deploy Your Project on Sevalla](#heading-how-to-deploy-your-project-on-sevalla)
    
* [Why This Project Matters](#heading-why-this-project-matters)
...
[Amazon S3](https://aws.amazon.com/s3/) is the industry standard for object storage, offering massive scale, global replication, and advanced features, but it comes with added complexity and often unpredictable costs. Sevalla’s object storage, on the other hand, is designed for developers who want the same durability and scalability without the steep learning curve.
...
Let us start by setting up a Node.js project. You can [clone this repository](https://github.com/manishmshiva/image-host) if you don’t want to setup the project from scratch.
...
[Login](https://app.sevalla.com/login) to Sevalla and click “Object Storage”. Click “Create Object Storage” and give it a name.
...
Go to [http://localhost:3000/](http://localhost:3000/) and try uploading a file. It should give you the URL to view the file after a successful upload.
...
First, push your project to GitHub or [fork my repository](https://github.com/manishmshiva/image-host). Then log in to your Sevalla dashboard and create a new application.
