...
* [What Is a Controlled Component?](#heading-what-is-a-controlled-component)
    
* [What Is an Uncontrolled Component?](#heading-what-is-an-uncontrolled-component)
    
* [Controlled vs Uncontrolled: What's the Difference?](#heading-controlled-vs-uncontrolled-whats-the-difference)
    
* [When to Use Controlled vs Uncontrolled Components](#heading-when-to-use-controlled-vs-uncontrolled-components)
    
    * [Use Controlled Components When:](#heading-use-controlled-components-when)
        
    * [Use Uncontrolled Components When:](#heading-use-uncontrolled-components-when)
