---
title: 'SQL Joins Tutorial: Cross Join, Full Outer Join, Inner Join, Left Join, and
  Right Join.'
subtitle: ''
author: freeCodeCamp
co_authors: []
...
* [What is a join?](#heading-what-is-a-join)
* [Setting up your database](#heading-setting-up-your-database)
* `[CROSS JOIN](#heading-cross-join)` 
* [Setting up our example data (directors and movies)](#heading-creating-directors-and-movies)
* `[FULL OUTER JOIN](#heading-full-outer-join)`
* `[INNER JOIN](#heading-inner-join)`
* [`LEFT JOIN` / `RIGHT JOIN`](#heading-left-join-right-join)
* [Filtering using `LEFT JOIN`](#heading-filtering-using-left-join)
* [Multiple joins](#heading-multiple-joins)
* [Joins with extra conditions](#heading-joins-with-extra-conditions)
* [The reality about writing queries with joins](#heading-the-reality-about-writing-queries-with-joins)
...
To begin, let's create our database. With PostgreSQL already [installed](https://www.postgresql.org/download/), we can run the command `createdb <database-name>` at our terminal to create a new database. I called mine `fcc`:
...
To make this date range, we can use the `[generate_series](https://www.postgresql.org/docs/current/functions-srf.html)` function:
...
> **Note:** if you're unfamiliar with `NULL` values, [see my explanation here](https://www.freecodecamp.org/news/sql-operators-tutorial/#dealing-with-missing-data-null-) in this SQL operator tutorial.
...
(If you're unfamiliar with all of the ways you can filter a SQL query, check out the [previously mentioned article here](https://www.freecodecamp.org/news/sql-operators-tutorial/).)
...
If you liked this post, you can [follow me on twitter](https://twitter.com/johnmosesman) where I talk about database things and all other topics related to development.
