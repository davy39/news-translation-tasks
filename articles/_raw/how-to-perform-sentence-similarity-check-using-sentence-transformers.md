...
[Sentence Transformers](https://sbert.net/) make this process simple and efficient. In this guide, you will learn what sentence similarity is, how Sentence Transformers work, and how to write code to measure similarity between two sets of sentences.

## Table of Contents

* [What Is Sentence Similarity?](#heading-what-is-sentence-similarity)
    
* [Why Use Sentence Transformers](#heading-why-use-sentence-transformers)
    
* [Loading a Pre-trained Model](#heading-loading-a-pre-trained-model)
    
* [Defining Sentences to Compare](#heading-defining-sentences-to-compare)
    
* [Converting Sentences into Embeddings](#heading-converting-sentences-into-embeddings)
    
* [Calculating Cosine Similarity](#heading-calculating-cosine-similarity)
    
* [Printing the Results](#heading-printing-the-results)
    
* [Sample Output](#heading-sample-output)
    
* [How to Interpret the Scores](#heading-how-to-interpret-the-scores)
    
* [Real-World Applications of Sentence Similarity](#heading-real-world-applications-of-sentence-similarity)
    
    * [Semantic Search](#heading-semantic-search)
        
    * [Duplicate Detection](#heading-duplicate-detection)
        
    * [Recommendation Systems](#heading-recommendation-systems)
        
    * [Chatbots and Virtual Assistants](#heading-chatbots-and-virtual-assistants)
        
    * [Improving Performance with Larger Models](#heading-improving-performance-with-larger-models)
...
Traditional methods like [Bag of Words](https://www.freecodecamp.org/news/how-bag-of-words-works/) relied on simple word matching or frequency counts. But these fail when words differ but the meaning stays the same.

Sentence Transformers solve this by using transformer-based language models like [BERT](https://en.wikipedia.org/wiki/BERT_%28language_model%29) or RoBERTa to create embeddings.

An [embedding](https://www.freecodecamp.org/news/understanding-word-embeddings-the-building-blocks-of-nlp-and-gpts/) is a list of numbers that represents the meaning of a sentence. When two embeddings are close together in this high-dimensional space, their sentences are similar in meaning.
...
The `convert_to_tensor=True` argument tells the model to return [PyTorch tensors](https://docs.pytorch.org/tutorials/beginner/introyt/tensors_deeper_tutorial.html), which work well with similarity calculations.

## Calculating Cosine Similarity

Once you have embeddings, you need a way to measure similarity. The [cosine similarity](https://www.youtube.com/watch?v=zcUGLp5vwaQ) metric is commonly used for this.
...
The [all-MiniLM-L6-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) model is fast and accurate for small to medium tasks.

For more accuracy, you can try larger models like [all-mpnet-base-v2](https://huggingface.co/sentence-transformers/all-mpnet-base-v2), though they may require more memory and time to run.
