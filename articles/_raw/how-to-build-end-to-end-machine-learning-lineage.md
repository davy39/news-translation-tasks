...
1. [What is Machine Learning Lineage?](#heading-what-is-machine-learning-lineage)
    
2. [What We’ll Build](#heading-what-well-build)
    
    * [The System Architecture - AI Pricing for Retailers](#heading-the-system-architecture-ai-pricing-for-retailers)
        
    * [The ML Lineage](#heading-the-ml-lineage)
        
3. [Workflow in Action](#heading-workflow-in-action)
...
5. [Step 2: The ML Lineage](#heading-step-2-the-ml-lineage)
    ...
    * [Stage 1: The ETL Pipeline](#heading-stage-1-the-etl-pipeline)
        
    * [Stage 2: The Data Drift Check](#heading-stage-2-the-data-drift-check)
        
    * [Stage 3: Preprocessing](#heading-stage-3-preprocessing)
        
    * [Stage 4: Tuning the Model](#heading-stage-4-tuning-the-model)
        
    * [Stage 5: Performing Inference](#heading-stage-5-performing-inference)
        
    * [Stage 6: Assessing Model Risk and Fairness](#heading-stage-6-assessing-model-risk-and-fairness)
        
    * [Test in Local](#heading-test-in-local)
...
7. [Step 4: Configuring Scheduled Run with Prefect](#heading-step-4-configuring-scheduled-run-with-prefect)
    ...
    * [Configuring the Docker Image Registry](#heading-configuring-the-docker-image-registry)
        
    * [Configure Prefect Tasks and Flows](#heading-configure-prefect-tasks-and-flows)
        
    * [Test in Local](#heading-test-in-local-1)
        
8. [Step 5: Deploying the Application](#heading-step-5-deploying-the-application)
    
    * [Test in Local](#heading-test-in-local-2)
...
In this project, I’ll integrate an ML lineage into [this price prediction system built on AWS Lambda architecture](https://levelup.gitconnected.com/building-a-dynamic-pricing-system-with-a-multi-layered-neural-network-c2a4c70bfcec) using DVC, an open-source version control system for ML applications.

The below diagram illustrates the system architecture and the ML lineage we’ll integrate:

![Figure A. A comprehensive ML lineage for an ML application on serverless Lambda (Created by Kuriko IWAI)](https://cdn.hashnode.com/res/hashnode/image/upload/v1759825040233/5027e5dd-a2fc-4d35-b7a3-4d9184f5f179.png align="center")

**Figure A:** A comprehensive ML lineage for an ML application on serverless Lambda (Created by [Kuriko IWAI](https://kuriko-iwai.vercel.app/))
...
If you want to see how to build this from the ground up, you can follow along with my tutorial [How to Build a Machine Learning System on Serverless Architecture](https://www.freecodecamp.org/news/how-to-build-a-machine-learning-system-on-serverless-architecture/).
...
After [generating an API token from the EventlyAI workplace,](https://docs.evidentlyai.com/quickstart_ml#1-1-set-up-evidently-cloud) we’ll add a Python script to detect data drift and store the results in the `metrics` variable:
...
![Figure B. Screenshot of the Evently workspace dashboard](https://cdn-images-1.medium.com/max/1440/0*2C1ICzvVazAUH7fk.png align="left")
...
DVC offers [various storage types](https://dvc.org/doc/user-guide/data-management/remote-storage#supported-storage-types) like AWS S3 and Google Cloud. We’ll use AWS S3 for this project but your choice depend on the project ecosystem, your familiarity with the tool, and any resource constraints.
...
![Figure C. Screenshot of the DVC remote in AWS S3 bucket](https://cdn-images-1.medium.com/max/1440/0*yl9N4P8LNI7d_G_z.png align="left")
...
![Figure D. The screenshot of the Prefect dashboard](https://miro.medium.com/v2/resize:fit:1260/0*pUJppTJ4MloU2DVr.png align="left")
...
You can learn more here: [Integrating the infrastructure CI/CD pipeline to an ML application](https://medium.com/towards-artificial-intelligence/integrating-ci-cd-pipelines-to-machine-learning-applications-f5657c7fa164)

All code is available in [my GitHub repository](https://github.com/krik8235/ml-sales-prediction).

The mock app is available [here](https://kuriko-iwai.vercel.app/online-commerce-intelligence-hub).
...
**You can check out my** [**Portfolio**](https://kuriko-iwai.vercel.app/) **/** [**Github**](https://github.com/krik8235)**.**
