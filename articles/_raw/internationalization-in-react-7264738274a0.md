...
What this babel plugin does is it extract all the string messages in your application that are defined using either **defineMessages**, **<FormattedMessa**ge>**;, or <FormattedHTM**LMessage>.

(Note that **defineMessages**, **<FormattedMessa**ge>**, and <FormattedHTM**LMessage> are all named exports of the React Intl package).
