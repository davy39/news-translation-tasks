...
Make sure you do this step _before_ you are stuck without Internet access.

1. Install [Python pip](https://pip.pypa.io/en/stable/installing/).
2. Make a copy of [this repository](https://github.com/kylemcdonald/FreeWifi) and install dependencies for the script we will be using:
...
_This post is dedicated to Lauren McCarthy, who has taught me the most about the art of getting a good deal._
