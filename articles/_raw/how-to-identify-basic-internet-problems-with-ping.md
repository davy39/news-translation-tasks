---
title: How to Identify Basic Internet Problems with the Ping Command
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
So what would happen if I could not connect to `Google.com`? For example #1, I simulate a broken network connection to my Mac by unplugging my router from the wall, and re-run the command. The first thing I notice is that it takes a _lot_ longer for the command to respond:
