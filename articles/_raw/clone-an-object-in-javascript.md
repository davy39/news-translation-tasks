---
title: JS Copy an Object – How to Clone an Obj in JavaScript
subtitle: ''
...
This means you need to be careful. The best option to implement deep cloning will be to use [Lodash](https://lodash.com/docs/#cloneDeep). You can then be sure that none of your data will be lost.
...
You can read [this article](https://medium.com/@pmzubar/why-json-parse-json-stringify-is-a-bad-practice-to-clone-an-object-in-javascript-b28ac5e36521) to understand why `JSON.parse(JSON.stringify())` is a bad practice to clone an object in JavaScript.
