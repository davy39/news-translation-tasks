---
title: How to Secure Your Home Wireless Infrastructure with Kismet and Python
subtitle: ''
...
I have a *Raspberry 4* with Ubuntu (focal) installed and decided to use the well-known [Kismet](https://www.kismetwireless.net/) to find out.
...
* [The saying 'Ask for forgiveness, not permission' doesn't apply here](#heading-the-saying-ask-for-forgiveness-not-permission-doesnt-apply-here)
    
* [Getting to know your hardware](#heading-getting-to-know-your-hardware)
...
The *kismet\_home\_alerts.py* script will support two modes:
