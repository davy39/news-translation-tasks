---
title: Build a 100 Days of Code Discord Bot with TypeScript, MongoDB, and Discord.js
  13
subtitle: ''
...
> Note that discord.js has released version 14, which includes breaking changes. For compatibility with this tutorial, you will want to ensure you are using discord.js 13 - you can install this with `npm install discord.js@13`. If you have any questions, feel free to join my [discord server](https://chat.nhcarrigan.com). 
...
_Screenshot of the OAuth screen with the required settings._
...
_If you see this response, then you've successfully created your first command!_
...
_You should see your embed update, and a confirmation from the bot!_
