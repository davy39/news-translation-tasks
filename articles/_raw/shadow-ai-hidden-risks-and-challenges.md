...
* [1\. What is Shadow AI? 🤔](#heading-1-what-is-shadow-ai)
    
* [2\. The drivers behind Shadow AI 📝](#heading-2-the-drivers-behind-shadow-ai)
    
* [3\. Risks associated with Shadow AI 🪲](#heading-3-risks-associated-with-shadow-ai)
    
* [4\. Strategies to mitigate Shadow AI 🛡️](#heading-4-strategies-to-mitigate-shadow-ai)
    
* [5\. The future of Shadow AI 🤖](#heading-5-the-future-of-shadow-ai)
    
* [Conclusion: Managing the double-edged sword of Shadow AI 🧬](#heading-conclusion-managing-the-double-edged-sword-of-shadow-ai)
...
User-friendly platforms like AutoML and [DataRobot](https://www.datarobot.com/), and pre-trained models on platforms like [Hugging Face](https://huggingface.co/), allow non-technical users to create AI models or deploy AI solutions quickly. For example, a marketing analyst might use [Google AutoML](https://cloud.google.com/automl?hl=en) to predict customer churn by uploading purchase histories to train a model.
...
For example, a healthcare provider might use an unauthorized diagnostic AI tool, unknowingly uploading patient data to a non-compliant server, thereby violating regulations like [HIPAA](https://www.hhs.gov/hipaa/index.html) or GDPR and incurring substantial fines.
...
**Compliance example:** Provide pre-approved access to cloud-based AI platforms like [Google Cloud AI](https://cloud.google.com/products/ai?hl=en) or [Azure AI](https://azure.microsoft.com/en-us/solutions/ai), configured with organizational security and compliance policies.
...
You can follow me on [Twitter](https://x.com/SonyaMoisset), [LinkedIn](https://www.linkedin.com/in/sonyamoisset/) or [Linktree](https://linktr.ee/sonyamoisset). Remember to #**GetSecure**, #**BeSecure** & #**StaySecure**!
