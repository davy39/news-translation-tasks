...
co_authors: []
series: null
date: '2020-05-28T11:30:28.000Z'
originalURL: https://freecodecamp.org/news/lessons-learned-from-my-journey-as-a-self-taught-developer
coverImage: https://www.freecodecamp.org/news/content/images/2020/05/1_DAP7LzvAGemiogLG4lSnWA--1-.png
tags:
- name: Life lessons
  slug: life-lessons
...
seo_title: null
seo_desc: 'By Victor Cassone

  The path of the self-taught developer is tough and filled with uncertainty. There
  is no straight line from newbie to career programmer. Because of this, I believe
  all self-taught developers have a unique story to tell.
...
I knew very few people in Omaha, so I searched [Meetup.com](http://Meetup.com) to try and find other people interested in Android development. I found a Meetup focused on mobile development which covered both iOS and Android development and I decided to go.
...
Websites like [Meetup.com](http://Meetup.com) are great for finding monthly programming-specific groups. Even in a pandemic, there are still many virtual Meetups that are very informative and beneficial.
...
Thanks for reading. If you want to hear about other insights I've learned along the way, [follow my account Zero to Programmer on Twitter](https://twitter.com/zero2programmer). My goal is to help you learn programming more efficiently.
