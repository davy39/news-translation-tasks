...
Ashley Williams is one of the leaders of the Node.js community. She tweeted about a new package managers.
...
_[Dependency graph in case of flat dependencies](http://maxogden.com/nested-dependencies.html" rel="noopener" target="_blank" title=")_
...
_[Dependency graph in case of nested dependencies](http://maxogden.com/nested-dependencies.html" rel="noopener" target="_blank" title=")_
...
As [ashley williams](https://www.freecodecamp.org/news/javascript-package-managers-101-9afd926add0a/undefined) explains, [npm v2 installs dependencies in a nested manner](https://docs.npmjs.com/how-npm-works/npm2). That’s why npm v3 is considerably faster by comparison.
...
_This popular developer meme illustrates the problems with non-determinism._
...
> “To make it more clear, your `package.json` states **“what I want”** for the project whereas your lockfile says **“what I had”** in terms of dependencies. — [Dan Abramov](https://www.freecodecamp.org/news/javascript-package-managers-101-9afd926add0a/undefined)
