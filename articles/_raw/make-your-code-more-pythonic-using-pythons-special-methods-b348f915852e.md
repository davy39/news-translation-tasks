...
_Credit: [ke dickinson](https://www.flickr.com/photos/ke-dickinson/7159943526/in/photolist-bUGzLb-JXhz-8MMTUA-o8fGSq-9tdgxB-" rel="noopener" target="_blank" title=")_

Let’s say that we want to design an _encryption key_ which will be in turn encrypted with a _master key —_ and whose “plaintext” value will only be used “in flight” to encrypt and decrypt our data — but will otherwise only be stored encrypted.
...
_Credit: [Defence-Imagery via Pixabay](https://pixabay.com/en/users/Defence-Imagery-11/" rel="noopener" target="_blank" title=")_
...
_Originally published at [codetrips.com](https://codetrips.com/2016/07/22/python-magic-methods/) on July 22, 2016._
