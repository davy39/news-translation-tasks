...
If you want to contribute to open source projects like freeCodeCamp, first you’ll need to set up linting.
...
### **Setup Linting for freeCodeCamp**
...
4: In your Atom text editor, go to **Preferences** >**;> Insta**ll >&g**t; and type li**nter-eslint in the Search Packages search box
...
6: In your Free Code Camp directory, close out of any `<filename&`gt;.js files and and then re-open
