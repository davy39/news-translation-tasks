...
![Chatbot App UI using Spring AI, React, Docker by Vikas Rajput](https://cdn.hashnode.com/res/hashnode/image/upload/v1726657239698/5170bf73-b317-4281-bcd1-583454d4113f.png align="center")
...
* [Get Your OpenAI key](#heading-get-your-openai-key)
    
* [Build the REST API in Spring Boot](#heading-build-the-rest-api-in-spring-boot)
    
* [Build the ChatUI using Reactjs](#heading-build-the-chatui-using-reactjs)
    
* [How to Dockerize the Application](#heading-how-to-dockerize-the-application)
    
* [Run the Application](#heading-run-the-application)
    
* [Congratulations 🎉](#heading-congratulations)
...
![How to generate your OpenAI key](https://cdn.hashnode.com/res/hashnode/image/upload/v1726818120291/5f1681a0-fdbe-401e-ab4b-769fe38d7957.png align="center")
...
![Build Spring AI app using the spring initializer](https://cdn.hashnode.com/res/hashnode/image/upload/v1726662395429/cd4b07fd-2597-43bf-8038-1821003125bb.png align="center")
