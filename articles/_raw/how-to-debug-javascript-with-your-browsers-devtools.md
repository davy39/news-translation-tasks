...
**_Here comes the hack!_**

![:sparkles:](https://forum.freecodecamp.com/images/emoji/emoji_one/sparkles.png?v=2)

We must leverage `Source Maps` to assign a name to the JavaScript from our editor. Its pretty simple:

Lets say we are on the [Factorialize](https://www.freecodecamp.com/challenges/factorialize-a-number) challenge, and our code looks like this:
...
* [Beginner's guide to bug squashing](https://www.freecodecamp.org/news/the-beginner-bug-squashing-guide/)
* [Debugging tips and tricks for beginners](https://www.freecodecamp.org/news/debugging-javascript-for-beginners-5d4ac15dd1cd/)
* [How to get the most out of your browser's debugging console](https://www.freecodecamp.org/news/how-to-go-beyond-console-log-and-get-the-most-out-of-your-browsers-debugging-console-e185256a1115/)
