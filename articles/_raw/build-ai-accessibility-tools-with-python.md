---
title: How to Build AI Speech-to-Text and Text-to-Speech Accessibility Tools with
  Python
subtitle: ''
...
- name: AI
  slug: ai
seo_title: 'AI in Inclusive Education: Build Speech-to-Text and Text-to-Speech Too'
...
* [A Note on Missing Files](#heading-a-note-on-missing-files)
    
* [What Inclusive Education Really Means](#heading-what-inclusive-education-really-means)
    
* [Toolbox: Five AI Accessibility Tools Teachers Can Try Today](#heading-toolbox-five-ai-accessibility-tools-teachers-can-try-today)
    
* [Platform Notes (Windows vs macOS/Linux)](#heading-platform-notes-windows-vs-macoslinux)
    
* [Hands-On: Build a Simple Accessibility Toolkit (Python)](#heading-hands-on-build-a-simple-accessibility-toolkit-python)
    
* [Quick Setup Cheatsheet](#heading-quick-setup-cheatsheet)
    
* [From Code to Classroom Impact](#heading-from-code-to-classroom-impact)
    
* [Developer Challenge: Build for Inclusion](#heading-developer-challenge-build-for-inclusion)
    
* [Challenges and Considerations](#heading-challenges-and-considerations)
    
* [Looking Ahead](#heading-looking-ahead)
...
* **Python 3.8** or later versions installed (for Windows users, in case you don’t have it installed, you can download the latest version at: [python.org](http://python.org). macOS users usually already have `python3`).
    
* **Virtual environment** set up (`venv`) — recommended to keep things clean.
    
* **You have to install** [**FFmpeg**](https://www.gyan.dev/ffmpeg/builds/#) (This is required for Whisper to read audio files).
...
Some files are not included in the [GitHub repository](https://github.com/tayo4christ/inclusive-ai-toolkit). This is intentional, they are either generated automatically or should be created/installed locally:
...
1. [**Microsoft Immersive Reader**](https://support.microsoft.com/en-gb/office/use-immersive-reader-in-word-a857949f-c91e-4c97-977c-a4efcaf9b3c1) – Text-to-speech, reading guides, and translation.
    
2. [**Google Live Transcribe**](https://cloud.google.com/speech-to-text) – Real-time captions for speech/hearing support.
    
3. [**Otter.ai**](http://Otter.ai) – Automatic note-taking and summarization.
    
4. [**Grammarly**](https://www.grammarly.com/) **/** [**Quillbot**](https://quillbot.com/login?returnUrl=%2F&triggerOneTap=true) – Writing assistance for readability and clarity.
    
5. [**Seeing AI (Microsoft)**](https://blogs.microsoft.com/accessibility/seeing-ai/) – Describes text and scenes for visually impaired learners.
...
1. **Download FFmpeg Build**: Visit the official FFmpeg [website](https://www.gyan.dev/ffmpeg/builds/#) to download the latest FFmpeg build for Windows.
...
![PowerShell confirming FFmpeg is installed](https://github.com/tayo4christ/inclusive-ai-toolkit/blob/a285ef9fd724d5221e1d7090c0d88713d1e5accb/Images/ffmpeg-version.jpg?raw=true align="left")
...
![Whisper successfully transcribed audio to text](https://github.com/tayo4christ/inclusive-ai-toolkit/blob/a285ef9fd724d5221e1d7090c0d88713d1e5accb/Images/whisper-transcript.jpg?raw=true align="left")
...
![Text-to-Speech complete — Audio saved as output.wav](https://github.com/tayo4christ/inclusive-ai-toolkit/blob/a285ef9fd724d5221e1d7090c0d88713d1e5accb/Images/tts-saved-ok.jpg?raw=true align="left")
...
![Explorer showing the generated output.wav file](https://github.com/tayo4christ/inclusive-ai-toolkit/blob/a285ef9fd724d5221e1d7090c0d88713d1e5accb/Images/output-wav-explorer.png.jpg?raw=true align="left")
...
1. Go to [OpenAI’s API Keys page.](https://auth.openai.com/log-in)
...
* **Error: insufficient\_quota** → You’ve run out of free credits. Add billing to continue.
...
| [**Install FFmpeg**](https://www.gyan.dev/ffmpeg/builds/) | [Download build → unzip → ad](https://www.gyan.dev/ffmpeg/builds/)d to PATH or cop[y `ffmpeg.exe`](https://www.gyan.dev/ffmpeg/builds/) | [`brew install`](https://www.gyan.dev/ffmpeg/builds/) `ffmpeg` (macO[S) `sudo apt in`](https://www.gyan.dev/ffmpeg/builds/)`stall ffmpeg` [(Linux)](https://www.gyan.dev/ffmpeg/builds/) |
| [**R**](https://www.gyan.dev/ffmpeg/builds/)**un** [**STT script**](https://www.gyan.dev/ffmpeg/builds/) | `python` [`transcribe.py`](http://transcribe.py) | [`pyth`](https://www.gyan.dev/ffmpeg/builds/)`on3` [`transcribe.py`](http://transcribe.py) |
| [**Install**](https://www.gyan.dev/ffmpeg/builds/) **TTS d**[**eps**](https://www.gyan.dev/ffmpeg/builds/) | [`pip ins`](https://www.gyan.dev/ffmpeg/builds/)`tall transformer`[`s torch soundf`](https://www.gyan.dev/ffmpeg/builds/)`ile sentencepiece` | [`pip install`](https://www.gyan.dev/ffmpeg/builds/) `tra`[`nsformers torc`](https://www.gyan.dev/ffmpeg/builds/)`h soundfile sentencepiece` |
| **Run TTS script** | [`python`](https://www.gyan.dev/ffmpeg/builds/) [`tts.py`](http://tts.py) | `python3` [`tts.py`](http://tts.py) |
| **Install OpenAI client (A**[**PI)**](https://www.gyan.dev/ffmpeg/builds/) | [`pip ins`](https://www.gyan.dev/ffmpeg/builds/)`tall` [`openai`](https://www.gyan.dev/ffmpeg/builds/) | [`pip`](https://www.gyan.dev/ffmpeg/builds/) `install o`[`penai`](https://www.gyan.dev/ffmpeg/builds/) |
| [**Run**](https://www.gyan.dev/ffmpeg/builds/) **API script** | [`python trans`](https://www.gyan.dev/ffmpeg/builds/)`cribe_`[`api.py`](http://api.py) | [`pyth`](https://www.gyan.dev/ffmpeg/builds/)`on3 transcribe_`[`api.py`](http://api.py) |
...
Whether you chose the **local Whisper**, the **cloud API**, or SpeechT5 for **text-to-speech**[,](https://www.gyan.dev/ffmpeg/builds/) you should now have a working prototype that can:
...
**Full source code on GitHub:** [Inclusive AI Toolkit](https://github.com/tayo4christ/inclusive-ai-toolkit)
