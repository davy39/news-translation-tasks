...
We start by importing the necessary packages and configuring some parameters. We will use [Keras](https://keras.io/) to fit the deep learning models. The training data is the [Twitter US Airline Sentiment data set from Kaggle](https://www.kaggle.com/crowdflower/twitter-airline-sentiment).
...
You can find the notebook on [GitHub](https://github.com/bertcarremans/TwitterUSAirlineSentiment/blob/master/source/Handling%20overfitting%20in%20deep%20learning%20models.ipynb). Have fun with it!
