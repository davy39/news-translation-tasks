...
* [Overview of GitHub CLI](#heading-overview-of-github-cli)
    
* [Key Features](#heading-key-features-of-github-cli)
    
* [Benefits of Using GitHub CLI](#heading-benefits-of-using-github-cli)
    
* [Installation and Setup](#heading-installation-and-setup)
    
* [Authenticating with a GitHub Account](#authenticating-with-a-github-account)
    
* [Navigating the GitHub CLI](#heading-navigating-the-github-cli)
    
* [Managing Repositories](#heading-how-to-manage-repositories-with-the-github-cli)
    
* [Working with Pull Requests and Issues](#heading-managing-branches-and-pull-requests)
    
* [Pushing and Pulling Changes](#heading-pushing-and-pulling-changes)
    
* [Working with GitHub Actions](#heading-working-with-github-actions)
    
* [Managing Gists](#heading-how-to-manage-gists-with-the-github-cli)
    
* [Releases and Tags](#heading-interacting-with-releases-and-tags)
    
* [Custom Scripts and Aliases](#heading-how-to-extend-the-github-cli-with-custom-scripts-and-aliases)
    
* [Troubleshooting](#heading-troubleshooting-common-issues)
