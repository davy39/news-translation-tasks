...
With a single PUT operation, you can actually upload an object of up to 5 GB. But, when it comes to uploading larger objects (above 5GB), using Amazon S3’s [Multipart Upload](https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html) feature is a better approach.
...
* [How Multipart Uploads Work](#heading-how-multipart-uploads-work)
    
* [Getting started](#heading-getting-started)
    
    * [Step 1: Download the AWS CLI](#heading-step-1-download-the-aws-cli)
        
    * [Step 2: Configure AWS IAM credentials](#heading-step-2-configure-aws-iam-credentials)
        
* [Step 1: Split Object](#heading-step-1-split-object)
    
* [Step 2: Create an Amazon S3 bucket](#heading-step-2-create-an-amazon-s3-bucket)
    
* [Step 3: Initiate Multipart Upload](#heading-step-3-initiate-multipart-upload)
    
* [Step 4: Upload split files to S3 Bucket](#heading-step-4-upload-split-files-to-s3-bucket)
    
* [Step 5: Create a JSON File to Compile ETag Values](#heading-step-5-create-a-json-file-to-compile-etag-values)
    
* [Step 6: Complete Mulitipart Upload to S3](#heading-step-6-complete-mulitipart-upload-to-s3)
...
![AWS multipart upload process](https://cdn.hashnode.com/res/hashnode/image/upload/v1753729484012/63a68bcc-8c2d-4110-a007-bd67a3b4b2e4.png align="center")
...
1. [Sign in](https://eu-north-1.signin.aws.amazon.com/oauth?client_id=arn%3Aaws%3Asignin%3A%3A%3Aconsole%2Fcanvas&code_challenge=gHNgZ4aX7afSDOY05TLWJNFrXDRnWRy-Mn3_TqW2p9o&code_challenge_method=SHA-256&response_type=code&redirect_uri=https%3A%2F%2Fconsole.aws.amazon.com%2Fconsole%2Fhome%3FhashArgs%3D%2523%26isauthcode%3Dtrue%26nc2%3Dh_si%26src%3Dheader-signin%26state%3DhashArgsFromTB_eu-north-1_bcd5b75451c14744) to your AWS dashboard.
...
![Image of AWS CLI version](https://cdn.hashnode.com/res/hashnode/image/upload/v1753730059205/5164dd17-5f66-40ba-b044-f1bca46a22a0.png align="center")
...
![Image of object size](https://cdn.hashnode.com/res/hashnode/image/upload/v1753730190692/bd22598d-0267-4507-864d-f3f7397faf19.png align="center")
...
![Image of split object](https://cdn.hashnode.com/res/hashnode/image/upload/v1753730408994/33ef3552-9a92-46e9-9c2a-686e73d23c65.png align="center")
...
If you don’t already have an S3 bucket created, follow the steps in the AWS [Get Started with Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/GetStartedWithS3.html) documentation to create one.
...
![Image of object successfully uploaded to AWS using multipart upload](https://cdn.hashnode.com/res/hashnode/image/upload/v1753731196794/c7e121d4-f3a7-4d23-95c5-26b1b5e3b699.png align="center")
...
Check out this [documentation from the AWS knowledge center](https://repost.aws/knowledge-center/s3-multipart-upload-cli) to learn more about multi-part uploads using AWS CLI.
