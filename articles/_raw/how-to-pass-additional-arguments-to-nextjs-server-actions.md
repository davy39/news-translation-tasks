...
If you are interested in learning Next.js Server Actions with design patterns and project building, I have created a crash course for you that you can find [here](https://www.youtube.com/watch?v=gQ2bVQPFS4U).
...
1. [Why Would You Need to Pass Additional Arguments?](#heading-why-would-you-need-to-pass-additional-arguments)
    
2. [A Form with a Server Action](#heading-a-form-with-a-server-action)
    
3. [How to Pass Additional Arguments](#heading-how-to-pass-additional-arguments)
    
4. [What About the Hidden Fields?](#heading-what-about-the-hidden-fields)
...
Create a directory called `actions` under the `app` directory of your Next.js application. Now create a `user.js` file under the `actions` folder with the following code:
...
![Application with server actions](https://cdn.hashnode.com/res/hashnode/image/upload/v1729167845597/b4c58399-4188-4b89-8ec7-dd2602c10ccd.png align="center")
...
![Output Mike](https://cdn.hashnode.com/res/hashnode/image/upload/v1729167722231/e8c40a4d-e506-42fb-8ea3-233e295ac534.png align="center")
...
![Application with server actions again](https://cdn.hashnode.com/res/hashnode/image/upload/v1729167845597/b4c58399-4188-4b89-8ec7-dd2602c10ccd.png align="center")
...
![hidden field](https://cdn.hashnode.com/res/hashnode/image/upload/v1729485711865/21f33410-fcdd-46ea-b14c-d57004b30a96.png align="center")
...
* Here’s the [Server Action Crash Course with Patterns and Project](https://www.youtube.com/watch?v=gQ2bVQPFS4U).
...
* Checking out and follow my Open Source work on [GitHub](https://github.com/atapas).
