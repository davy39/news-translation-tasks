...
I love JavaScript, and using it I've created a developer platform for developers like you. There you can not only learn JavaScript, but also various other languages like C, C++, Java, Node, Python, and more! [Join here for free](https://codedamn.com) and learn with other developers straight outta your browser!

JavaScript is here to stay, and rule the industry this decade. Do you agree? Tell me on my [twitter](https://twitter.com/mehulmpt) and [Instagram](https://instagram.com/mehulmpt) handles - let's connect!
