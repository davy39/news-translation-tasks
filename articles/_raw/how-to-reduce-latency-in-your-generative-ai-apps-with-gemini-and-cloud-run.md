...
* [Phase 1: The "Location-Aware" Code](#heading-phase-1-the-location-aware-code)
    
* [Phase 2: Build & Push](#heading-phase-2-build-amp-push)
    
* [Phase 3: The "Triangle" Deployment](#heading-phase-3-the-triangle-deployment)
    
* [Phase 4: The Global Network (The Glue)](#heading-phase-4-the-global-network-the-glue)
    
* [Phase 5: Testing (Teleportation Time)](#heading-phase-5-testing-teleportation-time)
    
* [Conclusion: The Global AI Edge](#heading-conclusion-the-global-ai-edge)
...
**Note**: The project utilizes various Google Cloud services (Cloud Run, Artifact Registry, Load Balancer, Vertex AI), all of which require a Google Cloud Project with billing enabled to function. While many of these services offer a free tier, you must link a billing account to your project. Although a billing account is required, new Google Cloud users may be eligible for a [**free trial credit**](https://console.cloud.google.com/freetrial?hl=en&facet_utm_source=google&facet_utm_campaign=%28organic%29&facet_utm_medium=organic&facet_url=https%3A%2F%2Fcloud.google.com%2Fsignup-faqs) that should cover the cost of this lab. [See credit program eligibility and coverage](https://cloud.google.com/free/docs/free-cloud-features#free-trial)
...
![Screenshot showing the Google Cloud APIs being successfully completed](https://cdn.hashnode.com/res/hashnode/image/upload/v1764156603095/fb2ffd56-12e4-4b9f-ac2d-8fbb30fc0a2d.png align="center")

### Create and Populate [`main.py`](http://main.py)

This is the brain of our service. In your Cloud Shell terminal, create a file named [`main.py`](http://main.py) and paste the following code into it:
...
Using the `mkdir gemini-app` command, create and navigate into a directory where you should place your [`main.py`](http://main.py) and `Dockerfile`:
...
![Screenshot of Cloud Shell Editor showing Dockerfile and terminal build output.](https://cdn.hashnode.com/res/hashnode/image/upload/v1764159484475/97a5b2b6-f3c2-4d1b-8bf8-6f302748e744.png align="center")
...
![Diagram of the Global AI Architecture Triangle Deployment.](https://cdn.hashnode.com/res/hashnode/image/upload/v1764661657796/0890a47b-589a-4cf8-b537-bb61e5e65ee7.png align="center")
...
* `--set-env-vars SERVICE_REGION=...` injects an environment variable into the running container to let the [`main.py`](http://main.py) code know its own physical region.
...
![Screenshot of Cloud Shell terminal showing the execution of the cloud run services.](https://cdn.hashnode.com/res/hashnode/image/upload/v1764160600271/fbb6a810-7496-4b29-a405-b67a22a988ed.png align="right")

![Cloud run Service Url (asia region) terminal screenshot showing the successful execution of the service](https://cdn.hashnode.com/res/hashnode/image/upload/v1764160624375/dd4dc7e7-22a9-4d8b-a36c-7a0988068f57.png align="center")

![Cloud run Service Url (europe region) terminal screenshot showing the successful execution of the service](https://cdn.hashnode.com/res/hashnode/image/upload/v1764160656898/1b6ca938-9ce4-48f6-bb3b-d09900dbde68.png align="center")

![Cloud run Service Url (us-east region) terminal screenshot showing the successful execution of the service](https://cdn.hashnode.com/res/hashnode/image/upload/v1764160665595/39c2524d-62c8-4187-8b8f-15f7ebbffba4.png align="center")
...
2. **Context Injection:** It dynamically adds the `X-Client-Geo-Location` header to the request, telling your code exactly where the user is<sup>.</sup>
...
![Screenshot of Cloud Shell terminal showing the execution of global load balancer setup commands.](https://cdn.hashnode.com/res/hashnode/image/upload/v1764161003478/549c959d-8ab5-45d6-a2ae-94129529b5b4.png align="center")
...
![Cloud Shell terminal screenshot showing the successful execution of commands to create the gemini-backend-global service](https://cdn.hashnode.com/res/hashnode/image/upload/v1764161323862/299c6c43-9074-493c-95b1-2c08208aa2ec.png align="center")
...
![Cloud Shell terminal screenshot showing the results of curl commands simulating users in Paris, Tokyo, and New York.](https://cdn.hashnode.com/res/hashnode/image/upload/v1764161891891/ecc290ef-1c75-4088-b453-093a92b404ff.png align="center")
...
* [Vertex AI Generative AI SDK](https://www.google.com/search?q=https://cloud.google.com/vertex-ai/docs/generative-ai/learn/sdk)
    
* [Artifact Registry Documentation](https://cloud.google.com/artifact-registry/docs)
    
* [Cloud Run Documentation](https://cloud.google.com/run/docs)
    
* [Global External HTTP(S) Load Balancer Overview](https://www.google.com/search?q=https://cloud.google.com/load-balancing/docs/load-balancing-overview%23external_http_s_load_balancing)
    
* [Serverless Network Endpoint Groups (NEGs)](https://www.google.com/search?q=https://cloud.google.com/load-balancing/docs/negs/serverless-neg-overview)
    
* [Serve traffic from multiple regions](https://docs.cloud.google.com/run/docs/multiple-regions)
