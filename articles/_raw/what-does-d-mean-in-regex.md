---
title: Regular Expression Metacharacters - What Does \d Mean in RegEx?
subtitle: ''
author: Kolade Chris
co_authors: []
series: null
...
## What We'll Cover
- [What is `\d` in RegEx?](#heading-what-is-d-in-regex)
- [How to Use the `\d` Metacharacter ](#heading-how-to-use-the-d-metacharacter)
- [What is the Difference between the Digit Character set `[0-9]` and `\d` Metacharacter?](#heading-what-is-the-difference-between-the-digit-character-set-0-9-and-d-metacharacter)
