---
title: How to Build a Real-time Chat App with ReactJS and Firebase
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_How to setup a Firebase project_
...
_What you'll see while Firebase is creating your project._
...
_Choose the type of app to which you want to add Firestore_
...
_Select authentication from dropdown_
...
_Choose your authentication sign in method_
...
_Chose test mode or production mode (we choose production mode)._
...
_Set a location (default is the location closest to you)_
...
_Demo showing chat scrolling to the bottom with a new message_
...
For example, if you are deploying your app to [https://my-react-chat-app.com](https://my-react-chat-app.com), enter my-react-chat-app.com as an authorized domain. Click the **Add** button to apply the changes.
