...
[Strix](https://github.com/usestrix/strix) changes that. It is an open-source AI hacker that acts like a real attacker. 
...
* [Example: Insecure Direct Object Reference (IDOR)](#heading-example-insecure-direct-object-reference-idor)
    
* [Example: Remote Code Execution (RCE) via Unsafe Deserialization](#heading-example-remote-code-execution-rce-via-unsafe-deserialization)
...
* [**Familiarity with Docker**](https://www.freecodecamp.org/news/how-docker-containers-work/)**:** Strix runs its tests in isolated Docker containers. A basic understanding of images and containers will help you follow what’s happening under the hood.
...
![Strix interface](https://cdn.hashnode.com/res/hashnode/image/upload/v1759984071844/c1acc193-8916-412f-aa84-19593a77001a.png align="center")
...
Make sure you have [Docker](https://www.docker.com/) running, Python 3.12 or newer, and an LLM provider key ready.
...
If you prefer not to deal with setup, you can use the hosted version at [usestrix.com](https://usestrix.com/). The cloud platform runs the same engine but offers more performance, managed storage, and integrations for larger teams. 
