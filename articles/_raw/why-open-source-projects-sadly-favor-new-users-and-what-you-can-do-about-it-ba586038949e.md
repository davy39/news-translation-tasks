---
title: Why open source projects (sadly) favor new users, and what you can do about
  it
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_Simplified diagram of developer tech adoption.In the diagram above, we have two competing technologies, A and B. Their adoption is proportionate to the buzz (blogposts, talks, Github repos) around them, and to their perceived value as reported by current users._
...
![Image](https://cdn-media-1.freecodecamp.org/image/not-found.jpg)
_Result of a simple simulation._
...
_Comparison of the lifetime of .NET versus the lifetime of knockout.js._
