...
* [Stretching CRUD: Upsert, Archive, Bulk](#heading-stretching-crud-upsert-archive-bulk)
    
* [Breaking CRUD: Domain Actions](#heading-breaking-crud-domain-actions)
    
* [Breaking CRUD: Domain Authorization](#heading-breaking-crud-domain-authorization)
    
* [CRUD Alternative: Align to Workflows](#heading-crud-alternative-align-to-workflows)
