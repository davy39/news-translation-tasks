...
In this tutorial, you’ll learn how to build tic-tac-toe using [Phaser.js](https://phaser.io/), a fast, fun, and open source framework for making 2D games in the browser.
...
You can [play the game here](https://manishshivanandhan.com/phaser-tic-tac-toe) to get a feel of what you are going to build.

## Table of Contents

* [What is Phaser.js?](#heading-what-is-phaserjs)
    
* [Project Setup](#heading-project-setup)
    
* [How to Set Up the Game Configuration](#heading-how-to-set-up-the-game-configuration)
    
* [How to Preload Assets](#heading-how-to-preload-assets)
    
* [How to Create the Game Scene](#heading-how-to-create-the-game-scene)
    
* [How to Draw the Grid](#heading-how-to-draw-the-grid)
    
* [How to Initialize and Reset the Game](#heading-how-to-initialize-and-reset-the-game)
    
* [How to Handle Player Input](#heading-how-to-handle-player-input)
    
* [How to Place Marks on the Board](#heading-how-to-place-marks-on-the-board)
    
* [How to Check for a Winner](#heading-how-to-check-for-a-winner)
    
* [How to Detect a Draw](#heading-how-to-detect-a-draw)
    
* [How to Draw the Winning Line](#heading-how-to-draw-the-winning-line)
...
Create a folder for your project and add two files: `index.html` and `game.js`. The HTML file loads Phaser and the JavaScript file contains the game logic. [Here is the repository](https://github.com/manishmshiva/phaser-tic-tac-toe) with the finished code.
...
![Final Game](https://cdn.hashnode.com/res/hashnode/image/upload/v1754903555585/eac6d264-a50a-4bc6-8acc-6cdf7fc214eb.png align="center")
...
If you enjoy online games, check out [GameBoost](https://gameboost.com/), the ultimate marketplace for gamers. You can find [Fortnite accounts](https://gameboost.com/fortnite/accounts) with exclusive skins, along with options for other popular games like Grow a Garden, Clash of Clans, and more.
