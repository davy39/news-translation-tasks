...
* [What is React and what does it do?](#heading-what-is-react-and-what-does-it-do)
    
    * [Web development before React](#heading-web-development-before-react)
        
    * [The benefits of React](#heading-the-benefits-of-react)
        
    * [How React works under the hood](#heading-how-react-works-under-the-hood)
        
* [How to build a React app](#heading-how-to-build-a-react-app)
    
    * [Build a React app from scratch using Webpack and Babel](#heading-build-a-react-app-from-scratch-using-webpack-and-babel)
        
    * [What is CRA (create-react-app)?](#what-is-cra-create-react-app)
...
* [SSR building tools](#heading-ssr-building-tools)
    
    * [What is Astro?](#heading-what-is-astro)
        
    * [What is Gatsby?](#heading-what-is-gatsby)
        
* [React's metaframeworks](#heading-reacts-metaframeworks)
    
    * [What is Next?](#heading-what-is-nextjs)
        
    * [What is Remix?](#heading-what-is-remix)
...
If you wonder what "declaratively" means, you might be interested in [this article about programming paradigms](https://www.freecodecamp.org/news/an-introduction-to-programming-paradigms/) I wrote a while ago.
...
[jQuery](https://jquery.com/), a popular JavaScript library, was introduced as a way to simplify the process of manipulating the DOM and handling browser events. It provided a concise and easy-to-use syntax for selecting and manipulating HTML elements on a page.
...
Other JavaScript frameworks such as [AngularJS](https://angularjs.org/) and [Backbone.js](https://backbonejs.org/) also gained popularity in the early 2010s.

AngularJS provided a more structured approach to building web applications and was heavily focused on [data binding](https://www.youtube.com/watch?v=OoLI8nb-VH8) and [dependency injection](https://www.youtube.com/watch?v=yunF2PgJlHU). Backbone.js was a lightweight framework that allowed developers to create simple web applications with minimal overhead.
...
If you want to dig deeper into this transition that happened between previous tools and frameworks like React, I recommend [this video by uidotdev](https://youtu.be/Wm_xI7KntDs).
...
**Webpack:** [Webpack](https://webpack.js.org/) is a popular open-source module bundler for JavaScript applications. It takes multiple JavaScript files and their dependencies and packages them into a single optimized bundle for use in a web browser. It also has the capability to transform and bundle other types of assets such as CSS, images, and fonts.
...
If you're interested in knowing more about JS modules and how to bundle them with Webpack, you can take a look at [this article I wrote](https://www.freecodecamp.org/news/modules-in-javascript/).

**Babel:** [Babel](https://babeljs.io/) is a popular open-source JavaScript compiler that allows developers to write code in the latest versions of JavaScript and translate it into code that can run on older browsers and environments. It supports the latest ECMAScript features and can also transpile other languages that compile to JavaScript, such as TypeScript and JSX.
...
1. Start a node project by running this command in your terminal:
...
If you're interested in a more detailed approach, you can take a look at [this article](https://medium.com/@JedaiSaboteur/creating-a-react-app-from-scratch-f3c693b84658).

3. Now create an SRC folder and two `index.js` and `index.html` files within it by running the next two commands:
...
4. Hop onto the `index.html` file and put this within it:
...
5. Hop onto the `index.js` file and put this within it:
...
6. Now we need to add some config files for Babel and Webpack. In your root directory run the following:
...
7. Inside your `webpack.config.js` file put the following:
...
6. Inside your `.babelrc` file put the following:
...
7. Finally, go to your `package.json` file and add the following within the `scripts` section:
...
[Create-React-App (CRA)](https://create-react-app.dev/) is a popular and officially supported tool for creating React applications quickly and easily. It is a command-line interface (CLI) tool that automates the setup of a new React project by generating a basic file structure, configuration files, and build scripts.
...
For further info on why CRA is not the best building tool available today, I recommend [this video](https://youtu.be/kvkAoCbTM3Q) and [this video](https://youtu.be/7m14f0ZzMyY).

[Vite.js](https://vitejs.dev/) is a build tool and development server that is designed to optimize the development experience for modern web applications. It was created by [Evan You](https://twitter.com/youyuxi?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor), the creator of the popular JavaScript framework [Vue.js](https://vuejs.org/).
...
If you're interested in further exploring the many rendering options available in web development, you can refer to [the article I recently wrote about rendering patterns.](https://www.freecodecamp.org/news/rendering-patterns/)

# SSR Building Tools

## What is Astro?

[Astro](https://astro.build/) is a modern static site generator and web development framework that allows developers to build fast and efficient websites and web applications using a combination of server-side rendering and client-side rendering.
...
From the [Astro docs](https://docs.astro.build/en/core-concepts/project-structure/) we can see how the project structure works:
...
If you'd like to get a more detailed overview of how Astro works, I recommend you [check out their docs](https://docs.astro.build/en/getting-started/). They're really well-written and easy to follow.

## What is Gatsby?

[Gatsby](https://www.gatsbyjs.com/) is a modern web framework based on React that allows developers to build fast, dynamic websites and applications using the latest web technologies. It was initially released in 2015 by [Kyle Mathews](https://twitter.com/kylemathews?lang=es), and has since grown to become one of the most popular static site generators and web frameworks in the world.
...
1. **Next.js:** [Next.js](https://nextjs.org/) is a metaframework that provides server-side rendering, automatic code splitting, and simplified client-side routing. It also includes built-in support for static site generation, API routes, and other advanced features.
    
2. **Remix:** [Remix](https://remix.run/) is a metaframework for building server-rendered React applications. It provides a unified data management system, a simple and intuitive routing system, and other features that can simplify building complex web applications. Remix aims to improve developer productivity by providing a simpler, more streamlined development experience for building large, complex web applications.
...
Next.js is a popular metaframework for building server-side rendered (SSR) React applications. It is an open-source project developed by [Vercel](https://vercel.com/) (formerly Zeit) and has gained popularity due to its ease of use, performance, and flexibility.
...
If you wander what "hydration" means, again you can refer to [the article I wrote about rendering patterns](https://www.freecodecamp.org/news/rendering-patterns/#the-concept-of-hydration). ;)
...
For a deeper dive into how Next works, refer to [their awesome docs](https://nextjs.org/learn/foundations/about-nextjs).
...
For a deeper dive into how Next works, refer to [their docs](https://remix.run/docs/en/1.14.1/tutorials/blog).
