---
title: The Deno Handbook – A TypeScript Runtime Tutorial with Code Examples
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
* [What is Deno?](#heading-what-is-deno)
* [Why Deno? Why now?](#heading-why-deno-why-now)
* [Should you learn Deno?](#heading-should-you-learn-deno)
* [Will it replace Node.js?](#heading-will-it-replace-nodejs)
* [First-class TypeScript support](#heading-first-class-typescript-support)
* [Similarities and differences with Node.js](#heading-similarities-and-differences-with-nodejs)
* [No package manager](#heading-no-package-manager)
* [Install Deno](#heading-install-deno)
* [The Deno commands](#heading-the-deno-commands)
* [Your first Deno app](#heading-your-first-deno-app)
* [Deno code examples](#heading-deno-code-examples)
* [Your first Deno app (for real)](#heading-your-first-deno-app-for-real)
* [The Deno sandbox](#heading-the-deno-sandbox)
* [Formatting code](#heading-formatting-code)
* [The standard library](#heading-the-standard-library)
* [Another Deno example](#heading-another-deno-example)
* [Is there an Express/Hapi/Koa/* for Deno?](#heading-is-there-an-expresshapikoa-for-deno)
* [Example: use Oak to build a REST API](#heading-example-use-oak-to-build-a-rest-api)
* [Find out more](#heading-find-out-more)
* [A few more random tidbits](#heading-a-few-more-random-tidbits)
...
_My [TypeScript tutorial](https://flaviocopes.com/typescript/) will help you get up and running quickly with TypeScript if you want._
...
_Of course running arbitrary code from the Internet is not a practice_ I'd generally _recommend. In this case we are running it from the Deno official site, plus Deno has a sandbox that prevents programs to do anything you don’t want to allow. More on this later._
