...
co_authors: []
series: null
date: '2019-01-03T16:08:23.000Z'
originalURL: https://freecodecamp.org/news/lessons-i-learned-the-first-year-after-completing-a-coding-bootcamp-4ef3800fd1f8
coverImage: https://cdn-media-1.freecodecamp.org/images/1*bLQ43HLQRp1r6KGs2G7PsA.jpeg
tags:
- name: '#CodingBootcamp '
  slug: codingbootcamp
- name: JavaScript
...
seo_desc: 'By Mario Hoyos
  ...
  Hello, there. If you don’t care about my background, feel free to skip this section
  to get a summary of some lessons I’ve ...'
---
...
![Image](https://cdn-media-1.freecodecamp.org/images/HNeLlJkAyhwksnfejkkbzNFs-Jr591jIxk1a)
...
Prior to making the leap, I was working as a pharmacist. Unlike most people who sign up for a bootcamp hoping to increase their income, I went into it knowing very well that I was not likely to land a job with a comparable salary, at least for a while. I wrote about it at length [here if you want to read more](https://byrslf.co/life-is-too-short-to-be-miserable-and-why-i-left-a-six-figure-job-in-the-search-for-something-327ab84416a9).
...
![Image](https://cdn-media-1.freecodecamp.org/images/K9FVGvTF8OQyDohHMTGNpwux8v0iauWNDyX8)
_Photo by [Unsplash](https://unsplash.com/photos/EPppwcVTZEo?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Helloquence</a> on <a href="https://unsplash.com/search/photos/lesson?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
![Image](https://cdn-media-1.freecodecamp.org/images/eoEoLf6vbxrkgFOZl19NahzDLI0IEE0aGBd5)
_Photo by [Unsplash](https://unsplash.com/photos/bwki71ap-y8?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Tim Gouw</a> on <a href="https://unsplash.com/search/photos/interview?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[**Codewars: Train your coding skills**](https://www.codewars.com/)  
[_Codewars is where developers achieve code mastery through challenge. Train on kata in the dojo and reach your highest…_www.codewars.com](https://www.codewars.com/)
...
[_? Algorithms study materials, behavioral content and tips for rocking your coding interview …g_ithub.com](https://github.com/yangshun/tech-interview-handbook)
...
[_A complete computer science study plan to become a software engineer. - jwasham/coding-interview-university_github.com](https://github.com/jwasham/coding-interview-university)
...
![Image](https://cdn-media-1.freecodecamp.org/images/N6NUC3zOQnxVViq7BJaqVbSqj-2MwrNBgbTK)
_Photo by [Unsplash](https://unsplash.com/photos/IOzk8YKDhYg?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Hope House Press — Leather Diary Studio</a> on <a href="https://unsplash.com/search/photos/books?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[**The Robert C. Martin Clean Code Collection — Robert C. Martin**](https://www.amazon.com/gp/product/B00666M59G/ref=oh_aui_d_detailpage_o02_?ie=UTF8&psc=1)
...
![Image](https://cdn-media-1.freecodecamp.org/images/YyPO3UvhyLmuDgmvUL5cBxgI5AiY5c68VdGB)
_Photo by [Unsplash](https://unsplash.com/photos/s9CC2SKySJM?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Green Chameleon</a> on <a href="https://unsplash.com/search/photos/study?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[_Build 30 things with vanilla JS in 30 days with 30 tutorials_javascript30.com](https://javascript30.com/)
...
[_Learn all about CSS Grid with Wes Bos in this free video series!_cssgrid.io](https://cssgrid.io/)
...
[_Learn to set up authentication in your single page apps. Learn the anatomy of JSON Web Tokens, how to use JWT to…_frontendmasters.com](https://frontendmasters.com/courses/secure-auth-jwt/)
...
[_Learn the principles and best practices for writing maintainable test applications to catch errors before your product…_frontendmasters.com](https://frontendmasters.com/courses/testing-practices-principles/)
...
[_Fix errors before your app reaches the end user by writing maintainable unit test & integration tests for your React…_frontendmasters.com](https://frontendmasters.com/courses/testing-react/)
...
[_Simplify large React applications by separating your component logic, state and display properties to make React…_frontendmasters.com](https://frontendmasters.com/courses/advanced-react-patterns/)
...
[_Build scalable React applications using the tools and techniques available in the React ecosystem. You'll test your…_frontendmasters.com](https://frontendmasters.com/courses/intermediate-react/)
...
[_We’re going to tackle some big topics in just five hours: Algorithms and Big O Analysis, Recursion, Sorting, Data…_frontendmasters.com](https://frontendmasters.com/courses/computer-science/)
...
[_Learn how to deploy your next passion project online or your organization's next-generation client-side application…_frontendmasters.com](https://frontendmasters.com/courses/aws-frontend-react/)
...
[_Take your JavaScript to the next level. Gain an understanding of callbacks, higher order functions, closure…_frontendmasters.com](https://frontendmasters.com/courses/javascript-hard-parts/)
...
[_Develop an intuitive understanding of the new features of JavaScript in ES6+: iterators, generators, promises, and…_frontendmasters.com](https://frontendmasters.com/courses/javascript-new-hard-parts/)
...
[_Visual Studio Code is a modern, full-featured code editor built from the ground for the needs of web developers …_frontendmasters.com](https://frontendmasters.com/courses/visual-studio-code/)
...
![Image](https://cdn-media-1.freecodecamp.org/images/ii2PwBtW2uFtXcBkLsfxcu8iNk9aShf1o2FC)
_Photo by [Unsplash](https://unsplash.com/photos/NL_DF0Klepc?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Cesar Carlevarino Aragon</a> on <a href="https://unsplash.com/search/photos/tools?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[**Tools I wish I had known about when I started coding**](https://medium.freecodecamp.org/tools-i-wish-i-had-known-about-when-i-started-coding-57849efd9248)  
[_In the tech world, there are thousands of tools that people will tell you to use. How are you supposed to know where to…_medium.freecodecamp.org](https://medium.freecodecamp.org/tools-i-wish-i-had-known-about-when-i-started-coding-57849efd9248)
...
[**Tools I wish I had known about when I started coding: Revisited**](https://medium.freecodecamp.org/tools-i-wish-i-had-known-about-when-i-started-coding-revisited-ffb715ffd23f)  
[_A few days ago, I wrote this article for freeCodeCamp which has since gone on to be read more times than I could have…_medium.freecodecamp.org](https://medium.freecodecamp.org/tools-i-wish-i-had-known-about-when-i-started-coding-revisited-ffb715ffd23f)

### Podcasts

![Image](https://cdn-media-1.freecodecamp.org/images/Nc10vNxibwC6xocR8My4QA5AENfPwoPnmF1e)
_Photo by [Unsplash](https://unsplash.com/photos/NMbZ7QM3XWM?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">neil godding</a> on <a href="https://unsplash.com/search/photos/podcast?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[**Potluck - Typescript × E-commerce platforms × Job-hopping × Working for agencies × more - Syntax…**](https://syntax.fm/)  
[_Full Stack Developers Wes Bos and Scott Tolinski dive deep into web development topics, explaining how they work and…_syntax.fm](https://syntax.fm/)
...
[_A live podcast about front end web design and UX._shoptalkshow.com](https://shoptalkshow.com/)
...
![Image](https://cdn-media-1.freecodecamp.org/images/JKroGJyBcVtEvqpPPRZbDp3DWNp3eWtaGjNc)
_Photo by [Unsplash](https://unsplash.com/photos/tpLz5aKdQmM?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">rawpixel</a> on <a href="https://unsplash.com/search/photos/community?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
[**Learn to code with free online courses, programming projects, and interview preparation for…**](https://www.freecodecamp.org/)  
[_Learn to code with free online courses, programming projects, and interview preparation for developer jobs._www.freecodecamp.org](https://www.freecodecamp.org/);’
...
[_CodeNewbie started as a weekly TwitterChat to connect people learning to code by Saron. Since then it's grown into a…_www.codenewbie.org](https://www.codenewbie.org/)
...
### I hope that you have learned something new today! I would appreciate it if you could drop some ? or leave a comment below! Also, feel free to follow me on T[witter](https://twitter.com/marioahoyos) and M[edium](https://medium.com/@mariohoyos) :)
