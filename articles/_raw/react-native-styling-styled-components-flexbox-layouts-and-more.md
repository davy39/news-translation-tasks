---
title: 'React Native Styling: Styled Components, Flexbox Layouts, and More'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
There are a few popular libraries for styling React Native. Some of them provide features similar to [Bootstrap](https://guide.freecodecamp.org/bootstrap/index.md), including default forms, button styles, and page layout options. 
