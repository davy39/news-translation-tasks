---
title: The HTML Handbook – Learn HTML for Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
[Note: you can download a PDF / ePub / Mobi version of this book so you can read it offline.](https://flaviocopes.com/page/html-handbook/)

## **Book Index**

* [Preface](#heading-preface)
* [HTML Basics](#heading-html-basics)
* [The document heading](#heading-the-document-heading)
* [The document body](#heading-the-document-body)
* [Tags that interact with text](#heading-tags-that-interact-with-text)
* [Links](#heading-links)
* [Container tags and page structure HTML](#heading-container-tags-and-page-structure-html)
* [Forms](#heading-forms)
* [Tables](#heading-tables)
* [Multimedia tags: audio and video](#heading-multimedia-tags-audio-and-video)
...
We even know what the first web page was. It's this: [http://info.cern.ch/hypertext/WWW/TheProject.html](http://info.cern.ch/hypertext/WWW/TheProject.html)
...
> _Using the [white-space CSS property](https://developer.mozilla.org/en-US/docs/Web/CSS/white-space) you can change how things behave. You can find more information on how CSS processes white space in the [CSS Spec](https://www.w3.org/TR/CSS2/text.html#white-space-model)_
...
This _might_ be used by Google to generate the page description in its result pages, if it finds it better describes the page than the on-page content (don't ask me how).
...
[See more about this tag](https://developer.mozilla.org/en-US/docs/Mozilla/Mobile/Viewport_meta_tag).
...
**[Click here to get a PDF / ePub / Mobi version of this](https://flaviocopes.com/page/html-handbook/) book **to read offline**!**
