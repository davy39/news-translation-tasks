...
_Just pinch the screens together_
...
_Siftables — [Check out the talk on YouTube](https://www.youtube.com/watch?v=JP0w9lZoLwU" rel="noopener" target="_blank" title=")_
...
I started to spam every possible blogger, JavaScript guru, and Subreddit I could think of with a link to the repo. We got some really awesome feedback. One person who noticed was [Quincy Larson](https://www.freecodecamp.org/news/what-if-all-your-mobile-devices-formed-a-single-screen-9c6ff01ed0c3/undefined):
...
[_swip - a library to create multi device experiments_](https://github.com/paulsonnentag/swip)  
...
_Example of the right alignment but wrong size_
...
_Concept of how the canvas world looks_
