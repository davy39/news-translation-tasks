...
* [What Even Is Scrum?](#heading-what-even-is-scrum)
    
* [The Three Roles in Scrum (and Who Does What)](#heading-the-three-roles-in-scrum-and-who-does-what)
    
* [The Scrum Rhythm: What a Sprint Actually Looks Like](#heading-the-scrum-rhythm-what-a-sprint-actually-looks-like)
    
* [Who attends the Ceremonies:](#heading-who-attends-the-ceremonies)
    
* [Standups: Where You Talk Like a Human, Not a Robot](#heading-standups-where-you-talk-like-a-human-not-a-robot)
    
* [Sprint Planning](#heading-sprint-planning)
    
* [What’s a User Story and Why Does It Sound Like a Children’s Book?](#heading-whats-a-user-story-and-why-does-it-sound-like-a-childrens-book)
    
* [What Counts as “Done”? Definition of Done and Why It’s Important](#heading-what-counts-as-done-definition-of-done-and-why-its-important)
    
* [Demos, Retros, and Saying the Hard Things](#heading-demos-retros-and-saying-the-hard-things)
    
* [Tools You Might Encounter](#heading-tools-you-might-encounter)
    
* [If You’re Preparing for a Job, Here’s What You Can Do](#heading-if-youre-preparing-for-a-job-heres-what-you-can-do)
...
Image Source: [https://www.invensislearning.com/blog/what-are-scrum-ceremonies/](https://www.invensislearning.com/blog/what-are-scrum-ceremonies/)
...
[Here is a video example of a standup](https://youtu.be/q_R9wQY4G5I?si=W1AcvcLXB-mnUM1f).
...
A helpful rule of thumb many teams use is the [**Gherkin**\-style "Given–When–Then"](https://medium.com/@nic/writing-user-stories-with-gherkin-dda63461b1d2) format:
...
[Here is a great video example](https://www.youtube.com/watch?v=7hoGqhb6qAs) thats outlines how to draft effective and powerful user stories.
...
[Here is a beautiful video](https://youtu.be/pYOJyQoBT3U?si=nVygkQQx79NaAOo4) highlighting the impotence of DoD.
...
[Here is a video](https://youtu.be/5eu1HotNmWs?si=1DZaSmztB6rHyawj) highlighting the importance of a Retro and Sprint Review.
