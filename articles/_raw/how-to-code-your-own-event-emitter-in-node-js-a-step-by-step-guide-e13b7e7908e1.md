...
_Mastering the Node.JS Internals_
...
As an exercise feel free to implement other events’ APIs from the documentation [https://nodejs.org/api/events.html](https://nodejs.org/api/events.html).
