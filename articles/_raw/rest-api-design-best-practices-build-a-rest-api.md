---
title: REST API Design Best Practices Handbook – How to Build a REST API with JavaScript,
...
- [Our Example Project](#heading-our-example-project)
    - [Prerequisites](#heading-prerequisites)
    - [Architecture](#heading-architecture)
    - [Basic Setup](#heading-basic-setup)
- [REST API Best Practices](#heading-rest-api-best-practices)
    - [Versioning](#heading-versioning)
    - [Name resources in plural](#heading-name-resources-in-plural)
    - [Accept and respond with data in JSON format](#heading-accept-and-respond-with-data-in-json-format)
    - [Respond with standard HTTP Error Codes](#heading-respond-with-standard-http-error-codes)
    - [Avoid verbs in endpoint names](#heading-avoid-verbs-in-endpoint-names)
    - [Group associated resources together](#heading-group-associated-resources-together-logical-nesting)
    - [Integrate filtering, sorting & pagination](#heading-integrate-filtering-sorting-amp-pagination)
    - [Use data caching for performance improvements](#heading-use-data-caching-for-performance-improvements)
    - [Good security practices](#heading-good-security-practices)
    - [Document your API properly](#heading-document-your-api-properly)
- [Conclusion](#heading-conclusion)

## Our Example Project

![Image](https://www.freecodecamp.org/news/content/images/2022/04/alvaro-reyes-qWwpHwip31M-unsplash--1-.jpg)
_Photo by [Unsplash](https://unsplash.com/@alvarordesign?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Alvaro Reyes</a> on <a href="https://unsplash.com/s/photos/project?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)_
...
_Photo by [Unsplash](https://unsplash.com/@conniwenningsimages?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Constantin Wenning</a> on <a href="https://unsplash.com/s/photos/handshake?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)_
...
![Image](https://www.freecodecamp.org/news/content/images/2022/04/Bildschirmfoto-2022-04-30-um-11.22.28.png)
