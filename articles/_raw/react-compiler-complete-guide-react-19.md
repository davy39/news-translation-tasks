...
If these are exciting to you, I recommend [watching this video](https://www.youtube.com/watch?v=hiiGUjEkzbM) that explains how each feature will impact you as a React developer. I hope you like it 😊.
...
Does this mean we do not have to use `memo`, `useMemo()`, `useCallback`, and so on anymore? No – we mostly don't. The compiler can take care of these things automatically if you understand and follow the [Rules of React](https://react.dev/reference/rules) for components and hooks.
...
1. [What is a Compiler, traditionally?](#heading-what-is-a-compiler-traditionally)
    
2. [React Compiler Architecture](#heading-react-compiler-architecture)
    
3. [React Compiler in action](#heading-react-compiler-in-action)
    
4. [Understanding the problem: Without the React Compiler](#heading-understanding-the-problem-without-the-react-compiler)
    
5. [Fixing the problem: Without the React Compiler](#heading-fixing-the-problem-without-the-react-compiler)
    
6. [Fixing the problem: Using the React Compiler](#heading-fixing-the-problem-using-the-react-compiler)
    
7. [Optimized React App with React Compiler](#heading-optimized-react-app-with-react-compiler)
    
8. [React Compiler in React DevTools](#heading-react-compiler-in-react-devtools)
    
9. [Diving deep - How does the React Compiler work?](#heading-diving-deep-how-does-the-react-compiler-work)
    
10. [How do you opt in and out of the React compiler?](#heading-how-do-you-opt-in-and-out-of-the-react-compiler)
    
11. [Can we use the React Compiler with React 18.x?](#heading-can-we-use-the-react-compiler-with-react-18x)
    
12. [Repositories to look into](#heading-repositories-to-look-into)
    
13. [What's Next?](#heading-whats-next)
...
![Compiler phases as described above](https://cdn.hashnode.com/res/hashnode/image/upload/v1724227359567/a3994e4c-9018-4b67-94be-8b5f403eceb9.png align="center")
...
![The Product Page](https://cdn.hashnode.com/res/hashnode/image/upload/v1724240252940/bd5118d1-2819-4119-ac96-57e267742432.png align="center")

The component hierarchy and the data passing between the components look like this:

![Product Page Component Hierarchy](https://cdn.hashnode.com/res/hashnode/image/upload/v1724240027326/0a8a653d-9c6a-43ff-9457-81dde019e56e.png align="center")
...
![With timestamp](https://cdn.hashnode.com/res/hashnode/image/upload/v1724241332454/5debcdce-0349-40a3-916f-78e479668c12.png align="center")
...
![compiler diff](https://cdn.hashnode.com/res/hashnode/image/upload/v1724242207319/b3f2aa7e-d387-4de4-a2e6-9491f5cf7996.png align="center")
...
![Applying memoization](https://cdn.hashnode.com/res/hashnode/image/upload/v1724242889553/ec0d54fc-8c50-4fef-a4ea-e8c5951da9ad.png align="center")
...
If you want to configure the React compiler with Next.js, Remix, Webpack, and so on, you can [follow this guide](https://react.dev/learn/react-compiler#installation).
...
You can see it working visually [from here](https://youtu.be/bdWUVp0TbTU?t=1326).

## React Compiler in React DevTools

[React DevTools](https://react.dev/learn/react-developer-tools) version 5.0+ has built-in support for the React compiler. You will see a badge with the text `Memo ✨` beside the components optimized by the React compiler. This is fantastic!
...
Now that you've seen how the React compiler works on React 19 code, let's deep dive into understanding what's happening in the background. We will use the React [Compiler Playground](https://playground.react.dev/) to explore the translated code and the optimization steps.
