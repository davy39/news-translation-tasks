...
_Programming the Smart Mirror with my Daughter_
...
_Initial Design of Smart Mirror_
...
_Revised Design of the Smart Mirror_
...
_My Daughter using a Power Drill to Screw in the Top of the Mirror_
...
_3D Printed Pink Raspberry Pi Case_
...
![Image](https://cdn-media-1.freecodecamp.org/image/not-found.jpg)
_My Daughter and I Connecting all the Wires on the Back of the Smart Mirror_
...
_Installing the Acrylic Mirror into the Frame_
