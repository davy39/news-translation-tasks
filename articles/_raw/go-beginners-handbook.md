...
1. [How to get started with Go](#heading-how-to-get-started-with-go)
2. [How to install Go](#heading-how-to-install-go)
3. [How to setup your editor](#heading-how-to-setup-your-editor)
4. [How to write Hello, World! in Go](#heading-how-to-write-hello-world-in-go)
5. [How to compile and run a Go program](#heading-how-to-compile-and-run-a-go-program)
6. [The Go workspace](#heading-the-go-workspace)
7. [Diving into the Go language](#heading-diving-into-the-go-language)
8. [Variables in Go](#heading-variables-in-go)
9. [Basic types in Go](#heading-basic-types-in-go)
10. [Strings in Go](#heading-strings-in-go)
11. [Arrays in Go](#heading-arrays-in-go)
12. [Slices in Go](#heading-slices-in-go)
13. [Maps in Go](#heading-maps-in-go)
14. [Loops in Go](#heading-loops-in-go)
15. [Conditionals in Go](#heading-conditionals-in-go)
16. [Operators in Go](#heading-operators-in-go)
17. [Structs in Go](#heading-structs-in-go)
18. [Functions in Go](#heading-functions-in-go)
19. [Pointers in Go](#heading-pointers-in-go)
20. [Methods in Go](#heading-methods-in-go)
21. [Interfaces in Go](#heading-interfaces-in-go)
22. [Where to go from here](#heading-where-to-go-from-here)
...
_Successful installation modal_
...
_Displaying the Go version you have_
...
_VS Code settings for Go - Format on Paste and Format on Save_
...
_Warning for unused declared variables_
...
_Error in compiler for unused declared variables_
