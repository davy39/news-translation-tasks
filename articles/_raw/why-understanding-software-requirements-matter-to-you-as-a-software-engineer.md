---
title: Why You Need to Understand Software Requirements as a Software Engineer
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2020-04-27T20:17:38.000Z'
originalURL: https://freecodecamp.org/news/why-understanding-software-requirements-matter-to-you-as-a-software-engineer
coverImage: https://www.freecodecamp.org/news/content/images/2020/04/understanding-software-requirements.jpg
tags:
...
seo_title: null
seo_desc: "By Greg Byrne\nIn this article, you'll learn all about Software Requirements.\
  \ You'll get an outline on the topic area, the process, and most importantly what\
  \ your responsibilities are in this area as a software engineer. \nYou should gain\
  \ some insight ..."
---
...
This article borrows heavily from the tome that is the [IEEE SWEBOK guide](https://www.computer.org/education/bodies-of-knowledge/software-engineering). It attempts to distill some of that knowledge, re-purposing it more concisely. In case your wondering, SWEBOK is an acronym for the Software Engineering Body of Knowledge which is maintained by the IEEE Computer Society.
...
You can [read more of my articles on my blog](https://www.gregbyrne.ie/).
