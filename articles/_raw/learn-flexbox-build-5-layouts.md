...
## Table of Contents
   ...
   * [Setup](#heading-project-setup)
   * [Level-1](#heading-layout-difficulty-level-1-how-to-build-a-card-layout)
   * [Level-2](#heading-layout-difficulty-level-2-how-to-build-a-nav-bar-layout)
   * [Level-3](#heading-layout-difficulty-level-3-how-to-build-a-sidebar-layout)
   * [Level-4](#heading-layout-difficulty-level-4-how-to-build-a-card-layout-2)
   * [Level-5](#heading-layout-difficulty-level-5-the-holy-grail-of-layouts)
...
Let's start playing around with SCSS. Open [CodePen](https://codepen.io/) or any code editor and go through this with me, these step by step.👇
