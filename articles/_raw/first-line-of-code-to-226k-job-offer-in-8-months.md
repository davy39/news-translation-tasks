---
title: How I Went from Writing My First Line of Code to a $226K Job Offer in Just
  8 Months
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2019-09-18T16:39:14.000Z'
originalURL: https://freecodecamp.org/news/first-line-of-code-to-226k-job-offer-in-8-months
coverImage: https://www.freecodecamp.org/news/content/images/2019/09/Love-to-learn_tim-mossholder_unsplash.jpg
tags:
- name: bootcamp
  slug: bootcamp
- name: growth mindset,
...
seo_title: null
seo_desc: 'By Jason Zedde

  I got offers from Google, Lyft, Yelp, cloud unicorn Rubrik, IBM Artificial Intelligence,
  and JP Morgan Chase. My story may help you in your job search.

  Introduction

  I hope my story inspires current software engineering job seekers -  e...'
---
...
I was choosing between a Chief of Staff role for a hyper-growth adtech company and attending a [coding “bootcamp.”](https://www.hackreactor.com/onsite-immersive) The Chief of Staff role was lucrative and certain - seemingly an extraordinary ticket to a Silicon Valley fast track. The bootcamp seemed expensive and risky.
...
But once I started coding I didn’t want to stop. I loved the technical challenge, was thrilled to make headway against something so intimidating. And I figured [developing a second professional skillset](https://dilbertblog.typepad.com/the_dilbert_blog/2007/07/career-advice.html) might prepare me for an unusually impactful career. 
...
I took an online course and, after coding ~40 hours/week for three weeks, I decided to apply to [Hack Reactor](https://www.hackreactor.com/onsite-immersive), which I had heard described as “the Harvard of bootcamps,” just to see if I could get in. I passed the entrance exam by the skin of my teeth the same week I received the Chief of Staff offer.
...
Hack Reactor wasn’t just teaching content, it was teaching a new kind of [grit](https://en.wikipedia.org/wiki/Grit_(personality_trait)) and [growth mindset](https://www.mindsetworks.com/science/), and the process was exhilarating.
...
To ensure ample [sleep for learning](https://news.berkeley.edu/2011/03/08/sleep-brainwaves/), I kept strict bedtimes. 

To fight repetitive stress aches, [boost wellbeing](https://www.fastcompany.com/3025957/what-happens-to-our-brains-when-we-exercise-and-how-it-makes-us-happier), and [support learning](http://www.educationalneuroscience.org.uk/resources/neuromyth-or-neurofact/exercise-enhances-learning/), I worked out every other day. 
...
And most importantly, to maintain baseline wellbeing during such an intense schedule, I meditated for a full hour every morning before class, usually using a mix of vipassana (a form of [body scanning](https://ggia.berkeley.edu/practice/body_scan_meditation)) and [loving-kindness](https://jackkornfield.com/meditation-lovingkindness/) techniques. 

This last habit may strike some as extreme, but the [evidence behind meditation](https://nccih.nih.gov/health/meditation/overview.htm) improving wellbeing is strong, especially [loving-kindness](https://www.psychologytoday.com/us/blog/feeling-it/201409/18-science-backed-reasons-try-loving-kindness-meditation). I cannot overstate how valuable this practice was in helping me embrace the curiosity and joy of learning rather than grow anxious about the challenges of bootcamp and uncertain employment.

I also benefited from a blessing in disguise. A travel conflict prevented me from enrolling in the in-person immersive, so despite living a 10-minute walk from the SF campus, I had to take the remote program. Between the lack of commute, easy access to food, and the quiet of my apartment, I was able to protect another ~90 minutes a day of uninterrupted [deep work](https://medium.com/@dsilvestre/deep-work-by-cal-newport-lessons-305a375c41b8).

The first six weeks involved two-day pair programming sprints building on semi-completed code repositories. We raced through rewriting the JavaScript [Underscore](https://underscorejs.org/) library, building basic data structures from scratch, learning object-oriented vs. functional programming, calculating time and space complexity, and wiring up a full stack app from client to server to database. Our smaller, 24-person cohort grew close joking with one another over video conference 10+ hours/day.

Three weeks in, I was afraid I wasn’t going to pass the gating mid-course assessment, so I [wrote a letter to myself](https://www.creativityatwork.com/2003/01/10/art-of-possibility-ben-zander/) dated in the future explaining how it came to be that I passed the assessment. 

I mentioned all my existing self-care and learning habits and added a few more, including reviewing code I didn’t fully understand until I could mentally explain the core concepts to an imaginary 8 year-old (the [Feynman Technique](https://fs.blog/2012/04/feynman-technique/)). 
...
I negotiated a 6-week position as opposed to the typical 12-week position to give me exposure to the new curriculum while limiting the delay in job searching and studying full-time. I was grateful to learn on the job ([teaching in particular boosted my own learning](https://medium.com/accelerated-intelligence/memory-learning-breakthrough-it-turns-out-that-the-ancients-were-right-7bbd3090d9cc)) and the modest pay bought me two more months of living expenses – a big relief!
...
_Companies that made me offers_
...
_16% of my applications converted to offers just over 8 months after my first line of code_
...
* First, while my goals gave me direction, overly focusing on goals would only leave me dissatisfied with the gap between where I was and where I wanted to be. I wanted [habits over goals](https://fs.blog/2017/06/habits-vs-goals/).
...
I kept notes on new concepts and “aha” moments after I solved a problem, treating them as my invaluable collection of “[mental models](https://fs.blog/mental-models/)” I hoped would grow sufficient to pattern match to any interview prompt. I would review them on [spaced repetition intervals](https://artofmemory.com/wiki/Spaced_Repetition_and_Recall) to most efficiently commit to long-term memory. 
...
* [emphasizing results](https://resumegenius.com/how-to-write-a-resume/accomplishments-on-resume-quantify-achievements) over context or action in my resume, 
...
I almost bit the bait, but paused and [deflected the salary question](https://www.lewis-lin.com/blog/deflect-salary-questions-from-a-recruiter-like-an-expert) as Hack Reactor instructs. _“_I’d actually like to go the other way – can you tell me your range and I’ll tell you if you’re in the ballpark?” I said. “Sure, we start at $125K.”
...
![Image](https://lh3.googleusercontent.com/gT6Afyw5jf5cB6k4gwFw21zgiYoM6-Hq66p74auEbpE6oUZJfnXUTYT4e_WteWKoEfcWDP5Lb9snCN7yLYXcgm_O2E19TL_bXk-LA6CK8glKZ_-TfVnGebvXWmibh6M3Y9IAgR0F)
_I saw almost a 90% increase in compensation by waiting and passing on my first offer_
...
I also scoured blog posts by [Haseeb Qureshi](https://haseebq.com/farewell-app-academy-hello-airbnb-part-ii/), another earn-to-give bootcamp graduate, and chatted regularly with my Hack Reactor career coach who had advised hundreds of negotiations before mine.
...
## [In search of software engineering roles?](http://www.swejobsearch.com/resources/)

I've curated the list of top resources I used to prep for interviews. I'm also offering coaching sessions to job seekers that commit 10% or more of their future income to high impact charities.  **Get access to both [here](http://www.swejobsearch.com/resources/).**
...
I shared specific compensation information in this article for two reasons. One, I want this post to be as useful as possible to job seekers from non-traditional backgrounds, many of whom may be less familiar with these numbers. And two, because [sharing our salaries](https://www.nytimes.com/2018/08/31/smarter-living/pay-secrecy-national-labor-rights-act.html) is a concrete way to fight pay inequality that hurts everyone, [especially minorities](https://leanin.org/equal-pay-data-about-the-gender-pay-gap). 

Fighting pay inequality is also aligned with the mission and culture of Lyft, which is extraordinarily committed to fighting pay inequality. It administers a third-party pay equity audit every year, and this past year Lyft became a different kind of “unicorn” in Silicon Valley after [no systemic pay gap was found](https://www.forbes.com/sites/maggiemcgrath/2019/07/31/lyfts-2019-pay-equity-audit-has-a-surprising-result-its-male-and-female-employees-earn-the-same-thing/#56e6e0357a8d). Precise salary information already exists on sites like [paysa](https://www.paysa.com/salaries/software-engineer--t), [levels](https://www.levels.fyi/), and [blind](https://www.teamblind.com/search/software%20engineer%20lyft), so details shared here are nothing new.
