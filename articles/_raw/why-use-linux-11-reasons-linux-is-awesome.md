---
title: Why Use Linux? 11 Reasons Linux is Awesome
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2020-02-22T23:45:00.000Z'
originalURL: https://freecodecamp.org/news/why-use-linux-11-reasons-linux-is-awesome
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9c71740569d1a4ca323f.jpg
tags:
- name: Linux
  slug: linux
- name: toothbrush
  slug: toothbrush
seo_title: null
seo_desc: 'In this article, we''ll look at some of the things developers love about
  Linux so you can decide if it''s right for you.

  Constant and efficient improvements.

  Linux updates happen through the global collaboration of developers. Bugs are documented
  and r...'
---
...
Linux has an active community of those willing to share their knowledge and help (much like FreeCodeCamp!). There are command line utilities built into Linux that provide documentation on commands, libraries, standards, etc. ([Man pages](https://en.wikipedia.org/wiki/Man_page) and [Info pages](https://en.wikipedia.org/wiki/Info_(Unix)), and there is documentation available on the Internet in a variety of formats including [The Linux Documentation Project](http://www.tldp.org/), [LinuxQuestions](http://www.linuxquestions.org/), [ServerFault](http://serverfault.com/), and [The Arch Wiki](https://wiki.archlinux.org/).

In addition to documentation, there are plenty of helpful and welcoming communities for newcomers to ask questions such as [Ask Ubuntu](https://askubuntu.com/) and [Reddit’s r/linuxquestions](https://www.reddit.com/r/linuxquestions/).

There are self-paced certifications that can be taken that are recognized in the IT industry ([CompTIA’s Linux+](https://certification.comptia.org/certifications/linux) and [LPI’s LPIC tests](https://www.lpi.org/)). Although not required, learning [C](https://en.wikipedia.org/wiki/C_(programming_language)) gives the ability for a user to review the Linux code to see what they are running.
...
## More info about Linux:

* [Basic Linux commands you should know](https://www.freecodecamp.org/news/basic-linux-commands-bash-tips-you-should-know/)
