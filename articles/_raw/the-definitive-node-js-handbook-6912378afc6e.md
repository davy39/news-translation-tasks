---
title: The definitive Node.js handbook – Learn Node for Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
**Note:** Some tools, like Next.js for example, make environment variables defined in `.env` automatically available without the need to use `dotenv`.
...
**Note:** Node 10 includes [experimental support](https://nodejs.org/api/fs.html#fs_fs_promises_api) for a promise based API.
