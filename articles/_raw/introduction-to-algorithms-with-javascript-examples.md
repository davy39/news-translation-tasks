---
title: Introduction to Algorithms Handbook – with JavaScript Examples
subtitle: ''
author: German Cocca
co_authors: []
series: null
...
* [Algorithmic complexity](#heading-algorithmic-complexity)
    
* [Searching algorithms](#heading-searching-algorithms)
    
    * [Linear search](#heading-linear-search)
        
    * [Binary search](#heading-binary-search)
        
* [Sorting algorithms](#heading-sorting-algorithms)
    
    * [Bubble sort](#heading-bubble-sort)
        
    * [Selection sort](#heading-selection-sort)
        
    * [Insertion sort](#heading-insertion-sort)
        
    * [Merge sort](#heading-merge-sort)
        
    * [Quick sort](#heading-quick-sort)
        
    * [Radix sort](#heading-radix-sort)
        
* [Traversing algorithms](#heading-traversing-algorithms)
    
    * [Breadth first search (BFS)](#heading-breadth-first-search-bfs)
        
    * [Depth first search (DFS)](#heading-depth-first-search-dfs)
        
        * [Pre order DFS](#heading-pre-order-dfs)
            
        * [Post order DFS](#heading-post-order-dfs)
            
        * [In order DFS](#heading-in-order-dfs)
