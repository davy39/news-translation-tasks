...
There are [lots of writings](https://www.joelonsoftware.com/2000/10/02/painless-functional-specifications-part-1-why-bother/) already on why it’s important to write a design doc before diving into coding. So all I’ll say here is:
...
_Photo by [Unsplash](https://unsplash.com/photos/x5SRhkFajrA?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Todd Quackenbush</a> on <a href="https://unsplash.com/search/photos/ingredients?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
_Photo by [Unsplash](https://unsplash.com/photos/EF8Jr-uPS2Y?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">rawpixel</a> on <a href="https://unsplash.com/search/photos/writing?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
If you, like me, have trouble being funny, [Joel Spolsky](https://en.wikipedia.org/wiki/Joel_Spolsky) (_obviously_ known for his comedic talents…) has this tip:
...
_Photo by [Unsplash](https://unsplash.com/photos/IuE715vJo2I?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">SpaceX</a> on <a href="https://unsplash.com/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
...
In talking to [Shrey Banga](https://www.freecodecamp.org/news/how-to-write-a-good-software-design-document-66fcf019569c/undefined) recently about this, I learned that Quip has a similar process, except in addition to having an experienced engineer or tech lead on your team as a reviewer, they also suggest having an engineer on a _different_ team review the doc. I haven’t tried this, but I can certainly see this helping get feedback from people with different perspectives and improve the general readability of the doc.
...
My coworker [Kent Rakip](https://www.linkedin.com/in/krakip/) has a good answer to this: **A design doc is successful if the right ROI of work is done.** That means a successful design doc might actually lead to an outcome like this:
...
Giving credit where credit is due, I learned a lot of the above by working alongside some _incredible_ engineers at [Plaid](https://plaid.com/) ([we are hiring!](https://jobs.lever.co/plaid?lever-via=fUydCnRbfC&commitment=Full-time&team=Engineering) Come design and build some sweet technical systems with us) and [Quora](https://www.quora.com/careers).

If you like this post, [follow me on Twitter](https://www.twitter.com/zhangelaz) for more posts on engineering, processes, and backend systems.
