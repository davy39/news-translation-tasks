---
title: I visualized the data from every single game of Hearthstone I played. All 4,700
  of them.
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_I’ve tracked every ranked game since March. That’s 4,700+ games so far. Sure wish there was a way to get this data more easily (ahem… [@playhearthstone](https://twitter.com/playhearthstone" rel="noopener" target="_blank" title=")?)._
...
_I play in both ranked formats: Standard and Wild._
...
_Those moving averages help to calm my ladder anxiety._
...
_You’re seeing that correctly — I was **one win** away from Legend **7 different times** in season 24. Sigh._
...
_Note how it takes about 100 games for a deck to stabilize. Remember that next time you read about someone’s “amazing” 82.35% win rate (after just 17 games)._
...
_My Zoo deck performed very well until I got to Rank 5._
...
_Not even a 53.9% win-rate could salvage the performance of my season 27 Zoo Warlock._
