...
* [But we’re not all full stack](#heading-but-were-not-all-full-stack)
* [So what is the difference between Front End Development and Back End Development?](#heading-so-what-is-the-difference-between-front-end-development-and-back-end-development)
* [What is Front End Development?](#heading-what-is-front-end-development)
* [What is Back End Development?](#heading-what-is-back-end-development)
* [Where things get fuzzy](#heading-where-things-get-fuzzy)
* [Resources to learn](#heading-resources-to-learn)
...
_Front End Engineer vs Back End Engineer_
...
_It's like building a website... with more steps_
...
_Back end giving the front end a 500 Internal Server Error_
...
_Never stopped to think if we should write JS on a server_
