...
co_authors: []
series: null
date: '2020-01-03T21:53:00.000Z'
originalURL: https://freecodecamp.org/news/source-code-editors-explained
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9e3f740569d1a4ca3c26.jpg
tags:
- name: coding
  slug: coding
- name: editor
...
- name: Visual Studio Code
  slug: vscode
seo_title: null
seo_desc: "Source code editors are the programs that allow for code creation and editing.\
  \ \nAny text editor can be used to write code. But dedicated code editors offer\
  \ many useful features, including: text completion, markup coloring, and tabs/panes\
  \ for side-by-..."
---
...
![Sublime Text Icon](https://discourse-user-assets.s3.amazonaws.com/original/2X/1/1249e18855b9c9ef177e636e6c4e308b4877bf2d.png)
...
Sublime Text is a very popular editor that has been around [since 2008](https://www.sublimetext.com/blog/articles/one-point-oh). There are many options and [extensions](https://packagecontrol.io/) available, and a lot of [help available](http://stackoverflow.com/search?q=sublime+text) online to help [set it up](http://www.websightdesigns.com/wiki/Setting_up_Sublime_Text_3).
...
![Brackets Icon](https://discourse-user-assets.s3.amazonaws.com/original/2X/d/df30640741461569071875cf4ff6cad9924f8b32.png)
...
![Atom Icon](https://discourse-user-assets.s3.amazonaws.com/original/2X/7/7f6ba67d0ea310e1c1024f83c9acc1e0ecf255a8.png)

![Atom Screenshot](https://discourse-user-assets.s3.amazonaws.com/original/2X/8/8016e7c0937e8ce6fcb6104c9aee0026443912f5.png)

Atom is an [open source](https://github.com/atom/atom) editor, developed by [GitHub](https://github.com/). Like Sublime Text, Atom is quite popular.

It is very configurable (“hackable”, as they say) but advanced features may  
be overwhelming to new users. There is also plenty of [helpful](http://readwrite.com/2014/05/20/github-atom-5-tips-getting-started-tutorial-corey-johnson/) [documentation](http://flight-manual.atom.io/) [availble](http://stackoverflow.com/search?q=atom) online.
