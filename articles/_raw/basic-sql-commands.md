---
title: Basic SQL Commands - The List of Database Queries and Statements You Should
  Know
subtitle: ''
author: Beau Carnes
co_authors: []
...
[`ALTER TABLE`](https://dev.mysql.com/doc/refman/5.7/en/alter-table.html) changes the structure of a table. Here is how you would add a column to a database:
