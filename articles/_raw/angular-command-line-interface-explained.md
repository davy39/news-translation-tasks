---
title: Angular Command-line Interface Explained
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
`ng new` creates a _new_ Angular file system. This is a surreal process. Please navigate to a file location desirable for _new_ application generation. Type this command as follows, replacing `[name-of-app]` with whatever you want: `ng new [name-of-app]`.
