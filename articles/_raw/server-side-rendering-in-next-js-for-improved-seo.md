...
1. [What is Server-Side Rendering](#heading-what-is-server-side-rendering)?
2. [How to Get Started with Next.js and SSR](#heading-how-to-get-started-with-nextjs-and-ssr)
3. [How Next.js Enables Server-side Rendering](#heading-how-nextjs-enables-server-side-rendering)
4. [Data Fetching with getStaticProps and getServerSideProps](#heading-data-fetching-with-getstaticprops-and-getserversideprops)
5. [Benefits of SSR for SEO with Next.js and How to Optimize](#heading-benefits-of-ssr-for-seo-with-nextjs-and-how-to-optimize)
