...
* [Prerequisites: What You Should Know Before Reading This Guide](#heading-prerequisites-what-you-should-know-before-reading-this-guide)
    
    * [Essential React Knowledge](#heading-essential-react-knowledge)
        
    * [JavaScript Prerequisites](#heading-javascript-prerequisites)
        
    * [React Concepts You'll Encounter](#heading-react-concepts-youll-encounter)
        
* [Development Environment](#heading-development-environment)
    
* [Conceptual Understanding](#heading-conceptual-understanding)
    
* [What You DON'T Need to Know](#heading-what-you-dont-need-to-know)
    
* [Self-Assessment Questions](#heading-self-assessment-questions)
    
* [Recommended Preparation](#heading-recommended-preparation)
    
* [What This Guide Will Teach You](#heading-what-this-guide-will-teach-you)
    
* [Understanding the Building Blocks: Props in React](#heading-understanding-the-building-blocks-props-in-react)
    
    * [What are props?](#heading-what-are-props)
        
    * [A more modern way: Destructuring props](#heading-a-more-modern-way-destructuring-props)
        
* [What is Prop Drilling and Why is it a Problem?](#heading-what-is-prop-drilling-and-why-is-it-a-problem)
    
    * [A simple example: Passing a username](#heading-a-simple-example-passing-a-username)
        
    * [A realistic example: Shopping cart prop drilling](#heading-a-realistic-example-shopping-cart-prop-drilling)
        
    * [Why does this happen and get worse](#heading-why-does-this-happen-and-get-worse)
        
* [Solution 1: React Context API – Understanding the Concept](#heading-solution-1-react-context-api-understanding-the-concept)
    
    * [The radio station analogy](#heading-the-radio-station-analogy)
        
    * [What is createContext()?](#heading-what-is-createcontext)
        
    * [Creating a basic Context Provider](#heading-creating-a-basic-context-provider)
        
    * [Understanding the useContext hook](#heading-understanding-the-usecontext-hook)
        
    * [Creating a custom hook for cleaner usage](#heading-creating-a-custom-hook-for-cleaner-usage)
        
    * [Putting it all together: Complete Context example](#heading-putting-it-all-together-complete-context-example)
        
* [Advanced Context Patterns and Concepts](#heading-advanced-context-patterns-and-concepts)
    
    * [Multiple contexts for separation of concerns](#heading-multiple-contexts-for-separation-of-concerns)
        
    * [Understanding useReducer for complex state logic](#heading-understanding-usereducer-for-complex-state-logic)
        
* [Solution 2: State Management Libraries Explained](#heading-solution-2-state-management-libraries-explained)
    
    * [Understanding Redux: The predictable state container](#heading-understanding-redux-the-predictable-state-container)
        
    * [Redux Toolkit: Modern Redux made simple](#heading-redux-toolkit-modern-redux-made-simple)
        
    * [Zustand: Simple and flexible state management](#heading-zustand-simple-and-flexible-state-management)
        
* [Performance Optimization Strategies Explained](#heading-performance-optimization-strategies-explained)
    
    * [Why do unnecessary re-renders happen?](#heading-why-do-unnecessary-re-renders-happen)
        
    * [Solution 1: Split contexts to minimize re-renders](#heading-solution-1-split-contexts-to-minimize-re-renders)
        
    * [Solution 2: Memoize context values to prevent object recreation](#heading-solution-2-memoize-context-values-to-prevent-object-recreation)
        
    * [Solution 3: Select only what you need](#heading-solution-3-select-only-what-you-need)
        
    * [Solution 4: Use React.memo for expensive components](#heading-solution-4-use-reactmemo-for-expensive-components)
        
    * [Solution 5: Optimize with custom selector hooks](#heading-solution-5-optimize-with-custom-selector-hooks)
        
* [Testing Shared State: A Comprehensive Approach](#heading-testing-shared-state-a-comprehensive-approach)
    
    * [Why shared state testing is different](#heading-why-shared-state-testing-is-different)
        
    * [Testing React Context](#heading-testing-react-context)
        
    * [Testing Redux stores](#heading-testing-redux-stores)
        
* [When to Use Each Approach: A Decision Framework](#heading-when-to-use-each-approach-a-decision-framework)
    
    * [Decision tree for state management](#heading-decision-tree-for-state-management)
        
    * [Detailed comparison of approaches](#heading-detailed-comparison-of-approaches)
        
    * [Real-world examples of when to use each](#heading-real-world-examples-of-when-to-use-each)
        
* [Common Pitfalls and How to Avoid Them](#heading-common-pitfalls-and-how-to-avoid-them)
    
    * [Pitfall 1: Context hell (too many nested providers)](#heading-pitfall-1-context-hell-too-many-nested-providers)
        
    * [Pitfall 2: Massive context values causing unnecessary re-renders](#heading-pitfall-2-massive-context-values-causing-unnecessary-re-renders)
        
    * [Pitfall 3: Not memoizing context values](#heading-pitfall-3-not-memoizing-context-values)
        
    * [Pitfall 4: Prop drilling when Context would be better](#heading-pitfall-4-prop-drilling-when-context-would-be-better)
        
    * [Pitfall 5: Using global state for everything](#heading-pitfall-5-using-global-state-for-everything)
        
    * [Pitfall 6: Not handling loading and error states in shared state](#heading-pitfall-6-not-handling-loading-and-error-states-in-shared-state)
        
* [Best Practices for Maintainable Shared State](#heading-best-practices-for-maintainable-shared-state)
    
    * [1\. Use consistent naming conventions](#heading-1-use-consistent-naming-conventions)
        
    * [2\. Group related state and actions together](#heading-2-group-related-state-and-actions-together)
        
    * [3\. Create selector hooks for complex data access](#heading-3-create-selector-hooks-for-complex-data-access)
        
    * [4\. Handle side effects properly](#heading-4-handle-side-effects-properly)
        
    * [5\. Implement proper error boundaries](#heading-5-implement-proper-error-boundaries)
...
* [Conclusion: Building Maintainable React Applications](#heading-conclusion-building-maintainable-react-applications)
    ...
    * [Key principles to remember](#heading-key-principles-to-remember)
        
    * [The evolution of a typical application](#heading-the-evolution-of-a-typical-application)
        
    * [Final recommendations](#heading-final-recommendations)
...
`useReducer` has various benefits over multiple `useState`s:
