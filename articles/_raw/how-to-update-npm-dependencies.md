...
_Resource: [npm-check-updates](https://www.npmjs.com/package/npm-check-updates)_
...
Both `npm outdated` and `npm-check-updates` are useful tools to check for packages that could use a version bump. 
