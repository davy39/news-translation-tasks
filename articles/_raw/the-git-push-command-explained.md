---
title: The Git Push Command Explained
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
The `git push` command allows you to send (or _push_) the commits from your local branch in your local Git repository to the remote repository.
...
There are a number of different options you can pass with the command, you can learn more about them in the [Git documentation](https://git-scm.com/docs/git-push#_options_a_id_options_a) or run `git push --help`.
