...
![Diagram illustrating a queue. Items are added to the back through "enqueue" and removed from the front through "dequeue." Arrows show the flow into and out of a rectangular box representing the queue.](https://cdn.hashnode.com/res/hashnode/image/upload/v1749741091206/42a62a3c-cf1b-4e7a-b8ce-4209e13f70d3.png align="center")
...
* [What are Queues?](#heading-what-are-queues)
    
* [What are Linked Lists?](#heading-what-are-linked-lists)
    
* [What is a Simple Queue?](#heading-what-is-a-simple-queue)
    
* [What is a Circular Queue?](#heading-what-is-a-circular-queue)
    
* [What is a Double Ended Queue?](#heading-what-is-a-double-ended-queue)
    
* [What is a Priority Queue?](#heading-what-is-a-priority-queue)
    
* [When to Use Queues (and When to Avoid Them)](#heading-when-to-use-queues-and-when-to-avoid-them)
...
3. **Linked Lists Data Structure:** It's important to have a solid understanding of linked lists before starting this tutorial. I wrote a detailed [linked list tutorial](https://www.freecodecamp.org/news/how-to-code-linked-lists-with-typescript-handbook) that you can use to learn about this data structure.
...
Clone the project from the [GitHub repository and code along](https://github.com/Yazdun/fcc-queues) with the tutorial.
...
![Diagram of a linked list with four nodes connected sequentially. Node 1 is labeled as the head and Node 4 as the tail.](https://cdn.hashnode.com/res/hashnode/image/upload/v1749741385495/1bfab581-481d-4108-9f48-bf93d9dcf4f1.png align="center")
...
![Diagram showing a circular doubly linked list with five nodes labeled from Node 1 (head) to Node 5 (tail), connected in a loop.](https://cdn.hashnode.com/res/hashnode/image/upload/v1749741872784/d01a9c89-945e-4b4a-acff-56b7e528ea7e.png align="center")

You can learn more about circular linked lists in my [Linked Lists Handbook](https://www.freecodecamp.org/news/how-to-code-linked-lists-with-typescript-handbook/#heading-what-is-a-circular-linked-list).
