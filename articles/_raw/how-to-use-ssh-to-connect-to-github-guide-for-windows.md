...
1. [What is SSH?](#heading-what-is-ssh)
    
2. [How Does the Secure Shell Protocol Work?](#heading-how-does-the-secure-shell-protocol-work)
    

* [TCP/IP](#heading-tcpip)
    
* [The SSH Connection Process](#heading-the-ssh-connection-process)
    

3. [How to Use SSH in Windows](#heading-how-to-use-ssh-in-windows)
    

* [Windows PowerShell or Command Prompt](#heading-windows-powershell-or-command-prompt)
    
* [Windows Subsystem for Linux (WSL)](#heading-windows-subsystem-for-linux-wsl)
    
* [Third-Party SSH Clients (for example, PuTTY)](#heading-third-party-ssh-clients-for-example-putty)
    

4. [How to Use SSH In Windows To Connect To GitHub](#heading-how-to-use-ssh-in-windows-to-connect-to-github)
    

* [Install Through Windows Optional Features](#heading-install-through-windows-optional-features)
    
* [Download And Install From Github](#heading-download-and-install-from-github)
    
* [How To Generate SSH Keys](#heading-how-to-generate-ssh-keys)
    
* [How To Add The Public Key To GitHub](#heading-how-to-add-the-public-key-to-github)
    
* [Testing The SSH Connection](#heading-testing-the-ssh-connection)
    
* [Cloning A Repository Using SSH](#heading-cloning-a-repository-using-ssh)
...
SSH runs on the [TCP/IP set of rules](https://www.freecodecamp.org/news/what-is-tcp-ip-layers-and-protocols-explained/) that computers use to communicate over the internet.
...
You can read more about the TCP/IP protocol [here](https://www.cloudflare.com/learning/ddos/glossary/tcp-ip/) if you’d like to go deeper.
...
![ssh cli command result, in this case a positive one that ssh is installed on the system](https://cdn.hashnode.com/res/hashnode/image/upload/v1727215416889/9985624e-ffe6-4aff-9e58-2fe3e6b36f26.png align="center")
...
1. Visit the GitHub repository for the Win32-OpenSSH (32-bit) or Win64-OpenSSH (64-bit) release, depending on your Windows version:
    ...
    * 32-bit: [https://github.com/PowerShell/Win32-OpenShell/releases](https://github.com/PowerShell/Win32-OpenShell/releases)
        
    * 64-bit: [https://github.com/PowerShell/Win64-OpenShell/releases](https://github.com/PowerShell/Win64-OpenShell/releases)
...
![a windows prompt, generated by clicking "windows + r"](https://cdn.hashnode.com/res/hashnode/image/upload/v1727217366905/348ece20-432c-443e-951c-5c61ae4c7b94.png align="center")

The services manager:

![The services manager generated after clicking "windows + r"](https://cdn.hashnode.com/res/hashnode/image/upload/v1727217489636/dffca024-3cb2-4b2b-8a03-fb4a2b5cc629.png align="center")

Scroll and look for the openSSH SSH server:

![this is image indicates that openSSH server is runing in the system, automatically as far as the system is powered on ](https://cdn.hashnode.com/res/hashnode/image/upload/v1727217823859/accbf838-e6cb-491a-ad1a-affa0dd59230.png align="center")
...
![opened the openSSH on the services manager](https://cdn.hashnode.com/res/hashnode/image/upload/v1727218121688/a902b304-8103-49a5-8852-7094b4f70d5a.png align="center")
...
![ dedicated firewall rule that permits the OpenSSH Server to communicate through the Windows Firewall](https://cdn.hashnode.com/res/hashnode/image/upload/v1727219301264/fb58d5ce-f8cf-49d2-9b56-6f1571c08652.png align="center")
...
![cli command for generating ssh keys and its response](https://cdn.hashnode.com/res/hashnode/image/upload/v1727220068539/7ee02096-da9e-4a26-8da8-106ec2dcefee.png align="center")

You will get what you see in the above image if you’re successful.

The public key will be saved as `id_`[`rsa.pub`](http://rsa.pub) in the `.ssh` directory of your user's home folder (for example, `C:\Users\you\.ssh\id_`[`rsa.pub`](http://rsa.pub)).

![viewing the private and public ky oon our local system in our home-directory/.ssh](https://cdn.hashnode.com/res/hashnode/image/upload/v1727220167279/b04fed4a-17d1-49e6-ad34-d5cb41692d13.png align="center")
...
* Click on the "New SSH key" button. Give your key a descriptive title, and then copy the contents of the `id_`[`rsa.pub`](http://rsa.pub) file (your public key) into the "Key" field.
...
You can solve this by following the process [here](https://gist.github.com/bsara/5c4d90db3016814a3d2fe38d314f9c23).

### Cloning a Repository Using SSH

Navigate to one of your GitHub repositories and copy the SSH clone URL, which typically starts with [`git@github.com`](mailto:git@github.com):

![ssh link to clone a github repo](https://cdn.hashnode.com/res/hashnode/image/upload/v1727222441040/926444a1-bdf8-4f33-980c-0c2c87691a6b.png align="center")

In your local terminal, run the command `git clone` [`git@github.com`](mailto:git@github.com)`:username/repository.git` to clone the repository using the SSH protocol.
