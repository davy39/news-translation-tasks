...
If you’re a developer looking for a simple, fast, and self-hosted backend, [PocketBase](https://github.com/pocketbase/pocketbase) might be exactly what you need.
...
* [What is PocketBase](#heading-what-is-pocketbase)?
    
* [Why Developers Love PocketBase](#heading-why-developers-love-pocketbase)
    
* [How to Install Pocketbase](#heading-how-to-install-pocketbase)
    
* [Extending PocketBase with JavaScript](#heading-extending-pocketbase-with-javascript)
    
* [Using SDKs to Interact with PocketBase](#heading-using-sdks-to-interact-with-pocketbase)
    
* [Self-Hosting PocketBase using Sevalla](#heading-self-hosting-pocketbase-using-sevalla)
    
* [Security and Open Source Nature](#heading-security-and-open-source-nature)
    
* [When to Use PocketBase](#heading-when-to-use-pocketbase)
...
It includes an embedded [SQLite](https://sqlite.org/) database, real-time subscriptions, file and user management, a clean admin dashboard, and a REST-style API.
...
[PocketBase](https://pocketbase.io/docs/how-to-use/) focuses on speed and simplicity. You don’t need to install multiple packages or services.
...
Getting PocketBase running takes less than a minute. You can download a [prebuilt executable](https://pocketbase.io/docs/) from the official releases page.
...
You can create JavaScript files inside the pb\_hooks folder, and PocketBase will automatically load and run them. These scripts can listen to events like record creation, updates, authentication, and more.

Here’s a simple example that sends a welcome email whenever a new user signs up.

Create a file named pb\_hooks/user\_email.js inside your PocketBase directory:
...
This makes it friendly for teams who may not be comfortable with Go but still want to add dynamic logic to their backend. You can find more details in the official documentation under “[Extend with JavaScript](https://pocketbase.io/docs/js-overview/).”
...
When you are ready to move beyond testing, PocketBase gives you two options. You can self-host it using your own infrastructure or use their managed cloud version at [Pocketbase.io](https://pocketbase.io/).
...
* Sevalla has a [template for PocketBase](https://docs.sevalla.com/templates/overview), so it simplifies the manual installation and setup for each resource you will need for installation.
    

[Log in](https://app.sevalla.com/login) to Sevalla and click on Templates. You can see Pocketbaseas one of the templates.
...
To login for the first time, you will need a superuser login. To create that, go back to the application and click “Logs”. You will see a url starting with [https://0.0.0.0.](http://0.0.0.0.)
