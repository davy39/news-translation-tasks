...
![A comic I drew about using other people’s stuff, with the wheel as an example.](https://victoria.dev/blog/how-to-choose-and-care-for-a-secure-open-source-project/wheels.png)
...
Having [well-written documentation](https://victoria.dev/blog/word-bugs-in-software-documentation-and-how-to-fix-them/) is one way a project can stand out and demonstrate the thoughtfulness and dedication of its maintainers. 
