---
title: Do You Solve Programming Problems or Complete Exercises? (The Difference Matters.)
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2020-02-11T13:59:00.000Z'
originalURL: https://freecodecamp.org/news/do-you-solve-programming-problems-or-complete-exercises-the-difference-matters
coverImage: https://www.freecodecamp.org/news/content/images/2020/02/amy-haddad-article.jpg
tags:
- name: code
  slug: code
...
seo_desc: 'By Amy Haddad
  ...
  People tend to use the terms “problems” and “exercises” interchangeably. But there’s
  a difference—and it matters.

  Professor Paul Zeitz makes the distinction.

  Take 5 × 5. That’s easy, and that’s an exercise. So is 5,490,900 × 496. It’s a...'
---
...
“An exercise is a mathematical question that you immediately know how to answer,” explains Zeitz in a [lecture series on problem-solving](https://www.thegreatcoursesplus.com/show/art_and_craft_of_mathematical_problem_solving). “You may not answer it correctly, in fact you may never answer it correctly...but there’s no doubt about how to proceed.”
...
Each day we put our [problem-solving](https://www.freecodecamp.org/news/how-to-be-a-great-programmer-34939494996d/) skills to work as programmers: debugging code, learning a new topic, or even solving a problem. Exercises have their place, but as a programmer there’s no replacement for solving problems.
...
Here’s an example of an exercise from a [project](https://github.com/LambdaSchool/JS-Exercise-Functions-Arrays-Objects) that asked me to write a function, which took an array of cars.
...
It’s important to note that this exercise was once a problem for me. If you do a problem enough, it can become an exercise. At the same time, you can make an exercise a problem by [adding a constraint](https://www.freecodecamp.org/news/why-i-recycle-programming-problems-7785e04e451d/). 
...
The best solution is to endure it and get yourself [unstuck](https://www.freecodecamp.org/news/how-to-get-unstuck/). In my experience, the struggle means I’m learning a lot and the breakthrough is usually around the corner. 
