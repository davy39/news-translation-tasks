...
* [What is a JWT?](#heading-what-is-a-jwt)
    
    * [JSON Web Tokens Are Made Of Three Elements](#heading-json-web-tokens-are-made-of-three-elements)
        
    * [Asymmetric Signing (RS256) Explained](#heading-asymmetric-signing-rs256-explained)
        
    * [Analogy: The Lock and Key for Asymmetric Signatures](#heading-analogy-the-lock-and-key-for-asymmetric-signatures)
        
* [Symmetric Signing: HS256 (HMAC with SHA-256)](#heading-symmetric-signing-hs256-hmac-with-sha-256)
    
    * [How HS256 Verification Works](#heading-how-hs256-verification-works)
        
* [JWTs in Action: A Typical Authentication Flow](#heading-jwts-in-action-a-typical-authentication-flow)
    
* [JWT Security Best Practices & Considerations](#heading-jwt-security-best-practices-amp-considerations)
...
1. **Prepare the data:** The server takes the header (which includes the algorithm) and the payload. It Base64Url-encodes them, and then concatenates them with a dot: `Base64Url(Header) + "." + Base64Url(Payload)`.
    ...
    ![Animated gif of the process converting header and payload to base64 encoded string](https://cdn.hashnode.com/res/hashnode/image/upload/v1751810671075/128fa652-fe2a-4413-a238-71531bfe67ae.gif align="center")
...
![Image displaying the fully formed JWT token along with original header and payload](https://cdn.hashnode.com/res/hashnode/image/upload/v1751830473890/31da21a0-50db-4a48-b4c3-378c2ac1616a.png align="center")
...
![ Flow diagram of asymmetric verification process](https://cdn.hashnode.com/res/hashnode/image/upload/v1751813812291/de32c7b0-1f3c-4f26-995e-b5c618b104b3.png align="center")
...
![Flow diagram of symmetric verification process](https://cdn.hashnode.com/res/hashnode/image/upload/v1751814851136/a73b7af6-e92d-40f3-b1e3-c4bd2406ede9.png align="center")
...
I hope you’ve found this tutorial useful, and as always if you want to ask any questions or hear about upcoming articles, you can always follow me on ‘X’, my handle is @grantdotdev and follow by clicking [here](https://x.com/grantdotdev).
