---
title: What are Data Transfer Objects? Learn to Use DTOs in Your Java Spring-Based
  Projects
subtitle: ''
...
* [What is a DTO?](#heading-what-is-a-dto)
    
* [How to Create a DTO for a Spring-Based Application](#heading-how-to-create-a-dto-for-a-spring-based-application)
    
* [How to Create DTOs From Two or Multiple Objects](#heading-how-to-create-dtos-from-two-or-multiple-objects)
...
![Image showing the lifecycle of DTO in a software system](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfY0uhU1igdbtYzBocBZFOY37O2IjXOD5wCJ26DS0B3U6SZnIswn1n8kWi7ZKL5tQfSQjAZR7ecJ-5Aavop5iB3meJA5ywuKlv7fChG2Oq1_fxNtNW_8RijTFQx2d1ZG-A5y5uYag?key=3uLKQHZqj2e_zuUsBBBZwg align="center")

Image [source](https://www.linkedin.com/pulse/clean-spring-boot-apis-separating-entities-dtos-mappers-fabio-ribeiro-zrn9f?utm_source=share&utm_medium=member_ios&utm_campaign=share_via) | Fabio Ribeiro
...
![Image showing the bi-directional flow of DTO in a software system, flowing from controller to Database and from Database back to the controller](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdHient8hAwmq3b3KhZi2tNuh0n_1ZuIFJxef1VnM_R5K4KoC0gjeZAF1vZ1d1_lliWKmltiNhhtlfCpadydurab8dNkfLQiru1wGcl2Egak-_3-IYI_n5adrbcrU-4ezKIVERU?key=3uLKQHZqj2e_zuUsBBBZwg align="left")
