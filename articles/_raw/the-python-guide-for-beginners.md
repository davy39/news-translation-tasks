...
# Table of contents
1. [Introduction to Python](#heading-introduction-to-python)
2. [Installing Python 3](#heading-installing-python-3)
3. [Running Code](#heading-running-code)
4. [Syntax](#heading-syntax)
5. [Comments](#heading-comments)
6. [Variables](#heading-variables)
7. [Types](#heading-types)
8. [Typecasting](#heading-typecasting)
9. [User Input](#heading-user-input)
10. [Operators](#heading-operators)
11. [Conditionals](#heading-conditionals)
12. [Lists](#heading-lists)
13. [Tuples](#heading-tuples)
14. [Sets](#heading-sets)
15. [Dictionaries](#heading-dictionaries)
16. [while Loops](#heading-while-loops)
17. [for Loops](#heading-for-loops)
18. [Functions](#heading-functions)
19. [Scope](#heading-scope)
20. [List Comprehensions](#heading-list-comprehensions)
21. [Lambda Functions](#heading-lambda-functions)
22. [Modules](#heading-modules)
23. [if __name__ == '__main__'](#heading-if-name-main)
24. [Files](#heading-files)
25. [Classes and Objects](#heading-classes-and-objects)
26. [Inheritance](#heading-inheritance)
...
# Lists
As promised in the [Types](#heading-types) section, this section and the next three about Tuples, Sets, and Dictionaries will have more in depth explanations of each of them since they are very important and broadly used structures in Python to organize and deal with data.
