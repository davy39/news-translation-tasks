---
title: Git Blame Explained with Examples
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
You can find more information about aliasing git commands [here](https://guide.freecodecamp.org/git/git-alias/index.md).
