...
* **✨** [What is Event Delegation?](#heading-what-is-event-delegation)
* ✨ [What is Event Bubbling?](#heading-what-is-event-bubbling)
* ✨ [How Event Bubbling Happens in JavaScript](#heading-how-event-bubbling-happens-in-javascript)
* ✨ [How Event Bubbling Happens in React](#heading-how-event-bubbling-happens-in-react)
* ✨ [How to Stop Event Bubbling in Your Components](#heading-how-to-stop-event-bubbling-in-your-components)
* ✨ [Event.target vs Event.currentTarget](#heading-eventtarget-vs-eventcurrenttarget)
* ✨ [Updated Event Firing Order and useCapture Param in JavaScript](#heading-updated-event-firing-order-and-usecapture-param-in-javascript)
* ✨ [Which Events Do Not Bubble and How Are They Handled?](#heading-which-events-do-not-bubble-and-how-are-they-handled)
* ✨ [Event Listeners In React Version 16 and before VS Version 17+](#heading-event-listeners-in-react-version-16-and-before-vs-version-17)
* ✨ [Special Edge Case: What If You Need an Outer Parent to Fire too?](#heading-special-edge-case-what-if-you-need-an-outer-parent-to-fire-too)
...
_generated via [https://memegenerator.net/](https://memegenerator.net/" rel="nofollow noopener noopener)_
...
_Image from [https://ehsankorhani.com/](https://ehsankorhani.com/" rel="noopener ugc nofollow)_
...
_Image by [https://www.w3.org/](https://www.w3.org/" rel="nofollow noopener noopener)_
...
_Image by [React](https://reactjs.org/blog/2020/08/10/react-v17-rc.html" rel="noopener)_
...
_Image by Mariya Diminsky(me)_
...
_Image from [React](https://reactjs.org/docs/legacy-event-pooling.html" rel="noopener)_
...
Note that I’m utilizing arrow functions here so `bind`ing state isn’t necessary. If you aren’t sure what this means, feel free to [read another article I wrote about this topic here](https://www.freecodecamp.org/news/learn-es6-the-dope-way-part-ii-arrow-functions-and-the-this-keyword-381ac7a32881/).
...
_Screenshot by Mariya Diminsky taken from [Babel](https://babeljs.io/" rel="noopener)_
