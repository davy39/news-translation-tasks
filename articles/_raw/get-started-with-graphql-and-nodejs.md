...
The main purpose of this server-client [Node.js](https://nodejs.org/en/) project is to help other people **understand how GraphQL exposes data from the Server and how the Client fetches it**. 

I have tried to make it as simple as possible - if you want to dive into the code of the project you can find it [here](https://github.com/reymon359/graphql-hello-world-server).
...
![Writting query on GraphQl Playground](https://www.freecodecamp.org/news/content/images/2021/02/greeting-query-on-playground.gif)
...
![Fetching data from the server](https://www.freecodecamp.org/news/content/images/2021/02/fetching-data-from-server-3.png)
...
![Displaying the data](https://www.freecodecamp.org/news/content/images/2021/02/displaying-the-data.png)
...
I hope you enjoyed this article. You can read [it too on my site](https://ramonmorcillo.com/getting-started-with-graphql-and-nodejs/ ) along with others! If you've got any questions, suggestions, or feedback in general, don't hesitate to reach out on any of the social networks from [my site](https://ramonmorcillo.com/).
