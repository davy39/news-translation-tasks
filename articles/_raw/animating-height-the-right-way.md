...
The reason for this is of course that animating the height property in CSS causes the browser to perform expensive layout and paint operations on every frame. There’s a fantastic section on rendering performance over at [Google Web Fundamentals, I suggest you check it out.](https://developers.google.com/web/fundamentals/performance/rendering/)
...
As evidenced from Addy Osmani’s [excellent article](https://medium.com/@addyosmani/the-cost-of-javascript-in-2018-7d8950fbb5d4), low-end devices take significantly longer to parse and execute javascript compared to their higher end counterparts.
...
* [Demo site utilising the technique](https://resummy.no)
* [Live example in vanilla JS](https://codesandbox.io/s/3x2zjl0l7m)
* [Simple example in react](https://codesandbox.io/s/983z7n92rw)
* [NPM package and documentation for react](https://fredrikoseberg.github.io/react-anim-kit-docs/#/)
...
Instead I needed to get creative with other [CSS properties that does not incur those costs](https://csstriggers.com/). Namely transforms.
...
[You can see a live example here in vanilla JS.](https://codesandbox.io/s/3x2zjl0l7m)
...
As I previously mentioned, I developed this method while working on a personal project in React. This demo site uses this method exclusively in all of its “height animation”. [Check out the demo site here.](https://resummy.no/)
...
* [view the library on NPM here](https://www.npmjs.com/package/react-anim-kit)
* D[ocumentation can be found here.](https://fredrikoseberg.github.io/react-anim-kit-docs/#/docs/animateheight)
...
* [Example with moving surrounding content](https://codesandbox.io/s/jn5rp5jvzy)
...
* [Moving surrounding content with AnimateHeightContainer](https://codesandbox.io/s/6zz62yp65w)
* [Accordion example](https://codesandbox.io/s/202w3n81q0)
