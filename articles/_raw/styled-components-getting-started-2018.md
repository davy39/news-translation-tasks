...
This was until I started using styled-components, when I joined a build to learn project for a [Chingu](https://medium.com/chingu) voyage ([`grad.then()`](https://github.com/chingu-voyage3/grad.then/) if you're interested) we decided to use a CSS-in-JS package, [Marina](https://twitter.com/mar_biletska) who was on my team was such an inspiration for me watching how components were styled and really gave me the confidence to start using styled-components.
...
A great resource for getting started with styled-components which really helped me is [Simon Vrachliotis](https://twitter.com/simonswiss)'s [egghead.io](https://egghead.io/) styled-components [playlist](https://egghead.io/playlists/styled-components-4169206d) which is a great foundation for starting out with styled-components ? the first lesson is for pro members but the rest are currently available to watch for free.
