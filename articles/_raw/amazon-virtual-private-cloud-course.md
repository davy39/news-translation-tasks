...
We just released a full course about Amazon Virtual Private Cloud on the freeCodeCamp.org YouTube channel.
...
Watch the full course below or on [the freeCodeCamp.org YouTube channel](https://youtu.be/g2JOHLHh4rI) (2-hour watch).
...
And you type in example.com, the address of our web server.

Now what happens now because you put in example.com, but like I said, the computers communicate using IP addresses.

So this is where a domain name system or DNS server comes in.

Your computer will speak to a DNS server.

And it's going to ask that DNS server what is the IP address for example.com.
...
And we're going to paste it over where it says EC to dot Amazon aws.com.
