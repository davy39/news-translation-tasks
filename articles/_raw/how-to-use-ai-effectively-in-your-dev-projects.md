...
Here’s what the website we're building looks like: ([Live demo](https://car-rental-tutorial.vercel.app)) ([Github Repo](https://github.com/iamspruce/car-rental-tutorial))

![Final design of a responsive car rental website](https://cdn.hashnode.com/res/hashnode/image/upload/v1753118807037/0802b468-c69d-4792-9ac9-6ebe0421eef5.png align="center")

## Table of Contents

1. [Step 1: Planning and Research (The Brainstorm)](#heading-step-1-planning-and-research-the-brainstorm)
    
2. [Step 2: Design and UI Copy](#heading-step-2-design-and-ui-copy)
    
3. [Step 3: Writing the Boilerplate Code](#heading-step-3-writing-the-boilerplate-code)
    
4. [Step 4: Making the Code Actually Good](#heading-step-4-making-the-code-actually-good)
    
    * [What the AI Got Right (and Wrong)](#heading-what-the-ai-got-write-and-wrong)
        
    * [Refactoring in Action](#heading-refactoring-in-action)
        
5. [So, What's the Takeaway?](#heading-so-whats-the-takeaway)
...
![ChatGPT output showing a proposed plan for building a car rental website, including key features and suggested tech stack.](https://cdn.hashnode.com/res/hashnode/image/upload/v1753119862498/a583a845-73d7-41e3-be32-c880702e6d90.png align="center")
...
![Basic wireframes generated by ChatGPT representing the layout of a car rental website, including homepage, car listings, and contact section.](https://cdn.hashnode.com/res/hashnode/image/upload/v1753115541678/26056ae5-ff2e-47de-af4a-2b34605d8802.png align="center")
...
Okay, I've got a rough idea of the layout. Time to turn these ugly wireframes into a real design. For this, I use AI-powered UI generation tools (you can find a few out there, like [https://stitch.withgoogle.com](https://stitch.withgoogle.com/projects/17333997864138596143), or even use [v0.dev](https://v0.dev) to get ideas).
...
![AI-generated modern UI design for a car rental website, showcasing a clean, professional interface with car listings.](https://cdn.hashnode.com/res/hashnode/image/upload/v1753114569826/ef5bbf7d-d62d-4237-b424-97b02873c07f.png align="center")
...
![Code snippet provided by an AI UI tool that converts design directly into HTML and CSS for a car rental site.](https://cdn.hashnode.com/res/hashnode/image/upload/v1753114611241/a929850d-5d93-4338-a5f6-5dc7991118b7.png align="center")
...
You can always play with the full code [here](https://github.com/iamspruce/car-rental-tutorial).
...
![Gemini output converting HTML and Tailwind code into a functional React + TypeScript app using shadcn/ui and lucide-react.](https://cdn.hashnode.com/res/hashnode/image/upload/v1753115245332/b1a0f42c-820c-4f7e-9730-77fb47cc35fb.png align="center")
