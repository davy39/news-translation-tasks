...
_An empty SVG element with a black border._
...
_After appending the rectangles with data to the SVG._
...
_After setting the x and y positions of the rectangles._
...
_Adding text labels to our bars._
