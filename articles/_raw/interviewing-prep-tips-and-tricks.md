---
title: How to prepare for a technical interview - tips and tricks to help you perform
  your best
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2019-09-30T23:22:43.000Z'
originalURL: https://freecodecamp.org/news/interviewing-prep-tips-and-tricks
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9ca02f740569d1a4ca4715.jpg
tags:
...
seo_desc: "By John Mosesman\nAh, the coding interview. \n\n\"Dread it. Run from it.\
  \ Destiny arrives all the same.\"    - Thanos 2018\n\nOk, maybe that's a little\
  \ dramatic, but I don't know anyone who is thrilled about going through the interview\
  \ process. The job searc..."
---
...
Two of the main ones are [FizzBuzz](https://en.wikipedia.org/wiki/Fizz_buzz) and solving the [Fibonacci sequence](https://en.wikipedia.org/wiki/Fibonacci_number) (make sure you know these).
...
Read books like [Cracking the Coding Interview](http://www.crackingthecodinginterview.com/) or practice algorithms and puzzles on [HackerRank](https://www.hackerrank.com/).

Read the other great posts on [Developer News](https://www.freecodecamp.org/news/search/?query=interview) about interviewing.
...
Afterwards if you feel embarrassed, defeated, or anything else—take a deep breath and let it go! Don't let your [Lizard Brain](https://seths.blog/2010/01/quieting-the-lizard-brain/) weigh you down. A bad interview is not the end of the world. Your career isn't ruined, your reputation isn't ruined, and your life isn't ruined.
...
If you have any questions or comments, feel free to reach out to [me on Twitter](https://twitter.com/johnmosesman/), and if you want more information on how to prepare for a development career, I write stuff like this on [my blog.](https://johnmosesman.com/)
