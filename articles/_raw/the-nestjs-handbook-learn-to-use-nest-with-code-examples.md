...
1. [What is NestJS?](#heading-1-what-is-nestjs)
    
    * [1.1 History and Philosophy](#heading-11-history-and-philosophy)
        
2. [Why Choose NestJS?](#heading-2-why-choose-nestjs)
    
    * [2.1 Benefits and Use Cases](#heading-21-benefits-and-use-cases)
        
    * [2.2 Comparison with Other Frameworks](#heading-22-comparison-with-other-frameworks)
        
3. [Getting Started](#heading-3-getting-started)
    
    * [3.1 Installing the CLI](#heading-31-installing-the-cli)
        
    * [3.2 Creating Your First Project](#heading-32-creating-your-first-project)
        
    * [3.3 Project Structure Overview](#heading-33-project-structure-overview)
        
4. [Core NestJS Building Blocks](#heading-4-core-nestjs-building-blocks)
    
    * [4.1 Modules](#heading-41-modules)
        
    * [4.2 Controllers](#heading-42-controllers)
        
    * [4.3 Providers (Services)](#heading-43-providers-services)
        
5. [Dependency Injection](#heading-5-dependency-injection)
    
    * [5.1 How DI Works in NestJS](#heading-51-how-di-works-in-nestjs)
        
    * [5.2 Custom Providers and Factory Providers](#heading-52-custom-providers-and-factory-providers)
        
6. [Routing & Middleware](#heading-6-routing-amp-middleware)
    
    * [6.1 Defining Routes](#heading-61-defining-routes)
        
    * [6.2 Applying Middleware](#heading-62-applying-middleware)
        
7. [Request Lifecycle & Pipes](#heading-7-request-lifecycle-amp-pipes)
    
    * [7.1 What Are Pipes?](#heading-71-what-are-pipes)
        
    * [7.2 Built-In vs. Custom Pipes](#heading-72-built-in-vs-custom-pipes)
        
8. [Guards & Authorization](#heading-8-guards-amp-authorization)
    
    * [8.1 Implementing Guards](#heading-81-implementing-guards)
        
    * [8.2 Role-Based Access Control](#heading-82-role-based-access-control)
        
9. [Exception Filters](#heading-9-exception-filters)
    
    * [9.1 Handling Errors Gracefully](#heading-91-handling-errors-gracefully)
        
    * [9.2 Creating Custom Filters](#heading-92-creating-custom-filters)
        
10. [Interceptors & Logging](#heading-10-interceptors-amp-logging)
    
    * [10.1 Transforming Responses](#heading-101-transforming-responses)
        
    * [10.2 Logging and Performance Metrics](#heading-102-logging-and-performance-metrics)
        
11. [Database Integration](#heading-11-database-integration)
    
    * [11.1 TypeORM with NestJS](#heading-111-typeorm-with-nestjs)
        
    * [11.2 Mongoose (MongoDB)](#heading-112-mongoose-mongodb)
        
    * [11.3 Prisma](#heading-113-prisma)
        
12. [Configuration Management](#heading-12-configuration-management)
    
    * [12.1 @nestjs/config Module](#heading-121-nestjsconfig-module)
        
    * [12.2 Environment Variables](#heading-122-environment-variables)
        
13. [Authentication](#heading-13-authentication)
    
    * [13.1 JWT Strategy](#heading-131-jwt-strategy)
        
    * [13.2 OAuth2 / Social Login](#heading-132-oauth2-social-login)
        
14. [Conclusion & Further Resources](#heading-conclusion-amp-further-resources)
    
    * [Summary](#heading-summary)
        
    * [Official Docs and Community Links](#heading-official-docs-and-community-links)
...
This launches a development server on [`http://localhost:3000`](http://localhost:3000) with automatic reload on file changes.
