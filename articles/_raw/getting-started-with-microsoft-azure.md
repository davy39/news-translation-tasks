---
title: How to Get Started with Microsoft Azure - Function Apps, HTTP Triggers, and
  Event Queues
subtitle: ''
author: freeCodeCamp
co_authors: []
...
Microsoft jumped into this space with [Azure](https://azure.microsoft.com) a while back. Their portal, where all the services are grouped and "organized", offers so many services it feels nearly impossible to be an expert. 

I'll cover __function apps, triggers, bindings, and event queues__, enough to get a web developer started on something great in the cloud.

![Tulip fields near Amsterdam](https://www.freecodecamp.org/news/content/images/2019/09/spring-2019-16.jpg)
...
![Creating a function app in Azure's web portal](https://www.freecodecamp.org/news/content/images/2019/09/create-function-app.png)

![Function app settings](https://www.freecodecamp.org/news/content/images/2019/09/function-app-creation-settings.png)
...
![Azure function app logs after http trigger](https://www.freecodecamp.org/news/content/images/2019/09/http-trigger-in-azure.png)
...
```
[Bindings](https://docs.microsoft.com/en-us/azure/azure-functions/functions-triggers-bindings) are Azure's handy way to connect to various services and resources without needing to do a lot of setup.
...
![Sending a request through Postman to our Azure function app](https://www.freecodecamp.org/news/content/images/2019/09/postman-request-to-http-trigger.png)
...
![Azure function app logs receiving an http trigger](https://www.freecodecamp.org/news/content/images/2019/09/trigger-demo-logs-executing.png)
...
But if something is wrong with our send-email code, we would never want that to get in the way of creating a user or responding to the customer. We can create async messaging through an [event queue](https://docs.microsoft.com/en-us/azure/azure-functions/functions-bindings-storage-queue).
...
![Azure function app resource group](https://www.freecodecamp.org/news/content/images/2019/09/function-app-resource-group.png)
...
![Azure function app logs after queue trigger](https://www.freecodecamp.org/news/content/images/2019/09/queue-trigger-executing.png)
...
The same job might add to a queue about sending an email, triggering a coupon SMS to send in an hour, putting a Slack message
to a marketing team, or any of a million other things that might need to happen when a new user is created. If any one of them fails (Slack is down?), the others go on happily on their way.
...
_You can read more of my articles on my blog at [wilkie.tech](https://wilkie.tech)._
