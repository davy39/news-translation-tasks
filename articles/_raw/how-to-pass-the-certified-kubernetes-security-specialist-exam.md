---
title: How to Pass the Certified Kubernetes Security Specialist Exam – Cheat sheet
  and Study Guide
subtitle: ''
author: freeCodeCamp
co_authors: []
...
* [Resources for the CKS Exam](#heading-resources-for-the-exam)
* [Aliases](#heading-aliases)
    * [vi defaults for ~/.vimrc](#heading-vi-defaults-for-vimrc)
    * [kubectl defaults for ~/.bashrc](#heading-kubectl-defaults-for-bashrc)
* [Shortcuts](#heading-shortcuts)
* [Kubernetes Cheat Sheet](#heading-kubernetes-cheat-sheet)
    * [kubectl run command](#heading-kubectl-run-command)
    * [How to generate yaml spec from an existing pod](#heading-how-to-generate-yaml-spec-from-an-existing-pod)
    * [kubectl pod commands](#heading-kubectl-pod-commands)
    * [How to print logs and export them](#heading-how-to-print-logs-and-export-them)
    * [How to create configmaps and secrets](#heading-how-to-create-config-maps-and-secrets)
    * [Helpful commands for debugging](#heading-helpful-commands-for-debugging)
    * [Rolling updates and rollouts](#heading-rolling-updates-and-rollouts)
    * [Scale and autoscale command](#heading-scale-and-autoscale-command)
    * [Network policy](#heading-network-policy)
    * [Static analysis using Kubesec](#heading-static-analysis-using-kubesec)
    * [Vulnerability scanning using Trivvy](#heading-vulnerability-scanning-using-trivvy)
    * [How to remove unwanted services](#heading-how-to-remove-unwanted-services)
    * [Runtime classes](#heading-runtime-classes)
    * [RBAC commands](#heading-rbac-commands)
    * [Cluster maintenance](#heading-cluster-maintenance)
* [CKS Exam Tips](#heading-cks-exam-tips)
    * [JSON and JSONPath](#heading-json-and-jsonpath)
* [CKS Exam Topics](#heading-cks-exam-topics)
    * [How to secure and harden container images](#heading-how-to-secure-and-harden-container-images)
    * [How to minimise OS footprint](#heading-how-to-minimise-os-footprint)
        * [Conatiner layers](#heading-conatiner-layers)
        * [Multi stage builds](#heading-multi-stage-builds)
    * [How to limit node access](#heading-how-to-limit-node-access)
    * [SSH hardening](#heading-ssh-hardening)
        * [How to disable SSH](#heading-how-to-disable-ssh)
        * [How to remove obsolete packages and services](#heading-how-to-remove-obsolete-packages-and-services)
        * [How to restrict kernel modules](#heading-how-to-restrict-kernel-modules)
        * [How to identify and disable open ports](#heading-how-to-identify-and-disable-open-ports)
    * [How to restrict network access](#heading-how-to-restrict-network-access)
        * [How to identity a service running on port](#heading-how-to-identity-a-service-running-on-port)
        * [UFW firewall](#heading-ufw-firewall)
    * [Linux syscalls](#heading-linux-syscalls)
        * [How to trace Syscalls using Strace](#heading-how-to-trace-syscalls-using-strace)
    * [AquaSec tracee](#heading-aquasec-tracee)
    * [How to restrict syscalls with Seccomp](#heading-how-to-restrict-syscalls-with-seccomp)
        * [Seccomp in Kubernetes](#heading-seccomp-in-kubernetes)
    * [AppArmor](#heading-apparmor)
        * [How to use AppArmor in Kubernetes](#heading-how-to-use-apparmor-in-kubernetes)
    * [Linux capabilities](#heading-linux-capabilities)
* [How to Prepare for the Exam](#heading-how-to-prepare-for-the-exam)
* [Practice, practice, and practice!](#heading-practice-practice-and-practice)
***
...
*You can read this and other articles at [faizanbashir.me](https://faizanbashir.me/rough-guide-to-qualifying-the-cks-exam-in-a-hurry)*
