...
* [Introduction to Server Actions in Next.js](#introduction-to-server-actions-in-nextjs)
    
* [Introduction to zod for Validation](#introduction-to-zod-for-validation)
    
* [How to Build the Contact Form Component](#heading-how-to-build-the-contact-form-component)
    
* [How to Create the Server Actions and Validate the Form Data with zod](#heading-how-to-create-the-server-actions-and-validate-the-form-data-with-zod)
    
* [How to Integrate the Server Action into Our Contact Form](#heading-how-to-integrate-the-server-action-into-our-contact-form)
...
![working form](https://cdn.hashnode.com/res/hashnode/image/upload/v1732051133068/960bd90a-cb22-4e8b-86e2-fdb78b5cf330.gif align="center")

**Note**: this tutorial mainly focuses on the logic and not the design. For the complete design, you can visit the GitHub repository which I’ve linked to at the end.
...
Inside the `app` directory, create a folder called "components.**"**

Inside of the `components` folder, create a new file, `contactForm.tsx`, and add the following code:
...
Import the `ContactForm` component in your `page.tsx` file:
...
![contact form image](https://cdn.hashnode.com/res/hashnode/image/upload/v1732048786231/694ac568-9d71-4597-ba61-962483740320.png align="center")
...
In the **app** folder, create another folder, `api`.

Inside the `api` folder, create a file called `action.ts` and paste in the following code:
...
**Note:** this is where you send the message to your email using any email service provider of your choice. For the sake of the article, we are simply returning an object.
...
![working form](https://cdn.hashnode.com/res/hashnode/image/upload/v1732051093066/c6cd1da7-fe24-4eea-85db-a6845efc501d.gif align="center")
...
* [server action documentation](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations)
    

Here's the [GitHub repository](https://github.com/DeraCodings/server-action-zod) of the complete project.
