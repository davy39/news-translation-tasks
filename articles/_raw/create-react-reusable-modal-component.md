...
* [What Will This Article Cover?](#heading-what-will-this-article-cover)
    
* [The Core Modal Component](#heading-the-core-modal-component)
    
* [Props Interface](#heading-props-interface)
    
* [The Markup](#heading-the-markup)
    
* [React useEffect](#heading-react-useeffect)
    
* [When Do We Use useEffect?](#heading-when-do-we-use-useeffect)
    
* [How to Use the Reusable Modal](#heading-how-to-use-the-reusable-modal)
    
* [Additional Improvements](#heading-additional-improvements)
...
If you’re not familiar with `useEffect` and plan on using React more, l’d highly recommend reading about it [here](https://react.dev/reference/react/useEffect), as it is one of the backbones of React’s ecosystem.
...
As always, feel free to drop me a follow or reach out on [Twitter/X](https://x.com/grantdotdev).
