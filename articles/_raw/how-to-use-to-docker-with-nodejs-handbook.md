...
In this handbook, you’ll learn what Docker is and why it’s a must-have skill for backend and full-stack developers. And, most importantly, you’ll learn how to use it in real-world projects from start to finish.
...
1. [What is a Container?](#heading-what-is-a-container)
    
2. [Docker vs Virtual Machines](#heading-docker-vs-virtual-machines)
    
3. [Docker Installation](#heading-docker-installation)
    
4. [Basic Docker Commands](#heading-basic-docker-commands)
    
5. [Practice with JavaScript](#heading-practice-with-javascript)
    
    * [How to Pull the MongoDB Image](#heading-how-to-pull-the-mongodb-image)
        
    * [How to Pull the Mongo Express Image](#heading-how-to-pull-the-mongo-express-image)
        
    * [Docker Network](#heading-docker-network)
...
9. [How to Use Docker Compose](#heading-how-to-use-docker-compose)
    ...
    * [Why Use Docker Compose?](#heading-why-use-docker-compose)
        
10. [How to Build Our Own Docker Image](#heading-how-to-build-our-own-docker-image)
    
    * [The Solution](#heading-the-solution)
        
    * [Why Mongodb Works](#heading-why-mongodb-works)
        
    * [Add Your App to Docker Compose](#heading-add-your-app-to-docker-compose)
        
    * [Start All Services](#heading-start-all-services)
        
    * [Verify Everything Works](#heading-verify-everything-works)
        
    * [What Changed and Why It Works](#heading-what-changed-and-why-it-works)
...
12. [How to Create a Private Docker Repository](#heading-how-to-create-a-private-docker-repository)
    ...
    * [Step 1: Get Your AWS Access Keys](#heading-step-1-get-your-aws-access-keys)
        
    * [Step 2: Check if AWS CLI is Installed](#heading-step-2-check-if-aws-cli-is-installed)
        
    * [Step 3: Configure AWS CLI](#heading-step-3-configure-aws-cli)
        
    * [Step 4: Test Your AWS Configuration](#heading-step-4-test-your-aws-configuration)
        
    * [Step 5: Login to ECR (Docker Registry)](#heading-step-5-login-to-ecr-docker-registry)
        
    * [Understanding Image Naming in Docker Repositories](#heading-understanding-image-naming-in-docker-repositories)
        
    * [Step 6: Build, Tag, and Push Your Image](#heading-step-6-build-tag-and-push-your-image)
        
13. [Assignment: Create and Push a New Version](#heading-assignment-create-and-push-a-new-version)
    
    * [Deploying Our Image](#heading-deploying-our-image)
        
    * [Why Must We Use the Full Image URL for ECR](#heading-why-must-we-use-the-full-image-url-for-ecr)?
        
    * [Deploy Your App Using Docker Compose](#heading-deploy-your-app-using-docker-compose)
        
    * [Sharing Our Private Docker Image](#heading-sharing-our-private-docker-image)
        
14. [Docker Volumes](#heading-docker-volumes)
    
    * [How Docker Volumes Work](#heading-how-docker-volumes-work)
        
    * [Types of Docker Volumes](#heading-types-of-docker-volumes)
        
    * [Example Docker Compose File Using Volumes](#heading-example-docker-compose-file-using-volumes)
        
    * [Start Your Application](#heading-start-your-application)
...
![pictures of stack containers, to portrait or give an idea what containers are or a vivid pictureof containers aliking to containers in docker](https://cdn.hashnode.com/res/hashnode/image/upload/v1762863191484/827d0731-a392-419f-b17b-9a3611a4f3b4.jpeg align="center")

### Where Do Containers Live?

Since containers are portable and can be shared across teams and systems, they need a place to live. That’s where container repositories come in – special storage locations for containers. Organizations can have private repositories for internal use, while public ones like [Docker Hub](https://hub.docker.com/) let anyone browse and use shared containers.

![an image of docker hub, showing a catalogue of images](https://cdn.hashnode.com/res/hashnode/image/upload/v1762863680430/caddd581-08e1-45c7-a676-818ad364f56b.png align="center")
...
Docker works on Windows, macOS, and Linux, but each system has slightly different steps. The official Docker [documentation](https://docs.docker.com/get-started/introduction/) has clear instructions for all operating systems under Docker Docs: Install Docker.

If you are more of a visual learner, this YouTube video walks you through installing Docker on Windows and Linux step by step: [Watch here](https://www.youtube.com/watch?v=BuGEGM_elXY).

Here is a simple roadmap:

First, check your system requirements. Docker won’t run on every computer, so make sure your OS version is supported (the official [docs](https://docs.docker.com/engine/install/) have a checklist).

1. Windows and macOS users:
    
    * **Newer systems:** Download and install [**Docker Desktop**](https://docs.docker.com/desktop/)**.** It’s the easiest way to get started.
        
    * **Older systems:** If your computer doesn’t support Docker Desktop (for example, missing Hyper-V or older OS versions), you can use [**Docker Toolbox**](https://docker-docs.uclv.cu/toolbox/toolbox_install_windows/). Toolbox installs Docker using a lightweight virtual machine, so you can still run containers even on older machines.
        
2. Linux users: You will usually install Docker through your package manager (`apt` for Ubuntu/Debian, `yum` for CentOS/Fedora, etc.). The official [docs](https://docs.docker.com/desktop/setup/install/linux/) show the commands for your distro.
...
![docker version displayed on cli](https://cdn.hashnode.com/res/hashnode/image/upload/v1762871221981/6b01cf18-a8b5-4aa9-b213-38cffd4ae5f4.png align="center")
...
![docker run redis shown on cli](https://cdn.hashnode.com/res/hashnode/image/upload/v1762872367018/39039261-9617-4e5f-8156-9529697d0667.png align="center")
...
![running docker images on cli](https://cdn.hashnode.com/res/hashnode/image/upload/v1762872440545/bfdb401f-7dd6-4f72-920b-545fbf5193e1.png align="center")
...
![ran docker ps in the terminal to list all running containers](https://cdn.hashnode.com/res/hashnode/image/upload/v1762873018123/2e184c25-e4f1-445c-b182-81987929c014.png align="center")
...
To know which versions are available, you can visit [**Docker Hub**](https://hub.docker.com/repositories) or check the image tags online. Also, running `docker images` on your machine will show you all downloaded images and their versions.
...
![starting a docker container with logs](https://cdn.hashnode.com/res/hashnode/image/upload/v1762873445952/ffb56b5d-f850-4b53-998d-467ed431a191.png align="center")
...
![result of running docker exec -it my-redis2 /bin/sh](https://cdn.hashnode.com/res/hashnode/image/upload/v1762876729378/d16e8f00-ab9c-447b-b274-76d613b30ce3.png align="center")
...
You can [pull the starter project from GitHub here](https://github.com/Oghenekparobo/docker_tut_js).
...
Next, we will prepare to set up our database. Head over to [Docker Hub](https://hub.docker.com/) and type **“mongo”** in the search box. You will see the official MongoDB image published by Docker.

![official mongo db database in dockerhub](https://cdn.hashnode.com/res/hashnode/image/upload/v1762950041097/89f54e21-f607-488a-8d98-d688733270c4.png align="center")
...
![mongo db listed in the repository column after running docker images](https://cdn.hashnode.com/res/hashnode/image/upload/v1762950246712/343d4d23-9c61-4480-956c-a5c2cd391889.png align="center")
...
![docker images command showing both mongo db database and mongo express images verifying they have been installed by docker on your project](https://cdn.hashnode.com/res/hashnode/image/upload/v1762951088081/06345eb1-80c9-4fcd-8585-5ff309ed2779.png align="center")
...
![mongo-network created with docker network create mongo-network then to see it in the list run docker network ls](https://cdn.hashnode.com/res/hashnode/image/upload/v1762953968310/bdf51a4e-1986-48a4-922b-6f312ff99414.png align="center")
...
![checking if the mongo container is running](https://cdn.hashnode.com/res/hashnode/image/upload/v1762956236708/44dbe331-b736-4526-8dae-019150b618d8.png align="center")
...
For more details about the available environment variables and options, you can check the official Docker Hub page for Mongo Express [here](https://hub.docker.com/_/mongo-express).

Before opening your browser at [`http://localhost:8081`](http://localhost:8081), it’s a good idea to check if the Mongo Express container is running properly. You can do this by viewing its logs:
...
Once everything looks good in the logs, you can safely visit [`http://localhost:8081`](http://localhost:8081) to access the Mongo Express interface.

![mongo-express interface from http://localhost:8081 ](https://cdn.hashnode.com/res/hashnode/image/upload/v1762957766334/f64b1f06-87a8-4ffb-b905-47e1871cca64.png align="center")
...
You already have MongoDB running inside a Docker container (mongo). The container exposes the default MongoDB port 27017 to the host, so any process on your laptop/desktop can reach it via [localhost:27017](http://localhost:27017).

**Important:** The Node.js app is **outside Docker** (it’s just a regular node server.js process you start from your terminal).

Because the app is external, we **must use** [**localhost**](http://localhost) (or 127.0.0.1) as the host name – **not** the container name mongo.

Once we later containerise the Node.js app and put it on the same Docker network, we’ll switch the host to mongo. For now, keep it [localhost](http://localhost).
...
You can get the full backend and frontend code ready to run and tweak it for your setup here: [GitHub repo](https://github.com/Oghenekparobo/docker_tut_js/tree/mongodb-connection).
...
![docker-composer.yml file in the root of the project](https://cdn.hashnode.com/res/hashnode/image/upload/v1763032152636/7fc026ba-d593-4097-a34c-945b398f2aeb.png align="center")
...
* To access Mongo Express, open your browser and go to [http://localhost:8081](http://localhost:8081) to interact with MongoDB through the web interface.
...
![docker compose up -d succesfuly created the containers and docker ps shows the containers](https://cdn.hashnode.com/res/hashnode/image/upload/v1763034021801/c4f806d2-080f-4b52-9f36-7b2044a7f8c5.png align="center")
...
You can get a full sample, including the Dockerfile **and** the docker‑compose file, [here](https://github.com/Oghenekparobo/docker_tut_js/tree/docker-compose).
...
![Dockerfile VS CODE Illustration](https://cdn.hashnode.com/res/hashnode/image/upload/v1763037649231/a831ccc0-5b84-4e70-82bf-08ef7de85ddf.png align="center")
...
Once this runs, your Node.js app will be live inside a container, separate from your local environment. You can open your browser at [`http://localhost:3000`](http://localhost:3000) and see your Todo app working just like it did locally.
...
* **container\_name: todo-app** that gives the container a friendly name
    
* **ports: "3000:3000"** that exposes the app on port 3000
    
* **depends\_on: mongodb** that ensures MongoDB starts before the app
...
Get the full updated code [here](https://github.com/Oghenekparobo/docker_tut_js/tree/docker-image).
...
![Amazon ECR Landing page](https://cdn.hashnode.com/res/hashnode/image/upload/v1763044840247/bbfb5cfa-aa22-4a4f-a5e4-da91cd539063.png align="center")
...
![creating our repository on AWS ECR](https://cdn.hashnode.com/res/hashnode/image/upload/v1763045060132/b2f8b287-026c-47f6-bd44-9fbad62da0f5.png align="center")
...
![AWS ECR our todo-app empty repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1763045250855/477e4566-8f47-41f8-93e6-4c3bcb28668f.png align="center")
...
1. Log in to the AWS Console at [https://console.aws.amazon.com](https://console.aws.amazon.com)
...
* [`docker.io`](http://docker.io) is the registry (in this case, Docker Hub)
...
![aws push commands for the ecr todo-app repo ](https://cdn.hashnode.com/res/hashnode/image/upload/v1763050402411/f4afd0ed-bc2a-4bf2-9bc4-4d373a54bab4.png align="center")
...
![your image now deployed on AWS ECR](https://cdn.hashnode.com/res/hashnode/image/upload/v1763066904897/fe44a2e2-1e20-4ff5-88ec-799475b2fe0d.png align="center")
...
You can find the final code here: [https://github.com/Oghenekparobo/docker\_tut\_js/tree/final](https://github.com/Oghenekparobo/docker_tut_js/tree/final)
