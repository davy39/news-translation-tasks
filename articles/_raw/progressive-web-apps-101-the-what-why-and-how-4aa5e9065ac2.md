...
The term Progressive Web App was coined by [Alex Russell](https://www.freecodecamp.org/news/progressive-web-apps-101-the-what-why-and-how-4aa5e9065ac2/undefined) and Frances Berriman. In Alex’s words:
...
_User engagement on mobile web vs apps_
...
Google has published a [checklist of items](https://developers.google.com/web/progressive-web-apps/checklist) for Progressive Web apps. I will go over four minimum requirements for an application to be a PWA:

#### 1. Web App Manifest

![Image](https://cdn-media-1.freecodecamp.org/images/1*LhaR74lzxYyeKwNOWh9oNQ.png)
_A sample manifest.json file_

This is just a `json` file that gives meta information about the web app. It has information like the icon of the app (which a user sees after installing it in their app drawer), background color of the app, name of the app, short name, and so on. We can write this manifest file ourselves or we can use [tools](https://app-manifest.firebaseapp.com/) to generate one for us.

![Image](https://cdn-media-1.freecodecamp.org/images/1*yzOwzdDG48AlJcPrSby1kw.png)
_You can auto-generate manifest file using Google’s tools._
...
**Note: This is part 1 of 2 part series. In the next part, we will create a Progressive Web App from scratch with a skeleton index.html. [Check out part 2 here.](https://medium.freecodecamp.org/progressive-web-apps-102-building-a-progressive-web-app-from-scratch-397b72168040)**

Did you learn something new? Have comments? Know a DevJoke? [Tweet me @shrutikapoor08](https://twitter.com/shrutikapoor08)

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Why do programmers get confused between Halloween and Christmas?<br>Because OCT 31 = DEC 25 <a href="https://twitter.com/hashtag/DevJokes?src=hash&amp;ref_src=twsrc%5Etfw">#DevJokes</a> <a href="https://twitter.com/hashtag/WorkChat?src=hash&amp;ref_src=twsrc%5Etfw">#WorkChat</a></p>&mdash; Shruti Kapoor (@shrutikapoor08) <a href="https://twitter.com/shrutikapoor08/status/1010257045566586880?ref_src=twsrc%5Etfw">June 22, 2018</a></blockquote>
