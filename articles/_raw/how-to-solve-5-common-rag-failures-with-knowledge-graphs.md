...
subtitle: Moving beyond semantic search for robust reasoning.
...
* [The Brittle Baseline: Our Standard RAG Setup](#heading-the-brittle-baseline-our-standard-rag-setup)
    
* [A More Robust Implementation: The KnowledgeGraph](#heading-a-more-robust-implementation-the-knowledgegraph)
    
    * [What is a Knowledge Graph?](#heading-what-is-a-knowledge-graph)
        
    * [Why is this More Effective?](#heading-why-is-this-more-effective)
        
* [5 RAG Failures and Their Graph-Based Solutions](#heading-5-rag-failures-and-their-graph-based-solutions)
    
    * [Pattern 1: The Multi-Hop Failure](#heading-pattern-1-the-multi-hop-failure)
        
    * [Pattern 2: The Causal Synthesis Failure](#heading-pattern-2-the-causal-synthesis-failure)
        
    * [Pattern 3: The Entity Ambiguity Trap](#heading-pattern-3-the-entity-ambiguity-trap)
        
    * [Pattern 4: The Contradictory Information Failure](#heading-pattern-4-the-contradictory-information-failure)
        
    * [Pattern 5: The Implicit Relationship Hallucination](#heading-pattern-5-the-implicit-relationship-hallucination)
...
3. **Resolve contradictions:** It can store metadata (like dates) directly *on the edge* to programmatically determine the most current fact.
...
Our `query_explicit_relation` function asks a very specific, structural question: "Start at the node **'Tesla'** and return *only* the nodes connected to it by an edge with the *exact label* **'partners\_with'**".
