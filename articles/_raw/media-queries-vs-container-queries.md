...
* [Responsive and Intrinsic Web Design](#heading-responsive-and-intrinsic-web-design)
* [What are media queries?](#heading-what-are-media-queries)
* [What are container queries?](#heading-what-are-container-queries)
* [Real-life comparison and key differences](#heading-how-do-media-queries-and-container-queries-compare)
* [Which should you use and when?](#heading-which-should-you-use-and-when)
* [Conclusion](#heading-conclusion)

## Responsive and Intrinsic Web Design

Before 2010, web developers could get away with creating websites that worked mainly on desktop. This was until Ethan Marcotte introduced the concept of Responsive Web Design (RWD). It's [defined by MDN](https://developer.mozilla.org/en-US/docs/Learn/CSS/CSS_layout/Responsive_Design) as _a way to design for a multi-device web_. This lead to the adoption of media queries as a component of RWD. 
...
_Media and container queries CodePen demo: project inspired by Miriam Suzanne._
...
_Summary of main differences, explained in detail below_
...
_Media query vs container query (image credit: <i>[web.dev](http://web.dev/)</i>)_
...
* [freeCodeCamp on Media Queries](https://www.freecodecamp.org/news/learn-css-media-queries-by-building-projects/)
* [Ahmad Shadeed on Container Queries](https://ishadeed.com/article/css-container-query-guide/)
* [How to Use Media Queries and Container Queries](https://www.youtube.com/watch?v=2rlWBZ17Wes)
