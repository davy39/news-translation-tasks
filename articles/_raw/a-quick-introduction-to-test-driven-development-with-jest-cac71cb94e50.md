...
You may now continue on your own as well. Check out the definitive version of the kata with all tests passing [here](https://github.com/nclsmitchell/js-kata-jest).

Feel free to reach me on Twitter if you have any questions or comments [@nclsmitchell](https://twitter.com/nclsmitchell) or through Medium :)
