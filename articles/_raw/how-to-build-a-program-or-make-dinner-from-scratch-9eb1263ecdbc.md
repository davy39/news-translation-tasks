...
_True fact: people are far more likely to accept complexity if it comes with the promise of food._

**And** you’ll learn how to write a function that does the stuff I mentioned above, just like I did for this [freeCodeCamp challenge](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/map-the-debris).
...
_Unless you’re reading this on a Samsung phone, in which case you’re looking at a Korean hotpot._
...
> _Types of paella include Valencian paella, vegetarian/vegan paella (Spanish: paella de verduras), seafood paella (Spanish: paella de marisco), and mixed paella (Spanish: paella mixta), among many others.” — [Wikipedia](https://en.wikipedia.org/wiki/Paella)_
...
_The answer to that last one is “Nashville”._
...
**_T_, the orbital period, equals 2 multiplied by Pi, in turn multiplied by the square root of the radius, _r_ cubed, divided by the gravitational mass, _GM_.**
...
If you need a refresher on iterating through arrays, have a look at my [article on iterating, featuring breakfast arrays](https://victoria.dev/verbose/iterating-over-objects-and-arrays-frequent-errors/)! (5 minutes read)
...
If you liked this article, I’d love to know! You can find this and other articles explaining coding concepts with food [on my blog.](https://victoria.dev/verbose/)
