...
![GIF showing Slider in action](https://discourse-user-assets.s3.amazonaws.com/original/2X/0/08d83a22c28da836a06853b1f1ea669b398326b9.gif)
...
* [References](https://guide.freecodecamp.org/miscellaneous/guide-to-build-a-sliding-image-gallery/#references)
...
We are using [Sass](http://sass-lang.com/) and the SCSS syntax so we can nest and use variables
...
#### **Play and Pause _This feature is optional, but quite easy to implement._ We will hide the play button, so we don’t see both the play and pause buttons:**
