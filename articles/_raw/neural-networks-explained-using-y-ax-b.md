---
title: How Neural Networks Work – Explained Using the Straight Line Equation y = ax
  + b
subtitle: ''
...
- name: Data Science
  slug: data-science
seo_title: Importance of straight lines in deep neural networks
...
* [Linear Classification](#heading-linear-classification)
    
* [Comparison](#heading-comparison)
    
* [Key Additions to Help Build Deep Neural Networks](#heading-key-additions-to-help-build-deep-neural-networks)
    
* [Modelling a Deep Neural Network](#heading-modelling-a-deep-neural-network)
...
![Plot of y=3x+30](https://cdn.hashnode.com/res/hashnode/image/upload/v1764650083131/997f2a53-78ac-4b6f-a0c1-b995fb515075.png align="center")
...
![Input Data](https://cdn.hashnode.com/res/hashnode/image/upload/v1764651274954/0aa2dfc2-d846-40e6-872d-e7d5abe598a8.png align="center")
...
![Linear Regression-Trial 1](https://cdn.hashnode.com/res/hashnode/image/upload/v1764651323645/a3e79765-99bc-42be-8836-82119d7fbf66.png align="center")
...
![Linear Regression-Trial 2](https://cdn.hashnode.com/res/hashnode/image/upload/v1764651379913/42a8fc61-7927-46de-aadf-b691544b9a1b.png align="center")
...
![Linear Regression-Trial 3](https://cdn.hashnode.com/res/hashnode/image/upload/v1764651454435/5fea2d39-8254-48e6-be14-69c803982ec7.png align="center")
...
![Linear Classification](https://cdn.hashnode.com/res/hashnode/image/upload/v1764651531018/e669ed7b-1c86-4093-b7e5-feb06464ebfe.png align="center")
...
1. **Pre-Activation Part:** This portion of the neuron computes an intermediate value which is helpful in further processing. She’s figured out the parameters `a` (weight) and `b` (bias) to arrive at the following formula: `z = x-3`
...
2. **Activation Part:** This portion triggers the neuron to make decisions based on a threshold value. The following equation segregates the points into two classes.
...
![Comparison between Linear Regression and Classification](https://cdn.hashnode.com/res/hashnode/image/upload/v1764652317811/f4411011-fcd3-4a53-b116-a3c8a27c81d8.png align="center")
