...
For reference, you can find the source code of this project on [Git](https://github.com/eh3rrera/ARKitAnimation)Hub.
...
This method sets the text of the text view to the measure status of READY or NOT READY_._ It shows a description of the tracking status of the AR camera with the help of the method `getTrackingDescription()`. And the (last) calculated distance in centimeters. Notice we have to multiply the value by `100.0`.
