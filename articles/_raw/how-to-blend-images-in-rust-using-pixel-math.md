...
![mathematical graph with x and y axis](https://cdn.hashnode.com/res/hashnode/image/upload/v1724421916445/8d27ec1d-43f5-4cc3-b706-b9bd2efb05a4.png align="center")
...
If you're not familiar with Rust, I highly encourage you to learn the basics. [Here's an interactive Rust course that can get you started.](https://www.freecodecamp.org/news/rust-in-replit/)

## Table Of Contents

1. [Introduction](#heading-introduction)
    
2. [How Image Blending Works](#heading-how-image-blending-works)
    
3. [Project Setup](#heading-project-setup)
    
4. [How to Read Pixel Values](#heading-how-to-read-pixel-values)
    
5. [How to Blend Functions](#heading-how-to-blend-functions)
    
    1. [Average Blend](#heading-average-blend)
        
    2. [Multiply Blend](#heading-multiply-blend)
        
    3. [Lighten Blend](#heading-lighten-blend)
        
    4. [Darken Blend](#heading-darken-blend)
        
    5. [Screen Blend](#heading-screen-blend)
        
    6. [Addition Blend](#heading-addition-blend)
        
    7. [Subtraction Blend](#heading-subtraction-blend)
        
6. [How to Apply Blend Functions To Images](#heading-how-to-apply-blend-functions-to-images)
    
7. [Putting It All Together](#heading-putting-it-all-together)
    
8. [Glossary](#heading-glossary)
...
For more information on the `image` crate, you can refer to the [official documentation](https://docs.rs/image/).

To follow along, you can use any two images, the only requirement being that they should be of the same size and in the same format. You can also find the images used in this tutorial, along with complete code, [in the GitHub repository here](https://github.com/anshulsanghi-blog/blend-images).
...
![Source image 1: Fireflies in a dark forest area](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236939605/77d32c76-abf6-4d24-bba7-df40729863b8.jpeg align="center")

![Source image 2: Fireflies in a bright forest area](https://cdn.hashnode.com/res/hashnode/image/upload/v1724428339241/3cc70fd2-f6da-4704-8606-97c094a2ff35.jpeg align="center")
...
![Result of average blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236691772/291f14f4-2019-4771-8cd2-b9f9b3cf3f86.jpeg align="center")

### Multiply Blend

A multiply blend involves channel-wise multiplication of input pixel values after they've been normalized[\[¹\]](#heading-glossary) to get the output pixel. The output pixel is then rescaled back to the original range by multiplying with 255.
...
![Result of multiply blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236703622/9aff3ffd-9a63-4b76-9675-d7db4ccee89b.jpeg align="center")
...
![Result of lighten blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236726111/5d1607fb-2740-46b8-906d-1ffb482a0561.jpeg align="center")
...
![Result of darken blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236746972/18307fa1-1a77-4d39-b233-a7a6d87233d0.jpeg align="center")

### Screen Blend

Screen blend refers to multiplying the inverse of two images, and then inverting the result. In our implementation, the pixels first need to be normalized[\[¹\]](#heading-glossary). The normalized[\[¹\]](#heading-glossary) values are then inverted by subtracting them from 1, then they're multiplied and inverted again.
...
![Result of screen blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236758380/fd531b6e-729c-4db4-987e-f503478ff950.jpeg align="center")
...
We also have to convert the values to u16 in order to avoid loss of value due to overflow. We can also use normalized[\[¹\]](#heading-glossary) values here to achieve the same result.
...
![Result of addition blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236766684/05f01177-024d-4196-a9fa-5274bb56a0f4.jpeg align="center")
...
We also convert the values to i16 in order to avoid loss of value due to overflow and lack of sign. We can also use normalized[\[¹\]](#heading-glossary) values here to achieve the same result.
...
![Result of subtraction blending source images](https://cdn.hashnode.com/res/hashnode/image/upload/v1724236775603/507ba176-579d-494f-bb56-25a27ed2317f.jpeg align="center")
...
I highly encourage you to try that out. You can also reach out to me for help with anything in this tutorial or with extending the code in this tutorial. I'd be happy to answer all your queries. Email is the best way to reach me, you can email me at [anshul@anshulsanghi.tech](mailto:anshul@anshulsanghi.tech).
