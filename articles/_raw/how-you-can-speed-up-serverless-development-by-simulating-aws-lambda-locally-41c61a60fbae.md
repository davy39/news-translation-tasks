...
_Running the simulator on our example project_
...
We use a [Docker image](https://hub.docker.com/r/lambci/lambda/~/dockerfile/) created by [Michael Hart](https://www.freecodecamp.org/news/how-you-can-speed-up-serverless-development-by-simulating-aws-lambda-locally-41c61a60fbae/undefined) to create the function runtime. Using Docker allows us to control the environment and enforce memory limits and timeouts.
...
_Registered 10 functions with the Lambda Simulator_
...
This plugin will help solve a big problem for myself and the team at [A Cloud Guru](https://www.freecodecamp.org/news/how-you-can-speed-up-serverless-development-by-simulating-aws-lambda-locally-41c61a60fbae/undefined). Unit tests and local executions reduce the time we spend waiting for deployments to the cloud.
