...
* [Understanding the Two Approaches (CSS Animations and Worklets)](#heading-understanding-the-two-approaches)
    
* [How to Migrate from Reanimated Version 3 to Version 4](#heading-how-to-migrate-from-reanimated-version-3-to-version-4)
    
* [CSS Animations Tutorial](#heading-css-animations-tutorial)
    
* [Worklets Tutorial](#heading-worklets-tutorial)
    
* [Real-World Patterns](#heading-real-world-patterns)
    
* [Performance Optimizations](#heading-performance-optimizations)
    
* [Debugging Tips](#heading-debugging-tips)
...
Update `babel.config.js` (the plugin must be last):
...
If you need to maintain the exact timing from version 3, divide your duration values by 1.5.

### Step-by-Step Migration Process

Here's how to migrate your project from Reanimated 3 to version 4:

**Step 1:** Verify your project is using React Native 0.76 or newer with New Architecture enabled. Check your iOS Podfile for `ENV['RCT_NEW_ARCH_ENABLED'] = '1'` and your Android gradle.properties for `newArchEnabled=true`.

**Step 2:** Install the new versions of Reanimated and the worklets package:

```bash
npm install react-native-reanimated@^4.1.0 react-native-worklets@^0.5.0
```

**Step 3:** Update your `babel.config.js` to use the new worklets plugin:
...
**Step 4:** Search your codebase for the removed APIs and replace them:
...
**Step 5:** Rebuild your native apps:
...
For more detailed debugging information and advanced troubleshooting, check the [official debugging guide here](https://docs.swmansion.com/react-native-reanimated/docs/guides/debugging/).
...
The [official documentation](https://docs.swmansion.com/react-native-reanimated) provides complete API references, detailed guides, and interactive examples. The [GitHub repository](https://github.com/software-mansion/react-native-reanimated) includes production-ready sample code you can study and adapt.
