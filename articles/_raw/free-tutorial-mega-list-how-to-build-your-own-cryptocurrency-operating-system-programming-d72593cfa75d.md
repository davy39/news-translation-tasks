---
title: 'Free Tutorial Mega-List: How to Build Your Own Cryptocurrency, Operating System,
  Programming Language, and More'
subtitle: ''
author: Fatos Morina
co_authors: []
series: null
date: '2018-05-13T18:34:46.000Z'
originalURL: https://freecodecamp.org/news/free-tutorial-mega-list-how-to-build-your-own-cryptocurrency-operating-system-programming-d72593cfa75d
coverImage: https://cdn-media-1.freecodecamp.org/images/0*gQTr9gKaNodOaDgi.png
tags:
- name: Blockchain
  slug: blockchain
- name: GitHub
...
- name: 'tech '
  slug: tech
seo_title: null
seo_desc: 'I recently stumbled upon a new GitHub repository that had a long list of
  tutorials about how to build many technologies. The list includes tutorials on how
  to Build your own Blockchain / Cryptocurrency, Web Server, Template Engine,_ and
  many more.

  I ...'
---

I recently stumbled upon a new GitHub [repository](https://github.com/danistefanovic/build-your-own-x) that had a long list of tutorials about how to build many technologies. The list includes tutorials on how to **Build your own Blockchain / Cryptocurrency, Web Server, Template Engine,**\_ and many more.

I stumbled upon this repository while browsing through the most popular GitHub repositories in a new Chrome tab using [GitHunt](http://www.fatosmorina.com/get-trending-github-projects-chrome-tab-githunt/). It is a really long list, and may overwhelm you a bit, but this repository is worth checking out. You can always watch it and come back to it. Maybe you need to learn something better by building it, or perhaps you’ll find some tutorial you need.

Here is the [complete list](https://github.com/danistefanovic/build-your-own-x) that has been added to GitHub and made public by the author [Daniel Stefanovic](https://www.freecodecamp.org/news/free-tutorial-mega-list-how-to-build-your-own-cryptocurrency-operating-system-programming-d72593cfa75d/undefined) at the time of this writing.
...
* [Cryptocurrency for Dummies: Bitcoin and Beyond](https://www.toptal.com/bitcoin/cryptocurrency-for-dummies-bitcoin-and-beyond)
...
I hope you find this [repository](https://github.com/danistefanovic/build-your-own-x) helpful. I certainly did. You can contribute to the complete list on [GitHub](https://github.com/danistefanovic/build-your-own-x).

Happy learning!

*This post was originally published on* [*Medium*](https://medium.com/@FatosMorina/85-free-udacity-nanodegree-courses-16310e6cc29e)*.*
