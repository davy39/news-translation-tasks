---
title: Google Sheets Tutorial – How to Use Regex and VLOOKUP to Display Images from
  Google Drive
subtitle: ''
...
_Make a copy to edit yourself_

All cell and range references below will be from this sheet so you can easily look and see what I'm talking about.

I've also made a folder of images [here](https://drive.google.com/drive/folders/1na_BdarFXheF5t6YssKY2qPfTEDLYlSF?usp=sharing) that is publicly shared so all this works. You don't have to make a copy of this unless you just want to 😀.
...
You don't _have_ to use them, but it makes references in functions easier since you'll be writing the name of something instead of a sterile cell reference.

We'll use three of them:

1. `B4` = `itemSelect` This is the cell where our dropdown list will live.
2. `B8:G13` = `pictureMatch` This is the range for our VLOOKUP function. It contains the names of the pictures we'll display followed by their respective URLs.
3. `B8:B16` = `pictureName` This is the first column of the `pictureMatch` range for referencing just the names in our data validation cell.
...
_You might want to make your message more helpful than this one._
...
Here's an example of one of our image URLs: [`https://drive.google.com/file/d/1IaO08gj3GWIUQDAnzKEob62Gcl87ufuN/view?usp=sharing`](https://drive.google.com/file/d/1IaO08gj3GWIUQDAnzKEob62Gcl87ufuN/view?usp=sharing)
...
_This extracts everything between the /d/ and the /_
...
If you feel lost in a recursive nightmare, I encourage you to pull up the [**example spreadsheet**](https://docs.google.com/spreadsheets/d/1rFU2gPy6rU8IKFDmsxKHYCf0KGVHkcumQ5O5QCf156M/edit?usp=sharing) and examine the parts of the function in `F4` piece by piece. 👍
...
_This is likely the only place you'll find a NIN gif in an article about spreadsheets today._
...
Follow me on Twitter to see more content like this: [https://twitter.com/EamonnCottrell](https://twitter.com/EamonnCottrell)
