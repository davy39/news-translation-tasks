...
* [How to Set Up the Azure Virtual Machine](#heading-how-to-set-up-the-azure-virtual-machine)
    
    * [Create a Resource Group](#heading-create-a-resource-group)
        
    * [Create the Virtual Machine](#heading-create-the-virtual-machine)
        
    * [Get the Virtual Machine Public IP](#heading-get-the-virtual-machine-public-ip)
        
    * [Configure the VM Network to Allow Access Only from the User's IP](#heading-configure-the-vm-network-to-allow-access-only-from-the-users-ip)
        
* [How to Set Up the VM for Running AI Models](#heading-how-to-set-up-the-vm-for-running-ai-models)
    
    * [Set Up the Virtual Machine](#heading-set-up-the-virtual-machine)
        
    * [Set Up Docker Compose](#heading-set-up-docker-compose)
        
    * [Deploy the Containers](#heading-deploy-the-containers)
        
    * [Run the LLMs Locally Inside the Docker Container](#heading-run-the-llms-locally-inside-the-docker-container)
...
And finally, you need to have Azure CLI installed. Follow the installation instructions shown [here](https://learn.microsoft.com/en-us/cli/azure) to install it locally on your machine.
...
![Newly creted resource group on Azure.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742103607596/a4545962-a77f-466f-9866-83345359dfa2.png align="center")
...
![List of Virtual Machines on Azure.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742106067836/092e5fe1-505a-4d5d-bd6f-59aa707afe55.png align="center")
...
![Azure VM default network settings for SSH](https://cdn.hashnode.com/res/hashnode/image/upload/v1742110598028/2789344f-ec3f-4fb4-99c5-a25452dd7154.png align="center")
...
Don't be scared by this script. It might seem complex, but it's actually pretty straightforward. The first thing it does is try to get the user's IP address. It first attempts to fetch the user's IP from a service called [api.ipify.org](https://api.ipify.org) (because public IPs can change frequently), which returns your current public IP. If there's an error, it falls back to using the IP address stored in the `.env` file.
...
![Azure VM configured network settings.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742113381994/24653c49-0476-4822-b646-ff7ee9fd2be6.png align="center")
...
![List of running Docker Containers.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742638797106/fcce6983-6adb-4e62-93af-99dd59887f72.png align="center")
...
![A browser window showing the Ollama Web UI.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742639360587/3980f847-b76b-474f-9973-d0d5bbe2d36e.png align="center")
...
![Response from an AI Model.](https://cdn.hashnode.com/res/hashnode/image/upload/v1742650146763/0d2e43b8-5653-4390-8f88-07a55d4966bc.png align="center")

---

## Wrapping Up

That is it for this one. I hope you enjoyed it and, better yet, understood everything we did together. I build such stuff every other week and document them with blogs. Feel free to check out some of my previous tutorials on [DEV](https://dev.to/shricodev) and [freeCodeCamp](https://www.freecodecamp.org/news/author/shricodev).

You can find the complete source code [here](https://github.com/shricodev/local-ai-models-docker-azure).
