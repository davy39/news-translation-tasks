...
![unDraw's Homepage](https://i.imgur.com/ncSY7Rn.png align="left")
...
![Download the SVG file](https://i.imgur.com/qGrT73n.png align="left")
...
Using `<iframe>` also defeats the purpose of the *Scalable* in the name *Scalable Vector Graphics* because SVG images added with this format are not scalable.
