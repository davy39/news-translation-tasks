---
title: 'Change the signs: how to use dynamic programming to solve a competitive programming
  question'
subtitle: ''
author: freeCodeCamp
co_authors: []
...
So this Greedy approach would not work here. We have to **“try out a specific choice of whether to negate or not for a number and see what choice gives us the optimal solution”_._**
...
2. Figuring out what to [**memoize**](https://www.interviewcake.com/concept/java/memoization)**. (not memoRize :P)**
...
However, there is a slightly better approach as well to solving this problem as suggested by [Divya Godayal](https://www.freecodecamp.org/news/just-change-the-signs-how-to-solve-a-competitive-programming-question-f9730e8f04a9/undefined). This problem can even be solved by 1 dimensional dynamic programming based solution.
