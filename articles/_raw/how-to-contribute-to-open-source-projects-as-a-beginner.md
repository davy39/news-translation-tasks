...
* [Inspired by a Room Full of Potential](#heading-inspired-by-a-room-full-of-potential)
    
* [Introduction](#heading-introduction)
    
* [What is Open Source?](#heading-what-is-open-source)
    
* [Benefits of Contributing to Open Source](#heading-benefits-of-contributing-to-open-source)
    
* [How to Get Started with Open-Source Contributions](#heading-how-to-get-started-with-open-source-contributions)
    
* [Non-Tech Open Source Contributions](#heading-non-tech-open-source-contributions)
...
1. **Git**: Git is a version control system that allows you to track changes in your code and collaborate with others. You can install Git from [git-scm.com](https://git-scm.com/).
...
2. **GitHub Account**: Most open-source projects are hosted on GitHub, so create an account at [github.com](https://github.com/).
    
    ![GitHub homepage](https://cdn.hashnode.com/res/hashnode/image/upload/v1733214199999/142c4c47-8ed8-4fb8-a4ee-e57105ff35d4.png align="center")
    
3. **Text Editor**: Choose a text editor or IDE (Integrated Development Environment) where you will write your code. Popular choices include [Visual Studio Code](https://code.visualstudio.com/), [Sublime Text](https://www.sublimetext.com/), and [JetBrains IDEs](https://www.jetbrains.com/).
...
1. **GitHub Explore**: GitHub has an [Explore](https://github.com/explore) page where you can find trending repositories or search for projects by language or interest.
...
2. **Good First Issues**: Many open-source projects label beginner-friendly issues with the tag "good first issue." You can find these by searching for "good first issue" on GitHub or other platforms.
    ...
    ![finding good first issues](https://cdn.hashnode.com/res/hashnode/image/upload/v1733214567620/eee17260-2f94-455b-a925-60a8bec0cbc5.png align="center")
    
3. **Open Source Communities**: Websites like [First Timers Only](https://www.firsttimersonly.com/) and [Up For Grabs](http://up-for-grabs.net/) list open-source projects that are actively looking for beginner contributors.
...
1. **Read the README**: The README file of a project is the first place you should look. It provides an overview of the project, how to set it up, and often outlines the contribution guidelines.
    ...
    ![an example of README](https://cdn.hashnode.com/res/hashnode/image/upload/v1733214859166/b762f2c2-ffde-43e8-8d6f-50697a2b6078.png align="center")
...
2. **Check the Issues**: Look at the issues in the project’s GitHub repository. Issues are often where bugs, feature requests, or tasks are tracked. Look for labels like `good first issue` or `beginner-friendly`.
    ...
    ![The issues tab on GitHub](https://cdn.hashnode.com/res/hashnode/image/upload/v1733214763497/28f9dda5-8abb-45ef-aff9-dd3f2ab1f22d.png align="center")
...
4. **Read the Contribution Guidelines**: Many projects have contribution guidelines. These guidelines might cover things like coding style, testing requirements, and how to format commit messages. Make sure you read and understand these guidelines.
    ...
    ![contribution guidelines](https://cdn.hashnode.com/res/hashnode/image/upload/v1733214985183/cb9921b7-c3eb-4ec4-bf6d-93083cdb416a.png align="center")
...
1. **Fork the Repository**: On GitHub, click the "Fork" button to create your own copy of the project.
    ...
    ![fork a repo](https://cdn.hashnode.com/res/hashnode/image/upload/v1733215091342/648dd025-f162-45dd-9edb-8d6fa8e7bff4.png align="center")
...
1. **Go to the Original Repository**: Navigate to the original repository (not your fork).
    
    ![create a new pull request](https://cdn.hashnode.com/res/hashnode/image/upload/v1733215228523/f76e02bc-fd29-4416-a56e-c5c9232efe71.png align="center")
