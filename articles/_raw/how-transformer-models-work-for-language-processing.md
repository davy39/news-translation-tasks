...
* [Understanding Attention from the Ground Up](#heading-understanding-attention-from-the-ground-up)
    
* [Peeking Inside the Transformer](#heading-peeking-inside-the-transformer)
    
* [How to Build a Mini Transformer Step by Step](#heading-how-to-build-a-mini-transformer-step-by-step)
    
* [From Scratch to Pre-trained: How to Use Hugging Face](#heading-from-scratch-to-pre-trained-how-to-use-hugging-face)
    
* [What's Next for Transformers?](#heading-whats-next-for-transformers)
