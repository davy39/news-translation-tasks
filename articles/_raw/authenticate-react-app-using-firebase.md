...
- name: Firebase
  slug: firebase
seo_title: A Step-by-Step Guide to Authenticating Your React App with Firebase
...
* [Why Use Firebase for Authentication?](#heading-why-use-firebase-for-authentication)
    
* [Step 1: How to Set Up a Firebase Project](#heading-step-1-how-to-set-up-a-firebase-project)
    
* [Step 2: How to Install Firebase in Your Project](#heading-step-2-how-to-install-firebase-in-your-project)
    
* [Step 3: How to Initialize Firebase in Your App](#heading-step-3-how-to-initialize-firebase-in-your-app)
    
* [Step 4: How to Set Up Authentication Methods](#heading-step-4-how-to-set-up-authentication-methods)
    
* [Authentication Method Using Google](#heading-authentication-method-using-google)
    
* [Step 5: How to Upload to GitHub](#heading-step-5-how-to-upload-to-github)
...
* **A Google Account**: Firebase is a Google product, and you need a Google account to access the Firebase Console and use Firebase services. If you don’t have a Google account, [you can create one here](https://support.google.com/mail/answer/56256?hl=en).
...
![Firebase website](https://cdn.hashnode.com/res/hashnode/image/upload/v1723410569746/560dfa39-e8d5-4b22-bb84-94946daeac08.png align="center")

* Click "Add Project" and follow the on-screen instructions to create a new project.
    

![Creating a project base](https://cdn.hashnode.com/res/hashnode/image/upload/v1727812540013/eceb505e-ea69-43f0-a845-ad26d86d5c26.gif align="center")
...
* ![Registering your project to firebase](https://cdn.hashnode.com/res/hashnode/image/upload/v1723412408046/4bf3956f-1d7d-4dff-8a70-72a757c01d2b.gif align="center")
...
![Pasting the SDK in your project](https://cdn.hashnode.com/res/hashnode/image/upload/v1723459271302/4773d484-b5a2-4cbe-9626-76765cafd9b8.png align="center")
...
* Enable "Email/Password" under the "Sign-in providers" section.
    ...
    ![Authentication using email and password](https://cdn.hashnode.com/res/hashnode/image/upload/v1723457322104/6914efdc-87cf-4fce-b84f-bd407b6b4918.gif align="center")
...
![Visual Result of signup and signin put together](https://cdn.hashnode.com/res/hashnode/image/upload/v1727813072045/5a91493d-69a0-4a90-98b2-61905b23e460.gif align="center")
...
![Enabling Google Auth](https://cdn.hashnode.com/res/hashnode/image/upload/v1727813344687/f1838b83-9af9-42a7-bf98-6a7d617cedc3.gif align="center")
...
![Using signInWithPop()](https://cdn.hashnode.com/res/hashnode/image/upload/v1727813634035/14c00c73-f289-480a-a396-3abd839b3a75.gif align="center")
...
![signOut() visual display](https://cdn.hashnode.com/res/hashnode/image/upload/v1727813736679/21c2162b-b376-43b7-87cb-242d78acef38.gif align="center")
...
![Storing the API keys in .env file](https://cdn.hashnode.com/res/hashnode/image/upload/v1727813941388/5e647b8c-c76b-4671-b44b-21ac4dcddc89.png align="center")
...
![Firebase file](https://cdn.hashnode.com/res/hashnode/image/upload/v1727814253953/514db02f-44f8-44fc-b03c-4cf77cb5c4ba.png align="center")

* Finally, update your **.gitignore** file to include the **.env** file. This step also protects other sensitive files and directories, like **node\_modules**.
...
The code I used for this tutorial article can be found on my [GitHub](https://github.com/ijayhub/authentication-example-tutorial).
