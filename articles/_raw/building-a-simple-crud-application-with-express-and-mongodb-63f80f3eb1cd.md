...
Turns out, Express doesn’t handle reading data from the <form> element on it’s own. We have to add another package c[alled body-](https://www.npmjs.com/package/body-parser)parser to gain this functionality.
