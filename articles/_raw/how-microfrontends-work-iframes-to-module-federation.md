...
* [What are Microfrontends?](#heading-what-are-microfrontends)
    
* [Traditional Microfrontend Patterns](#heading-traditional-microfrontend-patterns)
    
    * [Server-Side Composition](#heading-server-side-composition)
        
    * [iframes](#heading-iframes)
        
    * [Build Time Integration – Packages](#heading-build-time-integration-packages)
        
* [Modern Microfrontend Patterns](#heading-modern-microfrontend-patterns)
    
    * [Module Federation](#heading-module-federation)
        
    * [Single SPA](#heading-single-spa)
        
* [Detailed Comparison](#heading-detailed-comparison)
    
* [Tradeoffs and Challenges with Module Federation](#heading-tradeoffs-and-challenges-with-module-federation)
    
    * [Setup Complexity](#heading-setup-complexity)
        
    * [Runtime Challenges](#heading-runtime-challenges)
        
    * [Operational Concerns](#heading-operational-concerns)
...
![Diagram showing a reverse proxy setup with nginx. The proxy routes `/blog/*` requests to the Marketing UI and `/account/*` requests to the Accounts UI.](https://cdn.hashnode.com/res/hashnode/image/upload/v1747496226912/fda979cd-c95c-4d48-a7dc-87956672b24d.png align="center")

### **iframes**

Another common approach is using iframes, though this method has significant limitations.

Unlike server-side composition, which operates at the page level, iframes can integrate as widgets within pages. Using iframes, you can load another website as a part of the website you want to integrate it within using the [&lt;iframe&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/iframe) tag.

![Diagram illustrating iframe integration, showing website.com/blog embedding a 'Widget' using an iframe with source 'website.com/widget'.](https://cdn.hashnode.com/res/hashnode/image/upload/v1747496936962/7c24a43a-80d4-45f4-a2df-3de0e0e0bc1c.png align="center")
...
![Diagram illustrating build-time integration via packages, showing website.com/blog integrating a 'Widget' component, version 1.0.0, fetched from a company's NPM registry.](https://cdn.hashnode.com/res/hashnode/image/upload/v1747497485861/70385841-28c6-441e-ae4d-c977b3563ecf.png align="center")
...
Module Federation originated as a [Webpack 5 feature](https://webpack.js.org/concepts/module-federation/), extending the bundler's capabilities to load JavaScript code from remote sources at runtime.

[Module Federation 2.0](https://module-federation.io/) is the evolution/improvement of the original Webpack 5 feature, with implementations available for other popular bundlers like RSPack and Vite as well.
...
When you look up microfrontends, [Single SPA](https://single-spa.js.org) often appears as a popular solution. But its primary use case is quite specific: integrating components across multiple frameworks (for example, React + Angular + Vue in the same application). Here's how it works in practice:
