---
title: How to Build a To-Do List MCP Server Using TypeScript – with Auth, Database,
  and Billing
subtitle: ''
author: Shola Jegede
co_authors: []
...
* [Why Go Beyond Basic MCP Servers](#heading-why-go-beyond-basic-mcp-servers)
...
* [Database Setup with Neon PostgreSQL](#heading-database-setup-with-neon-postgresql)
    ...
    * [1\. Connect your Neon Database](#heading-1-connect-your-neon-database)
        
    * [2\. Create your DB File](#heading-2-create-your-db-file)
        
    * [3\. Step-by-Step Breakdown of setup-db.ts](#heading-3-step-by-step-breakdown-of-setup-dbts)
        
    * [4\. Full setup-db.ts File](#heading-4-full-setup-dbts-file)
        
* [Authentication with Kinde](#heading-authentication-with-kinde)
    
    * [1\. Create a Kinde Application](#heading-1-create-a-kinde-application)
        
    * [2\. Configure Kinde Settings](#heading-2-configure-kinde-settings)
        
    * [3\. Environment Variables](#heading-3-environment-variables)
        
    * [4\. Create the Kinde Auth Server](#heading-4-create-the-kinde-auth-server)
        
    * [5\. Complete Authentication Flow](#heading-5-complete-authentication-flow)
        
    * [6\. Why This Matters](#heading-6-why-this-matters)
        
    * [7\. Key Connections](#heading-7-key-connections)
        
    * [8\. Full kinde-auth-server.ts File](#heading-8-full-kinde-auth-serverts-file)
...
* [MCP Server Implementation (with Billing System Integration)](#heading-mcp-server-implementation-with-billing-system-integration)
    ...
    * [1\. Create Your File](#heading-1-create-your-file)
        
    * [2\. Project Setup and Imports](#heading-2-project-setup-and-imports)
        
    * [3\. Database Connection and Configuration](#heading-3-database-connection-and-configuration)
        
    * [4\. Authentication System](#heading-4-authentication-system)
        
    * [5\. Core Helper Functions](#heading-5-core-helper-functions)
        
    * [6\. Core Server Implementation](#heading-6-core-server-implementation)
        
    * [7\. Register Tools](#heading-7-register-tools)
        
    * [8\. Tool Handlers](#heading-8-tool-handlers)
        
    * [9\. Full server.ts File](#heading-9-full-serverts-file)
        
    * [10\. Data Flow & Integration](#heading-10-data-flow-amp-integration)
        
    * [11\. Error Handling & Security](#heading-11-error-handling-amp-security)
        
    * [12\. Testing & Deployment](#heading-12-testing-amp-deployment)
        
* [Testing the Complete System](#heading-testing-the-complete-system)
    
    * [1\. Start the Services](#heading-1-start-the-services)
        
    * [2\. Configure Cursor MCP](#heading-2-configure-cursor-mcp)
        
    * [3\. Test the Complete Flow](#heading-3-test-the-complete-flow)
        
* [Troubleshooting](#heading-troubleshooting)
    
    * [1\. MCP Server Not Detected](#heading-1-mcp-server-not-detected)
        
    * [2\. Database Connection Issues](#heading-2-database-connection-issues)
        
    * [3\. Kinde Authentication Problems](#heading-3-kinde-authentication-problems)
        
    * [4\. Token Errors](#heading-4-token-errors)
...
If you read this [freeCodeCamp MCP handbook](https://www.freecodecamp.org/news/how-to-build-a-custom-mcp-server-with-typescript-a-handbook-for-developers), you learned how to set up a simple MCP server in TypeScript. That’s useful for learning the protocol, but it doesn’t reflect what you need in production.
...
* [Kinde Account](https://kinde.com) **→** for authentication and billing
    
* [Neon Account](https://neon.com) **→** for PostgreSQL database
    
* Node.js (v18+) ([download](https://nodejs.org/en/download))
    
* Cursor IDE **→** for MCP integration and tool testing ([download](https://cursor.com/download))
...
To secure your MCP server, you’ll use [Kinde](https://kinde.com), an authentication provider that makes it easy to handle logins, user sessions, and tokens.
...
* Note down these values (you’ll use them shortly):
    ...
    * **Domain**: [`https://your-domain.kinde.com`](https://your-domain.kinde.com)
...
* Redirect URL → [`http://localhost:3000/callback`](http://localhost:3000/callback)
...
* The user copies this token and runs *“save\_token: &lt;your-jwt-token&gt;”* in the Cursor Chat to store it.
...
* *save\_token* → Save your token gotten from Kinde
...
You can find the complete source code for this tutorial in [this GitHub repository](https://github.com/sholajegede/todo_mcp_server). If it helped you in any way, consider giving it a star (⭐) to show your support!

Also, if you found this tutorial valuable, feel free to share it with others who might benefit from it. I’d really appreciate your thoughts, you can mention me on X [@wani\_shola](https://x.com/wani_shola) or [connect with me on LinkedIn](https://www.linkedin.com/in/sholajegede).
