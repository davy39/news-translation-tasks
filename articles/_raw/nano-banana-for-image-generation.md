...
* [What is "Nano Banana"?](#heading-what-is-nano-banana)
    
    * [Why "Nano Banana"?](#heading-why-nano-banana)
        
* [Setting Up Your Project](#heading-setting-up-your-project)
    
    * [Step 1: Get an API key from Google Gemini](#heading-step-1-get-an-api-key-from-google-gemini)
        
    * [Step 2: Install the SDK and Other Dependencies](#heading-step-2-install-the-sdk-and-other-dependencies)
        
    * [Step 3: Set Up Your Environment](#heading-step-3-set-up-your-environment)
        
    * [Step 4: Image Generation & Editing](#heading-step-4-image-generation-amp-editing)
        
* [Beyond the Basics: What Else Can You Do?](#heading-beyond-the-basics-what-else-can-you-do)
...
1. [Using Google AI Studio](https://aistudio.google.com/prompts/new_chat?model=gemini-2.5-flash-image-preview): The simplest and easiest way to generate or edit images in Google Studio. This is a web-based tool that gives you direct access to the Gemini models without writing a single line of code. It's the absolute best place to test and start, and is useful for developers and non-developers, also. Also, there's no need to install libraries, manage API keys, or write any code
...
The very first step for using “Nano Banana” is to get an API key. Head over to [Google AI Studio](https://aistudio.google.com/apikey), click on “Create API key“, and generate a new one by specifying a project from your existing Google Cloud projects.

![API key generated from Google Gemini ](https://cdn.hashnode.com/res/hashnode/image/upload/v1757429573699/1c5d1a52-2e63-476b-a957-604542044fc7.png align="center")
...
![A golden retriever puppy sitting happily in a sunny meadow filled with white daisies, surrounded by bright green grass and a cheerful, vibrant atmosphere.](https://cdn.hashnode.com/res/hashnode/image/upload/v1757485705896/50484418-c53c-4d61-8846-2c8875dc2cbd.png align="center")
...
![A before and after image of a playful dog wearing a small pointed wizard hat and round spectacles, sitting upright with a charming and magical look, giving a whimsical, storybook-like feel.](https://cdn.hashnode.com/res/hashnode/image/upload/v1757486336530/84cba4bf-91bd-49b7-8fd3-e94b20eabbfb.png align="center")
...
* [`Image.open`](http://Image.open)`(input_image_path)`: This line uses the Pillow library to open your local image file to be used.
...
![Three-part image showing a golden retriever puppy in a daisy field, a red baseball cap with the letter “A,” and the final edited version where the puppy is wearing the red cap while sitting happily among the daisies](https://cdn.hashnode.com/res/hashnode/image/upload/v1757486318798/2fe3ca32-3053-44cc-9350-b1c47abacdd9.png align="center")
...
![Side-by-side comparison of an old photograph and a restored version. The left shows a scratched, sepia-toned photo of a vintage car on a rural road, while the right shows the same scene digitally restored in color, with a blue classic car under a bright sky in a golden countryside](https://cdn.hashnode.com/res/hashnode/image/upload/v1757486506412/201bf046-4c63-46eb-a026-f2a432ca8c3d.png align="center")
