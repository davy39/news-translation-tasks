...
_Illustration by [John Adesanya](https://www.facebook.com/adesanya.john.52" rel="noopener" target="_blank" title=")_
...
are used for comparing values. They include greater than, less than, equal-to, not-equal-to. Their representation varies as well depending on what programming language you are learning. `&l`t;> is not equal-to in some languages, while in others, `i`t’s `!= o`r !==.
* Logical Operators  
