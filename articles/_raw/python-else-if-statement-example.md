---
title: Python Else-If Statement Example
subtitle: ''
...
1. [What is an `if` statement?](#if)
    1. [Syntax of an `if` statement](#if-syntax)
    2. [Example of an `if` statement](#if-example)
2. [What is an `if else` statement?](#if-else)
    1. [Example of an `if else` statement](#if-else-example)
3. [What is an `elif` statement?](#elif)
    1. [Example of an `elif` statement](#elif-example)

## What Is An `if` Statement in Python? <a name="if"></a>
...
### How to Create an `if` Statement in Python - A Syntax Breakdown <a name="if-syntax"></a>
...
- On a new line, add one level of indentation. Many code editors will do this automatically for you. For example, when using the [Visual Studio Code editor](https://code.visualstudio.com/) with the [Python extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python), right after you write the colon from the previous step and hit `Enter`, it will automatically indent your code with the right level of indentation. This level of indentation is how Python knows that the code statements you will write are associated with the `if` statement.
...
### What Is An example Of An `if` Statement in Python? <a name="if-example"></a>
...
At this point, it is also worth mentioning that you should make sure to indent the code inside the`if` statement. If you forget to indent that print statement, you will end up getting the following indentation error:
...
## What Is An `if else` Statement in Python? <a name="if-else"></a>
...
### What Is An Example Of An `if else` Statement in Python? <a name="if-else-example"></a>
...
## What Is An `elif` Statement in Python? <a name="elif"></a>
...
### What Is An Example Of An `elif` Statement in Python? <a name="elif-example"></a>
