...
If you own a Windows computer, I recommend using [Visual Studio Community Edition](https://visualstudio.microsoft.com/vs/community). If you own a Mac, I recommend using [Xcode](https://developer.apple.com/xcode). These provide robust features and excellent support for C++ development. If you're looking for a lightweight install on any platform, [CLion](https://www.jetbrains.com/clion/download) is a fantastic choice.

For those who prefer not to install any software or are unable to, [replit](https://replit.com) is a convenient web-based IDE that allows you to start coding immediately.
...
![Screenshot showing what the playbacks look like](https://cdn.hashnode.com/res/hashnode/image/upload/v1742956414812/64ed10ba-5f80-442b-b469-9d6462521578.png align="center")

Watch this short [YouTube video](https://youtu.be/uYbHqCNjVDM) which explains how to view a code playback in more detail.

## **Playback Press**

[Playback Press](https://playbackpress.com/books) is a platform for sharing code playbacks. The site contains collections of code playbacks grouped together by language/technology into different ‘books’. If you want to see the full C++ book, you can go here: [An Animated Introduction to Programming in C++](https://playbackpress.com/books/cppbook).

Code playbacks on the platform include AI tutoring, mini-quizzes, and text-to-speech features.

[Storyteller](https://markm208.github.io/) is the free and open-source tool that powers code playbacks.
...
In order to access the AI tutor and to generate new multiple choice questions, simply create a free account on Playback Press and add the [book](https://playbackpress.com/books/cppbook) to your bookshelf. It is still free, but you do need to register in order to access the AI features.

## **Table of Contents**

* [Part 1: Variables](#heading-part-1-variables)
    
* [Part 2: Selection](#heading-part-2-selection)
    
* [Part 3: Looping](#heading-part-3-looping)
    
* [Part 4: Arrays](#heading-part-4-arrays)
    
* [Part 5: Functions](#heading-part-5-functions)
    
* [Part 6: Vectors](#heading-part-6-vectors)
    
* [Part 7: Structured Data](#heading-part-7-structured-data)
    
* [Part 8: Pointers](#heading-part-8-pointers)
    
* [Part 9: Object-Oriented Programming](#heading-part-9-object-oriented-programming)
    
* [Part 10: Data Structures](#heading-part-10-data-structures)
    
* [Part 11: SQLite Databases](#heading-part-11-sqlite-databases)
...
* [1.1 Name printer program](https://playbackpress.com/books/cppbook/chapter/1/1)
...
* [1.2 Distance formula](https://playbackpress.com/books/cppbook/chapter/1/2)
    
* [1.3 Basic types in C++](https://playbackpress.com/books/cppbook/chapter/1/3)
    
* [1.4 Number types](https://playbackpress.com/books/cppbook/chapter/1/4)
    
* [1.5 Characters and strings](https://playbackpress.com/books/cppbook/chapter/1/5)
...
* [1.6 Weekly pay calculator](https://playbackpress.com/books/cppbook/chapter/1/6)
    
* [1.7 Distance formula revisited](https://playbackpress.com/books/cppbook/chapter/1/7)
    
* [1.8 Gas Mileage](https://playbackpress.com/books/cppbook/chapter/1/8)
...
* [2.1 Booleans](https://playbackpress.com/books/cppbook/chapter/2/1)
    
* [2.2 Even/odd calculator](https://playbackpress.com/books/cppbook/chapter/2/2)
    
* [2.3 Overtime pay with an if/else](https://playbackpress.com/books/cppbook/chapter/2/3)
    
* [2.4 Water temperature](https://playbackpress.com/books/cppbook/chapter/2/4)
...
For example, if you had a float variable that held 1.29 to represent $1.29 and you subtracted the .05 from it (to represent giving back a nickel), you would think that you would be left with exactly 1.24. Unfortunately, the computer might store that value or it might store 1.2399999 or 1.2400001 instead of exactly 1.24.

These very small inconsistencies can cause a problem calculating the number of pennies to return. Consider converting the amounts into ints to solve this problem.
...
* [3.1 A simple loop](https://playbackpress.com/books/cppbook/chapter/3/1)
    
* [3.2 More loops](https://playbackpress.com/books/cppbook/chapter/3/2)
    
* [3.3 Summation](https://playbackpress.com/books/cppbook/chapter/3/3)
    
* [3.4 Nested loop](https://playbackpress.com/books/cppbook/chapter/3/4)
    
* [3.5 `for` loop](https://playbackpress.com/books/cppbook/chapter/3/5)
    
* [3.6 Capitalization](https://playbackpress.com/books/cppbook/chapter/3/6)
    
* [3.7 `break` and `continue`](https://playbackpress.com/books/cppbook/chapter/3/7)
...
* [4.1 Arrays](https://playbackpress.com/books/cppbook/chapter/4/1)
    
* [4.2 Average and standard deviation of an array of values](https://playbackpress.com/books/cppbook/chapter/4/2)
    
* [4.3 Problems with arrays](https://playbackpress.com/books/cppbook/chapter/4/3)
    
* [4.4 Flipping coins](https://playbackpress.com/books/cppbook/chapter/4/4)
    
* [4.5 Multi-dimensional arrays](https://playbackpress.com/books/cppbook/chapter/4/5)
...
* [5.1 Functions](https://playbackpress.com/books/cppbook/chapter/5/1)
    
* [5.2 Value returning functions](https://playbackpress.com/books/cppbook/chapter/5/2)
    
* [5.3 Functions with parameters](https://playbackpress.com/books/cppbook/chapter/5/3)
    
* [5.4 Passing parameters by reference](https://playbackpress.com/books/cppbook/chapter/5/4)
    
* [5.5 The scope of variables](https://playbackpress.com/books/cppbook/chapter/5/5)
    
* [5.6 Prime number function](https://playbackpress.com/books/cppbook/chapter/5/6)
    
* [5.7 Passing arrays to functions](https://playbackpress.com/books/cppbook/chapter/5/7)
...
* [6.2 Passing a `vector` to a function](https://playbackpress.com/books/cppbook/chapter/6/2)
    
* [6.3 Advanced features of `vector`s](https://playbackpress.com/books/cppbook/chapter/6/3)
    
* [6.4 Reading from a file and storing in a `vector`](https://playbackpress.com/books/cppbook/chapter/6/4)
    
* [6.5 Linear search and binary search](https://playbackpress.com/books/cppbook/chapter/6/5)
    
* [6.6 Bubble sort](https://playbackpress.com/books/cppbook/chapter/6/6)
    
* [6.7 Writing to a file](https://playbackpress.com/books/cppbook/chapter/6/7)
    
* [6.8 Two dimensional `vector`s](https://playbackpress.com/books/cppbook/chapter/6/8)
...
* [8.1 Simple pointers](https://playbackpress.com/books/cppbook/chapter/8/1)
    
* [8.2 Pointer to an object](https://playbackpress.com/books/cppbook/chapter/8/2)
    
* [8.3 Vectors of pointers](https://playbackpress.com/books/cppbook/chapter/8/3)
    
* [8.4 Arrays are pointers](https://playbackpress.com/books/cppbook/chapter/8/4)
    
* [8.5 Passing data to functions with pointers](https://playbackpress.com/books/cppbook/chapter/8/5)
    
* [8.6 Comparing pointers](https://playbackpress.com/books/cppbook/chapter/8/6)
    
* [8.7 Three types of variables- global, local, and dynamic](https://playbackpress.com/books/cppbook/chapter/8/7)
    
* [8.8 Dynamic variables example](https://playbackpress.com/books/cppbook/chapter/8/8)
    
* [8.9 Dangling pointers and null pointers](https://playbackpress.com/books/cppbook/chapter/8/9)
    
* [8.10 Dynamic array of students](https://playbackpress.com/books/cppbook/chapter/8/10)
...
* [9.1 Simple class](https://playbackpress.com/books/cppbook/chapter/9/1)
    
* [9.2 A class with data members](https://playbackpress.com/books/cppbook/chapter/9/2)
    
* [9.3 A class with objects for data members](https://playbackpress.com/books/cppbook/chapter/9/3)
    
* [9.4 Common word analysis](https://playbackpress.com/books/cppbook/chapter/9/4)
    
* [9.5 Student and course registration system](https://playbackpress.com/books/cppbook/chapter/9/5)
    
* [9.6 Inheritance and polymorphism](https://playbackpress.com/books/cppbook/chapter/9/6)
    
* [9.7 Shape inheritance hierarchy](https://playbackpress.com/books/cppbook/chapter/9/7)
    
* [9.8 Inheritance and polymorphism in C++](https://playbackpress.com/books/cppbook/chapter/9/8)
    
* [9.9 Copy Constructor Example](https://playbackpress.com/books/cppbook/chapter/9/9)
...
* [10.1 Simple linked list](https://playbackpress.com/books/cppbook/chapter/10/1)
    
* [10.2 Simple hash table](https://playbackpress.com/books/cppbook/chapter/10/2)
    
* [10.3 More complex hash table](https://playbackpress.com/books/cppbook/chapter/10/3)
    
* [10.4 STL `unordered_map`](https://playbackpress.com/books/cppbook/chapter/10/4)
    
* [10.5 Binary search tree](https://playbackpress.com/books/cppbook/chapter/10/5)
    
* [10.6 Graph adjacency matrix](https://playbackpress.com/books/cppbook/chapter/10/6)
...
* [11.1 The C++ SQLite API](https://playbackpress.com/books/cppbook/chapter/11/1)
    
* [11.2 An Object Oriented Auction Program](https://playbackpress.com/books/cppbook/chapter/11/2)
    
* [11.3 SQLite Transactions](https://playbackpress.com/books/cppbook/chapter/11/3)
...
You can find all of these code playbacks in my free book, [An Animated Introduction to Programming in C++](https://playbackpress.com/books/cppbook/). There are more free books here:
...
Comments and feedback are welcome via email: [mark@playbackpress.com](mailto:mark@playbackpress.com).
