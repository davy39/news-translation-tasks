...
- [Rust Overview](#heading-rust-overview)
- [How to Use Rust in Replit](#heading-how-to-use-rust-in-replit)
- [Basics of Rust](#heading-basics-of-rust)
  - [Variables in Rust](#heading-variables-in-rust)
  - [Functions in Rust](#heading-functions-in-rust)
  - [Strings and Slices in Rust](#heading-strings-and-slices-in-rust-1)
  - [The `char` Type in Rust](#heading-the-char-type-in-rust)
  - [Number Types in Rust](#heading-number-types-in-rust)
  - [Structs in Rust](#heading-structs-in-rust)
  - [Enums in Rust](#heading-enums-in-rust)
  - [Macros in Rust](#heading-macros-in-rust)
  - [Ownership in Rust](#heading-ownership-in-rust)
- [Project #1 - Build a CLI Calculator in Rust](#heading-project-1-build-a-cli-calculator-in-rust)
  - [Project Outcome](#heading-project-outcome)
  - [CLI Calculator Project Methodology](#heading-cli-calculator-project-methodology)
    - [Step 1 - Create a New Project](#heading-step-1-create-a-new-project)
    - [Step 2 - Understand the Syntax](#heading-step-2-understand-the-syntax)
    - [Step 3 - Run the Project](#heading-step-3-run-the-project)
    - [Step 4 - Command Line Arguments](#heading-step-4-command-line-arguments)
    - [Step 5 - Parse Strings into Numbers](#heading-step-5-parse-strings-into-numbers)
    - [Step 6 - Perform Basic Arithmetic Operations](#heading-step-6-perform-basic-arithmetic-operations)
    - [Step 7 - Format the Output](#heading-step-7-format-the-output)
    - [Step 8 - Bring It All Together](#heading-step-8-bring-it-all-together)
- [Project #2 - Build an Image Combiner in Rust](#heading-project-2-build-an-image-combiner-in-rust)
  - [Project Outcome](#heading-project-outcome-1)
  - [Image Combiner Project Methodology](#heading-image-combiner-project-methodology)
    - [Step 1 - Create a New Project](#heading-step-1-create-a-new-project-1)
    - [Step 2 - Add a New Module for Args](#heading-step-2-add-a-new-module-for-args)
    - [Step 3 - Import and Use the `args` Module](#heading-step-3-import-and-use-the-args-module)
    - [Step 4 - Add an External Crate](#heading-step-4-add-an-external-crate)
    - [Step 5 - Read an Image File](#heading-step-5-read-an-image-file)
    - [Step 6 - Handle Errors with `Result`](#heading-step-6-handle-errors-with-result)
    - [Step 7 - Resize the Images to Match](#heading-step-7-resize-the-images-to-match)
    - [Step 8 - Create a Floating Image](#heading-step-8-create-a-floating-image)
    - [Step 9 - Create the Combined Image Data](#heading-step-9-create-the-combined-image-data)
    - [Step 10 - Attach the Combined Data to the Floating Image](#heading-step-10-attach-the-combined-data-to-the-floating-image)
    - [Step 11 - Write the Image to a File](#heading-step-11-write-the-image-to-a-file)
    - [Step 12 - Bring It All Together](#heading-step-12-bring-it-all-together)
...
<a href="https://replit.com/github/freeCodeCamp/Rust-in-Replit">
  <img src="https://replit.com/badge/github/freeCodeCamp/Rust-in-Replit" alt="run on replit" width="200" height="60" style="display: block; margin: 0 auto" />
</a>
...
A _struct_ is a custom data type used to group related data. You have already come across a struct in the [Strings and Slices](#heading-strings-and-slices-in-rust-1) section:
