...
* [So… What Is Kanban?](#heading-so-what-is-kanban)
    
* [The Classic Kanban Board: Three Simple Columns](#heading-the-classic-kanban-board-three-simple-columns)
    
* [How Developers Use Kanban in Real Life](#heading-how-developers-use-kanban-in-real-life)
    
* [Kanban vs Scrum: What’s the Difference?](#heading-kanban-vs-scrum-whats-the-difference)
    
* [So which one should you use Scrum or Kanban?](#heading-so-which-one-should-you-use-scrum-or-kanban)
    
* [What Tools Do Teams Use for Kanban?](#heading-what-tools-do-teams-use-for-kanban)
    
* [How to Use Kanban to Manage Your Own Coding Projects](#heading-how-to-use-kanban-to-manage-your-own-coding-projects)
    
* [Final Thoughts: Why Kanban Isn’t Just a Board](#heading-final-thoughts-why-kanban-isnt-just-a-board)
...
<table><tbody><tr><td colspan="1" rowspan="1"><p><strong>&nbsp;To Do</strong></p></td><td colspan="1" rowspan="1"><p><strong>In Progress</strong></p></td><td colspan="1" rowspan="1"><p><strong>Done</strong></p></td></tr></tbody></table>
...
[Here’s a video](https://youtu.be/R8dYLbJiTUE?si=Hh00XXI4_1urv4Mp) recapping key concepts.
...
[Here’s a video](https://youtu.be/F5QIqFEDv2k?si=jvNoAiHmrv_iq-Lx) on the main differences between Scrum and Kanban you can watch if you want more detail.
...
[Here is a detailed video](https://youtu.be/kiI3IweyAeQ?si=M1mtS5HCCcGcT78J) that’'ll teach you more about how Scrumban works in practice.
