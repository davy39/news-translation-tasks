---
title: 'AWS Cheatsheet: The Top 5 Things to Learn First When Getting Started with
  Amazon Web Services'
subtitle: ''
author: Colby Fayock
co_authors: []
...
* [Object storage with AWS S3](#heading-object-storage-with-aws-s3)
* [Host and deploy a static website with AWS S3 and CloudFront](#heading-host-and-deploy-a-static-website-with-aws-s3-and-cloudfront)
* [Create a serverless function with AWS Lambda](#heading-create-a-serverless-function-with-aws-lambda)
* [Spin up a managed server with AWS EC2](#heading-spin-up-a-managed-server-with-aws-ec2)
* [Learn the AWS acronyms](#heading-learn-the-aws-acronyms) (seriously)
