...
4. [How to Define Routes](#heading-how-to-define-routes)
    
5. [How to Create the Router](#how-to-create-the-router)
    
6. [How to Navigate Between Screens](#heading-how-to-navigate-between-screens)
    
7. [How to Pass Parameters](#heading-how-to-pass-parameters)
    
8. [Sub-Routes and ShellRoute](#heading-sub-routes-and-shellroute)
    
9. [Redirection and Guards](#heading-redirection-and-guards)
    
10. [How to Set Up a Real Flutter Project using GoRouter](#heading-how-to-set-up-a-real-flutter-project-using-gorouter)
    
11. [Project Structure:](#heading-project-structure)
    
    * [1\. main.dart](#heading-1-maindart)
        
    * [2\. Model](#heading-2-model)
        
    * [3\. Controller](#heading-3-controller)
        
    * [4\. Config](#heading-4-config)
        
    * [5\. Screens](#heading-5-screens)
        
    * [6\. Widgets](#heading-6-widgets)
        
12. [A Few Screenshots:](#heading-a-few-screenshots)
    
13. [Conclusion](#heading-conclusion)
    
14. [References](#heading-references)
...
With go\_router, you can pass parameters in two main ways:
...
As your app grows, you’ll need to organize routes in a hierarchy or keep persistent UI elements like a bottom navigation bar. go\_router makes this possible with **Sub-routes** and **ShellRoute**.
...
go\_router provides two main tools here: **redirects** and **guards**.
...
The `config` folder stores all the configuration and setup files for your app. In this project, it’s where we keep `route_config.dart`, which contains all the go\_router setup and route definitions.
...
![Home page of the app](https://cdn.hashnode.com/res/hashnode/image/upload/v1703872135819/0470da63-f9e7-4358-a523-803222e8469e.png align="center")

![product detail page](https://cdn.hashnode.com/res/hashnode/image/upload/v1703872148850/fc84b934-844f-4dee-8b09-3c7fcf03ce78.png align="center")

![image previewer](https://cdn.hashnode.com/res/hashnode/image/upload/v1703872217140/610e283e-2588-446e-9a0f-300e3f1d961c.png align="center")

![down section of the detail page](https://cdn.hashnode.com/res/hashnode/image/upload/v1703872162253/6c7de9e7-b5f4-4773-91b8-df5e97a4d0cc.png align="center")

![dialog box display in the product detail page](https://cdn.hashnode.com/res/hashnode/image/upload/v1703872199030/bc0cd8d3-4028-4bff-bf5a-620e32fcdd45.png align="center")
...
1. For more advanced features and detailed code examples, refer to the [official `go_router` documentation](https://pub.dev/packages/go_router)
    
2. You can also check out the [`go_router` GitHub repository](https://github.com/flutter/packages/blob/main/packages/go_router)
