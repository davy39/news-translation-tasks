...
1. [A little bit of history](#heading-a-little-bit-of-history)
    
2. [Just JavaScript](#heading-just-javascript)
    
3. [A brief intro to the syntax of JavaScript](#heading-a-brief-intro-to-the-syntax-of-javascript)
    
4. [Semicolons](#heading-semicolons)
    
5. [Values](#heading-values)
...
9. [Operators](#heading-operators)
    
10. [Precedence rules](#heading-precedence-rules)
    
11. [Comparison operators](#heading-comparison-operators)
    
12. [Conditionals](#heading-conditionals)
    
13. [Arrays](#heading-arrays)
    
14. [Strings](#heading-strings)
    
15. [Loops](#heading-loops)
    
16. [Functions](#heading-functions)
    
17. [Arrow functions](#heading-arrow-functions)
    
18. [Objects](#heading-objects)
    
19. [Object Properties](#heading-object-properties)
    
20. [Object Methods](#heading-object-methods)
    
21. [Classes](#heading-classes)
    
22. [Inheritance](#heading-inheritance)
    
23. [Asynchonous Programming and Callbacks](#heading-asynchonous-programming-and-callbacks)
    
24. [Promises](#heading-promises)
    
25. [Async and Await](#heading-async-and-await)
    
26. [Variable scope](#heading-variable-scope)
