...
* [How to Find the Best Anything](#heading-how-to-find-the-best-anything)
    
    * [How to Find the Best Water Bottle](#heading-how-to-find-the-best-water-bottle)
        
* [How to Find the Best Programming Language](#heading-how-to-find-the-best-programming-language)
    
    * [Navigating Public and Expert Opinions](#heading-navigating-public-and-expert-opinions)
        
    * [Low Level vs High Level](#heading-low-level-vs-high-level)
        
    * [Tightly Structured (Static) vs Loosely Structured (Dynamic)](#heading-tightly-structured-static-vs-loosely-structured-dynamic)
        
    * [Popularity Is Only One Factor](#heading-popularity-is-only-one-factor)
        
    * [Popularity Is Not A Guarantee Of Employment](#heading-popularity-is-not-a-guarantee-of-employment)
        
    * [Hardware & Working With What You Have](#heading-hardware-amp-working-with-what-you-have)
        
    * [What if I Want the AI to Code For Me?](#heading-what-if-i-want-the-ai-to-code-for-me)
        
    * [Avoid the Sunk-Cost Fallacy](#heading-avoid-the-sunk-cost-fallacy)
        
* [How to Find the Best Libraries and Frameworks](#heading-how-to-find-the-best-libraries-and-frameworks)
    
    * [What Are Libraries and Frameworks?](#heading-what-are-libraries-and-frameworks)
        
    * [How to Choose Libraries and Frameworks](#heading-how-to-choose-libraries-and-frameworks)
        
* [How to Find the Best Programming Principles and Practices](#heading-how-to-find-the-best-programming-principles-and-practices)
    
    * [D.R.Y – Don’t Repeat Yourself](#heading-dry-dont-repeat-yourself)
        
    * [What About Other Programming Principles?](#heading-what-about-other-programming-principles)
        
* [A Note About Patterns and Architectures](#heading-a-note-about-patterns-and-architectures)
    
    * [How to Find the Best Software Architecture](#heading-how-to-find-the-best-software-architecture)
        
    * [The Design Pattern Trap](#heading-the-design-pattern-trap)
