...
[Play the game](https://manishshivanandhan.com/snake-game-with-phaser/) here to get a feel for what you’ll be building.
...
* [Grid, Colors, and Game Config](#heading-grid-colors-and-game-config)
    
* [Scene State and Helper Functions](#heading-scene-state-and-helper-functions)
    
* [Preload and Create](#heading-preload-and-create)
    
* [Initialize the Game](#heading-initialize-the-game)
    
* [Reading Input Each Frame](#heading-reading-input-each-frame)
    
* [Stepping the Snake, Eating, and Drawing](#heading-stepping-the-snake-eating-and-drawing)
    
* [Spawning Food and Increasing Speed](#heading-spawning-food-and-increasing-speed)
    
* [Game Over and Restart](#heading-game-over-and-restart)
    
* [How the Whole Thing Fits Together](#heading-how-the-whole-thing-fits-together)
    
* [Useful Next Steps](#heading-useful-next-steps)
...
[Phaser](https://phaser.io/) is a free JavaScript library for 2D games. You write plain JavaScript and let Phaser do the heavy lifting. You don’t need a build system or a game engine installer. You can start with a single HTML file and one JavaScript file.
...
If you’re into online gaming, [GameBoost](https://gameboost.com/) is the place to be. Discover [GTA Modded Accounts](https://gameboost.com/grand-theft-auto-v/accounts) packed with exclusive upgrades. You’ll also find accounts for other fan-favorite titles like Fortnite, Grow a Garden, Clash of Clans, and more – all in one trusted marketplace.
