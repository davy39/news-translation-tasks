...
* [What We’re Building](#heading-what-were-building)
    ...
    * [AI Pricing for Retailers](#heading-ai-pricing-for-retailers)
        
    * [The Models](#heading-the-models)
        
    * [Tuning and Training](#heading-tuning-and-training)
        
    * [The Prediction](#heading-the-prediction)
        
    * [Performance Validation](#heading-performance-validation)
        
* [The System Architecture](#heading-the-system-architecture)
    
    * [Core AWS Resources in the Architecture](#heading-core-aws-resources-in-the-architecture)
        
* [The Deployment Workflow in Action](#heading-the-deployment-workflow-in-action)
    
    * [Step 1: Draft Python Scripts](#heading-step-1-draft-python-scripts)
        
    * [Step 2: Configure Feature/Model Stores in S3](#heading-step-2-configure-featuremodel-stores-in-s3)
        
    * [Step 3: Create a Flask Application with API Endpoints](#heading-step-3-create-a-flask-application-with-api-endpoints)
        
    * [Step 4: Publish a Docker Image to ECR](#heading-step-4-publish-a-docker-image-to-ecr)
        
    * [Step 5: Create a Lambda Function](#heading-step-5-create-a-lambda-function)
        
    * [Step 6: Configure AWS Resources](#heading-step-6-configure-aws-resources)
        
* [Building a Client Application (Optional)](#heading-building-a-client-application-optional)
    
    * [The React Application](#heading-the-react-application)
...
![What the UI will look like](https://cdn.hashnode.com/res/hashnode/image/upload/v1755873936847/ecf696ef-e161-4453-a6ad-e97d92ac1677.png align="center")

You can explore the UI from [here](https://kuriko-iwai.vercel.app/online-commerce-intelligence-hub).
...
The primary model was trained on a dataset of around 500,000 samples ([source)](https://archive.ics.uci.edu/dataset/352/online+retail) and fine-tuned using `Optuna`'s Bayesian Optimization, with grid search available for further refinement.
...
![Fig. The system architecture (Created by Kuriko IWAI)](https://miro.medium.com/v2/resize:fit:4680/0*ulcNtwJeU5EOfhTg.png align="left")

Fig. The system architecture (Created by [Kuriko IWAI)](https://kuriko-iwai.vercel.app/)
...
Serverless functions also can experience [**cold starts**](https://www.freecodecamp.org/news/cold-start-problem-in-recommender-systems/). With heavy tasks in the function, the API gateway would timeout before serving predictions.
...
![Fig. Screenshot of the Flask app local response](https://cdn.hashnode.com/res/hashnode/image/upload/v1755607075000/e0e8cbcb-8817-4aa5-b3d1-37b76cc684fb.png align="center")
...
![Flask app response](https://miro.medium.com/v2/resize:fit:1260/0*zu8mamgKMKOUxwCA.png align="left")
...
![Fig. Screenshot of the AWS ECR console](https://miro.medium.com/v2/resize:fit:1260/0*tUQkbDW-uAmrjBfx.png align="left")
...
![Fig. Screenshot of AWS Lambda function configurationFig. Screenshot of AWS Lambda function configuration](https://miro.medium.com/v2/resize:fit:1260/0*3b-wIEUzRooQcvN_.png align="left")
...
![Fig. Screenshot of the AWS API Gateway configurationFig. Screenshot of the AWS API Gateway configuration](https://miro.medium.com/v2/resize:fit:1260/0*60TP64gdSjhKfiO8.png align="left")
...
* Align the resource endpoint with the API endpoint defined in the [`app.py`](http://app.py).
...
![Fig. Screenshot of the AWS Lambda dashboard](https://miro.medium.com/v2/resize:fit:1260/0*DlfiEieZArmYlOuT.png align="left")
...
For full-stack deployment, we’ll build a simple React application to display the prediction using the [recharts](https://recharts.org/en-US) library for visualization.

Other options for quick frontend deployment include [Streamlit](https://streamlit.io/) or [Gradio](https://www.gradio.app/).
...
All code (backend) is available in [my Github Repo](https://github.com/krik8235/ml-sales-prediction).
