...
This article won't be an introduction to [Node.js](https://nodejs.org/en/), [Express.js](https://expressjs.com/), or [REST API](https://www.freecodecamp.org/news/rest-apis/)s. Make sure to check out the links before diving deeper if you need a refresher. 🤿
...
_Auto-generated SwaggerUi, at http://localhost:3030/api-documentation_
...
I am currently building [_**taggr**_](https://taggr.ai/)_,_ a cross-platform desktop application that enables users to **rediscover** their digital **memories** while keeping their **privacy**. 
