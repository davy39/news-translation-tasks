...
_Requesting Permission to Access User's Location_
...
When the user clicks on the _Get Location_ button above, we will access the Geolocation API, retrieve the user location, and provide a link to see the user's location on a map.
...
![OpenStreetMap Using Geolocation API data](https://www.freecodecamp.org/news/content/images/2024/02/geolocation-getCurrentPosition.png)
_The OpenStreetMap Website Pin On the Latitude and Longitude Data_
...
If you enjoyed this article and want to learn more from me, I recommend you check out my new book _[Beginning Modern JavaScript](https://codewithnathan.com/beginning-modern-javascript)_.
