...
Together with my friend [Jim](https://twitter.com/jd_medlock) we created a [collection of application ideas](https://github.com/florinpop17/app-ideas) which is intended to solve this issue once and for all! 
...
Below you’ll find **5 projects** for each of the tiers (**15 in total**), but there are over **30 projects** (at the moment) in [this GitHub repository](https://github.com/florinpop17/app-ideas). Make sure you check it out as we are planning to add more projects in the future. You are welcome to help! (More about this in the _Contributing_ section below ?)
...
You are welcome to contribute to the project in the [GitHub repository](https://github.com/florinpop17/app-ideas)! Any contribution is highly appreciated.
...
**Florin Pop**: [Twitter](https://twitter.com/florinpop1705) and [website](https://florin-pop.com).

**Jim Medlock**: [Twitter](https://twitter.com/jd_medlock) and [Medium](https://medium.com/@jdmedlock)
...
_Originally published at [www.florin-pop.com](https://www.florin-pop.com/blog/2019/03/15-plus-app-ideas-to-build-to-level-up-your-coding-skills/)._
