...
1. A character set `[]` - match any character between these brackets. ![character-sets](https://www.freecodecamp.org/news/content/images/2019/09/character-sets.png)
2. `a-z` - match all lowercase letters ![a-z](https://www.freecodecamp.org/news/content/images/2019/09/a-z.png)
3. `0-9` - match all numbers ![0-9](https://www.freecodecamp.org/news/content/images/2019/09/0-9.png)
