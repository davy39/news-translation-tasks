---
title: 'Common SQL Interview Questions: Your Database Cheat Sheet'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
### Create a user my723acct with password kmd26pt. Use the user _data and temporary data tablespaces provided by PO8 and provide to this user 10M of storage space in user_ data and 5M of storage space in temporary_data.
