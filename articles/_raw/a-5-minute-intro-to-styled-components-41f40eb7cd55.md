...
This will seem counter-intuitive at first, since the whole point of using CSS instead of directly styling HTML elements (remember the `<fo`nt> tag?) is to decouple styles and markup by introducing this intermediary class layer.
