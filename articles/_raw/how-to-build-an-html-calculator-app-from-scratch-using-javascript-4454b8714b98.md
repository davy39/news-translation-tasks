...
1. [If/else statements](https://zellwk.com/blog/js-if-else)
2. [For loops](https://zellwk.com/blog/js-for-loops)
3. [JavaScript functions](https://zellwk.com/blog/js-functions)
4. [Arrow functions](https://zellwk.com/blog/es6/#arrow-functions)
5. `&&` and `||` operators
...
You can grab the source code for the happy path through [this link](http://zellwk.com/blog/calculator-part-1) (scroll down and enter your email address in the box, and I’ll send the source codes right to your mailbox).
...
You can grab the source code for the edge cases part through [this link](http://zellwk.com/blog/calculator-part-2) (scroll down and enter your email address in the box, and I’ll send the source codes right to your mailbox).
...
4. [ES6 Destructuring](https://zellwk.com/blog/es6#destructuring)
...
You can grab the source code for the refactor part through [this link](https://zellwk.com/blog/calculator-part-3) (scroll down and enter your email address in the box, and I’ll send the source codes right to your mailbox).

I hope you enjoyed this article. If you did, you might love [Learn JavaScript](https://learnjavascript.today/)—a course where I show you how to build 20 components, step by step, like how we built this calculator today.
