...
* [Understanding eBPF Observability](#heading-understanding-ebpf-observability)
    
* [How eBPF Tracing Works (Without Getting Lost in the Kernel)](#heading-how-ebpf-tracing-works-without-getting-lost-in-the-kernel)
    
* [How to Set Up Your Environment](#heading-how-to-set-up-your-environment)
    
* [How to Trace Your First Request: Hands-On Tutorial](#heading-how-to-trace-your-first-request-hands-on-tutorial)
    
* [How to Interpret Traces](#heading-how-to-interpret-traces)
    
* [Real-World Debugging Scenarios](#heading-real-world-debugging-scenarios)
    
* [Advanced Tracing Insights](#heading-advanced-tracing-insights)
    
* [Best Practices and Production Considerations](#heading-best-practices-and-production-considerations)
    
* [Next Steps and Resources](#heading-next-steps-and-resources)
...
The trace\_tcp gadget shows network connections, giving us visibility into service-to-service communication.
...
The traceloop and trace\_tcp gadgets give you application-level insights, but sometimes you need to go deeper. The trace\_exec gadget shows you every process execution in your containers.
...
* [eBPF.io](http://eBPF.io): The central hub for eBPF documentation, tutorials, and project listings
    
* [Inspektor Gadget docs](https://inspektor-gadget.io/docs/latest/): Comprehensive guides for all gadgets and use cases
    
* [Cilium documentation](https://docs.cilium.io/en/stable/index.html): Deep dives into eBPF networking
    
* [CNCF Blog — “What is Observability 2.0?](https://www.cncf.io/blog/2025/01/27/what-is-observability-2-0/): A quick overview of how modern observability moves beyond traditional tools by unifying metrics, logs, and traces for real-time insight in cloud-native systems.
    

**Learning resources:**

* [Learning eBPF by Liz Rice](https://cilium.isovalent.com/hubfs/Learning-eBPF%20-%20Full%20book.pdf): Comprehensive book covering eBPF fundamentals
    
* [eBPF Summit](https://ebpf.io/summit-2025/): Annual conference with talks from eBPF creators and users
    
* [CNCF webinars](https://www.cncf.io/online-programs/cncf-on-demand-webinar-how-to-start-building-a-self-service-infrastructure-platform-on-kubernetes/): Regular sessions on observability topics
    
* [Kubernetes observability SIGs](https://www.kubernetes.dev/community/community-groups/): Community discussions and projects
    

To make this tutorial easy to follow and experiment with, I have included all Kubernetes manifests, demo applications, and eBPF tracing commands in this [repository](https://github.com/Emidowojo/ebpf-k8s-tracing-tutorial). You can also connect with me on [LinkedIn](https://www.linkedin.com/in/emidowojo/) if you’d like to stay in touch.
