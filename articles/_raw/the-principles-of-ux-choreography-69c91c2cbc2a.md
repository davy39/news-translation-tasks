...
co_authors: []
series: null
date: '2015-04-08T00:35:17.000Z'
originalURL: https://freecodecamp.org/news/the-principles-of-ux-choreography-69c91c2cbc2a
coverImage: https://cdn-media-1.freecodecamp.org/images/1*bVba7oDXC6JeLyeUbwvCZw.gif
tags:
- name: animation
  slug: animation
- name: Art
...
- name: UX
  slug: ux
seo_title: null
seo_desc: 'By Rebecca Ussai Henderson

  The intersection of Disney and UX and why learning how to draw Mickey Mouse will
  change how you approach design

  Recently I collaborated together with Glen Keane, Disney animator and legend, on
  a talk at SXSW. This article i...'
---
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*iVWINSa_xrQ13oLckXOCyQ.png)

> UX Choreography is a combination of the _how_ with the _when and why_ — the proper techniques of applying motion and captivating an audience combined with the most integral moments in user experience where you can start engaging your user in a two-way dialogue.
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*YctY2u6kWGtQmiNl8gfl5g.jpeg)
_Beast getting frustrated and surprised_
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*_lflrcbyVdMzQURlNcD0DQ.gif)

![Image](https://cdn-media-1.freecodecamp.org/images/1*YB7PwA_y3E2VJCTF8T3v-g.gif)
_Examples of Feedback. iOS password shake: simple head shake, directly relates to how we give feedback to each other. Dots: simple and delightful, many different layers working together. Yahoo News: each circle fills one by one, the counter updates, your progress is complete and you are rewarded with a full screen fact. Beats: genres react when you tap, progress building is a queue to the user. (PS — check out capptivate.co for great examples)._
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*bwwKkgU_aT83UJvFJEpOOw.jpeg)
_Mickey’s open hand becomes a symbol for the action of reaching across and grabbing a ball_
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*GOQj0cN_IacXFrJqDNW_Zw.png)
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*oCXsKtvvbl71b3KniroLNg.gif)

![Image](https://cdn-media-1.freecodecamp.org/images/1*IuE9-JIrOjpLDTXWflHkDg.gif)
_Examples of Feedforward. Clear: a subtle hint at a new list item as soon as you pull. Moldiv: a slight peek at the controls behind the home screen gives users a cue. Yummly: what was previously just a white background now becomes an input field. Snapchat: pull to refresh, the hint of a color or a spinner is a cue that something is about to happen._
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*JzKhmaZ_0KAzz4pTrbfPrQ.png)
_sequence of Mia in Duet_
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*bwqcE-mGNpy7A4OnCqda6Q.gif)

![Image](https://cdn-media-1.freecodecamp.org/images/1*d99NROjEWxxNxQgdEc_APA.gif)
_Examples of Spatial Awareness. Calendar: days of the week rest side by side, ease the user between each one. Stellar: a storytelling app takes the theme further into its UI with the use of pages. VSCO: trays of controls act like a toolkit you can pull up from the bottom. Nike Making: categories zoom full screen, push to top, then the layers of sub-categories drop down and float into place._
...
![Image](https://cdn-media-1.freecodecamp.org/images/1*r9rpW_WuNOb4opZhulL1qQ.gif)
_A scene from Little Whirlwind, animated by Freddie Moore._
