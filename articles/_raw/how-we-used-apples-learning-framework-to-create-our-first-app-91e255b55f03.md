...
co_authors: []
series: null
date: '2017-07-31T14:39:29.000Z'
originalURL: https://freecodecamp.org/news/how-we-used-apples-learning-framework-to-create-our-first-app-91e255b55f03
coverImage: https://cdn-media-1.freecodecamp.org/images/1*mrHHVnsRGXn8O7Jy4BJglA.png
tags:
- name: Apple
  slug: apple
- name: Design
...
- name: technology
  slug: technology
seo_title: null
seo_desc: 'By Jonata Corrêa

  After one month of work, my team and I finished the first version of Echo, our tracker
  iOS application. We built it as a result of a challenge created by the Challenge
  Based Learning (CBL) method and it was a great experience.
...
![Image](https://cdn-media-1.freecodecamp.org/images/FEjy8DbWBaBmPenusSYbhr3Ac74MkL9zg8i1)
...
![Image](https://cdn-media-1.freecodecamp.org/images/-lGi3YQYdKfOJbeSIY1gbpURFig1-xGFXM0e)
_[Source](https://www.numbeo.com/crime/in/Porto-Alegre" rel="noopener" target="_blank" title=")_
...
> _“The learners plan and participate in a journey that builds the foundation for solutions and addresses academic requirement.” — [Digital Promise](http://cbl.digitalpromise.org/about/)_
...
> _“In the Act Phase evidence-based solutions are developed and implemented with an authentic audience and the results evaluated. The Learners combine a desire to make a difference with a demonstration of content mastery.” — [Digital Promise](http://cbl.digitalpromise.org/about/)_
