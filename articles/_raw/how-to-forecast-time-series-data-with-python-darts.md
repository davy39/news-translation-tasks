...
There are various libraries for time series forecasting in Python, and [Darts](https://unit8co.github.io/darts/) is one of them. Unlike other forecasting libraries, Darts is a high-level forecasting library with algorithms to handle various time series data, regardless of the kind of trend they portray.
...
* [What is Python Darts?](#heading-what-is-python-darts)
    
* [Prerequisites](#heading-prerequisites)
    
* [How to Set Up Dependencies](#heading-how-to-set-up-dependencies)
    
* [Understanding the Dataset](#heading-understanding-the-dataset)
    
* [How to Prepare the Data for Darts](#heading-how-to-prepare-the-data-for-darts)
    
* [How to Build a Forecasting Model](#heading-how-to-build-a-forecasting-model)
    
    * [Classical Model](#heading-classical-model)
        
    * [Machine Learning Models](#heading-machine-learning-models)
        
    * [How to Forecast with Deep Learning models](#heading-how-to-forecast-with-deep-learning-models)
        
* [Model Evaluation](#heading-model-evaluation)
    
* [BackTesting](#heading-backtesting)
    
* [Hyper Parameter Tuning](#heading-hyper-parameter-tuning)
...
* Download the [Netflix stock data](https://www.kaggle.com/datasets/kalilurrahman/netflix-stock-data-live-and-latest).
...
![Image showing the first 5 rows of the Netflix stock data](https://cdn.hashnode.com/res/hashnode/image/upload/v1757927775470/2d4b542c-3869-40c5-844c-a733b5cc4bea.png align="center")
...
![Image showing a line chart of Netflix stock data from 2000 to date](https://cdn.hashnode.com/res/hashnode/image/upload/v1757928810807/75a1fa13-4f2e-4bdd-a539-5eaf2663843a.png align="center")
...
![Image showing the ARIMA model forecast of netflix stock ](https://cdn.hashnode.com/res/hashnode/image/upload/v1758028284156/a40f2341-cfc6-4a9f-8297-e0511c2bb254.png align="center")

You can improve the model by adding some additional parameters to the `ARIMA()` class. You can read more about that in the [Darts documentation](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.arima.html).
...
![Image showing the LightGBM model forecast of netflix stock ](https://cdn.hashnode.com/res/hashnode/image/upload/v1758029933172/54f34a69-4f6b-4b44-85ab-d0b45931d701.png align="center")

You can read more about tuning the LightGBM model from the [Darts documentation](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.lgbm.html) to improve the above model.
...
![Image showing the LSTM model forecast of Netflix stock ](https://cdn.hashnode.com/res/hashnode/image/upload/v1758116174578/2ff80218-2254-452d-8d4c-2f85c61612de.png align="center")

You can look up the [Darts documentation](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.rnn_model.html) to improve the model and check out other deep learning models also.
...
Note that each model has its specific parameter you would have to tune, and you will need to check [the Darts documentation](https://unit8co.github.io/darts/userguide/hyperparameter_optimization.html) for the hyperparameters of other models.
...
Another interesting thing with Darts is its ability to handle [hierarchical time series](https://unit8co.github.io/darts/userguide/timeseries.html#hierarchical-time-series). Here, data is structured at aggregated levels.

Darts is one of the most powerful time series libraries in Python and has a lot of models to handle various cases. You can proceed to explore models such as [Transformers](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.transformer_model.html) and also [multi-series forecasting](https://unit8co.github.io/darts/examples/01-multi-time-series-and-covariates.html), which are used for special use cases.

If you are interested in more data science and statistics articles, don’t forget to check out [my blog](https://learndata.xyz/blog).
