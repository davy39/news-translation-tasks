...
If you want to skip the reading, [here](https://github.com/mihailgaberov/memory-card) 💁 is the GitHub repository 🙌. And [here](https://memory-card-blush-pi.vercel.app/) you can see the live demo.

## **Table of Contents**

* [Project Description](#heading-project-description)
    
* [Let’s Build the Game](#heading-lets-build-the-game)
    
* [Testing the App](#heading-testing-the-app)
    
* [API Fallback Mechanism](#heading-api-fallback-mechanism)
    
* [Optimizations](#heading-optimizations)
    
* [Future Improvements](#heading-future-improvements)
...
![Memory Card game screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1732517597049/8677428e-ebd6-4f0b-a1f6-2a2d9f5f2dd2.png align="center")
...
![Project Structure](https://cdn.hashnode.com/res/hashnode/image/upload/v1732517663524/648124f0-aa8c-4c50-9292-4bdbd1c9c4db.png align="center")
...
4. Header/Footer/Subtitle Components
...
The only dependencies we will use in this project are the hook package from UI.dev (by the way, [here](https://ui.dev/why-react-renders) you can find a well-explained article on how rendering in React works).

The other dependency is the famous CSS preprocessor, [SASS](https://sass-lang.com/), that we’ll need to be able to write our CSS modules in SASS instead of regular CSS.
...
![Running Tests](https://cdn.hashnode.com/res/hashnode/image/upload/v1732517719141/8b034f36-761e-4433-acfd-82a2c4cffffc.png align="center")
