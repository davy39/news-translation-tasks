---
title: Reflections on being an indie hacker
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
date: '2018-12-05T21:32:02.000Z'
originalURL: https://freecodecamp.org/news/reflections-on-being-an-indie-hacker-95e19d2edb47
coverImage: https://cdn-media-1.freecodecamp.org/images/1*Or2dantuEoAbOMXRY6i4oQ.jpeg
tags:
...
seo_desc: 'By Tigran Hakobyan
  ...
  My name is Tigran and by definition, I’m probably a half-indie hacker. Why half
  you may ask? Because I’m a full-time software engineer at Buffer but at the same
  time I’m building an online profitable side-business called Cronhub.
...
My name is Tigran and by definition, I’m probably a half-indie hacker. Why half you may ask? Because I’m a full-time software engineer at Buffer but at the same time I’m building an online profitable side-business called [Cronhub](http://www.cronhub.io/).
...
![Image](https://cdn-media-1.freecodecamp.org/images/q62s-UwFndhhmw53l4TUa98rL5vAO-qtBpeM)
_How IndieHackers.com defines indie hacker_

I generate money independently through the product I’ve created but also have a primary source of income which is my employer. I’m a solo founder and have been bootstrapping [Cronhub](http://www.cronhub.io/) for the past 8 months or so. As you see I may have the rights to call myself an indie hacker, right? If your answer is yes then let’s read my story further. Also, I’ve written [another article](https://blog.cronhub.io/reflections-on-being-a-remote-developer/) if you like to read more about how I work remotely.
...
![Image](https://cdn-media-1.freecodecamp.org/images/4omaTQwAsqhPtlDE0yjL6PQSbEvYHPoFu-Qn)
_Cronhub’s listing on ProductHunt_
...
![Image](https://cdn-media-1.freecodecamp.org/images/TQtuw5M5D5Nz5q3vdhhUHYkOA-vNqiQX8aU2)
...
![Image](https://cdn-media-1.freecodecamp.org/images/6fKikKxFeXsfu1GFi-HaRQL8Trw2D1BbSp4b)
_Jumped to the first page for certain keywords!_
...
![Image](https://cdn-media-1.freecodecamp.org/images/9aEDORcw6Q6tB0kkISLrnLocGBGt9K1aSGPe)
_The organic search is the top acquisition channel_
...
I found a great report, [The Developer Coefficient](https://stripe.com/reports/developer-coefficient-2018) by [Stripe](http://www.stripe.com/) that conducted a study with thousands of C-level executives and developers across 30+ industries. One of the survey questions was the following:
...
_I also want to thank my wife [Ani](https://www.instagram.com/_nyut/) for helping me to edit this article. ❤️_

_Originally published at [blog.cronhub.io](https://blog.cronhub.io/reflections-on-being-an-indie-hacker/) on December 5, 2018._
