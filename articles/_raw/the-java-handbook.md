---
title: The Java Handbook – Learn Java Programming for Beginners
subtitle: ''
...
- [How to Write Hello World in Java](#heading-how-to-write-hello-world-in-java)
    - [What’s Going On in the Code?](#heading-whats-going-on-in-the-code)
    - [What is JVM?](#heading-what-is-jvm)
    - [What is JRE and JDK?](#heading-what-is-jre-and-jdk)
- [How To Setup Java on Your Computer?](#heading-how-to-setup-java-on-your-computer)
- [How To Install a Java IDE on Your Computer?](#heading-how-to-install-a-java-ide-on-your-computer)
- [How To Create a New Project on IntelliJ IDEA](#heading-how-to-create-a-new-project-on-intellij-idea)
- [How to Work with Variables in Java](#heading-how-to-work-with-variables-in-java)
    - [What Are the Rules for Declaring Variables?](#heading-what-are-the-rules-for-declaring-variables)
    - [What Are final Variables?](#heading-what-are-final-variables)
- [What are the Primitive Data Types in Java?](#heading-what-are-the-primitive-data-types-in-java)
    - [What is Type Conversion or Casting?](#heading-what-is-type-conversion-or-casting)
    - [What are Wrapper Classes in Java](#heading-what-are-wrapper-classes-in-java)
- [How to Use Operators in Java](#heading-how-to-use-operators-in-java)
    - [What Are the Arithmetic Operators?](#heading-what-are-the-arithmetic-operators)
    - [What Are the Assignment Operators?](#heading-what-are-the-assignment-operators)
    - [What Are the Relational Operators?](#heading-what-are-the-relational-operators)
    - [What Are the Logical Operators?](#heading-what-are-the-logical-operators)
    - [What Are the Unary Operators?](#heading-what-are-the-unary-operators)
- [How to Work with Strings in Java](#heading-how-to-work-with-strings-in-java)
    - [How to Format a String](#heading-how-to-format-a-string)
    - [How to Get the Length of a String or Check if It's Empty or Not](#heading-how-to-get-the-length-of-a-string-or-check-if-its-empty-or-not)
    - [How to Split and Join Strings](#heading-how-to-split-and-join-strings)
    - [How to Convert a String to Upper or Lowercase](#heading-how-to-convert-a-string-to-upper-or-lowercase)
    - [How to Compare Two Strings](#heading-how-to-compare-two-strings)
    - [How to Replace Characters or Substring in a String](#how-to-replace-characters-or-substring-in-a-string)
    - [How to Check If a String Contains a Substring or Not](#heading-how-to-check-if-a-string-contains-a-substring-or-not)
- [What Are the Different Ways of Inputting and Outputting Data?](#heading-what-are-the-different-ways-of-inputting-and-outputting-data)
- [How to Use Conditional Statements in Java](#heading-how-to-use-conditional-statements-in-java)
- [What is a switch-case statement?](#heading-what-is-a-switch-case-statement)
- [What is Variable Scope in Java?](#heading-what-is-variable-scope-in-java)
- [What Are Default Values of Variables in Java?](#heading-what-are-default-values-of-variables-in-java)
- [How to Work with Arrays in Java](#heading-how-to-work-with-arrays-in-java)
    - [How to Sort an Array](#heading-how-to-sort-an-array)
    - [How to Perform Binary Search on an Array](#heading-how-to-perform-binary-search-on-an-array)
    - [How to Fill an Array](#heading-how-to-fill-an-array)
    - [How to Make Copies of an Array](#heading-how-to-make-copies-of-an-array)
    - [How to Compare Two Arrays](#heading-how-to-compare-two-arrays)
- [How to Use Loops in Java](#heading-how-to-use-loops-in-java)
    - [For Loop](#heading-for-loop)
    - [For-Each Loop](#heading-for-each-loop)
    - [While Loop](#heading-while-loop)
    - [Do-While Loop](#heading-do-while-loop)
- [How to Work with Array Lists in Java](#heading-how-to-work-with-array-lists-in-java)
    - [How to Add or Remove Multiple Elements](#heading-how-to-add-or-remove-multiple-elements)
    - [How to Remove Elements Based on a Condition](#heading-how-to-remove-elements-based-on-a-condition)
    - [How to Clone and Compare Array Lists](#heading-how-to-clone-and-compare-array-lists)
    - [How To Check if an Element Is Present or the Array List Is Empty](#heading-how-to-check-if-an-element-is-present-or-the-array-list-is-empty)
    - [How to Sort an Array List](#heading-how-to-sort-an-array-list)
    - [How To Keep Common Elements From Two Array Lists](#heading-how-to-keep-common-elements-from-two-array-lists)
    - [How To Perform an Action on All Elements of an Array List](#heading-how-to-perform-an-action-on-all-elements-of-an-array-list)
- [How To Work With Hash Maps in Java](#heading-how-to-work-with-hash-maps-in-java)
    - [How To Put or Replace Multiple Elements in a Hash Map](#how-to-put-or-replace-multiple-elements-in-a-hash-map)
    - [How To Check if a Hash Map Contains an Item or if It’s Empty](#heading-how-to-check-if-a-hash-map-contains-an-item-or-if-its-empty)
    - [How To Perform an Action on All Elements of a Hash Map](#heading-how-to-perform-an-action-on-all-elements-of-a-hash-map)
- [Classes and Objects in Java](#heading-classes-and-objects-in-java)
    - [What is a Method?](#heading-what-is-a-method)
    - [What is Method Overloading?](#heading-what-is-method-overloading)
- [What are Constructors in Java?](#heading-what-are-constructors-in-java)
- [What Are Access Modifiers in Java?](#heading-what-are-access-modifiers-in-java)
- [What Are the Getter and Setter Methods in Java?](#heading-what-are-the-getter-and-setter-methods-in-java)
- [What is Inheritance in Java?](#heading-what-is-inheritance-in-java)
- [How to Override a Method in Java](#heading-how-to-override-a-method-in-java)
