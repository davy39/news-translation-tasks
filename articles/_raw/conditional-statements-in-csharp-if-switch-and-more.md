---
title: 'How to Use Conditional Statements in C#: If, Switch, and More Explained with
  Example Code'
subtitle: ''
...
* [What You Will Learn In This Article](#heading-what-you-will-learn-in-this-article)
    
* [If / Else if / Else Statements](#heading-if-else-if-else-statements)
    
* [Replacing If / Else with Ternary Operator](#heading-replacing-if-else-with-ternary-operator)
    
* [Switch Case Statements](#heading-switch-case-statements)
    
* [Switch Statements - Expression Syntax](#heading-switch-statements-expression-syntax)
    
* [Performance Summary](#heading-performance-summary)
...
| **Method** | **Mean (execution time -** [**nano seconds**](https://en.wikipedia.org/wiki/Nanosecond)**)** |
| --- | --- |
...
As always if you want to chat about any of my articles you can follow me on [Twitter](https://x.com/grantdotdev).
