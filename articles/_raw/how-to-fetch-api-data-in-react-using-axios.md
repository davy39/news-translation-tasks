...
1. [What is an API and Why Do We Need it?](#heading-what-is-an-api-and-why-do-we-need-it)
    
2. [Types of APIs You’ll Encounter](#heading-types-of-apis-youll-encounter)
    
3. [Tools We’ll Use](#heading-tools-well-use)
    
4. [How to Fetch Data with React](#heading-how-to-fetch-data-with-react)
    
    * [How to Fetch Data with fetch()](#heading-how-to-fetch-data-with-fetch)
        
    * [Refactor with Axios](#heading-refactor-with-axios)
        
5. [How to Handle Loading and Error States](#heading-how-to-handle-loading-and-error-states)
    
    * [What is a Loading State?](#heading-what-is-a-loading-state)
        
    * [What is an Error State?](#heading-what-is-an-error-state)
        
6. [How to Keep Your API Keys Safe](#heading-how-to-keep-your-api-keys-safe)
    
    * [Why it's Important:](#heading-why-its-important)
        
7. [Fun Public APIs to Practice With](#heading-fun-public-apis-to-practice-with)
...
* `apiKey=YOUR_API_KEY` – this is your personal API key you get after signing up on [newsapi.org](http://newsapi.org)
...
**Note:** In Vite, all environment variables must start with VITE\_ to be accessible in the browser. Make sure to add .env to your .gitignore file so it doesn’t get pushed to GitHub.
