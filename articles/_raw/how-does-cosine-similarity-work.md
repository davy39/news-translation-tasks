...
When you talk to a large language model (LLM), it feels like the model understands meaning. But under the hood, the system relies on numbers, vectors, and math to find the [relationships between words](https://www.turingtalks.ai/p/how-to-perform-sentence-similarity-check-using-sentence-transformers) and sentences.
...
* [What Is Cosine Similarity](#heading-what-is-cosine-similarity)
    
* [The Math Behind Cosine Similarity](#heading-the-math-behind-cosine-similarity)
    
* [A Simple Example](#heading-a-simple-example)
    
* [Cosine Similarity in Embeddings](#heading-cosine-similarity-in-embeddings)
    
* [How LLMs Use Cosine Similarity](#heading-how-llms-use-cosine-similarity)
    
* [Limits of Cosine Similarity](#heading-limits-of-cosine-similarity)
    
* [Why It Matters for LLMs](#heading-why-it-matters-for-llms)
...
The dot product multiplies corresponding numbers in the two vectors and adds them up. The magnitude of a vector is like finding the length of an arrow, using the [Pythagorean theorem](https://en.wikipedia.org/wiki/Pythagorean_theorem).
...
Let’s see a short example using Python. Suppose you want to check how similar two short texts are. We can use [scikit-learn](https://scikit-learn.org/) to turn them into vectors and then compute cosine similarity.
...
An [embedding](https://www.freecodecamp.org/news/how-ai-agents-remember-things-vector-stores-in-llm-memory/) is a dense vector that captures meaning. Each word, phrase, or sentence is turned into a set of numbers that place it in a high-dimensional space.
