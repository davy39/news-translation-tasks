...
1. [What are Controlled Components](#heading-what-are-controlled-components)?
2. [How Controlled Components Work](#heading-how-controlled-components-work) 
3. [Benefits of using Controlled Components](#heading-benefits-of-using-controlled-components)
4. [Examples of Controlled Components](#heading-examples-of-controlled-components)
5. [What are Uncontrolled Components](#heading-what-are-uncontrolled-components)?
6. [How Uncontrolled Components Work](#heading-how-uncontrolled-components-work)
7. [When to use Uncontrolled Components](#heading-when-to-use-uncontrolled-components)
8. [Limitations to Uncontrolled Components](#heading-limitations-of-uncontrolled-components)
9. [Examples of Uncontrolled Components](#heading-examples-of-uncontrolled-components)
10. [Factors to Consider When Choosing Between Controlled and Uncontrolled Components](#heading-factors-to-consider-when-choosing-between-controlled-and-uncontrolled-components)
