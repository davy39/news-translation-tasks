---
title: The Design Patterns for Distributed Systems Handbook – Key Concepts Every Developer
  Should Know
subtitle: ''
...
1. [What are Distributed Systems?](#heading-what-are-distributed-systems)
2. [Common Challenges in Distributed Systems](#heading-common-challenges-in-distributed-systems)
3. [Command and Query Responsibility Segregation (CQRS) Pattern](#heading-command-and-query-responsibility-segregation-cqrs-pattern)
4. [Two-Phase Commit (2PC) Pattern](#heading-two-phase-commit-2pc-pattern)
5. [Saga Pattern](#heading-saga-pattern)
6. [Replicated Load-Balanced Services (RLBS) Pattern](#heading-replicated-load-balanced-services-rlbs-pattern)
7. [Sharded Services Pattern](#heading-sharded-services-pattern)
8. [Sidecar Pattern](#heading-sidecar-pattern)
9. [Write-Ahead Log Technique](#write-ahead-log-pattern)
10. [Split-Brain Pattern](#heading-split-brain-pattern)
11. [Hinted Handoff Pattern](#heading-hinted-handoff-pattern)
12. [Read Repair Pattern](https://www.freecodecamp.org/news/p/62b41b39-6b8e-4e9b-a541-1071140ffb3a/read-repair-pattern)
13. [Service Registry Pattern](#heading-service-registry-pattern)
14. [Circuit Breaker Pattern](#heading-circuit-breaker-pattern)
15. [Leader Election Pattern](#heading-leader-election-pattern)
16. [Bulk Head Pattern](#heading-bulk-head-pattern)
17. [Retry Pattern](#heading-retry-pattern)
18. [Scatter Gather Pattern](#heading-scatter-gather-pattern)
19. [Bloom Filters Data Structure](#bloom-filters-pattern) 

## What are Distributed Systems?

![Image](https://www.freecodecamp.org/news/content/images/2023/05/image-110.png)
_Netflix Architecture. [Source](https://www.geeksforgeeks.org/system-design-netflix-a-complete-architecture/)_
