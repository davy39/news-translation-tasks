...
_Jumping from C++ to Python (Photo by [Unsplash](https://unsplash.com/photos/TZ-D7A7Oy0s?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Erik Dungan</a> on <a href="https://unsplash.com/search/photos/deep-dive?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="))_
...
When I started coding in Python, I first wrote C++ code in Python. It worked, but I didn’t gain any benefit from the language. My coding improved when I started writing in a more “Pythonic” fashion and started using libraries, and more advanced concepts such as [generators](http://book.pythontips.com/en/latest/generators.html), [decorators](http://book.pythontips.com/en/latest/decorators.html) and [contexts](http://book.pythontips.com/en/latest/context_managers.html).

As a Python developer I tend to look first for the library that solves the issue at hand. Python has a rich [library ecosystem](https://pypi.org/) and community that supports it. There are libraries for doing practically anything. Here are some handy ones that I use on a daily basis: [**NumPy**](http://www.numpy.org/) for numerical calculations, [**OpenCV**](https://opencv.org/) for computer vision, [**json**](https://docs.python-guide.org/scenarios/json/) for reading json files, [**SciPy**](https://www.scipy.org/scipylib/index.html) for scientific calculations, [**sqlite3**](https://docs.python.org/3.7/library/sqlite3.html) for databases.
...
_Photo by [Unsplash](https://unsplash.com/photos/fYjIBVvUuRM?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title="">Channey</a> on <a href="https://unsplash.com/search/photos/snorkeling?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText" rel="noopener" target="_blank" title=")_
