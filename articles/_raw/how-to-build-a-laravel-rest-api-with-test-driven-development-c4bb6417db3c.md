...
There is a famous quote by [James Grenning](https://wingman-sw.com/about), one of the pioneers in TDD and Agile development methodologies:
...
> **Note:** This walkthrough assumes that you understand the basic concepts of [Laravel](https://laravel.com/docs/5.7) and [PHPUnit](https://phpunit.de/documentation.html). If you’ve got that out of the way? Let’s drive.
...
We will not actually be using the routes and views generated. For this project, we would be using [jwt-auth](https://github.com/tymondesigns/jwt-auth). So go ahead and [set it up](https://github.com/tymondesigns/jwt-auth/wiki/Installation) in your application.

> **Note:** If you’re having errors with JWT’s `generate` command, you can follow [this](https://github.com/tymondesigns/jwt-auth/issues/1298#issuecomment-330458018) fix till it’s been added to the stable release.
...
_The entire code for this walkthrough is available on Github [here](https://github.com/kofoworola/tdd-journey). Feel free to play around with it._
