---
title: How to Use Github Actions to Deploy a Next.js Website to AWS S3
subtitle: ''
author: Colby Fayock
co_authors: []
series: null
...
* [What is Continuous Deployment?](#heading-what-is-continuous-deployment)
* [What are we going to build?](#heading-what-are-we-going-to-build)
* [Step 0: Setting up a new Next.js project on GitHub](#heading-step-0-setting-up-a-new-nextjs-project-on-github)
* [Step 1: Manually creating and deploying a Next.js project to a new S3 Bucket](#heading-step-1-manually-creating-and-deploying-a-nextjs-project-to-a-new-s3-bucket)
* [Step 2: Creating a new GitHub Action workflow to automatically build a Next.js project](#heading-step-2-creating-a-new-github-action-workflow-to-automatically-build-a-nextjs-project)
* [Step 3: Configuring a GitHub Action to deploy a static website to S3](#heading-step-3-configuring-a-github-action-to-deploy-a-static-website-to-s3)
...
I [previously wrote about](https://www.freecodecamp.org/news/what-are-github-actions-and-how-can-you-automate-tests-and-slack-notifications/) how we can use them to automate tasks like running tests on our code and sending notifications to Slack.
...
_Note: this tutorial will not walk you through how to host a website on S3, but you can check out my other tutorial that will [walk you through hosting a website on S3](https://www.freecodecamp.org/news/how-to-host-and-deploy-a-static-website-or-jamstack-app-to-s3-and-cloudfront/) step-by-step._

![Image](https://www.freecodecamp.org/news/content/images/2020/10/s3-bucket-website-hosting.jpg)
_Static website hosting in AWS S3_
...
_New workflow in GitHub Actions_
...
_Successful build logs for a GitHub Action workflow_
...
_Creating an Access Key in AWS_
...
_Finding Secret and Access Key in AWS_
...
_Successful AWS S3 sync in GitHub Action workflow_
...
_New GitHub Action workflow from code change_
...
_AWS S3 hosted app with updated code changes_
...
You can check out [my other guide](https://www.freecodecamp.org/news/how-to-host-and-deploy-a-static-website-or-jamstack-app-to-s3-and-cloudfront/) here which walks you through setting up CloudFront as well as a step-by-step guide through creating the site in S3.
