...
co_authors: []
series: null
date: '2016-03-30T04:39:13.000Z'
originalURL: https://freecodecamp.org/news/train-like-an-aws-certified-cloud-ninja-534f1770eba2
coverImage: https://cdn-media-1.freecodecamp.org/images/1*fPKv6yB4M3uGXb4PZyTOJQ.jpeg
tags:
- name: AWS
  slug: aws
...
seo_desc: 'By Drew Firment
  ...
  “See first with your mind, then with your eyes, and finally with your body.” — Yagyu
  Munenori


  During my journey across the flow of a large-scale enterprise cloud adoption, I
  discovered that the greatest barrier to mass migrations i...'
---

By Drew Firment

![Image](https://cdn-media-1.freecodecamp.org/images/1*fPKv6yB4M3uGXb4PZyTOJQ.jpeg)
...
[**Why learning to code Alexa Skills is the gateway to a cloud computing job**](https://medium.freecodecamp.org/why-learning-to-code-alexa-skills-is-the-gateway-to-a-cloud-computing-job-fa13c1c0c853)  
[_There are radical economic shifts underway. Society is moving from commodity-based capital toward intellectual capital…_medium.freecodecamp.org](https://medium.freecodecamp.org/why-learning-to-code-alexa-skills-is-the-gateway-to-a-cloud-computing-job-fa13c1c0c853)

The free [Intro to Alexa](https://acloud.guru/series/alexa-devs) training series is designed to help anyone learn how to design and program an Alexa skill.
...
The [AWS Whitepapers](http://aws.amazon.com/whitepapers) and [AWS FAQs](http://aws.amazon.com/faqs) offer the purple belt student an opportunity to fill in the details and solidify their knowledge before scheduling the certification exam.
...
For those seeking to expand their changing horizons, [A Cloud Guru](https://acloud.guru/courses) offers a series of courses on a variety of cloud computing services. AWS is constantly evolving their platform, with over 1,000 product release each year.
...
You can easily keep up with the latest releases by listening to a weekly five-minute episode of [AWS This Week](https://acloud.guru/series/aws-this-week).

[**Top Stories From AWS This Week**](https://acloud.guru/aws-this-week)  
[_Sign up for exclusive access to all AWS This Week videos, delivered to your inbox. It's FREE._acloud.guru](https://acloud.guru/aws-this-week)
...
At this stage of enlightenment, a cloud guru continually thirsts for new knowledge. Explore free introductions to other cloud providers including [Microsoft Azure](https://acloud.guru/learn/intro-to-azure) and [Google Cloud Platform](https://acloud.guru/learn/gcp-101) — and it’s never too late to start learning [how to code in the cloud](https://acloud.guru/learn/coding-for-cloud-101)!

A Cloud Guru also supports a [community-sourced publication](https://read.acloud.guru/) with articles from engineers and leaders in the industry. It’s another free source of cloud insights — with a lot of hands-on tutorials and fun projects.
