...
* [Installing and Importing the Polars Library](#heading-installing-and-importing-the-polars-library)
    
* [What is a Series?](#heading-what-is-a-series)
    
* [What is a DataFrame?](#heading-what-is-a-dataframe)
    
* [How to Read CSV Files with Polars](#heading-how-to-read-csv-files-with-polars)
    
* [Some other Important Functions](#heading-some-other-important-functions)
...
**Joining** datasets and **concatenating** datasets are two different concepts. While concatenating means ‘linking’ two separate datasets, [joining](https://www.freecodecamp.org/news/understanding-sql-joins/) refers to combining datasets based on a shared column (a key).  
...
Reading CSV files with Polars is extremely similar to how it works in Pandas. For this tutorial, I’ll be using the Titanic Dataset. Here’s the [link to the dataset](https://www.kaggle.com/datasets/yasserh/titanic-dataset?select=Titanic-Dataset.csv) so you can download it. In this part of the tutorial, we’ll be mainly talking about column selection (useful in feature selection) and filtering the data.
...
In the above example, we renamed the column named ‘PassengerId’ to ‘renamed\_col’.
