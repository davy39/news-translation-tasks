...
Before getting started with this guide, make sure you've read through my [previous tutorial](https://www.freecodecamp.org/news/host-a-website-on-aws-ec2-using-a-css-template) on AWS EC2. It covers the essentials of creating and configuring an EC2 instance. You'll learn how to navigate the AWS Management Console, select the right instance type, configure security groups, and more.
...
* [Step 1: Launch Your EC2 Instance](#heading-step-1-launch-your-ec2-instance)
    
* [Step 2: Wait… The Script Did Everything Already?](#heading-step-2-wait-the-script-did-everything-already)
    
* [Step 3: Access Your Website](#heading-step-3-access-your-website)
    
* [Wrapping Up](#heading-wrapping-up)
    
* [Want more?](#heading-want-more)
...
* ![user data script](https://cdn.hashnode.com/res/hashnode/image/upload/v1732640127024/ec187a49-61ac-4a98-82c1-c149bcf8ef91.png align="center")
