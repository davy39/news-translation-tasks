...
Hello everyone! In this guide, you’ll learn about the powerful [**ZenUI Library**](https://zenui.net). It’s a comprehensive, free collection of UI components and templates designed to enhance your development workflow and elevate your projects.
...
* [Why Use ZenUI](#heading-why-use-zenui)?
    
* [ZenUI Features](#heading-zenui-features)
    
* [Tailwind CSS Integration and Framework Compatibility](#heading-tailwind-css-integration-and-framework-compatibility)
    
* [How to Start Using ZenUI](#heading-how-to-start-using-zenui)
    
* [How to Customize ZenUI Components](#heading-how-to-customize-zenui-components)
    
* [How to Use ZenUI Website Templates](#heading-how-to-use-zenui-website-templates)
    
* [How to Extract Color from an Image](#heading-how-to-extract-color-from-an-image)
    
* [How to Customize Any Icon in the ZenUI Library](#heading-how-to-customize-any-icon-in-the-zenui-library)
...
You can visit their website to learn more: [https://zenui.net](https://zenui.net).
...
Head over to the [ZenUI Library website](https://zenuilibrary.com) where you can browse through a wide variety of UI components, templates, essential blocks, and SVG icons. ZenUI Library offers everything from simple buttons to more complex layouts.
...
2. **Toggle Dark Mode with JavaScript:** You can also add a button to toggle dark mode dynamically:
...
![clone-zenui-template-from-github-repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1727202543195/e1c05f17-b12f-4ab3-9b9d-23cebd948349.png align="center")
...
You can [watch this video](https://youtu.be/wPopdyqpxHQ?si=p-12ygf5LiXCLAQ7) on how to use the ZenUI Library template and how to customize it. Or you can play around with:
...
![select-image-from-device](https://cdn.hashnode.com/res/hashnode/image/upload/v1727273571064/e90f47f7-dab9-458c-a26d-c6b20ba4199f.png align="center")

Now you will see a magical tool called “**Extract Color From Uploaded Image**” like the below image:

![zenui-color-picker-modal](https://cdn.hashnode.com/res/hashnode/image/upload/v1727273665557/5faad30a-c3fc-4783-b59c-f6999b22d927.png align="center")
...
![color-picker-real-time-indecator](https://cdn.hashnode.com/res/hashnode/image/upload/v1727273940270/147b94a5-b95d-47b8-bb5e-437d0276c8a1.jpeg align="center")
...
![color-palette-generator-input](https://cdn.hashnode.com/res/hashnode/image/upload/v1727274330786/019228a2-aae8-41e3-bb69-c2fe8a68f4d5.png align="center")
...
![copy-color-code](https://cdn.hashnode.com/res/hashnode/image/upload/v1727274619884/871ad483-a3f8-4d8e-9b9e-76ac7cbd0ee5.png align="center")

## How to Customize Any Icon in the ZenUI Library

Go to the [ZenUI Library](https://zenui.net) website, and click on the icons button from the top navigation bar. This will bring you to the ZenUI icons homepage. Now choose an icon you want to use and click on it. You will see a drawer come out like in the below image:

![customize-zenui-icon](https://cdn.hashnode.com/res/hashnode/image/upload/v1727274886810/a283107e-aa84-4537-b7f8-7e866b163422.png align="center")
...
ZenUI isn’t just about freely available components. It’s also about fostering a community of developers and designers. Join the [**ZenUI community**](https://web.facebook.com/share/g/wAbkC1XFB5Ssc121/) so you can share your work, learn from fellow developers, and get early access to new components and templates.

You can contribute to ZenUI by submitting templates, reporting bugs, or suggesting features. You can find the community on platforms like [GitHub](https://github.com/Asfak00/zenui-library) and [**Facebook**](https://web.facebook.com/zenuilibrary).
...
Feel free to explore the library at [https://zenui.net](https://zenui.net), and don’t hesitate to reach out if you need help or have feedback.
