...
* [Why Freezed?](#heading-why-freezed)
    
* [Without Freezed: A Manual Example](#heading-without-freezed-a-manual-example)
    
* [With Freezed: A Cleaner Alternative](#heading-with-freezed-a-cleaner-alternative)
    
* [Defining a Freezed Class](#heading-defining-a-freezed-class)
    
    * [Explanation:](#heading-explanation-line-by-line)
        
* [Running Code Generation](#heading-running-code-generation)
    
* [Using the Freezed Class](#heading-using-the-freezed-class)
    
    * [Explanation:](#heading-explanation)
        
* [Adding JSON Serialization](#heading-adding-json-serialization)
    
    * [New parts explained:](#heading-new-parts-explained)
        
* [Using JSON Serialization](#heading-using-json-serialization)
    
    * [Explanation:](#heading-explanation-1)
        
* [Advanced Usage: Freezed Unions](#heading-advanced-usage-freezed-unions)
    
    * [Defining a Union](#heading-defining-a-union)
        
    * [Using the Union](#heading-using-the-union)
        
    * [Pattern Matching with Freezed](#heading-pattern-matching-with-freezed)
        
    * [MaybeWhen: Handling Partial States](#heading-maybewhen-handling-partial-states)
        
    * [Map: Working with State Objects Directly](#heading-map-working-with-state-objects-directly)
        
* [Why Use Unions?](#heading-why-use-unions)
...
First, install Freezed and its related packages. Add this to your **pubspec.yaml** file:
...
Create a file named `user.dart` and add the following:
...
Update `user.dart` to support JSON:
...
Create a new file called `result.dart`:
...
For advanced features and best practices, visit the official Freezed documentation on [pub.dev](https://pub.dev/packages/freezed).
