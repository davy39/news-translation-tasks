---
title: Rust Tutorial – Learn Advanced Iterators & Pattern Matching by Building a JSON
  Parser
subtitle: ''
...
1. [What are Iterators in Rust?](#heading-what-are-iterators-in-rust)
	1. [How to implement iterators in Rust](#heading-how-to-implement-iterators-in-rust)
	2. [What are peekable iterators in Rust?](#heading-what-are-peekable-iterators-in-rust)
2. [What is The Match Statement in Rust?](#heading-what-is-the-match-statement-in-rust)
	1. [How to use iterators in match statements in Rust](#heading-how-to-use-iterators-in-match-statements-in-rust)
	2. [What are match guards in Rust?](#heading-what-are-match-guards-in-rust)
	3. [What is binding in Rust?](#heading-what-is-binding-in-rust)
3. [How to Build a JSON Parser – Stage 1: Reader](#heading-how-to-build-a-json-parser-stage-1-reader)
	1. [What is the UTF-8 byte encoding?](#heading-what-is-the-utf-8-byte-encoding)
	2. [How to read the data](#heading-how-to-read-the-data)
	3. [How to implement the iterator for JsonReader](#heading-how-to-implement-the-iterator-for-jsonreader)
4. [How to Build a JSON Parser – Stage 2: Prepare Intermediate Data Types](#heading-how-to-build-a-json-parser-stage-2-prepare-intermediate-data-types)
	1. [The value type](#heading-the-value-type)
	2. [How to add helpful conversion methods](#heading-how-to-add-helpful-conversion-methods)
5. [How to Build a JSON Parser – Stage 3: Tokenization](#heading-how-to-build-a-json-parser-stage-3-tokenization)
	1. [How to define expected valid tokens](#heading-how-to-define-expected-valid-tokens)
	2. [How to implement the tokenizer struct](#heading-how-to-implement-the-tokenizer-struct)
	3. [How to tokenize an iterator of characters](#heading-how-to-tokenize-an-iterator-of-characters)
	4. [How to parse string tokens](#heading-how-to-parse-string-tokens)
	5. [How to parse number tokens](#heading-how-to-parse-number-tokens)
	6. [How to parse boolean tokens](#heading-how-to-parse-boolean-tokens)
	7. [How to parse Null Literal](#heading-how-to-parse-null-literal)
	8. [How to parse delimiters](#heading-how-to-parse-delimiters)
	9. [How to parse a terminating character](#heading-how-to-parse-a-terminating-character)
6. [How to Build a JSON Parser – Stage 4: From Tokens To Value](#heading-how-to-build-a-json-parser-stage-4-from-tokens-to-value)
	1. [How to parse primitives](#heading-how-to-parse-primitives)
	2. [How to parse arrays](#heading-how-to-parse-arrays)
	3. [How to parse objects](#heading-how-to-parse-objects)
7. [How to Use the JSON parser](#heading-how-to-use-the-json-parser)
...
Now let's write the code to run for this example. We start by copying over a sample JSON file to the root of the project, which you can find [here](https://raw.githubusercontent.com/anshulsanghi-blog/json-parser/master/test.json).
...
You can find the complete code for everything we looked at in this article in [this repository](https://github.com/anshulsanghi-blog/json-parser).
