...
* [Why Choose AWS for Frontend Hosting?](#heading-why-choose-aws-for-frontend-hosting)
    
* [AWS Services for Frontend Hosting](#heading-aws-services-for-frontend-hosting)
...
Before we explore the specific AWS services for frontend hosting, let’s first look at why developers and companies often choose AWS over more familiar platforms like [Netlify](https://www.netlify.com/) or [Vercel](https://vercel.com/).
...
To help you get started using S3 for hosting, here’s an article that explains [how to host a static website using AWS S3 and Cloudfront](https://www.freecodecamp.org/news/host-a-static-website-on-aws-s3-and-cloudfront/).
...
![Using AWS Elastic BeanStalk to create a full-stack application](https://cdn.hashnode.com/res/hashnode/image/upload/v1746279088455/a417bf0a-8cb6-4d1e-bddb-33a470e082f9.png align="center")
...
To better understand how it works, I used AWS Elastic Beanstalk to set up a CI/CD pipeline. You can read this article: [How to Create a CI/CD Using AWS Elastic BeanStalk](https://dev.to/ijay/how-to-create-a-cicd-using-aws-elastic-beanstalk-15nh).
...
![using the EC2 for running your web application](https://cdn.hashnode.com/res/hashnode/image/upload/v1746280458269/6acafa6a-70f5-4a31-807c-de3cc3c09dfa.png align="center")
...
To help you understand how it works and how to connect it to your code editor (IDE), here's an article that walks you through the process: [How to Connect Your AWS EC2 Instance to VS Code](https://www.freecodecamp.org/news/how-to-connect-your-aws-ec2-instance-to-vs-code/).
...
![using amplify for frontend or full-stack application](https://cdn.hashnode.com/res/hashnode/image/upload/v1746282073570/9392f80c-aede-400a-a8f8-207167f44545.png align="center")
...
Here is a simple guide for building with AWS Amplify. I hope it helps you understand it better: [How Can AWS Amplify Improve Your Development Process?](https://dev.to/ijay/how-can-aws-amplify-improve-your-development-process-2gj5)

And here’s an in-depth guide that walks you through [building a full-stack app with AWS Amplify and React](https://www.freecodecamp.org/news/ultimate-guide-to-aws-amplify-and-reacxt/).
...
![using AWS light sail for your application](https://cdn.hashnode.com/res/hashnode/image/upload/v1746348715984/c013a2de-b004-4c44-a5c6-23ddb9226962.png align="center")
...
For a fun, project-based tutorial, check out this guide that teaches you [how to use AWS LightSail to deploy Docker containers to the cloud](https://www.freecodecamp.org/news/how-do-deploy-docker-containers-to-the-cloud-with-aws-lightsail/).
...
![Using AWS App Runner](https://cdn.hashnode.com/res/hashnode/image/upload/v1746351485218/748d06a5-b4dd-493d-b809-e72af84d0f5c.png align="center")
...
If you want to learn more about deploying apps with AppRunner, here’s a tutorial about [deploying a Kotlin microservice to AppRunner](https://www.freecodecamp.org/news/kotlin-aws-app-runner/) that you can check out.
