...
- name: AI
  slug: ai
seo_title: The Future of AI Accessibility Tools in Education
...
* [What We’ve Achieved So Far](#heading-what-weve-achieved-so-far)
    
* [Case Study 1: Translating Makaton to English](#heading-case-study-1-translating-makaton-to-english)
    
* [Case Study 2: AURA Prototype (Adaptive Speech Assistant)](#heading-case-study-2-aura-prototype-adaptive-speech-assistant)
    
* [The Bigger Picture: Multimodal Accessibility Tools](#heading-the-bigger-picture-multimodal-accessibility-tools)
    
* [How to Build a Multimodal Makaton to English Translator (Gesture + Speech)](#heading-how-to-build-a-multimodal-makaton-to-english-translator-gesture-speech)
    
* [Project Overview](#heading-project-overview)
    
* [Challenges and Ethical Considerations](#heading-challenges-and-ethical-considerations)
    
* [Where We’re Heading Next](#heading-where-were-heading-next)
    
* [Conclusion: Building an Inclusive Future with AI](#heading-conclusion-building-an-inclusive-future-with-ai)
...
In [my first freeCodeCamp tutorial](https://www.freecodecamp.org/news/create-a-real-time-gesture-to-text-translator/), I built a gesture-to-text translator using MediaPipe. This project demonstrated how computer vision can track hand movements and convert them into text in real time. For learners who rely on gestures, this kind of system can provide a bridge to participation.
...
👉 You can explore the full project on [GitHub](https://github.com/tayo4christ/Gesture_Article) or read the complete tutorial on [freeCodeCamp](https://www.freecodecamp.org/news/create-a-real-time-gesture-to-text-translator/).

In another [freeCodeCamp article](https://www.freecodecamp.org/news/build-ai-accessibility-tools-with-python/), I demonstrated how to build AI accessibility tools with Python, such as speech recognition and text-to-speech. These projects provided readers with a foundation for building their own inclusive tools, and you can find the full source code in the [repository.](https://github.com/tayo4christ/inclusive-ai-toolkit)
...
![Single vs Multimodal Systems](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/main/single-vs-multimodal.png?raw=true align="left")
...
![Makaton Workflow](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/main/makaton-workflow.png?raw=true align="left")
...
Another project I worked on is called [**AURA**](https://aura-apraxia-aac-a8qejouwasaqequrhetbfw.streamlit.app/), the *Apraxia of Speech Adaptive Understanding and Relearning Assistant*. The idea was to design a system that not only recognises speech but also supports learners with speech disorders by detecting errors, adapting feedback, and offering multimodal alternatives.
...
![AURA Workflow](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/main/aura-workflow.png?raw=true align="left")
...
![Multimodal Applications](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/main/multimodal-applications.png?raw=true align="left")
...
* `tests/`: This directory is for test scripts. The `test_`[`fuse.py`](http://fuse.py) file likely contains tests for the fusion function, which is a part of the multimodal translation process.
    
* `streamlit_`[`app.py`](http://app.py): This is the main application file where the Streamlit app is implemented. It contains the code that runs the app, handling the user interface and the logic for translating Makaton gestures and speech into English.
...
![Streamlit app ‘Makaton to English (Multimodal Demo)’ showing the Simulated Sign tab with ‘Pick a sign’, ‘Transcribe 3s’, and ‘Output: No input detected’.](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/8117234b9dc032aa0f4ff32abad92e7ad3344b81/ui-home-simulated-tab.jpg?raw=1 align="left")

*Figure — App interface: the Simulated Sign tab before any input.*

![Simulated sign ‘hello_sign’ selected in the Streamlit app; Output shows “Hello”.](https://github.com/tayo4christ/ai-accessibility-articles-assets/blob/8117234b9dc032aa0f4ff32abad92e7ad3344b81/ui-simulated-hello-output.jpg?raw=1 align="left")
...
The link to the full code: [Multimodal\_Makaton](https://github.com/tayo4christ/makaton-multimodal-demo/tree/main/makaton_multimodal_demo)
