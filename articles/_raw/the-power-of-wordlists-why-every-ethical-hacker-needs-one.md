...
You can combine this wordlist with a brute-force tool like [Hydra](https://www.stealthsecurity.sh/p/hacking-hydra-practical-tutorial) to perform an attack. The tool goes through the wordlist, testing each password against the login form. After a while, you hit a match. You’ve just cracked the login.
...
One of the most famous password wordlists in the hacking community is Rockyou.txt. It has 14 million passwords collected after the site [Rockyou.com](http://Rockyou.com) was breached by hackers. [Here is the full wordlist](https://github.com/praetorian-inc/Hob0Rules/blob/master/wordlists/rockyou.txt.gz).
...
[Here is a sample directory wordlist](https://github.com/danielmiessler/SecLists/blob/master/Discovery/Web-Content/directory-list-1.0.txt).
...
For example, a product at [product.com](http://product.com) can contain a development server at [dev.product.com](http://dev.product.com). Or an admin panel at [admin.product.com](http://admin.product.com). These subdomains might not be well protected like the main website.

Tools like **Sublist3r** and **Amass** are popular for this task. [Here is a subdomain wordlist](https://github.com/danielmiessler/SecLists/blob/master/Discovery/DNS/subdomains-top1million-5000.txt) for these types of attacks.
...
**Hope this tutorial helped you understand how to use wordlists. For more articles on Cybersecurity, join our free newsletter** [**Stealth Security**](https://www.stealthsecurity.sh/)**. To learn hacking using hands-on labs, check out our private community** [**The Hacker’s Hub**](https://www.skool.com/hackershub)**.**
