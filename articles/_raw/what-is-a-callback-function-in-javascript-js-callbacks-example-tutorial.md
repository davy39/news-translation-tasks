---
title: What is a Callback Function in JavaScript? JS Callbacks Example Tutorial
subtitle: ''
...
If you don't like regular expressions, you can read [below](#heading-and-if-we-didnt-use-a-regular-expression) how to do the same checks without using a regular expression.
