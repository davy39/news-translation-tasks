...
1. [Why Automate Alert Provisioning?](#heading-why-automate-alert-provisioning)
    
2. [What are SigNoz and Terraform?](#heading-what-are-signoz-and-terraform)
    
3. [Overview of the Setup](#heading-overview-of-the-setup)
    
4. [Prerequisites](#heading-prerequisites)
    
5. [Steps to Set Up the Project](#heading-steps-to-setup-the-project)
    
6. [Best Practices and Security Considerations](#heading-best-practices-and-security-considerations)
    
7. [Integrating with CI/CD Pipelines](#integrating-with-cicd-pipelines)
    
8. [Advanced Customizations and Troubleshooting](#heading-advanced-customizations-and-troubleshooting)
...
If you plan to send alerts to specific channels, define them using `signoz_notification_channel`. For example, create a [`channels.tf`](http://channels.tf) file:
...
Create an [`alerts.tf`](http://alerts.tf) file to define your alert:
...
* Update the target in [`alerts.tf`](http://alerts.tf):
...
For instance, storing your SigNoz API token as an environment variable (TF\_VAR\_signoz\_api\_token) not only mitigates the risk of credential exposure but also simplifies the process of credential rotation. Also, enforce access control policies around your configuration repositories and CI/CD pipelines to further secure these secrets.
...
I hope you’ve enjoyed this tutorial and have learned something new. I’m always open to suggestions and discussions on [LinkedIn](https://www.linkedin.com/in/gursimarsm). Hit me up with direct messages.

If you’ve enjoyed my writing and want to keep me motivated, consider leaving starts on [GitHub](https://github.com/gursimarsm) and endorsing me for relevant skills on [LinkedIn](https://www.linkedin.com/in/gursimarsm).
