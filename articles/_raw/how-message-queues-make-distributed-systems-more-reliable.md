...
1. [Reliability in Distributed Systems](#heading-what-does-reliability-mean-in-the-context-of-distributed-systems)
    
2. [What Makes Software Reliable?](#heading-what-makes-software-reliable)
    
3. [What is a Message Queue?](#heading-what-is-a-message-queue)
    
4. [How Message Queues Help Make Distributed Systems More Reliable](#heading-how-message-queues-help-make-distributed-systems-more-reliable)
    
5. [Challenges with Message Queues](#heading-challenges-with-message-queues)
...
![Multiple producers adding messages to a message queue that in turn are consumed by a consumer.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701696280571/8697cb07-c765-4f9e-b709-a7a03adf3e11.png?auto=compress,format&format=webp align="center")
...
The below example uses [Boto3](http://boto3.amazonaws.com) which is a Python Client for AWS SQS.
...
2. Designing systems with queues that have multiple consumers isn’t trivial. What happens if a message is processed twice? Is [**idempotency**](https://en.wikipedia.org/wiki/Idempotence) a requirement? Or does it break our use case? These complexities can often lead us to situations where message queues may not be the best solution.
