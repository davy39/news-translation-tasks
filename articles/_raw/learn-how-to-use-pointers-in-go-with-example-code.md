...
* [What is a Pointer?](#heading-what-is-a-pointer)
    
    * [Understanding Memory](#heading-understanding-memory)
        
    * [Stack vs Heap](#heading-stack-vs-heap)
        
    * [The Pointer](#heading-the-pointer)
        
* [Declaring and Using Pointers](#heading-declaring-and-using-pointers)
    
    * [Pointers to Basic Types](#heading-pointers-to-basic-types)
        
    * [Getting an Address with &](#heading-getting-an-address-with-amp)
        
    * [Pointers to Structs](#heading-pointers-to-structs)
        
    * [Pointers to Other User Types](#heading-pointers-to-other-user-types)
        
* [Why Use Pointers?](#heading-why-use-pointers)
    
    * [Avoiding Copies](#heading-avoiding-copies)
        
    * [Sharing and Mutating State](#heading-sharing-and-mutating-state)
        
    * [Method Receivers](#heading-method-receivers)
        
    * [Interfacing with Low-Level APIs](#heading-interfacing-with-low-level-apis)
        
* [Common Pitfalls and Misunderstandings](#heading-common-pitfalls-and-misunderstandings)
    
    * [Nil Pointers](#heading-nil-pointers)
        
    * [Reference Types](#heading-reference-types)
        
* [Pointer Receivers](#heading-pointer-receivers)
    
    * [Value Receivers vs Pointer Receivers](#heading-value-receivers-vs-pointer-receivers)
        
    * [Idiomatic Go](#heading-idiomatic-go)
        
* [Exercises for the Reader](#heading-exercises-for-the-reader)
    
* [Bonus: Weak Pointers (Go 1.24+)](#heading-bonus-weak-pointers-go-124)
    
    * [What Are Weak Pointers?](#heading-what-are-weak-pointers)
        
    * [When to Use Weak Pointers?](#heading-when-to-use-weak-pointers)
        
* [Summary & Best Practices](#heading-summary-amp-best-practices)
    
* [Solutions to Exercises](#heading-solutions-to-exercises)
...
![Memory Layout](https://i.ibb.co/B2jZ3Smc/memory.png align="left")
...
![Pointer Example](https://i.ibb.co/4ZGzs3Rz/pointer.png align="left")
...
![Value vs Pointer](https://i.ibb.co/tPXSr9FN/counter.png align="left")
