---
title: API Integration Patterns – The Difference between REST, RPC, GraphQL, Polling,
...
REST APIs use a [stateless](https://lightcloud.substack.com/i/104443280/stateless-architecture), client-server communication model, wherein each message contains all the information necessary to understand and process the message.
...
Some of these integration patterns are also [asynchronous](https://lightcloud.substack.com/p/synchronous-and-asynchronous-communication) and initiated by the server, unlike the request-response patterns which are [synchronous](https://lightcloud.substack.com/p/synchronous-and-asynchronous-communication) and initiated by the client.
...
Standard polling on the other hand can remain [stateless](https://lightcloud.substack.com/i/104443280/stateless-architecture), making it more [fault tolerant](https://lightcloud.substack.com/i/59017006/fault-tolerance) and scalable.
