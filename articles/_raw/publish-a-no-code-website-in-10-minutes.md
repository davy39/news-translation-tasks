---
title: How to Publish a no-code website in 10 minutes
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
First, select a Hugo theme. There are [many](https://themes.gohugo.io/). Some are geared toward web sites with one or more content web pages, while others are optimized for blog-like sites with timestamped posts.
