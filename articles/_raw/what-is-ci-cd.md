---
title: What is CI/CD? Learn Continuous Integration/Continuous Deployment by Building
  a Project
subtitle: ''
author: German Cocca
co_authors: []
...
* [How CI/CD works](#heading-how-cicd-works)
    
* [The key benefits of CI/CD](#heading-the-key-benefits-of-cicd)
    
* [Tools for CI/CD](#heading-tools-for-cicd)
    
* [How to set up a CI/CD pipeline with GitHub Actions](#heading-how-to-set-up-a-cicd-pipeline-with-github-actions)
    
    * [Initializing the project](#heading-initializing-the-project)
        
    * [What are GitHub Actions and how do they work?](#heading-what-are-github-actions-and-how-do-they-work)
        
    * [Setting up our workflow](#heading-setting-up-our-workflow)
        
    * [The magic](#heading-the-magic)
...
The first step in the CI/CD pipeline is code integration. In this step, developers commit their code changes to a remote repository (like [GitHub](https://github.com/), [GitLab](https://about.gitlab.com/) or [BitBucket](https://bitbucket.org/product/)), where the code is integrated with the main codebase.
...
If you're not familiar with the topic of testing, you can refer [to this article I wrote a while ago](https://www.freecodecamp.org/news/test-a-react-app-with-jest-testing-library-and-cypress/).
...
[Jenkins](https://www.jenkins.io/) is an open-source automation server that is widely used in CI/CD pipelines. It is highly customizable and supports a wide range of plugins, making it suitable for various development environments. Some of its key features include:
...
If you want to learn more about Jenkins, [here's a full course for you](https://www.freecodecamp.org/news/learn-jenkins-by-building-a-ci-cd-pipeline/).

### Travis CI

[Travis CI](https://www.travis-ci.com/) is a cloud-based CI/CD platform that provides automated testing and deployment for software projects. It supports several programming languages and frameworks, making it suitable for various development environments. Some of its key features include:
...
Here's a helpful tutorial about [how to automate deployment on GitHub Pages with Travis CI](https://www.freecodecamp.org/news/learn-how-to-automate-deployment-on-github-pages-with-travis-ci/).

### GitHub actions

[GitHub Actions](https://github.com/features/actions) is a powerful CI/CD tool that allows developers to automate workflows, run tests, and deploy code directly from their GitHub repositories.
...
Popular hosts such as [Vercel](https://vercel.com/) or [Netlify](https://www.netlify.com/) have built-in in CI/CD features that allow you to link an online repository to a given site, and deploy to that site after a given event occurs in that repo.
...
Here's a tutorial about [how to deploy a front-end app with Netlify](https://www.freecodecamp.org/news/how-to-deploy-your-front-end-app/). And in this tutorial, you'll [learn how to use Vercel to deploy a Next.js app](https://www.freecodecamp.org/news/how-to-build-a-jamstack-site-with-next-js-and-vercel-jamstack-handbook/).

# How to Set Up a CI/CD Pipeline with GitHub Actions

Cool, so now that we have a clear idea of what CI/CD is, let's see how we can implement a simple example with an actual project using [GitHub actions](https://github.com/features/actions).

## Initializing the Project

We'll start with a very basic React app built with [Vite](https://www.freecodecamp.org/news/how-to-build-a-react-app-different-ways/#what-is-vite). You can do that by running `yarn create vite` in your console.
...
The way GitHub reads and executes these workflows is by automatically reading files within the `.github/workflows` directory in the root of our project. These workflow files should have the `.yaml` extension and use the [YAML](https://www.redhat.com/en/topics/automation/what-is-yaml) syntax.
...
Before we can push this code and see how the magic works, we first need to create a site on Netlify and get the **NETLIFY\_AUTH\_TOKEN** and **NETLIFY\_SITE\_ID**. This is quite straight forward even if you don't have previous experience with Netlify, so give it a try and Google a bit if you can't figure it out. ;)
