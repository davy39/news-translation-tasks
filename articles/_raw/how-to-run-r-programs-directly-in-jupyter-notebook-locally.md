...
* [Install Conda](#heading-install-conda)
    
* [Create a New Environment](#heading-create-a-new-environment)
    
* [Activate Your Conda Environment](#heading-activate-your-conda-environment)
    
* [Install ipykernel and jupyter](#heading-install-ipykernel-and-jupyter)
    
* [Install R in the Conda Environment](#heading-install-r-in-the-conda-environment)
    
* [Open the Jupyter Notebook](#heading-open-the-jupyter-notebook)
    
* [Run R in Jupyter Notebook](#heading-run-r-in-jupyter-notebook)
...
![activate conda env](https://cdn.hashnode.com/res/hashnode/image/upload/v1727898007890/f8bf9ced-6c9e-4198-9116-63a32e7d0f03.png align="center")
...
![Open Jupyter Notebook](https://cdn.hashnode.com/res/hashnode/image/upload/v1727898291254/b932284e-05af-4eec-a6aa-f6b9ad50dd1c.png align="center")
...
![R in notebook](https://cdn.hashnode.com/res/hashnode/image/upload/v1727898368089/a2d22b41-8ddd-480b-aaa4-65aeafb12f69.png align="center")

Now, you can use the R language directly in your Jupyter Notebook!

![Run "R" in Jupyter Notebook](https://cdn.hashnode.com/res/hashnode/image/upload/v1727898457072/05015331-742c-49c5-9325-b1d1cb1fc6cd.png align="center")
