---
title: Remember the $86 million license plate scanner I replicated? I caught someone
  with it.
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_What a front facing ALPR camera sees — not much._
...
_A four camera array would need to be angled similar to this. Icons from [Freepik](http://www.freepik.com/" rel="noopener" target="_blank" title=")._
...
_Any production-ready version of a vehicle-mounted ALPR needs some form of stabilisation. Not a hand._
...
_Rolling shutter issues on a Contour HD @ 60km/h._
...
_Slimline Australian plates need their own separate country detection to regular Australian plates?_
...
_The planar warp tool provided with Open ALPR_
