...
In a previous article, I gave a [brief introduction to React](https://www.freecodecamp.org/news/a-brief-introduction-to-react/). This tutorial introduces an alternative approach to building a component-based frontend. It covers the fundamentals of [Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) to build modular, reusable elements for your web applications.
...
This book is available for free on [Playback Press](https://playbackpress.com/books/). The book is a hands-on guide to modern web development, covering everything from core JavaScript features to building full-stack apps with various tools and technologies.
...
After this introduction, you might want to explore the official Web Components resources: [MDN Web Components Guide](https://developer.mozilla.org/en-US/docs/Web/API/Web_components).

## **Table of Contents**

* [Web Components Part 1: Your First Custom Element](#heading-web-components-part-1-your-first-custom-element)
    
* [Web Components Part 2: Data Communication](#heading-web-components-part-2-data-communication)
    
* [Web Components Part 3: Custom Events](#heading-web-components-part-3-custom-events)
    
* [Web Components Part 4: Building a Complete App](#heading-web-components-part-4-building-a-complete-app)
    
* [React vs Web Components Comparison](#heading-react-vs-web-components-comparison)
...
**View the playback here:** [**Web Components Part 1- LegendHeader**](https://playbackpress.com/books/webdevbook/chapter/3/8)
...
**View the playback here:** [**Web Components Part 2- LegendTable**](https://playbackpress.com/books/webdevbook/chapter/3/9)
...
**View the playback here:** [**Web Components Part 3- NewLegendForm**](https://playbackpress.com/books/webdevbook/chapter/3/10)
...
**View the playback here:** [**Web Components Part 4- AuthBox**](https://playbackpress.com/books/webdevbook/chapter/3/11)
