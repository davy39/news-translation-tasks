...
2. [Project Setup with ExpressJS](#heading-project-setup-with-expressjs)
    ...
    * [1\. Create a New Project Folder](#heading-1-create-a-new-project-folder)
        
    * [2\. Initialize a Node.js Project](#heading-2-initialize-a-nodejs-project)
        
    * [3\. Install Express.js](#heading-3-install-expressjs)
        
    * [4\. Optional: Install Nodemon for Development](#heading-4-optional-install-nodemon-for-development)
        
    * [5\. Create the Main Server File](#heading-5-create-the-main-server-file)
        
    * [6\. Run the Project](#heading-6-run-the-project)
        
3. [Understanding the Problem](#heading-understanding-the-problem)
    
    * [Observing the Behavior](#heading-observing-the-behavior)
        
    * [Why Does This Happen?](#heading-why-does-this-happen)
        
4. [Understanding JavaScript Execution](#heading-understanding-javascript-execution)
    
    * [How Libuv Works](#heading-how-libuv-works)
        
    * [Asynchronous Nature of Node.js](#heading-asynchronous-nature-of-nodejs)
...
6. [How to Implement Worker Threads](#heading-how-to-implement-worker-threads)
    ...
    * [Communication Between Threads](#heading-communication-between-threads)
        
    * [Setting Up Worker Communication](#heading-setting-up-worker-communication)
        
7. [How to Optimize with Multiple Cores](#heading-how-to-optimize-with-multiple-cores)
    
    * [Checking How Many Cores Your System Has](#heading-checking-how-many-cores-your-system-has)
        
    * [Utilizing Multiple Cores for Faster Execution](#heading-utilizing-multiple-cores-for-faster-execution)
        
8. [How to Implement Multi-Core Optimization](#heading-how-to-implement-multi-core-optimization)
    
    * [Understanding the Code Line by Line](#heading-understanding-the-code-line-by-line)
        
    * [Thread Planning and Configuration](#heading-thread-planning-and-configuration)
        
    * [Dividing Work Across Multiple Workers](#heading-dividing-work-across-multiple-workers)
        
    * [Handling Complex Tasks](#heading-handling-complex-tasks)
        
9. [Performance Comparison](#heading-performance-comparison)
    
    * [Testing Results](#heading-testing-results)
...
10. [Summary](#heading-summary)
    ...
    * [The Multi-Core Challenge](#heading-the-multi-core-challenge)
        
    * [Discovering Available Cores](#heading-discovering-available-cores)
        
    * [Asynchronous Worker Creation](#heading-asynchronous-worker-creation)
        
    * [Multi-Threaded Implementation Strategy](#heading-multi-threaded-implementation-strategy)
        
    * [Key Concepts Recap](#heading-key-concepts-recap)
        
    * [What We Learned](#heading-what-we-learned)
        
11. [Final Words](#heading-final-words)
    
12. [Additional Resources](#heading-additional-resources)
...
In this section, we will go through a detailed, beginner-friendly setup for a Node.js project using [Express](https://expressjs.com/). This guide explains every step, so even if you are new to Node.js, you can follow along easily.
...
* [`http://localhost:3000/non-blocking`](http://localhost:3000/non-blocking) displays a simple non-blocking message.
    
* [`http://localhost:3000/blocking`](http://localhost:3000/blocking) executes a CPU-intensive task using Worker Threads.
...
If you open your browser and visit the [`http://localhost:3000/non-blocking`](http://localhost:3000/non-blocking) URL, it works perfectly fine and responds immediately.

![Non-blocking Browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079165626/6d6a3c24-8095-4243-83db-8a44865e5af9.png align="center")

But if you visit the [`http://localhost:3000/blocking`](http://localhost:3000/blocking) URL, the page keeps loading and doesn’t respond right away.

What's even more interesting is that if you try to access [`http://localhost:3000/non-blocking`](http://localhost:3000/non-blocking) **while** `/blocking` is still running, it also becomes unresponsive.
...
![Blocking Browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079338040/ecaf458e-d91a-4752-863e-71ac34081949.gif align="center")
...
![Single Threaded Programming](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079437967/3330b62c-54c2-41a9-bccc-8f962e71287c.gif align="center")
...
![Weak JS](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079547228/0799f826-3715-4664-b94b-e8f2e80afd04.gif align="center")
...
![Understanding JavaScript Execution](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079628895/02bc21f7-1d49-4952-9c17-3f57cbbe3488.gif align="center")
...
![How libuv works](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079720366/9f01e68c-ad5f-491a-9e68-d91a4ec5f3fb.gif align="center")
...
![Asynchronous Nature of Node.js](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079806477/dd7b58e2-48ab-4994-ad09-41fad2f0b78b.gif align="center")
...
![CPU Intensive Problem](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079890972/98686661-0c5f-493e-a0b4-25c744c60938.gif align="center")
...
![Communication between threads](https://cdn.hashnode.com/res/hashnode/image/upload/v1761079966779/34f22f5e-9334-4e89-b54f-71de3de90923.gif align="center")
...
* We import parentPort from worker\_threads.
...
![Setting up worker communication](https://cdn.hashnode.com/res/hashnode/image/upload/v1761080061445/f1f213c7-6cce-4334-81e5-8cd828682f8e.gif align="center")
...
![IO Operations](https://cdn.hashnode.com/res/hashnode/image/upload/v1761080131679/148cc279-e4f0-4f68-b2a9-34110abcbc90.gif align="center")
...
![Final index](https://cdn.hashnode.com/res/hashnode/image/upload/v1761080243361/dddd924c-9138-4790-ac6c-811b39772c6c.gif align="center")
...
![Final Index](https://cdn.hashnode.com/res/hashnode/image/upload/v1761164273474/02892dd3-3524-4e7e-83fa-ac279910d759.gif align="center")

Running the `index-optimized.js` file and hitting the same route takes considerably less time – around 3 seconds.

![Final Optimized](https://cdn.hashnode.com/res/hashnode/image/upload/v1761164303764/4ba27180-49f7-4485-a1a5-73f2f419ab9b.gif align="center")

Stopping it and running `index.js` again clearly shows the original implementation is slower.

![Final unoptimized](https://cdn.hashnode.com/res/hashnode/image/upload/v1761164358090/4c3b9056-b936-4341-9302-461c290ea70e.gif align="center")
...
If you found the information here valuable, feel free to share it with others who might benefit from it. I’d really appreciate your thoughts – mention me on X [@sumit\_analyzen](https://x.com/sumit_analyzen) or on Facebook [@sumit.analyzen](https://facebook.com/sumit.analyzen), [watch my coding tutorials](https://youtube.com/@logicBaseLabs), [visit my website](https://sumitsaha.me) or simply [connect with me](https://www.linkedin.com/in/sumitanalyzen/) on LinkedIn.

## Additional Resources

You can also check the [Node.js Worker Threads documentation](https://nodejs.org/api/worker_threads.html) for more in-depth learning. You can find all the source code from this tutorial in [this GitHub repository](https://github.com/logicbaselabs/node-worker-threads/). If it helped you in any way, consider giving it a star to show your support!
