...
[**_A JavaScript library for building user interfaces_ - React**](https://facebook.github.io/react/)  
...
[_Build cross platform desktop apps with JavaScript, HTML, and CSS._electron.atom.io](http://electron.atom.io/)
...
Update: Windows users will need to do the following: (thanks to [@bfarmilo](http://twitter.com/bfarmilo))
