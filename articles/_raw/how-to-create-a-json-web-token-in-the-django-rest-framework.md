...
1. [What is a JWT?](#heading-what-is-a-jwt)
    
2. [Why Use JWT in the Django Rest Framework?](#heading-why-use-jwt-in-the-django-rest-framework)
    
3. [How to Set Up JWT in the Django Rest Framework](#heading-how-to-set-up-jwt-in-the-django-rest-framework)
    
4. [How to Use These Tokens](#heading-how-to-use-these-tokens)
    
5. [FAQs](#heading-faqs)
    
6. [Best Practices](#heading-best-practices)
    
7. [Final Thoughts](#heading-final-thoughts)
...
You’ll need a library to handle JWTs. The most popular one is [djangorestframework-simplejwt](https://github.com/jazzband/djangorestframework-simplejwt).
...
In your [`urls.py`](http://urls.py) (usually in the root project or `api` app):
...
| [`urls.py`](http://urls.py) config | Connects your custom token view to the login endpoint |
...
* [SimpleJWT Documentation](https://django-rest-framework-simplejwt.readthedocs.io/en/latest/)
    
* [Official DRF Docs](https://www.django-rest-framework.org/)
    
* [JWT.io](https://jwt.io/) – great for debugging and learning how JWTS work.
    
* [OWASP Cheat Sheet on JWT](https://cheatsheetseries.owasp.org/cheatsheets/JSON_Web_Token_for_Java_Cheat_Sheet.html)
