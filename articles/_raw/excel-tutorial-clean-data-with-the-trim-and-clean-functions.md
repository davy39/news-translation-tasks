---
title: Excel Tutorial – How to Clean Data with the TRIM() and CLEAN() Functions
subtitle: ''
author: Eamonn Cottrell
co_authors: []
series: null
date: '2023-01-20T17:42:49.000Z'
originalURL: https://freecodecamp.org/news/excel-tutorial-clean-data-with-the-trim-and-clean-functions
coverImage: https://www.freecodecamp.org/news/content/images/2023/01/clean-and-trim-fcc.jpg
tags:
- name: data
  slug: data
- name: excel
...
- name: spreadsheets
  slug: spreadsheets
seo_title: null
seo_desc: 'Without clean data, your spreadsheet is knocking on death''s door. In this
  tutorial I will show you two fast ways to clean up the data in your Excel or Google
  Sheets spreadsheet.

  When dealing with data sets, especially large ones and/or those that you...'
---
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/clean-desk.gif)
_a man flipping his messy desk and it becoming magically organized_

_pssst_: I have a video walkthrough at the bottom 👇 of the article too 😉
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/char-1.png)
_screenshot of ascii table in Excel_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/a-mess.gif)
_a woman waving hands and saying, "this is a mess"_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/confusion.gif)
_Obi Wan visibly confused_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/image-153.png)
_Zelda recipe table_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/image-154.png)
_Table of Recipe ingredients copied straight off website_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/import.png)
_screenshot of data import from web in Excel_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/recipe-table-1.png)
_Excel data import navigator window screenshot_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/expand-values.png)
_Screenshot of Excel Power Query menu_

![Image](https://www.freecodecamp.org/news/content/images/2023/01/delimiter.png)
_Screenshot of delimiter for expanded values_

![Image](https://www.freecodecamp.org/news/content/images/2023/01/extracted.png)
_Screenshot of Expanded list values in Ingredient column_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/sheets-trim.png)
_Imported data from webpage in Google Sheets_

By using `=CLEAN()` on the ingredients cells, we can get rid of some non-printable carriage returns causing the line breaks.

![Image](https://www.freecodecamp.org/news/content/images/2023/01/justclean.png)
_Table after Cleaning cells_

By using `=TRIM()` on the cells, we can get rid of all the leading spaces.

![Image](https://www.freecodecamp.org/news/content/images/2023/01/justtrim.png)
_Table after Trimming white spaces_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/both.png)
_Table after cleaning and trimming at once_
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/image-155.png)
