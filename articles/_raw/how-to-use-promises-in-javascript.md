---
title: Asynchronous JavaScript – How to Use Promises in Your JS Code
subtitle: ''
author: Joan Ayebola
co_authors: []
series: null
...
1. [What is asynchronous JavaScript?](#heading-what-is-asynchronous-javascript)
2. [The need for promises](#heading-the-need-for-promises)
3. [What is callback hell?](#heading-what-is-callback-hell)
4. [How to create a promise](#heading-how-to-create-a-promise)
5. [How to consume promises with `.then()` and `.catch()`](#heading-how-to-consume-promises-with-then-and-catch)
6. [How to chain promises with `.then()`](#heading-how-to-chain-promises-with-then)
7. [More complex examples of promise chaining](#heading-more-complex-examples-of-promise-chaining)
8. [How to handle errors with `.catch()`](#heading-how-to-handle-errors-with-catch)
9. [Error handling in more detail](#heading-error-handling-in-more-detail)
10. [Async/await in JavaScript](#heading-asyncawait-in-javascript)
11. [Alternative asynchronous programming methods](#heading-alternative-asynchronous-programming-methods)
