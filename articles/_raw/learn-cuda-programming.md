...
co_authors: []
series: null
date: '2024-09-24T15:08:44.736Z'
originalURL: https://freecodecamp.org/news/learn-cuda-programming
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1727270335728/ef2e9de3-14e5-4762-93a4-e07efb9e01ce.jpeg
tags:
- name: cuda
  slug: cuda
- name: youtube
  slug: youtube
seo_title: null
seo_desc: CUDA (Compute Unified Device Architecture) is a parallel computing platform
  and application programming interface (API) model created by NVIDIA. It allows developers
...
Watch the full course on [the freeCodeCamp.org YouTube channel](https://www.youtube.com/watch?v=86FAWCzIe_4) (12-hour watch).
