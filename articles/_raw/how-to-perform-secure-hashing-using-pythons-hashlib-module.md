...
This makes hashing perfect for storing passwords, verifying file integrity, and creating unique identifiers. In this tutorial, you'll learn how to use [Python's built-in `hashlib` module](https://docs.python.org/3/library/hashlib.html) to implement secure hashing in your applications.
...
[You can find the code on GitHub](https://github.com/balapriyac/python-basics/tree/main/secure-hashing).
...
No external libraries are required, as [hashlib](https://docs.python.org/3/library/hashlib.html) and [os](https://docs.python.org/3/library/os.html) are both part of Python's standard library.

## Table of Contents

1. [Basic Hashing with Python's hashlib](#heading-basic-hashing-with-pythons-hashlib)
    
2. [Why Simple Hashing Isn't Enough for Passwords](#heading-why-simple-hashing-isnt-enough-for-passwords)
    
3. [Adding Salt to Your Hashes](#heading-adding-salt-to-your-hashes)
    
4. [Verifying Salted Passwords](#heading-verifying-salted-passwords)
    
5. [Using Key Derivation Functions](#heading-using-key-derivation-functions)
    

## Basic Hashing with Python’s hashlib

Let's start with the fundamentals. The hashlib module provides access to several hashing algorithms like [MD5](https://www.md5hashgenerator.com/), [SHA-1](https://en.wikipedia.org/wiki/SHA-1), [SHA-256](https://emn178.github.io/online-tools/sha256.html), and more.
...
This property is called the [avalanche effect](https://en.wikipedia.org/wiki/Avalanche_effect) where a tiny change creates a completely different output.

## Why Simple Hashing Isn't Enough for Passwords

You might think you can just hash passwords and store them in your database. But there's a problem: attackers use [rainbow tables](https://en.wikipedia.org/wiki/Rainbow_table), which are precomputed databases of hashes for common passwords.
...
While salted SHA-256 is better than plain hashing, modern applications should use key derivation functions (KDFs) specifically designed for password hashing. These include [PBKDF2](https://www.npmjs.com/package/pbkdf2) (Password-Based Key Derivation Function 2), [bcrypt](https://bcrypt-generator.com/), [scrypt](https://en.wikipedia.org/wiki/Scrypt), and [Argon2](https://en.wikipedia.org/wiki/Argon2). You can check the links to learn more about these key derivation functions.
