...
The open-closed principle can be confusing because it's a two-direction principle. According to [Bertrand Meyer's](https://en.wikipedia.org/wiki/Bertrand_Meyer) definition on [Wikipedia](https://en.wikipedia.org/wiki/Open%E2%80%93closed_principle), the **open-closed principle (OCP)** states that software entities (classes, modules, functions, etc.) should be open for extension, but closed for modification.
...
In 1987, the Liskov Substitution Principle (LSP) was introduced by [Barbara Liskov](https://en.wikipedia.org/wiki/Barbara_Liskov) in her conference keynote “Data abstraction”. A few years later, she defined the principle like this:
...
For more understanding, you can watch [this video](https://www.youtube.com/watch?v=XzdhzyAukMM) by [Beau Carnes](https://www.freecodecamp.org/news/author/beau/) on the [freeCodeCamp YouTube channel](https://www.youtube.com/c/Freecodecamp) or read [this article](https://www.freecodecamp.org/news/solid-principles-explained-in-plain-english/) by [Yiğit Kemal Erinç](https://www.freecodecamp.org/news/author/erinc/).
