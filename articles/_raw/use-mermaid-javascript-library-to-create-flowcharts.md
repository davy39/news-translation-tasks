...
* [What is Mermaid?](#heading-what-is-mermaid)
    
* [Getting Started with Mermaid](#heading-getting-started-with-mermaid)
    
* [How to Start Your Flowchart in Mermaid](#heading-how-to-start-your-flowchart-in-mermaid)
    
* [Nodes and Shapes in Mermaid](#heading-nodes-and-shapes-in-mermaid)
    
* [How to Add Styling with Mermaid](#heading-how-to-add-styling-with-mermaid)
...
[**Mermaid**](https://mermaid.js.org/) is a JavaScript library that *translates written declarations of entities and relationships into diagrams*. It’s like coding a diagram. The instructions are also Markdown-compliant.

Mermaid is not the only tool of this kind. There are other ones, like [PlantUML](https://plantuml.com/), that have been around longer. But scripting with Mermaid has a very gentle learning curve, and it distinguishes itself from similar tools in many ways:

* As opposed to other tools like PlantUML, Mermaid is *made for the web*. It is Node-compatible, and the diagrams show as modified SVGs with inserted “[foreign objects](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/foreignObject)”. These are more compliant with HTML and CSS frameworks.
...
* It also has a strong support, is actively maintained, and makes use of well-known, robust JS graphics libraries like [d3.js](https://d3js.org/), [cytospace.js](https://cytoscape.org/what_is_cytoscape.html), and [dagre-d3](https://github.com/dagrejs/dagre-d3).
...
Finally, if you need more guidance on creating flowcharts in general, [I’ve created a separate post](https://www.freecodecamp.org/news/how-to-make-flowcharts-with-mermaid) that walks you through the process step-by-step. While the examples in that post use Mermaid, its use is entirely optional.
...
If you're using GitHub, Mermaid is supported in GitHub markdown. Additionally, [Zaira Hira has written a helpful guide](https://www.freecodecamp.org/news/diagrams-as-code-with-mermaid-github-and-vs-code/) for Visual Studio Code users. Check your IDE for available plugins and extensions.
...
* [Mermaid Chart](https://www.mermaidchart.com/) is a cloud-based project manager designed for collaboration and sharing. It offers features like templates, version history, and presentation capabilities, making it ideal for project management.
    
* [Mermaid Live](https://mermaid.live/) is best for quick, one-off diagrams. You can see a view of Mermaid Live on my computer in the image below. You can select a diagram from sample options, modify its code in the editor under the **“&lt;/&gt; Code”** tab, or paste your own script. Changes instantly appear in the Diagram window, and diagrams can be exported as PNG or SVG from the **Actions** menu.
    

![Screen shot of Mermaid Live Editor](https://cdn.hashnode.com/res/hashnode/image/upload/v1733822730335/3b353b4c-19d4-44f0-b779-bbc89c68c4a6.png align="center")

While Live is convenient, it’s not a reliable way to track your scripts, so save your work externally. There are other online editors similar to Mermaid Live, and [Zaira Hira’s article](https://www.freecodecamp.org/news/diagrams-as-code-with-mermaid-github-and-vs-code/) provides insights into one of them.
...
If you were using old versions of Mermaid (&lt;10.5.0) you could’ve configured your chart using [directives](https://mermaid.js.org/config/directives.html). You do that by declaring a JavaScript-object-like statement enclosed between percentages (“`%%…%%`”) symbols, usually after declaring the diagram type, like so:
...
For developers who are installing the Mermaid package, the recommended method for configuration is using JavaScript. Mermaid is also configurable through a JSON configuration file that exists in the folder of the library. For more details about those methods, consult the [documentation chapter about API usage](https://mermaid.js.org/config/usage.html#configuration).

You can find a list of the attributes and properties that you can affect when configuring your diagram on [this page of the Mermaid documentation](https://mermaid.js.org/config/schema-docs/config.html).
...
![What the shape will look like on your diagram - a square with an A in it.](https://cdn.hashnode.com/res/hashnode/image/upload/v1732613071351/e4763247-0828-4a0c-998e-92beb46cc651.png align="center")
...
![Using a longer name for a node ID](https://cdn.hashnode.com/res/hashnode/image/upload/v1732613862345/49ae30eb-d5d5-4892-9f67-025bb1836841.png align="center")
...
![Ways to declare shapes and labels with different Mermaid versions](https://cdn.hashnode.com/res/hashnode/image/upload/v1734631211809/8538aa8a-c971-4446-9e87-954556a3b382.png align="center")
...
![You need just one shape declaration per node](https://cdn.hashnode.com/res/hashnode/image/upload/v1735917613257/146c42d6-64ca-4c36-863b-782c3c8e2164.png align="center")
...
![Main flowchart shapes table. Image from https://www.smartdraw.com/flowchart/flowchart-symbols.htm](https://cdn.hashnode.com/res/hashnode/image/upload/v1733765176295/06d45bcd-38c1-4c88-854d-c91bdb7e0a7c.jpeg align="center")
...
![start and end points with different versions of Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1736598049946/3401a3a3-083d-4ef4-91ec-88adb19b7470.jpeg align="center")
...
![terminal points with different versions of Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1736294592460/898bede3-b035-4946-8ab2-8ccb90ece832.jpeg align="center")
...
![inputoutput shape with different versions of Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1736294704637/4541fa1f-bae1-4899-b2d5-c7e147605623.jpeg align="center")

### The Process (Rectangle) Shape

You can represent a process using a rectangle in a flowchart. It represent a **single step** in your workflow, like an expression (for example, `x = y*x²`), a **entire block statement**, like “`loop through array and update values by multiplying by 2`”, or an **entire sub-process**, like an existing function or even a module.
...
![process shape with different versions of Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1736294826349/d289878f-3239-4e68-ad4a-e9c50d554332.jpeg align="center")
...
![decision shape with different versions of Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1736294905673/7b543118-6c1a-4d78-ba68-cd323baae7ad.jpeg align="center")
...
![Use of markdown for shape labelling in Mermaid flowchart](https://cdn.hashnode.com/res/hashnode/image/upload/v1732618144206/f00f9e9f-da69-48ae-9ad8-73bf0c9768b2.png align="center")
...
![Adding an arrow to a Mermaid flowchart](https://cdn.hashnode.com/res/hashnode/image/upload/v1732628585336/7758f7b5-6173-47fc-a32f-f48bcfbedb62.png align="center")
...
![Different types of edges that can be added to Mermaid flowcharts](https://cdn.hashnode.com/res/hashnode/image/upload/v1732628607536/44a80f6a-9fea-41e0-aafb-d17d61a643ec.png align="center")
...
![Chaining and Operators in Mermaid flowchart syntax](https://cdn.hashnode.com/res/hashnode/image/upload/v1732628641910/3b82896a-7b51-44bc-b8ae-6f6facc3dcb8.png align="center")
...
![The two ways of adding labels to a links in Mermaid flowcharts](https://cdn.hashnode.com/res/hashnode/image/upload/v1732629631977/866b28d9-3d74-4066-8e50-5112ef1d040a.png align="center")
...
![Example of edge labelling](https://cdn.hashnode.com/res/hashnode/image/upload/v1734641046249/e9cf3ccc-6170-4338-bc20-b2fe9009d7bb.png align="center")
...
![Subgraphs with Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1735917794248/9bdfa5b6-725d-4ec5-841f-81be89c6d8f9.png align="center")
...
![Example of direction inheritance with subgraphs](https://cdn.hashnode.com/res/hashnode/image/upload/v1735917902060/b1282d51-11fc-490c-a81d-4a75d4851c19.png align="center")
...
![Shape styling with Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1735917988147/20c6d541-7755-464a-8a1a-2050c73be70f.png align="center")
...
![Adding classes with Mermaid classDef](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918057458/46283ac9-cf5a-468d-9a6c-a92a3d5bb7bf.png align="center")
...
![Styling nodes and subgraphs](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918115736/6e22a8ef-e00b-4fb7-a50f-c317f54c7538.png align="center")
...
The problem with edges is that they don’t have IDs: they are treated more like being part of an array, so they should be referred with an index – which won’t always correspond to the edge you want. Here is an example, based on [this discussion](https://forum.obsidian.md/t/styling-links-in-mermaid/38789/2):
...
![Styling links](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918182173/7f80fae4-2994-4558-87c2-2cb0c506bbe5.png align="center")
...
The change should apply to all the edges in the flowchart and it should be based on the [d3-shape library](https://d3js.org/d3-shape/curve). But to date I haven’t been able to reliably configure curvature using either the directive method or the frontMatter method.
...
For example, out of the Mermaid documentation about the general syntax is [this script using the frontMatter method](https://mermaid.js.org/intro/syntax-reference.html):
...
![Example of a theme in Mermaid](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918258769/59f41799-6e72-4e1a-946f-b75953e5a468.png align="center")
...
![Configuring using frontMatter](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918365078/2a204976-3175-485f-bfa8-f951d296bbb1.png align="center")
...
![Configuring using a directive](https://cdn.hashnode.com/res/hashnode/image/upload/v1735918450420/7f9b9d84-7193-48ad-a841-be00ca234db6.png align="center")
...
For details about the configurable flowchart properties using these and JavaScript methods, [visit the Mermaid documentation](https://mermaid.js.org/config/schema-docs/config-defs-flowchart-diagram-config.html). If you want examples on how to configure themes, [follow this resource](https://mermaid.js.org/config/theming.html). At the time of this writing, configuring through directives or frontMatter is something that I haven’t explored in depth. I invite you to give it a try and let me know what you discover.

### Interactivity

Another thing that you can do with Mermaid is [adding simple interactivity](https://mermaid.js.org/syntax/flowchart.html#interaction). You can do this by using the following pattern, using the reserved words `click`, `call` and `callback`, where `callback` is the name of a callback function:
...
Visit the recommended resource given by the documentation itself for a working example for tooltips, but no links: [https://jsfiddle.net/yk4h7qou/2/](https://jsfiddle.net/yk4h7qou/2/). Check the examples in the Mermaid documentation to see how links work, but the tooltips won’t work: [https://mermaid.js.org/syntax/flowchart.html#interaction](https://mermaid.js.org/syntax/flowchart.html#interaction).
...
I also recommend reading the [Mermaid API usage section](https://mermaid.js.org/config/usage.html) in the Mermaid documentation to better understand how to apply JavaScript to Mermaid configurations and diagram manipulation.
