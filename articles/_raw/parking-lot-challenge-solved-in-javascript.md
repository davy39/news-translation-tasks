---
title: How to Solve the Parking Lot Challenge in JavaScript
subtitle: ''
...
Our app will provide basic UI controls allowing an (imaginary) operator to work with the parking lot software\_.\_ And in order to make their work a bit more pleasing to the eye, we will try to animate the basic functions our software provides.
...
[Embedded content](https://parking-lot-chi.vercel.app/)
...
* [utils](https://github.com/mihailgaberov/parking-lot/tree/main/src/utils) – contains a helper method for generating fictitious car license plates that we use later when representing a parking slot as *busy*
