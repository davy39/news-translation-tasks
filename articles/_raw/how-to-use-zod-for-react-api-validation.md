...
* [What is Zod, and Why Use it for React API Calls?](#heading-what-is-zod-and-why-use-it-for-react-api-calls)
    
* [How to Generate a New TypeScript React Project](#heading-how-to-generate-a-new-typescript-react-project)
    
* [Core Zod Concepts: Basic Usage, Types, and Validation](#heading-core-zod-concepts-basic-usage-types-and-validation)
    
* [How to Build Zod Schemas for API Responses](#heading-how-to-build-zod-schemas-for-api-responses)
    
* [How to Integrate Zod with React API Calls](#heading-how-to-integrate-zod-with-react-api-calls)
    
* [How to Render the User Interface (UI) and Handle Errors in React](#heading-how-to-render-the-user-interface-ui-and-handle-errors-in-react)
...
![Image of the resulting code above](https://cdn.hashnode.com/res/hashnode/image/upload/v1738857987322/55a5943c-6633-4432-a441-c3dfa9400d93.png align="center")
...
![Image of the resulting code above](https://cdn.hashnode.com/res/hashnode/image/upload/v1738859384410/27c2a5f3-2410-4709-ac27-8bf24f6c3fd8.png align="center")
...
Building on our understanding of Zod’s core concepts, let’s create Zod schemas specifically for data received from API calls. We’ll leverage data from [JSONPlaceholder](https://jsonplaceholder.typicode.com/posts), which offers information about posts.  
