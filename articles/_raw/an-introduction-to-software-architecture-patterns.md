...
coverImage: https://www.freecodecamp.org/news/content/images/2022/05/pexels----3172740.jpg
tags:
- name: api
  slug: api
- name: Microservices
...
seo_title: null
seo_desc: 'Hi everyone! In this handbook you''re going to learn about the vast, intricate
  field that is Software Architecture.

  This is a field that I found both confusing and intimidating when I was first starting
  my journey into coding. So I''ll try and spare yo...'
---
...
* [What is software architecture](#heading-what-is-software-architecture)?
    
* [Important software architecture concepts to know](#heading-important-software-architecture-concepts-to-know)
    
    * [What's the Client-Server model](#whats-the-client-server-model)?
        
    * [What are APIs](#heading-what-are-apis)?
        
    * [What is Modularity](#heading-what-is-modularity)?
        
* [What's your infrastructure like?](#heading-whats-your-infrastructure-like)
    
    * [Monolithic Architecture](#heading-monolithic-architecture)
        
    * [Microservices Architecture](#heading-microservices-architecture)
        
    * [What is back end for front-end (BFF)](#heading-what-is-back-end-for-front-end-bff)?
        
    * [How to use load balancers and horizontal scaling](#heading-how-to-use-load-balancers-and-horizontal-scaling)
        
* [Where your infrastructure lives](#heading-where-your-infrastructure-lives)
    
    * [On premise hosting](#heading-on-premise-hosting)
        
    * [Traditional server providers](#heading-traditional-server-providers)
        
    * [Hosting on the Cloud](#heading-hosting-on-the-cloud)
        
        * [Traditional](#heading-traditional)
            
        * [Elastic](#heading-elastic)
            
        * [Serverless](#heading-serverless)
            
        * [Lots of other services](#heading-lots-of-other-services)
            
* [Different folder structures to know](#heading-different-folder-structures-to-know)
    
    * [All in one place folder structure](#heading-all-in-one-place-folder-structure)
        
    * [Layers folder structure](#heading-layers-folder-structure)
        
    * [MVC folder structure](#heading-mvc-folder-structure)
