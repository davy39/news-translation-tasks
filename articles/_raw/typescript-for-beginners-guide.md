...
* [Advantages of TypeScript](#heading-advantages-of-typescript)
    
* [Code Generation](#heading-code-generation)
    
* [Installation](#heading-installation)
    
* [Configuration](#heading-configuration)
    
* [Understanding tsconfig.json](#heading-understanding-tsconfig-json)
    
* [TypeScript Basics](#heading-typescript-basics)
    
* [Type Declarations and Variables in TypeScript](#heading-type-declarations-and-variables-in-typescript)
    
* [Functions in TypeScript](#heading-functions-in-typescript)
    
* [Classes and Objects in TypeScript](#heading-classes-and-objects-in-typescript)
    
* [Interfaces in TypeScript](#heading-interfaces-in-typescript)
    
* [Enums in TypeScript](#heading-enums-in-typescript)
    
* [Generics in TypeScript](#heading-generics-in-typescript)
...
Before we dive into TypeScript, you'll need to make sure that you have Node.js installed on your system. `Node.js` is a runtime environment that allows you to run JavaScript outside of the browser. You can download Node.js from the [official website](https://nodejs.org/en/download/).
