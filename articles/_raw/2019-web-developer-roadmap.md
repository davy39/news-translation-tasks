---
title: The 2020 Web Developer Roadmap – A Visual Guide to Becoming a Front End, Back
  End, or DevOps Developer
subtitle: ''
author: Quincy Larson
co_authors: []
series: null
date: '2019-06-30T05:58:31.000Z'
originalURL: https://freecodecamp.org/news/2019-web-developer-roadmap
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9ca1c9740569d1a4ca50a6.jpg
tags:
...
One of the best such list of skills is [Kamran Ahmed's](https://twitter.com/kamranahmedse) Developer Roadmap, which he regularly updates.
...
There are a lot of other concepts you can learn. I recommend working through a good entry-level computer science course to get started. Here's [all of Harvard's CS50 course lectures ad-free on freeCodeCamp's YouTube channel](https://www.youtube.com/playlist?list=PLWKjhJtqVAbmGw5fN5BQlwuug-8bDmabi).
...
* CSS Preprocessors. These use to be necessary, but CSS itself has added many of the features that made these preprocessors so useful. [freeCodeCamp currently teaches Sass](https://www.freecodecamp.org/learn), but we are in the process of phasing that out as well.
* CSS Architecture: I don't think these are necessary unless you designing CSS systems is a big part of your day-to-day job.
* A bit of a nitpick: TypeScript is a promising way to reduce bugs and code with confidence. We're adding this to [Version 7.0 of the freeCodeCamp core curriculum](https://www.freecodecamp.org/forum/t/help-us-build-version-7-0-of-the-freecodecamp-curriculum/263546). I think this should be even more prominent on the roadmap, but it is on there.
...
Here's freeCodeCamp's [free 4-hour course on SQL](https://www.youtube.com/watch?v=HXV3zeQKqGY), which will teach you the basics.

And if you want to dive even deeper, here's our [free 8-hour course on relational database design](https://www.youtube.com/watch?v=ztHopE5Wnpc).
...
Here is a detailed guide to [which programming language should you learn first](https://www.freecodecamp.org/news/how-to-choose-which-programming-language-you-should-learn-in-2019-60abef241012/).
...
Here's a quick [30-minute introduction to the field of DevOps](https://www.youtube.com/watch?v=UqMUoINlKnY) that should give you a better idea of whether DevOps is something you're interested.
