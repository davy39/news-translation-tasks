...
![Running node . prints out Hello, World!!!](https://www.freecodecamp.org/news/content/images/2021/11/image-33.png)
...
Firstly, we need to install the commitlint CLI and add a commitlint config (in this case the default [Conventional Commits Config](https://www.conventionalcommits.org/)).
...
Now we need to install [husky](https://typicode.github.io/husky/#/) to run commitlint as a pre-commit hook.
...
![Error that should occur due to not following the default convention](https://www.freecodecamp.org/news/content/images/2021/11/image-34.png)
_Error that should occur due to not following the default convention_
...
![Code should get committed due to following the default convention](https://www.freecodecamp.org/news/content/images/2021/11/image-35.png)
_Code should get committed due to following the default convention_
...
The [Conventional Commits Convention](https://www.conventionalcommits.org/) works for most projects. But sometimes you might want to add some more rules specific to your use case.
...
* Demo Repository - [https://github.com/AnishDe12020/commitlint-example](https://github.com/AnishDe12020/commitlint-example)
* Commitlint website and docs - [https://commitlint.js.org/#/](https://commitlint.js.org/#/)
* Commitlint GitHub action - [https://github.com/wagoid/commitlint-github-action](https://github.com/wagoid/commitlint-github-action)
* Standard Version GitHub Repository - [https://github.com/conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version)
* Husky website and docs - [https://typicode.github.io/husky/#/](https://typicode.github.io/husky/#/)
