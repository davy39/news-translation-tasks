...
**[Download the cheatsheet in PDF format here](https://reedbarger.com/resources/the-react-cheatsheet-for-2021)** (it takes 5 seconds).
...
* [JSX Elements](#heading-jsx-elements)
* [Components and Props](#heading-components-and-props)
* [Lists and Keys](#heading-lists-and-keys)
* [Event Listeners and Handling Events](#heading-event-listeners-and-handling-events)

### Essential React Hooks

* [State and useState](#heading-state-and-usestate)
* [Side Effects and useEffect](#heading-side-effects-and-useeffect)
* [Refs and useRef](#heading-refs-and-useref)

### Hooks and Performance

* [Preventing Re-renders and React.memo](#heading-preventing-re-renders-and-reactmemo)
* [Callback functions and useCallback](#heading-callback-functions-and-usecallback)
* [Memoization and useMemo](#heading-memoization-and-usememo)

### Advanced React Hooks

* [Context and useContext](#heading-context-and-usecontext)
* [Reducers and useReducer](#heading-reducers-and-usereducer)
* [Writing custom hooks](#heading-writing-custom-hooks)
* [Rules of hooks](#heading-rules-of-hooks)
...
_Want to keep this guide for future reference?_

**[Download a complete PDF version of this cheatsheet here.](https://reedbarger.com/resources/the-react-cheatsheet-for-2021)**
