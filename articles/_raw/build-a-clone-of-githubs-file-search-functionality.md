...
_Github file search functionality_
...
You can see the live demo of the application [here](https://github-file-search-react.netlify.app/).
...
Open `styles.scss` and add the contents from [here](https://github.com/myogeshchavan97/github-file-search-react/blob/master/src/styles.scss) inside it.
...
Create a new file `api.js` inside the `utils` folder and add the content from [here](https://github.com/myogeshchavan97/github-file-search-react/blob/master/src/utils/api.js) inside it.
...
For displaying the icons, we'll use the `react-icons` npm library. It has a really nice website that lets you easily search and use the icons you need. Check it out [here](https://react-icons.github.io/react-icons/).
...
You can find the code up to this point in [this branch](https://github.com/myogeshchavan97/github-file-search-react/tree/initial_code).

## Add basic search functionality <br /> <br/>
...
We are using React Hooks here for our state and lifecycle methods. If you are new to React Hooks check out [this article](https://levelup.gitconnected.com/an-introduction-to-react-hooks-50281fd961fe) for an introduction.
...
_Initial working search functionality_
...
You can find code up to this point in [this branch](https://github.com/myogeshchavan97/github-file-search-react/tree/switching_view).

## Add functionality to navigate between files <br /> <br />
...
_Search and Navigate_

You can find the code up to this point in [this branch](https://github.com/myogeshchavan97/github-file-search-react/tree/navigation_functionality).

## Add functionality to highlight matching  text <br /> <br />
...
You can find the code up to this point in [this branch](https://github.com/myogeshchavan97/github-file-search-react/tree/text_highlighting).

Complete GitHub Source Code: [here](https://github.com/myogeshchavan97/github-file-search-react)
Live Demo: [here](https://github-file-search-react.netlify.app/)

**Check out my other React, Node.js, and Javascript articles at [Medium](https://medium.com/@yogeshchavan), [dev.to](https://dev.to/myogeshchavan97) and subscribe to get weekly updates directly in your inbox [here](https://subscribe-user.herokuapp.com/)**.
