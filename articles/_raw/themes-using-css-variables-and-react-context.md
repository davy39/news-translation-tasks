...
![CSS Variables](https://www.freecodecamp.org/news/content/images/2020/01/cover-2.png)
...
In this guide I'll use the `useContext` hook, which you can read more about [here](https://reactjs.org/docs/hooks-reference.html#usecontext). But the principle is the same with class components.
...
The full source code can be found [on github](https://github.com/dorshinar/blog/blob/master/src/components/themer/themer.jsx).
...
This article was previously published on my blog: [dorshinar.me](https://dorshinar.me/themes-using-css-variables-and-react-context). If you want to read more content, you can check my blog as it would mean a lot to me.
