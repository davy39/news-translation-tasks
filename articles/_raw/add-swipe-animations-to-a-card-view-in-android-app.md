...
![Animation showing smooth slide to refresh swiping animation on a android cardview.](https://www.freecodecamp.org/news/content/images/2021/11/iHxFjvI4x.gif)
...
![Android card view with a quote.](https://www.freecodecamp.org/news/content/images/2021/11/9CVHyoJfV.png)
...
We won't be making the XML code for the user interface. You can [get the layout](https://github.com/gouravkhunger/QuotesApp/blob/main/app/src/main/res/layout/fragment_quote.xml) I used here from the GitHub repository, or build your own.

[Here's the complete code](https://github.com/gouravkhunger/QuotesApp) for our Quotes app, if you wish to check it out. It uses the MVVM design pattern, but this article doesn't rely on what pattern you use for the business logic of your app, as we'll just be working on the UI part.
...
![Mean Position of Quote Card](https://www.freecodecamp.org/news/content/images/2021/11/dEnpWr7e4.png)
_Mean Position of the Card_

We want the card to swipe if and only if the user swipes it to the left of the mean position.

![Animation illustrating user swipes to the left of the Quote Card](https://www.freecodecamp.org/news/content/images/2021/11/7epeWn53S.gif)
_Swipe only if moved towards the left of mean position_
...
![Animation highlighting starting position of Quote Card](https://www.freecodecamp.org/news/content/images/2021/11/NiH3lsseM.gif)
_Starting position of card._
...
_Visualisation of the aforementioned concept_
...
Don't forget to download the app and test it out yourself. Stars and contributions on the [GitHub repository](https://github.com/gouravkhunger/QuotesApp) are welcomed!
...
For this, you have to keep track of the start position and end position then animate them with `alpha()` from `0` to `1`. For an example, you can refer to my library [Accolib](https://github.com/gouravkhunger/AccoLib) to create animated FAQ accordions.

* **Basic animated layout changes can be achieved with view animations.**

Thanks a lot for reading so far, I hope this post added some value. Subscribe to my newsletter at [Genics Blog](https://genicsblog.com) to stay updated with my future articles!
