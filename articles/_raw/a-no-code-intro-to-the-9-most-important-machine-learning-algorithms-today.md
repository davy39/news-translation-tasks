---
title: 9 Key Machine Learning Algorithms Explained in Plain English
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
[Recommendation systems](https://nickmccullum.com/python-machine-learning/introduction-recommendation-systems/) are used to find similar entries in a data set.
...
[Linear regression](https://nickmccullum.com/python-machine-learning/linear-regression-python/) is used to predict some `y` values based on the value of another set of `x` values.

### The History of Linear Regression

Linear regression was created in the 1800s by [Francis Galton](https://en.wikipedia.org/wiki/Francis_Galton).
...
Later on, Galton discovered something much more interesting. The son’s height tended to be _closer to the overall average height of all people_ than it was to his own father_._
...
[Logistic regression](https://nickmccullum.com/python-machine-learning/logistic-regression-python/) is similar to linear regression except that instead of calculating a numerical `y` value, it estimates which _category_ a data point belongs to.
...
You will not have to memorize the [Sigmoid Function](https://en.wikipedia.org/wiki/Sigmoid_function) to be successful in machine learning. With that said, having some understanding of its appearance is useful. 
...
_In this diagram TN stands for "True Negative" and FN stands for "False Negative". FP stands for "False Positive" and TP stands for "True Positive"._
...
The [K-nearest neighbors](https://nickmccullum.com/python-machine-learning/k-nearest-neighbors-python/) algorithm can help you solve classification problems where there are more than two categories.
...
2. Calculate the [Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance) from the new data point `x` to all the other points in the data set
...
[Decision trees and randoms forests](https://nickmccullum.com/python-machine-learning/decision-trees-random-forests-python/) are both examples of tree methods.
...
Building decision trees is harder than you might imagine. This is because deciding which features to split your data on (which is a topic that belongs to the fields of [Entropy](https://en.wikipedia.org/wiki/Entropy) and [Information Gain](https://machinelearningmastery.com/information-gain-and-mutual-information/#:~:text=Information%20gain%20is%20the%20reduction,before%20and%20after%20a%20transformation.)) is a mathematically complex problem.
...
[Support vector machines](https://nickmccullum.com/python-machine-learning/support-vector-machines-python/) are classification algorithms (although, technically speaking, they could also be used to solve regression problems) that divide a data set into categories based by slicing through the widest gap between categories. This concept will be made more clear through visualizations in a moment.

### What Are Support Vector Machines?

[Support vector machines](https://en.wikipedia.org/wiki/Support_vector_machine) – or SVMs for short – are supervised machine learning models with associated learning algorithms that analyze data and recognize patterns.
...
[K-means clustering](https://nickmccullum.com/python-machine-learning/k-means-clustering-python/) is a machine learning algorithm that allows you to identify segments of similar data within a data set.
