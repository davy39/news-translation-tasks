...
(Note that the session id is _not_ your password, but is something completely separate and generated on the fly. Proper password handling and authentication is outside the scope of this article, but you can find some in depth guides [here](https://www.freecodecamp.org/news/search/?query=authentication).)
