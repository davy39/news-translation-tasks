---
title: How to Create and Publish an NPM Package – a Step-by-Step Guide
subtitle: ''
...
When you decide on a name, go to the [NPM registry](https://www.npmjs.com/) and run a search. Be sure there's no exact match to the name you chose (or a match that is too similar).
...
If you do not already have Node installed, you should go ahead and install it. You can visit the official website to [download and install Node.js](https://nodejs.org/en/download/). NPM comes pre-installed with Node.
...
* `version`: The initial value is 1.0.0. You update the number when you update your package using [semantic versioning](https://www.freecodecamp.org/news/semantic-versioning-1fd6f57749f7/).
...
You can visit the [NPM website](https://www.npmjs.com/) and run a search for your package. You should see your package show up in the search results.
