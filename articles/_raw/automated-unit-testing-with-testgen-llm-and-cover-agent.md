...
There have been some recent developments in artificial intelligence that promise to help automate the unit test development processes. In February, researchers at Meta released a paper on [Automated Unit Test Improvement using Large Language Models](https://arxiv.org/abs/2402.09171). This introduced an innovative method for automating unit testing.
...
* [Meta’s TestGen-LLM](#heading-metas-testgen-llm)
    
* [How does TestGen-LLM work?](#heading-how-does-testgen-llm-work)
    
* [Open-Source Implementation (Cover-Agent)](#heading-open-source-implementation-cover-agent)
    
* [How does Cover-Agent work?](#heading-how-does-cover-agent-work)
    
* [How to Use Cover-Agent](#heading-how-to-use-cover-agent)
    
* [Benefits of the Open-Source Cover-Agent](#heading-benefits-of-the-open-source-cover-agent)
    
* [How can you Contribute to this Technology?](#how-can-you-contribute-to-this-technology)
...
*Test generation workflow(*[*From TestGen\_LLM paper*](https://arxiv.org/abs/2402.09171)*)*
...
* Poetry installed for managing Python package dependencies. You can find installation instructions for Poetry [here](https://python-poetry.org/docs/).
...
You can run the binary without any Python environment installed on your system (for example, within a Docker container that does not contain Python). You can download the release for your system by navigating to the project's [release page](https://github.com/Codium-ai/cover-agent/releases).
...
This is the test\_calculator.py placed in the test folder.
...
Make sure that your OPENAI\_API\_KEY is set in your environment variables, as it is required for the OpenAI API.
...
In this example we reached 100% code coverage. For larger code bases, the procedure is relatively the same. You can read through [this guide](https://dev.to/oluwadamisisamuel1/how-to-automate-test-generation-with-ai-using-codiumai-cover-agent-1kep) for a walkthrough on a larger code base.
...
Cover-Agent source code is publicly available through [this GitHub repo](https://github.com/Codium-ai/cover-agent). They encourage developers of all backgrounds to test their product and make contributions to further improve and grow this new technology.
...
* [Meta’s Research Paper](https://arxiv.org/abs/2402.09171)
    
* [Cover-Agent Blog for further study](https://www.codium.ai/blog/we-created-the-first-open-source-implementation-of-metas-testgen-llm/)
    
* [Article for installation process and use cases](https://dev.to/oluwadamisisamuel1/how-to-automate-test-generation-with-ai-using-codiumai-cover-agent-1kep)
