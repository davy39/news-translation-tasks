---
title: The Python Handbook – Learn Python for Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
- [Introduction to Python](#heading-introduction-to-python)
- [How to Install Python](#heading-how-to-install-python)
- [How to Run Python Programs](#heading-how-to-run-python-programs)
- [Python 2 vs Python 3](#heading-python-2-vs-python-3)
- [Python Basics](#heading-python-basics)
- [Data Types in Python](#heading-data-types-in-python)
- [Operators in Python](#operators)
- [The Ternary Operator in Python](#heading-the-ternary-operator-in-python)
- [Strings in Python](#heading-strings-in-python)
- [Booleans in Python](#heading-booleans-in-python)
- [Numbers in Python](#heading-numbers-in-python)
- [Constants in Python](#heading-constants-in-python)
- [Enums in Python](#heading-enums-in-python)
- [User Input in Python](#heading-user-input-in-python)
- [Control Statements in Python](#heading-control-statements-in-python)
...
- [Sets in Python](#heading-sets-in-python)
- [Functions in Python](#heading-functions-in-python)
- [Objects in Python](#heading-objects-in-python)
- [Loops in Python](#heading-loops-in-python)
- [Classes in Python](#heading-classes-in-python)
- [Modules in Python](#heading-modules-in-python)
- [The Python Standard Library](#heading-the-python-standard-library)
- [The PEP8 Python Style Guide](#heading-the-pep8-python-style-guide)
- [Debugging in Python](#heading-debugging-in-python)
- [Variable Scope in Python](#heading-variable-scope-in-python)
- [How to Accept Arguments from the Command Line in Python](#heading-how-to-accept-arguments-from-the-command-line-in-python)
- [Lambda Functions in Python](#heading-lambda-functions-in-python)
- [Recursion in Python](#heading-recursion-in-python)
- [Nested Functions in Python](#heading-nested-functions-in-python)
- [Closures in Python](#heading-closures-in-python)
- [Decorators in Python](#heading-decorators-in-python)
- [Docstrings in Python](#heading-docstrings-in-python)
- [Introspection in Python](#heading-introspection-in-python)
- [Annotations in Python](#heading-annotations-in-python)
- [Exceptions in Python](#heading-exceptions-in-python)
- [The with Statement in Python](#heading-the-with-statement-in-python)
- [How to Install 3rd Party Packages in Python Using pip](#heading-how-to-install-3rd-party-packages-in-python-using-pip)
- [List Comprehensions in Python](#heading-list-comprehensions-in-python)
- [Polymorphism in Python](#heading-polymorphism-in-python)
- [Operator Overloading in Python](#heading-operator-overloading-in-python)
- [Virtual Environments in Python](#heading-virtual-environments-in-python)
...
Send any feedback, errata, or opinions at <mailto:flavio@flaviocopes.com>, and you can reach me on Twitter [@flaviocopes](https://twitter.com/flaviocopes).
