...
I’ve [recently written an article](https://www.freecodecamp.org/news/how-to-deploy-a-nextjs-api-to-production-using-sevalla/) on working with Next.js API and deploying it to production. In this case, I would’ve used a JSON file as a mini-database.
...
So in this article, we'll walk through how to build a REST API with Next.js, store data in a Sevalla-managed database, and deploy the whole project to production using Sevalla's [PaaS infrastructure](https://www.freecodecamp.org/news/vps-vs-paas-how-to-choose-a-hosting-solution/).

## Table of Contents

* [What is Next.js?](#heading-what-is-nextjs)
    
* [Installation and Setup](#heading-installation-and-setup)
    
* [How to Build a NextJS API](#heading-how-to-build-a-nextjs-api)
    
* [Provisioning a Database in Sevalla](#heading-provisioning-a-database-in-sevalla)
    
* [Deploying to Sevalla](#heading-deploying-to-sevalla)
...
Your API template should be running at port 3000. Go to [http://localhost:3000](http://localhost:3000/) and you should see the following message:
...
![Folder setup](https://cdn.hashnode.com/res/hashnode/image/upload/v1754479396056/a80a0fd3-707d-4813-b402-041561354c94.png align="center")
...
While this setup can seem complicated for a simple project, it provides a clear structure for large-scale web applications. If you want to go deeper into building complex APIs with Next.js, [here is a tutorial](https://nextjs.org/blog/building-apis-with-nextjs) you can follow.
...
[Sevalla](https://sevalla.com/) is a modern, usage-based Platform-as-a-service provider and an alternative to sites like Heroku or to your self-managed setup on AWS. It combines powerful features with a smooth developer experience.
...
If you are new to Sevalla, you can [sign up](https://sevalla.com/signup/) using your GitHub account to enable direct deploys from your GitHub. Every time you push code to your project, Sevalla will auto-pull and deploy your app to the cloud.

Once you login to Sevalla, click on “Databases”.

![Sevalla Databases](https://cdn.hashnode.com/res/hashnode/image/upload/v1754477578430/7b7fa655-0f35-4901-90be-07bd5abdf2c0.png align="center")

Now let’s create a [PostgreSQL](https://www.freecodecamp.org/news/posgresql-course-for-beginners/) database.

![Create Postgresql Database](https://cdn.hashnode.com/res/hashnode/image/upload/v1754477639118/d6ea82ae-45c9-40a7-bcf5-d144885db929.png align="center")
...
![Database settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1754479205197/58c01504-59c0-4df3-b9f9-cb14e1431135.png align="center")
...
![Postgresql successful connection](https://cdn.hashnode.com/res/hashnode/image/upload/v1754485714515/c63f11fc-2310-462a-9b42-c0528e500637.png align="center")
...
![Database studio](https://cdn.hashnode.com/res/hashnode/image/upload/v1754486852876/2437c76a-562a-4575-9cc0-a5f563aa6206.png align="center")
...
![Database Schema](https://cdn.hashnode.com/res/hashnode/image/upload/v1754487097219/9d01d9b7-e3c6-427b-9b42-c97065826af7.png align="center")

Click “create table and you should see the table created as below:

![Users table](https://cdn.hashnode.com/res/hashnode/image/upload/v1754487162119/c64e0577-d094-4549-85f4-ab8c8d15f48e.png align="center")

Let’s add a dummy record using “add record” button to use it to test our API. The id field should be in UUID format (and you can [generate one here](https://www.uuidgenerator.net/)).
...
We’ll use [Postman](https://www.postman.com/) for this since its easy to create POST requests using Postman. We’ll send a sample data under “body” → “raw” → “JSON”.

![Post Request](https://cdn.hashnode.com/res/hashnode/image/upload/v1754543941765/a77be1b8-05c3-4c61-a5c3-f7f0fbf48b4d.png align="center")

The response from Postman should be as below:

![Postman results](https://cdn.hashnode.com/res/hashnode/image/upload/v1754544001954/5a52331c-a445-4b10-8c4b-9337ca873c13.png align="center")
...
Push your code to GitHub or [fork my repository](https://github.com/manishmshiva/nextjs-api-pgsql). Now lets go to Sevalla and create a new app.

![Sevalla create app](https://cdn.hashnode.com/res/hashnode/image/upload/v1754545093624/9747a06d-0dcf-482a-89b9-732b9937b1dc.png align="center")
...
![Sevalla Create New App](https://cdn.hashnode.com/res/hashnode/image/upload/v1754545136001/dde5fe4d-4691-401c-a3ef-959b8e53f62a.png align="center")
...
Go to the “Environment variables” section and add the key “PGSQL\_URL” and the URL in the value field.
...
Hope you enjoyed this article. I’ll see you soon with another one. You can [connect with me here](https://manishshivanandhan.com/) or [visit my blog](https://blog.manishshivanandhan.com/).
