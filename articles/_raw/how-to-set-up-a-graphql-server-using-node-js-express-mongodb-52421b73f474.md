...
_MLab free option to use in our MongoDB Server._
...
_Our database created with MLab._
...
_The data object that GraphiQL Playground returned for us._
...
_In our first mutation, we created a user._
...
_All our users will be returned._
...
_The exact user that we asked._
