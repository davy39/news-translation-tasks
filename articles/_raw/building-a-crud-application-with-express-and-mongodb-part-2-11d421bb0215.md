...
Let’s try triggering a **PUT** request through JavaScript this time since we’ve already learned how to trigger a request through a <form> element while going throug**h th**e POST request in the previous article.
