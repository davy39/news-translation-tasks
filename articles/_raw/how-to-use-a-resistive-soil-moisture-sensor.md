...
* [What is a Soil Moisture Sensor?](#heading-what-is-a-soil-moisture-sensor)
    
* [Types of Soil Moisture Sensors](#heading-types-of-soil-moisture-sensors)
    
* [Parts of a Resistive Soil Moisture Sensor](#heading-parts-of-a-resistive-soil-moisture-sensor)
    
* [How to Calibrate the Sensor for Your Soil](#heading-how-to-calibrate-the-sensor-for-your-soil)
    
* [Example 1: How to Determine Soil Moisture Level in Percentage from Analog Output](#heading-example-1-how-to-determine-soil-moisture-level-in-percentage-from-analog-output)
    
* [Example 2: How to Determine Soil Moisture State from Digital Output](#heading-example-2-how-to-determine-soil-moisture-state-from-digital-output)
...
![Sensor probes labelled diagram](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909048810/7c2367b5-872c-4e98-acf8-d8b2f0851f6c.jpeg align="center")
...
![Sensor voltage comparator module labelled diagram](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909173338/454ae6bf-2d34-4131-af88-c990eb988cbd.jpeg align="center")
...
![Schematic diagram for soil calibration](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909238974/d84a8df3-52d0-4f5e-90a4-9a4fa6c198fb.jpeg align="center")
...
![Serial monitor showing analog reading for dry soil](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909305339/35d99200-d169-4419-9292-e54a9c544d77.png align="center")
...
![Serial monitor showing analog reading for wet soil](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909623291/5478b034-ce56-4f9b-a6d7-758508eb0c1a.png align="center")
...
![Circuit diagram for Example 1](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909722810/0aff204d-2ddd-44d5-80b5-5765b9cf5fe9.jpeg align="center")
...
![Physical setup for Project 1](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909770251/226bd848-2a58-4e2f-9bf4-796a54983d47.jpeg align="center")
...
![Test example 1 with 37% moisture level](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909854736/5312e441-d9fd-498f-bd87-b902231b27f4.jpeg align="left")

* At about a 76% moisture level, four LEDs are lit.
    

![Test example 1 with 76% moisture level](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909910096/eabf2f8d-7499-4c6a-be49-74d4c8a3da30.jpeg align="left")

You can also simulate the example on Tinkercad here: [https://www.tinkercad.com/embed/6s47ZvIrNOP](https://www.tinkercad.com/embed/6s47ZvIrNOP).

![Example 1 Tinkercad simulation image](https://cdn.hashnode.com/res/hashnode/image/upload/v1752100775640/12f92988-7697-4069-9068-86f663b20794.png align="center")
...
![Circuit diagram for example 2](https://cdn.hashnode.com/res/hashnode/image/upload/v1751909967743/761e3422-ad95-4f8e-9b4d-4963970c926e.jpeg align="left")
...
![Physical setup for example 2](https://cdn.hashnode.com/res/hashnode/image/upload/v1751910000801/55382b8f-cdd4-4f85-9b6a-342af252329b.jpeg align="left")
...
![Test example 2 with wet soil](https://cdn.hashnode.com/res/hashnode/image/upload/v1751910035826/19edc7e0-09a2-404a-8ce4-fb978c5b9f6b.jpeg align="left")

* For dry soil, that is, if the moisture level is below the threshold, you should have the following output:
    

![Test example 2 with dry soil](https://cdn.hashnode.com/res/hashnode/image/upload/v1751910068607/33881bb3-ba7b-41fd-a637-001016298312.jpeg align="left")

You can also simulate the example on Tinkercad here: [https://www.tinkercad.com/embed/2wHwfKherNz](https://www.tinkercad.com/embed/2wHwfKherNz).

![Example 2 Tinkercad simulation](https://cdn.hashnode.com/res/hashnode/image/upload/v1752100906816/cd1b3de4-f5e6-4760-ab03-8f46443ba270.png align="center")
...
You can access all the code on [GitHub](https://github.com/michaelikoko/resistive-soil-moisture-sensor).
