...
1. [Auto Scaling Explained](#heading-auto-scaling-explained)
    
2. [Dynamic Scaling](#heading-dynamic-scaling)
    
3. [Scheduled Scaling](#heading-scheduled-scaling)
    
4. [Why use Auto Scaling](#heading-why-use-auto-scaling)
    
5. [Load Balancing Explained](#heading-load-balancing-explained)
    
6. [Why use Load Balancing](#heading-why-use-load-balancing)
    
7. [Bringing it Together – Load Balancing and Auto Scaling in Action](#heading-bringing-it-together-load-balancing-and-auto-scaling-in-action)
...
This is a cheap and easy way of ensuring [high availability](https://lightcloud.substack.com/i/59017006/high-availability) without having multiple instances in different availability zones.
