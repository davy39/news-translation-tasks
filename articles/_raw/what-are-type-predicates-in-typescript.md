...
* [What's New → TypeScript 5.5 → Inferred Type Predicates](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-5-5.html#inferred-type-predicates)
...
Cover photo background is from [Mona Eendra](https://unsplash.com/@monaeendra?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) on [Unsplash](https://unsplash.com/photos/flowers-beside-yellow-wall-vC8wj_Kphak?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
