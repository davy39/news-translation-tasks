---
title: Interaction Design – How to Evaluate Interaction Costs and Improve User Experience
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_The “table-stakes” for all modern product designers._
...
_The difference between UX (user experience) and IxD (interaction design)._
...
_The more complex the IA, the more the user has to click to get to their desired screen. [Credits: Topta](https://dribbble.com/shots/4406909-The-Comprehensive-Guide-to-Information-Architecture" rel="noopener nofollow)l_
...
_You can create an RRA from user interviews or with data if the product is live._
...
_The more choices there are, the longer it takes the user to make a decision._
...
_Apple is the world’s most valuable brand for a reason._
