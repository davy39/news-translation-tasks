...
* [What are JavaScript modules](#heading-what-are-javascript-modules)?
* [What exactly is the export keyword in JavaScript](#heading-what-exactly-is-the-export-keyword-in-javascript)?
* [What is the default export in JavaScript](#heading-what-is-the-default-export-in-javascript)?
* [What is the named export in JavaScript](#heading-what-is-the-named-export-in-javascript)?
* [How to create a simple app using JavaScript modules](https://www.freecodecamp.org/news/p/a393357b-0fad-4f0d-8f01-d2a3e1d62854/how-to-create-a-simple-app-using-javascript-modules)
* [Conclusion](https://www.freecodecamp.org/news/p/a393357b-0fad-4f0d-8f01-d2a3e1d62854/conclusion)
...
I've also created a video tutorial based on this article. You can watch it [here on YouTube](https://youtu.be/YHRXgUeF1dA).

Here is the [Live Demo](https://fcc-javascript-modules.netlify.app/) of what we'll be creating:
...
Simply clone the [starter boilerplate](https://github.com/Yazdun/fcc-javascript-modules/tree/starter) from the GitHub repository and then follow along with the tutorial. This way, you can focus on learning and implementing the concepts without getting caught up in setup details.

GitHub Source code (please give it a star if you enjoy the tutorial ⭐️ ):

* Starter Boilerplate: [View on GitHub](https://github.com/Yazdun/fcc-javascript-modules/tree/starter)
* Final Version: [View on GitHub](https://github.com/Yazdun/fcc-javascript-modules)
...
If you haven't done so already, please refer to the [Getting Started](#heading-getting-started) section to set up the boilerplate project before continuing. This will allow you to progress through the tutorial.

![Image](https://www.freecodecamp.org/news/content/images/2023/08/image-24.png)
_Once you run the boilerplate project, you will be able to see the following page in your browser_
...
Thanks for reading this till the end! You can follow me on [Twitter](https://twitter.com/Yazdun) where I share more useful tips on web development. Happy coding!
