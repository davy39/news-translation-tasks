---
title: How to Use JavaScript's Map() Method to Solve Breadth-First and Depth-First
  Search Problems
subtitle: ''
author: freeCodeCamp
co_authors: []
...
The JavaScript `map()` method is an [object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) with a key and value pair. An object's key and value are connected using a colon (:) while the key and value of a map are connected using an arrow (=>).
...
_Graphical Representation of The Given States_
...
_An Undirected Graph Representing The Routes_
...
_A Directed Graph Representing The Routes_
