...
You can source data from almost anywhere in Gatsby. In our case, we’re using _Markdown_. When you build your site, Gatsby creates a GraphQL schema for all the data. Then you use [GraphQL](https://graphql.org/learn/) in your React components to query your sourced data.
...
Since the release of the [React Hooks API](https://reactjs.org/docs/hooks-intro.html) and the [`useStaticQuery` hook](https://www.gatsbyjs.org/docs/use-static-query/) in Gatsby, it is very easy to query your data. 
...
> Originally published on [TinaCMS.org](https://tinacms.org/blog/three-ways-to-edit-md/)
...
---
Feel free to visit me on these links:

Watch Weibenfalks tutorial for [Tina & Gatsby](https://www.youtube.com/watch?v=eZWJ9ZtF61A&t=265s).
