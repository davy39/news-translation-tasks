---
title: 'Tree Traversals explained: They’re like a class of lazy students trying to
  cheat on their exam'
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_A left skewed binary search tree._
...
EDIT: Kudos to [Divya Godayal](https://www.freecodecamp.org/news/tree-traversals-explained-theyre-like-a-class-of-lazy-students-trying-to-cheat-on-their-exam-b46563211427/undefined) for pointing out a set of major mistakes in the initial draft and also for ensuring that the article flows nicely :) :)
