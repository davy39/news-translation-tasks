---
title: How to Create a Full-Stack Application with Next.js – A Step-By-Step Tutorial
  for Beginners
subtitle: ''
author: freeCodeCamp
co_authors: []
...
* [How to create a shared layout in Next.js](#heading-how-to-create-a-shared-layout-in-nextjs)
* [How to create a custom navigation bar in Next.js](#heading-how-to-create-a-custom-navigation-bar-in-nextjs)
* [How to create an API route in Next.js](#heading-how-to-create-an-api-route-in-nextjs)
* [How to build the homepage](#heading-how-to-build-the-homepage)
* [What is the App Router in Next.js?](#heading-what-is-the-app-router-in-nextjs)
* [How to enhance the modularity and maintainability of your Next.js codebase](#heading-how-to-enhance-the-modularity-and-maintainability-of-your-nextjs-codebase)
* [How to create a dynamic character's page](#heading-how-to-create-a-dynamic-characters-page)
* [How to create dynamic API routes in Next.js](#heading-how-to-create-dynamic-api-routes-in-nextjs)
...
* [What is `generateStaticParams` in Next.js?](#heading-what-is-generatestaticparams-in-nextjs)
* [What's the purpose of `dynamicParams` when generating static pages in Next.js?](#heading-whats-the-purpose-of-dynamicparams-when-generating-static-pages-in-nextjs)
* [How to generate static pages with `generateStaticParams`](#heading-how-to-generate-static-pages-with-generatestaticparams)
* [How to build the quiz section](#heading-how-to-build-the-quiz-section)
* [How to create a client-side component in Next.js](#heading-how-to-create-a-client-side-component-in-nextjs)
...
_Preview of the sticky navigation bar_
