...
> TL;DR (updated 2021) You can now use [dataunlocker.com](https://dataunlocker.com/) service, which is a fully managed solution for fixing ad blockers' impact on the client-side analytics tools such as Google Analytics. Log in to [DataUnlocker Admin](https://admin.dataunlocker.com/) to complete the quick 3-step setup of your web application or website.

> The article below from 2017 explains some principles used behind the [solution](https://github.com/dataunlocker/save-analytics-from-content-blockers), as well as it is described in the solution's [readme](https://github.com/dataunlocker/save-analytics-from-content-blockers#readme).
...
All the code and described steps below are available [on GitHub](https://github.com/dataunlocker/save-analytics-from-content-blockers). The description below explains the method basics, and of course the suggested approach can be improved to be even more “anti-blocking.”
...
Download the script directly from [_https://www.google-analytics.com/analytics.js_](https://www.google-analytics.com/analytics.js','ga'), open it with any text editor and replace all occurrences of:
...
Gathering all the files in the example together ([see GitHub](https://github.com/dataunlocker/save-analytics-from-content-blockers)), we should end up with the following JavaScript server code:
...
Again, the demo application is available [on GitHub](https://github.com/dataunlocker/save-analytics-from-content-blockers), feel free to test it! Let me know if you have any feedback or interesting experiences using this approach.
