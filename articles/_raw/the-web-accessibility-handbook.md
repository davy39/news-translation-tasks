...
* [What is Accessibility?](#heading-what-is-accessibility)
    
* [Basic Accessibility Practices](#heading-basic-accessibility-practices)
    
    * [Semantic and Non-Semantic HTML](#heading-semantic-and-non-semantic-html)
        
    * [Text Content](#heading-text-content)
        
    * [Page Layouts](#heading-page-layouts)
        
    * [Interactive Elements](#heading-interactive-elements)
        
    * [Keyboard Accessibility](#heading-keyboard-accessibility)
        
    * [Form Labels](#heading-form-labels)
        
    * [Links](#heading-links)
        
    * [Table Accessibility](#heading-table-accessibility)
        
* [Additional CSS and JavaScript Practices](#heading-additional-css-and-javascript-practices)
    
    * [Styling Form Elements](#heading-styling-form-elements)
        
    * [Color Contrast](#heading-color-contrast)
        
    * [JavaScript Practices](#heading-javascript-practices)
        
* [Advanced Accessibility Practices: WAI-ARIA](#heading-advanced-accessibility-practices-wai-aria)
    
    * [The role attribute](#heading-the-role-attribute)
        
    * [aria-\* attribute](#heading-aria--attribute)
        
    * [Dynamic Content Attributes](#heading-dynamic-content-attributes)
        
    * [Form Validation and Errors](#heading-form-validation-and-errors)
        
    * [Using non-semantic elements as buttons](#heading-using-non-semantic-elements-as-buttons)
        
* [Multimedia Accessibility](#heading-multimedia-accessibility)
    
* [Mobile Accessibility](#heading-mobile-accessibility)
...
People with visual impairments commonly use devices like [screen readers](https://axesslab.com/what-is-a-screen-reader/) to visualise and understand a website’s content, for example. So a big part of web accessibility is designing a website that can be easily accessed by a screen reader.
...
Semantic HTML tags clearly describe their purpose to the browser and the developers through their names. They improve code readability and also help with [SEO (Search Engine Optimisation)](https://seo.co/semantic-html/). Examples of semantic tags include: `<button>`, `<a>`, `<header>`, `<footer>`.

You can find a list of all semantic elements [here](https://developer.mozilla.org/en-US/docs/Glossary/Semantics#semantic_elements).
...
* Text color should have 4.5:1 contrast with the background. See the [Color Contrast](#heading-color-contrast) section for details.
    

If you want more tips on styling text, visit [MDN Docs - CSS Text Styling](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Text_styling).
...
These elements are called [sectioning elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Element#content_sectioning). Following are advantages of using these elements:
...
For instance, visit [this](https://mdn.github.io/learning-area/tools-testing/cross-browser-testing/accessibility/native-keyboard-accessibility.html) page and try to navigate to each interactive element by pressing Tab on your keyboard. You can also press Enter/Spacebar to click on a button or a link. This should give you an idea of what a keyboard-accessible website looks like.
...
Here, we have used the correct semantic elements for the hyperlink, button, and input element. All these elements can be accessed through Tab and interacted with using Enter/Spacebar. Check out other form-related elements in this [list](https://developer.mozilla.org/en-US/docs/Web/HTML/Element#forms).
...
The [`tabindex`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex) attribute takes an integer that specifies the tab order of tab-able elements, instead of the default top to bottom tab order. A positive integer means the element is focussed in an order specified by the attribute’s value.
...
Keyboard Accessibility is important for audio and video controls too. We’ll discuss this in the [Multimedia Accessibility](#heading-multimedia-accessibility) section.
...
Check out the [form with the label](https://mdn.github.io/learning-area/accessibility/html/good-form.html) and [form without the label](https://mdn.github.io/learning-area/accessibility/html/bad-form.html) in these examples for more clarity. Use Mac’s Voiceover (⌘+F5) or Windows’ Narrator (Ctrl+Windows+Enter) to see how it reads out the form elements.
...
* Clickable association with input field helps the user’s select small inputs like [checkboxes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/checkbox) or [radio buttons](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/radio).
...
When using an icon, make sure that you include the alt attribute with description about the image. We’ll understand its purpose in the [Multimedia Accessibility](#heading-multimedia-accessibility) section.
...
The skip link is keyboard accessible and is also read out by the screen reader. Clicking on it takes you straight to the main content. Visit [WebAIM](https://webaim.org/) and press Tab on your keyboard to see skip links in action.

#### Link Styling

By default, links created with the anchor tag are visually different from non-link text. This is because the anchor tag has built-in styles like colour, [text-decoration](https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration), focus-ring (displays when you tab on to the link with the keyboard) and hover effects.
...
* Links should have different colors for default, [visited](https://developer.mozilla.org/en-US/docs/Web/CSS/:visited), [focus](https://developer.mozilla.org/en-US/docs/Web/CSS/:focus) and [hover](https://developer.mozilla.org/en-US/docs/Web/CSS/:hover) states.
    
* Link text color should be different from the non-link text and should have different styling.
    
* Link text color should have a contrast of 3:1 between other text and 4.5:1 contrast between background color. See the [Color Contrast](#heading-color-contrast) section for more understanding
...
With the help of [pseudo-classes](https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-classes), this adds different styles for when link is hovered, previously visited, focussed (with the keyboard), or active (when the link is being clicked).
...
Links are used to navigate to another web page on the same website or navigate to an external website. Specifying the link in the [href](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#href) attribute does this for you without any need to add JavaScript code.
...
Check out the [Good Links](https://mdn.github.io/learning-area/accessibility/html/good-links.html) and [Bad Links](https://mdn.github.io/learning-area/accessibility/html/bad-links.html) examples from the docs. You can also test them with VoiceOver (⌘+F5).

#### Link Proximity

If your web page has a lot of interactive elements like links and buttons, ensure that they are spaced properly to prevent accidental clicks. This helps people with [Motor Control Issues](https://axesslab.com/hand-tremors/) that may click on the wrong link.

Using the [`margin`](https://developer.mozilla.org/en-US/docs/Web/CSS/margin) property should be enough to ensure spacing.
...
Check out [MDN Docs - Table Accessibility](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Structuring_content/Table_accessibility) to understand best practices.
...
![Recommended Color contrast ratios](https://cdn.hashnode.com/res/hashnode/image/upload/v1736175276741/40ee7fe4-110c-4dd1-95f3-4cb7620de032.png align="center")
...
* [Chrome Developer Tools](https://developer.chrome.com/docs/devtools/accessibility/contrast) - Identifies text in your website not meeting AA and AAA ratings
...
When you have functionality triggered by events like [mouse-over](https://developer.mozilla.org/en-US/docs/Web/API/Element/mouseover_event) and [mouse-out](https://developer.mozilla.org/en-US/docs/Web/API/Element/mouseout_event), they cannot be accessed by people that depend on keyboard navigation. So, to make the functionality accessible by keyboard, you need to add the same event handlers to events like [focus](https://developer.mozilla.org/en-US/docs/Web/API/Element/focus_event) and [blur](https://developer.mozilla.org/en-US/docs/Web/API/Element/blur_event).
...
Check out the [Form Validation](https://mdn.github.io/learning-area/accessibility/css/form-validation.html) Example to understand more.
...
But if you want to use a `div` instead of a button, you still need to add JavaScript functionality, as explained in the the [Keyboard Accessibility](#heading-keyboard-accessibility) section.
...
You can find the full list of available roles at [MDN Docs: WAI-ARIA Roles](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles).
...
If native semantic elements or the `role` attribute alone are not sufficient, aria-\* attributes can provide extra context. You can find a full list of these attributes in [MDN Docs-ARIA](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes).
...
Check out the [aria-no-live](https://mdn.github.io/learning-area/accessibility/aria/aria-no-live.html) example from MDN Docs. It loads a new quote every 10 seconds, which you can see clearly as a user with no visual impairment. But the screen reader only reads the initial page content and does not announce the updates. This is not good for accessibility.

To fix this, WAI-ARIA provides the [`aria-live`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-live) attribute that makes the screen reader read out content that is updated. You can add this attribute to the element that contains the dynamic content.
...
The [`aria-atomic`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-atomic) attribute tells screen readers to read out the entire element as a single atomic unit. This avoids confusion for visually impaired users. Check out the [aria-live](https://mdn.github.io/learning-area/accessibility/aria/aria-live.html) example from MDN Docs with Mac’s VoiceOver (⌘+F5). It reads out the entire element when the content is updated.
...
The [`alert`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/alert_role) role does two things. It semantically identifies this element as a piece of important information. Secondly, this role turns the element into a [live](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/ARIA_Live_Regions) region which means the screen reader is notified immediately if there are any changes.

The [`aria-relevant`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-relevant) attribute describes what changes need to be announced in a live region. The attribute takes a space-separated list of the following values:
...
You can check the [Form Validation Example](https://mdn.github.io/learning-area/accessibility/css/form-validation.html) from the MDN Docs.
...
This is helpful for regular users, but visually impaired users may get confused as to which fields are required. To make it easier for them, we can use the [`aria-required`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-required) attribute.
...
We have already discussed form labels in the [Interactive Elements](#heading-interactive-elements) section.

You’ve now seen some of the different attributes that WAI-ARIA offers and how they enhance accessibility. You can visit [MDN Docs: WAI-ARIA](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Accessibility/WAI-ARIA_basics#accessibility_of_non-semantic_controls_2) to check out additional details I may have missed.
...
When using the [&lt;audio&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio) and [&lt;video&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video) elements, remember to include multiple sources – that is, provide the audio and video in different formats. For browsers that do not support the formats you have mentioned, include a fallback download link so they can access the resource.
...
* The video player object is of type [`HTMLMediaElement`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLMediaElement), that contains several methods you can use to control the video.
...
Check out the [MDN Docs](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Accessibility/Multimedia#creating_custom_audio_and_video_controls) for more detail about this functionality.
...
If you run a business, you could pay a professional to do the transcripts. Check out the [docs](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Accessibility/Multimedia#audio_transcripts) for options. To show the transcript on the UI, you could use a show/hide panel. Referring to the docs, see the [audio transcript UI](https://mdn.github.io/learning-area/accessibility/multimedia/audio-transcript-ui/) ([source code](https://github.com/mdn/learning-area/tree/main/accessibility/multimedia/audio-transcript-ui)) for an example.
...
Save this file and name it with a `.vtt` extension. To link this file to your video, include it in a [`<track>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/track) element:
...
You can also add custom styling to subtitle menu and subtitle text. Check out [MDN Docs - Adding captions and subtitles to HTML video](https://developer.mozilla.org/en-US/docs/Web/Media/Guides/Audio_and_video_delivery/Adding_captions_and_subtitles_to_HTML5_video) for the implementation.
...
First, let’s talk about mouse-specific events. We have already seen how to make mouse-specific events accessible in the [JavaScript Practices](#heading-javascript-practices) section. Events like [mousedown](https://developer.mozilla.org/en-US/docs/Web/API/Element/mousedown_event) or [mouseup](https://developer.mozilla.org/en-US/docs/Web/API/Element/mouseup_event) are often used for drag and drop functionalities.

But these are not accessible for touchscreen users, so you should add the same functionality to touch-specific events like [touchstart](https://developer.mozilla.org/en-US/docs/Web/API/Element/touchstart_event) and [touchend](https://developer.mozilla.org/en-US/docs/Web/API/Element/touchend_event). The following example is in the context of drag and drop:
...
Next, you have to ensure that you are following responsive design when designing your web pages. Responsive designs make sure the website looks good on both desktop and mobile phones. I have written a detailed guide on [responsive design](https://medium.com/gitconnected/read-this-to-make-your-website-responsive-35af4ab7992b), so check it out if you are interested.
...
![Lighthouse audit with accessibility issues](https://cdn.hashnode.com/res/hashnode/image/upload/v1739631885589/c886f304-aba2-44ac-8d75-88fac2f60c55.png align="center")
...
![Lighthouse audit with good accessibility](https://cdn.hashnode.com/res/hashnode/image/upload/v1739632090527/2db4798a-53d3-4010-9756-83de8b0f208a.png align="center")
...
![Rendering tool](https://cdn.hashnode.com/res/hashnode/image/upload/v1741959781294/36f6c233-9326-4acb-a551-e95a56a87d8a.png align="center")
...
Apart from the Developer Tools, there’s an NPM plugin called [eslint-plugin-jsx-a11y](https://www.npmjs.com/package/eslint-plugin-jsx-a11y) that evaluates React JSX code for accessibility issues.

You can find all the code snippets on [GitHub](https://github.com/KunalN25/accessibilityguide).
...
* [Web Dev Simplified- Guide on Accessibility](https://www.youtube.com/watch?v=2oiBKSjOOFE)
