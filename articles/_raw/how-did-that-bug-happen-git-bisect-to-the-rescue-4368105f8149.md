...
`git bisect` is a very handy command that lets you [isolate which commit introduced a bug](https://git-scm.com/docs/git-bisect). You tell it which version of your repository was bug-free, and it runs a [binary search](https://en.wikipedia.org/wiki/Binary_search_algorithm) between your current commit and the one that seems to have bug, asking you to confirm whether the bug seems to be there at each step of the search.
...
_Originally published at [odino.org](https://odino.org/how-did-that-bug-happen-git-bisect-to-the-rescue/) (24th June 2018)._  
