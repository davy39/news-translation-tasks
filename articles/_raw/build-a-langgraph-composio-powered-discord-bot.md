...
If you’re not confident about any of these, try following along anyway. You might pick things up just fine. And if it ever gets confusing, you can always check out the full source code [here](https://github.com/shricodev/discord-bot-langgraph-composio).
...
* [How to Set Up the Environment](#heading-how-to-set-up-the-environment)
    ...
    * [Configure Composio](#heading-configure-composio)
        
    * [Configure Discord Integration](#heading-configure-discord-integration)
        
    * [Add Environment Variables](#heading-add-environment-variables)
        
* [Build the Application Logic](#heading-build-the-application-logic)
    
    * [Define Types and Utility Helpers](#heading-define-types-and-utility-helpers)
        
    * [Implement LangGraph Workflow](#heading-implement-langgraph-workflow)
        
    * [Set Up Discord.js Client](#heading-set-up-discordjs-client)
...
* [discord.js](https://discord.js.org): Interacts with the Discord API
    
* [composio](https://composio.dev): Adds tools integration support to the bot
    
* [openai](https://platform.openai.com): Enables AI-powered responses
    
* [langchain](https://www.langchain.com): Manages LLM workflows
    
* [zod](https://zod.dev): Validates and parses data safely
...
![Composio dashboard](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/lkr1pys0txedp9vam4tt.png align="left")
...
![Output of the `composio whoami` command](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/ifzbkw6u6bwnj68lwqxt.png align="left")
...
![Add Composio Google Sheets integration](https://cdn.hashnode.com/res/hashnode/image/upload/v1750336813743/9079ef2b-dc2a-4b10-b001-50e4cf98f3c5.png align="center")

Head over to the URL that’s shown, and you should be authenticated like so:

![Composio authentication success](https://cdn.hashnode.com/res/hashnode/image/upload/v1750325571006/b0864445-7471-471f-88eb-f2ec8d832b39.png align="center")
...
![Composio list of integrations](https://cdn.hashnode.com/res/hashnode/image/upload/v1750325653419/4585b63a-5581-4102-92e4-a55dca018063.png align="center")
...
You can find a guide on how to create and add a bot to your server in the [Discord.js](https://discordjs.guide/preparations/adding-your-bot-to-servers.html#bot-invite-links) documentation.
...
![LangGraph nodes for the Discord bot workflow](https://cdn.hashnode.com/res/hashnode/image/upload/v1750327093884/fa8e6b4e-ca61-4900-9b3b-7b3a2863c296.png align="center")
...
![Command failed output for deploying slash command to Discord](https://cdn.hashnode.com/res/hashnode/image/upload/v1750340614800/ce0b37bc-647c-4b94-9099-2e396b0ffa93.png align="center")
...
These are quite standard, and there are many more based on different use cases. You can always check them all out [here](https://discordjs.guide/popular-topics/intents.html#privileged-intents).
...
If you got lost somewhere while coding along, you can find the source code [here](https://github.com/shricodev/discord-bot-langgraph-composio).
