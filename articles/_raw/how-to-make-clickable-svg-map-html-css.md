...
- name: SVG
  slug: svg
seo_title: null
seo_desc: "SVG, or Scalable Vector Graphics, is a versatile image format that you\
  \ can use in a wide range of applications, from web design to print media and data\
  \ visualization. \nThe scalability, small file size, and accessibility of SVG images\
  \ make this format..."
---
...
Stears and The BBC used SVG Maps to visualize election data. Users can click on a region to see the distribution of ballots cast. See [here](https://www.stears.co/elections/2023/president/) for more info.

%[https://youtu.be/RCUkQhGGxxM]
...
You can create an SVG map using vector graphics software such as [Adobe Illustrator](https://www.youtube.com/watch?v=GsojLuJpe_0) or Inkscape, or with code using libraries such as D3.js or Leaflet.    
  
You can also download SVG maps from Wikipedia using a creative-commons license. Click [here](https://upload.wikimedia.org/wikipedia/commons/2/24/West-Africa.svg) for the map we'll use in this tutorial.  
...
You may notice the `xlink` prefix on the attributes. This supports earlier browser versions. You can use the deprecated `xlink:href` attribute as a fallback in addition to the href attribute. See more info [here](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/xlink:href).
...
* `#mapsection`: This targets SVG elements with the ID _mapsection_. It sets the width to 50%, height to auto, and stroke properties for the element.
* `#mali`, `#Benin`, `#Nigeria`, `#Zimbabwe`, `#Zambia`, and `#Somalia`: These target specific `path` elements with IDs corresponding to their country names. They set the _fill_ color for each country.
...
Click here to see the live [demo](https://rufai.github.io/buildingx/TourAfrique/).   
  
Find the complete code [here](https://github.com/rufai/rufai.github.io/tree/master/buildingx/TourAfrique).
