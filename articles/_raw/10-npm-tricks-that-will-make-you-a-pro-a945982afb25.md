...
_One project and one package._
...
_The outdated list is really beautiful!_
...
_As you can see, npm-update-all will update all your packages to the latest version._
...
_Run your scripts with a click of a button! VSCode supports listing scripts from multiple packages at the same time._
