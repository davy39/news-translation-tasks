...
We just released a tutorial on the freeCodeCamp.org YouTube channel that will teach you how to create a discord chat bot that talks like a character of your choice. You will learn to create the bot in both Python and JavaScript.
...
* Build the Discord bot in JavaScript
...
Watch the course below or [on the freeCodeCamp.org YouTube channel](https://www.youtube.com/watch?v=UjDpW_SOrlw) (1-hour watch).
...
So now we're going to repeat the process for the JavaScript bot.

So we go back to the discord developer portal, and create a new application.

This time, I'm going to call it chatty bots, JavaScript.
...
Go to my GitHub repository, there is a discord bots.js file that contains the code that we will use for this JavaScript chatbot.

Let's copy paste.

And I'll go through the code line by line.

So first, we import the discord CPI for the JavaScript module.
...
So in permissions, we find this chat about JavaScript.
...
Now that we are logged in as chatty about JavaScript 1048 let's go back to our discord channel.
...
And the JavaScript bots shouldn't be able to talk here.

And in our general channel, nobody is ever allowed to talk here.

Cool.

So now we have successfully built the bot both in Python and in JavaScript.
...
We know that our web server approach has worked Now let's repeat this process for the JavaScript bot.
...
We have a cool Python chat bot and a cool JavaScript chat bot not can run indefinitely.
