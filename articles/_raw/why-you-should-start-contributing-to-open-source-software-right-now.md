...
co_authors: []
series: null
date: '2020-09-10T08:22:00.000Z'
originalURL: https://freecodecamp.org/news/why-you-should-start-contributing-to-open-source-software-right-now
coverImage: https://www.freecodecamp.org/news/content/images/2020/09/work-desk-with-various-items.png
tags:
- name: GitHub
  slug: github
- name: open source
...
seo_title: null
seo_desc: "By Markus Hatvan\nYou might not be aware of it, but you use some form of\
  \ open source software every single day. \nEvery time you start an app on your phone\
  \ or launch a program on your computer, you profit from the code that someone has\
  \ written for free..."
---
...
WordPress, the largest and most well-known content management system, is used by [38% of all websites](https://w3techs.com/technologies/details/cm-wordpress) worldwide. It is open source and free to use.

Linux powers [30% of all websites](https://w3techs.com/technologies/details/os-linux) globally. It is open source and free.
...
According to the [State of the Octoverse report](https://octoverse.github.com/) by GitHub, out of more than 40 million developers on GitHub, 10 million new users joined in 2019 alone!
...
A good example is the well-known code editor [Visual Studio Code](https://github.com/microsoft/vscode) which got very popular and has a total of 1,200+ contributors on GitHub. 
...
I wrote lint rules for JavaScript projects called [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) and [svelte](https://github.com/sveltejs/svelte). It's a great feeling knowing that my pull request will improve the code quality of many developers all around the world. 
...
With websites like [OpenCollective](https://opencollective.com/) or [GitHub Sponsors](https://github.com/sponsors), you can donate to speed up the development of projects that you like.
...
The `README.md` file of a project usually includes a passage on how to contribute.

If you decide to contribute to a project, I recommend reading my article about [Contributing To Open Source Projects The Right Way](https://markushatvan.com/blog/contributing-to-open-source-projects-the-right-way). It's a detailed step-by-step guide about the contribution workflow. 
...
If you liked the article, you can connect with me through these channels:
