...
co_authors: []
series: null
date: '2018-04-10T19:17:26.000Z'
originalURL: https://freecodecamp.org/news/how-to-organize-your-thoughts-on-the-whiteboard-and-crush-your-technical-interview-b668de4e6941
coverImage: https://cdn-media-1.freecodecamp.org/images/1*3xaKKtplALFR5Jhm9ODXsQ.png
tags:
- name: Life lessons
  slug: life-lessons
...
seo_desc: 'By Doug Arcuri
  ...
  On organizational skills and the applied science of gluing lots of things together
  in the craft of software engineering


  _The [ABC’s of Programming](http://arthur-johnston.com/abcs/" rel="noopener" target="blank"
  title=") did not inclu...'
---
...
![Image](https://cdn-media-1.freecodecamp.org/images/nr4-uz-0grKWKASaukL9ZmlB53DbS05ocd8t)
_The [ABC’s of Programming](http://arthur-johnston.com/abcs/" rel="noopener" target="_blank" title=") did not include O for Organization._

Some weeks ago, a bright individual reposted on [Hacker News](https://news.ycombinator.com/item?id=16703553) a well-thought out and succinct post about [the most important skill in software development](https://www.johndcook.com/blog/2015/06/18/most-important-skill-in-software/). In this post, John D. Cook pointed out a quote from the article [Organizational Skills Beat Algorithmic Wizardry](http://prog21.dadgum.com/177.html), by James Hague. Both authors tackle the software engineering subject of **organization** **as a skill**. They contrast this to the mastery of computer science tested in interviews, taught in academia, or touted in blog posts. Their contemplation got me pondering about how our craft could be improved.
...
Rarely at a whiteboard does anyone perform well. You have to show a masterful thought process and hold a lot in your head. You have to communicate, but how do you communicate while ignoring the screaming voice in your head that says “[hurry up](https://twitter.com/dougarcuri/status/974631783454117889)!” while moving around enthusiastically?
...
![Image](https://cdn-media-1.freecodecamp.org/images/-HAbsJmoAIRdELQHI8RvBtTWsP8UJamCLic4)
_A typical 5' by 3' whiteboard cut into three sections._
...
![Image](https://cdn-media-1.freecodecamp.org/images/1rWyb8VlNsRkDJuO3JVJPwKOK1aJ6jJse86e)
_A problem statement above is very important to look over._
...
![Image](https://cdn-media-1.freecodecamp.org/images/Kx78DCzOWsekTcYbq7IHTLHPiI86LGMeLiki)
_Assumptions are all the questions need answering._
...
![Image](https://cdn-media-1.freecodecamp.org/images/KaGXec4BDotCR4yui4XjlYCaou68b3k8s7NO)
_Approach is the strategy, the structure and the visualization scratch pad._
...
![Image](https://cdn-media-1.freecodecamp.org/images/D7wu7tK8joDe2EtBsBUJstNdCUH6hZZ2TLfL)
_The main event is centered so it can be supported from all sides._
...
![Image](https://cdn-media-1.freecodecamp.org/images/CXfiUeO43n5271PhhKqn5FPG5xvheGJQMYXE)
_Tests should never be optional._
...
![Image](https://cdn-media-1.freecodecamp.org/images/aAuYzHGrTqKnY7xJ1B4K1GmBryaY3iNX67y8)
_Approaching the actual organization problem with a solution. If you are left handed, try reversing the setup_
...
Remember, there is pride in improving on top of code by way of organization and structure. I’ve written a [few](https://hackernoon.com/the-springboard-pattern-340e00379404) [posts](https://hackernoon.com/no-description-provided-8d9e0f3a3abb) about organization and the [subject](https://hackernoon.com/the-decision-hypothesis-aa512e0113) linking organization to system complexity. There is a strong link. This is why I appreciated John’s and James’ thoughts deeply. They are organized messages without _hurry up_ time expiration.

![Image](https://cdn-media-1.freecodecamp.org/images/-6Qm9owYwAYEHCUXT67dk0t6-vvKZOCw1KiL)
_What it may look like on a first try. Try iterating to discover more patterns._

_If you find yourself in this [situation](https://www.youtube.com/watch?v=XKu_SEDAykw), ask for a larger whiteboard!_
