...
* [How Does the Global Execution Context Work?](#heading-how-does-the-global-execution-context-work)
    
* [Memory Creation Phase](#heading-memory-creation-phase)
    
* [Understanding the Flowchart](#heading-understanding-the-flowchart)
    
* [What Exactly is Hoisting?](#heading-what-exactly-is-hoisting)
    
* [Does Only var Get Hoisted?](#heading-does-only-var-get-hoisted)
    
* [Temporal Dead Zone (TDZ) – What is it Really?](#heading-temporal-dead-zone-tdz-what-is-it-really)
    
* [Function Hoisting – The Most Interesting Part!](#heading-function-hoisting-the-most-interesting-part)
    
* [What Happens in the Memory Phase:](#heading-what-happens-in-the-memory-phase)
...
![Flowchart diagram illustrating JavaScript Global Execution Context workflow, showing the two phases - Memory Creation Phase where variables and functions are allocated, and Code Execution Phase where code runs line by line, including how Function Execution Context is created when functions are called](https://cdn.hashnode.com/res/hashnode/image/upload/v1761988425883/33792916-eee7-4f87-b365-51a04290aa96.png align="center")
