...
* [What is Named Entity Recognition?](#heading-what-is-named-entity-recognition)
    
* [What is Hugging Face Transformers?](#heading-what-is-hugging-face-transformers)
    
* [How to Build the News Analyzer](#heading-how-to-build-the-news-analyzer)
    
* [Accuracy in NER](#heading-accuracy-in-ner)
    
* [Other Use Cases](#heading-other-use-cases)
...
[**Hugging Face Transformers**](https://huggingface.co/docs/transformers/en/index) is a Python library that gives you access to some of the most advanced NLP models out there.
...
The library provides a simple `pipeline()` function that lets you run complex tasks like NER in just a few lines of code. You can find many pre-trained models at [**huggingface.co/models**](http://huggingface.co/models).

For this project, we’ll use one that’s been fine-tuned for English NER.

## **How to Build the News Analyzer**

Let’s build the news analyzer. [**Here is a Google colab notebook**](https://colab.research.google.com/drive/1Bd3mMGCv5izBwEyfI8VrOVtVtMRy-1yt?usp=sharing) if you want to try this hands on.
...
We’ll use feedparser to get news articles. Here’s how you fetch and print out summaries from [**CNN’s RSS feed**](http://rss.cnn.com/rss/money_topstories.rss)**:**
...
![RSS articles](https://cdn.hashnode.com/res/hashnode/image/upload/v1746721895350/6af303c4-a0f4-429b-b09c-07d3d989c8d8.png align="center")
...
![NER Response](https://cdn.hashnode.com/res/hashnode/image/upload/v1746721942832/05a4dbf1-dcd6-4d99-a6dc-96dcca170b5c.png align="center")
...
* **Combine NER with other techniques:** Pair it with [sentiment analysis](https://www.freecodecamp.org/news/what-is-sentiment-analysis-a-complete-guide-to-for-beginners/), keyword matching, or frequency counts to make the data more reliable and actionable.
...
If you enjoy online games, check out [GameBoost](https://gameboost.com/)[,](https://gameboost.com/) the ultimate marketplace for gamers. You can find in-game items that help you level up faster, like [*Grow a Garden*](https://gameboost.com/grow-a-garden/items)*, Fortnite, Clash of Clans* and many more.
