...
I’ve had a bitter-sweet relationship with [Vim](http://(https://vim.sourceforge.io/about.php) for a long time.
...
_This would take some **really** bad luck…_
...
To **d**elete everything **i**nside a pair of parentheses, you would type `di(`. And on it goes.
