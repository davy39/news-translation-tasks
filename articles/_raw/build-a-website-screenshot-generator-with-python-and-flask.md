...
You’ll use [**Flask**](https://blog.ashutoshkrris.in/getting-started-with-flask), a lightweight web framework, to create a simple web interface and handle requests. Then, you’ll integrate an external API to capture website screenshots programmatically.
...
* [Integrating the ScreenshotBase API](#heading-integrating-the-screenshotbase-api)
    
* [Adding Customization Options](#heading-adding-customization-options)
...
If you don’t have it, you can download it from [python.org/downloads](https://www.python.org/downloads/).
...
We’ll be using the [**ScreenshotBase API**](https://screenshotbase.com/) to capture website screenshots. It provides a simple REST endpoint that takes a URL and returns a screenshot image.
...
You can explore them in the [ScreenshotBase SDK documentation](https://screenshotbase.com/docs/sdks).
