...
You can also download the Git Cheat Sheet in PDF format (along with some other resources) for free by joining my newsletter at [flaviocopes.com/access](https://flaviocopes.com/access/).

## Table of Contents

* [**Preface**](#heading-preface)
    
* [**Basic Git Commands**](#heading-basic-git-commands)
    
* [**The Working Directory and the Staging Area**](#heading-the-working-directory-and-the-staging-area)
    
* [**Working with Branches**](#heading-working-with-branches)
    
* [**Merging in Git**](#heading-merging-in-git)
    
* [**Git Remotes**](#heading-git-remotes)
    
* [**Amending Commits**](#heading-amending-commits)
    
* [**Stashing in Git**](#heading-stashing-in-git)
    
* [**Git Tagging**](#heading-git-tagging)
    
* [**Reverting Changes in Git**](#heading-reverting-changes-in-git)
    
* [**Viewing History Logs**](#heading-viewing-history-logs)
    
* [**Git Diffs**](#heading-git-diffs)
    
* [**Git Flow**](#heading-git-flow)
    
* [**Exploring Git References**](#heading-exploring-git-references)
    
* [**How to Configure Git**](#heading-how-to-configure-git)
    
* [**Git Security**](#heading-git-security)
    
* [**How to Set Aliases in Git**](#heading-how-to-set-aliases-in-git)
    
* [**Rebasing in Git**](#heading-rebasing-in-git)
    
* [**What is Cherry-Picking?**](#heading-what-is-cherry-picking)
    
* [**Patching in Git**](#heading-patching-in-git)
    
* [**Relative Dates in Git**](#heading-relative-dates-in-git)
    
* [**Git Blame**](#heading-git-blame)
    
* [**Archiving in Git**](#heading-archiving-in-git)
    
* [**How to Track Files in Git**](#heading-how-to-track-files-in-git)
    
* [**Index Manipulation in Git**](#heading-index-manipulation-in-git)
    
* [**Squashing in Git**](#heading-squashing-in-git)
    
* [**Data Integrity in Git**](#heading-data-integrity-in-git)
    
* [**Cleaning Up in Git**](#heading-cleaning-up-in-git)
    
* [**Git Subtree**](#heading-git-subtree)
    
* [**How to Search in Git**](#heading-how-to-search-in-git)
    
* [**Bisecting in Git**](#heading-bisecting-in-git)
    
* [**Git Attributes**](#heading-git-attributes)
    
* [**Git Checkout**](#heading-git-checkout-2)
    
* [**Git Reflog**](#heading-git-reflog)
    
* [**How to Handle Untracked Files in Git**](#heading-how-to-handle-untracked-files-in-git)
    
* [**Force Pushing in Git**](#heading-force-pushing-in-git)
    
* [**Git Fetching and Pulling**](#heading-git-fetching-and-pulling)
    
* [**How to Handle Merge Conflicts in Git**](#heading-how-to-handle-merge-conflicts-in-git)
    
* [**Working Trees in Git**](#heading-working-trees-in-git)
    
* [**Submodules in Git**](#heading-submodules-in-git)
...
Creates a new branch named &lt;new\_branch&gt; with no commit history, effectively starting a new branch that begins with a clean working directory and index, as if it were a new repository.
