...
co_authors: []
series: null
date: '2024-05-30T15:26:47.390Z'
originalURL: https://freecodecamp.org/news/learn-the-basics-of-go-by-building-a-full-stack-web-app-with-react-and-go
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1717082781962/c90d205c-48ae-42bf-a88e-52161ef1aee0.png
tags:
- name: Go Language
  slug: go
- name: React
...
- name: youtube
  slug: youtube
seo_title: null
seo_desc: Go can work great on the backend for a React project. We just released a
  course on the freeCodeCamp.org channel that will leach you how to build a full stack
  web app with React and Go. This comprehensive course is designed to teach you the
  fundamenta...
---
...
Whether you're a beginner looking to learn Go or an experienced developer wanting to expand your skill set, this course has something for everyone. Watch the course on [the freeCodeCamp.org YouTube channel](https://www.youtube.com/watch?v=lNd7XlXwlho) (2-hour watch).
