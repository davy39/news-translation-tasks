...
* [Case study: A Bank Teller](#heading-case-study-a-bank-teller)
* [Sequential Processing](#heading-sequential-processing-no-concurrency)
* [Concurrency](#heading-concurrency)
* [What are Goroutines and Channels?](#heading-what-are-goroutines-and-channels)
* [What is a Goroutine?](#what-is-a-gourotine)
* [How to Implement a Goroutine](#heading-how-to-implement-a-goroutine)
* [How Does a Goroutine Work?](#heading-how-does-a-goroutine-work)
* [What are waitGroups?](#heading-what-are-waitgroups)
* [What are Channels?](#heading-what-are-channels)
* [How to Write Data to a Channel](#heading-how-to-write-data-to-a-channel)
* [How to Read Data from a Channel](#heading-how-to-read-data-from-a-channel)
* [How to Implement Channels with Goroutine](#heading-how-to-implement-channels-with-goroutine)
* [What are Channel Buffers?](#heading-what-are-channel-buffers)
* [What is an Unbuffered Channel?](#heading-what-is-an-unbuffered-channel)
* [How to Create a Buffered Channel](#heading-how-to-create-a-buffered-channel)
* [What are Channel Directions?](#heading-what-are-channel-directions)
* [How to Handle Multiple Communication Operations with Channel Select](#heading-how-to-handle-multiple-communication-operations-with-channel-select)
* [How to Timeout Long Running Processes in a Channel](#how-to-timeout-long-running-process-in-a-channel)
* [How to Close a Channel](#heading-how-to-close-a-channel)
* [How to Iterate Over Channel Messages](#heading-how-to-iterate-over-channel-messages)
