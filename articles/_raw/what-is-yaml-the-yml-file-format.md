...
1. [What is YAML?](#intro)
2. [XML VS JSON VS YAML - What's The Difference?](#differences)
    1. [XML](#xml)
    2. [JSON](#json)
    3. [YAML](#yaml)
3. [Features and basic rules of YAML](#features-and-rules)
    1. [How to create a YAML file](#create-file)
    2. [Multi-document support in YAML](#multi-document)
    3. [Indentation in YAML](#indentation)
    4. [Tabs in YAML](#tabs)
    5. [Whitespace in YAML](#whitespace)
    6. [Explicit data types in YAML](#explicit-data-types)
4. [An introduction to YAML syntax](#syntax)
    1. [Scalars](#scalars)
    2. [Collections](#collections)

## What is YAML? <a name="intro"></a>
...
## XML VS JSON VS YAML - What's The Difference? <a name="differences"></a>
...
## Features and Basic Rules of YAML <a name="features-and-rules"></a>

Now, let's go over some of the basic rules and features of the language.

### How to Create a YAML File <a name="create-file"></a>

To create a YAML file, use either the `.yaml` or `.yml` file extension.

### Multi-Document Support in YAML <a name="multi-document"></a>
...
### Indentation in YAML <a name="indentation"></a>
...
### Explicit Data Types in YAML <a name="explicit-data-types"></a>
...
## An Introduction to YAML Syntax <a name="syntax"></a>
