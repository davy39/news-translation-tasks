...
* [What is Social Authentication?](#heading-what-is-social-authentication)
    
    * [What is Strapi?](#heading-what-is-strapi)
        
    * [What is Nuxt.js?](#heading-what-is-nuxtjs)
        
    * [What Will You Learn in This Guide?](#heading-what-will-you-learn-in-this-guide)
        
* [Prerequisites](#heading-prerequisites)
    
* [How to Set Up Strapi for Social Authentication](#heading-how-to-set-up-strapi-for-social-authentication)
    
    * [How to Set Up Strapi’s Providers](#heading-how-to-set-up-strapis-providers)
        
    * [How to Create GitHub’s Oauth App](#heading-how-to-create-githubs-oauth-app)
        
    * [How to Connect Github OAuth APP to Provider on Strapi](#heading-how-to-connect-github-oauth-app-to-provider-on-strapi)
        
    * [How to Test the Strapi API](#heading-how-to-test-the-strapi-api)
        
* [How to Set Up Nuxt.js for Social Authentication](#heading-how-to-set-up-nuxtjs-for-social-authentication)
...
![Strapi's Installation interface on Virtual Studio Code](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729719988851_Screenshot+2024-10-23+at+22.23.44.png align="left")
...
![VS Code Terminal Interface for a running Strapi project](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729722404206_Screenshot+2024-10-23+at+23.26.03.png align="left")
...
![Strapi Admin Registration Interface](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729722491173_Screenshot+2024-10-23+at+23.28.01.png align="left")
...
![Strapi Welcome Page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729722679829_Screenshot+2024-10-23+at+23.28.50.png align="left")
...
![Strapi Settings Page Overview](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729722965788_Screenshot+2024-10-23+at+23.35.39.png align="left")

Scroll down and Click on Providers in the Users & Permissions plugin section:

![The Strapi's Providers page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729723008188_Screenshot+2024-10-23+at+23.36.35.png align="left")

You will see this list of Providers to select from. For this article, select GitHub by clicking the pen icon on the right:

![Editing the Github providers setting](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729723164437_Screenshot+2024-10-23+at+23.39.11.png align="left")
...
![Github Explore Page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729716332697_Screenshot+2024-10-23+at+21.45.06.png align="left")

Then navigate to your Developer Settings:

![Profile Settings Page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729716365753_Screenshot+2024-10-23+at+21.45.18.png align="left")

Select OAuth Apps and New OAuth app:

![Developer Settings Page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729716462052_Screenshot+2024-10-23+at+21.46.56.png align="left")
...
![OAuth's APP registration Page](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729716551370_Screenshot+2024-10-23+at+21.48.51.png align="left")

Go ahead and click “Register application”, and you will see your Client ID. Now you need to generate your Client Secret:

![Github Application successfully created.](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729723880674_Screenshot+2024-10-23+at+23.49.35.png align="left")
...
![Adding Github Provider to Strapi](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729723954537_Screenshot+2024-10-23+at+23.52.13.png align="left")

You can save everything now, and your GitHub Provider should be enabled.

![Strapi's Provider Interface](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729724039006_Screenshot+2024-10-23+at+23.53.23.png align="left")
...
![Strapi Interface for Roles: Authenticated and Public](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729724464559_Screenshot+2024-10-24+at+00.00.46.png align="left")
...
![Strapi's Public Role Interface](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729724599165_Screenshot+2024-10-24+at+00.02.09.png align="left")
...
![Postman's Interface for testing APIs.](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729725634296_Screenshot+2024-10-24+at+00.20.16.png align="left")
...
![Interface for authorizing Strapi](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729725737744_Screenshot+2024-10-24+at+00.22.04.png align="left")
...
![VS code interface for installing NUXT](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729732718758_Screenshot+2024-10-24+at+01.52.37.png align="left")

Open your project and run `npm run dev` to get it started:

![Interface for a running Nuxt project.](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729734102247_Screenshot+2024-10-24+at+02.40.17.png align="left")
...
![Nuxt application interface on browser.](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1729734185176_Screenshot+2024-10-24+at+02.42.51.png align="left")

In your code editor, delete the `Tutorial.vue` in the components folder and go to `index.vue` in the pages folder. There, you’ll want to add the following:
...
This code provides you with a simple homepage and a link to the login page which currently leads to a 404 page. In your pages folder, create `login.vue` and add the following code:
...
In your pages folder, create a folder called `connect`, and then inside that a file named `_provider.vue`, and add the following code to handle the callback function:
...
![Nuxt File structure on VScode](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1730069360059_Screen+Shot+2024-10-27+at+11.47.45+PM.png align="left")

The code in `_provider.vue` handles redirects from the Strapi backend. Nuxt.js has a routing pattern that takes advantage of /connect/\*provider where, in this case, the provider is GitHub.

It gets an access token which is stored as `access_token`, then makes an API call to the backend in the mounted lifecycle method. This returns a response that contains the user and a JWT. It stores the user and JWT in both cookies and localStorage using a package called [@nuxtjs/auth-next](https://auth.nuxtjs.org/), then redirects the user to the user account page.
...
Next, you’ll need the [@nuxtjs/axios](https://axios.nuxtjs.org/) and [@nuxtjs/strapi](https://strapi.nuxtjs.org/) packages to fetch data from the backend. [@nuxtjs/axios](https://axios.nuxtjs.org/) is already integrated when installing Nuxt, but you have to set your baseurl.
...
Then install [@nuxtjs/strapi](https://strapi.nuxtjs.org/) using the following command:
...
![Content Manager Interface on Strapi showcasing Users](https://paper-attachments.dropboxusercontent.com/s_604FB5A9DF1492F56A770C5B36ABD7454099B52858C205A9399E3B1409CA50D8_1730072300480_Screen+Shot+2024-10-28+at+12.36.40+AM.png align="left")
