...
* [What is Platform-Agnosticism?](#heading-what-is-platform-agnosticism)
* [How Native and other Cross-Platform Apps work](#heading-how-native-and-other-cross-platform-apps-work)
* [How Flutter Apps are Different from their Host Apps](#heading-how-flutter-apps-are-different-from-their-host-apps)
* [How Does Flutter Render User Interfaces (UIs)?](#heading-how-does-flutter-render-user-interfaces-uis)
* [How Do Platform Channels Work in Flutter?](#heading-how-do-platform-channels-work-in-flutter)  
- [Method Channels](#heading-method-channels)  
- [Event Channels](#heading-event-channels)  
- [Packages and Plugins](#heading-packages-and-plugins)
...
![How Native Apps Work](https://www.freecodecamp.org/news/content/images/2024/05/native_apps.png)
_How Native Apps Work_
...
![How Cross-Platform Apps Work](https://www.freecodecamp.org/news/content/images/2024/05/other_cross_platform_apps.png)
_How Cross-Platform Apps Work_
...
When Flutter builds an app for a target platform, it ships an _inner Flutter app_ and the Flutter engine within the built app. For example, when we build a Flutter codebase for Android, we will obtain an APK (an Android "installable"). Within this Flutter-built APK will be the Flutter engine and the Flutter app.
...
![How Flutter Apps Work](https://www.freecodecamp.org/news/content/images/2024/05/flutter_apps.png)
_How Flutter Apps Work_
...
The Flutter engine uses [Skia](https://skia.org) or [Impeller](https://docs.flutter.dev/perf/impeller) for low-level rendering tasks. Skia is an open-source graphics library with a robust set of drawing capabilities. Skia makes it possible to create smooth UIs.
...
![The "Canvas"es used by Flutter for Each Platform ](https://www.freecodecamp.org/news/content/images/2024/05/image.png)
_The "Canvas"es used by Flutter for Each Platform_

![The rendering layers of Flutter Apps in Operating Systems and Browsers](https://www.freecodecamp.org/news/content/images/2024/05/image-4.png)
_The rendering layers of Flutter Apps in Operating Systems and Browsers_
...
![Systematic Diagram of MethodChannels](https://www.freecodecamp.org/news/content/images/2024/05/platform-channels.png)
_Systematic Diagram of MethodChannels_
...
![Platform Channels Programming Languages ](https://www.freecodecamp.org/news/content/images/2024/05/image-5.png)
_Platform Channels Programming Languages_
