...
_1st generation(left) and a 2nd generation Seoul Bike(right), a [gift from the Dutch embassy to Seoul City](https://www.dutchcycling.nl/news/140-dutch-prime-minister-donates-bikes-to-seoul" rel="noopener" target="_blank" title=")._
...
_On-bicycle touch screen interface._
...
_Solid Line: in-app; Dashed Line: on-bicycle interface._
...
_The first screen you see when you open the app._
...
_Once logged in on a device, the profile is stored in the device (e.g. Facebook, Daum, Twitter etc.)_
...
_The main screen contains other rent option wit just a click of a button._
...
_English language support for foreign visitors and expats who do not speak Korean._
...
_Less complication was the main target when designing this page._
...
_The logo that set the Korean design community on fire._

![Image](https://cdn-media-1.freecodecamp.org/images/Syo3i-BU7dLHt0ZhCDKbBAcoKVsnaMRtoj4f)
_Brand consistency is something that should be enforced throughout all Seoul City services._
...
### Download the free UI Kit [here](https://martintotev.github.io/uikit.html).
...
You can find me at [martintotev.github.io](http://martintotev.github.io), follow me on twitter [@martintotevUX](https://twitter.com/martintotev89) or shoot me an email at martintotev89@gmail.com
