...
* [What is the Spring Framework?](#heading-what-is-the-spring-framework)
    
* [What is the Spring Boot Framework?](#heading-what-is-the-spring-boot-framework)
    
* [Core Differences Between Spring and Spring Boot](#heading-core-differences-between-spring-and-spring-boot)
    
* [Real World Example](#heading-real-world-example)
    
* [How to Choose Between Spring and Spring Boot](#heading-how-to-choose-between-spring-and-spring-boot)
...
![Image containing the Spring Framework Runtime Components](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdVmXBnm1fS-t0pN7w-zAglYvKrx37zoEZ4HdeszACcU8Ig4PFs_mKlfU49SALDAtrWUE1bj8bZ6lnvDoc4SoM_VxH5Nerime9uuNlIc5S6picvT3ho6Jv8dEmFTv7zrOKFNVDMxg?key=Zq-Isk9ZAG_nIZ1YfHDMRfMs align="left")

Image [source](https://docs.spring.io/spring-framework/docs/3.2.x/spring-framework-reference/html/overview.html) | Overview of the Spring Framework
...
Meanwhile, configuration in Spring Boot is easier as you can use the [Spring Initializr website](https://start.spring.io/). There, you just have to select the dependencies for the project, add a little more setup, and then download the zip file that contains the configuration for the project. It requires minimal steps to do this, which improves your productivity and makes the learning curve easier.
...
In Spring Boot, you can either go straight into your IDE and start creating the needed files and configurations for your project, or you can choose to use the [Spring initializr](https://start.spring.io/) to select dependencies and generate the base files and configurations for your project. The second option is preferred since it is less tedious.

#### Step 1: Choose Necessary Dependencies for Your Project and Download the Zip File

Open the [Spring initializr](https://start.spring.io/) website, choose the project as Maven, language as Java, and fill in the project metadata. For this project, fill in the Artifact as Hello. 

![Image showing how to correctly fill the metadata for a Spring Boot project from the Spring initializer website](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe41zF3IjWT8f8yW1kNlD4in3jhPev8DAm6lrIXf1anqZiZnCQtHfEavLP1u0DxMJ-h8crZVfsVcAdrEYxFHxuGmHF5PyjOEblTJEEL5vKx3XY1LYYbwY3CSyZAUfD7yv4nNpud7g?key=Zq-Isk9ZAG_nIZ1YfHDMRfMs align="left")
...
1. [Spring Framework Official Documentation](https://spring.io/projects/spring-framework/) 
    
2. [Baeldung – Introduction to Spring Framework](https://docs.spring.io/spring-framework/docs/3.2.x/spring-framework-reference/html/overview.html)
    
3. [Ellow. Spring vs Spring Boot: An In-depth Comparison](https://ellow.io/spring-vs-spring-boot/)
