...
![Overview of 2 sections Dividers applied to the FreeCodeCamp header](https://www.freecodecamp.org/news/content/images/2022/02/image-90.png align="left")

*Overview of 2 sections Dividers applied to the FreeCodeCamp header*

Before we dig into the technical part, I have created an [online generator](https://css-generators.com/section-divider/) for section dividers. All you have to do is to select your configuration and get the CSS code in no time.
...
![Illustration of a slanted divider](https://www.freecodecamp.org/news/content/images/2022/02/slanted-divider.png align="left")
...
![A step-by-step illustration to create a slanted divider](https://www.freecodecamp.org/news/content/images/2022/02/image-81.png align="left")
...
![Illustration of the clip-path points](https://www.freecodecamp.org/news/content/images/2022/02/image-82.png align="left")
...
That's the code you will get from the [the online generator](https://css-generators.com/section-divider/) I made. We can improve it by introducing CSS variables:
...
![Illustration of the full-width arrow divider](https://www.freecodecamp.org/news/content/images/2022/02/image-83.png align="left")
...
![A step-by-step illustration to create a full width arrow divider](https://www.freecodecamp.org/news/content/images/2022/02/image-84.png align="left")
...
For this one, my [online generator](https://css-generators.com/section-divider/) will be very useful (especially if you're not comfortable with math formulas) so you can easily get the final values without trouble.
...
The above is valid CSS code but at the time of writing this, there is no support for trigonometric functions so it won't work in any browser. Either you calculate the values manually or use [the online generator](https://css-generators.com/section-divider/) to get the `clip-path` values.
...
You can find a lot of online tools that can help you. My favorite one is: [https://bennettfeely.com/clippy/](https://bennettfeely.com/clippy/)

## How to Create a Rounded Divider for Your Website

![Illustration of the rounded divider](https://www.freecodecamp.org/news/content/images/2022/02/image-87.png align="left")
...
![Illustration of the gradients used with the mask property](https://www.freecodecamp.org/news/content/images/2022/02/image-89.png align="left")
...
Now, in addition to having a [cool online generator for section dividers](https://css-generators.com/section-divider/), you also know the secret behind creating them.
...
I will be releasing more generators in the future so bookmark this link: [https://css-generators.com/](https://css-generators.com/) and follow me [on Twitter](https://twitter.com/ChallengesCss) to not miss them.
