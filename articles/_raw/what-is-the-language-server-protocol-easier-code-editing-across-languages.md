---
title: Understanding the Language Server Protocol – Easier Code Editing Across Languages
  and Tools
subtitle: ''
author: Alex Pliutau
co_authors: []
...
But then Microsoft introduced the [Language Server Protocol](https://microsoft.github.io/language-server-protocol/) (LSP) as a solution to the problem above, which elegantly transforms this **M\*N** complexity into a more manageable **M+N** situation.

## Table of Contents

* [Why Microsoft Created the LSP](#heading-why-microsoft-created-the-lsp)
    
* [What is the Language Server Protocol (LSP)?](#heading-what-is-the-language-server-protocol-lsp)
    
* [Language Server Features](#heading-language-server-features)
    
* [How Does LSP Work?](#heading-how-does-lsp-work)
    
* [Language Server for Go](#heading-language-server-for-go)
    
* [LSP Adoption](#heading-lsp-adoption)
...
You can find more info in this [Language Server Extension Guide](https://code.visualstudio.com/api/language-extensions/language-server-extension-guide).
...
![Communication between the editor and the Language Server](https://miro.medium.com/v2/resize:fit:700/0*Vdycq7316e_hKTCe.png align="left")
...
For example, [here](https://github.com/golang/tools/blob/master/gopls/doc/features/README.md) you can see the list of editor features that **gopls** (the Go Language Server) provides.

And [here](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#languageFeatures) you can see the full LSP specification for available features.

There are hundreds of Language Servers out there. Typically, every mature programming language (or markup language) has at least one Language Server. You can see the full list of language servers that implement LSP [here](https://microsoft.github.io/language-server-protocol/implementors/servers/).

## **How Does LSP Work?**

The Language Server Protocol is built upon [JSON-RPC](https://www.jsonrpc.org/). It specifically uses JSON RPC 2.0. You can think of JSON-RPC as a remote procedure call protocol that uses JSON for data encoding.
...
The most popular and commonly used language server for Go is [gopls](https://github.com/golang/tools/tree/master/gopls). It is used by many editors, for example by the [Visual Studio Code Go extension](https://github.com/golang/vscode-go). Previously, there was another popular Language Server for Go by the Sourcegraph team called [go-langserver](https://github.com/sourcegraph/go-langserver), but this is no longer under active maintenance.
...
Here is how I can inspect what language servers my [Zed](https://zed.dev/) editor is currently running:
