---
title: 'Program design in the Unix environment: an academic article summary'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
Today, let’s take a look at “[Program Design in the Unix Environment](http://harmful.cat-v.org/cat-v/unix_prog_design.pdf)” published in 1983 by Pike and Kernighan.

The paper opens by listing why Unix has been successful, and then comments on the [Unix philosophy](https://en.wikipedia.org/wiki/Unix_philosophy) and its benefits. It does so by looking at examples where programs diverged from the Unix philosophy and discussing the resulting trade offs
