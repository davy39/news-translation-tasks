...
## Table Of Contents
- [How the Bubble Sort Algorithm Works](#heading-how-the-bubble-sort-algorithm-works)
  - [First Iteration of the Sorting](#heading-first-iteration-of-the-sorting)
  - [Second Iteration of the Sorting and the Rest](#heading-second-iteration-of-the-sorting-and-the-rest)
- [Python Code Example of Bubble Sort Algorithm](#heading-python-code-example-of-bubble-sort-algorithm)
- [Java Code Example of Bubble Sort Algorithm](#heading-java-code-example-of-bubble-sort-algorithm)
- [C++ Code Example of Bubble Sort Algorithm](#heading-c-code-example-of-bubble-sort-algorithm)
