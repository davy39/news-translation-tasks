---
title: The NGINX Handbook – Learn NGINX for Beginners
subtitle: ''
...
_Trust me, it's not that hard..._
...
- [Introduction to NGINX](#heading-introduction-to-nginx)
- [How to Install NGINX](#heading-how-to-install-nginx)
    - [How to Provision a Local Virtual Machine](#heading-how-to-provision-a-local-virtual-machine)
    - [How to Provision a Virtual Private Server](#heading-how-to-provision-a-virtual-private-server)
    - [How to Install NGINX on a Provisioned Server or Virtual Machine](#heading-how-to-install-nginx-on-a-provisioned-server-or-virtual-machine-2)
- [Introduction to NGINX's Configuration Files](#heading-introduction-to-nginxs-configuration-files)
- [How to Configure a Basic Web Server](#heading-how-to-configure-a-basic-web-server)
    - [How to Write Your First Configuration File](#heading-how-to-write-your-first-configuration-file)
    - [How to Validate and Reload Configuration Files](#heading-how-to-validate-and-reload-configuration-files)
    - [How to Understand Directives and Contexts in NGINX](#heading-how-to-understand-directives-and-contexts-in-nginx)
    - [How to Serve Static Content Using NGINX](#heading-how-to-serve-static-content-using-nginx)
    - [Static File Type Handling in NGINX](#heading-static-file-type-handling-in-nginx)
    - [How to Include Partial Config Files](#heading-how-to-include-partial-config-files)
- [Dynamic Routing in NGINX](#heading-dynamic-routing-in-nginx)
    - [Location Matches](#heading-location-matches)
    - [Variables in NGINX](#heading-variables-in-nginx)
    - [Redirects and Rewrites](#heading-redirects-and-rewrites)
    - [How to Try for Multiple Files](#heading-how-to-try-for-multiple-files)
- [Logging in NGINX](#heading-logging-in-nginx)
- [How to Use NGINX as a Reverse Proxy](#heading-how-to-use-nginx-as-a-reverse-proxy)
    - [Node.js With NGINX](#heading-nodejs-with-nginx)
    - [PHP With NGINX](#heading-php-with-nginx)
- [How to Use NGINX as a Load Balancer](#heading-how-to-use-nginx-as-a-load-balancer)
- [How To Optimize NGINX for Maximum Performance](#heading-how-to-optimize-nginx-for-maximum-performance)
    - [How to Configure Worker Processes and Worker Connections](#heading-how-to-configure-worker-processes-and-worker-connections)
    - [How to Cache Static Content](#heading-how-to-cache-static-content)
    - [How to Compress Responses](#heading-how-to-compress-responses)
- [How to Understand the Main Configuration File](#heading-how-to-understand-the-main-configuration-file-1)
- [How To Configure SSL and HTTP/2](#heading-how-to-configure-ssl-and-http2)
    - [How To Configure SSL](#heading-how-to-configure-ssl)
    - [How to Enable HTTP/2](#heading-how-to-enable-http2)
    - [How to Enable Server Push](#heading-how-to-enable-server-push)
...
Now that you have a functioning Ubuntu virtual machine on your system, all that is left to do is [install NGINX](#heading-how-to-install-nginx-on-a-provisioned-server-or-virtual-machine-2).
...
If you own a custom domain name, you may assign a sub-domain to this server. Now that you're inside the server, all that is left to is [install NGINX](#heading-how-to-install-nginx-on-a-provisioned-server-or-virtual-machine-2).
...
I **highly discourage** you from editing the original `nginx.conf` file unless you absolutely know what you're doing. For learning purposes, you may rename it, but [later on](#heading-how-to-understand-the-main-configuration-file-1), I'll show you how you should go about configuring a server in a real life scenario.
