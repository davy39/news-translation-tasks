...
* [Intro to Object-Oriented Programming](#heading-intro-to-object-oriented-programming)
    
* [How to Create Objects – Classes](#heading-how-to-create-objects-classes)
    
    * [Some things to keep in mind about classes](#heading-some-things-to-keep-in-mind-about-classes)
        
* [The four principles of OOP](#heading-the-four-principles-of-oop)
    
    * [Inheritance](#heading-inheritance)
        
        * [Some things to keep in mind about inheritance](#heading-some-things-to-keep-in-mind-about-inheritance)
            
    * [Incapsulation](#heading-encapsulation)
        
    * [Abstraction](#heading-abstraction)
        
    * [Polymorphism](#heading-polymorphism)
        
* [Object Composition](#heading-object-composition)
