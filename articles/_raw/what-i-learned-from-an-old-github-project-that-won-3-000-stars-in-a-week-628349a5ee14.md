...
co_authors: []
series: null
date: '2018-02-26T08:31:08.000Z'
originalURL: https://freecodecamp.org/news/what-i-learned-from-an-old-github-project-that-won-3-000-stars-in-a-week-628349a5ee14
coverImage: https://cdn-media-1.freecodecamp.org/images/0*RJ3529egn26oSMl4.png
tags:
- name: GitHub
  slug: github
- name: JavaScript
...
- name: 'tech '
  slug: tech
seo_title: null
seo_desc: 'By TOAST UI

  A Lonely Open Source

  We have been developing a Markdown WYSIWYG Editor project for three years, with
  its first commit in March 2015. I went to work on December 30, 2017 to release version
  1.0 and publish it to npm.

  At that time, the repos...'
---
...
We have been developing a [Markdown WYSIWYG Editor](https://github.com/nhnent/tui.editor) project for three years, with its first commit in March 2015. I went to work on December 30, 2017 to release version 1.0 and publish it to [npm](https://www.npmjs.com/package/tui-editor).
...
No surprise. Even from [Google](https://github.com/google) and [Facebook](https://github.com/facebook), there are open source projects that have no contributors. I guess some of you may have experienced disappointment as your precious open source went to nothing but the void. Moreover, we are used to using [GitHub](https://github.com/) as our free Git repository. Aren’t we?
...
![Image](https://cdn-media-1.freecodecamp.org/images/fxEd5o4o2pUlorTc9inK0ShqcPRAeKbbbdIc)
_Yes. I tried to record everything that seemed important. ?_
...
![Image](https://cdn-media-1.freecodecamp.org/images/VN2sBeV4QJppueU7fffqSQKqaMausO9oEKBU)
_TOAST UI Editor README.md for 0.14.0 and 1.0.0_
...
![Image](https://cdn-media-1.freecodecamp.org/images/T4viYEoUzOI5wh9T1yLa7R5jQqcvHdKwTyji)
_Number of Unique Visitors and Stars. Documents update on 12/30/2017_

![Image](https://cdn-media-1.freecodecamp.org/images/GaCXGWvuhf95YHVXrVFPp14YYvmZbBAOcbSR)
_Star/UV is almost 5x after updating README_
...
You can easily find articles about how to write a nice README file on Google. It is also a good idea to study the READMEs in other projects listed on [Awesome Readme](https://github.com/matiassingers/awesome-readme).
...
Answer the questions on [StackOverflow](https://stackoverflow.com/) and [Quora](https://www.quora.com/). Talk to people in [Facebook Groups](https://www.facebook.com/groups/). Submit a link to [HackerNews](https://news.ycombinator.com/) and [Reddit](https://www.reddit.com/). And ask [Newsletters](http://javascriptweekly.com/issues/368) to post your project.

![Image](https://cdn-media-1.freecodecamp.org/images/CBGMjGs-i9eacEIZ8xKdCLs33H2rMdiez5YB)
_Tell them what your project is._
...
![Image](https://cdn-media-1.freecodecamp.org/images/2ZzKAhZ8Rkt6E30BX8wLuAqjrRS3DntIOwC2)
_Thank you guys ?_

### Learn GitHub Explore

GitHub is the best place to get your contributors. If your project is on GitHub, don’t look too far away, and learn more about it first. At the top of GitHub, you can always find a menu that follows you around with a cute Octocat. The [Explore](https://github.com/explore) is what we should pay attention to. The page shows developers useful and interesting open-source projects.

Explore gives you an opportunity to showcase your project to [24 million GitHub users](https://octoverse.github.com/). That’s why you should maintain your open source project on GitHub.
...
![Image](https://cdn-media-1.freecodecamp.org/images/uKJBu0akQT8hAe-QGY9CiF6HV1zP34Ud1P5O)
_GitHub Explore Trending &amp; Topics_
...
When you open this page, you will see the [Collections](https://github.com/collections), [Topics](https://github.com/topics), and [Trending](https://github.com/trending) tabs — each of those list nice open source projects. Among them, we will look into Trending and Topics. We can’t help with the Collections, as it is curated by GitHub.
...
![Image](https://cdn-media-1.freecodecamp.org/images/v6YScBoXtOlnjtj8VIqkaKSKs43RaazIX2ak)
_Trending Main 1st with 4,761 stars this week. You’ll need luck to take this place._
...
![Image](https://cdn-media-1.freecodecamp.org/images/n4GCid-4SZ89d9Q9Mvs5T8Z5kT-El1Tp36XP)
_Trending Today JavaScript 25th with 63 stars today. You can do this too._
...
![Image](https://cdn-media-1.freecodecamp.org/images/xgjJzmJuEXJ0zEXIAAvJnpPkFePhQ2Ki2VoG)
_Unique Visitors on Jan. 10, Jan. 11_
...
![Image](https://cdn-media-1.freecodecamp.org/images/gSlAVbCTOm94GAUSM2uUt9fOGvpEuI7Ig5Yo)
_Unique Visitors on Jan. 12._
...
![Image](https://cdn-media-1.freecodecamp.org/images/Fkh7LnVBf-xxiw07DBLx0f0k-kvnxept2yMr)
_Unique Visitors on Jan. 13._

The following day, January 13, most visitors came from GitHub. The editor recorded 2,000 stars on this day, **four days** after it was posted on the communities. Although the growth has decreased since then, a month later, the [Trending for This Month](https://github.com/trending?since=monthly) is still bringing in new visitors.
...
![Image](https://cdn-media-1.freecodecamp.org/images/-pGKqUjYfdTv3sQAsvGz8S2yi4qA5UPpF-op)
_Project Topics in Repository Page_
...
However, GitHub manages a list named [Featured Topics](https://github.com/topics). Therefore, it is better to choose the relevant topics from the Featured Topics to get more visitors.

![Image](https://cdn-media-1.freecodecamp.org/images/85HgGTwD9TESI-T21bArImtsKG6f4-zc4DS3)
_GitHub Explore All Featured Topics &amp; Popular Topics_
...
![Image](https://cdn-media-1.freecodecamp.org/images/9hgwX85q-YLQbcHAO3sDmEH6JOgBe7tgm4XX)
_GitHub Explore JavaScript Topic. Your project will never beat freeCodeCamp. ?_
...
![Image](https://cdn-media-1.freecodecamp.org/images/3RufjyexWtRQbUFwJE6z2pVVvHWHIXB99FDY)
_Project Description in Repository Page_
...
![Image](https://cdn-media-1.freecodecamp.org/images/fN0S0mRMAk9ZnuJKr2YdiPiP4XTToB-9ILH3)
_A Project on Trending &amp; Topics List_
...
I’ve had the chance to write this article because the former maintainers ([Shiren](https://github.com/shiren), [JungHwan](https://github.com/junghwan-park)) who did a great job for this project. I believe this project already had the value that it has today. And the tips in this article helped us achieve the rest.

Last month I had a truly special experience as a developer. I would like to thank the [TOAST UI family](https://github.com/nhnent?q=tui) and the [Dooray! Team](https://dooray.com/) for all your support!

If you are interested in the [TOAST UI Editor](https://github.com/nhnent/tui.editor), I recommend that you try [Dooray!](https://dooray.com/) too. It comes with the editor and is free for less than 100 collaborators. Let the TOAST UI Editor be with you ?

[**Pleasure to work together, Dooray!**](https://dooray.com/)  
[_Mail, Issue tracker, and Chat, anyone can easily post their task and collaborate with guests as well as project members._dooray.com](https://dooray.com/)[**nhnent/tui.editor**](https://github.com/nhnent/tui.editor)  
[_tui.editor — ?? Markdown WYSIWYG Editor. GFM Standard + Chart & UML Extensible.gi_thub.com](https://github.com/nhnent/tui.editor)

Originally posted at [Toast Meetup](http://meetup.toast.com/posts/141) written by [KyuWoo Choi ?](https://www.freecodecamp.org/news/what-i-learned-from-an-old-github-project-that-won-3-000-stars-in-a-week-628349a5ee14/undefined)
