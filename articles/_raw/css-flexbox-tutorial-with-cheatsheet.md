...
* [Flexbox Architecture](#heading-flexbox-architecture)
* [flex-direction](#heading-flex-direction-property)
* [justify-content](#heading-justify-content-property)
* [align-content](#heading-align-content-property)
* [align-items](#heading-align-items-property)
* [align-self](#heading-align-self-property)
* [flex - grow | shrink | wrap | basis](#heading-flex-grow-shrink-wrap-basis-properties)
* [Shorthands](#heading-shorthand-flexbox-properties)
...
This project is a [part of this article](https://www.freecodecamp.org/news/learn-css-media-queries-by-building-projects/).
...
If you want to **exercise** your Flexbox knowledge, you can [read this article of mine](https://www.freecodecamp.org/news/learn-flexbox-build-5-layouts/) where you'll be **building five responsive layouts using F**lexbox. Here's a demo:
