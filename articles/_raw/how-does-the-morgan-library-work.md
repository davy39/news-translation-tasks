...
* [What is an Express Middleware?](#heading-what-is-an-express-middleware)
    
* [A Brief Overview of How Morgan Works](#heading-a-brief-overview-of-how-morgan-works)
    
* [What is a Morgan Token?](#heading-what-is-a-morgan-token)
    
* [What Happens When Morgan is Initialised?](#heading-what-happens-when-morgan-is-initialised)
    
* [What Happens When Morgan Captures a Request?](#heading-what-happens-when-morgan-captures-a-request)
...
Some middlewares like Morgan and [cors](https://www.npmjs.com/package/cors) are higher-order functions. They accept configuration arguments when initialised and return a middleware function, executed by Express when hit by a request.
...
The next sections of this article explains how Morgan works under the hood. To follow along, open up [Morgan’s index.js file on GitHub](https://github.com/expressjs/morgan/blob/master/index.js).
...
The string above is used to create a format function using the [Function constructor](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/Function) and returned as:
...
If you have any questions, you can connect with me on [LinkedIn](https://www.linkedin.com/in/orimdominicadah/). I’ll be happy to respond.
