...
co_authors: []
series: null
date: '2018-11-04T16:05:15.000Z'
originalURL: https://freecodecamp.org/news/the-first-step-towards-learning-to-code-2e4c31e86630
coverImage: https://cdn-media-1.freecodecamp.org/images/1*CFeeiP9bD0riPqSIfCzX6A.jpeg
tags:
- name: HTML
  slug: html
- name: Inspiration
...
- name: 'tech '
  slug: tech
seo_title: null
seo_desc: 'By Niamh McCooey

  A couple of months ago, I was chatting to a developer at work about how I’ve always
  wanted to learn to code but never tried.

  Coding always seemed like one of those skills that was incredibly powerful (hence
  the allure). At the same t...'
---
...
![Image](https://cdn-media-1.freecodecamp.org/images/nfRdlv1hiH988xDoDqM7-FxSYU14fNJb6VPO)
...
![Image](https://cdn-media-1.freecodecamp.org/images/xMgp33dGmO0rpbL3LtnbEoXu36UZ3Wx-20I5)
...
![Image](https://cdn-media-1.freecodecamp.org/images/7i4inG4i9HOeaUHdXNsF5FrrmYnjFrmpSx-s)
...
Cut to 10 weeks ago. I’m chatting to the developer at work about all this alluring code stuff. She tells me about [Codebar.](http://www.codebar.io/) It is a weekly meetup aiming to diversify the tech industry. Codebar organizes free coaching sessions for people underrepresented in tech.
...
![Image](https://cdn-media-1.freecodecamp.org/images/niNPueDfyi75HA71aRdjE9p7vqfqvnBEYxpe)

### **I Want More**

I’ve spent the last 10 weeks learning the most basic HTML and CSS and using it to build my [first ever website](https://niamhmccoo.github.io/) (right now I’m experiencing the unprecedented joy of browser testing, so we’ll see how that goes later).

For any other complete beginners out there, I highly recommend the [Codebar tutorials](http://tutorials.codebar.io/) for a basic introduction. I recommend [Flexbox Froggy](https://flexboxfroggy.com/) for learning some cool front end displays. I recommend [CSS Diner](https://flukeout.github.io/) for learning everything there is to know about selectors.
...
![Image](https://cdn-media-1.freecodecamp.org/images/7WzzMmw7cB8gEIQbjhXchHyA94LHGIqVKVR8)
