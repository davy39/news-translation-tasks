...
co_authors: []
series: null
date: '2022-06-15T22:23:18.000Z'
originalURL: https://freecodecamp.org/news/the-most-popular-coding-challenge-websites
coverImage: https://www.freecodecamp.org/news/content/images/2022/06/fCC-Banner.png
tags:
...
- name: Job Hunting
  slug: job-hunting
seo_title: null
seo_desc: "If you want to improve your analytical skills, there's no better way to\
  \ do that than solving problems. \nIf you are a programmer, then this is something\
  \ you should do for yourself. Programmers need to deal with all sorts of problems\
  \ almost every day. ..."
---
...
# Contents
1. [beecrowd](#heading-1-beecrowd-formerly-uri-1)
1. [HackerRank](#heading-2-hackerrank-2)
1. [Codeforces](#heading-3-codeforces-1)
1. [LeetCode](#heading-4-leetcode-1)
1. [Kaggle](#heading-5-kaggle-1)
1. [CodeChef](#heading-6-codechef-1)
1. [AtCoder](#heading-7-atcoder-1)
1. [Topcoder](#heading-8-topcoder)
1. [Coderbyte](#heading-9-coderbyte)
1. [Project Euler](#heading-10-project-euler)
1. [Codewars](#heading-11-codewars)
1. [SPOJ](#heading-12-spoj)
1. [CodinGame](#heading-13-codingame)
1. [GeeksforGeeks](#heading-14-geeksforgeeks-popularly-known-as-gfg-1)
1. [Toph](#heading-15-toph)
1. [LightOJ](#heading-16-lightoj-1)
1. [Exercism](#heading-17-exercism)
1. [Online Judge](#heading-18-online-judge-commonly-known-as-uva)
1. [HackerEarth](#heading-19-hackerearth)
1. [Code Jam - Google's Coding Competitions](#heading-20-code-jam-googles-coding-competitions-1)
1. [ICPC](#heading-21-icpc-international-collegiate-programming-contest-1)
...
<figure class="kg-card kg-image-card">
  <img src="https://www.freecodecamp.org/news/content/images/2022/07/chodi765ql8li7b9yia6-resized.jpeg" class="kg-image" alt="A dropdown showing the different challenge categories on beercrowd">
</figure>
...
CodeChef is another popular Indian website like [HackerRank](#heading-2-hackerrank-2) where you can solve a lot of problems, take part in contests, and so on.
...
If you are a complete beginner, then start with [beecrowd](#1beecrowdformerlyuri). If you want to start problem solving along with learning a specific programming language, then start with [HackerRank](#heading-2-hackerrank-2). 
    
After solving almost 50+ problems on beecrowd or HackerRank, start solving problems on [Codeforces](#heading-3-codeforces-1). The first time, you won't be able to do that well in the programming contests on Codeforces, and that is completely okay – it is natural. You just need to try regularly. The questions might seem pretty hard to you, but it'll become easier day by day after solving problems continuously. 
    
You can participate in [AtCoder](#7atcoder) the day you start solving problems on Codeforces. You can also try [CodeChef](#heading-6-codechef-1), but I find Codeforces is enough in this case. 
    
This will prepare you for the [ICPC](#21icpcinternationalcollegiateprogrammingcontest) and [Code Jam](#heading-20-code-jam-googles-coding-competitions-1). Don't forget to solve the earlier questions on Code Jam.

If you want to gain expertise in Data Science, then simply go for [Kaggle](#heading-5-kaggle-1).

If you want to gain expertise in Algorithms, then [LeetCode](#4leetcode), and [LightOJ](#16lightoj) are your only places. [GeeksforGeeoks](#heading-14-geeksforgeeks-popularly-known-as-gfg-1) will also help you in this aspect. 
