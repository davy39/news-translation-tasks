...
2. [Quick setup commands](#heading-quick-setup-commands)
    
3. [Why animations matter](#heading-why-animations-matter)
    
4. [High-level types of Flutter animations](#heading-high-level-types-of-flutter-animations)
    
5. [Implicit animations](#heading-implicit-animations)
    
    * [AnimatedContainer example](#heading-animatedcontainer-example)
        
6. [Explicit animations](#heading-explicit-animations)
    
    * [Explanation](#heading-explanation)
        
7. [Curved animations](#heading-curved-animations)
    
8. [Chaining animations (translation + rotation)](#heading-chaining-animations-translation-rotation)
    
9. [Staggered animations](#heading-staggered-animations)
    
10. [Hero animations](#heading-hero-animations)
    
11. [AnimatedBuilder with multiple properties](#heading-animatedbuilder-with-multiple-properties)
    
12. [Gesture-based animations](#heading-gesture-based-animations)
    
13. [AnimatedSwitcher](#heading-animatedswitcher)
    
14. [TweenSequence](#heading-tweensequence)
    
15. [Physics-based animations](#heading-physics-based-animations)
...
18. [Extra practical tips and best practices](#heading-extra-practical-tips-and-best-practices)
    
19. [Common helpers & widgets (cheat-list)](#heading-common-helpers-amp-widgets-cheat-list)
...
* [Animation performance & best practices (DevTools)](https://docs.flutter.dev/tools/devtools/performance)
