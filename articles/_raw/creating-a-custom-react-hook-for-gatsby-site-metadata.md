...
I have detailed this pattern before in a post about [using the react](http://localhost:8899/react-context-api-getting-started)  
[context api](http://localhost:8899/react-context-api-getting-started), it's a component that you pass a function to, to render  
a component.
...
The [Gatsby documentation](https://www.gatsbyjs.org/docs/use-static-query/) covers the use of it and also how to make  
