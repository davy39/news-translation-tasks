---
title: How Big O Notation Works – Explained with Cake
subtitle: ''
author: Cedd Burge
co_authors: []
series: null
...
For the Factorial Time example, the guests take part in a [Pétanque](https://en.wikipedia.org/wiki/P%C3%A9tanque) competition, and the winner takes home the cake. 
...
Real world examples of O(n!) operations are anything that requires analysing a list of permutations, such as the [traveling salesman problem](https://en.wikipedia.org/wiki/Travelling_salesman_problem).
...
There are quite a few other ‘Big O’ notations, such as O(n log n) and O(c^n) but they all follow the same pattern. If you want to learn more about it, [check out this article](https://www.freecodecamp.org/news/big-o-notation-why-it-matters-and-why-it-doesnt-1674cfa8a23c/).
