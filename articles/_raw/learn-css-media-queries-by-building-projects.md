...
* [What are CSS Media Queries?](#heading-what-are-css-media-queries)
* [Steps to follow](#heading-how-to-set-up-the-project)
* [The Syntax](#heading-css-media-query-syntax)
* [Practice Projects](#heading-lets-build-some-projects-using-css-media-queries)
...
You can learn more about [Background Properties here](https://www.freecodecamp.org/news/learn-css-background-properties/) if you want to make responsive images for responsive websites.
...
By the way, project 2 is a part of [this article](https://www.freecodecamp.org/news/learn-flexbox-build-5-layouts/) of mine. If you're interested to learn more and practice both your Flexbox and media query skills, then go for it!
