---
title: Understand How Express.js Works by Building Your Own Server Multiplexer from
  Scratch
subtitle: ''
author: Sifundo
co_authors: []
...
A kata is all about **deliberate** practice. It comes from martial arts like Karate and Judo, and, according to Wikipedia, it’s defined as a pre-determined sequence of movements, techniques, and patterns that follow a specific order (source: [wikipedia](https://en.wikipedia.org/wiki/Kata)).
...
* [Form 1: Server-Side Frameworks](#form-1--server-side-frameworks)
    
    * [First Drill: Unpacking Express.js](#first-drill--unpacking-expressjs)
        
    * [The Server](#the-server)
        
    * [The Socket in Node.js](#the-socket-in-nodejs)
        
    * [The Socket in Node.js Source Code](#the-socket-in-nodejs-source-code)
        
* [Form 2: Implementing a Custom Server Mux](#form-2--implementing-a-custom-server-mux)
    
    * [Creating Our Custom Router](#creating-our-custom-router)
        
    * [Basic Mux Skeleton](#basic-mux-skeleton)
        
    * [The Hook Function](#the-hook-function)
    ...
    * [Testing the Queue](#testing-the-queue)
        
    * [Processing Requests](#processing-requests)
        
    * [Lookup Table and Handlers](#lookup-table-and-handlers)
...
* **UDP** is a connectionless protocol and does not guarantee reliable communication, but allows for low-latency and efficient data transfer. This is ideal for time-sensitive applications such as video conferencing, online gaming, and voice over IP (VoIP) (source [Wikipedia](https://en.wikipedia.org/wiki/User_Datagram_Protocol)).
    
* **TCP** is a connection-oriented protocol with reliable, ordered, and error-checked data transmission between applications on networked devices. It’s a major part of internet applications (source [Wikipedia](https://en.wikipedia.org/wiki/Transmission_Control_Protocol)).
...
At this point, if you’ve never worked with prototypes or Object-Oriented JavaScript (OOJS), this might feel like advanced territory. But don’t worry – the good folks at [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain) have an excellent guide on prototypes to get you up to speed.
...
In more advanced frameworks like [Hono.js](https://hono.dev/), the request wrapper might add additional functionality, such as helper methods for setting headers or parsing body content. For now, we’re keeping things simple and just returning the request and response with the URL and method.
...
Thanks for reading! I hope you enjoyed this exploration as much as I did writing it. If you have any thoughts, questions, or just want to connect I am on [x](https://x.com/codelit09), feel free to reach out.
