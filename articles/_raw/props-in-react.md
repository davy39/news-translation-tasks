...
_Screenshot showing the output rendered ("My name is Tooba / The sum of the numeric props I received is 7.")_
...
_Output of the code logging DummyComponent to the console_

## How Props Are Shared Accross Components in React
...
_Output displayed on the browser based on the isParent prop passed from the parent to the child component_
