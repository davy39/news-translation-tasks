...
* [Why Should You Build Multi-Screen Apps?](#heading-why-should-you-build-multi-screen-apps)
    
* [Flutter's Navigation Systems](#heading-flutters-navigation-systems)
    
* [The Simple Navigator API: Navigator.push](#heading-the-simple-navigator-api-navigatorpush)
    
* [Named Routes: The Scalable Approach](#heading-named-routes-the-scalable-approach)
    
* [Backstack Management: Controlling User Flow](#heading-backstack-management-controlling-user-flow)
    
* [Code Organization Tips for Scalable Navigation](#heading-code-organization-tips-for-scalable-navigation)
    
* [Scalable Navigation: When Built-in Isn't Enough](#heading-scalable-navigation-when-built-in-isnt-enough)
    
* [How to Set Up Your Flutter Project: The Car List App](#heading-how-to-set-up-your-flutter-project-the-car-list-app)
...
![home screen screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1749887050970/68969384-f510-4a77-b08f-989440f9a7ac.png align="center")

![detail screen screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1749887061102/a293159f-77b9-4904-8a86-d98ba73cf574.png align="center")

![profile screen screenshot](https://cdn.hashnode.com/res/hashnode/image/upload/v1749887072401/452170e1-770c-4807-a648-941c397f84ec.png align="center")

You can view the completed project here: [https://github.com/Atuoha/routing\_workshop](https://github.com/Atuoha/routing_workshop)
