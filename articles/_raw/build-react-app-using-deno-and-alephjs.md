---
title: How to Build React Applications with Deno Using the AlephJS Library
subtitle: ''
author: Akash Joshi
co_authors: []
series: null
...
To be able to use AlephJS, you need Deno installed on your machine. You can see how to install and get started with Deno in my [previous article here](https://www.freecodecamp.org/news/build-a-url-shortener-in-deno/).
...
I've written about Deno previously on [freeCodeCamp](https://www.freecodecamp.org/news/build-a-url-shortener-in-deno/) where I demoed some Deno basics, including URL imports. Since Aleph is a Deno framework, all imports happen in the "Deno way".
