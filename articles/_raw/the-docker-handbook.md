...
* [Introduction to Containerization and Docker](#heading-introduction-to-containerization-and-docker)
* [How to Install Docker](#heading-how-to-install-docker)
  * [How to Install Docker on macOS](#heading-how-to-install-docker-on-macos)
  * [How to Install Docker on Windows](#heading-how-to-install-docker-on-windows)
  * [How to Install Docker on Linux](#heading-how-to-install-docker-on-linux)
* [Hello World in Docker - Intro to Docker Basics](#heading-hello-world-in-docker-intro-to-docker-basics)
  * [What is a Container?](#heading-what-is-a-container)
  * [What is a Docker Image?](#heading-what-is-a-docker-image)
  * [What is a Docker Registry?](#heading-what-is-a-docker-registry)
  * [Docker Architecture Overview](#heading-docker-architecture-overview)
  * [The Full Picture](#heading-the-full-picture)
* [Docker Container Manipulation Basics](#heading-docker-container-manipulation-basics)
  * [How to Run a Container](#heading-how-to-run-a-container)
  * [How to Publish a Port](#heading-how-to-publish-a-port)
  * [How to Use Detached Mode](#heading-how-to-use-detached-mode)
  * [How to List Containers](#heading-how-to-list-containers)
  * [How to Name or Rename a Container](#heading-how-to-name-or-rename-a-container)
  * [How to Stop or Kill a Running Container](#heading-how-to-stop-or-kill-a-running-container)
  * [How to Restart a Container](#heading-how-to-restart-a-container)
  * [How to Create a Container Without Running](#heading-how-to-create-a-container-without-running)
  * [How to Remove Dangling Containers](#heading-how-to-remove-dangling-containers)
  * [How to Run a Container in Interactive Mode](#heading-how-to-run-a-container-in-interactive-mode)
  * [How to Execute Commands Inside a Container](#heading-how-to-execute-commands-inside-a-container)
  * [How to Work With Executable Images](#heading-how-to-work-with-executable-images)
* [Docker Image Manipulation Basics](#heading-docker-image-manipulation-basics)
  * [How to Create a Docker Image](#heading-how-to-create-a-docker-image)
  * [How to Tag Docker Images](#heading-how-to-tag-docker-images)
  * [How to List and Remove Docker Images](#heading-how-to-list-and-remove-docker-images)
  * [How to Understand the Many Layers of a Docker Image](#heading-how-to-understand-the-many-layers-of-a-docker-image)
  * [How to Build NGINX from Source](#heading-how-to-build-nginx-from-source)
  * [How to Optimize Docker Images](#heading-how-to-optimize-docker-images)
  * [Embracing Alpine Linux](#heading-embracing-alpine-linux)
  * [How to Create Executable Docker Images](#heading-how-to-create-executable-docker-images)
  * [How to Share Your Docker Images Online](#heading-how-to-share-your-docker-images-online)
* [How to Containerize a JavaScript Application](#heading-how-to-containerize-a-javascript-application)
  * [How to Write the Development Dockerfile](#heading-how-to-write-the-development-dockerfile)
  * [How to Work With Bind Mounts in Docker](#heading-how-to-work-with-bind-mounts-in-docker)
  * [How to Work With Anonymous Volumes in Docker](#heading-how-to-work-with-anonymous-volumes-in-docker)
  * [How to Perform Multi-Staged Builds in Docker](#heading-how-to-perform-multi-staged-builds-in-docker)
  * [How to Ignore Unnecessary Files](#heading-how-to-ignore-unnecessary-files)
* [Network Manipulation Basics in Docker](#heading-network-manipulation-basics-in-docker)
  * [Docker Network Basics](#heading-docker-network-basics)
  * [How to Create a User-Defined Bridge in Docker](#heading-how-to-create-a-user-defined-bridge-in-docker)
  * [How to Attach a Container to a Network in Docker](#heading-how-to-attach-a-container-to-a-network-in-docker)
  * [How to Detach Containers from a Network in Docker](#heading-how-to-detach-containers-from-a-network-in-docker)
  * [How to Get Rid of Networks in Docker](#heading-how-to-get-rid-of-networks-in-docker)
* [How to Containerize a Multi-Container JavaScript Application](#heading-how-to-containerize-a-multi-container-javascript-application)
  * [How to Run the Database Server](#heading-how-to-run-the-database-server)
  * [How to Work with Named Volumes in Docker](#heading-how-to-work-with-named-volumes-in-docker)
  * [How to Access Logs from a Container in Docker](#heading-how-to-access-logs-from-a-container-in-docker)
  * [How to Create a Network and Attaching the Database Server in Docker](#heading-how-to-create-a-network-and-attaching-the-database-server-in-docker)
  * [How to Write the Dockerfile](#heading-how-to-write-the-dockerfile)
  * [How to Execute Commands in a Running Container](#heading-how-to-execute-commands-in-a-running-container)
  * [How to Write Management Scripts in Docker](#heading-how-to-write-management-scripts-in-docker)
* [How to Compose Projects Using Docker-Compose](#heading-how-to-compose-projects-using-docker-compose)
  * [Docker Compose Basics](#heading-docker-compose-basics)
  * [How to Start Services in Docker Compose](#heading-how-to-start-services-in-docker-compose)
  * [How to List Services in Docker Compose](#heading-how-to-list-services-in-docker-compose)
  * [How to Execute Commands Inside a Running Service in Docker Compose](#heading-how-to-execute-commands-inside-a-running-service-in-docker-compose)
  * [How to Access Logs from a Running Service in Docker Compose](#heading-how-to-access-logs-from-a-running-service-in-docker-compose)
  * [How to Stop Services in Docker Compose](#heading-how-to-stop-services-in-docker-compose)
  * [How to Compose a Full-stack Application in Docker Compose](#heading-how-to-compose-a-full-stack-application-in-docker-compose)
...
The order of the options you provide doesn't really matter. If you put the `--publish` option before the `--detach` option, it'll work just the same. One thing that you have to keep in mind in case of the `run` command is that the image name must come last. If you put anything after the image name then that'll be passed as an argument to the container entry-point (explained in the [Executing Commands Inside a Container](#executing-commands-inside-a-container) sub-section) and may result in unexpected situations.
