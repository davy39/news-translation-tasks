...
1. [What are Regex](#heading-what-are-regex)?  
– [How to Write Regular Expression Patterns](#heading-how-to-write-regular-expression-patterns)
2. [How to Use Regular Expressions in JavaScript](#heading-how-to-use-regular-expressions-in-javascript)  
– RegEx Methods in JavaScript  
– [Advanced Searching with Flags](#heading-advanced-searching-with-flags)
3. [Anchors in Regex](#heading-anchors-in-regex)  
– [Multiline Mode(m) of Anchors](#heading-multiline-mode-of-anchors-and)   
– [Word Boundaries (`\b`)](#heading-word-boundaries-b)
4. [Quantifiers in Regex](#heading-quantifiers-in-regex)  
– [Greedy Quantifiers](#heading-greedy-quantifiers)  
– [Non Greedy Quantifiers (Lazy Mode)](#Non Greedy Quantifiers (Lazy Mode))
5. [Sets and Ranges in Regex](#heading-sets-and-ranges-in-regex)  
– [Sets](#heading-sets)  
– [Ranges](#heading-ranges)  
– [Negating / Excluding Ranges](#heading-negating-excluding-ranges)  
– [Predefined Character Classes](#heading-predefined-character-classes)
6. [Special Characters and Escaping in Regex](#heading-special-characters-and-escaping-in-regex)  
– [Metacharacters](#heading-metacharacters)  
– [Escaping Special Characters](#heading-escape-special-characters)
7. [Groupings in RegEx](#heading-groupings-in-regex)  
– [Capturing Groups](#heading-capturing-groups)  
– [Non-Capturing Groups](#heading-non-capturing-groups)  
– [Backreferences](#heading-backreferences)  
– [Regex Alternation](#heading-regex-alternation)
8. [Lookahead and Lookbehind Assertions in Regex](#heading-lookahead-and-lookbehind-in-regex)  
...
9. [Practical Examples and Use Cases of Regex](#heading-practical-examples-and-use-cases-of-regex)  
– [Password Strength Checking](#heading-password-strength-checking)  
– [Email Validation](#heading-email-validation-function)   
– [Phone Number Formatting](#heading-phone-number-formatting-function)
10. [RegEx Tips and Best Practices](#heading-tips-and-best-practices-for-using-regular-expressions)
...
There are several online resources and tools available for testing and learning regular expressions. Websites like [Regex101](https://regex101.com/) and [RegExr](https://regexr.com/) provide interactive platforms to test and debug regular expressions. Also leverage online tutorials and documentation to learn regex concepts.

The MDN Web Docs have a helpful guide to [Regular Expressions here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_expressions). And here's a quick start guide to regular expressions in JavaScript: [RegExp Tutorial](https://www.freecodecamp.org/news/a-quick-and-simple-guide-to-javascript-regular-expressions-48b46a68df29/).
