...
This handbook is also available as a video session as part of the [40 Days of JavaScript](https://www.youtube.com/watch?v=t8QXF85YovE&list=PLIJrr73KDmRw2Fwwjt6cPC_tk5vcSICCu) initiative. Please check it out.

%[https://www.youtube.com/watch?v=XpMW-gxNYD8] 

## Table of Contents

1. [Errors in JavaScript](#heading-errors-in-javascript)
    
2. [Handling Errors With the try and catch](#heading-handling-errors-with-the-try-and-catch)
    
    * [The try Block](#heading-the-try-block)
        
    * [The catch Block](#heading-the-catch-block)
        
3. [Error Handling: Real-World Use Cases](#heading-error-handling-real-world-use-cases)
    
    * [Handling Division by Zero](#heading-handling-division-by-zero)
        
    * [Handling JSON](#heading-handling-json)
        
4. [Anatomy of the Error Object](#heading-anatomy-of-the-error-object)
    
    * [What is the Error Object?](#heading-what-is-the-error-object)
        
5. [Throwing Errors and Re-throwing Errors](#heading-throwing-errors-and-re-throwing-errors)
    
    * [Rethrowing](#heading-rethrowing)
        
6. [The finally with try-catch](#heading-the-finally-with-try-catch)
    
    * [Caution with finally](#heading-caution-with-finally)
        
7. [Custom Errors](#heading-custom-errors)
    
    * [A Real-World Use Case of Custom Errors](#heading-a-real-world-use-case-of-custom-errors)
        
8. [Task Assignments for You](#heading-task-assignments-for-you)
    
    * [Find the Output](#heading-find-the-output)
        
    * [Payment Process Validation](#heading-payment-process-validation)
        
9. [40 Days of JavaScript Challenge Initiative](#heading-40-days-of-javascript-challenge-initiative)
    
10. [Before We End...](#heading-before-we-end)
...
![Math Error](https://cdn.hashnode.com/res/hashnode/image/upload/v1752115297863/02d9e89d-e5c1-4759-a11e-ab57d04bcfff.png align="center")
...
* If the catch block is not found, the error will not be caught. The error gets bubbled up, and may end up crashing the program. You can learn more in-depth about events and event bubbling from [here](https://www.youtube.com/watch?v=ybgI5vVE668).
...
There are 101 ways of learning something. But nothing can beat structured and progressive learning methodologies. After spending more than two decades in Software Engineering, I’ve been able to gather the best of JavaScript together to create the [40 Days of JavaScript](https://www.youtube.com/playlist?list=PLIJrr73KDmRw2Fwwjt6cPC_tk5vcSICCu) challenge initiative.
