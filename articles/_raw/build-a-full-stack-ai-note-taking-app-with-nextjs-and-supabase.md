...
co_authors: []
series: null
date: '2025-03-20T19:41:03.970Z'
originalURL: https://freecodecamp.org/news/build-a-full-stack-ai-note-taking-app-with-nextjs-and-supabase
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1742499604089/f6c63ce3-f6eb-45fc-8f3e-08f68364ee53.png
tags:
- name: Next.js
  slug: nextjs
- name: youtube
  slug: youtube
seo_title: null
seo_desc: Taking notes is a fundamental skill for staying organized, whether you're
  a student, professional, or developer. But what if your notes could do more than
  just store information? Imagine having an intelligent note-taking app that allows
  you to organi...
---
...
Start learning today by watching the full course for free on [the freeCodeCamp.org YouTube channel](https://youtu.be/6ChzCaljcaI) (3-hour watch).

%[https://youtu.be/6ChzCaljcaI]
