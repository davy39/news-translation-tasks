---
title: A Crash Course in OSI Layers
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
* **_Layer 4 - Transport Layer:_** The transport layer ensures that messages are delivered error-free, in sequence, and with no losses or duplication. It relieves the higher layer protocols from any concern with the transfer of data between them and their peers.
