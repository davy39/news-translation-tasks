...
Fun fact: I first launched [my GitHub Pages site](https://victoria.dev) 1,018 days ago.
...
* Deploy to my [separate, public, GitHub Pages repository](https://victoria.dev/blog/two-ways-to-deploy-a-public-github-pages-site-from-a-private-hugo-repository/) (Netlify).
...
The writing of rules mostly comes down to shell commands, which is  the main reason Makefiles are as portable as they are. The best part is  that you can do pretty much _anything_ in a terminal, and certainly handle all the workflow steps listed above.
...
In my Makefile, I specify the absolute site path using the [default environment variable](https://help.github.com/en/articles/virtual-environments-for-github-actions#environment-variables) `GITHUB_WORKSPACE`. I’ll dive into this and other GitHub Actions features in the next post.
