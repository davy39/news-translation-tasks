...
If you’re new to TypeScript or FormData, I recommend checking out [TypeScript’s official documentation](https://www.typescriptlang.org/docs/) and [MDN’s guide on FormData](https://developer.mozilla.org/en-US/docs/Web/API/FormData) before proceeding.
...
You can use either types or interfaces, it’s just a matter of preference. You can find out more about how they differ in this [official TypeScript documentation playground](https://www.typescriptlang.org/play/?#example/types-vs-interfaces).
