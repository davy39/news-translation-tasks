...
In this article, we’ll look at an FAQ accordion built using `<details>`. You can see the final project [here](#heading-our-example-project).

## Table of Contents

* [What is the HTML `<details>` Element?](#heading-what-is-the-html-element)
    
* [An FAQ Accordion Built with the `<details>` Element](#heading-an-faq-accordion-built-with-the-element)
    
* [Browser Support and Accessibility Considerations](#heading-browser-support-and-accessibility-considerations)
...
![Example project using the  element](https://cdn.hashnode.com/res/hashnode/image/upload/v1752662715342/74db7ba5-f7a6-44be-974c-36c0418c4a81.png align="center")

This design is by [Frontend Mentor](https://www.frontendmentor.io/?via=ophyboamah) (and you can check out the project on [Codepen](https://codepen.io/ophyboamah/full/ByaRqaN)).
...
Now, let's focus on transforming our basic accordion into something visually appealing (foundational styles can be found on the [Codepen](https://codepen.io/ophyboamah/full/ByaRqaN)). First, we’ll add the icons as SVGs within `<summary>` with classes (closed-icon and open-icon) to make them easy to style.
...
According to [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/details), `<details>` is a well established feature that works across many devices and the popular browsers (Chrome, Edge, Firefox, and Safari) since January 2020.
...
* [CSS-Tricks Guide to Styling Details](https://css-tricks.com/quick-reminder-that-details-summary-is-the-easiest-way-ever-to-make-an-accordion/)
    
* [Web.dev Learn HTML: Details](https://web.dev/learn/html/details/)
