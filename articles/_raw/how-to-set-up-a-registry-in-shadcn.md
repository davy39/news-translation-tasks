...
* [What is a Registry in shadcn?](#heading-what-is-a-registry-in-shadcn)
    
* [How to Create and Configure Your Registry](#heading-how-to-create-and-configure-your-registry)
    
* [Namespace System](#heading-namespace-system)
    
* [Authentication for Private Registries](#heading-authentication-for-private-registries)
    
* [CLI Commands](#heading-cli-commands)
    
* [Dependency Resolution](#heading-dependency-resolution)
...
shadcn's main system uses the `registry.json` file. The file provides key information about the registry, such as resource names and places along with the files that go with them.
...
Creating a shadcn registry involves setting up a configuration file (`registry.json`) at the root of your project. This file contains the metadata and structure of your registry, helping define components and their relationships.

shadcn provides this [starter template](https://github.com/shadcn-ui/registry-template) to help you understand how registries work.
...
Here’s an example of a simple `registry.json`:
...
After creating the `registry.json` file, you can add components to the registry. These components can be UI elements, functions, or utilities.

**Example 1: Adding a Simple Button Component**
...
Reference the component in your `registry.json` like this:
...
> You can learn more about [registry basics](https://ui.shadcn.com/docs/registry/getting-started) in the shadcn UI docs.
...
You can learn more about [**Namespace**](https://ui.shadcn.com/docs/registry/namespace#authentication--security) in the shadcn UI docs.
...
Bearer tokens are ideal for integrating with external APIs like GitHub or internal services that support OAuth 2.0.

You include the token in the `Authorization` header of the request. You typically get this token through an OAuth 2.0 flow, and it grants access to protected resources.
...
The `Authorization` header contains a base64-encoded string of the format `username:password`. While it’s pretty easy to implement, it’s less secure than more modern methods like OAuth 2.0.
...
You can learn more about [**Authentication and Security**](https://ui.shadcn.com/docs/registry/namespace#authentication--security) in the shadcn UI docs.
...
Learn more about [**CLI Commands**](https://ui.shadcn.com/docs/registry/namespace#cli-commands) in the shadcn UI docs.
...
You can learn more about [Dependency Resolution](https://ui.shadcn.com/docs/registry/namespace#authentication--security) in the shadcn UI docs.
...
**Solution:** To fix this, just add the required environment variables to `.env` or `.env.local`.
...
You can learn more about [Error Handling](https://ui.shadcn.com/docs/registry/namespace#authentication--security) in the shadcn UI docs.

## Conclusion

The shadcn registry system provides a good, modular solution for managing and sharing components or utilities across projects. If you’re looking to explore practical implementations, platforms like [shadcn/studio](https://shadcnstudio.com/) which showcase how you can leverage [shadcn components](https://shadcnstudio.com/components) to build sleek, modern UI solutions with minimal setup.
...
I have prepared this article with the help of [Pruthvi Prajapati](https://github.com/PruthviPraj00), a front-end developer with 3 years of experience.
