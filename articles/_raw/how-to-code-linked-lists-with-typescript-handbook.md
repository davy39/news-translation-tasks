...
3. [What are Linked Lists?](#heading-what-are-linked-lists)
    
4. [What is a Singly Linked List?](#heading-what-is-a-singly-linked-list)
    
    * [How to Create a Generic Node Structure for a Singly Linked List](#heading-how-to-create-a-generic-node-structure-for-a-singly-linked-list)
        
    * [How to Implement a Singly Linked List](#heading-how-to-implement-a-singly-linked-list)
        
    * [What is the head Pointer in a Linked List?](#heading-what-is-the-head-pointer-in-a-linked-list)
        
    * [How to Prepend a Node in a Singly Linked List](#heading-how-to-prepend-a-node-in-a-singly-linked-list)
        
    * [How to Append a Node in a Singly Linked List](#heading-how-to-append-a-node-in-a-singly-linked-list)
        
    * [How to Delete the head of a Singly Linked List](#heading-how-to-delete-the-head-of-a-singly-linked-list)
        
    * [How to Delete the Last Node of a Singly Linked List](#heading-how-to-delete-the-last-node-of-a-singly-linked-list)
        
    * [How to Delete a Node from a Singly Linked List](#heading-how-to-delete-a-node-from-a-singly-linked-list)
        
    * [How to Find a Node in a Singly Linked List](#heading-how-to-find-a-node-in-a-singly-linked-list)
        
    * [How to Insert a Node at a Specific Position in a Singly Linked List](#heading-how-to-insert-a-node-at-a-specific-position-in-a-singly-linked-list)
        
    * [How to Traverse a Singly Linked List](#heading-how-to-traverse-a-singly-linked-list)
        
    * [How to Test Your Singly Linked List](#heading-how-to-test-your-singly-linked-list)
        
5. [What is a Doubly Linked List?](#heading-what-is-a-doubly-linked-list)
    
    * [How to Create a Generic Node Structure for a Doubly Linked List](#heading-how-to-create-a-generic-node-structure-for-a-doubly-linked-list)
        
    * [How to Implement a Doubly Linked List](#heading-how-to-implement-a-doubly-linked-list)
        
    * [How to Prepend a Node in a Doubly Linked List](#heading-how-to-prepend-a-node-in-a-doubly-linked-list)
        
    * [How to Append a Node in a Doubly Linked List](#heading-how-to-append-a-node-in-a-doubly-linked-list)
        
    * [How to Delete the Head of a Doubly Linked List](#heading-how-to-delete-the-head-of-a-doubly-linked-list)
        
    * [How to Delete the Last Node of a Doubly Linked List](#heading-how-to-delete-the-last-node-of-a-doubly-linked-list)
        
    * [How to Delete a Node from a Doubly Linked List](#heading-how-to-delete-a-node-from-a-doubly-linked-list)
        
    * [How to Find a Node in a Doubly Linked List](#heading-how-to-find-a-node-in-a-doubly-linked-list)
        
    * [How to Traverse a Doubly Linked List](#heading-how-to-traverse-a-doubly-linked-list)
        
    * [How to Insert a Node at a Specific Position in a Doubly Linked List](#heading-how-to-insert-a-node-at-a-specific-position-in-a-doubly-linked-list)
        
    * [How to Test Your Doubly Linked List](#heading-how-to-test-your-doubly-linked-list)
        
6. [What is a Circular Linked List?](#heading-what-is-a-circular-linked-list)
    
7. [What is a Circular Singly Linked List?](#heading-what-is-a-circular-singly-linked-list)
    
    * [How to Create a Generic Node Structure for a Circular Singly Linked List](#heading-how-to-create-a-generic-node-structure-for-a-circular-singly-linked-list)
        
    * [How to Implement a Circular Singly Linked List](#heading-how-to-implement-a-circular-singly-linked-list)
        
    * [How to Prepend a Node in a Circular Singly Linked List](#heading-how-to-prepend-a-node-in-a-circular-singly-linked-list)
        
    * [How to Append a Node in a Circular Singly Linked List](#heading-how-to-append-a-node-in-a-circular-singly-linked-list)
        
    * [How to Delete the Head of a Circular Singly Linked List](#heading-how-to-delete-the-head-of-a-circular-singly-linked-list)
        
    * [How to Delete the Last Node of a Circular Singly Linked List](#heading-how-to-delete-the-last-node-of-a-circular-singly-linked-list)
        
    * [How to Delete a Node from a Circular Singly Linked List](#heading-how-to-delete-a-node-from-a-circular-singly-linked-list)
        
    * [How to Find a Node in a Circular Singly Linked List](#heading-how-to-find-a-node-in-a-circular-singly-linked-list)
        
    * [How to Traverse a Circular Singly Linked List](#heading-how-to-traverse-a-circular-singly-linked-list)
        
    * [How to Insert a Node at a Specific Position in a Circular Singly Linked List](#heading-how-to-insert-a-node-at-a-specific-position-in-a-circular-singly-linked-list)
        
    * [How to Test Your Circular Singly Linked List](#heading-how-to-test-your-circular-singly-linked-list)
        
8. [What is a Circular Doubly Linked List?](#heading-what-is-a-circular-doubly-linked-list)
    
    * [How to Create a Generic Node Structure for a Circular Doubly Linked List](#heading-how-to-create-a-generic-node-structure-for-a-circular-doubly-linked-list)
        
    * [How to Implement a Circular Doubly Linked List](#heading-how-to-implement-a-circular-doubly-linked-list)
        
    * [How to Prepend a Node in a Circular Doubly Linked List](#heading-how-to-prepend-a-node-in-a-circular-doubly-linked-list)
        
    * [How to Append a Node in a Circular Doubly Linked List](#heading-how-to-append-a-node-in-a-circular-doubly-linked-list)
        
    * [How to Delete the Last Node of a Circular Doubly Linked List](#heading-how-to-delete-the-last-node-of-a-circular-doubly-linked-list)
        
    * [How to Delete the Head of a Circular Doubly Linked List](#heading-how-to-delete-the-head-of-a-circular-doubly-linked-list)
        
    * [How to Find a Node in a Circular Doubly Linked List](#heading-how-to-find-a-node-in-a-circular-doubly-linked-list)
        
    * [How to Traverse a Circular Doubly Linked List](#heading-how-to-traverse-a-circular-doubly-linked-list)
        
    * [How to Delete a Node from a Circular Doubly Linked List](#heading-how-to-delete-a-node-from-a-circular-doubly-linked-list)
        
    * [How to Insert a Node at a Specific Position in a Circular Doubly Linked List](#heading-how-to-insert-a-node-at-a-specific-position-in-a-circular-doubly-linked-list)
        
    * [How to Test Your Circular Doubly Linked List](#heading-how-to-test-your-circular-doubly-linked-list)
        
9. [When to Use Linked Lists (and When to Avoid Them)](#heading-when-to-use-linked-lists-and-when-to-avoid-them)
    
    * [Why Use Linked Lists?](#heading-why-use-linked-lists)
        
    * [Real-World Use Cases](#heading-real-world-use-cases)
        
    * [When Not to Use Linked Lists](#heading-when-not-to-use-linked-lists)
        
    * [Better Alternatives for Specific Cases](#heading-better-alternatives-for-specific-cases)
...
1. **TypeScript:** You need to know [TypeScript basics](https://www.freecodecamp.org/news/learn-typescript-with-react-handbook/), such as interfaces, types, and classes.
    
2. **Algorithm fundamentals:** You need a basic understanding of data structures and algorithms. For example, you should be comfortable analyzing time and space complexity using [Big-O notation](https://www.freecodecamp.org/news/big-o-cheat-sheet-time-complexity-chart/).
...
Clone the project from the [GitHub repository](https://github.com/Yazdun/fcc-linked-list) and code along with the tutorial.
...
![Diagram of a singly linked list with four nodes labeled A, B, C, and D. It starts with the head at Node A and ends with the tail at Node D, pointing to NULL. Each node points to the next node in sequence.](https://cdn.hashnode.com/res/hashnode/image/upload/v1748530545447/8dbffb8d-c941-4c57-934b-22c0335bdd6b.png align="center")
...
1. Builds a [generic](https://www.typescriptlang.org/fr/docs/handbook/2/generics.html) `Node`: Uses `<T>` to handle any data type.
...
![Diagram of a doubly linked list with nodes labeled A to D. Arrows indicate the "next" and "prev" connections between nodes, with Node A as the head and Node D as the tail. The tail points to NULL.](https://cdn.hashnode.com/res/hashnode/image/upload/v1748530715135/52d0559e-0767-45cf-93b6-b236ba890740.png align="center")
...
* It builds a [generic](https://www.typescriptlang.org/fr/docs/handbook/2/generics.html) `Node`: Uses `<T>` to handle any data type, such as numbers or strings.
...
![Diagram of a circular singly linked list with nodes labeled A, B, C, and D. Arrows indicate the "next" pointers, forming a loop. The head points to Node A, and the tail points to Node D.](https://cdn.hashnode.com/res/hashnode/image/upload/v1748531277470/15e7aafc-e499-47ec-a0b7-2b0e61867162.png align="center")
...
![Diagram of a Circular Doubly Linked List with nodes labeled A, B, C, and D, showing next and prev pointers. Node A is connected to Head, and Node D is connected to Tail. Links form a circular structure.](https://cdn.hashnode.com/res/hashnode/image/upload/v1748531479718/6eeb89a6-ee2a-4e24-a2c5-e4c798e65ce2.png align="center")
...
* It builds a [generic](https://www.typescriptlang.org/fr/docs/handbook/2/generics.html) `Node`: Uses `<T>` to handle any data type.
...
Thanks for following along with this tutorial. You can follow me on [X](https://x.com/Yazdun), where I share more useful tips on data structures and web development.
