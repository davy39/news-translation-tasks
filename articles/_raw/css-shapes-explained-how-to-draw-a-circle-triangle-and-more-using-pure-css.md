---
title: 'CSS Shapes Explained: How to Draw a Circle, Triangle, and More Using Pure
  CSS'
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_CSS Borders have angled edges_
...
_The text is offset by the specified values. In this case 20px at top, 5px to the right, 30px at the bottom and 10 px to the left_
...
_border-radius set to 50px on the inset_
...
_Text flows around the shape!_
