...
co_authors: []
series: null
date: '2018-04-24T21:48:19.000Z'
originalURL: https://freecodecamp.org/news/how-to-layout-and-design-a-website-without-any-design-skills-86d94e40b55a
coverImage: https://cdn-media-1.freecodecamp.org/images/1*Phg_9259Vl8tNHyCh_W3sg.jpeg
tags:
- name: Design
  slug: design
...
seo_desc: 'By Jessica Chan
  ...
  build up your portfolio, you may have come across this conundrum:
...
%[https://www.youtube.com/watch?v=BWS4IO5Wdsc&feature=youtu.be&t=612]
...
One good place to find example websites is [Theme Forest](https://themeforest.net/). It has a ton of free and premium website templates and WordPress themes. And if you stick with the most popular themes, you know that generally they will be examples of good designs.

Here is one coffee shop example from a theme I found.

### [The7](https://the7.io/coffee/)

![Image](https://cdn-media-1.freecodecamp.org/images/CwDQtWgEDoAuCV2QbGOwk4-2haLo6ShbjfZA)
...
### [The Wormhole Coffee](http://www.thewormhole.us/)

![Image](https://cdn-media-1.freecodecamp.org/images/KgKQlk0O0aC8CCXbyV8DaLxUBHfDncZ6rO6x)
...
### [Caffe Streets](http://www.caffestreets.com/)

![Image](https://cdn-media-1.freecodecamp.org/images/wJ9dMdP7xxHxtoCB2a9EYDTHUsd0WoaokzgI)
...
![Image](https://cdn-media-1.freecodecamp.org/images/HDMc3Ey2CObm46o17kvJHGWhgKjrxdoRgPn-)
...
![Image](https://cdn-media-1.freecodecamp.org/images/PZRfYxllDpERdb8oB8I3UuG2F-fT2BX73eMZ)
...
![Image](https://cdn-media-1.freecodecamp.org/images/JjSmjbTYDE5Qd9i4cH9W4rpKDxLXk92VTw-s)

![Image](https://cdn-media-1.freecodecamp.org/images/hszTPLF2H01n7v--G7mXhzQxyUCxK-5ARteB)
...
![Image](https://cdn-media-1.freecodecamp.org/images/jlAIYSPgnei-1Wt4Ys51MUIBBGDqu7o1dlsU)
...
Here are complete wireframes of the desktop and the mobile version of the website. I created these using a free online tool called [Mockflow](https://mockflow.com/). They let you create one project for free, and they have paid plans if you want more than one project.

It’s pretty easy to use, and I like the sketchy style option because it’s fun ?

![Image](https://cdn-media-1.freecodecamp.org/images/tqWcD2VYl9l0F5NgsJ8FSnP9Cl3eqUrd1dr5)

![Image](https://cdn-media-1.freecodecamp.org/images/2t6gYI5AIAl1X6q0j9zIU1gn22kejMY7rYJo)
...
If you need some color inspiration, Canva has some [sample color palettes](https://www.canva.com/learn/brand-color-palette/) that you can try out.
...
![Image](https://cdn-media-1.freecodecamp.org/images/RxiZDgixwfbfhNyCxovKQML3ven3LRzYNoSJ)
...
[Google Fonts](https://fonts.google.com/) is a great place to look for fonts that you can load on your website for free. Just don’t get too many, because every font family, weight, and style will add additional load to the site.
...
3. Get the task runner up and running. (I’m using [Gulp](https://gulpjs.com/) for this project.)
...
* [Responsinator.com](http://www.responsinator.com/) (free)
* [Screenfly](http://quirktools.com/screenfly) by Quirktools (free)
* [Browserstack](https://www.browserstack.com/) (paid) — Browserstack allows you to test virtual machines on actual devices.

### The finished product!

Here’s a screenshot of the finished Central Coffee website:

![Image](https://cdn-media-1.freecodecamp.org/images/JycvLFxLnypcvwpARjmHo6F4U-IRSPIbr1hW)

You can check out the real site for yourself [on my Github.io page](https://thecodercoder.github.io/central-coffee-demo).
...
◾️ Read more helpful posts like this on my blog: [Coder-Coder.com.](https://coder-coder.com)  
◾️ Follow me on [Instagram](https://www.instagram.com/thecodercoder/) and [Twitter](https://twitter.com/thecodercoder)!  
◾️ Check out coding tutorials on [my YouTube channel](https://www.youtube.com/c/codercodertv).
