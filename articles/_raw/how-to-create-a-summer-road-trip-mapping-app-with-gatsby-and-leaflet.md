...
co_authors: []
series: null
date: '2020-03-24T13:01:46.000Z'
originalURL: https://freecodecamp.org/news/how-to-create-a-summer-road-trip-mapping-app-with-gatsby-and-leaflet
coverImage: https://www.freecodecamp.org/news/content/images/2020/03/road-trip-mapping-app-2.jpg
tags:
- name: front end
  slug: front-end
...
seo_title: null
seo_desc: 'Get ready for the summer by building your own road trip mapping app with
...
* [Step 1: Cleaning up some unneeded code](#id="step-1-cleaning-up-some-unneeded-code")
* [Step 2: Create our road trip locations](#heading-step-2-create-our-road-trip-locations)
* [Step 3: Prepare our app with some functions](#heading-step-3-prepare-our-app-with-some-functions)
* [Step 4: Building our trip path](#heading-step-4-building-our-trip-path)
* [Step 5: Styling our map components](#heading-step-5-styling-our-map-components)
* [Want to learn more about maps?](#heading-want-to-learn-more-about-maps)

_Author’s Note: Even though we’re going through some challenging times, we can still be optimistic that we’ll get through this together and be able to enjoy our summer. Stay safe and wash your hands. ❤️_

%[https://www.youtube.com/watch?v=FkO8uggDEXY]
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/summer-road-trip-map.jpg)
_[Colbana's Summer Road Trip](https://summer-road-trip.netlify.com/)_
...
If you’re not sure about one of the above items, you can try checking out the beginning of [my previous tutorial](https://www.freecodecamp.org/news/create-your-own-santa-tracker-with-gatsby-and-react-leaflet/).
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/terminal-creating-new-gatsby-app.jpg)
_Creating a new Leaflet Gatsby app in the terminal_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/terminal-starting-gatsby-development-server.jpg)
_Starting your Gatsby app in the terminal_

If all goes as planned, your server should start and you should now be able to see your basic mapping app in your browser!

![Image](https://www.freecodecamp.org/news/content/images/2020/03/gatsby-starter-leaflet-in-browser.jpg)
_New Leaflet Gatsby app in the browser_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/new-empty-mapping-app.jpg)
_New mapping app with nothing going on_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/mapping-app-with-road-trip-path.jpg)
_Mapping app with road trip path_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/road-trip-mapping-app-with-popup.jpg)
_Road trip mapping app with popups_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/03/road-trip-mapping-app.jpg)
_Final version of the road trip mapping app_
