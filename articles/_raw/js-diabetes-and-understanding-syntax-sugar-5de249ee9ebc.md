...
It was time for me to get on GitHub, and share my gift with the _world_. I opened up the first project I could find, and started reading. It looked something like this:
...
_When you search like you’re desperately trying to not lose a round of [Pictionary](https://en.wikipedia.org/wiki/Pictionary" rel="noopener" target="_blank" title="), you’re in trouble._
...
3. Bothering random developers until someone could “Explain Like I’m 5,” but in the end, still being confused why someone would write something like that. Sadism, _probably_.
...
_Diabetes or side-effects of reading this whole article?_
