...
[_This article is intended for those who are trying to start their programming career, or are preparing to interview for…_medium.freecodecamp.org](https://medium.freecodecamp.org/the-most-important-things-you-need-to-know-for-a-programming-interview-3429ac2454b)[**The 30-minute guide to rocking your next coding interview**](https://medium.freecodecamp.org/coding-interviews-for-dummies-5e048933b82b)  
[_How I improved in coding interviews and received offers from the big tech companies._medium.freecodecamp.org](https://medium.freecodecamp.org/coding-interviews-for-dummies-5e048933b82b)

I recently came across a programming problem that I had to solve within a time span of 1 hour. It was a part of a programming contest being held on [Leetcode.](https://leetcode.com) I found this problem to be a great candidate to be asked in a programming interview. I will go through the problem in detail here and discuss my reasons for why this is a good interview problem. I will do my best to try and relate it to the points mentioned before.

#### Table of Contents

* [? Let’s Play Snakes and Ladders](https://medium.com/p/8431cdeab2a7#a667)
* [Looks like a typical Dynamic Programming problem](https://medium.com/p/8431cdeab2a7#0028)
* [Graph Model](https://medium.com/p/8431cdeab2a7#838c)
* [The Flaw in the DP formulation](https://medium.com/p/8431cdeab2a7#b56d)
* [Updated DP formulation](https://medium.com/p/8431cdeab2a7#9ed1)
* [Breadth First Search to the Rescue! ⛑](https://medium.com/p/8431cdeab2a7#8720)
* [Cell Value to Row and Column Mapping?](https://medium.com/p/8431cdeab2a7#9ab1)
* [Problematic Cell Values ?](https://medium.com/p/8431cdeab2a7#5724)
* [Making one move per Snake ?](https://medium.com/p/8431cdeab2a7#1546)
* [Can we get rid of the “direction” thingy? ?](https://medium.com/p/8431cdeab2a7#a68e)
* [Mapping the other way around](https://medium.com/p/8431cdeab2a7#6afa)
* [Why again this is the best programming interview problem?](https://medium.com/p/8431cdeab2a7#ce03)

### ? Let’s Play Snakes and Ladders

This question was a part of a recent weekly programming contest held on [LeetCode](https://medium.com/@BlogLeetCode). It’s a 1.5 hour contest with 4 programming challenges of varying difficulty. This was marked as a medium difficulty problem. Being able to solve it during the timeframe is a big thing as you will realize after going through the article.

FYI, I couldn’t ?

[**Snakes and Ladders - LeetCode**](https://leetcode.com/problems/snakes-and-ladders/description/)  
[_Level up your coding skills and quickly land a job. This is the best place to expand your knowledge and get prepared…_leetcode.com](https://leetcode.com/problems/snakes-and-ladders/description/)
...
_Route Followed: 1 → 4 → 10 (Snake Up!) → 22_
...
_Route Followed: 1 → 4 → 9 → 14 → 17 → 22_
...
_Loop introduced by snakes in the graph representation._
...
_The player moves from cell 1 to 22 and follows the path 1 → 6→ 11 → 16 → 22._
...
_The 6 moves when the player is at the cell 1_
...
Thanks [Divya Godayal](https://www.freecodecamp.org/news/the-perfect-programming-interview-problem-8431cdeab2a7/undefined) for suggesting this simplistic check. This definitely cuts down on the code length and covers all the above cases. Cheers!
