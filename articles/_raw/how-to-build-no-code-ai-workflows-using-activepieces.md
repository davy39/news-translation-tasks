...
subtitle: Let’s learn how to use Activepieces to build smart AI workflows with a simple
  visual builder. No coding or complex setup needed.
...
* [What is Activepieces?](#heading-what-is-activepieces)
    
* [Understanding the Activepieces ecosystem](#heading-understanding-the-activepieces-ecosystem)
    
* [Building a workflow in Activepieces](#heading-building-a-workflow-in-activepieces)
    
* [Deploying ActivePieces on the Cloud using Sevalla](#heading-deploying-activepieces-on-the-cloud-using-sevalla)
    
* [Real-world examples](#heading-real-world-examples)
...
[Activepieces](https://github.com/activepieces/activepieces) is an open-source automation platform that focuses on ease of use.
...
![Activepieces Layout](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683020718/b2d3f49b-8edf-435e-bbd7-4cb10dd80dbf.png align="center")
...
![ActivePieces Integrations](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683057739/69d6eb1c-b75e-4711-9d76-0638b43c242f.png align="center")
...
![ActivePieces Workflow](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683082555/3a25c6b8-7454-4b2e-b421-7bbbe65212be.png align="center")
...
To use Activepieces, you can either install it on your computer (not recommended due to the complex setup), [buy a cloud subscription](https://www.activepieces.com/), or self-host it. 

If you prefer to install it on your computer, [here are the instructions](https://www.activepieces.com/docs/install/options/docker). 
...
* Sevalla has a [template for ActivePieces](https://docs.sevalla.com/templates/overview), so it simplifies the manual installation and setup for each resource you will need for installation.
    

[Log in](https://app.sevalla.com/login) to Sevalla and click on Templates. You can see Activepieces as one of the templates.

![Sevalla Templates](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683152719/dcc829e0-c06e-4e23-b118-d09a3b5cea32.png align="center")
...
![Sevalla Provisioning](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683186122/a6e557b8-b001-4fb3-9637-c208f8a7d81f.png align="center")
...
![Activepieces Dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683211801/02a70ff2-7f42-4b98-8109-4acf22e690cd.png align="center")
...
![Activepieces Templates](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683242859/1dc73871-8e16-4f0b-b535-0f781a4e5cb6.png align="center")
...
![ActivePieces Workflow](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683271246/17d52f70-0d79-47c4-ac3a-2a887136d5b9.png align="center")
...
![AI Component](https://cdn.hashnode.com/res/hashnode/image/upload/v1764683293561/8a7baa9a-2f5c-4c64-8775-1e68308d70b4.png align="center")
