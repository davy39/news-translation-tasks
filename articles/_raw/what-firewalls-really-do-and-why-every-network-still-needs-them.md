...
* [What We Will Cover](#heading-what-we-will-cover)
    
* [What a Firewall Is in Simple Terms](#heading-what-a-firewall-is-in-simple-terms)
    
* [What Firewalls Actually Do](#heading-what-firewalls-actually-do)
    
* [How Firewalls Reduce Attack Surface](#heading-how-firewalls-reduce-attack-surface)
    
* [Firewalls and Internal Network Protection](#heading-firewalls-and-internal-network-protection)
    
* [Setting up a firewall](#heading-setting-up-a-firewall)
    
* [Firewalls in Cloud and Hybrid Networks](#heading-firewalls-in-cloud-and-hybrid-networks)
    
* [Firewalls and Compliance Requirements](#heading-firewalls-and-compliance-requirements)
    
* [Common Misunderstandings About Firewalls](#heading-common-misunderstandings-about-firewalls)
    
* [Why Firewalls Still Matter Today](#heading-why-firewalls-still-matter-today)
    
* [Firewalls as a Foundation, Not a Finish Line](#heading-firewalls-as-a-foundation-not-a-finish-line)
...
![How firewall helps](https://cdn.hashnode.com/res/hashnode/image/upload/v1766072062052/cfdc2af2-bc89-43e9-b69a-dda8f94b1f9d.png align="center")
...
This layered approach is known as [defence in depth](https://www.geeksforgeeks.org/ethical-hacking/defence-in-depth/). Firewalls are a core layer in that strategy.
...
![network segmentation](https://cdn.hashnode.com/res/hashnode/image/upload/v1766072134125/a631c42a-8201-41e8-9f46-2bbcc6b113f6.png align="center")
...
To make this practical, let’s look at a real, working example using [UFW](https://help.ubuntu.com/community/UFW), an open source firewall available on most Linux systems. These are actual commands you would run on a server.
...
Some believe that [endpoint security](https://en.wikipedia.org/wiki/Endpoint_security) replaces firewalls. Endpoint tools protect individual devices. Firewalls protect the network paths between them. Both are needed.
...
New technologies don’t remove the need for boundaries. Even [zero-trust models](https://www.cisa.gov/zero-trust-maturity-model) rely on strict access controls, often enforced by firewall-like systems.
