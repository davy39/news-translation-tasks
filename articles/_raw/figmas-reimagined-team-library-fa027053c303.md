...
_New UI available at base of left-hand panel._
...
_Team Library view in the left-hand panel of the Figma desktop app._
...
_The icon that resembles four squares in a diamond shape appears in the Figma menu bar when an object, group, or Frame is selected._

![Image](https://cdn-media-1.freecodecamp.org/images/0td1-8QwDWysqYKc5ErZs9m-CRnWYjZoZu3d)
_The right-click menu on an object, group, or Frame exposes the Component options as well._
...
_Using Components and Instances, a group of text boxes across multiple Frames can have their properties adjusted at the same time._
...
_In-file notification when one or more Instance in your file has it’s master Component updated._
...
_Add a description to your Components in the right-hand Figma panel._

Read _even more_ about Components here:

[**Components in Figma**](https://blog.figma.com/components-in-figma-e7e80fcf6fd2)  
[_Today we are excited to release Components in Figma. By bringing concepts like composition, inheritance and unlimited…_blog.figma.com](https://blog.figma.com/components-in-figma-e7e80fcf6fd2)
...
_Creating a Frame behind a Component and changing the fill color will change the color of the Component tile in the File Component list and Team Library panel._
