---
title: 'The C Beginner''s Handbook: Learn C Programming Language basics in just a
  few hours'
subtitle: ''
author: Flavio Copes
co_authors: []
...
1. [Introduction to C](#heading-introduction-to-c)
2. [Variables and types](#heading-variables-and-types)
3. [Constants](#heading-constants)
4. [Operators](#heading-operators)
5. [Conditionals](#heading-conditionals)
6. [Loops](#heading-loops)
7. [Arrays](#heading-arrays)
8. [Strings](#heading-strings)
9. [Pointers](#heading-pointers)
10. [Functions](#heading-functions)
11. [Input and output](#heading-input-and-output)
12. [Variables scope](#variables-scope)
13. [Static variables](#heading-static-variables)
14. [Global variables](#heading-global-variables)
15. [Type definitions](#heading-type-definitions)
16. [Enumerated Types](#heading-enumerated-types)
17. [Structures](#heading-structures)
18. [Command line parameters](#heading-command-line-parameters)
19. [Header files](#header-files)
20. [The preprocessor](#heading-the-preprocessor)
