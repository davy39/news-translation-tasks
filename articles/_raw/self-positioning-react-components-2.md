...
_querying an element on NYTimes.com_
...
A big thanks to [Dexter](https://medium.com/@rundexter) engineering specifically [Daniel Ilkovich](https://medium.com/@ilkovich) and [David Hu](https://medium.com/@octopi)for letting me share this code and all of their help and support while building the user tutorial feature on our [site](http://rundexter.com/).
