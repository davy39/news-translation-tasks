...
?This is where Google Tez’s A**QR** sounds promising. Audio is used to start the transaction. Its best selling part is that transactions can be completed with a simple device that has just a microphone and speaker — and isn’t that what phones used to be a decade ago?
