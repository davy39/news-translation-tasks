---
title: 'How to Build an AI-Powered Flutter App with Google Antigravity: A Hands-On
  Tutorial'
subtitle: ''
...
In November 2025, Google launched [**antigravity**](https://antigravity.google/blog/introducing-google-antigravity), a new interactive coding platform that has fundamentally shifted my workflow.

Antigravity has completely [changed how fast you can prototype](https://www.youtube.com/watch?v=SVCBA-pBgt0&t=2s) and iterate on projects. Instead of writing boilerplate code or spending hours searching through documentation, you can describe your needs in natural language, review the plan, and let AI agents create, test, and even run the code.
...
We’ll use Antigravity to let AI agents plan, write, test, and show video walkthroughs of your app. This “[vibe coding](https://www.freecodecamp.org/news/how-to-use-vibe-coding-effectively-as-a-dev/)” style means that you describe what you want, review plans, and approve changes – all while agents handle the heavy lifting.

The app will feature a [glassmorphism](https://www.freecodecamp.org/news/glassmorphism-how-to-create-a-glass-card-in-figma/) design: frosted glass cards, blurred backgrounds, subtle borders, and soft translucency. This will give the app a premium, modern feel that’s both elegant and calming.

## Here's what we'll cover:

* [Prerequisites](#heading-prerequisites)
    
* [Understanding the Antigravity Engine](#heading-understanding-the-antigravity-engine)
    
* [Prompts - the Key to Successful Vibe Coding in Antigravity](#heading-prompts-the-key-to-successful-vibe-coding-in-antigravity)
    
* [Step 1: Open Antigravity and Create a Workspace](#heading-step-1-open-antigravity-and-create-a-workspace)
    
* [Step 2: Mastering the Art of Agentic Prompting](#heading-step-2-mastering-the-art-of-agentic-prompting)
    
* [Step 3: Implement the Glassmorphic Main Screen](#heading-step-3-implement-the-glassmorphic-main-screen)
    
* [Step 4: Add Persistence and Daily Logic](#heading-step-4-add-persistence-and-daily-logic)
    
* [Step 5: Add On-Device Smart Reminders with Gemma](#heading-step-5-add-on-device-smart-reminders-with-gemma)
    
* [Step 6: Final Polish](#heading-step-6-final-polish)
    
* [Antigravity quota limit](#heading-antigravity-quota-limit)
...
* Google Antigravity installed (you can use the free public preview from [antigravity.google](https://antigravity.google/))
...
![Open Agent Manager in Antigravity](https://cdn.hashnode.com/res/hashnode/image/upload/v1766772585000/860da5bb-99f5-4e57-a3ef-18f93d4b6a54.png align="center")

The panel on the left has an “+ Open Workspace” – just click that to create a new workspace:

![Click "Open Workspace" to create a new workspace in Antigravity](https://cdn.hashnode.com/res/hashnode/image/upload/v1766432535748/016d64c0-3869-48f7-860d-0a6b087db01e.png align="center")

Then go ahead and click “Open New Workspace”:

![Open the workspace by clicking "Open New Workspace"](https://cdn.hashnode.com/res/hashnode/image/upload/v1766432590892/24504fd9-e621-4ecd-b6d5-7d99ac0fd14a.png align="center")

Then just name it `water_tracker` and create it:

![Name and create the workspace](https://cdn.hashnode.com/res/hashnode/image/upload/v1766432640664/3d9a3522-6199-4659-a62d-ec199c87be2e.png align="center")

Now you have a clean workspace ready for prompts:

![Workspace is now ready](https://cdn.hashnode.com/res/hashnode/image/upload/v1766432668236/e0df1845-6012-4732-97da-f45135d41680.png align="center")
...
![Paste the prompt into the Agent Manager chat and click the blue "+" button](https://cdn.hashnode.com/res/hashnode/image/upload/v1766433166692/2e0ba4b8-dbb0-4101-a2c6-a250ec318dbf.png align="center")
...
![Review the response/plan and click proceed if you're happy with the results](https://cdn.hashnode.com/res/hashnode/image/upload/v1766777527328/cceff62d-9cf3-4794-b8e6-65565598b4d8.png align="center")
...
!["Agent is running terminal commands" - for you to review](https://cdn.hashnode.com/res/hashnode/image/upload/v1766778411176/0ea3013b-e7b9-486f-ab3b-c65f2ef1b628.png align="center")

As shown in the above screenshot, the agent will ask to run: `flutter pub add provider shared_preferences intl flutter_animate google_fonts`.
...
![Accept the agent's work](https://cdn.hashnode.com/res/hashnode/image/upload/v1766436979535/d5b65713-761a-4b3d-ad6e-ebea5be343d9.png align="center")
...
![Accept the agent creating specific paths in your workspace](https://cdn.hashnode.com/res/hashnode/image/upload/v1766778588513/d348cab7-147a-4733-8a31-cf66010a2449.png align="center")

### Verifying the Emulator Launch

Before launching on the emulator, the agent will ask for permission to launch it:

![Agent asking permission to launch emulator](https://cdn.hashnode.com/res/hashnode/image/upload/v1766779040373/7cfcaf88-ba61-40d2-8eda-f100a65c0151.png align="center")

The agent will then initialize the project and show you the running app in the integrated emulator:

![Agent showing the running app](https://cdn.hashnode.com/res/hashnode/image/upload/v1766833166339/bab74ad2-d15a-4870-b767-1f8a08ca8836.png align="center")
...
![Checking project folders/files](https://cdn.hashnode.com/res/hashnode/image/upload/v1767653383038/5f84773b-0b04-4417-9c1b-c992f1a9e9c1.png align="center")

Clicking this button reveals the **Explorer** view on the left, where you can now see the newly created `water_tracker` project. You should explore the `lib/` directory to verify that the agent successfully created `main.dart` and organized your files into the `core`, `data`, and `ui` folders as proposed in its earlier plan.

This is your chance to perform a sanity check on the code itself. Open `main.dart` to ensure the agent correctly set up the `WaterTrackerApp` and initialized your theme before you proceed to the next stage of development.

![Perform your sanity check](https://cdn.hashnode.com/res/hashnode/image/upload/v1766783330487/83adf159-a017-40e6-9c93-299c243735ca.png align="center")
...
* **The Editor View (Verification)**: When you click the **'Open editor'** button (the `< >` icon) in the top right, the IDE reveals the standard VS Code-style workspace. This is where the physical files (like `main.dart` and the folder structure you just authorized) actually appear.  
...
![Demo of the animation](https://cdn.hashnode.com/res/hashnode/image/upload/v1766835614486/1930f868-07a9-4264-95cc-af48f163549f.png align="center")
...
We’ll now ask the agent to add persistence and daily reset logic using shared\_preferences.
...
![Saved progress](https://cdn.hashnode.com/res/hashnode/image/upload/v1766837605166/93c57ff2-c279-4897-b8b3-e2697b76064b.png align="center")
...
![Reminders with Gemma](https://cdn.hashnode.com/res/hashnode/image/upload/v1766838947780/f051ad6e-383d-4965-ae41-dd939cb181c9.png align="center")

To test the AI Hydration Coach:
...
![Screenshot showing various app features like setting goals and saving](https://cdn.hashnode.com/res/hashnode/image/upload/v1766840697130/8227c083-76af-4ab3-9b59-fd645e429dad.png align="center")
...
![Showing confetti when you reach your goal](https://cdn.hashnode.com/res/hashnode/image/upload/v1766839488270/7e9f12ce-0d68-45e5-a01d-1634f367e311.png align="center")
...
![Selecting another model to use](https://cdn.hashnode.com/res/hashnode/image/upload/v1766831055155/c04b71e6-2949-4294-aa9b-3c8df8511c19.png align="center")
