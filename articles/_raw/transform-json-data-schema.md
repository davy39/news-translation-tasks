...
* [Add and Inspect the JSON File](#heading-add-and-inspect-the-json-file)
    
* [Define the Target Schema](#heading-define-the-target-schema)
    
* [How to Clean JSON Data with Pure Python](#heading-how-to-clean-json-data-with-pure-python)
    
* [How to Clean JSON Data with Pandas](#heading-how-to-clean-json-data-with-pandas)
    
* [How to Validate the Cleaned JSON](#heading-how-to-validate-the-cleaned-json)
    
* [Pandas vs Pure Python for Data Cleaning](#heading-pandas-vs-pure-python-for-data-cleaning)
...
Here’s how (assuming the file name is **“old\_customers.json”**):

![Code to view or print contents of the raw JSON file in terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1752079424973/3cd77410-6fa9-483d-9a73-edbe4c035327.jpeg align="center")
...
If someone asks for JSON data to be cleaned, it probably means that the [current schema](https://json-schema.org/understanding-json-schema/about) is unsuitable for its intended purpose. At this point, you want to be clear on what the final JSON export should look like.
...
![A screenshot of the old JSON Schema to be transformed](https://cdn.hashnode.com/res/hashnode/image/upload/v1751956173106/d5957404-57ae-4de9-b61b-90eefa0b9260.jpeg align="center")

![The expected JSON Schema](https://cdn.hashnode.com/res/hashnode/image/upload/v1751956365336/dcf6a024-1ae6-4c95-92ae-5544ba4cbb3e.jpeg align="center")
...
![Script runtime displayed in terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1751957367537/4a33fc16-7158-427e-b715-bec10a586857.jpeg align="center")
...
![The expected JSON output after schema transformation](https://cdn.hashnode.com/res/hashnode/image/upload/v1751961256627/d7b585f7-4585-4354-9fa7-a171adb31f90.jpeg align="center")
...
As you know, JSON schema changes with each file structure. If your JSON data differs from what we’ve been working with so far, learn how to create a schema [here](https://json-schema.org/learn/getting-started-step-by-step#validate-json-data-against-the-schema). Otherwise, the schema below defines the structure we expect for our cleaned JSON:
...
You can study the [Pandas cheatsheet](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf) to learn more data manipulation methods.
