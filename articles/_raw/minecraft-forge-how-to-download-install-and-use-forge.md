---
title: 'Minecraft Forge: How to Download, Install, and Use Forge'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
* A Minecraft account which can be bought from their official website. ([https://minecraft.net/en-us/store/](https://minecraft.net/en-us/store/))
* An IDE (Eclipse or IntelliJ are recommended for Minecraft development)

After installing/acquiring these pieces of software, download your desired Forge version at [https://files.minecraftforge.net/](https://files.minecraftforge.net/).
