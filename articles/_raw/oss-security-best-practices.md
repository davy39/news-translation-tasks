---
title: Open Source Software Security Handbook – Best Practices for Securing Your Projects
subtitle: ''
...
1. [Open Source Software Attacks](#heading-open-source-software-attacks)
2. [Software Supply Chain Attacks](#heading-software-supply-chain-attacks)
3. [What is Web Application Security?](#heading-what-is-web-application-security)
4. [The "Iceberg" Analogy](#heading-the-iceberg-analogy)
5. [GitHub Marketplace](#heading-github-marketplace)
6. [How to Use GitHub Marketplace to Mitigate Risk in your Open Source Projects](#heading-how-to-use-github-marketplace-to-mitigate-risk-in-your-open-source-project)
7. [Software Composition Analysis](#heading-software-composition-analysis) 
8. [What is Secret Sprawl?](#heading-what-is-secret-sprawl)
9. [Static Code Analysis](#heading-static-code-analysis)
10. [How to Get Value from ChatOps](#heading-how-to-get-value-from-chatops)
11. [Open Source Software Best Practices](#heading-open-source-software-best-practices)
12. [Five Tips for OSS Security](#heading-5-tips-for-oss-security)
13. [How to Make an Impact in the Open Source Software Community](#heading-how-to-make-an-impact-in-the-open-source-software-community)
14. [Key Takeaways for Open Source Security 101](#heading-key-takeaways-for-open-source-security-101)
...
_[Learn more about typosquatting attacks here](https://snyk.io/blog/typosquatting-attacks/)._
...
_[Read more about crossenv here](https://snyk.io/advisor/npm-package/crossenv)._
...
_[Read more about fallguys here](https://snyk.io/advisor/npm-package/fallguys)._
...
_[Read more about this attack here](https://snyk.io/blog/a-post-mortem-of-the-malicious-event-stream-backdoor/)._
...
_A vulnerability can be introduced at any point in the supply chain_
...
_[Read more about RCE here](https://security.snyk.io/vuln/SNYK-JAVA-ORGAPACHELOGGINGLOG4J-2314720)._
...
_An example of a SDLC pipeline_
...
_Securing your SDLC is critical_
...
_[Read through the OWASP top 10 here](https://owasp.org/Top10/)._
...
_The modern application's risk profile with a bigger attack surface_
...
_[GitHub Marketplace has over 10,000th actions](https://github.blog/2021-10-21-github-marketplace-welcomes-its-10000th-action)!_
...
_Examples of notifications from Dependabot and Snyk_
...
_Screen before installing GitGuardian in your project_
...
_Tools usually have a lot of integrations for your projects_
...
_Bringing visibility into your communication channels_
...
_Learn more about project management. [https://github.com/features/issues](https://github.com/features/issues)_
...
_Example of a list of Milestones and Labels_
...
_GitHub will let you know if your main branch is not protected_
...
_Requiring status checks before merging_
...
_Make sure to update the right email address for notifications_
...
_If you do not need a webhook anymore, delete it from your project!_
...
_Security overview under the Security tab_
...
_Make sure your community profile is in good shape_
...
_GitHub will let you know if some of your issues appear to be stale!_
...
_An example of labels to showcase the health of a project_
...
_Choose the right license for your project_
...
_The Snyk Learn platform. https://learn.snyk.io/_
