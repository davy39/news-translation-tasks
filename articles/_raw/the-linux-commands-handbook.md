---
title: The Linux Command Handbook – Learn Linux Commands for Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
series: null
...
- [Introduction to Linux and shells](#heading-introduction-to-linux-and-shells)
- [The Linux `man` command](#heading-the-linux-man-command)
- [The Linux `ls` command](#heading-the-linux-ls-command)
- [The Linux `cd` command](#heading-the-linux-cd-command)
- [The Linux `pwd` command](#heading-the-linux-pwd-command)
- [The Linux `mkdir` command](#heading-the-linux-mkdir-command)
- [The Linux `rmdir` command](#heading-the-linux-rmdir-command)
- [The Linux `mv` command](#heading-the-linux-mv-command)
- [The Linux `cp` command](#heading-the-linux-cp-command)
- [The Linux `open` command](#heading-the-linux-open-command)
- [The Linux `touch` command](#heading-the-linux-touch-command)
- [The Linux `find` command](#heading-the-linux-find-command)
- [The Linux `ln` command](#heading-the-linux-ln-command)
- [The Linux `gzip` command](#heading-the-linux-gzip-command)
- [The Linux `gunzip` command](#heading-the-linux-gunzip-command)
- [The Linux `tar` command](#heading-the-linux-tar-command)
- [The Linux `alias` command](#heading-the-linux-alias-command)
- [The Linux `cat` command](#heading-the-linux-cat-command)
- [The Linux `less` command](#heading-the-linux-less-command)
- [The Linux `tail` command](#heading-the-linux-tail-command)
- [The Linux `wc` command](#heading-the-linux-wc-command)
- [The Linux `grep` command](#heading-the-linux-grep-command)
- [The Linux `sort` command](#heading-the-linux-sort-command)
- [The Linux `uniq` command](#heading-the-linux-uniq-command)
- [The Linux `diff` command](#heading-the-linux-diff-command)
- [The Linux `echo` command](#heading-the-linux-echo-command)
- [The Linux `chown` command](#heading-the-linux-chown-command)
- [The Linux `chmod` command](#heading-the-linux-chmod-command)
- [The Linux `umask` command](#heading-the-linux-umask-command)
- [The Linux `du` command](#heading-the-linux-du-command)
- [The Linux `df` command](#heading-the-linux-df-command)
- [The Linux `basename` command](#heading-the-linux-basename-command)
- [The Linux `dirname` command](#heading-the-linux-dirname-command)
- [The Linux `ps` command](#heading-the-linux-ps-command)
- [The Linux `top` command](#heading-the-linux-top-command)
- [The Linux `kill` command](#heading-the-linux-kill-command)
- [The Linux `killall` command](#heading-the-linux-killall-command)
- [The Linux `jobs` command](#heading-the-linux-jobs-command)
- [The Linux `bg` command](#heading-the-linux-bg-command)
- [The Linux `fg` command](#heading-the-linux-fg-command)
- [The Linux `type` command](#heading-the-linux-type-command)
- [The Linux `which` command](#heading-the-linux-which-command)
- [The Linux `nohup` command](#heading-the-linux-nohup-command)
- [The Linux `xargs` command](#heading-the-linux-xargs-command)
- [The Linux `vim` editor command](#heading-the-linux-vim-editor-command)
- [The Linux `emacs` editor command](#heading-the-linux-emacs-editor-command)
- [The Linux `nano` editor command](#heading-the-linux-nano-editor-command)
- [The Linux `whoami` command](#heading-the-linux-whoami-command)
- [The Linux `who` command](#heading-the-linux-who-command)
- [The Linux `su` command](#heading-the-linux-su-command)
- [The Linux `sudo` command](#heading-the-linux-sudo-command)
- [The Linux `passwd` command](#heading-the-linux-passwd-command)
- [The Linux `ping` command](#heading-the-linux-ping-command)
- [The Linux `traceroute` command](#heading-the-linux-traceroute-command)
- [The Linux `clear` command](#heading-the-linux-clear-command)
- [The Linux `history` command](#heading-the-linux-history-command)
- [The Linux `export` command](#heading-the-linux-export-command)
- [The Linux `crontab` command](#heading-the-linux-crontab-command)
- [The Linux `uname` command](#heading-the-linux-uname-command)
- [The Linux `env` command](#heading-the-linux-env-command)
- [The Linux `printenv` command](#heading-the-linux-printenv-command)
...
This is a man (from __manual__) page. Man pages are an essential tool to learn as a developer. They contain so much information that sometimes it's almost too much.  
