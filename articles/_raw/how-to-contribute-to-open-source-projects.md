...
co_authors: []
series: null
date: '2022-04-21T23:38:34.000Z'
originalURL: https://freecodecamp.org/news/how-to-contribute-to-open-source-projects
coverImage: https://www.freecodecamp.org/news/content/images/2022/04/open-source-contributions.jpeg
tags:
- name: community
  slug: community
- name: open source
  slug: open-source
seo_title: null
seo_desc: 'By Ankita Tripathi

  If you''ve been considering contributing to an open source project, you might be
  weighing the pros and cons of doing so.

  You might hear things like open-source projects won''t help you grow. Or they can''t
  change your career trajector...'
---
...
One year later, after networking and gaining experience, I applied as a participant. The [Metanorma organisation](https://www.metanorma.org/) saw my volunteering experience and selected me for GSoD'21. And it's in that way that I became a part of the ever-growing open-source community.
...
Well, first of all, start with the topics you're interested in. Browse github.com/topics/[topic of your interest] to search for something you'd like to work on. For example, if you want to browse projects regarding Python, then you can use this: https://github.com/topics/python.

Unless it's something very niche, you should find tons of projects concerning your chosen topic to start your contributions.
...
* [Codetriage](https://www.codetriage.com/): Start contributing by finding any open-source repo from this gold mine. 
...
Look at what Santosh Yadav, an open-source expert in Angular and a GitHub star, shares:
