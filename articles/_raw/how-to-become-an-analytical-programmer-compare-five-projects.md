---
title: How to Become an Analytical Programmer – Solve the "Rock, Paper, Scissors"
  Game 5 Ways Using JavaScript & Mermaid.js
subtitle: ''
author: evaristo.c
co_authors: []
series: null
...
1. [Visual Tools for Code Comparison](#heading-visual-tools-for-code-comparison): In this part, we’ll talk about diagrams and focus on the one we’ll use for this project – the use case-driven system block diagram.
    
2. [What we are going to do](#heading-what-we-are-going-to-do): here, we reveal the focus of our analysis, what we expect to do, what we will consider when making the diagrams, and a short intro to the tool we will use for this, Mermaid.js.
    
3. [Five Code Examples of Rock, Paper, Scissors](#heading-five-code-examples-of-rock-paper-scissors): Next, we’ll assess the JavaScript code of five CodePen projects, starting from the simplest one and finishing with the most complex one. At each assessment, we’ll make a comparison against the preceding projects.
    
    * [“CPC Rock Paper Scissors” by Amit: A project with fireworks animations](#heading-cpc-rock-paper-scissors-by-amit-a-project-with-fireworks-animations)
        
    * [“Rock paper scissors game using native drag & drop” by Hmz C: A project using the HTML Drag element](#heading-rock-paper-scissors-game-using-native-drag-amp-drop-by-hmz-c-a-project-using-the-html-drag-element)
        
    * [“Rock Paper Scissors” by Brad Traversy: A project with a modal and a reset](#heading-rock-paper-scissors-by-brad-traversy-a-project-with-a-modal-and-a-reset)
        
    * [“Rock Paper Scissors OOP” by Damian: A project written in OOP](#heading-rock-paper-scissors-oop-by-damian-a-project-written-in-oop)
        
    * [“Recurrent Neural Network - Rock, Paper, Scissors” by Andrew Worcerster: A project implementing AI](#heading-recurrent-neural-network-rock-paper-scissors-by-andrew-worcerster-a-project-implementing-ai)
        
4. [Final Thoughts](#heading-final-thoughts)
...
![An example of Use Case-Driven System Block Diagram, by computer science students at Rice University](https://cdn.hashnode.com/res/hashnode/image/upload/v1746025297569/da5599e5-838a-4c90-bbf8-ddcaba58e36f.jpeg align="center")
...
To elaborate upon the suitability of this methodology for code analysis, we’ll apply the fundamentals of use case-driven system block diagram methodology to analyze five JavaScript projects’ code – each created by a different developer – implementing the Rock, Paper, Scissors game on [CodePen](https://codepen.io/).
...
![Rules of the Rock Paper Scissors game, Wikipedia](https://cdn.hashnode.com/res/hashnode/image/upload/v1746025625482/59c24cc3-d1e8-455b-8387-67733487e58d.jpeg align="center")
...
Follow this link: [https://gist.github.com/evaristoc/81dc9f508aa54c355f3f89b08a2450d5](https://gist.github.com/evaristoc/81dc9f508aa54c355f3f89b08a2450d5) if you want to find the copy of the JavaScript codes used for this article.
...
![Querying CodePen in search for the projects](https://cdn.hashnode.com/res/hashnode/image/upload/v1746808534102/acd2dba9-05d4-454d-8bb8-f4ee51dff304.jpeg align="center")
...
The Rice course focuses more on **what** the diagram should show, but not so much on **how** to actually build it. For that, I refer to a [previous article](https://www.freecodecamp.org/news/how-to-make-flowcharts-with-mermaid/) where I broke down the diagram creation process. Here’s how the two approaches align:
...
To create the diagrams, we’ll use [**Mermaid.js**](https://mermaid.js.org/), a JavaScript library that converts text into diagrams. It’s Markdown-compatible, which makes it especially handy for online projects, blog posts, and documentation.
...
If you aren’t familiar with using Mermaid.js, I wrote [an extensive tutorial](https://www.freecodecamp.org/news/use-mermaid-javascript-library-to-create-flowcharts/) about the tool, along with its pros and cons. Although I will refrain from talking in-depth about Mermaid.js here, I will make use of some other tricks that were not included in previous articles.
...
![Simple SB-Diagram of the RPS game by Amit](https://cdn.hashnode.com/res/hashnode/image/upload/v1746177298317/0b9f4609-9810-4ba5-8d8f-6e0869080fdb.jpeg align="center")
...
![First Refinement of SB-Diagram of the RPS game by Amit](https://cdn.hashnode.com/res/hashnode/image/upload/v1746177264415/e826d8e8-bddb-4f9e-9f86-8454f4671ac1.jpeg align="center")
...
![Second Refinement of SB-Diagram of the RPS game by Amit](https://cdn.hashnode.com/res/hashnode/image/upload/v1746177244326/42474333-e6c5-499e-ba95-86541ebd525b.jpeg align="center")
...
![Final SB Diagram of the RPS game by Amit](https://cdn.hashnode.com/res/hashnode/image/upload/v1746178100298/bf5f7240-b125-4780-aaf8-fdbbdd911390.jpeg align="center")
...
![Simple SB-Diagram of the RPS game by Hmz C](https://cdn.hashnode.com/res/hashnode/image/upload/v1746315569277/60685986-16dd-4cb0-8290-252ed69114bf.jpeg align="center")
...
![Refinement of SB Diagram of the RPS game by Hmz C](https://cdn.hashnode.com/res/hashnode/image/upload/v1746315095906/70866854-a624-48b5-89ea-4dcb5d7f5eeb.jpeg align="center")
...
![Final SB Diagram of the RPS game by Hmz C](https://cdn.hashnode.com/res/hashnode/image/upload/v1746314611833/a54d5c7a-bd10-4a74-aea2-37176e14908b.jpeg align="center")
...
If you started self-learning JavaScript at some point between 2015 and today (2025), you might have heard of this guy. [Brad Traversy](https://www.linkedin.com/in/bradtraversy) is a legend among those learning to code and has also made his own learning program.
...
![Simple SB-Diagram of the RPS game by B. Traversy](https://cdn.hashnode.com/res/hashnode/image/upload/v1746314052265/03bf54f2-a2a6-4a9b-91ec-7465082314db.jpeg align="center")
...
![Refinement of the SB-Diagram of the RPS game by B. Traversy](https://cdn.hashnode.com/res/hashnode/image/upload/v1746312146770/922d42c9-f993-4287-8e2c-53b5a4c9b17f.jpeg align="center")
...
![Final SB Diagram of the RPS game by B. Traversy](https://cdn.hashnode.com/res/hashnode/image/upload/v1746311699920/0c89b8c0-aa93-418f-858f-171006c4bacc.jpeg align="center")
...
![First Simple SB-Diagram of the RPS game by Damian](https://cdn.hashnode.com/res/hashnode/image/upload/v1746311035208/e9dee7a0-2428-4c08-bc41-37b81846ae34.jpeg align="center")
...
![Second Simple SB-Diagram of the RPS game by Damian](https://cdn.hashnode.com/res/hashnode/image/upload/v1746310389266/a078bebe-dee4-47b1-a5e8-c164008878e9.jpeg align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1746308587568/b17961e2-8c97-4446-956c-85fe1a8b8630.jpeg align="center")
...
![Final SB Diagram of the RPS game by Damian](https://cdn.hashnode.com/res/hashnode/image/upload/v1746308090111/246b7eae-5f72-4117-9c9a-62571873e112.jpeg align="center")
...
Andrew Worcester hasn’t been a regular contributor to CodePen but has created about 50 projects since 2013. The project we are going to analyze was created in 2019, one year after the first release of `brain.js`.

This code implements a more advanced version of the "Rock, Paper, Scissors" game, which uses neural networks (via the `brain.js` library) to predict the player’s next move and even simulate emotions for the computer opponent based on its win/loss patterns.
...
![RPSBrain 01 - Simple SB-Diagram of the RPS game by A. Worcester](https://cdn.hashnode.com/res/hashnode/image/upload/v1746282747010/f1c43834-0558-4d1c-8e71-f09f7f92f2c4.jpeg align="center")
...
![First Refinement of SB Diagram of the RPS game by A. Worcerster](https://cdn.hashnode.com/res/hashnode/image/upload/v1746282227818/020fd3c7-3864-4e5c-8af1-de185a04484f.jpeg align="center")
...
![Second Refinement of SB Diagram of the RPS game by A. Worcerster](https://cdn.hashnode.com/res/hashnode/image/upload/v1746280491504/2cbb972c-535d-4a56-b5d7-23fb4f3eba63.jpeg align="center")
...
![Final SB Diagram of the RPS game by A. Worcerster](https://cdn.hashnode.com/res/hashnode/image/upload/v1746277838797/066c8372-c20e-4917-acf5-b8a70a743e96.jpeg align="center")
...
If you were able to follow the analysis specifically for this project and want to compare it to a similar project implementing the same game, check the [example provided by brain.js team](https://rockpaperscissors-ai.vercel.app/). You might need to have a basic knowledge of Vue.js though.
