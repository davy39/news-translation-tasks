...
So I wrote a Python script named “rm-p.py”. It’s a wrapper for `rm` that checks if a corresponding `.<filename>.rm-prot`ection (which I call a “protection file”). The prompt asks the question defined in the protection file when it can be found.
...
_Demo: Trying to delete a protected file._
