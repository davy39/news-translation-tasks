...
![CodeIgnitor download via composer output.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737222358773/c0be04da-c507-41cf-b98e-8c9126146b31.png align="center")
...
![Php spark serve output.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737224950979/8e7ccdac-ce8b-4b71-b41b-5ee02dfd9970.png align="center")

Then, open your browser and go to [`http://localhost:8080`](http://localhost:8080). You should see the CodeIgniter welcome page.

![CodeIgnitor welcome page.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737225118799/c7a38536-62fa-4788-814d-cd246a973691.png align="center")
...
Or **download as ZIP (from CodeIgniter official website):** [Download here](https://www.codeigniter.com/download). Extract it in `/var/www/html`. Whereby you can do so using the terminal or UI.
...
![ZIP Extraction image.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737210782723/25317e2b-151b-491e-8e83-89c32d9cf5ee.png align="center")
...
![Extracted folder(Codeigniter-develop) image.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737212632072/6240acc1-27bd-49fe-acd4-5b3f80a92163.png align="center")

> change `Codeigniter-develop /bcit-ci-CodeIgniter-bcb17eb/….`folder name to just codeigniter

### Verify Extraction

Visit your web server's URL (for example, [`http://localhost`](http://localhost)) to check if the contents are correctly deployed.
...
![Config.php terminal image.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737213372442/259f712f-2df4-4517-a382-88966b021950.png align="center")
...
Replace [`http://your-domain-or-ip/`](http://your-domain-or-ip/) with your actual domain or IP address where the project will be accessible.
...
Open your web browser and navigate to the base URL ([`http://your-domain-or-ip`](http://your-domain-or-ip)). You should see the default CodeIgniter welcome page if everything is set up correctly:

![CodeIgniter welcome page.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737218343140/7a41485a-152e-496e-9ba7-811e5c4b774b.png align="center")

Run `curl` [`ifconfig.me`](http://ifconfig.me) to find your public IP. If you're hosting CodeIgniter on a local machine (for example, in your home network), use the following command to check your local IP: `hostname -I`.
...
![Application folders.](https://cdn.hashnode.com/res/hashnode/image/upload/v1737219751160/af7240e8-2793-45b9-9cff-1f9a74add34f.png align="center")
