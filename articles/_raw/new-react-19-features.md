...
co_authors: []
series: null
date: '2024-03-27T16:43:00.000Z'
originalURL: https://freecodecamp.org/news/new-react-19-features
coverImage: https://www.freecodecamp.org/news/content/images/2024/03/Group-27.png
tags:
- name: React
  slug: react
- name: 'update '
...
seo_desc: 'By Neha sharma
  ...
  ReactJS is one of the most popular UI libraries in the front-end development world.
  And one of the reasons I love React is because of the team behind it and the community''s
  enthusiasm for it.

  And when the community speaks up about the ...'
---
...
![Andrew clark tweet on upcoming ReactJS19 new features](https://www.freecodecamp.org/news/content/images/2024/03/image-70.png)

### Here's what we'll cover:

1. [New Features in React v19 – Overview](#heading-new-features-in-react-v19-overview)
2. [React Compiler](#heading-1-react-compiler)
3. [Server Components](#heading-2-server-components)
4. [Actions](#heading-3-actions)
5. [Web Components](#heading-4-web-components)
6. [Document Metadata](#heading-5-document-metadata)
7. [Asset Loading](#heading-6-asset-loading)
8. [New React Hooks](#heading-7-new-react-hooks)  
– [The new `use()` hook](#heading-the-new-use-hook)  
– [The `useFormStatus()` hook](#heading-the-useformstatus-hook)  
– [The `useFormState()` hook](#heading-the-useformstate-hook)  
– [The `useOptimistic()` hook](#heading-the-useoptimistic-hook)
9. [Can I use React 19 Now?](#heading-can-i-use-react-19-now)
...
In React19, we have new hooks to handle form status and data as well. This will make working with forms smoother and easier. Combining these hooks with `action`s ([new React19 feature](#heading-3-actions)) will make working with forms and handling data easier.
...
![Forms flow in reactJS by using the new hooks - useOptimistic(), useFormState(), useFormStatus()](https://www.freecodecamp.org/news/content/images/2024/03/Screenshot-2024-03-16-at-09.41.26.png)
_Summary of new hooks_
