...
It has many features and an editor that's highly optimized for writing. You can even build different themes using **[handlebars](https://handlebarsjs.com/).js**.
...
1. [Why Use Next.js for the Front End and Not a Ghost CMS Theme?](#heading-why-use-nextjs-for-the-front-end-and-not-a-ghost-cms-theme)
2. [Project Requirements](#heading-project-requirements)
3. [How to Set Up Ghost CMS](#heading-how-to-set-up-ghost-cms)
4. [How to Set Up Ghost CMS with the Cloud](#heading-how-to-set-up-ghost-cms-with-the-cloud)
5. [How to Get the Blog Template](#heading-how-to-get-the-blog-template)
6. [How to Set Up Next.js](#heading-how-to-set-up-nextjs)
7. [What to know before following this tutorial](#what-to-know-before-following-this-tutorial-)
8. [Folder Structure](#heading-folder-structure)
9. [How to Configure Ghost CMS and Next.js](#heading-how-to-configure-ghost-cms-and-nextjs)
10. [Understanding the Next.js 13 App Folder](#heading-understanding-the-nextjs-13-app-folder)
11. [Demo Data for the Project](#heading-demo-data-for-the-project)
12. [How to Build the Blog](#heading-how-to-build-the-blog)
13. [How to Build the Header](#heading-how-to-build-the-header)
14. [How to Build the Footer](#heading-how-to-build-the-footer)
15. [How to Build the Layout](#heading-how-to-build-the-layout) 
16. [How to Build the Homepage](#heading-how-to-build-the-homepage)
17. [How to Build the Reading Page](#heading-how-to-build-the-reading-page)
18. [How to Build the Tag Page](#heading-how-to-build-the-tag-page) 
19. [How to Build the Author Page](#heading-how-to-build-the-author-page)
20. [How to Build Single Pages](#heading-how-to-build-single-pages)
21. [How to Handle Pagination](#heading-how-to-handle-pagination)
22. [Next.js SEO](#heading-nextjs-seo)
23. [How to Enable Search](#heading-how-to-enable-search)
24. [Error Handling](#heading-error-handling)
25. [How to Rebuild Your Static Site with Webhooks](#heading-how-to-rebuild-your-static-site-with-webhooks)
...
* [@types/tryghost__content-api](https://www.npmjs.com/package/@types/tryghost__content-api) package contains type definitions for @tryghost/content-api.
...
_Get your `GHOST_KEY` and `GHOST_URL`_
...
1. [How to build the header](#heading-how-to-build-the-header)
2. [How to build the footer](#heading-how-to-build-the-footer)
3. [How to build the layout](#heading-how-to-build-the-layout)
4. [How to build the homepage](#how-to-built-the-homepage)
5. [How to build the reading page](#heading-how-to-build-the-reading-page)
6. [How to build the tag page](#heading-how-to-build-the-tag-page)
7. [How to build the author page](#heading-how-to-build-the-author-page)
8. [How to build single pages](#heading-how-to-build-single-pages)
9. [How to handle pagination](#heading-how-to-handle-pagination)
10. [Next.js SEO](#heading-nextjs-seo)
11. [How to Enable Search](#heading-how-to-enable-search)
12. [Error Handling](#heading-error-handling)
13. [How to rebuild your static site with webhooks](#heading-how-to-rebuild-your-static-site-with-webhooks)
...
_Select the project in your Vercel dashboard_
