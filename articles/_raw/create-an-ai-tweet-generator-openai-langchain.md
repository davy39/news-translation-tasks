---
title: How to Create an AI Tweet Generator Using LangChain
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_OpenAI's various models (Found on their [website](https://platform.openai.com/docs/models/overview))_
