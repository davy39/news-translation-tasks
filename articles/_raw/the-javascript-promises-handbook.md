...
1. [What is a Promise?](#heading-what-is-a-promise)
2. [Comparing Promises to Other Async Patterns](#heading-comparing-promises-to-other-async-patterns)
3. [How to Create a Promise](#heading-how-to-create-a-promise)
4. [How to Get the Result of a Promise](#heading-how-to-get-the-result-of-a-promise)
5. [How to Handle Errors with `then`](#heading-how-to-handle-errors-with-then)
6. [Promise Chaining](#heading-promise-chaining)
7. [How to Create Immediately Fulfilled or Rejected Promises](#heading-how-to-create-immediately-fulfilled-or-rejected-promises)
8. [How to Use `async` and `await`](#heading-how-to-use-async-and-await)
9. [Promise Anti-Patterns](#heading-promise-anti-patterns)
