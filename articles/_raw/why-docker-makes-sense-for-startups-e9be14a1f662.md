...
_…guess this story could have been more timely written in 2015._
...
_Who needs kittens when you’ve got cartoon whales._
...
_One VM per (monolithic) service vs. multiple (micro) services per VM. Credit: [Martin Fowler](http://martinfowler.com" rel="noopener" target="_blank" title=")_
...
_A 3-node-strong Swarm cluster running the example-voting-app_
