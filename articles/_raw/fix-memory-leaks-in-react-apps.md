...
* [What Are Memory Leaks in React?](#heading-what-are-memory-leaks-in-react)
    
* [When Does A Component Unmount?](#heading-when-does-a-component-unmount)
    
* [Common Causes Of Memory Leaks And How To Fix Them](#heading-common-causes-of-memory-leaks-and-how-to-fix-them)
    
    * [Event Listeners](#heading-event-listeners)
        
    * [Timers](#heading-timers)
        
    * [Subscriptions](#heading-subscriptions)
        
    * [Async Operations](#heading-async-operations)
...
![GIF shows multiple 'resize' event listeners being created each time a component mounts.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149182882/58ddc026-d6b8-4120-9144-53b6d87fb63e.gif align="center")
...
![GIF shows a 'resize' event listener that is removed when the component unmounts.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149497654/f95d75b4-f41f-4bb0-806b-546555be813a.gif align="center")
...
![GIF shows a countdown timer component that continues to run and update state after it has been unmounted from the DOM.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149517577/34868e3e-e8f6-495a-a2f8-ef0e1e745051.gif align="center")

In the GIF, we notice that the console stops showing "\_\_ Outside effect ” anytime we hide/unmount the component. But the string, " Interval \_\_”, shows every time.
...
![GIF shows a countdown timer component that stops running and updating state after it unmounts.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149580900/7c37c824-93db-4b73-8ff4-c45c6404bb65.gif align="center")
...
![GIF shows a component that continues with an API call after it unmounts.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149803784/bf5cf55f-75fe-472f-9a08-653c53bdafaa.gif align="center")
...
![GIF shows an API call being cancelled after its component unmounts.](https://cdn.hashnode.com/res/hashnode/image/upload/v1758149811531/5497edbd-050c-4059-b088-239e8c5b65ef.gif align="center")
