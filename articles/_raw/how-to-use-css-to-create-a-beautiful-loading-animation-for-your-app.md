...
* [Just want the snippet?](#heading-just-want-the-snippet)
* [Part 1: Creating our loading animation](#heading-part-1-creating-our-loading-animation)
* [Part 2: Using our loading animation in a dynamic app](#heading-part-2-using-our-loading-animation-in-a-dynamic-app)
...
_Static HTML &amp; CSS webpage with content from fillerama.io_
...
_Static HTML &amp; CSS webpage with a gray background for the content_
...
_Static HTML &amp; CSS webpage with a gray background and transparent color for the content_
...
_Style difference between applying to the top level list or the list items_
...
_Subtle gradient background that might look like a glare_
...
![Image](https://www.freecodecamp.org/news/content/images/2020/05/static-html-css-gray-background-subtle-gradient.jpg)
_No change – it's not animating_
...
_Creating a new project with Next.js_
...
_Starting development server with Next.js_
...
_No height when there's no content_
