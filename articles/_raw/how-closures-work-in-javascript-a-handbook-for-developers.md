...
2. [Project Setup Before Learning Closures](#heading-project-setup-before-learning-closures)
    
    * [Create a New Project Folder](#heading-create-a-new-project-folder)
        
    * [Create the index.html File](#heading-create-the-indexhtml-file)
        
    * [Create the script Folder + Seven Example Files](#heading-create-the-script-folder-seven-example-files)
        
    * [Very Important Note](#heading-very-important-note)
        
    * [Run the Project](#heading-run-the-project)
        
3. [Functions and Parameters - The Basics](#heading-functions-and-parameters-the-basics)
    
4. [Accessing Variables Without Parameters](#heading-accessing-variables-without-parameters)
    
5. [Understanding Scope and Lexical Scoping](#heading-understanding-scope-and-lexical-scoping)
    
6. [What is a Closure?](#heading-what-is-a-closure)
    
7. [Functions as Objects](#heading-functions-as-objects)
    
8. [The Function-Parent Relationship](#heading-the-function-parent-relationship)
    
9. [Nested Functions and Closures](#heading-nested-functions-and-closures)
    
10. [Refining the Example](#heading-refining-the-example)
    
11. [Creating Private Properties with Closures](#heading-creating-private-properties-with-closures)
    
12. [The Role of Closures in Privacy](#heading-the-role-of-closures-in-privacy)
    
13. [Understanding Closure Mechanics](#heading-understanding-closure-mechanics)
    
    * [How Closures Make Decisions](#heading-how-closures-make-decisions)
        
14. [Closures and Enclosing Scopes](#heading-closures-and-enclosing-scopes)
    
    * [The Documentation Definition](#heading-the-documentation-definition)
        
    * [The Enclosing Scope Concept](#heading-the-enclosing-scope-concept)
        
    * [Interpreting the Closure Definition](#heading-interpreting-the-closure-definition)
        
15. [Practical Example - Self-Contained Closures](#heading-practical-example-self-contained-closures)
    
    * [Understanding References](#heading-understanding-references)
        
16. [The Difference Between var and let](#heading-the-difference-between-var-and-let)
    
    * [Understanding var and let Scoping](#heading-understanding-var-and-let-scoping)
        
    * [Observing the Difference](#heading-observing-the-difference)
        
    * [Using IIFE with let](#heading-using-iife-with-let)
        
17. [Understanding Closures Through a Practical Stopwatch Example](#heading-understanding-closures-through-a-practical-stopwatch-example)
    
    * [Defining the Stopwatch Function](#heading-defining-the-stopwatch-function)
        
    * [Using the Stopwatch](#heading-using-the-stopwatch)
        
    * [Calling the Timer Function](#heading-calling-the-timer-function)
        
    * [Inspecting the Timer Function](#heading-inspecting-the-timer-function)
        
    * [Closures and Garbage Collection](#heading-closures-and-garbage-collection)
        
18. [Closures in Asynchronous Code](#heading-closures-in-asynchronous-code)
    
    * [Basic Asynchronous Example with setTimeout](#heading-basic-asynchronous-example-with-settimeout)
        
    * [External Function Reference Example](#heading-external-function-reference-example)
        
19. [Practical Example: API Requests with Closures](#heading-practical-example-api-requests-with-closures)
    
    * [Refactoring with External Function](#heading-refactoring-with-external-function)
        
20. [Advanced Example - Closures in Loops](#heading-advanced-example-closures-in-loops)
    
    * [Synchronous Loop Example](#heading-synchronous-loop-example)
        
    * [Asynchronous Loop Example](#heading-asynchronous-loop-example)
        
    * [The var vs let Problem](#heading-the-var-vs-let-problem)
        
    * [Using console.dir with Loop Closures](#heading-using-consoledir-with-loop-closures)
        
    * [The var Loop Problem](#heading-the-var-loop-problem)
        
    * [Fixing the var Loop Problem with IIFE](#heading-fixing-the-var-loop-problem-with-iife)
        
21. [Summary and Key Takeaways](#heading-summary-and-key-takeaways)
    
    * [What is a Closure?](#heading-what-is-a-closure-1)
        
    * [The Main Ideas in This Guide](#heading-the-main-ideas-in-this-guide)
        
    * [The Importance of Closures](#heading-the-importance-of-closures)
        
22. [Final Words](#heading-final-words)
...
Open **Live Server** from VS Code and you'll see: [http://127.0.0.1:5500/closure/index.html](http://127.0.0.1:5500/closure/index.html)
...
> "variables that are used locally, but defined in an enclosing scope" ([Reference](https://web.archive.org/web/20160722004334/https://developer.mozilla.org/en-US/docs/Web/JavaScript/Closures))
...
The modern definition now says, "closure is the combination of a function bundled together with references to its surrounding state" which is written more concisely compared to before. ([Reference](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Closures))
...
Now call the function. You need to pass a URL for the API call. A popular choice is [jsonplaceholder](https://jsonplaceholder.typicode.com/), so use its `/todos/1` endpoint:
...
You can find all the source code from this tutorial in this [GitHub repository](https://github.com/logicbaselabs/understanding-closure/). If it helped you in any way, consider giving it a star to show your support!
