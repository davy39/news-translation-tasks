...
* [What is Round Trip Time (RTT)?](#heading-what-is-round-trip-time-rtt)
    
    * [How Distance Increases Round Trip Time](#heading-how-distance-increases-round-trip-time)
        
* [How Round Trip Time Affects Web Performance](#heading-how-round-trip-time-affects-web-performance)
    
    * [Why Client-Side Rendering Feels Slower](#heading-why-client-side-rendering-feels-slower)
        
* [How to Reduce Round Trip Time with Next.js](#heading-how-to-reduce-round-trip-time-with-nextjs)
    ...
    * [Image Optimization](#heading-image-optimization)
        
    * [Caching and Static Rendering](#heading-caching-and-static-rendering)
        
* [Trade-offs Across Next.js Rendering Methods](#heading-trade-offs-across-nextjs-rendering-methods)
    
* [When to Use Each Rendering Method](#heading-when-to-use-each-rendering-method)
...
The probability of bounce increases 32% as page load time goes from 1 second to 3 seconds ([Google/SOASTA Research, 2017](https://www.thinkwithgoogle.com/marketing-strategies/app-and-mobile/page-load-time-statistics/)). That means about one-third of visitors leave before the page even loads.
