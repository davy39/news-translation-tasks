...
* [What is Chrome DevTools?](#heading-what-is-chrome-devtools)
* [How to Open Chrome DevTools](#heading-how-to-open-chrome-devtools)
* [Keyboard shortcuts for Easy Navigation](#heading-keyboard-shortcuts-for-easy-navigation)
* [Key Chrome DevTools Features](#heading-key-chrome-devtools-features)
* [Practical DevTools Use Cases](#heading-practical-devtools-use-cases)
...
_A grid of elements, console, performance and network panels screenshots_
...
_A screenshot of Chrome DevTools' Elements panel_
...
_A screenshot of Chrome DevTools' Console panel_
...
_A screenshot of Chrome DevTools' Network panel_
...
_A screenshot of Chrome DevTools' Performance panel_
...
* Chrome browser ([Click this link to download](https://support.google.com/chrome/answer/95346?hl=en&co=GENIE.Platform%3DDesktop))
...
_A screenshot of debugging the modal's HTML, CSS in Elements panel_
...
_A GIF fixing the modal in Chrome DevTools' Elements panel_
...
_A screenshot of setting breakpoints the modal's JS in Sources panel_
...
_A GIF troubleshooting the modal bug in Chrome DevTools' Elements panel_

## Optimize Performance with the Network Panel

Here I've added a fetch function that makes an API call to a live endpoint ([`https://jsonplaceholder.typicode.com/posts/1`](https://jsonplaceholder.typicode.com/posts/1)). This is an excellent opportunity to explore the Network Panel's capabilities in diagnosing and understanding network-related problems.
...
_A screenshot overview of API request in Network panel_
...
_A GIF observing API requests and responses in Chrome DevTools' Network panel_
...
* [The Official Chrome DevTools documentation](https://developer.chrome.com/docs/devtools)
* [How to use the Chrome DevTools to troubleshoot websites](https://www.freecodecamp.org/news/learn-how-to-use-the-chrome-devtools-to-troubleshoot-websites/)
