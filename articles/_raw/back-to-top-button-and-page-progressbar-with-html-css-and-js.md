---
title: How to Make a Back to Top Button and Page Progress Bar with HTML, CSS, and
  JavaScript
subtitle: ''
author: freeCodeCamp
co_authors: []
...
![Document with a gradient background and a fixed button and the bottom right corner that says "Back To Top"](https://www.freecodecamp.org/news/content/images/2021/12/image-28.png)
_Document with a gradient background and a fixed button and the bottom right corner that says "Back To Top"_
...
![Button with a styled SVG icon](https://www.freecodecamp.org/news/content/images/2021/12/image-30.png)
_Button with a styled SVG icon_
...
![Styled Back to Top Button](https://www.freecodecamp.org/news/content/images/2021/12/image-44.png)
_Styled Back to Top Button_
...
![Page Scroll Progress Bar on Scroll](https://www.freecodecamp.org/news/content/images/2021/12/image-46.png)
_Page Scroll Progress Bar on Scroll_
...
![Screenshot explaining clientHeight and scrollHeight](https://www.freecodecamp.org/news/content/images/2021/12/image-47.png)
_Screenshot explaining `clientHeight` and `scrollHeight`_
