...
1. [Background](#heading-background)
    
2. [Understanding IP Addresses](#heading-understanding-ip-addresses)
...
4. [How to Determine Network vs. Host Portions](#heading-how-to-determine-network-vs-host-portions)
    ...
    * [Fixed-Length Approach](#heading-fixed-length-approach)
        
    * [What are the disadvantages here? 🤔](#heading-what-are-the-disadvantages-here)
        
5. [Classful Addressing](#heading-classful-addressing)
    
    * [IP Address Assignment](#heading-ip-address-assignment)
        
    * [What are the disadvantages here? 🤔](#heading-what-are-the-disadvantages-here-1)
        
6. [CIDR: Classless Interdomain Routing](#heading-cidr-classless-interdomain-routing)
    
    * [Real-world Example](#heading-real-world-example)
...
9. [Test Yourself](#heading-test-yourself)
    ...
    * [Converting Between Prefix Notation and Subnet Masks](#heading-converting-between-prefix-notation-and-subnet-masks)
        
    * [Working Backwards with Subnet Masks](#heading-working-backwards-with-subnet-masks)
        
    * [Non-Byte-Aligned Prefixes](#heading-non-byte-aligned-prefixes)
        
    * [Determining Network Membership](#heading-determining-network-membership)
        
10. [Special IPv4 Addresses](#heading-special-ipv4-addresses)
    
    * [The "This Host" Address: 0.0.0.0](#heading-the-this-host-address-0000)
        
    * ["This Network" Addresses](#heading-this-network-addresses)
        
    * [Broadcast Addresses](#heading-broadcast-addresses)
        
    * [Loopback Addresses: 127.0.0.0/8](#heading-loopback-addresses-1270008)
        
    * [Summary of Special IPv4 Addresses](#heading-summary-of-special-ipv4-addresses)
        
11. [IPv4 Header](#heading-ipv4-header)
    
    * [The Header Structure](#heading-the-header-structure)
        
    * [IPv4 Header – Interim Summary](#heading-ipv4-header-interim-summary)
        
12. [IPv4 Fragmentation](#heading-ipv4-fragmentation)
    
    * [Why Fragmentation Is Needed](#heading-why-fragmentation-is-needed)
        
    * [How Fragmentation Works in IP](#heading-how-fragmentation-works-in-ip)
        
    * [Identification Field](#heading-identification-field)
        
    * [Fragment Offset](#heading-fragment-offset)
        
    * [More Fragments and Don't Fragment Flags](#heading-more-fragments-and-dont-fragment-flags)
        
    * [Fragmentation Example](#heading-fragmentation-example)
        
    * [IPv4 Fragmentation – Summary](#heading-ipv4-fragmentation-summary)
...
14. [About the Author](#heading-about-the-author)
    
15. [Additional References](#heading-additional-references)
    

## Quick notes before we start

1. You can find more content about computer networks on my YouTube channel: [Computer Networks Playlist](https://www.youtube.com/playlist?list=PL9lx0DXCC4BMS7dB7vsrKI5wzFyVIk2Kg)
    
2. I am working on a book about Computer Networks! Are you interested in reading the initial versions and providing feedback? Send me an email: [gitting.things@gmail.com](mailto:gitting.things@gmail.com)
...
[![An example IPv4 address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744039300370/348d757a-c6b0-4930-8e3a-ee753c45f3fa.png align="center")](https://www.youtube.com/watch?v=zlDkqP3lMmU)

Test yourself – Does the following address represent a valid IP address?

[![Is this a valid IPv4 address? (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744039900249/587d8b94-1ac3-478c-87d9-4b0fd97023b2.png align="center")](https://www.youtube.com/watch?v=zlDkqP3lMmU)
...
[![This is not a valid IPv4 address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744040039746/71392606-7ac8-441d-ac36-2cf05bb8d67f.png align="center")](https://www.youtube.com/watch?v=zlDkqP3lMmU)
...
[![Network Identifier vs Host Identifier (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744040184260/2511a5f3-3a98-40e4-aabe-7853e3febacf.png align="center")](https://www.youtube.com/watch?v=zlDkqP3lMmU)
...
![Fixed-Length approach for IP addressing (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744040959545/38c8766b-5ad2-4fb1-98b1-612c70fbe8ad.png align="center")
...
![Classful addressing approach (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744088968355/e7f128c0-3173-4bb5-8872-3f820de6b354.png align="center")
...
![16-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744090490906/0a18b364-7ca2-4ed0-8f27-2103bcbdd579.png align="center")
...
![16-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744090582529/d314c9ca-73a3-4e48-92b8-b0a6c24ac7d3.png align="center")
...
Another way to express the network prefix is by using a [subnet mask](https://www.ipxo.com/blog/what-is-subnet-mask/), like so:
...
![16-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744090679551/5466e739-1e1b-4e34-a044-0d680ca9ad6e.png align="center")
...
![8-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744141258583/c4f606ff-410b-4b1f-92c5-505b5309cfa8.png align="center")
...
![24-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744297152994/0dae747f-2a10-4ad6-9e29-b21df15e6169.png align="center")
...
![16-bit subnet mask address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465135834/ff449f60-e660-4fea-b427-994a87be2c89.png align="center")

Given this network prefix, do these addresses belong to the same network?

![Do these addresses fit in the network defined before? (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465178617/ef7ddeca-86b2-4bb2-8e1d-471ef4f64a45.png align="center")

Yes, they do, as they share the same most-significant `16` bits, or two bytes

![These addresses fit in the same network (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465209149/25744a22-16b3-484d-9821-12920dd59be4.png align="center")

Does this address belong to the same network as that of the previous addresses?

![Additional address (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465232371/92bcb42c-5067-43e6-8cec-1eae9347d16a.png align="center")

Yes, it does. Again, it shares the same two most-significant bytes.

![This address also fits in the network defined before (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465259087/a4b9c525-3b4d-4501-bcf8-db62ebf47247.png align="center")

What about this one? Does it belong to the same network as the previous addresses?

![Additional address. Does this address fit in the network defined before? (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465285214/f57fd6c2-7665-4565-943e-959b981fedc8.png align="center")
...
![No, this address does not belong to the same network as the other ones (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465302503/0fdd959f-2d10-4a56-826d-e71604ca5267.png align="center")
...
![24-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465331643/b1f3ab4c-8e7e-449d-8879-fee3bf90ce1c.png align="center")

Given this subnet mask, do addresses (1) and (3) above belong to the same network?

![Do these addresses have the same network ID given a 24-bit subnet mask? (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465436680/ca71584d-53dc-4116-a109-d32c11e997ef.png align="center")

They do, as they both have the same most-significant three bytes – network `42.31.93`.

![24-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465461745/c01f5958-f675-45c5-bc41-de857483e25d.png align="center")

What about addresses (1) and (2)?

![Do these addresses have the same network ID given a 24-bit subnet mask? (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465532664/a0ef8f73-27d5-4488-98a9-1dbeaf457797.png align="center")
...
![24-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465498737/6d4cb056-126a-422f-94bc-4392a996869c.png align="center")
...
![14-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465576989/bb1a90c1-1563-4970-b0f5-e0f502e82563.png align="center")
...
![19-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465642118/2587e3bc-0c88-48a9-b876-b96fd3a493d1.png align="center")

### Determining Network Membership

Let's consider the following addresses:

![Two IP addresses (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465744667/86337750-0f67-4ed7-b8c2-7d6fcf330a71.png align="center")
...
![8-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465761356/67c590e1-daf5-4276-96ff-a39ee914d2d3.png align="center")
...
![12-bit subnet mask (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744465797029/fcbc4bd8-e273-4032-afb3-f10e2028738b.png align="center")
...
The address `255.255.255.255`, where all bits are set to `1`, is the address of all hosts in the local network – the broadcast address. This is similar to the [broadcast address in Ethernet](https://www.freecodecamp.org/news/the-complete-guide-to-the-ethernet-protocol/#heading-unicast-and-multicast-bits) (`FF:FF:FF:FF:FF:FF`). In both cases, all bits are set to `1`.
...
![Loopback operation (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1744736895494/fd1e4a8d-a834-4bf4-b4b9-1e83cf851161.png align="center")
...
![IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745583720695/21521520-3029-4a0a-b4e7-fa484ca350ab.png align="center")

The diagram above shows the header of IPv4 as defined in RFC 791. Let's examine each field:

#### Version (4 bits)

![Version field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745589954987/cb357d49-73ab-43e6-93b5-c2b7c7e3eb4a.png align="center")
...
![IHL field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745590070221/ca452338-299c-422c-aef4-8fe8569dd218.png align="center")

This field indicates the length of the header itself.

❓ Why do we need to specify the length? 🤔

Unlike [Ethernet](https://www.freecodecamp.org/news/the-complete-guide-to-the-ethernet-protocol/), where the header size is fixed, the IPv4 header length can vary because of optional fields. For an IP packet without special options, the header consists of `20` bytes, which is the most common case.
...
![TOS field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745590323255/e8a30561-bfbf-4bcd-a07c-3dbce88fc6c4.png align="center")
...
![Total Length field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745590421285/07a4b428-3a97-4ea8-9006-5fd8bb215d95.png align="center")
...
Unfortunately, the IP layer doesn’t necessarily know if some of the bytes in the packet are actually a padding of the second layer. I described this in detail in [a previous post](https://www.freecodecamp.org/news/the-complete-guide-to-the-ethernet-protocol/#heading-the-problem-with-the-type-length-field), where I showed that in Ethernet protocol, in some cases, [the receiving Ethernet entity cannot tell which bytes belong to the payload and which bytes are simply padding](https://www.freecodecamp.org/news/the-complete-guide-to-the-ethernet-protocol/#heading-the-problem-with-the-type-length-field). The IP layer needs to know precisely which bytes belong to the actual packet, hence the Total Length field.
...
![Fragmentation fields within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591136348/bb1035af-c967-4bb8-992c-c10e31b64cd1.png align="center")
...
![TTL field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591194176/3f3f98f6-b079-43d3-9ee3-b052b7f4f6d7.png align="center")
...
![A routing issue causing an infinite loop (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745775904428/72ba07f9-461d-483f-be16-773218d8f863.png align="center")
...
![Protocol field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591243041/ab9be6ea-5f11-4bb1-b93f-f0d9deef0c6f.png align="center")
...
This helps the receiving system know which protocol handler should process the packet's contents. It's similar to [the Type field in Ethernet](https://www.freecodecamp.org/news/the-complete-guide-to-the-ethernet-protocol/#heading-type-length-field-ethernet-ii-type-2-bytes), which specifies the protocol of the layer encapsulated within the Ethernet frame.

#### Header Checksum (16 bits)

![Header checksum field within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591295127/9953fb34-2b2f-4c9f-bf39-7a18ceaf2b1a.png align="center")
...
![Source and Destination IP Addresses fields within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591643443/b2409ba4-d2e3-468a-af2a-a71fc4ce4c30.png align="center")
...
![Options within IPv4 Header (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745591747762/66a3d602-4379-453a-b221-b4f694c3363c.png align="center")
...
![Two networks with different MTUs (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745770107962/b3bc6c7a-2adb-4868-893c-ec9e51303567.png align="center")
...
![Two IP packets, each consisting of two fragments (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745770316245/b137efa8-ae1c-42cb-918a-f6d0ee7b2c3a.png align="center")
...
![Possible issues in reassembling packets from two fragments (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745770377464/12aad8f1-0251-4289-bc9a-75084dbc1f7a.png align="center")
...
![The identification fields ensures fragments of the same original packet are reassembled together (Source: https://youtube.com/BriefVid)](https://cdn.hashnode.com/res/hashnode/image/upload/v1745770785114/6f04e59b-adfc-44a9-bf6e-1118ab748160.png align="center")
...
[Omer Rosenbaum](https://www.linkedin.com/in/omer-rosenbaum-034a08b9/) is [Swimm](https://swimm.io/)’s Chief Technology Officer. He's the author of the Brief [YouTube Channel](https://youtube.com/@BriefVid). He's also a cyber training expert and founder of Checkpoint Security Academy. He's the author of [Gitting Things Done](https://www.freecodecamp.org/news/gitting-things-done-book/) (in English) and [Computer Networks (in Hebrew)](https://data.cyber.org.il/networks/networks.pdf). You can find him on [Twitter](https://twitter.com/Omer_Ros).
