...
co_authors: []
series: null
date: '2019-11-11T14:57:44.000Z'
originalURL: https://freecodecamp.org/news/career-switchers-guide-to-your-dream-tech-job
coverImage: https://www.freecodecamp.org/news/content/images/2019/11/googleplex.jpg
tags:
- name: Career Change
  slug: career-change
- name: Job Interview
...
- name: technology
  slug: technology
seo_title: null
seo_desc: 'By David Tian

  In this article, I''ll discuss some pro tips that''ll help you ace your interviews
  at your dream companies and get the most out of your job offers.

  Introduction — From Wall Street to the Googleplex

  On March 31, 2019, I was downsized by a ...'
---
...
![Image](https://miro.medium.com/max/3264/1*nhcfyWkKLu_q4mBTetSHyw.jpeg)
_The Googleplex: Google’s Worldwide Headquarters_
...
# [About Me](https://www.linkedin.com/in/dctian)
...
![Image](https://www.freecodecamp.org/news/content/images/2019/11/image-4.png)
_[https://www.linkedin.com/in/dctian](https://www.linkedin.com/in/dctian)_
...
But in early April, while I was vacationing with my family in Mexico, one night I suddenly had a revelation that I wanted to build a self-driving car. Given that I had no prior experience with robotics or electronics, I set out to build a [Deep Learning/Self-Driving Robotic Car, DeepPiCar](https://towardsdatascience.com/tagged/deep-pi-car), that could run in my living room. 
...
![Image](https://miro.medium.com/max/1776/0*PqGFISPKqUjwc_Ki.jpeg)
_DeepPiCar running in my living room_
...
* If you want to transition into front-end development, create a cool website with a lot of interactivity with popular open-source frameworks, such as [React](https://reactjs.org/) and [Angular](https://angular.io/).
* If you are interested in server-side development, try to create a web crawler or search engine using distributed server technology such as [Cassandra](http://cassandra.apache.org/), [ZooKeeper](https://zookeeper.apache.org/), [Memcached](https://memcached.org/), and [Elastic Search](https://www.elastic.co/webinars/getting-started-elasticsearch), etc
...
* If you are interested in AI/ML, take one of the existing Computer Vision or Natural Language Processing deep learning models, and try to make a product out of it. For example, I took a pre-trained [object detection model, SSD](https://arxiv.org/abs/1512.02325), and adapted it to be a traffic sign detector for my DeepPiCar. If you are new to AI/ML, be sure to read [Part 1 of DeepPiCar](https://towardsdatascience.com/deeppicar-part-1-102e03c83f2c?source=---------5-----------------------), where I list several ML courses and resources to get you started.
* If you are into robotics, try to build some cool robots using a Raspberry Pi or an Nvidia Jetson Nano. Be sure to use either the new [Raspberry Pi 4](https://www.raspberrypi.org/products/raspberry-pi-4-model-b/) or [Jetson Nano](https://developer.nvidia.com/embedded/jetson-nano-developer-kit). Raspberry is more widely used by makers and enjoys better support, while Jetson Nano has a GPU onboard, so it may be better for [Deep Learning projects](https://www.sparkfun.com/products/15365).
* If you don’t have any project ideas, do not despair. You can always contribute to one of the open-source projects mentioned above, as well as [TensorFlow](http://tensorflow.org/) or [PyTorch](http://pytorch.org/) if you are into AI/ML. You may think you need to be an expert to contribute to these well-known open-source projects. You do NOT. Actually, in each open source project, there are quite a few small features and easy bug fixes designated for noobs to get their hands dirty first. This way, you can be familiar with the code base and submission process before tackling more complex issues.

![Image](https://miro.medium.com/max/1688/0*Ch5vkdlhxP1uRsbe.png)
_Top Open-Source Projects_
...
![Image](https://miro.medium.com/max/1080/1*blXkdzZ0Z2T9cezJmmX96g.png)
_DeepPiCar’s Blog Series_
...
![Image](https://miro.medium.com/max/1360/0*nS7N-kMs_oFwiTcG.png)

[**Tushar Roy’s LeetCode Hard Solutions**](https://www.youtube.com/watch?v=l3hda49XcDE&list=PLrmLmBdmIlpuE5GEMDXWf0PWbBD9Ga1lO): Tushar is actually an Engineering Manager at Apple. He made these videos when he was just a software engineer. I would say that watching his videos taught me not only these algorithms but also how to **present** complex ideas/algorithms clearly. This helped me immensely when I was doing whiteboard coding during on-site interviews.

![Image](https://miro.medium.com/max/1280/0*sTf-RyIfjStnTdf1.jpg)
...
* [**Cracking the Coding Interview Book(CtCI)**](https://amzn.to/2LLxmSm): There is a chapter that discussed system design, but it is covered at a pretty basic level
* [**Gaurav Sen’s System Design YouTube Channel**](http://youtube.com/watch?v=quLrc3PbuIw&list=PLMCXHnjXnTnvo6alSjVkgxV-VH6EPyvoX): I felt unfulfilled after reading CtCI’s system design chapter. Then I stumbled upon Gaurav’s channel, which has 22 videos. I downloaded all his videos onto my laptop and watched them on a long plane ride. Man, this guy is so GOOD (and funny) and explains things so clearly! About 10 videos are in-depth descriptions of individual distributed system components, the rest are actual use case discussion on how to build Netflix, or Tinder, or Facebook systems, etc.

![Image](https://miro.medium.com/max/1280/0*rIMPbQS57T_u5U-R.jpg)

* [**Tushar Roy’s System Design Videos**](https://www.youtube.com/watch?v=UzLMhqg3_Wc&list=PLrmLmBdmIlps7GJJWW9I7N0P0rB0C3eY2)**:** While Tushar is very good in LC Hard questions, he also has 5 great System Design videos. I recommend watching these videos after Gaurav’s, as Gaurav gives you a solid foundation in system design, and Tushar’s videos assume some of that knowledge.
...
![Image](https://miro.medium.com/max/1280/0*7R7K7tRug6GBHdfT.jpg)
...
![Image](https://miro.medium.com/max/937/1*a-pon57rs0aflAfiOj86lw.png)
...
![Image](https://miro.medium.com/max/1176/1*wZtT-iVYzKI26gNohTXAhw.png)

Internal Referrals — Have a strong advocate

![Image](https://miro.medium.com/max/700/0*07v0u9hdLQjmnQ00.jpg)
...
Overall, I felt that most 3rd party agencies didn’t work well for my job search this time. As a reference, when I looked for finance jobs in the past, I exclusively used executive search firms, and the results were great. But most of the tech giants don’t use 3rd party recruiting agencies. The only agencies that worked well for me were [TripleByte](https://triplebyte.com/iv/Wzwz8pq/cp/header) and [DeepLearning.ai](http://deeplearning.ai/), which I will discuss below.

### [TripleByte](https://triplebyte.com/iv/Wzwz8pq/cp/header) — Skip the phone interviews

![Image](https://miro.medium.com/max/1067/1*N8n2DoEP57Wpmtb0xmKF6w.png)
...
When I passed TripleByte’s test, I could choose from about 200 companies. They were mostly small startups, but with quite a few large companies, such as Apple, Adobe, American Express, etc. I ended up interviewing with the [Apple Siri group](https://www.apple.com/siri/) (huge), [Zoox](https://zoox.com/) (medium), and [Determined.ai](https://determined.ai/) (small) on-site. All of them are doing amazing engineering work. 

I highly recommend going through the TripleByte process, as it identified my weak points and saved me from many hours of phone screening and related headaches. [Take TripleByte’s online test here](https://triplebyte.com/iv/Wzwz8pq/cp/header).

### [DeepLearning.ai](http://deeplearning.ai/) and [Workera.ai](http://Workera.ai) — The Gospel for Aspiring Data Scientists/ML Engineers

![Image](https://miro.medium.com/max/1171/1*I5gI_cSrZLdT3fFf4N_cYQ.png)
...
![Image](https://miro.medium.com/max/528/1*LCR7hMBbjU3yzZGuze_sNw.png)
...
![Image](https://miro.medium.com/max/485/0*vN0RSfOWzKkGulG7.jpg)

One or two days before the technical phone interview, be sure to read up on [Glassdoor](http://glassdoor.com/) and [Leetcode](https://leetcode.com/) for previously asked interview questions for this company. For big companies, such a Google and Facebook, this does NOT work well, as there are hundreds of previously asked questions. 
...
![Image](https://miro.medium.com/max/1280/0*P4QVsG3vBNfY6UhY.jpg)
...
![Image](https://miro.medium.com/max/940/0*ZPXWlO_1OlBQa5fw.jpg)
...
![Image](https://miro.medium.com/max/600/1*HOQJzGbrCYQrXMZoIPl3UQ.png)
...
![Image](https://miro.medium.com/max/650/0*_KphaQpx9VCemE2C.jpg)
...
![Image](https://miro.medium.com/max/2000/0*4QQMQfLgKT0Y7XLV.png)
...
![Image](https://miro.medium.com/max/516/0*zYwn2rtIyq9npuS_.png)
...
![Image](https://miro.medium.com/max/1386/0*ZQjHTN8X0xZw0A1J.jpg)
...
![Image](https://miro.medium.com/max/750/0*2DB9c6E9xy1Hsu_e)

For take-home projects, since you typically need to spend a lot of time on them, make sure you are using your time wisely. 

For a company that you are really excited about, yes, do spend the 8–10 hours do a nice job coding and documenting your approach and design decisions. For [Scale.ai](http://scale.ai/)’s project, I spent at least 10 hours working on their project — even though the instruction told me to only spend about 2–3 hours. I did this because I thought it was fun and I learned a lot by exploring different ML approaches. 
...
![Image](https://miro.medium.com/max/400/0*XF9LDZeQZ6_GVE0J)
...
![Image](https://miro.medium.com/max/696/0*C5eicXplRRZIxXk3.png)
...
![Image](https://miro.medium.com/max/1280/0*Vnhf3KUToEKuUIGV.jpg)
_Gaurav Sen Designing WhatsApp_
...
![Image](https://miro.medium.com/max/1000/0*FuUaWBV2H26hOdIy.jpg)
...
![Image](https://miro.medium.com/max/1280/0*zrHrbhiBz6Mfv79F.jpg)
_Tushar Roy talking about Trie Data Structure_
...
Once you are done coding, try to walk through your code line-by-line with the diagrams on the side, so that you can show the interviewer that your implementation matches what you intended to do. Be sure to watch [**Tushar Roy’s LeetCode Hard Solutions**](https://www.youtube.com/watch?v=l3hda49XcDE&list=PLrmLmBdmIlpuE5GEMDXWf0PWbBD9Ga1lO) YouTube videos to learn how to present ideas on a whiteboard.
...
![Image](https://miro.medium.com/max/400/0*VOO-nVdsgXIbDUr5.png)
...
![Image](https://miro.medium.com/max/998/0*rvbji0M2GsMoD0CW.png)
...
![Image](https://miro.medium.com/max/2000/0*VsgMcMV6BniWLJgN.jpg)
...
![Image](https://miro.medium.com/max/1024/0*TBXEsZ8Nnx8eWzk-.jpg)
...
![Image](https://miro.medium.com/max/2000/0*m4TbZx-yWlVl0HCy.jpg)
...
![Image](https://miro.medium.com/max/480/0*cU5XEYWCmu9FJg8u)

### Components of an Offer Package

![Image](https://miro.medium.com/max/624/0*mU6OkvJojAbaIaV5.png)
_Source: levels.fyi_
...
![Image](https://miro.medium.com/max/1025/1*iSvZ60-cnf0qTPfwEGDHCw.png)
...
Fortunately, in recent years, the compensation information has been democratized, with many websites crowdsourcing from many candidates and then presenting the anonymized compensation data by level, job function and location. One well-known site is [levels.fyi](http://levels.fyi/).

![Image](https://miro.medium.com/max/917/1*LCu-2A8IXNYVfe-m9t5AFQ.png)
_Top Compensation for 3–5 YoE SWE. Source: levels.fyi_

![Image](https://miro.medium.com/max/912/1*9pETieZ01nFFBNkjoz7MbA.png)
_Top Compensation for 5+ YoE SWE. Source: levels.fyi_
...
For any non-Bay Area engineers, total compensation of $300,000–$400,000 may be eye-popping. But remember that Bay area housing is THE most expensive metro area in the US. The median housing price of Palo Alto, CA is $2.8M (source: Zillow.com), and of San Francisco Metro Area (source: [censusreporter.com](https://censusreporter.org/profiles/31400US4186041884-san-francisco-redwood-city-south-san-francisco-ca-metro-division/)) is $1.1M. For preciously this reason — lots of people are paid at a much higher rate. 

As a comparison, the median home prices of Manhattan, NY is $1.2M (source: Zillow.com), and that of New York/New Jersey Metro Area is only $440K. (source: [censusreporter.com](https://censusreporter.org/profiles/31000us35620-new-york-newark-jersey-city-ny-nj-pa-metro-area/))
...
![Image](https://miro.medium.com/max/1055/1*de6XA2-BzEbzRDASwdWEXA.png)

### Startups

![Image](https://miro.medium.com/max/285/0*m0izqd9brSBsnkdr)
...
In reality, these equity components are hard to evaluate, are extremely non-liquid with no monetary value for years to come, and indeed go to zero value when [90% of all startups fail](https://www.forbes.com/sites/neilpatel/2015/01/16/90-of-startups-will-fail-heres-what-you-need-to-know-about-the-10/#35d103c06679). (source: Forbes).
...
![Image](https://miro.medium.com/max/293/1*I3BYbnGWZCkQOJKaxwGSdA.png)
...
![Image](https://miro.medium.com/max/650/0*m5gcnqcx9RKhAzZj.png)
...
![Image](https://miro.medium.com/max/922/0*tD7uB2HX3Adlzhsm.png)
...
![Image](https://miro.medium.com/max/1540/0*QValU2nlepbet2yU)
...
![Image](https://miro.medium.com/max/445/1*ehMi2Z73NL4MxN6alUr1yw.png)
...
[**Blind**](https://www.teamblind.com/): This is an app that allows employees of varies companies (mostly tech) to post questions and answers anonymously. People generally discuss career decisions, company culture, interviews, and compensation, etc. 
...
![Image](https://miro.medium.com/max/730/0*r7S6egJR6P9O9WP7)

[**Coursera**](https://www.coursera.org/): Learn about the subjects you are passionate about. It is free or for a very nominal fee. I took both Machine Learning and Deep Learning courses there.

![Image](https://miro.medium.com/max/512/0*EcegqF8UG1uE9qGO)

[**DeepLearning.ai**](http://deeplearning.ai/) **and** [Workera**.ai**](https://www.freecodecamp.org/news/career-switchers-guide-to-your-dream-tech-job/Workera.ai)
...
[**Elements of Programming Interviews**](https://amzn.to/31O2JBe) **Book:** This is another excellent interview preparation book, similar to the CtCI book. But it is more geared towards experienced engineers, while CtCI can be read by beginners who have little algorithms background.

![Image](https://miro.medium.com/max/350/0*5aU2C4jyITY0A8-D.jpg)

[**GeeksForGeeks**](https://www.geeksforgeeks.org/): Like LeetCode, this is another website with very comprehensive A&DS questions and solutions. This site is free, and sometimes contains interview questions not found in LeetCode.

![Image](https://miro.medium.com/max/667/0*ZTMjAXFNZJnxw5wM.png)

[**Glassdoor**](https://www.glassdoor.com/index.htm)



![Image](https://miro.medium.com/max/589/1*qVt2_-4lyAnBgBxpQ7JV5A.png)

* Check a company’s employee reviews
* Find previous interview questions
* Set up job alerts to receive new job updates

[**Google Search**](https://www.google.com/): The starting point for ANY question in life. Do I need to say more?

![Image](https://miro.medium.com/max/1280/0*foG6evRh08Khr-wZ.jpg)

**Internal Employees:** Always try to reach out to your friends, or friends of friends, that work in the companies you want to apply to. They will be your most effective informants as well as advocates. [Connect with me on LinkedIn](https://www.linkedin.com/in/dctian/), and if you are a good fit, I would be happy to refer you to Google myself, or one of my friends who work at other top tech firms.
...
[**Level.fyi**](https://levels.fyi/): This site lists crowdsourced salary information by company, by seniority levels, by location, and by job function, so you will know if you are getting a fair offer from the companies. Of course, this works well only for larger companies, as there are more data points.

![Image](https://miro.medium.com/max/560/0*y6YcevhJEHIeMO0-.jpg)
...
[**Medium**/**Blog Sites**](https://medium.com/):
...
![Image](https://miro.medium.com/max/590/1*YNzUC78SPulsAznKTeUyNw.png)

[**TripleByte**](https://triplebyte.com/iv/Wzwz8pq/cp/header): Skip the phone interviews and directly go to on-sites if you pass their tech screening. See detailed description above

[**YouTube**](https://youtube.com/)



![Image](https://miro.medium.com/max/491/1*lVrmEfw_VMiq51OoZNKVkw.png)
