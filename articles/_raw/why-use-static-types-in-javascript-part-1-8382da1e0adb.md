---
title: Why use static types in JavaScript? (A 4-part primer on static typing with
  Flow)
subtitle: ''
author: freeCodeCamp
co_authors: []
...
I created an abstraction for the type `T`. Now you can use whatever type you want to represent `T`. For `numberT`, `T` was of type `number`. Meanwhile, for `arrayT`, T was of type `Array<numb`er>.
