...
_**Bootstrap source code example from Github**_
...
_**Git status gives information about the branch &amp; files**_
...
_**Files with green are now staged with git add**_
...
_**commit history of my master branch**_
