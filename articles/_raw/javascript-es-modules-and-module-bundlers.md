---
title: The JavaScript Modules Handbook – Complete Guide to ES Modules and Module Bundlers
subtitle: ''
...
1. [What Exactly Is a JavaScript Module?](#heading-what-exactly-is-a-javascript-module-2)
2. [Why Use Modules?](#heading-why-use-modules)
3. [Common Types of Module Systems in JavaScript](#heading-common-types-of-module-systems-in-javascript)
4. [How to Convert a JavaScript File into a Module](#heading-how-to-convert-a-javascript-file-into-a-module)
5. [How to Use an ES Module](#heading-how-to-use-an-es-module)
6. [How to Export a Module's Code](#heading-how-to-export-a-modules-code)
7. [How to Import Exported Code](#heading-how-to-import-exported-code)
8. [How to Use a Module's Imported Code](#heading-how-to-use-a-modules-imported-code)
9. [How to Rename Exports and Imports in ES Modules](#heading-how-to-rename-exports-and-imports-in-es-modules)
10. [Why Rename a Module's Code?](#heading-why-rename-a-modules-code)
11. [How to Rename Multiple Exports in an ES Module](#heading-how-to-rename-multiple-exports-in-an-es-module)
12. [How to Rename Multiple Imports in an ES Module](#heading-how-to-rename-multiple-imports-in-an-es-module)
13. [How to Import All Exportable Items from an ES Module in One Go](#heading-how-to-import-all-exportable-items-from-an-es-module-in-one-go)
14. [How to Export Anonymously to an ES Module](#heading-how-to-export-anonymously-to-an-es-module)
15. [What Exactly Is an Aggregator File?](#heading-what-exactly-is-an-aggregator-file)
16. [Project: How to Use an Aggregator File](#heading-project-how-to-use-an-aggregator-file)
17. [How to Use the `import()` Syntax to Load a Module Dynamically](#heading-how-to-use-the-import-syntax-to-load-a-module-dynamically)
18. [What Exactly Is `import.meta` in ES Modules?](#heading-what-exactly-is-importmeta-in-es-modules)
19. [Quick Review of Modules So Far](#heading-quick-review-of-modules-so-far)
20. [What Is a Module Bundler?](#heading-what-is-a-module-bundler)
21. [Why Do You Need a Module Bundler?](#heading-why-do-you-need-a-module-bundler)
22. [How Does a Module Bundler Work?](#heading-how-does-a-module-bundler-work)
23. [How to Use Webpack](#heading-how-to-use-webpack)
24. [How to Make Webpack Auto-Generate Your App's HTML File](#heading-how-to-make-webpack-auto-generate-your-apps-html-file)
25. [How to Make `HtmlWebpackPlugin` Use Your Source File as a Template to Auto-Generate a New HTML Page](#heading-how-to-make-htmlwebpackplugin-use-your-source-file-as-a-template-to-auto-generate-a-new-html-page)
26. [Important Stuff to Know about Updating Your App](#heading-important-stuff-to-know-about-updating-your-app)
27. [How to Rerun Webpack Automatically](#heading-how-to-rerun-webpack-automatically-1)
28. [How to Reload the Browser Automatically](#heading-how-to-reload-the-browser-automatically)
29. [What Exactly Is Webpack's Configuration File?](#heading-what-exactly-is-webpacks-configuration-file-3)
30. [Common Webpack Configuration Options](#heading-common-webpack-configuration-options)
31. [Overview](#heading-overview)
...
_Opening an index.html file in a Chrome browser_
...
_Inspecting a Chrome browser's console_
...
_Adding a project folder to VSCode's workspace_
...
_Installing the VSCode Live Server by Ritwick Dey_
...
_Opening HTML file in VSCode editor_
...
_Opening the project's HTML file with Live Server_
...
_A highlight of the project's aggregator file_
...
A **module bundler** is a tool developers use to bundle an app's [modules](#heading-what-exactly-is-a-javascript-module-2) and dependencies into a single browser-compatible JavaScript file.
...
A module bundler's last step is to save the compiled code into [step 1](#heading-first-it-creates-an-output-script-file)'s output script file.
...
* By default, Webpack generates its bundle as a `main.js` file—which it will save in the distribution folder you created in step 5. However, you can change the default setting by creating a configuration file—which Webpack will use automatically. We will discuss creating and using a configuration file [later](#heading-what-exactly-is-webpacks-configuration-file-3) in this guide.
...
Remember that you created your HTML file manually in [step 6](#heading-step-6-create-your-source-code-files). However, Webpack can also auto-generate one for you. Let's find out how.
...
**Note:** We will discuss how to use a configuration file [later](#heading-what-exactly-is-webpacks-configuration-file-3) in this guide.
...
Notice that the HTML document generated by `HtmlWebpackPlugin` does not contain [your source file](#heading-step-7-add-the-javascript-file-to-your-html-document)'s `<h1>` and `<button>` elements.
...
Open your `index.html` _source code_ file and delete the `<script>` tag you [previously used](#heading-step-12-refer-browsers-to-the-newly-created-bundle) to reference Webpack's distribution bundle.
...
2. Delete the `watch` property you [previously added](#heading-how-to-rerun-webpack-automatically-1) to your `package.json` file.

### Step 2: Specify your files' location

Tell the web server where it should get the files that Webpack did not generate by adding a `devServer` option to the configuration file you [created previously](#heading-step-2-create-a-configuration-file):
...
* We will discuss how to use a configuration file [later](#heading-what-exactly-is-webpacks-configuration-file-3) in this guide.
...
Remember that we used a configuration file in [step 2](#heading-step-2-specify-your-files-location). Let's talk more about what the file does.
...
The `module` field makes Webpack process assets—like CSS files and fonts—as [modules](#heading-what-exactly-is-a-javascript-module-2) in the dependency graph.
...
_Image of a development mode bundle compiled with webpack_

To make a non-minified output file readable, ensure Webpack's [devtool](#heading-devtool) field is not `eval`.
...
_Image of a production mode bundle compiled with webpack_
...
_Image of a none mode bundle compiled with webpack_
