...
* [What's Covered?](#heading-whats-covered)
    
* [What’s this Sheet Agent?](#heading-whats-this-sheet-agent)
    
* [How to Set Up the Project](#heading-how-to-set-up-the-project)
    
* [Core Components in the Application](#heading-core-components-in-the-application)
    
* [Google Sheet Agent in Action](#heading-google-sheet-agent-in-action)
...
![Working of an AI Agent](https://cdn.hashnode.com/res/hashnode/image/upload/v1757925559119/187f2b32-ddf0-46fb-8359-8cb62699da57.webp align="center")
...
To get the Composio API key, create an [account](https://platform.composio.dev/auth) and log in to the dashboard. You can find the API key in your default project settings.
...
![Google Sheets account connection button in Composio](https://cdn.hashnode.com/res/hashnode/image/upload/v1757925645287/a727f2d0-c151-4dea-96bf-3d2b6317cc8d.png align="center")
...
You can read more about it here: [Gemini Speech Generation (text-to-speech)](https://ai.google.dev/gemini-api/docs/speech-generation).
...
And if you want to use the OpenAI package, which is much easier to use as it returns the speech in `mp3` format, check out this project of mine: [shricodev/voice-chat-ai-agent (TTS)](https://github.com/shricodev/voice-chat-ai-configurable-agent/blob/main/app/api/tts/route.ts).
...
You can find the entire source code here: [shricodev/google-sheet-super-agent](https://github.com/shricodev/google-sheet-super-agent).
