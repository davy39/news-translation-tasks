...
Read [this link](https://github.com/robotopia-x/robotopia) to see how building a tool that helps libraries, schools, and educational institutions made teaching fun and entertaining.
...
_Makey-Makey workshop in the Stuttgart City Library_
...
_One of the solutions to the alarm clock task_
...
_One of the first mockups of the wizard idea_
...
_An example of the Blockly programming language_
...
_An older version with Robot Rick still in the program_
...
_A list of tutorials separated by topic_
...
_If-conditions level (advanced)_
...
_Unlocking a new block for the next levels_
...
_Users can develop their own logic to win_
...
_Two users can play one against one. Their robots will be spawned from the grey factories._
...
_Exhausted but happy. Our team: Paul, Per, Tim, and Johannes (left to right, top to bottom)_
...
_Photo source: [curlewresearch.com](https://curlewresearch.com/wp-content/uploads/2016/05/Server-P2P.jpg" rel="noopener" target="_blank" title=")_
...
_Peermusic is a mobile-ready music player that runs the browser locally. It strives to deliver all convenient features of modern music players by combining it with easy and encrypted P2P-based sharing of music files._
