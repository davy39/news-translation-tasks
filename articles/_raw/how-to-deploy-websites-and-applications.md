...
1. [What to consider when deploying a hosting platform](#heading-what-to-consider-when-deploying-to-a-hosting-platform)
    
2. [How to deploy a website or app with Render](#heading-how-to-deploy-a-website-or-app-with-render)
    
3. [How to deploy a website or app with Surge](#heading-how-to-deploy-a-website-or-app-with-surge)
    
4. [How to deploy a website or app with Vercel](#heading-how-to-deploy-a-website-or-app-with-vercel)
    
5. [How to deploy a website or app with GitHub Pages](#heading-how-to-deploy-a-website-or-app-with-github-pages)
    
6. [How to deploy a website or app with Netlify](#heading-how-to-deploy-a-website-or-app-with-netlify)
...
Step 1: First, ensure you have deployed your work or code from your editor to your GitHub account.

Step 2: Open a new browser tab and navigate to the [Render website](https://render.com/).

![render website](https://cdn.hashnode.com/res/hashnode/image/upload/v1743002851078/4bf085d2-7c38-432b-93bf-95f2b02368e7.gif align="center")

*Render website*

Step 3: Select the “GET STARTED” button on Render's home page to get going.
...
![Render sign in page](https://cdn.hashnode.com/res/hashnode/image/upload/v1743002894595/542d8097-4fcc-409a-bc80-a599656152c9.gif align="center")

*Sign in page*

Step 4: Once you access the dashboard, click the “New” button.

![Render dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1743002941009/36239b95-8cf3-4633-9b27-fb966a133270.png align="center")

*Dashboard of Render*

Step 5: Upon doing so, a drop-down menu will appear. It'll show you a comprehensive list of services provided by Render.

![List of services offered by render](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003263069/d8053161-5ef1-4c1b-a047-c635c75df2eb.png align="center")

*List of Services offered by render*

Step 6: Clicking “Static Site” from the drop-down menu will lead you to the “Create a New Static Site” page. From there, you can select the repository you wish to host.

![Create a new static site page](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003315411/fe9a7eb8-2303-48ad-b83a-fb471e821e05.png align="center")

*Create a New Static Site*

Step 7: After selecting the repository you wish to host, you will be directed to the deployment platform. There, you can provide the necessary information to host the application and click the “Create Static Site” button for it to deploy.

![Render deployment](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003358045/c37346e8-5793-40a3-95fc-17c388b110ed.png align="center")

*Deploying the app using Render*

Here's what the final output should look like:

![Hosted application](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003407878/76f120fe-8754-4e7c-8746-6107f47d7425.png align="center")
...
Deploying your static files to [surge.sh](https://https//surge.sh/) is easy using the command-line interface (CLI).

This command-line interface (CLI) streamlines the process of hosting and distributing your online projects.

![Surge website](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003449591/4825b5da-69a7-4780-924c-8c2206c82a96.png align="center")
...
![Hosted site with Surge](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003506734/70e7d551-2aa9-4023-980c-53a8fdd34d2d.png align="center")

*Hosted site with Surge*
...
Then open a new browser tab and navigate to [Vercel’s website](https://vercel.com/).

![Vercel website](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003556995/7c48e8dc-6955-45c2-a068-c6c1b0e15cf6.png align="center")
...
![Vercel add new project](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003587862/a04db892-e3fe-4218-a60f-ed134e143006.gif align="center")

*Add New Project*

On the next page, you will import your repository for deployment.

![Vercel deployment](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003630267/265499e1-d1cd-4083-a05c-68dc4c9e9741.gif align="center")

*Vercel Deployment*

Here's what the final output should look like:

![Vercel hosted site](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003666437/b418d602-42ca-4610-ae43-dc69bed0d954.gif align="center")
...
* Create a file under the root of your application called `vercel.json`.
...
![Vercel error fix](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003723518/6c44d496-331e-4d09-b221-f3c3dc6c688c.png align="center")
...
* If you are new to Vercel, you must understand how to deploy and configure your application. Reading [Vercel’s documentation](https://vercel.com/docs) can help you get up to speed.
...
First, go to GitHub's [website](https://https//github.com/).

![GitHub landing page](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003758359/0d8d7328-a8ad-4b79-a814-3a55b3a04bb1.png align="center")
...
![Github signin button and signup buttons](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003801213/5362aa34-2ec8-430f-8809-01b42f574495.png align="center")

*Github sign in button and sign up buttons*

Create a new repository by clicking the New button in the upper-right corner of your GitHub profile.

![Creating a new repo](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003843884/8c918dbf-64bf-40c8-8f32-25fa6fef157d.png align="center")

*Creating a new repository*

Give your repository a name that reflects your website.

![Entering repo name on GitHub](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003887101/51f0ab61-14b5-420c-95fb-27926b4dc566.gif align="center")

*Repository name*

Once you have finished the previous step, go back to your Editor. Copy the generated code and paste it into your editor.

![Code generated from new repository](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003942149/3c063b52-2bc2-4897-84af-e30ca8da18cd.png align="center")

*Code generated from new repository*
...
![GitHub repo settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1743003981000/6a55ae7c-2b69-44bd-bbe2-deaa695b63a5.png align="center")
...
![Settings section GitHub pages](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004028760/9130f72b-0e6a-4a18-a72a-da948eb67fec.gif align="center")
...
![Enabling GitHub Pages to host your site](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004108894/40fa0220-afba-4932-8900-1106046cf9e0.gif align="center")

*Enabling GitHub Pages to host your site*

Refresh the page to find the link leading to your published website.

![GitHub seeing your hosted site](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004156941/3364fd42-d47e-40ea-b147-0fc0fa4f25c6.gif align="center")

*Seeing your hosted site*
...
Then, open a new browser tab and navigate to the [Netlify website](https://www.netlify.com/).

![Netlify website](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004199311/04a14b1c-d034-4274-8657-1a9eeaaf1839.png align="center")
...
![Netlify dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004230273/ef1debf2-c475-4cd1-8930-4b5c0fd2c412.png align="center")
...
![Root index.html file](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004285308/0387adf5-f015-44e0-bb91-1fb718bfdc04.png align="center")
...
![Netlify drag and drop](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004356707/d7285059-51a0-4802-af41-1d81b560754f.png align="center")
...
![Netlify import existing project](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004398011/0de1ad8d-3f36-47e9-8faa-626b399fb27e.png align="center")
...
![Netlify connect to Git provider](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004440693/669cf508-588e-47f9-8542-24552c073009.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004493978/578f1241-8b07-432d-a40a-ed6549aecb53.png align="center")

*Choosing repository from Netlify*

After selecting the repository, the next step is configuring and deploying your site.

![Deploying from Netlify](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004531244/4f5d1691-6cd7-4c86-8be8-fa423a6e8772.gif align="center")

*Deploying from Netlify*

Here's the result:

![Netlify hosted app](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004569842/d7f6c8cf-855e-4d12-847b-9ec22b6bc177.gif align="center")
...
Create a file called `_redirects`, and inside write the following code:
...
![Encounter error during deployment which is caused by routing issue](https://cdn.hashnode.com/res/hashnode/image/upload/v1743004628305/2fa06275-812f-42ed-8bf0-b30765a0a821.png align="center")

*Encounter error during deployment which is caused by routing issue*
...
If you found this tutorial helpful, please share it with fellow developers who may also find it interesting. You can also stay updated on my latest projects by following me on [Twitter](https://https//twitter.com/ijaydimples) and [LinkedIn](https://https//www.linkedin.com/in/ijeoma-igboagu/).
