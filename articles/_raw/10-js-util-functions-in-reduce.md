...
In [my last article](https://www.yazeedb.com/posts/learn-reduce-in-10-minutes/) I offered you a challenge to recreate well-known functions using `reduce`. This article will show you how some of them can be implemented, along with some extras!
