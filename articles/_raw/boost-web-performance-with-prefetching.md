---
title: How to Boost Web Performance with Prefetching – Improve User Experience by
  Reducing Load Time
subtitle: ''
...
[![Multiple skeleton loader on a dashboard page](https://cdn.hashnode.com/res/hashnode/image/upload/v1726397417280/bc56c517-c63f-433e-93c6-939c3b82c556.gif align="center")](https://dribbble.com/shots/3358709-Skeleton-Loader#)
...
* [Prefetching as a Solution](#heading-prefetching-as-a-solution)
    
* [How Prefetching Improves User Experience](#heading-how-prefetching-improves-user-experience)
    
* [Understanding The Problem](#heading-understanding-the-problem)
    
* [Solution #1: Prefetching Data in the Parent Component](#heading-solution-1-prefetching-data-in-the-parent-component)
    
* [Solution #2: Prefetch Data on Page load](#heading-solution-2-prefetch-data-on-page-load)
    
* [How to Implement Prefetching with React](#heading-how-to-implement-prefetching-with-react)
    
* [Too much prefetching can also cause](#heading-how-to-implement-prefetching-with-react) [s](#heading-too-much-prefetching-can-also-cause-slowness)[lowness](#heading-how-to-implement-prefetching-with-react)
...
![Example of fetching data when the popover component mounts](https://cdn.hashnode.com/res/hashnode/image/upload/v1726395720567/6ec88fab-ffe2-4f20-b934-94342f9cf3c0.gif align="center")

It’s just frustrating how long the user has to wait whenever they hover on the image:

![User hovering images to load popover component that fetches data](https://cdn.hashnode.com/res/hashnode/image/upload/v1726395733461/3598da70-e8af-4a1a-b3cf-5c3ed62fe9cc.gif align="center")
...
This solution is inspired from [Martin Fowler’s blogpost](https://martinfowler.com/articles/data-fetch-spa.html?utm_source=cassidoo&utm_medium=email&utm_campaign=until-youre-ready-to-look-foolish-youll-never#prefetching). It allows you to fetch the data before the popup appears, instead of fetching on component load.
...
![Improving the UX by fetching the data from the parent component](https://cdn.hashnode.com/res/hashnode/image/upload/v1726395771616/69b6c536-8b62-4124-837a-f26746f6f305.gif align="center")

## Solution #2: Prefetch Data on Page load

This solution is inspired by [x.com](http://x.com) where, for the popover component, they fetch the data partially on the main page load and fetch the rest of the data when the component mounts.

![Twitter advertisement by XDevelopers. Text reads: "Calling all #developers! Innovate with our real-time and historical data on the X API. Get started with Pro👇". Image shows a person in a white shirt with text "Build what's next with our API @XDevelopers" and "Subscribe now!" Used by permission. From twitter.com.](https://cdn.hashnode.com/res/hashnode/image/upload/v1726395833198/c7f1fa64-986d-4bfc-83cb-f052cd560f3a.gif align="center")
...
![GIF explaining how we prefetch data from parent and load additional data on component mount for popover ](https://cdn.hashnode.com/res/hashnode/image/upload/v1726395913909/b5f6f231-5a1e-4c44-a4eb-bd5ed863ce3b.gif align="center")
...
You can use [vitejs](https://vitejs.dev/) (this is what I used) or [create-react-app](https://create-react-app.dev/) to create your app. Paste the command below in your terminal:
...
* ![Image of the folder structure once the vitejs app is created](https://cdn.hashnode.com/res/hashnode/image/upload/v1726764168271/2dc9bfa1-07d9-491e-96fd-e780c3623eeb.png align="center")
...
![Image of the PopoverExample component that contains image to the left and lorem ipsum text to the right](https://cdn.hashnode.com/res/hashnode/image/upload/v1727002319443/bcc28972-fce0-42ba-899c-274513c4a7c6.png align="center")
...
![Image of popover element that contains user information when the image is hovered](https://cdn.hashnode.com/res/hashnode/image/upload/v1727002429245/9af8f26e-f149-41f7-b124-3ec2a0f5c80a.png align="center")
...
* Next, we conditionally rendered a `div` with class name of `floating`. This is the actual popover component that opens when you hover on the image.
    ...
    * We made use of the [`floating-ui` library](https://floating-ui.com/) and its [basic hover example](https://floating-ui.com/docs/useHover) to achieve the hover effect for the popover.
...
* We made use of the [react-content-loader](https://github.com/danilowoz/react-content-loader) library in the `MyLoader` component. This library also has a website that helps you to create loaders, you can check it out [here](https://skeletonreact.com/).
...
This component appears inside the popover component. The purpose of this component is to load the `name` `email` `phone` `website` details which are fetched from [JSON placeholder API](https://jsonplaceholder.typicode.com/users/1).
...
The entire code for this app can be found [here](https://github.com/keyurparalkar/prefetch-examples).
...
* [Prefetching pages](https://www.patterns.dev/vanilla/prefetch/)
...
For more content, you can follow me on [Twitter](https://twitter.com/keurplkar), [GitHub](http://github.com/keyurparalkar), and [LinkedIn](https://www.linkedin.com/in/keyur-paralkar-494415107/).
