...
**Gotcha:** You can learn what synchronous and asynchronous means in JavaScript via [this article](https://www.freecodecamp.org/news/synchronous-vs-asynchronous-in-javascript/) by [TAPAS ADHIKARY](https://www.freecodecamp.org/news/author/tapas/).
...
You can check through [this article](https://www.freecodecamp.org/news/javascript-es6-promises-for-beginners-resolve-reject-and-chaining-explained/) by [Cem Eygi](https://www.freecodecamp.org/news/author/cemeygi/) to better understand promises.
...
You can read more about map() [here](https://www.freecodecamp.org/news/javascript-map-how-to-use-the-js-map-function-array-method/).
...
You can read more about this [here](https://www.freecodecamp.org/news/javascript-array-filter-tutorial-how-to-iterate-through-elements-in-an-array/).
...
You can read more about the find() method [here](https://www.freecodecamp.org/news/javascript-array-find-tutorial-how-to-iterate-through-elements-in-an-array/).
...
You can read more about destructuring Arrays and Objects [here](https://www.freecodecamp.org/news/array-and-object-destructuring-in-javascript/).
...
You can read more on JavaScript Spread and Rest operators [here](https://www.freecodecamp.org/news/javascript-rest-vs-spread-operators/).
...
**NB:** I decided to spread the values into an array. You can read more on unique values [here](https://www.geeksforgeeks.org/sets-in-javascript/).
...
**Gotcha:** We used an object as the second argument and we also used dynamic object keys. You can read more about the reduce method [here](https://www.freecodecamp.org/news/reduce-f47a7da511a9/).
...
This might not really make sense to you now, but by the time you are working on something bigger in the future, it'll fall into place! You can read more [here](https://www.freecodecamp.org/news/javascript-optional-chaining-explained/).
...
We will see how this can be done with async/await in the next section. You can read more about the fetch API [here](https://www.freecodecamp.org/news/how-to-make-api-calls-with-fetch/).
...
You can read more about async/await [here](https://www.freecodecamp.org/news/javascript-async-await-tutorial-learn-callbacks-promises-async-await-by-making-icecream/).
...
Suppose you are just getting started with JavaScript – I have curated an awesome list of resources that will help you learn JavaScript concepts and topics [here](https://github.com/olawanlejoel/Awesome-Javascript). Don’t forget to star and share! :).
