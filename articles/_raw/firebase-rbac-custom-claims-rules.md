---
title: How to Create Role-Based Access Control (RBAC) with Custom Claims Using Firebase
  Rules
subtitle: ''
...
[Firebase](https://firebase.google.com/) makes this possible with [custom claims](https://firebase.google.com/docs/auth/admin/custom-claims) and security rules. In this article, you’ll learn how to:
...
* [Step 1: Understand Firebase Custom Claims](#heading-step-1-understand-firebase-custom-claims)
    
* [Step 2: Assign a Role with the Firebase Admin SDK](#heading-step-2-assign-a-role-with-the-firebase-admin-sdk)
    
* [Step 3: Write and Enforce Firestore Security Rules](#heading-step-3-write-and-enforce-firestore-security-rules)
    
* [Step 4: Build the Frontend with Next.js and Firebase](#heading-step-4-build-the-frontend-with-nextjs-and-firebase)
    
* [Step 5: Test the RBAC Workflow](#heading-step-5-test-the-rbac-workflow)
...
If you’re new to Firebase, check out the [official setup guide](https://firebase.google.com/docs/web/setup) before continuing.
...
![an image showing the service account interface on firebase console](https://cdn.hashnode.com/res/hashnode/image/upload/v1760235082674/8f542b00-2246-4585-b267-f8cb663797ea.png align="center")
...
![image showing the firebase rules section](https://cdn.hashnode.com/res/hashnode/image/upload/v1760234391658/9e9cf217-6291-4189-a135-8310c8905587.png align="center")
...
Let’s bring this to life with a [working demo](https://github.com/CodeLeom/firebase-rbac) using Next.js and Firebase.
...
![an image of authentication section on firebase](https://cdn.hashnode.com/res/hashnode/image/upload/v1760441502551/7ce05b9b-51f2-4704-83ed-1b62bf22ef2c.png align="center")
...
Visit [http://localhost:3000](http://localhost:3000) in your browser. You should find the Firebase RBAC demo app.
...
* Explore Firebase’s [security rules](https://firebase.google.com/docs/rules/).
