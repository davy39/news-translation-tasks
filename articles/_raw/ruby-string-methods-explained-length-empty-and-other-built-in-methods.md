---
title: Ruby String Methods Explained - Length, Empty, and Other Built-In Methods
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_Note that the first letter is only capitalized if it is at the beginning of the string._ `ruby "-HELLO".capitalize #=> -hello "1HELLO".capitalize #=> 1hello`
...
`gsub` also accepts patterns (like _regexp_) as first parameter, allowing things like:
