...
* [Goodbye “Core Types”](#heading-goodbye-core-types)
    
* [Safer Nil-Pointer Handling](#heading-safer-nil-pointer-handling)
    
* [DWARF v5 Debug Info by Default](#heading-dwarf-v5-debug-info-by-default)
    
* [testing/synctest is Stable](#heading-testingsynctest-is-stable)
    
* [Experimental encoding/json/v2](#heading-experimental-encodingjsonv2)
    
* [Tooling Improvements](#heading-tooling-improvements)
    
* [Runtime Improvements](#heading-runtime-improvements)
    
* [Flight Recorder API](#heading-flight-recorder-api)
    
* [Platform Updates](#heading-platform-updates)
...
Core types were introduced in Go 1.18, where, [according to the documentation](https://go.dev/blog/coretypes), “a core type is an abstract construct that was introduced for expediency and to simplify dealing with generic operands”. For example, we have:
...
Testing concurrent code just got easier. The new [`testing/synctest`](https://pkg.go.dev/testing/synctest) package lets you run concurrency tests in a controlled environment where goroutines and time are deterministic.
