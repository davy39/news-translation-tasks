---
title: How to Build a Serverless CRUD REST API with the Serverless Framework, Node.js,
  and GitHub Actions
subtitle: ''
...
1. [Important Concepts to Understand](#heading-important-concepts-to-understand)
    
    * [Application Programming Interface (API)](#heading-application-programming-interface-api)
        
    * [HTTP Methods](#heading-http-methods)
        
    * [Amazon API Gateway](#heading-amazon-api-gateway)
        
    * [Amazon DynamoDB](#heading-amazon-dynamodb)
        
    * [Serverless CRUD Application](#heading-serverless-crud-application)
        
    * [The Serverless Framework](#heading-the-serverless-framework)
...
3. [Our Use Case](#heading-our-use-case)
    
4. [Tutorial Objectives](#heading-tutorial-objectives)
    
5. [How to get Started:Clone the Git Repository](#heading-how-to-get-started-clone-the-git-repository)
    
6. [Step 1: Set up the Serverless Framework Environment](#heading-step-1-set-up-the-serverless-framework-environment)
    
7. [Step 2: Define the API in the Serverless YAML File](#heading-step-2-define-the-api-in-the-serverless-yaml-file)
    
8. [Step 3: Develop the Lambda Functions for CRUD Operations](#heading-step-3-develop-the-lambda-functions-for-crud-operations)
    
    * [Create Coffee Lambda function](#heading-create-coffee-lambda-function)
        
    * [Get Coffee Lambda function](#heading-get-coffee-lambda-function)
        
    * [Update Coffee Lambda function](#heading-update-coffee-lambda-function)
        
    * [Delete Coffee Lambda function](#heading-delete-coffee-lambda-function)
        
9. [Step 4: Set Up CI/CD Pipeline Multi-stage Deployments for Dev and Prod Environments](#heading-step-4-set-up-cicd-pipeline-multi-stage-deployments-for-dev-and-prod-environments)
    
10. [Step 5: Test the Dev and Prod Pipelines](#heading-step-5-test-the-dev-and-prod-pipelines)
    
11. [Step 6: Test and Validate Prod and Dev APIs using Postman](#heading-step-6-test-and-validate-prod-and-dev-apis-using-postman)
...
To enhance your understanding and so you can follow along with this tutorial more effectively, go ahead and clone the project’s repository from my GitHub. You can do that [by going here](https://github.com/ifeanyiro9/coffee-shop-serverless-crud-api-nodejs). As we move forward, feel free to edit the files as you feel necessary.
...
![File structure](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353622612/2dd67caa-1a30-4511-afc5-babfaa0c5b82.png align="center")
...
The **handler** function extracts the **order\_id**, **new\_status**, and **customer\_name** from the request body. It then constructs the **params** object to specify the table name and the primary key for the order (using **OrderId** and **CustomerName**). The **UpdateExpression** sets the new status of the order.
...
![Select "Settings" option in GitHub repo at top right.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724352977158/9250d55a-941a-4bfd-9f7d-843e9b40d8b6.png align="center")

Next, click on **Actions** as seen in the image below:

![Select "Actions" option to set secret variables for GitHub Actions.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353027861/52692cba-1bd1-4773-9441-a080af16f513.png align="center")

From there, select **New repository secret** to create secrets.

![Select button to create new repository secret variables.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353092604/a54b12fa-31e7-43d0-b4d5-2abe6a641181.png align="center")
...
![Three secret variables needed to authenticate to AWS and Serverless Framework account.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353131423/5b4af7c7-ff3e-431f-a9ef-1ddf74fa9e46.png align="center")
...
![Select "Actions" in the top right of GitHub repository options.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353173167/f1775dbc-732c-432d-9ee0-9572b8b9908f.png align="center")
...
![Pipeline run logs for the different branch environments (main, dev)](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353205715/dd221126-4fed-4032-8b51-e883f1177173.png align="center")
...
!["Deploy" button that allows you to view log details.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353236275/7cbed3e1-d65a-4fa6-9dff-9974d1c2022a.png align="center")
...
![Detailed logs of a specific build run to review for errors or success.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353272312/43eee369-618f-45f9-b9aa-6ffb6e19061b.png align="center")
...
![Empty list result when inserting API URL in browser.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353307388/23791725-71d7-4b1d-908c-c0f5e0fb073b.png align="center")
...
![Testing the GET method using Postman.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353336998/17fff84a-a784-464f-a89e-9c73f3e863a0.png align="center")
...
![Testing the POST method using Postman.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353370197/4f3ab8df-4f1f-4c66-888c-4069b60151f9.png align="center")

Verify that the new order was saved in the DynamoDB table by reviewing the items in the environments specific table :

![Verifying new order is stored in DynamoDB table.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353402967/afbd2080-b66f-46ac-ac79-24a4d360871d.png align="center")
...
![Testing the PUT method using Postman.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353432881/f5354746-9b42-4fc9-bb70-5c18f076ecea.png align="center")

You can also verify that the order status was updated from the DynamoDB table item.

![Verifying order status update in DynamoDB table.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353463923/e6a2978c-bbb5-49c0-9b94-36ea404b8c11.png align="center")
...
![Testing the DELETE method using Postman.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353509090/e61a8ab8-7ce3-44b1-a122-34d29b5a5734.png align="center")

Again, you can verify that the order has been deleted in the DynamoDB table.

![Verifying empty items in DynamoDB table.](https://cdn.hashnode.com/res/hashnode/image/upload/v1724353541300/d6ed82aa-12ca-4cc2-9b0b-1b86be9557ee.png align="center")
