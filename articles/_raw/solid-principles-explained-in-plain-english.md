...
Uncle Bob is also the author of bestselling books _Clean Code_ and _Clean Architecture_, and is one of the participants of the ["Agile Alliance"](https://agilemanifesto.org/history.html). 
