...
2. [Arrays in Go](#heading-arrays-in-go)
    
    * [Initializing with Values](#heading-initializing-with-values)
        
    * [Array Length](#heading-array-length)
        
    * [Inner Representation of Arrays](#heading-inner-representation-of-arrays)
        
    * [Multi-dimensional Arrays](#heading-multi-dimensional-arrays)
        
    * [Limitations](#heading-limitations)
        
    * [When Arrays Are Useful](#heading-when-arrays-are-useful)
        
3. [Slices in Go](#heading-slices-in-go)
    
    * [When to use slices?](#heading-when-to-use-slices)
        
    * [How to Declare a Slice](#heading-how-to-declare-a-slice)
        
    * [Allocate (with make)](#heading-allocate-with-make)
        
    * [Append Elements](#heading-append-elements)
        
    * [How to Slice Slices](#heading-how-to-slice-slices)
        
    * [Inner Representation of Slices](#heading-inner-representation-of-slices)
        
    * [How to Copy Slices](#heading-how-to-copy-slices)
        
    * [Multi-dimensional Slices](#heading-multi-dimensional-slices)
        
    * [Slices vs Arrays](#heading-slices-vs-arrays)
        
4. [Maps in Go](#heading-maps-in-go)
    
    * [How to Declare a Map](#heading-how-to-declare-a-map)
        
    * [How to Access Values](#heading-how-to-access-values)
        
    * [How to Iterate Over a Map](#heading-how-to-iterate-over-a-map)
        
    * [Inner Representation of Maps](#heading-inner-representation-of-maps)
        
    * [Arrays vs. Slices vs. Maps](#heading-arrays-vs-slices-vs-maps)
        
5. [Mini Project: Shopping Cart Totals](#heading-mini-project-shopping-cart-totals)
    
6. [Practice Challenge](#heading-practice-challenge)
...
If you’ve completed the [Tour of Go](https://go.dev/tour) or written a few small Go programs, you’ll be ready to follow along – we’ll cover the internals at a beginner-friendly level.
...
If you're interested in how different hash map implementations work under the hood, check out my [article on hash maps](https://blog.gaborkoos.com/posts/2025-08-03-Hash-Map-Deep-Dive/).
