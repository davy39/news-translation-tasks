...
Closures are a notoriously difficult to grasp. But they are vital to advancing as a JavaScript developer. 

Understanding closures can lead to more elegant code and better job opportunities.

I hope this post helps the concept stick as fast as possible.

**BONUS**: Closures aren't JS specific! They're a computer science concept that - once you learn them -  you'll start to recognize everywhere else in software development.
...
## 2. Currying
[I've written on currying before](https://www.yazeedb.com/posts/deeply-understand-currying-in-7-minutes). It's when a function takes its arguments one at a time.
