...
1. [What is a CDN?](#heading-what-is-a-cdn)
    
    * [How does a CDN work?](#heading-how-does-a-cdn-work)
        
    * [Real-world analogy to explain CDNs](#heading-real-world-analogy-to-explain-cdns)
        
2. [Why are CDNs Important?](#heading-why-are-cdns-important)
    
3. [Different Ways to Use a CDN](#heading-different-ways-to-use-a-cdn)
    
    * [Remote Hosted CDN](#heading-remote-hosted-cdn)
        
    * [Locally Hosted CDN](#heading-locally-hosted-cdn)
        
    * [Hybrid Hosted CDN](#heading-hybrid-hosted-cdn)
...
![Diagram showing origin server communicating with different edge servers](https://cdn.hashnode.com/res/hashnode/image/upload/v1728819505243/6389ac39-e1d2-4348-9f97-8ee370eecd7f.png align="center")
...
* Access the resource by navigating to the CDN link URL (for example, [`https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css`](https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css)).
...
You can connect with me on [LinkedIn](https://www.linkedin.com/in/timothy-olanrewaju750/) or [X](https://x.com/SmoothTee_DC) for more frontend-related posts and articles.
