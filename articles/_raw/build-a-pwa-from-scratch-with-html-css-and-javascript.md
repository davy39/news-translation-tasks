...
* [What is a Progressive Web App ?](#heading-what-is-a-progressive-web-app)
* [Markup](#heading-markup)
* [Styling](#heading-styling)
* [Show data with JavaScript](#heading-show-data-with-javascript)
* [Web App Manifest](#heading-web-app-manifest)
* [What is a Service Worker?](#heading-what-is-a-service-worker)
* [Cache the assets](#heading-cache-the-assets)
* [Fetch the assets](#heading-fetch-the-assets)
* [Register the Service Worker](#heading-register-the-service-worker)
...
![Cached coffee images](https://www.freecodecamp.org/news/content/images/2021/10/cached-images.png)
...
You can check it out live [here](https://devcoffee-pwa.netlify.com/) and the source code is [here](https://github.com/ibrahima92/pwa-with-vanilla-js).

Read more of my articles on [my blog](https://www.ibrahima-ndaw.com/blog/how-to-build-pwa-with-javascript/)

## Next steps

[Web Manifest Documentation](https://developers.google.com/web/fundamentals/web-app-manifest)

[Service Worker Documentation](https://developers.google.com/web/fundamentals/primers/service-workers)
