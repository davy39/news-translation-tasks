...
* [Why is Network Traffic Analysis Important?](#heading-why-is-network-traffic-analysis-important)
    
* [Prerequisites](#heading-prerequisites)
    
* [How to Setup your Project](#heading-how-to-setup-your-project)
    
* [How to Build the Core Functionalities](#heading-how-to-build-the-core-functionalities)
    
* [How to Create the Streamlit Visualizations](#heading-how-to-create-the-streamlit-visualizations)
    
* [How to Capture the Network Packets](#heading-how-to-capture-the-network-packets)
    
* [Putting Everything Together](#heading-putting-everything-together)
    
* [Future Enhancements](#heading-future-enhancements)
...
* A basic understanding of [computer networking concepts](https://www.freecodecamp.org/news/computer-networking-how-applications-talk-over-the-internet/).
    
* Familiarity with the [Python programming language](https://www.freecodecamp.org/news/ultimate-beginners-python-course/) and its widely used libraries.
    
* Basic knowledge of [data visualization](https://www.freecodecamp.org/news/learn-data-visualization-in-this-free-17-hour-course/) techniques and libraries.
...
Network packets are categorized into two at transport level (TCP and UDP) and the ICMP protocol at the network level. If you are unfamiliar with the concepts of TCP/IP, I recommend checking out [this](https://www.freecodecamp.org/news/what-is-tcp-ip-layers-and-protocols-explained/) article on freeCodeCamp News.
...
![A network traffic analysis dashboard shows a pie chart with protocol distribution: TCP (48.7%), UDP (47.5%), and ICMP (3.8%). Below is a line graph displaying packets per second over time with several noticeable peaks. Total packets are 6743, and capture duration is 118.63 seconds.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735279281523/34802db4-7982-4c0f-a591-c2d5ca1e1f08.png align="center")

![A dark-themed dashboard showing a bar chart of top source IP addresses and a table of recent packets with details like timestamp, source, destination, protocol, and size.](https://cdn.hashnode.com/res/hashnode/image/upload/v1735279285726/246a5af6-2d15-49fa-9132-8103be79ce3a.png align="center")
