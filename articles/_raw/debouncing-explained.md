...
Well, [debouncing is a practice in software development](https://www.freecodecamp.org/news/javascript-debounce-example/) which makes sure that certain heavy tasks like the one above don't get fired so often.
...
You can also check out my video on Youtube on [React Debounce Function in 100 Seconds - Delay a function in React](https://youtu.be/EApDvKguG_0).

Get the code [here](https://codesandbox.io/s/react-debouncing-k5qdlv?file=/src/App.js).
