---
title: How to Deploy Your Own Cockroach DB  Instance on Kubernetes [Full Book for
  Devs]
subtitle: ''
...
1. [What Even Is CockroachDB? 🤔](#heading-what-even-is-cockroachdb)
    ...
    * [Simple Definition](#heading-simple-definition)
        
    * [Who Made CockroachDB? When Was it Released?](#heading-who-made-cockroachdb-when-was-it-released)
        
    * [What Problems Does CockroachDB Try to Solve?](#heading-what-problems-does-cockroachdb-try-to-solve)
        
    * [Key Terms You Should Know (in plain language):](#heading-key-terms-you-should-know-in-plain-language)
        
    * [Why the name “CockroachDB”? 😅](#heading-why-the-name-cockroachdb)
        
2. [Why Choose CockroachDB Over PostgreSQL or MongoDB 🤷🏾‍♂️?](#heading-why-choose-cockroachdb-over-postgresql-or-mongodb)
    
    * [How Fault Tolerance is Handled in PostgreSQL and MongoDB](#heading-how-fault-tolerance-is-handled-in-postgresql-and-mongodb)
        
    * [How CockroachDB Handles It Differently](#heading-how-cockroachdb-handles-it-differently)
        
3. [How CockroachDB Works Behind the Scenes ⚙️](#heading-how-cockroachdb-works-behind-the-scenes)
    
    * [Ranges: The Small Pieces of Data](#heading-ranges-the-small-pieces-of-data)
        
    * [Replication: Many Copies for Safety](#heading-replication-many-copies-for-safety)
        
    * [Raft Consensus: How All Copies Agree](#heading-raft-consensus-how-all-copies-agree)
        
    * [MultiRaft: Keeping Raft Efficient When Things Scale](#heading-multiraft-keeping-raft-efficient-when-things-scale)
        
    * [Rebalancing: Movement for Balance](#heading-rebalancing-movement-for-balance)
        
    * [Distributed Transactions: Doing Work Across Multiple Ranges](#heading-distributed-transactions-doing-work-across-multiple-ranges)
        
    * [How It All Fits Together: Read + Write Flow (What Happens When You Use It)](#heading-how-it-all-fits-together-read-write-flow-what-happens-when-you-use-it)
        
    * [Why This All Matters (Putting It in Plain English)](#heading-why-this-all-matters-putting-it-in-plain-english)
        
4. [Where (and How) Should You Host CockroachDB? ☁️](#heading-where-and-how-should-you-host-cockroachdb)
    
    * [Option 1: CockroachDB Cloud (fully managed by Cockroach Labs)](#heading-option-1-cockroachdb-cloud-fully-managed-by-cockroach-labs)
        
    * [Option 2: Bring Your Own Cloud (BYOC)](#heading-option-2-bring-your-own-cloud-byoc)
        
    * [Option 3: Use Cloud Marketplaces (AWS, GCP, Azure)](#heading-option-3-use-cloud-marketplaces-aws-gcp-azure)
        
    * [Option 4 (My Favorite 😁): Self-Hosting — Especially Using Kubernetes](#heading-option-4-my-favorite-self-hosting-especially-using-kubernetes)
        
5. [Setting Up Your Local Environment 🧑‍💻](#heading-setting-up-your-local-environment)
    
    * [Why these tools?](#heading-why-these-tools)
        
    * [Step 1: Install Minikube](#heading-step-1-install-minikube)
        
    * [Step 2: Install kubectl](#heading-step-2-install-kubectl)
        
    * [Step 3: Install Helm](#heading-step-3-install-helm)
        
6. [Deploying CockroachDB on Minikube (The Fun Part Begins 😁!)](#heading-deploying-cockroachdb-on-minikube-the-fun-part-begins)
    
    * [Step 1: Visit ArtifactHub](#heading-step-1-visit-artifacthub)
        
    * [Step 2: Explore the Helm Chart](#heading-step-2-explore-the-helm-chart)
        
    * [Step 3: Copy the Default Values](#heading-step-3-copy-the-default-values)
        
    * [Step 4: Create a Folder for Our Project](#heading-step-4-create-a-folder-for-our-project)
        
    * [Step 5: Understanding the Key Configurations](#heading-step-5-understanding-the-key-configurations)
        
    * [Step 6: Create a Simplified Values Config for the CockroachDB Helm Chart](#heading-step-6-create-a-simplified-values-config-for-the-cockroachdb-helm-chart)
        
    * [Overview of the YAML values](#heading-overview-of-the-yaml-values)
        
    * [🚀 Step 7: Install the CockroachDB Cluster Using Helm](#heading-step-7-install-the-cockroachdb-cluster-using-helm)
        
7. [Accessing the CockroachDB Console & Viewing Metrics](#heading-accessing-the-cockroachdb-console-amp-viewing-metrics)
    
    * [Step 1: Locate the CockroachDB Public Service](#heading-step-1-locate-the-cockroachdb-public-service)
        
    * [Step 2: Learn More About the Service](#heading-step-2-learn-more-about-the-service)
        
    * [Step 3: Access the CockroachDB Dashboard](#heading-step-3-access-the-cockroachdb-dashboard)
        
    * [Step 4: Visit the Dashboard](#heading-step-4-visit-the-dashboard)
        
    * [Step 5: Exploring the Metrics Dashboard](#heading-step-5-exploring-the-metrics-dashboard)
        
    * [Step 6: Creating a Little Load on the CockroachDB Cluster](#heading-step-6-creating-a-little-load-on-the-cockroachdb-cluster)
        
    * [Step 7: Viewing the Metrics from the Load](#heading-step-7-viewing-the-metrics-from-the-load)
        
    * [Step 8: View the List of Created Items in the Database](#heading-step-8-view-the-list-of-created-items-in-the-database)
        
8. [Backing Up CockroachDB to Google Cloud Storage ☁️](#heading-backing-up-cockroachdb-to-google-cloud-storage)
    
    * [Why Backups Are Absolutely Critical](#heading-why-backups-are-absolutely-critical)
        
    * [Connecting to Our DB – Installing Beekeeper Studio](#heading-connecting-to-our-db-installing-beekeeper-studio)
        
    * [How to Install Beekeeper Studio](#heading-how-to-install-beekeeper-studio)
        
    * [Connecting Beekeeper Studio to CockroachDB](#heading-connecting-beekeeper-studio-to-cockroachdb)
        
    * [Exposing the Cluster for Local Access](#heading-exposing-the-cluster-for-local-access)
        
    * [🐝 Connecting via Beekeeper Studio](#heading-connecting-via-beekeeper-studio)
        
    * [Verify the Connection](#heading-verify-the-connection)
        
    * [Creating a Google Cloud Account](#heading-creating-a-google-cloud-account)
        
    * [Creating a Google Cloud Storage Bucket](#heading-creating-a-google-cloud-storage-bucket)
        
    * [Giving CockroachDB Access to the Bucket](#heading-giving-cockroachdb-access-to-the-bucket)
        
    * [Attaching the Key to Our CockroachDB Cluster](#heading-attaching-the-key-to-our-cockroachdb-cluster)
        
    * [Testing Our Backup — Disaster Recovery Time](#heading-testing-our-backup-disaster-recovery-time)
        
9. [Managing Resources & Optimizing Memory Usage](#heading-managing-resources-amp-optimizing-memory-usage)
    
    * [How CockroachDB Uses Memory](#heading-how-cockroachdb-uses-memory)
        
    * [The Memory Usage Formula You Must Follow](#heading-the-memory-usage-formula-you-must-follow)
        
    * [Where You Find These Settings](#heading-where-you-find-these-settings)
        
    * [Concrete Example (Step-by-Step)](#heading-concrete-example-step-by-step)
        
    * [⚠️ On Requests vs Limits in Kubernetes](#heading-on-requests-vs-limits-in-kubernetes)
        
    * [Overriding the Default Fractions](#heading-overriding-the-default-fractions)
        
10. [Scaling CockroachDB the Right Way](#heading-scaling-cockroachdb-the-right-way)
    
    * [Key Metrics to Understand](#heading-key-metrics-to-understand)
        
    * [When (and What) to Scale Based on Your Metrics](#heading-when-and-what-to-scale-based-on-your-metrics)
        
    * [Disk-Bound Situations — What to Do When Your Disk Is the Limiting Factor](#heading-disk-bound-situations-what-to-do-when-your-disk-is-the-limiting-factor)
        
    * [Memory Pressure — What to Do When Your Database Hits the Limit](#heading-memory-pressure-what-to-do-when-your-database-hits-the-limit)
        
    * [When Queries Are Slow but Everything Else (CPU, Memory & Disk) Looks “Fine”](#heading-when-queries-are-slow-but-everything-else-cpu-memory-amp-disk-looks-fine)
        
    * [Understanding Disk Speed (IOPS & Throughput) Across Cloud Providers](#heading-understanding-disk-speed-iops-amp-throughput-across-cloud-providers)
        
    * [Downsizing the Cluster (Reducing Replicas)](#heading-downsizing-the-cluster-reducing-replicas)
        
    * [⚠️ The Wrong Way to Downscale](#heading-the-wrong-way-to-downscale)
        
    * [Decommissioning a Node Before Scaling Down the Cluster](#heading-decommissioning-a-node-before-scaling-down-the-cluster)
...
11. [What to Consider When Deploying CockroachDB on Google Kubernetes Engine (GKE) ☁️](#heading-what-to-consider-when-deploying-cockroachdb-on-google-kubernetes-engine-gke)
    ...
    * [Creating Your GKE Cluster](#heading-creating-your-gke-cluster)
        
    * [Connecting to your GKE cluster](#heading-connecting-to-your-gke-cluster)
        
    * [Deploying CockroachDB in Production (on GKE)](#heading-deploying-cockroachdb-in-production-on-gke)
        
    * [Understanding the Configuration](#heading-understanding-the-configuration)
        
    * [Installing the CockroachDB Cluster on GKE](#heading-installing-the-cockroachdb-cluster-on-gke)
        
    * [Connecting to Our CockroachDB Cluster (Now That TLS + mTLS Are Enabled)](#heading-connecting-to-our-cockroachdb-cluster-now-that-tls-mtls-are-enabled)
        
    * [Connecting via Mutual TLS (mTLS) — Why We Need a Certificate for Our root User](#heading-connecting-via-mutual-tls-mtls-why-we-need-a-certificate-for-our-root-user)
        
    * [Let’s Explore Our Cluster’s Certificate](#heading-lets-explore-our-clusters-certificate)
        
    * [Understanding the Certificate Sections (Explained Super Simply)](#heading-understanding-the-certificate-sections-explained-super-simply)
        
    * [Creating a Client Certificate (So We Can Finally Connect to CockroachDB)](#heading-creating-a-client-certificate-so-we-can-finally-connect-to-cockroachdb)
        
    * [Connecting to Our CockroachDB Cluster Securely (Using mTLS)](#heading-connecting-to-our-cockroachdb-cluster-securely-using-mtls)
        
    * [Restoring Our Previous Database into the New GKE CockroachDB Cluster (without SA keys)](#heading-restoring-our-previous-database-into-the-new-gke-cockroachdb-cluster-without-sa-keys)
        
    * [Restoring Our Previous Database from Google Cloud Storage](#heading-restoring-our-previous-database-from-google-cloud-storage)
        
    * [Now, Let’s Restore the Data 🎉](#heading-now-lets-restore-the-data)
        
    * [Connecting to the Database with a New User](#heading-connecting-to-the-database-with-a-new-user)
        
    * [Connecting with Passwordless Authentication (Mutual TLS)](#heading-connecting-with-passwordless-authentication-mutual-tls)
        
    * [Connecting via Mutual TLS (mTLS) from Our Apps on Kubernetes](#heading-connecting-via-mutual-tls-mtls-from-our-apps-on-kubernetes)
        
12. [How to Get a CockroachDB Enterprise License for FREEE!](#heading-how-to-get-a-cockroachdb-enterprise-license-for-free)
    
    * [Three Types of Licenses](#heading-three-types-of-licenses)
        
    * [How to Apply for the Free Enterprise License](#heading-how-to-apply-for-the-free-enterprise-license)
        
    * [Adding Your License to the CockroachDB Cluster](#heading-adding-your-license-to-the-cockroachdb-cluster)
        
13. [Conclusion & Next Steps ✨](#heading-conclusion-amp-next-steps)
...
![An image summarizing what CockroachDB is](https://cdn.hashnode.com/res/hashnode/image/upload/v1760416037885/c67edcbb-be85-4614-bdf3-104942048eea.jpeg align="center")
...
CockroachDB was created by [**Cockroach Labs**](https://www.cockroachlabs.com/), founded by Spencer Kimball, Peter Mattis, and Ben Darnell. The idea first started taking shape around 2014, and by 2015 Cockroach Labs was formally founded.
...
In Postgres land, that’s often handled by [**Patroni**](https://github.com/patroni/patroni) or [**repmgr**](https://www.repmgr.org/) (tools that handle cluster management, failover, leader election, and so on).
...
![A brief look at CockroachDB properties](https://cdn.hashnode.com/res/hashnode/image/upload/v1760416070693/af1ade70-19bb-4e9f-82ec-9711c13d8079.jpeg align="center")
...
![A little depiction of CockroachDB ranges](https://cdn.hashnode.com/res/hashnode/image/upload/v1760413105037/984f8b5c-bd53-4850-9704-57ce1dcedb80.png align="center")
...
![Replication of Ranges across multiple Nodes (databases) in CockroachDB](https://cdn.hashnode.com/res/hashnode/image/upload/v1760413678362/a0066780-1360-4511-8fd0-466f54ea2135.jpeg align="center")

Nobody likes losing their work, so you keep backup copies. CockroachDB does this for data as well.

For each range, there are usually 3 copies (replicas) stored on different machines (nodes). If one machine dies, you still have others. ([cockroachlabs.com](https://www.cockroachlabs.com/docs/stable/architecture/replication-layer?utm_source=chatgpt.com)). And these copies are always kept in sync: when you write something (for example, insert or update), the change is propagated to the other copies.
...
If you want, you can check it out here: [CockroachDB Cloud (managed by Cockroach Labs)](https://www.cockroachlabs.com/product/cloud/).
...
If you want to explore BYOC, you can read more here: [CockroachDB Bring Your Own Cloud](https://www.cockroachlabs.com/product/cloud/bring-your-own-cloud/).
...
* **GCP Marketplace** – CockroachDB is available on the Google Cloud Marketplace, making it easier to deploy within your GCP environment. You can learn more here: [GCP Marketplace](https://console.cloud.google.com/marketplace/product/cockroachdb-public/cockroachdb).
    
* **AWS Marketplace** – CockroachDB is listed there: [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-n3xpypxea63du).
    
* **Azure Marketplace** – Also supported for Azure deployments (SaaS/managed listings): [Azure Marketplace](https://marketplace.microsoft.com/en-us/product/saas/cockroachlabs1586448087626.cockroachdb-azure?tab=overview).
    
* **DigitalOcean** – There is support for CockroachDB deployment on DigitalOcean using their infrastructure: [Deploy CockroachDB on DigitalOcean](https://www.cockroachlabs.com/docs/stable/deploy-cockroachdb-on-digital-ocean).
...
#### Trade-of[f](https://www.reddit.com/r/hashicorp/comments/1ivtuo5?utm_source=chatgpt.com)s (things to watch out for)
...
If you don’t have the `choco` or `winget` package manager, you can install Minikube via PowerShell by following the steps in the [docs](https://minikube.sigs.k8s.io/docs/start/?arch=%2Fwindows%2Fx86-64%2Fstable%2F.exe+download).
...
1. Go to [https://artifacthub.io](https://artifacthub.io)
...
![The official CockroachDB Helm chart](https://cdn.hashnode.com/res/hashnode/image/upload/v1760848079912/1778bbcf-088a-4919-80bb-ca24241ffa85.png align="center")
...
![The Default Values button description](https://cdn.hashnode.com/res/hashnode/image/upload/v1760848210119/17cd734b-6d7c-40dc-a8c3-f01c85edd7a7.png align="center")

![Copy the default values](https://cdn.hashnode.com/res/hashnode/image/upload/v1760848520060/1e1ce249-0cf0-46cb-abbc-00efb3ea1343.png align="center")
...
You can learn more about [Google Cloud storage classes here](https://cloud.google.com/kubernetes-engine/docs/concepts/storage-overview).
...
You can [read more about this here](https://kubernetes.io/docs/concepts/workloads/pods/pod-qos/).
...
![The CockroachDB Helm Chart post-installation message](https://cdn.hashnode.com/res/hashnode/image/upload/v1761386160496/babc3e67-1ea9-4aa1-b6a7-516fe3a9972a.png align="center")
...
![The CockroachDB replicas running successfully](https://cdn.hashnode.com/res/hashnode/image/upload/v1761386195190/21469ce5-c909-4336-ba5f-a4c4a776a470.png align="center")
...
![Description of the crdb-cockroachdb-public service](https://cdn.hashnode.com/res/hashnode/image/upload/v1761387757614/dab8cfd0-2d89-45b0-a54f-41e530f1a6ab.png align="center")
...
![Result of port-forwarding the crdb-cockroachdb-public service on port 8080](https://cdn.hashnode.com/res/hashnode/image/upload/v1761387838362/186ff222-c643-4e67-b0a4-dbaff8777977.png align="center")
...
![The CockroachDB dashboard UI on http://localhost:8080](https://cdn.hashnode.com/res/hashnode/image/upload/v1761387968743/327288e5-4811-42bf-8fd8-74ed187792a4.png align="center")

### Step 5: Exploring the Metrics Dashboard

Now that you’re inside the CockroachDB Admin Console ([http://localhost:8080](http://localhost:8080)), let’s take things a step further by exploring the **Metrics** section. This is where CockroachDB really shines.
...
1. Create a new file called `books.json`
...
![The Completed state of the Books Job](https://cdn.hashnode.com/res/hashnode/image/upload/v1761460118429/99ed49a3-52e9-4357-ba2b-9295f0dfbdc8.png align="center")
...
![The SQL Queries Per Second Metric](https://cdn.hashnode.com/res/hashnode/image/upload/v1761460175366/6c1e129e-c8bd-4f41-89de-60a1a753026e.png align="center")
...
![The Service Latency Metric](https://cdn.hashnode.com/res/hashnode/image/upload/v1761460224971/8ba9d5ed-0724-4dc6-82f4-7e5d0d05be82.png align="center")

This small experiment gives you a real feel for how CockroachDB reacts under activity, even a tiny one.

To explore more metrics and dashboards, check out the [official CockroachDB documentation here](https://www.cockroachlabs.com/docs/stable/ui-overview-dashboard).
...
![The list of created books in the books table in the CockroachDB database](https://cdn.hashnode.com/res/hashnode/image/upload/v1761462270132/c881eca7-18b0-4647-a6b1-2841e7774969.png align="center")
...
1. Visit the official Beekeeper Studio download page here: [https://www.beekeeperstudio.io/get](https://www.beekeeperstudio.io/get)
    
2. Click the “Skip to the download” link. You’ll see something like this:
    
    ![Finding the Button to Skip to the DOwnload page on the Beekeeper Studio website](https://cdn.hashnode.com/res/hashnode/image/upload/v1761542821015/2e7a0fd5-7047-4090-97fb-46b81a3dd638.png align="center")
    
3. You’ll be redirected to a page listing download options for different operating systems.
    
    ![Page to select download option according to the user OS](https://cdn.hashnode.com/res/hashnode/image/upload/v1761542877590/6034dcf0-d9b0-447b-bd2b-089458729db7.png align="center")
...
![The CockroachDB service being of type ClusterIP](https://cdn.hashnode.com/res/hashnode/image/upload/v1761544640270/2cf9f8f1-15f1-459b-acd0-63b1c361fa54.png align="center")
...
Once it’s running, your CockroachDB instance will now be accessible from [`localhost:26257`](http://localhost:26257).  
...
3. Choose CockroachDB from the list.
    ...
    ![Selecting CockroachDB as a connection type in Beekeeper Studio](https://cdn.hashnode.com/res/hashnode/image/upload/v1761544886889/98443b46-574d-4bcc-a41c-d2daa7412201.png align="center")
...
4. In the connection window that pops up:
    ...
    * Host to [`localhost`](http://localhost)
...
![Connecting to the CockroachDB cluster from the Beekeeper Studio software](https://cdn.hashnode.com/res/hashnode/image/upload/v1761544818021/0248173e-9969-433c-a9d4-e83684bf34cf.png align="center")
...
![List of books in the CockroachDB database](https://cdn.hashnode.com/res/hashnode/image/upload/v1761545094817/99ef4415-bd0d-4452-817f-380996485397.png align="center")
...
Head over to 👉🏾 [https://console.cloud.google.com](https://console.cloud.google.com)
...
![Creating a new Project in our Google Cloud account](https://cdn.hashnode.com/res/hashnode/image/upload/v1761546797213/295c7b09-9bb8-4c34-85cf-8701242b2768.png align="center")
...
If not, you can easily create one by [following Google’s instructions here](https://docs.cloud.google.com/billing/docs/how-to/create-billing-account). (You’ll need a valid Debit or Credit card.)
...
To add your card via Google Subscriptions, [visit here](https://myaccount.google.com/payments-and-subscriptions). (You need to have a Google account first. Don’t worry, the site will direct you on what to do if you don’t.)

You’ll see a page like this:👇🏾

![Adding a card to Google Subscriptions](https://cdn.hashnode.com/res/hashnode/image/upload/v1761546938934/9e983134-dd7e-49b1-85a7-cd12bd01bf67.png align="center")
...
![Navigating to the Cloud Storage page](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089121918/c737c3e1-e45f-48e1-aed9-99e273583425.png align="center")

On the new page, click on the “Buckets” link in the side menu, then click the “Create Bucket” button.

![Creating a new Bucket in Cloud Storage](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089164660/8b9336fc-c0c3-4811-ab98-d3538596ee5a.png align="center")
...
![Creating your Bucket in Google Cloud Storage](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089287083/a376f695-81b8-4f5a-80a7-cd563c8b4c81.png align="center")
...
![Preventing random users from accessing your bucket](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089404876/38c8e6b5-0de0-4771-9bed-9334f8f8c43a.png align="center")
...
![Navigating the Service Accounts page](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089569066/2855b7fa-d896-4249-825d-4ec590499ca8.png align="center")
...
![Creating a new Service Account for the CockroachDB cluster, to give it access to our Cloud Storage Bucket](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089677768/05c9f9ed-257f-44c6-89b5-3880c8af017d.png align="center")
...
![Providing our Service Account with the necessary permissions to access the bucket](https://cdn.hashnode.com/res/hashnode/image/upload/v1762089744927/64ed65df-88ee-43c9-8be4-892a41a24989.png align="center")
...
![The necessary permissions to be assigned to the Service Account](https://cdn.hashnode.com/res/hashnode/image/upload/v1762092953125/0419abe8-a1ff-4f1c-b367-f9e203bdf6ff.png align="center")
...
![Finding the newly created service account, and creating a key](https://cdn.hashnode.com/res/hashnode/image/upload/v1762090008411/11c4b373-87b0-416d-bf14-1a9ccd15c452.png align="center")

On the new page, click “Add Key” then “Create new key.”

![Creating a new key for the new service account](https://cdn.hashnode.com/res/hashnode/image/upload/v1762090059309/ebe17228-e2a8-4abe-b41b-7378013570d5.png align="center")

A dialog box will pop-up, choose JSON as the key type, and click “Create.”

![Selecting the Key Type as JSON](https://cdn.hashnode.com/res/hashnode/image/upload/v1762090115728/5ed82664-f57a-4489-af08-be85c2ad42e9.png align="center")
...
To create an automatic backup schedule, run this SQL command inside the CockroachDB SQL shell 👇🏾(Replace the BUCKET\_NAME placeholder with the name of your Google Cloud Storage bucket):
...
You can read more about full and incremental backups in the official docs here 👉🏾[CockroachDB Backups Guide](https://www.cockroachlabs.com/docs/stable/take-full-and-incremental-backups).
...
![The job ID to copy](https://cdn.hashnode.com/res/hashnode/image/upload/v1762103549260/742fc309-9c4d-4967-9436-91539851a9b9.png align="center")
...
![Getting the status of the backup job](https://cdn.hashnode.com/res/hashnode/image/upload/v1762103606748/8627d561-0b54-4e6d-9109-ba7e1c7a85c3.png align="center")
...
![List existing Persistent Volumes for CockroachDB](https://cdn.hashnode.com/res/hashnode/image/upload/v1762107818554/01defffd-543b-486a-aa19-4bbf6f768270.png align="center")
...
![Database restored successfully](https://cdn.hashnode.com/res/hashnode/image/upload/v1762108106557/0da98d45-d8f4-48ed-b852-9f76209fb20f.png align="center")
...
If you go to the Helm chart docs on ArtifactHub, [CockroachDB Helm Chart on ArtifactHub](https://artifacthub.io/packages/helm/cockroachdb/cockroachdb), and scroll down to the **Configuration** section (or press Ctrl-F for `conf.cache`), you’ll see:
...
![Artifacthub docs for the CockroachDB Helm chart](https://cdn.hashnode.com/res/hashnode/image/upload/v1762235290740/bd176882-43bd-4abd-94e0-cce083335d64.png align="center")
...
![The Disk Read & Write Bytes/s metrics](https://cdn.hashnode.com/res/hashnode/image/upload/v1762325396257/553ac9d4-4927-40f3-b654-8b19a0b2aef8.png align="center")
...
![Illustrating the IOPS metrics on the dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1762325699278/dd549ac3-16cf-4373-9637-5a1e798bf5db.png align="center")
...
![The SQL p99 latency metric](https://cdn.hashnode.com/res/hashnode/image/upload/v1762326088120/e6f39e6e-942b-4db9-b808-cb228c1e0cc5.png align="center")
...
![Accessing the Disk Ops In Progress metrics on the COckroachDB dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1762488796957/b2a215fd-ec51-4ee3-9056-a5fa6d511c61.png align="center")
...
1. Open your `cockroachdb-values.yml` (the Helm chart values file)
...
**N.B.** If this doesn’t work or you receive an error from the Helm chart concerning not being able to modify some values (this is normal), just upsize the disk this way:👇🏾 (just replace the PVC\_NAME and SIZE placeholders accordingly)
...
![Accessing your Cluster memory usage](https://cdn.hashnode.com/res/hashnode/image/upload/v1762584827011/e7828548-7ed7-4a87-b6b2-fff52c6f6df1.png align="center")
...
Learn more about Hotspots [here](https://www.cockroachlabs.com/docs/stable/understand-hotspots).
...
* On the Hot Ranges page in the CockroachDB UI, some ranges show very high QPS (queries per second) compared to others.
    ...
    ![The Hot Ranges page in the CockorachDB dashboard UI](https://cdn.hashnode.com/res/hashnode/image/upload/v1762586236835/aeb3b0ea-b280-48d3-b12f-4cfe78d11dc1.png align="center")
...
Learning everything about hotspots, key visualizers, and range splitting is a bit advanced. For those wanting to dive deeper: see the CockroachDB [Performance Recipes page](https://www.cockroachlabs.com/docs/stable/performance-recipes).
...
* [Persistent Disk performance overview](https://cloud.google.com/compute/docs/disks/performance): explains how baseline IOPS and throughput are calculated and the per-instance caps.
    
* [About Persistent Disks](https://docs.cloud.google.com/compute/docs/disks/persistent-disks): quick definitions of `pd-standard` (HDD), `pd-balanced` (SSD), and `pd-ssd` (SSD).
    
* [Optimize PD performance](https://cloud.google.com/compute/docs/disks/optimizing-pd-performance): shows how disk size, machine series, and tuning can affect performance.
...
* [EBS volume types](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-volume-types.html): overview of all SSD and HDD types (`gp3`, `gp2`, `io2`, and so on).
    
* [General Purpose SSD (gp3)](https://docs.aws.amazon.com/ebs/latest/userguide/general-purpose.html): lets you provision custom IOPS and throughput for your disks (about 0.25 MiB/s per IOPS, up to 2,000 MiB/s).
...
* [Disk types overview](https://learn.microsoft.com/en-us/azure/virtual-machines/disks-types): compares Standard HDD, Standard SSD, Premium SSD, Premium SSD v2, and Ultra Disk.
    
* [Premium SSD v2](https://learn.microsoft.com/en-us/azure/virtual-machines/disks-deploy-premium-v2): lets you independently set IOPS and throughput for your disks.
    
* [VM & disk performance](https://learn.microsoft.com/en-us/azure/virtual-machines/disks-performance): lists per-VM IOPS and throughput caps.
...
* [Volumes overview](https://docs.digitalocean.com/products/volumes/): explains block storage and NVMe details.
    
* [Volume Limits](https://docs.digitalocean.com/products/volumes/details/limits/): shows per-Droplet IOPS and throughput caps (including burst windows).
...
![The newly added CockroachDB replicas](https://cdn.hashnode.com/res/hashnode/image/upload/v1762612478598/dee9f9e7-6b31-4b06-aed3-e2b0b97268fd.png align="center")

Also, check your CockroachDB Admin UI – the new nodes should now appear in the cluster overview.

![Newly added nodes in the cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762612539734/30e01a7d-3d2b-4160-be90-2988a161d87d.png align="center")
...
1. **Create a client pod** to run CockroachDB commands.  
    ...
    ![The CockroachDB service account details](https://cdn.hashnode.com/res/hashnode/image/upload/v1762620657038/34d5eb4b-de16-4e8a-b85c-1e7bf6b76172.png align="center")
...
5. Get the list of nodes and IDs:
    ...
    ![The nodes in the CockroachDB cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762620790692/af8d382e-71db-4eab-af7a-a3491d98c8a8.png align="center")
    
6. **Decommission the node with the highest index** (since Kubernetes will remove the highest-numbered replica when scaling down).  
    For example, if you’re removing the pod `crdb-cockroachdb-4…`, and the node ID is 5:
    
    ![The node to be decommissioned](https://cdn.hashnode.com/res/hashnode/image/upload/v1762620838125/b51856cb-2fbb-4b24-ba41-21f572c7678c.png align="center")
...
7. Navigate to the CockroachDB dashboard, and monitor until the node status shows as `decommissioned`.  
    In the CockroachDB Console’s Cluster Overview page, you’ll see formerly removed nodes under “Recently Decommissioned Nodes”.
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1762620923692/e678b21b-e2cc-4fe5-bd5b-46c4b0248958.png align="center")
...
![Scaling down to 3 nodes, the nodes status on the CockroachDB dashboarrd](https://cdn.hashnode.com/res/hashnode/image/upload/v1762621007089/cf7fce07-a3a6-4b01-9536-1d5476c2119e.png align="center")

To learn more about scaling down your CockroachDB nodes, visit the [official CockroachDB docs](https://www.cockroachlabs.com/docs/stable/scale-cockroachdb-kubernetes?filters=helm#remove-nodes).
...
To get started, head over to the [**Google Cloud Console**](https://console.cloud.google.com/).

In the search bar at the top, type “Kubernetes” and click on “Kubernetes Engine” from the dropdown.

![Searching the Kubernetes Engine resource](https://cdn.hashnode.com/res/hashnode/image/upload/v1762836788168/0d509529-69fb-4308-ba05-6a1426ee7fe1.png align="center")

You’ll be taken to the Kubernetes Engine page. On the left sidebar, click “Clusters.” Then click the “Create” button at the top.

![Creating a new cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762836843514/fc6d59a2-5b9d-4dee-9fea-7bbb7fc2a023.png align="center")
...
![Enabling the Compute Engine API](https://cdn.hashnode.com/res/hashnode/image/upload/v1763998084001/3ecbe47c-3def-4f9c-bc80-dabe2c0002c8.png align="center")

You can also learn more about enabling APIs in Google Cloud here: [Enable APIs in Google Cloud](https://docs.cloud.google.com/endpoints/docs/openapi/enable-api).
...
![Switching to Standard Cluster settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1762836938958/a2c35e79-6404-4c3a-a821-94d4ce926839.png align="center")
...
![Configuring Zonal clusters](https://cdn.hashnode.com/res/hashnode/image/upload/v1762836985443/eb7b1f79-66e3-4ca4-bfe3-842c5571509b.png align="center")
...
* Set the Maximum number of Nodes to 10, and the minimum to 0.
    ...
    ![Modifying our default node pool, the cluster autoscaler, etc](https://cdn.hashnode.com/res/hashnode/image/upload/v1762918866561/89a00b2c-46e8-440d-8662-77386cc2cf0e.png align="center")
...
* **Disk size:** 50 GB
    ...
    ![Configuring the E2 Machine type](https://cdn.hashnode.com/res/hashnode/image/upload/v1762837157043/89da8297-8ecc-4369-aef5-c3b0e75e37be.png align="center")
    
    ![Configuring our default pool CPU, RAM, and disk](https://cdn.hashnode.com/res/hashnode/image/upload/v1762920102117/173a1d66-d31b-49e3-835b-436ec2781b49.png align="center")
...
![Accessing out new cluster page](https://cdn.hashnode.com/res/hashnode/image/upload/v1762844143298/042cc870-82ae-4981-b7c8-d80b187f37a9.png align="center")

Next, click the “Connect” link at the top of the page. A modal will pop up. Copy the CLI command you see.

![Getting the command to access the cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762844213835/119b603c-26c3-46ee-83e1-8feba78031a7.png align="center")
...
📌 **Note:** To run this command successfully, you need to have the `gcloud` CLI tool installed. If you don’t have it yet, visit [Install Google Cloud SDK](https://docs.cloud.google.com/sdk/docs/install) and pick the steps for your OS.
...
![The command to provide your terminate your terminal to the newly created Kubernetes cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762844890936/12e6d8a7-b0ae-44d1-a77c-aeb118ba269b.png align="center")
...
![The available nodes in the GKE cluster](https://cdn.hashnode.com/res/hashnode/image/upload/v1762917947091/c29eb598-1723-43d0-a77f-c6611d04d3d8.png align="center")
...
* [Understanding Website Encryption (FreeCodeCamp)](https://www.freecodecamp.org/news/understanding-website-encryption/)
    
* [Mutual TLS Deep Dive (Medium)](https://medium.com/@LukV/mutual-tls-mtls-a-deep-dive-into-secure-client-server-communication-bbb83f463292)
...
![The CockorachDB replicas and disk in production](https://cdn.hashnode.com/res/hashnode/image/upload/v1762928441524/d7e3d17f-c144-468f-8cc5-d71628ac6a3b.png align="center")
...
![Trying to connect to the new CockroachDB cluster in insecure mode](https://cdn.hashnode.com/res/hashnode/image/upload/v1763193779864/f3e7abcb-34b0-4c21-8652-48a03e4ff6c9.png align="center")
...
If this still feels abstract, [watch this video](https://www.youtube.com/watch?v=EnY6fSng3Ew). It explains TLS beautifully.
...
**N.B.:** You need to have the `openssl` tool installed in order to be able to make the certificate human-readable. If you don’t, [install it following this tutorial](https://github.com/openssl/openssl#download).
...
![Connecting to the CokcorachDB cluster from Beekeeper Studio in "Secure" mode](https://cdn.hashnode.com/res/hashnode/image/upload/v1763389469459/bbdb17c5-1c3b-4163-932f-3cd5382160f4.png align="center")
...
![Successfully restored CockroachDB database](https://cdn.hashnode.com/res/hashnode/image/upload/v1763393752870/f95d76c0-3722-491a-a97c-a1b8a79bdc79.png align="center")
...
![Connecting as the mtls_auth user with the wrong certificate and key-pair](https://cdn.hashnode.com/res/hashnode/image/upload/v1763444971964/93f41787-425b-4e36-86da-4b688cef672f.png align="center")
...
CockroachDB’s [official docs recommend](https://www.cockroachlabs.com/docs/stable/secure-cockroachdb-kubernetes?filters=helm#deploy-cert-manager-for-mtls) managing client certificates using **cert-manager**.
...
![List of books from our books-pod logs](https://cdn.hashnode.com/res/hashnode/image/upload/v1763534354156/60114f7b-ba62-4706-a0b7-7629e20bfaaa.png align="center")
...
Learn more about CockroachDB licenses here 👉🏾 [https://www.cockroachlabs.com/docs/stable/licensing-faqs](https://www.cockroachlabs.com/docs/stable/licensing-faqs)
...
If you enjoyed this book, you can learn more about me by exploring more of my blogs and projects on my [LinkedIn profile](https://www.linkedin.com/in/prince-onukwili-a82143233/). and reach out to me on [Twitter (X)](https://x.com/POnukwili). You can find more of my [articles here](https://www.linkedin.com/in/prince-onukwili-a82143233/details/publications/) or on [my freeCodeCamp blog](https://www.freecodecamp.org/news/author/onukwilip/).

You can also [visit my website](https://prince-onuk.vercel.app). Let’s connect and grow together! 😊
