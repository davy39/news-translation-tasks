---
title: Full Stack Project Tutorial – Create a Recipe App Using React, Node.js and
  PostgreSQL
subtitle: ''
...
* [GitHub Repositor](#try-it-yourself-first)ies
* [Video Tutorial](#heading-video-tutorial)
* [Project Architecture](#heading-project-architecture)
* [How to Setup the Backend](#heading-how-to-setup-the-backend)
* [How to Setup the Database and Prisma](#heading-how-to-setup-the-database-and-prisma)
* [How to Get and Secure a Spoonacular API Key](#heading-how-to-get-and-secure-a-spoonacular-api-key)
* [How to Create the Search Endpoint](#heading-how-to-create-the-search-endpoint)
* [How to Setup the Frontend](#heading-how-to-setup-the-frontend)
* [How to Call the Search API and Display Results on the Frontend](#heading-how-to-call-the-search-api-and-display-results-on-the-frontend)
* [How to Create the Search Input and Recipe Card Component](#heading-how-to-create-the-search-input-and-recipe-card-component)
* [How to Build the Pagination and View More Functionality](#heading-how-to-build-the-pagination-and-view-more-functionality)
* [How to Build the Recipe Summary Modal Component](#how-to-build-the-recipe-summary-and-build-more-component)
* [How to Create Endpoints to Get/Create/Delete Favorite Recipes](#heading-how-to-create-endpoints-to-getcreatedelete-favorite-recipes)
* [How to Add Favorites Functionality to the Frontend](#heading-how-to-add-favorites-functionality-to-the-frontend)
* [How to Adding CSS/Styling](#heading-how-to-add-cssstyling)
...
[You can find the completed code on GitHub by clicking here,](https://github.com/chrisblakely01/react-node-recipe-app) or clone the repo:
...
If you want to save some time and skip the initial setup, [you can find the starter code here.](https://github.com/chrisblakely01/react-node-recipe-app-starter) This has a skeleton frontend/backend project already setup, as well as the basic layout and CSS. Or clone the repo:
...
_Diagram illustrating the various components of the app_
...
Start by navigating to [ElephantSQL](https://www.elephantsql.com/). Click on "Get a managed database today," followed by selecting the "Tiny Turtle" plan for a free instance.
...
To do this, navigate to [Spoonacular](https://spoonacular.com/) and click on "Start Now." Sign up for an account and proceed to the dashboard.
...
Firstly obtain an image from a source like [Pexels](https://www.pexels.com) or any other image repository. This will be used in the Hero section of our app at the top, and will have our title overlaid on it. Ensure the image has a horizontal orientation for better handling of aspect ratios.
...
If you enjoyed this project, you can find more at [CodeCoyotes.com](https://www.codecoyotes.com/), where you can also send me a message if you need to get in contact.   
