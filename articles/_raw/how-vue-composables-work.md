...
Before diving into the tutorial below, I want to mention that the documentation for Vue is *really* good. [The page on composables](https://vuejs.org/guide/reusability/composables) explains the basics really well and will get you 90 percent of the way there. I am writing this article because I think the examples in the docs could go a little deeper in explaining how things can work inside of a composable. I will be reiterating some of the information from the docs, but I will also provide an example of a more complex composable.

### Here’s what we’ll cover:

* [Why Use Composables?](#heading-why-use-composables)
    
* [Simple Composable Example](#heading-simple-composable-example)
    
* [Complex Composable Example](#heading-complex-composable-example)
    
    * [Util function for fetch](#heading-util-function-for-fetch)
        
    * [useAsyncState Composable](#heading-useasyncstate-composable)
        
    * [Usage in a component](#heading-usage-in-a-component)
...
For more real world examples you can check out the [VueUse library](https://vueuse.org/) and [repo](https://github.com/vueuse/vueuse).
