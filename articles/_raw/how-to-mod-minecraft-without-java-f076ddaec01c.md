...
In this video ([click here](https://www.youtube.com/watch?v=RqohEXw9yvw) if the embed doesn’t work above) I show you how to write a basic Minecraft mod using TypeScript, and run it on your local computer with both a desktop and a mobile Minecraft server.
...
You need a Minecraft _client_ to test your plugin.

Install at least one of the following:

* [Minecraft](https://www.minecraft.net/en-us/) Java Edition — a desktop client, if you want to test against a Bukkit server.
...
* `smac`— _Scriptcraft Modular Architecture Controller,_ a program that runs Minecraft Servers for your plugins.
* `yo` — _Yeoman_, a scaffolding tool.
...
[**Scaffold a Minecraft plugin using Magikcraft**](https://asciinema.org/a/242028)  
[_Magikcraft.io allows you to write Minecraft plugins in TypeScript/JavaScript that will run on Desktop / Mobile._asciinema.org](https://asciinema.org/a/242028)
...
* `node_modules` — modules from npm are installed here. You cannot use modules from npm that use V8 APIs (like fs or http). Many of the features that you need are provided by the [Scriptcraft API](https://github.com/walterhiggins/ScriptCraft) and by the `[@magikcraft/core](https://github.com/Magikcraft/magikcraft-core)` [package.](https://github.com/Magikcraft/magikcraft-core)
...
[**Start a Magikcraft Development Server**](https://asciinema.org/a/242023)  
[_Start a Magikcraft Development Server._asciinema.org](https://asciinema.org/a/242023)
