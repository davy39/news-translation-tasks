...
But instead of just finding any solution, [P1xt](https://www.freecodecamp.org/news/what-i-learned-from-writing-six-functions-that-all-did-the-same-thing-b38fd48f0d55/undefined)’s competition required you to focus on efficiency. It encouraged you to write your own tests, and to benchmark the performance of your solutions.
...
I wrote a simple testing script using the values [P1xt](https://www.freecodecamp.org/news/what-i-learned-from-writing-six-functions-that-all-did-the-same-thing-b38fd48f0d55/undefined) provided. Notice that in the script below, the function is included as a module:
...
Now that we have two functions, we can compare their efficiency. Again, thanks to [P1xt](https://www.freecodecamp.org/news/what-i-learned-from-writing-six-functions-that-all-did-the-same-thing-b38fd48f0d55/undefined) for providing this script in a previous forum thread.
...
If you’re curious, here is [P1xt](https://www.freecodecamp.org/news/what-i-learned-from-writing-six-functions-that-all-did-the-same-thing-b38fd48f0d55/undefined)’s write up of the competition, and all of the testing and benchmark data:
