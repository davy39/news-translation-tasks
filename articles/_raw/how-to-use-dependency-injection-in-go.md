...
* [What is Dependency Injection?](#heading-what-is-dependency-injection)
    
* [Manual DI in Go](#heading-manual-di-in-go)
    
    * [The Repository Layer](#heading-the-repository-layer)
        
    * [The Service Layer](#heading-the-service-layer)
        
    * [The Handler Layer](#heading-the-handler-layer)
        
    * [Wiring It All Together in main.go](#heading-wiring-it-all-together-in-maingo)
        
    * [Why Manual DI Works Well in Go](#heading-why-manual-di-works-well-in-go)
        
    * [Downsides of Manual DI](#heading-downsides-of-manual-di)
        
    * [A Quick Testing Example](#heading-a-quick-testing-example)
        
    * [Takeaway](#heading-takeaway)
        
    * [Exercise for the Reader](#heading-exercise-for-the-reader)
        
* [When DI Gets Hard](#heading-when-di-gets-hard)
    
    * [Nested Dependencies](#heading-nested-dependencies)
        
    * [Testing at Scale](#heading-testing-at-scale)
        
    * [Configuration Complexity](#heading-configuration-complexity)
        
    * [Patterns to Mitigate Complexity](#heading-patterns-to-mitigate-complexity)
        
    * [When Developers Consider DI Frameworks](#heading-when-developers-consider-di-frameworks)
        
    * [Key Takeaways](#heading-key-takeaways)
        
* [Go DI Libraries and Tools](#heading-go-di-libraries-and-tools)
    
    * [Google Wire (Compile-Time DI)](#heading-google-wire-compile-time-di)
        
    * [Uber Dig (Runtime DI)](#heading-uber-dig-runtime-di)
        
    * [Uber Fx (DI + App Lifecycle)](#heading-uber-fx-di-app-lifecycle)
        
    * [Other Lightweight DI Helpers](#heading-other-lightweight-di-helpers)
        
* [Choosing the Right Tool](#heading-choosing-the-right-tool)
    
    * [Key Takeaways](#heading-key-takeaways-1)
        
    * [Exercise for the Reader](#heading-exercise-for-the-reader-1)
        
* [Best Practices and Takeaways](#heading-best-practices-and-takeaways)
    
    * [Prefer Explicit Dependencies](#heading-prefer-explicit-dependencies)
        
    * [Start Simple (Manual DI)](#heading-start-simple-manual-di)
        
    * [Use Frameworks to Tame Complexity](#heading-use-frameworks-to-tame-complexity)
        
    * [Keep Wiring at the Edges](#heading-keep-wiring-at-the-edges)
        
    * [Favor Interfaces for Testability](#heading-favor-interfaces-for-testability)
        
    * [Avoid Over-Engineering](#heading-avoid-over-engineering)
        
    * [Balance Verbosity and Magic](#heading-balance-verbosity-and-magic)
        
    * [Adopt Incrementally](#heading-adopt-incrementally)
        
    * [Document Your Wiring](#heading-document-your-wiring)
        
    * [Key Takeaways](#heading-key-takeaways-2)
...
[Google Wire](https://github.com/google/wire) is a compile-time code generation tool. You define how dependencies relate to each other, and Wire generates the code to assemble them. There's no runtime magic, all the wiring is explicit in the generated code.
...
[Uber Dig](https://github.com/uber-go/dig) is a runtime dependency injection container. Unlike Wire, Dig uses reflection to automatically resolve dependencies when you invoke them.
...
[Uber Fx](https://github.com/uber-go/fx) builds on Dig and adds application lifecycle management. It's ideal for large microservices with multiple modules and background processes.
...
* [do](https://github.com/samber/do): A minimalistic DI container that focuses on simplicity and ease of use. It provides basic functionality to register and resolve dependencies without much overhead.
    
* [alice](https://github.com/justinas/alice): A lightweight middleware chaining library that can help manage dependencies in HTTP handlers, though it's not a full DI framework.
