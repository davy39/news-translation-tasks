...
![YouTube skeleton screen example showing placeholders](https://cdn.hashnode.com/res/hashnode/image/upload/v1729602784479/b4ffa403-f642-41f0-911b-897f2eebad2b.png align="center")
...
![skeleton screen with motion](https://cdn.hashnode.com/res/hashnode/image/upload/v1729603561030/235b53ed-a75d-4eb0-9126-c63174d0c59f.gif align="center")
...
If you’re new to React and wish to follow along, click this [link](https://vite.dev/guide/) and follow the steps to create your React project. When you’re done, come back here and let’s continue building.
...
There are variables that will be changing frequently in our project, and they need to be declared. You can read my article on [state management](https://www.freecodecamp.org/news/react-state-management/) if you are not familiar with the concept.
...
For more front-end related posts and articles, you can follow me on [LinkedIn](https://www.linkedin.com/in/timothy-olanrewaju750/) and [X](https://x.com/SmoothTee_DC).
