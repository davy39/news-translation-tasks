...
* [Basic project setup](#heading-project-setup)
* [Using Chat Models and other fundamental LangChain components](#heading-first-steps)
* [Using LangChain Expression Language to create chains](#heading-chaining)
* [Streaming output as soon as it is generated](#heading-streaming)
* [Passing context to steer the model’s output (basic RAG concepts)](#heading-how-to-guide-generation-with-context)
* [Debugging and tracing the internals of your chains](#heading-debugging)

Let’s dive in!

## Project Setup

We recommend using a [Jupyter notebook](https://jupyter.org/) to run the code in this tutorial since it provides a clean, interactive environment. See [this page](https://jupyter.org/install) for instructions on setting it up locally, or [check out this Google Colab notebook]( https://colab.research.google.com/drive/1MsQNc7AMS3qY4Y94_ZN8ppWcNh0RgD-v?usp=sharing) for an in-browser experience.
...
_Prompt templates in LangChain_
...
_Prompt model and output parser_
...
And if you want to learn more about Retrieval-Augmented Generation (RAG), here's a [RAG from scratch course on freeCodeCamp's YouTube channel](https://www.youtube.com/watch?v=sVcwVQRHIc8).
