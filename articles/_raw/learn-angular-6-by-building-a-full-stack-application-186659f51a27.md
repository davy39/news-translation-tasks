...
Your server will be running from [`http://localhost:8000`](http://localhost:8000).

We are using [pipenv](https://github.com/pypa/pipenv), the officially recommended pa[ckage](https://github.com/pypa/pipenv) management tool fo[r Pyth](https://github.com/pypa/pipenv)on. You’ll need to have it installed. The process is quite simple depending on your operating system.
...
You can serve your appl[ication locally by running the f](https://www.techiediaries.com/angular-material-tutorial-example/)[ollowing co](https://www.techiediaries.com/angular-bootstrap-tutorial)[mmands:](https://www.techiediaries.com/angular-material-tutorial-example/)
...
Your application will be running from [`http://localhost:4200`](http://localhost:4200).
...
If you are fam[ilia](https://angular.io/guide/template-syntax)r with the MVC (Model View Controller) pattern, the component class plays the role of the Controller. The HTML template plays the role of the View.
...
Throughout this **Angular 6** tutorial for beginners, we’ve seen, by building a simple real-world CRUD example, how to use different Angular concepts to create simple full-stack CRUD application with Angular and Django. You can find the source code in this [repository](https://github.com/techiediaries/ng-crm).
