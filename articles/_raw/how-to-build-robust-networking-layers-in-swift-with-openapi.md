...
* [What is OpenAPI and Why Should You Care?](#heading-what-is-openapi-and-why-should-you-care)
    
    * [Benefits for Swift (iOS) Developers](#heading-benefits-for-swift-ios-developers)
        
* [A Practical Guide to Implementing This Solution](#heading-a-practical-guide-to-implementing-this-solution)
    
    * [Step 1: Create a good openapi.yaml file (the specification)](#heading-step-1-create-a-good-openapiyaml-file-the-specification)
        
    * [Step 2: Set up your project](#heading-step-2-set-up-your-project)
        
    * [Step 3: Write a wrapper](#heading-step-3-write-a-wrapper)
        
    * [Step 4: Call the wrapper and display the data](#heading-step-4-call-the-wrapper-and-display-the-data)
        
* [Potential Pitfalls](#heading-potential-pitfalls)
    
    * [Verbose or ugly generated code](#heading-verbose-or-ugly-generated-code)
        
    * [Large Specs and Performance Issues](#heading-large-specs-and-performance-issues)
        
    * [Unsupported Spec Features](#heading-unsupported-spec-features)
        
* [Conclusion: Embrace Spec-Driven Development](#heading-conclusion-embrace-spec-driven-development)
...
* Prototyping an app that fetches and displays a list of posts from the [https://jsonplaceholder.typicode.com/](https://jsonplaceholder.typicode.com/) 
...
![App Creation Screen](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047209636/75cad7d3-f403-4285-8209-fd2bb65418e5.png align="center")

![Basic SwiftUI App after it's created](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047246793/3491aa5d-c35c-4157-adf2-789fe5e9cd96.png align="center")
...
![Adding the openapi.yaml file to our project](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047290178/fc31b759-b1c4-4b48-b58b-d90109614cd0.png align="center")
...
1. Swift OpenAPI Generator – [https://github.com/apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) – The Core Generator Plugin.
    
    ![Adding Swift OpenAPI Generator to our Project](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047376776/b1d7b2d0-9b1f-45c8-8c74-4395a4c80dd9.png align="center")
    
    ![Making sure that no targets are selected for the OpenAPIGenerator](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047411622/c6eca0c0-538e-40b5-a9b0-9fa044b60694.png align="center")
    
2. Swift OpenAPI Runtime – [https://github.com/apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) – This contains the common types and protocols used by the code generated by the generator plugin.
    
    ![Adding OpenAPIRuntime to our project](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047457532/846ec488-cfed-4ca5-811b-c38dba0aaf30.png align="center")
    
3. Swift OpenAPI URLSession – [https://github.com/apple/swift-openapi-urlsession](https://github.com/apple/swift-openapi-urlsession) – This is a transport layer that allows the generated code to use the Apple URLSession to make network requests. 
    
    ![Adding OpenAPIURLSession to our Project](https://cdn.hashnode.com/res/hashnode/image/upload/v1753047476699/9556047e-cc33-44b4-9980-0c692d4c1d01.png align="center")
...
![Where to check if you encounter that error](https://cdn.hashnode.com/res/hashnode/image/upload/v1753048265985/100428a4-e46a-4aa1-8fcf-4c74e26ffed6.png align="center")
...
![openapi-generator-config.yaml file](https://cdn.hashnode.com/res/hashnode/image/upload/v1753048237863/963d6bc0-a368-427b-add3-75dcf4bd3edf.png align="center")
...
![Adding the generator in the build phase](https://cdn.hashnode.com/res/hashnode/image/upload/v1753048334094/24e20adc-c6e0-4d66-965b-19d476a5ffd3.png align="center")
...
![Trust and Enable security dialog for the generator](https://cdn.hashnode.com/res/hashnode/image/upload/v1753048374405/6ff51ff4-d33a-4920-b95f-9fda0ee0aef4.png align="center")
...
![Generated Files](https://cdn.hashnode.com/res/hashnode/image/upload/v1753048508703/8fcec6bf-ad86-47de-b57c-7dca22256e06.png align="center")
...
![Simulator Run of the app showing the fetched posts](https://cdn.hashnode.com/res/hashnode/image/upload/v1753053957409/b89d50e8-ab73-4484-beda-3a328a575144.png align="center")
...
For developers ready to explore further, please checkout the official `swift-openapi-generator` repository on Github here: [https://github.com/apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator).

You can follow me on [GitHub](https://github.com/sravankaruturi) and [Hashnode](https://hashnode.com/@sravankaruturi) for my other posts and projects.
