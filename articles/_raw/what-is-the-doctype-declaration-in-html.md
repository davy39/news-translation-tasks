...
* **Strict DTD**: Used for web pages that _exclude_ attributes and elements that W3C expects to phase out as CSS support grows
* **Transitional DTD**: Used for web pages that _include_ attributes and elements that W3C expects to phase out as CSS support grows
