...
The first step is to opt-in to AWS Local Zones in the region of your choice. You can follow the instructions in the [AWS Local Zones documentation](https://docs.aws.amazon.com/local-zones/latest/ug/getting-started.html) to opt-in to these zones.
...
If you’ve enjoyed my writing and want to keep me motivated, consider leaving stars on [GitHub](https://github.com/gursimarsm) and endorse me for relevant skills on [LinkedIn](https://www.linkedin.com/in/gursimarsm).
