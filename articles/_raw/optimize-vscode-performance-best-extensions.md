---
title: VS Code Performance – How to Optimize Visual Studio Code and Choose the "Best"
  Extensions
subtitle: ''
author: freeCodeCamp
co_authors: []
...
<small>Edit of "Blindfolded Lady Justice" by [Tingey Injury Law Firm](https://unsplash.com/@tingeyinjurylawfirm?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/equal?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)</small>
...
3. **When is an extension loaded and active?**
   ...
   I'll discuss this in detail in the section [Activation Events](#activation-events). You need to check the *package.json* of the source code to find this out in advance. 
   
   You can run the **Developer: Startup Performance** command to see the Activation Events of installed extensions. I discuss this further in the section [How to audit performance.](#how-to-audit-performance) 
...
<small>Edit of untitled photo by [Pablo Merchán Montes](https://unsplash.com/@pablomerchanm?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/burger?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)</small>
...
You shouldn't need to compromise on performance to get the features you need. 

The most pragmatic approach is incrementally add the extensions you need. Do a little bit of research each time and test out the extension. And before you know it, you will have an awesome portfolio of extensions.
