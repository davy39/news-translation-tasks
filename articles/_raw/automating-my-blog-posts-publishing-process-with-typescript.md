...
Since I'm trying to build a writing habit, well, I'm writing more and more. Even though I use publishing blogs like [Medium](https://medium.com/@leandrotk_), [dev.to](https://dev.to/teekay), and [Hashnode](https://hashnode.com/@teekay), I like to post my content on [my own blog](http://leandrotk.github.io/tk) as well.
...
This post was originally published [on my blog](https://leandrotk.github.io/tk/2020/04/publisher-a-tooling-to-automate-the-process-to-publish-my-blog-posts/index.html).

My [Twitter](https://twitter.com/leandrotk_) and [Github](https://github.com/leandrotk/).

## Resources

* [Publisher Tooling: source code](https://github.com/leandrotk/publisher)
