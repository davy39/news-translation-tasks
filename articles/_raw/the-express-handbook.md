---
title: The Express +  Node.js Handbook – Learn the Express JavaScript Framework for
  Beginners
subtitle: ''
author: Flavio Copes
co_authors: []
...
* [How to Install Express](#heading-how-to-install-express)
    
* [The first "Hello, World" example](#heading-the-first-hello-world-example)
    
* [Request Parameters](#heading-request-parameters)
    
* [How to Send a Response to the Client](#heading-how-to-send-a-response-to-the-client)
    
* [How to Send a JSON Response](#heading-how-to-send-a-json-response)
    
* [How to Manage Cookies](#heading-how-to-manage-cookies)
    
* [How to Work with HTTP Headers](#heading-how-to-work-with-http-headers)
    
* [How to Handle Redirects](#heading-how-to-handle-redirects)
    
* [Routing in Express](#heading-routing-in-express)
    
* [Templates in Express](#heading-templates-in-express)
    
* [Express Middleware](#heading-express-middleware)
    
* [How to Serve Static Assets with Express](#heading-how-to-serve-static-assets-with-express)
    
* [How to Send Files to the Client](#heading-how-to-send-files-to-the-client)
    
* [Sessions in Express](#heading-sessions-in-express)
    
* [How to Validate Input in Express](#heading-how-to-validate-input-in-express)
    
* [How to Sanitize Input in Express](#how-to-sanitize-input-in-express)
    
* [How to Handle Forms in Express](#heading-how-to-handle-forms-in-express)
    
* [How to Handle File Uploads in Forms in Express](#heading-how-to-handle-file-uploads-in-forms-in-express)
