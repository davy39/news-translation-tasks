...
co_authors: []
series: null
date: '2023-12-08T17:07:46.000Z'
originalURL: https://freecodecamp.org/news/learn-coding-for-everyone-handbook
coverImage: https://www.freecodecamp.org/news/content/images/2023/12/How-to-Start-Learning-to-Code-cover--1-.png
tags:
- name: handbook
  slug: handbook
- name: learn to code
...
seo_title: null
seo_desc: 'In this handbook, I''ll address a question you may be asking yourself:
  should you learn how to code?

  After explaining why you definitely should, I''ll cover some of the benefits and
  challenges of being a software developer. I''ll also discuss some key s...'
---
...
* [What is programming?](#heading-what-is-programming)
    
* [Should you still learn to code \[Yes\]?](#heading-should-you-still-learn-to-code-answer-yes)
    
* [Why you should consider coding as a career](#heading-why-you-should-consider-coding-as-a-career)
    
* [Potential challenges of a programming job](#heading-potential-challenges-of-a-programming-job)
    
* [Why do software engineers get paid so well](#heading-why-do-software-engineers-get-paid-so-well)?
    
* [How to prepare for your coding journey](#heading-how-to-prepare-for-your-coding-journey)
    
* [Your ego is your enemy](#heading-your-ego-is-your-enemy)
    
* [Take responsibility for your learning](#heading-take-responsibility-for-your-learning)
    
* [I am afraid to start programming. What should I do?](#i-am-afraid-to-start-programming-what-should-i-do)
    
* [Strategies and tips for learning to code](#heading-strategies-and-tips-for-learning-to-code)
    
* [Can you learn coding in a single night?](#heading-can-you-learn-coding-in-a-single-night)
    
* [Avoid tutorial hell](#heading-avoid-tutorial-hell)
    
* [How to understand complex topics by using the Feynman Technique](#heading-how-to-understand-complex-topics-by-using-the-feynman-technique)
    
* [Don't memorize the syntax](#heading-dont-memorize-the-syntax)
    
* [Keep a To-Learn list](#heading-keep-a-to-learn-list)
    
* [Practical aspects of coding](#heading-practical-aspects-of-coding)
    
* [How to deal with overwhelming projects](#heading-how-to-deal-with-overwhelming-projects)
    
* [How to choose projects to build?](#heading-how-to-choose-projects-to-build)
    
* [Learn by building things from scratch](#heading-learn-by-building-things-from-scratch)
    
* [Build something that already exists](#heading-learn-by-building-things-from-scratch)
    
* [Beyond the basics](#heading-beyond-the-basics)
    
* [Develop a love of learning](#develop-a-love-of-learning)
    
* [Look at the bigger picture](#heading-look-at-the-bigger-picture)
    
* [Embrace lifelong learning](#heading-embrace-lifelong-learning-in-software-engineering)
    
* [Get the PDF version of the book](#heading-get-the-pdf-version-of-the-book)
...
A software bug in a Therac-25 radiation therapy machine [caused the death](https://www.newscientist.com/gallery/software-bugs/) of five patients after receiving a massive dose of X-rays.

Knight Capital [lost half a billion dollars](https://www.newscientist.com/gallery/software-bugs/) in half an hour when a software bug allowed computers to sell and buy millions of shares with no human oversight.
...
Sure, you might have heard of the developer who [implemented 10 applications in 10 hours in one sitting](https://dev.to/florinpop17/10-javascript-projects-in-10-hours-coding-challenge-316d). But that’s not the result of one-night of learning. He worked hard and learned a lot before he managed to pull that off.
...
Here's a [comment](https://twitter.com/tdierks/status/835912924329836545) from a senior dev at Google:
...
> I wrote 255 lines of code that included a working server and a client. I queried google 23 times mostly landing on StackOverflow, Netty 4 website, GitHub, and JavaDocs. If you do the math, that averages out to 1 query every 10 lines of code! I had no idea. — [Umer Mansoor](https://tiantiankan.me/a/5cb4c6c2f4b9a5fab76893b2)
...
Here’s another quote from a [comment](https://news.ycombinator.com/item?id=11603078) on Hacker News:
...
Nowadays, we get new languages and frameworks, or considerable changes to existing ones, so that trying to memorize the syntax is both difficult and not that important. As one commentator on a blog post brilliantly [put](http://disq.us/p/17uk3bk) it:

> “Great engineers know how to formulate good queries. Yet interviewers expect walking dictionaries.”

So, to sum it all up: [get really good at googling](https://www.freecodecamp.org/news/how-to-search-google-like-a-pro/) and learning as you go :)
...
Picture yourself as an apprentice painter, learning by replicating the works of masters. Similarly, in software development, [cloning an existing project](https://www.freecodecamp.org/news/javascript-game-tutorial-stick-hero-with-html-canvas/) is a [hands-on way to learn coding and problem-solving](https://www.freecodecamp.org/news/learn-how-to-create-an-instagram-clone-using-react/).
...
You can read this book as a PDF by downloading it [here](https://fatosmorina.gumroad.com/l/coding-for-everyone).
