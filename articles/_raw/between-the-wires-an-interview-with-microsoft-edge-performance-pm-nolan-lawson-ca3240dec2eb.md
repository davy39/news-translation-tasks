...
_I interviewed Nolan Lawson, Web Performance PM at [Microsoft Edge](https://www.microsoft.com/en-us/windows/microsoft-edge#x2QP2K1csjiH2CwS.97). He also maintains the popular open source library [PouchDB](https://github.com/pouchdb/pouchdb) together with others._
...
When I was six or seven, my uncle gave me a hand-me-down MS-DOS machine with a 5¼ inch floppy drive. It was ancient by today’s standards. It had basically two games: [Snake](https://en.wikipedia.org/wiki/Snake_(video_game)) and [Gorillas](https://en.wikipedia.org/wiki/Gorillas_(video_game)), and it actually displayed the BASIC code before they started up. Those two games were all I could figure out to do with it.

![Image](https://cdn-media-1.freecodecamp.org/images/WDEwCruaYCNHwnMclV8mql1ojpcm2GGQxgND)
_(8-inch, 5¼-inch, and 3½-inch floppy disks)_

![Image](https://cdn-media-1.freecodecamp.org/images/0dMk0hq3xNcQHzK-0nCW0jMB0ZrKemPeLAbo)
_(Gorillas, is a [IBM](https://en.wikipedia.org/wiki/Video_game" rel="noopener" target="_blank" title="Video game">video game</a> first distributed with <a href="https://en.wikipedia.org/wiki/MS-DOS" rel="noopener" target="_blank" title="MS-DOS">MS-DOS 5</a> and published in 1991 by <a href="https://en.wikipedia.org/wiki/IBM" rel="noopener" target="_blank" title="IBM) corporation.)_
...
_(PouchDB team reunion 2015, Nolan Lawson, Gregor Martynus and Calvin Metcalf)_
...
_(Dale commenting on Github issue)_
...
_(Nolan at Offline Camp with Jesse Beach and others, 2016)_
...
_(Nolan with Todd Reifsteck and Rob Hwacinski of the Microsoft Edge Team)_
