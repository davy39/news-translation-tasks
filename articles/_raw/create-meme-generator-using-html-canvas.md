...
![meme generator page on the browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1731772678380/edd33637-73dd-40b6-8b8d-352d350ac52e.png align="center")
...
* [`event.target`](http://event.target)`.files[0]`: Accesses the first file the user selects.
...
* [`link.download`](http://link.download) `= 'meme.png'`: Sets the file name for the downloaded meme (every meme you download will carry the name of `meme.png` – you can change it if you wish to).
    
* `link.href = canvas.toDataURL()`: Converts the canvas content into a Data URL.
    
* [`link.click`](http://link.click)`()`: Simulates a click on the link, triggering the download.
...
![Meme Generator project working in the browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1731787007980/24206a68-6e2e-4883-81f2-1db5169cb093.gif align="center")

### Final Results

Here are two memes created by our meme generator.

![meme 1](https://cdn.hashnode.com/res/hashnode/image/upload/v1731780897736/d136df1d-c3a4-416d-90ca-e6e400d10a0e.png align="center")

![meme 2](https://cdn.hashnode.com/res/hashnode/image/upload/v1731780929605/f67cc533-2bb4-4bdb-ad9f-1231caede069.png align="center")

Pretty cool right?

Now, you can try it out and create your own viral meme!

For more programming articles and posts, you can follow me on [X](https://x.com/SmoothTee_DC) or connect with me on [LinkedIn](https://www.linkedin.com/in/timothy-olanrewaju750/).
