...
In this tutorial, we’ll explore how to use CSS Subgrid to create a products section that stays flexible and looks great. You can move along to see what we'll build [here](#heading-building-a-products-section-with-subgrid).

### Table of Contents

* [Limitations of CSS Grid](#heading-limitations-of-css-grid)
    
* [How to Build a Products Section with Subgrid](#heading-how-to-build-a-products-section-with-subgrid)
    
* [How Does Subgrid Work?](#heading-how-does-subgrid-work)
    
* [How to Use Subgrid](#heading-how-to-use-subgrid)
    
* [Subgrid in Browser DevTools](#heading-subgrid-in-browser-devtools)
...
![An image showing an example grid with and without subgrid](https://cdn.hashnode.com/res/hashnode/image/upload/v1724192748056/e6d99008-5a04-4a83-927d-0d46be2e17a5.png align="center")
...
![An image of the final project to be built in this tutorial](https://cdn.hashnode.com/res/hashnode/image/upload/v1724225971840/767e1b9e-bd54-4505-b3ad-2c39901b28c3.png align="center")

Check it out on [Codepen](https://codepen.io/ophyboamah/pen/OJevpQP).

### Prerequisites

* Basic knowledge of HTML and CSS (For a refresher on how CSS Grid works, check out [my previous article on Web Layouts](https://www.freecodecamp.org/news/web-layouts-use-css-grid-and-flex-to-create-responsive-webpages/))
...
In our `index.html` file, we'll create the basic structure of the project which includes linking our CSS file and Google Fonts – all within the `<head>` tag. Within the `<body>` tag, we'll create a main container to house all the cards. Next, we'll create three individual cards as articles – each with an icon, title, text and button.
...
In our `style.css` file, we'll first set our global and base styles:
...
![An image of the products cards without Subgrid](https://cdn.hashnode.com/res/hashnode/image/upload/v1724176252090/b3540574-6779-4486-8622-fbf8fe8e9a09.png align="center")
...
![An image of the products cards aligned using subgrid](https://cdn.hashnode.com/res/hashnode/image/upload/v1724182833885/5d985d19-d203-4bd3-a5b2-afbf0f060fa9.png align="center")
...
![An image of an inspected subgrid in Chrome DevTools](https://cdn.hashnode.com/res/hashnode/image/upload/v1724164230096/01861ffd-27a3-4394-bf96-fefcedd890f2.png align="center")
...
* [MDN on CSS Subgrid](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout/Subgrid)
    
* [Learn CSS Subgrid](https://www.youtube.com/watch?v=Yl8hg2FG20Q)
    
* [Web Dev on CSS Subgrid](https://web.dev/articles/css-subgrid)
