---
title: How to Rock the Coding Interview – Tips That Helped Me Land Job Offers from
  Google, Airbnb, and Dropbox
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
A **palindrome** is a word, phrase, [number](https://en.wikipedia.org/wiki/Palindromic_number), or other sequence of [characters](https://en.wikipedia.org/wiki/Character_(symbol)) that reads the same backward and forward, such as _madam_ or _racecar_.
...
The content for this post [can be found here](https://www.techinterviewhandbook.org/). Future updates will be posted there. Pull requests for suggestions and corrections are welcome.
