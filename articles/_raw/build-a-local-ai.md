---
title: 'How to Build Your Own Local AI: Create Free RAG and AI Agents with Qwen 3
  and Ollama'
subtitle: ''
...
5. [Advanced Considerations and Troubleshooting](#heading-advanced-considerations-and-troubleshooting)
    ...
    * [Managing Context Length (num\_ctx)](#heading-managing-context-length-numctx)
...
* **Windows:** Download the installer from the Ollama website ([https://ollama.com/download](https://ollama.com/download)) and follow the setup instructions.
...
* **Ollama:** [Website](https://ollama.com/), [Model Library](https://ollama.com/library), [GitHub](https://github.com/ollama/ollama)
