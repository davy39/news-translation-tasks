...
1. [What is a REST API?](#heading-what-is-a-rest-api)
    
2. [Tools You’ll Need](#heading-tools-youll-need)
    
3. [How to Build a REST API in Django](#heading-how-to-build-a-rest-api-in-django)
    
    * [Step 1: Set Up Your Django Project](#heading-step-1-set-up-your-django-project)
        
    * [Step 2: Create a Model](#heading-step-2-create-a-model)
        
    * [Step 3: Make a Serializer](#heading-step-3-make-a-serializer)
        
    * [Step 4: Create the Views](#heading-step-4-create-the-views)
        
    * [Step 5: Set Up URLs](#heading-step-5-set-up-urls)
        
    * [Step 6: Test It!](#heading-step-6-test-it)
        
4. [DRF Permissions](#heading-drf-permissions)
    
    * [Common Built-In Permissions](#heading-common-built-in-permissions)
        
    * [Custom Permissions](#heading-custom-permissions)
        
    * [Combining Permissions](#heading-combining-permissions)
...
* `python` [`manage.py`](http://manage.py) `startapp api` – Creates a new Django app named `api` where your models, views, and API logic will live.
...
Then, in your main `myproject/`[`urls.py`](http://urls.py):
...
* [Django’s Official Docs](https://docs.djangoproject.com/en/stable/)
...
* [Real Python’s Django API Guide](https://realpython.com/django-rest-framework-quick-start/)
