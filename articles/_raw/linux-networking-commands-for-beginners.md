...
coverImage: https://www.freecodecamp.org/news/content/images/2022/12/FreeCodeCamp---Networking-in-Linux.png
tags:
- name: beginner
  slug: beginner
...
- name: Linux
  slug: linux
seo_title: null
seo_desc: "Can you imagine what it would be like to have a laptop but not to be able\
  \ to access the internet?\nIf you're a developer (or an aspiring one), you'll likely\
  \ use the internet every day. So you should learn a few useful networking commands.\
  \ \nTo learn ne..."
---
...
_Sample Output of the ifconfig command_
...
_Ethernet block in ifconfig command_
...
_LoopBack Interface block in ifconfig command_
...
_Tunnel Interface block in ifconfig command_
...
_Wireless Interface block in ifconfig command_
...
_Command to download file using Linux Terminal_
...
_Sample output of ping command_
...
_Sample output of nslookup command_
...
_Terminal command to find Logged-In user in Linux Terminal_
