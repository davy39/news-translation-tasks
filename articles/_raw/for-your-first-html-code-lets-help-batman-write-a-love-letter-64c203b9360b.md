...
So, let’s create a .html file. You can do this in Notepad, or any other basic editor, but I would recommend using VS Code instead. [Download and install VS Code here](https://code.visualstudio.com/). It’s free, and the only Microsoft Product I love.
...
Before we dive into coding this, download this Bat logo from [here](https://www.pexels.com/photo/batman-black-and-white-logo-93596/). You might want to crop the extra white space in the image. Copy the image in your project root directory and rename it “bat-logo.jpeg”.
