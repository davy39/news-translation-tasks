...
Download the software from [sonarsource downloads](https://www.sonarsource.com/products/sonarqube/downloads/) and choose the *Community Edition* for open-source projects.
...
To access SonarQube, you need to open browser and go to: [http://localhost:9000](http://localhost:9000)
...
![SonarQube project creation page](https://cdn.hashnode.com/res/hashnode/image/upload/v1746152681985/0b1829cb-bd2a-4961-bc69-18f5d677d9dd.png align="center")
...
On Windows/Linux, download the software from [SonarSource](https://docs.sonarsource.com/sonarqube-server/10.4/analyzing-source-code/scanners/sonarscanner/) and unzip it:
...
![Generate tokens in SolarQube](https://cdn.hashnode.com/res/hashnode/image/upload/v1746154994148/02ccf0cd-68ce-4447-bb1f-12ff04cd9e59.png align="center")

Provide a name for the token and click ‘Generate’:

![Name token and then generate](https://cdn.hashnode.com/res/hashnode/image/upload/v1746155102747/834dcbac-070e-4958-9cb7-44a738059343.png align="center")
...
* ![Scanner results dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1746151289131/d2794dc7-1a53-4787-8137-668849d50d2b.png align="center")
    

To view the analysis report, go to [http://localhost:9000/dashboard?id=java-sonar-demo](http://localhost:9000/dashboard?id=java-sonar-demo):

![Analysis results](https://cdn.hashnode.com/res/hashnode/image/upload/v1746151477685/931d1170-3c90-45d2-ab07-b60b551f3856.png align="center")
...
![Detailed results](https://cdn.hashnode.com/res/hashnode/image/upload/v1746151632987/090c61d0-0a37-4bb1-82a1-76f149a4cc86.png align="center")
