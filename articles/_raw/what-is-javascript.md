...
co_authors: []
series: null
date: '2019-12-06T00:05:00.000Z'
originalURL: https://freecodecamp.org/news/what-is-javascript
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9ed8740569d1a4ca3f76.jpg
tags:
- name: JavaScript
  slug: javascript
- name: toothbrush
  slug: toothbrush
seo_title: null
seo_desc: 'JavaScript is the most widely used scripting language on Earth. And it
  has the largest library ecosystem of any programming language.

  JavaScript is the core language of the web, and the only programming language that
  can run in all major web browsers...'
---
...
Most frequently used JavaScript Frameworks are React JS, Angular JS, Create JS, jQuery, nodeJS etc. For details follow this [link](https://javascriptreport.com/the-ultimate-guide-to-javascript-frameworks/).
