...
subtitle: Learn how LangChain and LangGraph help you design intelligent, adaptive
  AI workflows that move from simple prompts to full applications.
...
1. [What is LangChain?](#heading-what-is-langchain)
    
    * [Why LangChain Was Not Enough](#heading-why-langchain-was-not-enough)
        
2. [What is LangGraph?](#heading-what-is-langgraph)
    
3. [LangChain vs LangGraph](#heading-langchain-vs-langgraph)
    
4. [When to Use Each](#heading-when-to-use-each)
    
5. [Adding Memory and Persistence](#heading-adding-memory-and-persistence)
    
6. [Monitoring and Debugging with LangSmith](#heading-monitoring-and-debugging-with-langsmith)
    
7. [The LangChain Ecosystem](#heading-the-langchain-ecosystem)
