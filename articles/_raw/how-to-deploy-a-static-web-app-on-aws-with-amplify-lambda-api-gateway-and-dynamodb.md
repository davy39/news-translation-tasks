---
title: How to Deploy a Static Web App on AWS with Amplify, Lambda, API Gateway, &
  DynamoDB
subtitle: ''
author: Raju Manoj
co_authors: []
...
* [What We'll Build: A Serverless Sum Calculator](#heading-what-well-build-a-serverless-sum-calculator)
    
* [Core AWS Services We'll Use](#heading-core-aws-services-well-use)
    
* [Prerequisites: What You'll Need](#heading-prerequisites-what-youll-need)
    
* [Getting Started: How to Build Our Serverless Web App](#heading-getting-started-how-to-build-our-serverless-web-app)
    
* [How to Test Your Application: Is It Working?](#heading-how-to-test-your-application-is-it-working)
    
* [Common Issues and Solutions](#heading-common-issues-and-solutions)
    
* [Next Steps: Enhance Your Application](#heading-next-steps-enhance-your-application)
...
![Screenshot of DynamoDB console with "Create table" button highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1752056336365/33bf0598-da2e-45b9-9211-833bcd447ca9.png align="center")
...
![Screenshot of DynamoDB "Create table" form with "myTable" and "ID" entered, and other settings default](https://cdn.hashnode.com/res/hashnode/image/upload/v1752053498063/05a9db73-0df6-4679-b2bd-6eab52f93a6b.png align="center")
...
![Screenshot of DynamoDB table details page with the ARN highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1752053703489/be90f79a-38cd-42c6-b014-e0be229384fa.png align="center")
...
* **Permissions:** For now, you can leave the default execution role. We will modify its permissions shortly.
    ...
    ![Screenshot of Lambda "Create function" configuration with name and Python runtime selected](https://cdn.hashnode.com/res/hashnode/image/upload/v1752053897286/6873bb14-d94e-4857-be6c-2964c21f7759.png align="center")
...
![Screenshot of Lambda code editor with the Python code pasted in](https://cdn.hashnode.com/res/hashnode/image/upload/v1752053964053/037e2788-b43f-4f43-bc9a-65417001d353.png align="center")
...
![AWS Lambda console showing a Python script for a Lambda function named "AddFunc". The code imports modules for interacting with DynamoDB and defines a handler function to extract and sum two numbers. A test event is configured with JSON input values for "num1" and "num2". The console output indicates a successful execution, displaying the calculated sum and a status message.](https://cdn.hashnode.com/res/hashnode/image/upload/v1752054962119/650bee28-fcd3-416d-9e19-0784274b8210.png align="center")
...
![ Screenshot of Lambda function Configuration -> Permissions tab with the "Role name" highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1752054336167/bcb46506-a95b-47f0-b629-3a8ac9024819.png align="center")
...
![ Screenshot of IAM role page, showing "Add permissions" dropdown and "Create inline policy" selected](https://cdn.hashnode.com/res/hashnode/image/upload/v1752056539801/500c1465-91dc-49cc-b313-93ddf314142e.png align="center")
...
* **Resources:** This is crucial! We need to specify *which* DynamoDB table our Lambda function is allowed to write to.
    ...
    * Click **"Add ARN"** again in the pop-up to confirm.
    ...
    ![ Screenshot of IAM visual policy editor: DynamoDB service selected, PutItem action checked, and DynamoDB table ARN pasted in the resources section](https://cdn.hashnode.com/res/hashnode/image/upload/v1752056582357/10454e95-e63c-456f-905b-34cb7b8374ab.png align="center")
...
![Screenshot of API Gateway landing page with "Build" button under "REST API" highlighted](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057747903/36c55082-2cac-4f05-831c-610186857a92.png align="center")
...
![Screenshot of API Gateway "Create Method" screen with POST selected and Lambda Function integration configured](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057684772/72eb9071-8ba1-42a2-9a34-60d4268ac77e.png align="center")
...
![Screenshot of API Gateway "Enable CORS" dialog box](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057812238/0babb26e-2808-47f9-b6a8-50d31bb84ca9.png align="center")
...
![Screenshot of API Gateway "Deploy API" dialog with "New Stage" and "dev" entered](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057834205/5de98b6c-f128-4dc6-ab68-9af65f8b8318.png align="center")
...
**Copy this entire Invoke URL and save it somewhere safe. This is the URL our frontend will use to send numbers to our Lambda function!** It will look something like [`https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/dev`](https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/dev).

![Screenshot of API Gateway Stages page with the "Invoke URL" ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057869112/ec23f6bb-b885-4a44-b135-3a48c76fa93b.png align="center")
...
![Screenshot of Amplify console landing page with "Deploy" button under "Deploy without Git provider"](https://cdn.hashnode.com/res/hashnode/image/upload/v1752057954174/d4579189-1049-4896-8cc9-441101352731.png align="center")
...
* Select the **ZIP file** you created in step 5 above.
    ...
    ![Screenshot of Amplify "Deploy without Git provider" screen with app name and ZIP upload section](https://cdn.hashnode.com/res/hashnode/image/upload/v1752054718089/1e94472b-4190-489b-8c10-ec402f883cef.png align="center")
...
![Screenshot of Amplify console after successful deployment showing the "Domain" URL](https://cdn.hashnode.com/res/hashnode/image/upload/v1752054574379/a42bc253-94a1-4bc2-a42c-f7f5444d964b.png align="center")
...
* [AWS Lambda Documentation](https://aws.amazon.com/lambda/resources/): Dive deeper into serverless functions.
    
* [Amazon DynamoDB Developer Guide](https://www.google.com/search?q=https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Welcome.html): Learn more about NoSQL databases.
    
* [Amazon API Gateway Tutorials](https://www.google.com/search?q=https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-getting-started.html): Explore building various types of APIs.
    
* [AWS Amplify Documentation](https://docs.amplify.aws/): Discover more features for building and deploying full-stack applications.
