...
You need to install the project from [GitHub](https://github.com/a0m0rajab/reverse-engineering-lab) and run it to experiment with this tutorial.

## What We’ll Cover:

1. [Prerequisites:](#heading-prerequisites)
    
2. [What is an API?](#heading-what-is-an-api)
    
3. [How Do APIs Work?](#heading-how-do-apis-work)
    
4. [What is Reverse Engineering?](#heading-what-is-reverse-engineering)
    
5. [How to Reverse Engineer a Website](#heading-how-to-reverse-engineer-a-website)
    
    * [Explore the Website](#heading-explore-the-website)
        
    * [Check the Sales](#heading-check-the-sales)
        
    * [How to Use the API on Your Website](#heading-how-to-use-the-api-on-your-website)
        
    * [How to Get the Authorization and Explore it Through the Website](#heading-how-to-get-the-authorization-and-explore-it-through-the-website)
        
    * [Next Steps: Authorization and Authentication](#heading-next-steps-authorization-and-authentication)
...
![An explanation of APIs by the Postman team (From: What is an API? A Beginner's Guide to APIs | Postman)](https://voyager.postman.com/illustration/diagram-what-is-an-api-postman-illustration.svg align="left")
...
![Screenshot of the login page](https://cdn.hashnode.com/res/hashnode/image/upload/v1731438727536/cfb07e6b-2416-41c7-a24e-1cf52b1943b0.png align="center")

Page 2: The website data

![Screenshot of the data page](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258198260/8c96ed82-a288-4141-b97d-e97e71e6412e.png align="center")
...
![Chrome right-click menu](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258258531/1e50c70c-1b97-49a4-aed5-a821c56d638d.png align="center")
...
![Network tab in the Chrome developer tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258501092/3c0e3879-981b-48e2-95a9-736212152938.png align="center")
...
![Showing sales endpoints from the network tab in Chrome developer tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258473336/5b627ea4-9b84-440d-a6e4-d3b5a99714a6.png align="center")

If you click on the call, you will see that you have the headers, cookies, responses, and so on.

![Showing the headers of the API endpoint from Chrome dev tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258693963/69337d7d-79e1-4f16-b161-dc9401cb3c73.png align="center")
...
![Showing the response of the API endpoint from network developer tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258724075/6b1610e9-9919-4de1-beac-c57aa32d5768.png align="center")
...
![The steps to copy the API endpoint as fetch](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258767702/46715fa0-1abc-4d57-8912-3a84032b4d31.png align="center")
...
![The promise results in the console](https://cdn.hashnode.com/res/hashnode/image/upload/v1731258819878/45eebd69-3af1-4474-b221-65c527ead3eb.png align="center")
...
![Screenshot from Postman showing where to paste the url](https://cdn.hashnode.com/res/hashnode/image/upload/v1731260011131/b41277da-4b01-4212-a577-27491948ec94.png align="center")
...
![Screenshot from devtools showing how to copy as curl](https://cdn.hashnode.com/res/hashnode/image/upload/v1731260138355/3411bf8b-23b8-4a16-88fa-bfb4601458c0.png align="center")
...
![Postman interface showing where to paste the URL](https://cdn.hashnode.com/res/hashnode/image/upload/v1731260209476/b8c1633b-299a-4cca-afc5-1dee704be170.png align="center")
...
![Postman screenshot showing the API body and the status](https://cdn.hashnode.com/res/hashnode/image/upload/v1731260251132/aeb7c25c-6c39-475b-8e36-f265f8c7462c.png align="center")
...
![Showing the network tab from developer tools focusing on preserving log and the login endpoint](https://cdn.hashnode.com/res/hashnode/image/upload/v1731263927757/4cfb87f3-4688-403e-af6d-184a2c2f4aa9.png align="center")
...
![Showing the response tab from the network Chrome developer tools](https://cdn.hashnode.com/res/hashnode/image/upload/v1731263967453/56dadf64-14dc-48bc-a81b-b04cafca95e4.png align="center")
...
![Showing the set-cookie response header from headers](https://cdn.hashnode.com/res/hashnode/image/upload/v1731264427158/4f084e2a-b84a-4d5c-95b6-35ebfc725ab6.png align="center")

You will see the same value when you go to the cookies tab.

![Showing the cookies header, focusing on the logged value](https://cdn.hashnode.com/res/hashnode/image/upload/v1731264453607/8ad16508-b19d-4b69-89ba-6e796d7f0120.png align="center")
...
![Showing the headers, then request headers and cookies](https://cdn.hashnode.com/res/hashnode/image/upload/v1731264041695/ca811292-ae3a-4bb1-a33c-4a046b19ff4a.png align="center")

If you go to the cookies tab, you will notice the request did send the same cookies:

![Showing the cookies tab with request cookies and focusing on the provided cookie](https://cdn.hashnode.com/res/hashnode/image/upload/v1731263995185/bcc7f3ee-e510-42cb-817d-94a8f31472f6.png align="center")
...
![Postman screenshot focusing on headers, showing the cookie, status, and the data](https://cdn.hashnode.com/res/hashnode/image/upload/v1731264213696/85b535b9-d488-4bff-95f3-8fecb5093f1e.png align="center")
...
![Postman screenshot showing the headers and focusing on the cookie key.](https://cdn.hashnode.com/res/hashnode/image/upload/v1731264264606/f45c11c6-7121-4702-a57e-9435252d7245.png align="center")
...
If you like this article, subscribe to my [newsletter](https://hadithtechen.substack.com/) and follow me on [Twitter](https://www.freecodecamp.org/news/p/f2a5144e-e6e3-479d-a672-caf80e7431d2/twitter.com/a0m0rajab).
