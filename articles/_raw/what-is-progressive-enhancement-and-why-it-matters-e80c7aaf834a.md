...
[**Designing with Progressive Enhancement: Building the Web that Works for Everyone**](https://www.oreilly.com/library/view/designing-with-progressive/9780321659477/)  
[_Progressive enhancement is an approach to web development that aims to deliver the best possible experience to the…_www.oreilly.com](https://www.oreilly.com/library/view/designing-with-progressive/9780321659477/)[**Unboring.net | Workflow: Applying Progressive Enhancement on a WebVR project**](https://unboring.net/workflows/progressive-enhancement/)  
[_How I made an interactive content to be embedded on weather.com_unboring.net](https://unboring.net/workflows/progressive-enhancement/)
