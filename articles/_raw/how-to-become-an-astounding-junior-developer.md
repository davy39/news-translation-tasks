...
co_authors: []
series: null
date: '2020-07-22T16:39:28.000Z'
originalURL: https://freecodecamp.org/news/how-to-become-an-astounding-junior-developer
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9992740569d1a4ca207a.jpg
tags:
...
seo_desc: 'By John Mosesman
  ...
  If you''re reading this, you probably just got your first tech job — so congratulations!
  Getting the first job is one of the hardest things you''ll do in tech. There''s
  so much work and effort already behind you.
...
_https://jamesclear.com/marginal-gains_

One of my favorite books, [_Atomic Habits_ by James Clear,](https://jamesclear.com/atomic-habits) has a great diagram titled "The Power of Tiny Gains." It's a simple diagram. It shows the difference between a 1% _improvement_ and 1% _decline_ every day. 
...
![Image](https://www.freecodecamp.org/news/content/images/2020/05/Screen-Shot-2020-05-29-at-10.10.23-AM.png)
...
A better way to ask for help is to think of it like a [Mad Lib](https://en.wikipedia.org/wiki/Mad_Libs)™ (if you remember those):
...
_Sometimes pasting the whole error message works_
...
_Too much project-specific info returns no results_
...
_The underlying generic error_
...
Have you ever written an email or a text message describing a problem you have to someone, and right before you hit send you realize the solution? In the software world there's a phrase for this—[_rubber duck debugging_](https://en.wikipedia.org/wiki/Rubber_duck_debugging):
...
_Don't waste time on the impossible!_
