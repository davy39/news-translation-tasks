---
title: Vim Key Bindings – Vim Keys List Reference
subtitle: ''
author: Sahil
co_authors: []
series: null
...
Understanding Vim key bindings is crucial for navigating and editing text efficiently in Vim or Vim-based text editors like Neovim. 

In this article, we'll explore the most common Vim key bindings that will help you navigate your text editor seamlessly.

## Table of Content

* [Vim Modes](#heading-vim-modes)
* [How to Navigate using Vim Key Bindings](#heading-how-to-navigate-using-vim-key-bindings)
* [How to Edit Text in Normal Mode](#heading-how-to-edit-text-in-normal-mode)
* [Insert Mode](#heading-insert-mode)
* [Visual Mode](#heading-visual-mode)
* [More Navigation Commands](#heading-more-navigation-commands)
* [Programming Specific Key Bindings](#heading-programming-specific-vim-key-bindings)
