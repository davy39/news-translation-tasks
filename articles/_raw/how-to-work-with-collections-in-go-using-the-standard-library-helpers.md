...
In a previous article—[Arrays, Slices, and Maps in Go: a Quick Guide to Collection Types](https://www.freecodecamp.org/news/arrays-slices-and-maps-in-go-a-quick-guide-to-collection-types/)—we explored Go's three built-in collection types and how they work under the hood. That gave us the foundation for storing and accessing data efficiently.
...
* [Sorting & Searching Collections](#heading-sorting-amp-searching-collections)
    ...
    * [Sorting with sort](#heading-sorting-with-sort)
        
    * [Searching with](#heading-searching-with-sortsearch) [sort.Search](http://sort.Search)
        
    * [Sorting and Searching with slices](#heading-sorting-and-searching-with-slices)
        
    * [Practical Example: Sorting a Leaderboard](#heading-practical-example-sorting-a-leaderboard)
        
    * [Key Takeaways](#heading-key-takeaways)
        
* [Collection Helpers: slices & maps](#heading-collection-helpers-slices-amp-maps)
    
    * [Slice Helpers](#heading-slice-helpers)
        
    * [Practical Example: Filtering a Slice](#heading-practical-example-filtering-a-slice)
        
    * [Map Helpers](#heading-map-helpers)
        
    * [Practical Example: Combining Slices & Maps](#heading-practical-example-combining-slices-amp-maps)
        
    * [Performance Notes](#heading-performance-notes)
...
* ["Classical" Data Structures with container/\*](#heading-classical-data-structures-with-container)
    ...
    * [Doubly Linked Lists with container/list](#heading-doubly-linked-lists-with-containerlist)
        
    * [Priority Queues with container/heap](#heading-priority-queues-with-containerheap)
        
    * [Circular Buffers with container/ring](#heading-circular-buffers-with-containerring)
        
    * [Trade-offs compared to slices/maps](#heading-trade-offs-compared-to-slicesmaps)
        
    * [Key Takeaways](#heading-key-takeaways-2)
        
* [Specialized Utilities](#heading-specialized-utilities)
    
    * [Strings and Bytes as Collections](#heading-strings-and-bytes-as-collections)
        
    * [Reflection-Based Utilities](#heading-reflection-based-utilities)
        
    * [Key Takeaways](#heading-key-takeaways-3)
        
* [Case Study: A Simple Job Scheduler](#heading-case-study-a-simple-job-scheduler)
    
    * [Defining the Job Type](#heading-defining-the-job-type)
        
    * [Storing Jobs in a Map](#heading-storing-jobs-in-a-map)
        
    * [Snapshot Report with Slices](#heading-snapshot-report-with-slices)
        
    * [Priority Queue for Scheduling](#heading-priority-queue-for-scheduling)
        
    * [Putting It All Together](#heading-putting-it-all-together)
        
    * [Practice Challenge](#heading-practice-challenge)
        
* [Conclusion](#heading-conclusion)
    
* [Practice Challenge Solution](#heading-practice-challenge-solution)
...
* Have read the previous [article](https://www.freecodecamp.org/news/arrays-slices-and-maps-in-go-a-quick-guide-to-collection-types/) on arrays, slices, and maps, or already understand how these core collection types work.
...
![an image showing the steps involved in a binary search](https://i.imgur.com/teSktUu.png align="center")
...
For the complete list of string functions consult the [strings package documentation](https://pkg.go.dev/strings).
...
For the complete list of byte slice functions consult the [bytes package documentation](https://pkg.go.dev/bytes).
...
Reflection is a deep topic. For more details, see the [reflect package documentation](https://pkg.go.dev/reflect).
