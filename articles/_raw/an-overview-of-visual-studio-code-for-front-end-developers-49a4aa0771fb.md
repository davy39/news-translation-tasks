...
In the [Stack Overflow 2018 Developer Survey](https://insights.stackoverflow.com/survey/2018/), VSCode was ranked as the most popular development environment with around 35% out of over 100,000 respondents saying they use it. More stunningly, this figure is around 39% in the web development field.
...
* Find installation guideline of FiraCode [here](https://github.com/tonsky/FiraCode).
...
* [**Beautify**](https://marketplace.visualstudio.com/items?itemName=HookyQR.beautify): Beautify code in place and make your code more readable
...
_The colors of ( and { are separated right?_

* [**ESLint**](https://eslint.org/): a must-have extension for React or JavaScript developers in general. ESLint is used to find problems and typos within your code, and allows you to mark that typo. It also suggests solutions.
...
* **Material Icon Theme:** provides icons based on Google’s Material Design. To activate, click _Setting => File Icon Theme => Select Material Icon Theme_
...
_It is cool to have multiple terminals built right in your code editor, isn’t it?_
