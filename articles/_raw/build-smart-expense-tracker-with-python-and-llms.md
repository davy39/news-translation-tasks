...
1. [How to set up the expense data](#heading-how-to-set-up-the-expense-data)
    
2. [How to build a basic expense tracker](#heading-how-to-build-a-basic-expense-tracker)
    
3. [How to make it smart with llms (auto-categorization)](#heading-how-to-make-it-smart-with-llms-auto-categorization)
    
4. [How to Visualize Expenses](#heading-how-to-visualize-expenses)
    
5. [How to Build a Simple Expense Tracker Streamlit Dashboard](#heading-how-to-build-a-simple-expense-tracker-streamlit-dashboard)
...
Before you can build an expense tracker, you need real transaction data. Instead of creating a CSV from scratch, let’s use a dataset from Kaggle: [*My Expenses Dat*](https://www.kaggle.com/datasets/tharunprabu/my-expenses-data)[*a* by Tharun Prabu](https://www.kaggle.com/datasets/tharunprabu/my-expenses-data).
...
* [`pd.read`](http://pd.read)`_csv("Expense_data_1.csv")`: This reads your expense dataset from a CSV file into a DataFrame.
...
![Table showing sample expense data with columns Date, Account, Category, Note, and Amount](https://cdn.hashnode.com/res/hashnode/image/upload/v1756334641937/a87e1fe8-2fa8-4b95-9732-b52ee836f7b1.jpeg align="center")
...
![Table showing sample expense data with columns Date, Category, Note, Amount, and Expense/Income.](https://cdn.hashnode.com/res/hashnode/image/upload/v1756335752749/13188d2d-b5ad-4dcf-b219-5b2f704767a1.jpeg align="center")
...
![Image showing added expense data](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456560141/93cc57ca-cfcb-4a40-892d-9657b00a5918.jpeg align="center")
...
![Table showing recent expense data with columns Date, Category, Note, Amount, and Income/Expensed Currency.](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456611837/f571b6ee-3bd0-45a8-b7cd-2d6a67f0e242.jpeg align="center")
...
![Table showing summary of expenses](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456680569/4e86263c-4b7b-4f00-80e2-d633b8c479cd.jpeg align="center")
...
![Table showing categorization of expenses](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456793309/83f686cf-658c-4456-8d21-0ca8a80e2b20.jpeg align="center")
...
![Pie chart showing percentage breakdown of expenses by category, with each slice representing spending areas like Food, Entertainment, and Transportation.](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456884383/663058d1-e9f9-428d-912d-8a16cd456235.jpeg align="center")

![Bar chart showing total expenses grouped by category, highlighting spending differences such as Food, Transportation, Entertainment, and Gift.](https://cdn.hashnode.com/res/hashnode/image/upload/v1756456902426/abbef7c3-0575-45a1-8a67-f9d06f2948fd.jpeg align="center")
...
![Image showing how to run your Streamlit app](https://cdn.hashnode.com/res/hashnode/image/upload/v1756468770764/8ab43931-cd37-4791-826f-2ec47bb8dd4b.jpeg align="center")

Output:

![Image of the Streamlit expense tracker app showing an input form with fields for Date, Description, Amount, and auto-predicted Category, followed by a table of recorded expenses, and charts displaying spending breakdown by category.](https://cdn.hashnode.com/res/hashnode/image/upload/v1756458330622/83081c5e-4be7-4dc6-a32c-02a5cf78371a.jpeg align="center")
