...
You should also have basic knowledge of NLP such as text preprocessing and text representation techniques. You can learn more [here](https://www.freecodecamp.org/news/natural-language-processing-techniques-for-beginners/).

You can also [fork the repo](https://github.com/ibrahim-ogunbiyi/Semantic_Matching) which contains all the code in this article so you can follow along.
...
![The PDF we're working with here](https://cdn.hashnode.com/res/hashnode/image/upload/v1736408224052/2e6dacef-ef92-4113-a574-ec355e99e6f6.png align="center")
