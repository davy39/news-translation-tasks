...
1. [What is Incremental Static Regeneration (ISR)](#heading-what-is-incremental-static-regeneration-isr)
    
2. [How ISR Works Behind the Scenes](#heading-how-isr-works-behind-the-scenes)
    
3. [When Does ISR Trigger a New Page Generation?](#heading-when-does-isr-trigger-a-new-page-generation)
    
4. [Common Use Cases for ISR](#heading-common-use-cases-for-isr)
    
5. [Best Practices for Using ISR](#heading-best-practices-for-using-isr)
    
6. [Potential Pitfalls and How to Avoid Them](#heading-potential-pitfalls-and-how-to-avoid-them)
    
7. [Advanced Tips: On-Demand ISR](#heading-advanced-tips-on-demand-isr)
