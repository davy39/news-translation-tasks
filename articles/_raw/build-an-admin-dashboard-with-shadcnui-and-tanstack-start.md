...
![TanStack Start dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1764155564957/eda17d57-3f13-4526-be89-be55ec27453c.png align="center")

## Table of Contents

1. [Why TanStack Start?](#heading-why-tanstack-start)
    
2. [Why shadcn/ui?](#heading-why-shadcnui)
...
3. [How to Build the Admin Dashboard Using shadcn/ui and TanStack Start](#heading-how-to-build-the-admin-dashboard-using-shadcnui-and-tanstack-start)
    ...
    * [1\. Create a new TanStack app](#heading-1-create-a-new-tanstack-app)
        
    * [2\. Initial Cleanup](#heading-2-initial-cleanup)
        
    * [3\. Setting Up shadcn/studio Blocks](#heading-3-setting-up-shadcnstudio-blocks)
        
    * [4\. Routing Structure for the Dashboard](#heading-4-routing-structure-for-the-dashboard)
        
    * [5\. Creating the /dashboard Layout](#heading-5-creating-the-dashboard-layout)
        
    * [6\. Building the Dashboard Home Page](#heading-6-building-the-dashboard-home-page)
        
    * [7\. Set up the Products Page.](#heading-7-set-up-the-products-page)
        
    * [8\. Settings Page](#heading-8-settings-page)
...
[TanStack Start](https://tanstack.com/start/latest) is a modern full-stack React framework built on top of TanStack Router. It aims to be a flexible, type-safe alternative to traditional meta-frameworks like Next.js.
...
[shadcn/ui](https://ui.shadcn.com/) is a collection of beautifully designed, accessible React components built on top of Radix UI and styled with Tailwind CSS.
...
1. Remove the demo folder inside the `src/routes` directory (or wherever your router directory lives).
    
2. Delete `Header.tsx` from `src/components`.
    
3. Remove the `Header` import and usage from `src/routes/__root.tsx`.
    
4. Clean up the `src/routes/index.tsx` file to something minimal (or leave a simple landing page).
...
[shadcn/studio](https://shadcnstudio.com) is an open-source collection of copy-and-paste shadcn/ui components, blocks, and templates. It’s paired with a powerful shadcn theme generator to help you craft, customize, and ship faster.

#### What is Shadcn Registry?

A shadcn registry is a system for sharing and distributing reusable code assets such as UI components, hooks, and theme configurations across different projects. Running your own registry allows you to publish your custom components that others can then use. The registry uses a `registry.json` file to define and organize the components and their associated files. 

If you want to know more about registries, you can refer to the [official documentation here](https://ui.shadcn.com/docs/registry).

For quick building, we will use shadcn/studio’s free shadcn block – dashboard shell.

First, configure the registries in your `components.json`:
...
If you face any issues while setting up, you can refer to the [docs](https://shadcnstudio.com/docs/getting-started/how-to-use-shadcn-cli).

#### Install the Dashboard Shell Block

To get started, visit [Shadcn blocks](https://shadcnstudio.com/blocks) and navigate to the Dashboard and App section. Then select the [Dashboard Shell 1](https://shadcnstudio.com/blocks/dashboard-and-application/dashboard-shell#dashboard-shell-1) block (it’s free to use).

On the top-right, you’ll see a command to install the block into your project:

![shadcn/stuidio dashboard shell ](https://cdn.hashnode.com/res/hashnode/image/upload/v1764155098742/23d1bee2-e082-4b19-860a-8112fe6bf41c.png align="center")
...
* `src/routes/dashboard/index.tsx` – main dashboard overview
    
* `src/routes/dashboard/products.tsx` – products table page
...
This will set up the layout for the dashboard. Create `src/routes/dashboard.tsx` and paste:
...
For more details regarding the Sidebar component, you can [refer to the official docs here](https://ui.shadcn.com/docs/components/sidebar).
...
![tanstack start dashboard demo](https://cdn.hashnode.com/res/hashnode/image/upload/v1764747793227/ca1c0e10-e295-45c4-8e3c-15702583c887.jpeg align="center")
...
We will need to store our mock products’ data somewhere. For that, we will create a new file `data/products.ts` and paste the code below. This will help us mock the product data for our products table.
...
Once the data is done, let’s create a table in `/dashboard/products.tsx`. This table will use our mock product data and will provide multiple functions in the table, like search, sort, and filter. This table demonstrates the powerful combination of TanStack Query for data management and TanStack Table for rendering.

Paste the code below in the `products.tsx` file:
...
![tanstack start dashboard demo](https://cdn.hashnode.com/res/hashnode/image/upload/v1764748681745/6f73dc04-ac9a-4f75-a1ab-88ed1fc5c6f3.jpeg align="center")
...
The `useQuery` hook manages data fetching in our application. For more details, you can [refer to the official docs here](https://tanstack.com/query/latest).
...
* GitHub Repository: [https://github.com/themeselection/tanstack-dashboard-demo](https://github.com/themeselection/tanstack-dashboard-demo)
    
* Live Demo: [https://tanstack-dashboard-demo.vercel.app/dashboard](https://tanstack-dashboard-demo.vercel.app/dashboard)
