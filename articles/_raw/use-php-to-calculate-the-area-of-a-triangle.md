...
2. [Find the Area of a Triangle Using Direct Formulas](#heading-find-the-area-of-a-triangle-using-direct-formulas)
    
3. [Find the Area of a Triangle Using the Base and Height Approach](#heading-find-the-area-of-a-triangle-using-the-base-and-height-approach)
    
4. [Find the Area of a Triangle Using Heron's Formula](#heading-find-the-area-of-a-triangle-using-herons-formula)
    
5. [Find the Area of a Triangle Using Two Sides and Included Angle (Trigonometric Formula)](#heading-find-the-area-of-a-triangle-using-two-sides-and-included-angle-trigonometric-formula)
...
First, we define the three sides of the triangle. Then, we check all three conditions of the [Triangle Inequality Theorem](https://en.wikipedia.org/wiki/Triangle_inequality) which states that if the sum of two sides is greater than the third side, then it is a valid triangle, and the given sides can form a triangle.
