...
* For the parameters `radius = 10` and`PI = 3.14`, we will always have the same the result: `314.0`
* For the parameters `radius = 10` and`PI = 42`, we will always have the same the result: `4200`
...
With this concept, a cool thing we can do is to [memoize](https://en.wikipedia.org/wiki/Memoization) the function. Imagine we have this function:
