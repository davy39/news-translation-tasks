...
4. [Step 2: Design the Data Model](#heading-step-2-design-the-data-model)
    ...
    * [Add Methods to the TrackerData](#heading-add-methods-to-the-trackerdata)
        
5. [Step 3: Handle Errors Properly](#heading-step-3-handle-errors-properly)
    
    * [Map System Errors to Custom Errors](#heading-map-system-errors-to-custom-errors)
        
    * [Prepare for Error Output](#heading-prepare-for-error-output)
        
6. [Step 4: Create File Operations](#heading-step-4-create-file-operations)
    
    * [Add JSON Utility Functions](#heading-add-json-utility-functions)
        
    * [Register the Utilities](#heading-register-the-utilities)
        
7. [Step 5: Set Up the CLI Structure](#heading-step-5-set-up-the-cli-structure)
    
    * [The Command Architecture](#heading-the-command-architecture)
        
    * [Manage Paths with Global Context](#heading-manage-paths-with-global-context)
        
    * [Register the Command System](#heading-register-the-command-system)
        
8. [Step 6: Create Response Types](#heading-step-6-create-response-types)
    
    * [Define the Response Structures](#heading-define-the-response-structures)
        
    * [Implement the Output Module](#heading-implement-the-output-module)
        
    * [Update the Library Registration](#heading-update-the-library-registration)
        
9. [Step 7: Create Argument Parsing Helpers](#heading-step-7-create-argument-parsing-helpers)
    
    * [Implement Custom Data Parsers](#heading-implement-custom-data-parsers)
...
15. [Step 13: Implement Subcategory Commands](#heading-step-13-implement-subcategory-commands)
    ...
    * [List Subcategories](#heading-list-subcategories)
        
    * [Add Subcategories](#heading-add-subcategories)
        
    * [Delete Subcategories](#heading-delete-subcategories)
        
    * [Rename Subcategories](#heading-rename-subcategories)
...
18. [Test Your Application](#heading-test-your-application)
    ...
    * [Install the Binary](#heading-install-the-binary)
        
19. [What's Next and Advanced Features](#heading-whats-next-and-advanced-features)
    
    * [Advanced Features to Explore](#heading-advanced-features-to-explore)
...
You can find the complete implementation of `fintrack` with all features, including advanced output formatting, export functionality, and more, in the [GitHub repository](https://github.com/steph-crown/fintrack). The repository also includes installation instructions for downloading the binary or installing via Cargo.
