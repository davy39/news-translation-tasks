...
co_authors: []
series: null
date: '2018-03-03T11:46:48.000Z'
originalURL: https://freecodecamp.org/news/some-reflections-on-my-side-projects-first-anniversary-f1d78bdd2793
coverImage: https://cdn-media-1.freecodecamp.org/images/1*N-beU62Spgxjvp47yGJ9Hg.jpeg
tags:
...
seo_desc: 'By Will Abramson
  ...
  Basically, a side project is something you do on the side — or so I thought. It’s
  a project that you are self-motivated, rather than contracted, to wor...'
---
...
![Image](https://cdn-media-1.freecodecamp.org/images/7svkd8WiU44QnpTFoIdeK1dyHwfYRpQZ3yBU)
_My live application!_
...
* [Redux](https://redux.js.org/docs/introduction/): A state management library that combines perfectly with React.
* [GraphQL](http://graphql.org/): A data query language billed as the new REST.
* [ApolloClient](https://www.apollographql.com/docs/react/): A GraphQL client that makes it easy to build UI components that fetch data using GraphQL. Again, this goes really well with React.
...
![Image](https://cdn-media-1.freecodecamp.org/images/1AMLXxCFRbN1ok27k6wOHMxvybOtiJzaNnqO)
...
![Image](https://cdn-media-1.freecodecamp.org/images/HIsIHuaaGIeFyud6Hn1AvFaciCgiauOY01wA)
...
![Image](https://cdn-media-1.freecodecamp.org/images/xFc2xig0hC9So0GOHAqtUHz60QEqYIjgT3D4)
...
![Image](https://cdn-media-1.freecodecamp.org/images/N4xx-eWas2lcQ35rdyFQ8etGnfLEfM5lQUEQ)
_Anyone can be!_
...
![Image](https://cdn-media-1.freecodecamp.org/images/jQTOB2mty26uBnMoGCW1NHdXwyDbOLuy7E5O)
_Baby steps_
...
You can view my recently deployed side project [here](http://thecommunitymind.com) and view its source code in [GitHub](https://github.com/wip-abramson/TheCommunityMind). It still has a long way to go and I welcome advice, comments or contributions.
