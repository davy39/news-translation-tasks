...
About a year ago, I changed [my website](https://learnitmyway.com/) from Wordpress to [Hugo](http://gohugo.io/), which is a static site generator written in Go that uses Go’s template libraries for templating. I have recently done a viability assessment of [Gatsby](https://www.gatsbyjs.org/), another static site generator written in React that uses React for templating.

In this article, I compare the differences between Hugo v0.42 and Gatsby v1.93. For the comparison, I used [this Hugo site](https://learnitmyway-hugo.netlify.com/) and [this Gatsby site](http://learnitmyway-gatsby.netlify.com/). The code for each can be found on Github for [the Hugo site](https://github.com/DeveloperDavo/learnitmyway/tree/gatsby-vs-hugo) and for [the Gatsby site](https://github.com/DeveloperDavo/learnitmyway-gatsby).
...
One way of assessing stability would be to compare [Hugo’s issues on GitHub](https://github.com/gohugoio/hugo/issues) with [Gatsby’s issues on GitHub](https://github.com/gatsbyjs/gatsby/issues). You will see that Gatsby has more features, (which is exciting) but also has more bugs (which is not so exciting). I initially did not consider stability as a criteria until I found [this bug](https://github.com/gatsbyjs/gatsby/issues/6392) and that made me realise the importance of stability in software. I may be taking this one personally because of the time and effort I expended, trying to find that bug, but I still think Hugo is more stable than Gatsby.

#### Security

Gatsby uses JavaScript, and JavaScript applications are notorious for requiring a lot of Node modules to run. There is even a Node module that [sends Hot Pocket tweets](https://medium.com/@jdan/i-peeked-into-my-node-modules-directory-and-you-wont-believe-what-happened-next-b89f63d21558) and another that [harvests credit card numbers](https://hackernoon.com/im-harvesting-credit-card-numbers-and-passwords-from-your-site-here-s-how-9a8cb347c5b5) :D. Static sites tend to be more secure by nature, but I still think it is worth mentioning that more dependencies result in more code that you might not trust.
...
On the other hand, some things that require a plugin with Gatsby just come out of the box with Hugo. For example, [gatsby-plugin-react-helmet](https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-plugin-react-helmet) is needed to edit the head tag, whereas this can be done with simple HTML in Hugo. Since I enjoyed using the tooling that came with Gatsby, I give this one to Gatsby.
...
Both Gatsby and Hugo have really nice documentation. Hugo has a [Quick Start](https://gohugo.io/getting-started/quick-start/) and Gatsby has a [Getting Started](https://www.gatsbyjs.org/docs/) section. Gatsby also has a really nice [tutorial](https://www.gatsbyjs.org/tutorial/), which evens out the steeper learning curve. Personally, I found it easier to get started with Gatsby, but that is because I already understood React. I think it is fair to say that both Hugo and Gatsby have great documentation.
...
**Before you go…** Thanks for reading the article! I write about my professional and educational experiences as a self-taught software developer, so check out [my blog](https://www.learnitmyway.com/) or subscribe to [my newsletter](https://learnitmyway.com/newsletter) for more content.

**You might also like:**

* [How I release updates to my personal website](https://learnitmyway.com/how-i-release-updates-to-my-personal-website/)
* [Learning material — software development](https://www.learnitmyway.com/2016/11/11/learning-material-software-development/) (a list of learning resources, starting with Introduction to Computer Science)
* [Is full-stack web development worth learning?](https://learnitmyway.com/opinion-full-stack/)
