...
co_authors: []
series: null
date: '2017-12-19T06:03:05.000Z'
originalURL: https://freecodecamp.org/news/why-side-projects-are-so-damn-important-239ba37209e
coverImage: https://cdn-media-1.freecodecamp.org/images/1*XWCrOtVijQ8gqcEWKuWMBA.jpeg
tags:
...
seo_desc: 'By Jake Prins
  ...
  Trello, Craigslist, Unsplash, AppSumo, Twitter, Gmail… what do all these successful
  companies have in common?

  Yes, they can all trace their humble beginnings back to being something we might
  call a ‘side project’.
...
I’m still working hard on improvements (because when will a project ever be finished?), but in case you’re interested you can check it out [here](http://www.raterfox.com). (BTW, any feedback is welcome and highly appreciated! Contact me: jake@raterfox.com).

![Image](https://cdn-media-1.freecodecamp.org/images/h1a-AUOkVLWkoWxoRFaIzGAhOurzILYoXuuf)
_My side project: [RaterFox](http://www.raterfox.com" rel="noopener" target="_blank" title=")_
...
> _“More people cared about us in a few hours than in the entire last year.”_
...
Thanks for reading! Hope the information was helpfull. Follow me on Medium for more articles or on Twitter and Instagram [@jakeprins_nl](https://twitter.com/jakeprins_nl).
