...
* [1\. Write Code Like You’re Explaining it to a 5-Year Old](#heading-1-write-code-like-youre-explaining-it-to-a-5-year-old)
    
* [2\. Use AI Tools (or an AI Code Reviewer)](#heading-2-use-ai-tools-or-an-ai-code-reviewer)
    
* [3\. Get Rid of Unnecessary Comments](#heading-3-get-rid-of-unnecessary-comments)
    
* [4\. Follow the DRY Principle](#heading-4-follow-the-dry-principle)
    
* [5\. Fix Your Code Formatting & Follow a Consistent Style](#heading-5-fix-your-code-formatting-amp-follow-a-consistent-style)
    
* [6\. Don’t Let Your Functions Do Too Much](#heading-6-dont-let-your-functions-do-too-much)
    
* [7\. Organize Your Files and Folders Properly](#heading-7-organize-your-files-and-folders-properly)
...
Well, as a developer, you can use AI to help you write clean and readable code — all thanks to AI tools like [ChatGPT](https://chatgpt.com/), [Claude](https://claude.ai/), and [GitHub Copilot](https://github.com/features/copilot).
...
Along with that, you can also use AI-powered code reviewers like [CodeRabbit AI](https://www.coderabbit.ai/), which integrates with your pull requests to offer automated code reviews, walkthroughs, and more.
...
Here’s an example from an open-source repository “[minefield](https://github.com/bitbomdev/minefield/pull/158)” of a summary generated by CodeRabbit AI:
...
If you want to learn more, [here’s](https://docs.coderabbit.ai/getting-started/quickstart/) a quickstart guide that provides more info on how to get started and use CodeRabbit AI.
...
You can just install a VS Code extension/linters like [Prettier](https://prettier.io/), [ESLint](https://eslint.org/), or [Flake8](https://pypi.org/project/flake8/), depending on the programming language you use. Configure a few settings, and you’re good to go.
...
Well, it uses several different naming conventions – like `total_price` uses snake\_case, `UserData` uses PascalCase, and `getuser()` is in lowercase instead of camelCase.
...
You can connect with me on [Substack](https://substack.com/@nitinfab), and [Twitter](https://x.com/Nitinfab).

Also, if you're interested in learning more about AI, you can subscribe to my newsletter, [AI Made Simple](https://aimadesimple0.substack.com/), where I dive deeper into practical AI strategies for everyday people.
