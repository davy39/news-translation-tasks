...
[Previously](https://www.freecodecamp.org/news/10-js-util-functions-in-reduce/) I wrote about 10 utility functions implemented with JavaScript's [reduce function](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce). It was well-received, and I walked away with an even deeper appreciation for this magnificent multi-tool. Why not try 10 more?
...
For more detail, I wrote an [article on compose here](https://www.yazeedb.com/posts/a-quick-intro-to-pipe-and-compose).
