...
That means [understanding the domain that you're working in](https://khalilstemmler.com/articles/solid-principles/single-responsibility/).
...
Acting as a facade, maintaining readonly values, enforcing model expressiveness, encapsulating collections, AND [creating domain events](https://khalilstemmler.com/blogs/domain-driven-design/where-do-domain-events-get-dispatched/) are some very solid use cases for getters and setters in [Domain-Driven Design](https://khalilstemmler.com/articles/domain-driven-design-intro/).
