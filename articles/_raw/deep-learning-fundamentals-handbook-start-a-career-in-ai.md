---
title: Deep Learning Fundamentals Handbook – What You Need to Know to Start Your Career
  in AI
subtitle: ''
...
1. [Chapter 1: What is Deep Learning?](#heading-chapter-1-what-is-deep-learning)
    
2. [Chapter 2: Foundations of Neural Networks](#heading-chapter-2-foundations-of-neural-networks)  
    – Architecture of Neural Networks  
    – Activation Functions
    
3. [Chapter 3: How to Train Neural Networks](#chapter-4-how-to-train-neural-networks)  
    – Forward Pass - math derivation  
    – Backward Pass - math derivation
    
4. [Chapter 4: Optimization Algorithms in AI](#chapter-5-optimization-algorithms-in-ai)  
...
5. [Chapter 5: Regularization and Generalization](#chapter-6-regularization-and-generalization)  
    – Dropout  
    – Ridge Regularization (L2 Regularization)  
    – Lasso Regularization (L1 Regularization)  
    – Batch Normalization
    
6. [Chapter 6: Vanishing Gradient Problem](#chapter-7-vanishing-gradient-problem)  
    – Use appropriate activation functions  
    – Use Xavier or He Initialization  
    – Perform Batch Normalization  
    – Adding Residual Connections
    
7. [Chapter 7: Exploding Gradient Problem](#chapter-8-combatting-exploding-gradients)
    
8. [Chapter 8: Sequence Modeling with RNNs & LSTMs](#heading-chapter-8-sequence-modeling-with-rnns-amp-lstms)  
...
9. [Chapter 9: Deep Learning Interview Preparation](#heading-chapter-9-deep-learning-interview-preparation)  
...
Understanding the core principles of machine learning is crucial. If you're not yet familiar with these, I recommend checking out my [Fundamentals of Machine Learning Handbook](https://www.freecodecamp.org/news/machine-learning-handbook/), where I've laid out all the necessary groundwork. Also, my [Fundamentals of Machine Learning](https://lunartech.ai/course-overview/) course offers comprehensive teaching on these principles.

### 2\. Fundamentals of Statistics

Statistics play a vital role in making sense of data patterns and inferences in machine learning. For those who need to brush up on this, my [Fundamentals of Statistics](https://lunartech.ai/course-overview/) course is a another resource where I cover all the essential statistical concepts you'll need.

### 3\. Linear Algebra and Differential Theory

A [high level understanding of linear algebra](https://www.freecodecamp.org/news/linear-algebra-full-course/) and [differential theory](https://en.wikipedia.org/wiki/Differential_\(mathematics\)) is also important. We'll cover some aspects, such as differentiation rules, in this handbook. We'll go over matrix multiplication, matrix and vector operations, normalization concepts, and the basics of differentiation theory.

But I encourage you to strengthen your understanding in these areas. More on this content you can find on freeCodeCamp when searching for "Linear Algebra" like this course "[Full Linear Algebra Course](https://youtu.be/LwCRRUa8yTU?si=DEeXlC9_d1Ct9eAF)".
...
*Exploring the Layers of AI: From Artificial Intelligence to Deep Learning. (Image Source:* [*LunarTech.ai*](https://lunartech.ai)*)*
...
In simpler terms, Deep Learning is more advanced and more complex version of traditional Machine Learning. Deep Learning Models are based on [Neural Networks](https://www.freecodecamp.org/news/learn-machine-learning-and-neural-networks-without-frameworks/) and they try to mimic the way humans think and make decisions.
...
*AI Hierarchy: Navigating from Broad AI Concepts to Specialized Language Models (Image Source:* [*Medium*](https://medium.com/womenintechnology/ai-c3412c5aa0ac)*)*
...
*Simple Neural Network Architecture: Inputs, Weights, and Outputs Explained (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Simple Neural Network Architecture Highlighting the Input Layers (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Simple Neural Network Architecture Highlighting the Hidden Layer (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Simple Neural Network Architecture Highlighting the Output (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
[Activation functions](https://en.wikipedia.org/wiki/Activation_function) introduce non-linear properties to the neural network model, which enables the model to learn more complex patterns.

Without non-linearity, your deep network would behave just like a single-layer [perceptron](https://www.freecodecamp.org/news/the-history-of-ai/#the-perceptron), which can only learn [linear separable functions](https://en.wikipedia.org/wiki/Linear_separability). Activation functions define how the neurons should be activated – hence the name activation function.
...
*Neuron Activation: Transforming Weighted Inputs into Outputs (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Linear Activation Function (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Sigmoid Activation Function (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*ReLU Activation Function (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Leaky ReLU Activation Function (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Tanh Activation Function (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
Note - if you want to get more details about these activation functions, check out this tutorial where I cover this concept in further detail at ["What is an Activation Function"](https://www.youtube.com/watch?v=03-0UdyzWg4) and ["How to Solve the Vanishing Gradient Problem"](https://www.youtube.com/watch?v=HEeOBaFNXV4).
...
*From Input Layer through Hidden Layers to Prediction (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Forward and Backward Propagation in Neural Networks (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
If you want to learn more about Loss Functions, check out [here](https://en.wikipedia.org/wiki/Loss_function) or this [tutorial](https://www.youtube.com/watch?v=1I-3Tdk2-Hg).
...
*Matrix Operations in Neural Network Computations (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Sequential Data Flow Through Neural Network Layers (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
*Backpropagation Process in Neural Networks: Calculating Gradients (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
* ∇\_J\_(*θ*) is the gradient of the cost function *J* with respect to the parameter θ. It indicates the direction and magnitude of the steepest increase of *J*. By subtracting this from the current parameter value (multiplied by the learning rate), we adjust *θ* in the direction of the steepest decrease of *J*.
...
You can learn more in this [Gradient Descent Interview Tutorial](https://youtu.be/rOI2GuwjJSY).
...
In SGD, all model parameters are improved in each iteration step with only one training sample or a mini-batch. So, instead of going through all training samples at once to modify model parameters, the SGD algorithm improves parameters by looking at a single and **randomly** sampled training set (hence the name [**Stochastic**](https://www.merriam-webster.com/dictionary/stochastic), which means "involoving chance or probability").
...
For more details on SGD, you can check out this [tutorial](https://youtu.be/hqrI5OPtGOI).
...
* \_vt\_​ is the running average of the squared gradients.
...
* \_gt\_​ is the gradient at time step *t*, and \_θt\_​ is parameter vector at time step *t*.
...
* \_mt\_​ and *vt* are estimates of the first moment (the mean) and the second moment (the uncentered variance) of the gradients, respectively.
    
* *m\_hat* and v\_hat are bias-corrected versions of these estimates.
    
* \_β\_1​ and \_β\_2​ are the exponential decay rates for these moment estimates (usually set to 0.9 & 0.999, respectively).
...
If you want to see the actual mathematical representation where I am comparing Adam and AdamW, you can check out this [**Tutorial on YouTube**](https://youtu.be/0HJ4iUQWHVI).
...
* *rj*(*l*)​ is a random variable that follows Bernoulli distribution, where the probability of not being dropped out (success: 1) is 1−\_p\_.
...
**Testing Adjustment:** During testing process, the dropout is not applied. Instead, the activations are scaled down by a factor of *p* to account for the effect of dropout during training process. This is necessary because during training, on average, each unit is only active with probability 1−\_p\_.
...
If you want to learn more details about L1/L2 regularisation make sure to check this [video](https://youtu.be/NAfOLSOsyJI) and this [tutorial](https://www.youtube.com/watch?v=TDwpx-9M2IE) to see how these regularization techniques penalize the weights in neural network which are part of my free [Deep Learning Interview Preparation Course](https://youtu.be/Lf8XNN3-8nI).
...
*Batch Normalization:* [*Image Source*](https://images.app.goo.gl/TTG1B2reRZszz5c16)
...
* \_μ\_beta\_​ is the mean of the mini-batch
    
* *m* is the number of training examples in mini-batch, and
    
* \_xi\_​ is the activation of the current layer before batch normalization.
...
* *x*^\_i\_​ is the normalized activation
...
* \_n\_\_in​ is the number of neurons feeding into the layer
    
* \_n\_\_out​ is the number of neurons the results are fed into (that is, number of neurons in the next layer)
...
*Gradient Clipping (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
For intuitive and detailed explanation, check out this tutorial-interview answer on [Residual Connections](https://www.youtube.com/watch?v=bF7dUSepiLg).
...
* **Step 2: Scaling gradient**: If the norm of this gradient ∥\_g\_∥ is larger than a specified threshold *c*, we scale down gradient *g* to have the norm *c*, maintaining its direction. This is done by setting *g* to *c\_⋅\_g*/∥\_g\_∥
...
*RNN architecture (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
* *W\_xh* is the input-to-hidden weight matrix
    
* *W\_hh* is the hidden-to-hidden weight matrix
    
* *h\_0* is the initial hidden state (previous)
    
* *b\_h* is the hidden layer bias
    

*W\_hh* is often referred to as the **recurrent weight matrix**. This is the matrix that defines how much each of those previous hidden states will contribute to the computation of the present hidden state.
...
* \_W\_hy\_​ is the weight matrix from hidden to output layer
    
* \_b\_y\_​ is the bias for the output layer
...
*LSTM Architecture (Image Source:* [*LunarTech.ai*](https://lunartech.ai/course-overview/)*)*
...
**Cell States:** At the top row, we have rectangles in yellow labeled C\_(*t−1)*, *C*(t)​\_, … *C*(t+1)\_​. These represent the cell states of LSTM at consecutive time steps.
...
* **Output Gate (Purple):** Determines what part of the cell state will be used to generate the output hidden state \_h\_t\_​.
...
And those are just few topics that you can expect for your more advanced/FAANG interviews. Check out the full list of 100 Questions from this curriculum of [**here**](https://www.freecodecamp.org/news/ghost/#/editor/post/6548108b21405e03f5049361).
...
1. [Part 1 – The Essentials (Free 4-Hour Course)](https://courses.lunartech.ai/courses/deep-learning-interview-preparation-course-100-q-a-s): I believe in empowering every Data Science AI enthusiast. So I'm offering the first part of my interview course absolutely free. This section includes first set of 50 interview questions that cover the breadth of deep learning fundamentals.
    
2. [**Complete Course**](https://courses.lunartech.ai/courses/deep-learning-interview-preparation-course-100-q-a-s) **-** [**\[Full Deep Learning Interview Prep Course - 100 Q&A 7.5 hours \]**](https://courses.lunartech.ai/courses/deep-learning-interview-preparation-course-100-q-a-s)**:** For those who are determined to leave no stone unturned, our full course on LunarTech.ai is the ultimate preparation tool for easy but also complex Deep Learning interviews. Expanding to 100 in-depth interview questions, this comprehensive course delves into the nuances of deep learning, ensuring that you stand out in even the most demanding interviews, including companies like FAANG.
...
I am Tatev Aslanyan, Senior Machine Learning and AI Researcher. I have had the privilege of working in Data Science across numerous countries, including the US, UK, Canada, and the Netherlands. I am Co-founder of [**LunarTech**](https://lunartech.ai) where make Data Science and AI more accessible to everyone!
...
* Follow me on [LinkedIn](https://www.linkedin.com/in/tatev-karen-aslanyan/) and [X](https://twitter.com/tatevkaren7)
    
* Visit my [Personal Website for Free Resources](https://tatevaslanyan.com/free-resources/)
    
* Subscribe to [The Data Science and AI Newsletter](https://substack.com/@lunartech)
    

If you want to start a career in Data Science or AI, download my free [Data Science and AI Handbook](https://downloads.tatevaslanyan.com/six-figure-data-science-bootcamp--5a571) or [Fundamentals to Machine Learning Handbook](https://join.lunartech.ai/machine-learning-fundamentals)
