---
title: 'malloc in C: Dynamic Memory Allocation in C Explained'
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
Unlike other languages, C does not know the data type it is allocating memory for; it needs to be told. Luckily, C has an operator called `sizeof()` that we can use.
...
* [The beginner's handbook for C programming](https://www.freecodecamp.org/news/the-c-beginners-handbook/)
* [If...else statement in C explained](https://www.freecodecamp.org/news/if-statements-in-c/)
