...
* [How to Read This Article](#heading-how-to-read-this-article)
    
* [TypeScript Language Features](#heading-typescript-language-features)
    
    * [Objects](#heading-objects)
        
    * [Classes, Attributes, and Methods](#heading-classes-attributes-and-methods)
        
    * [Interfaces](#heading-interfaces)
        
    * [Abstract Classes](#heading-abstract-classes)
        
* [Object-Oriented Programming Principles](#heading-object-oriented-programming-principles)
    
    * [Inheritance – Superclass and Subclass](#heading-inheritance-superclass-and-subclass)
