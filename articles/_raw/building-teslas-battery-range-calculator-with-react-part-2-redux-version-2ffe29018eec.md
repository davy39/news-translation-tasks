...
? Check out the part 2 l[ive demo.](http://redux-tesla-charge-calculator.surge.sh/)
...
_**overall component UI layout**_
...
* JavaScript primitive data type(number, string, boolean, undefined, and null) =&g**t; immuta**ble
* Object, array and function =&g**t; muta**ble
