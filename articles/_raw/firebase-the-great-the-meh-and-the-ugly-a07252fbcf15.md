...
(**Edit May 2018**: Check [my review of Firebase Cloud Functions](https://medium.com/@Pier/firebase-cloud-functions-the-great-the-meh-and-the-ugly-c4562c6dc65d))
...
[**Firebase: The Good, Bad, and the Ugly - RaizException - Raizlabs Developer Blog**](https://www.raizlabs.com/dev/2016/12/firebase-case-study/)  
[_As part of our work as software developers at Raizlabs, we are constantly evaluating the latest development tools used…_www.raizlabs.com](https://www.raizlabs.com/dev/2016/12/firebase-case-study/)[**Reasons Not To Use Firebase**](https://crisp.im/blog/why-you-should-never-use-firebase-realtime-database/)  
[_Building real-time applications is today standard. At Crisp, we used Firebase in production over 9 month, starting from…_crisp.im](https://crisp.im/blog/why-you-should-never-use-firebase-realtime-database/)
