...
* [What is the separation of concerns?](#heading-what-is-the-separation-of-concerns)
* [What are presentation and container components?](#heading-what-are-container-and-presentational-components)
* [Why do we need these components?](#heading-why-do-we-need-these-components)
* [Presentation and container component example](#heading-presentation-and-container-component-example)
* [How to replace container components with React hooks](#heading-how-to-replace-container-components-with-react-hooks)
