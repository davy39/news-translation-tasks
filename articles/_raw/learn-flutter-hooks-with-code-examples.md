...
* [Why Flutter Hooks?](#heading-why-flutter-hooks)
    
* [Common Flutter Hooks](#heading-common-flutter-hooks)
    
    * [How to Use the useState Hook in Flutter](#heading-how-to-use-the-usestate-hook-in-flutter)
        
    * [How to Use the useAnimationController Hook in Flutter](#heading-how-to-use-the-useanimationcontroller-hook-in-flutter)
        
    * [How to Use the useEffect Hook in Flutter](#heading-how-to-use-the-useeffect-hook-in-flutter)
        
    * [How to Use the useMemoized Hook in Flutter](#heading-how-to-use-the-usememoized-hook-in-flutter)
        
    * [How to Use the useRef Hook in Flutter](#heading-how-to-use-the-useref-hook-in-flutter)
        
    * [How to Use the useCallback Hook in Flutter](#heading-how-to-use-the-usecallback-hook-in-flutter)
        
    * [How to Use the useContext Hook in Flutter](#heading-how-to-use-the-usecontext-hook-in-flutter)
        
    * [How to Use the useTextEditingController Hook in Flutter](#heading-how-to-use-the-usetexteditingcontroller-hook-in-flutter)
        
* [How to Create a Custom Hook in Flutter](#heading-how-to-create-a-custom-hook-in-flutter)
    
* [Advanced Hooks](#heading-advanced-hooks)
    
* [Demonstration: Counter Example with Hooks](#heading-demonstration-counter-example-with-hooks)
    
* [Best Practices](#heading-best-practices)
    
* [Hooks vs Stateful Widgets](#heading-hooks-vs-stateful-widgets)
...
* [flutter\_hooks package on pub.dev](https://pub.dev/packages/flutter_hooks)
