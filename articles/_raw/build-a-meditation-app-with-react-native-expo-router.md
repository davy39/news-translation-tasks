...
co_authors: []
series: null
date: '2024-07-03T16:00:29.026Z'
originalURL: https://freecodecamp.org/news/build-a-meditation-app-with-react-native-expo-router
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1720022414585/f0f87e6e-c5b4-4ea3-8ccb-d56c14e2d94f.jpeg
tags:
- name: React Native
  slug: react-native
- name: youtube
  slug: youtube
seo_title: null
seo_desc: Are you looking to enhance your React Native skills while creating a practical
  and soothing application? This new course from freeCodeCamp.org is perfect for you!
  You'll learn how to build a meditation app using Expo, an open-source platform for
  maki...
---

Are you looking to enhance your React Native skills while creating a practical and soothing application? This new course from [freeCodeCamp.org](http://freeCodeCamp.org) is perfect for you! You'll learn how to build a meditation app using Expo, an open-source platform for making universal native apps for Android, iOS, and the web with JavaScript and React. Throughout the course, you'll leverage TypeScript, React, NativeWind, and other powerful tools to develop a simple yet functional mobile app that promotes relaxation and mindfulness.
...
Watch the full course on [the freeCodeCamp.org YouTube channel](https://youtu.be/9UKCv9T_rIo) (2-hour watch).

%[https://youtu.be/9UKCv9T_rIo]
