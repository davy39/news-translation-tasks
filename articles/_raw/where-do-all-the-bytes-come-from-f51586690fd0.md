...
_It’s not the exact original sprite sheet, but you can get a sense of the small blocks of data that can be use over-and-over again._
...
_Behold, that level that you parents could never complete._
...
_A block-view of how JPG image compression works._
...
_Since this image has lots of duplicate pixels (the blue sky background) compressors like PNG do a better job than their block-based JPG counterparts._
...
_A much better comparison. The .[kkrieger](https://en.wikipedia.org/wiki/.kkrieger" rel="noopener" target="_blank" title=") demo fit 30 minutes of a 3D shooter gameplay, with physics, sound, textures, and AI into 64kb of data. Seems like a massive amount of gain for just 24kb more than the original Mario._
