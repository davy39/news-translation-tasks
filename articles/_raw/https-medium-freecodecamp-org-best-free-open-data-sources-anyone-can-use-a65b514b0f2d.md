...
co_authors: []
series: null
date: '2019-01-10T17:28:42.000Z'
originalURL: https://freecodecamp.org/news/https-medium-freecodecamp-org-best-free-open-data-sources-anyone-can-use-a65b514b0f2d
coverImage: https://cdn-media-1.freecodecamp.org/images/1*UBez92qzGAno5MLXjnIMIw.jpeg
tags:
- name: big data
  slug: big-data
- name: Data Science
...
seo_desc: 'By Hiren Patel
  ...
  In simple terms, Open Data means the kind of data which is open for anyone and everyone
  for access, modification, reuse, and sharing.
...
In simple terms, [Open Data](https://en.wikipedia.org/wiki/Open_data) means the kind of data which is open for anyone and everyone for access, modification, reuse, and sharing.
...
[Open data is important](http://www.prowebscraper.com/blog/6-major-benefits-of-open-data/) because the world has grown increasingly data-driven. But if there are restrictions on the access and use of data, the idea of data-driven business and governance will not be materialized.
...
### 2. [**WHO (World Health Organization) — Open data repository**](https://www.who.int/gho/database/en/)
...
### 3. [**Google Public Data Explorer**](https://www.google.com/publicdata/directory)
...
### 4. [**Registry of Open Data on AWS (RODA)**](https://registry.opendata.aws/)
...
### 5. [**European Union Open Data Portal**](http://open-data.europa.eu/en/data/)
...
### 7. [**U.S. Census Bureau**](http://www.census.gov/data.html)
...
### 10. [**freeCodeCamp Open Data**](https://github.com/freeCodeCamp/open-data)
...
### 11. [**Yelp Open Datasets**](https://www.yelp.com/dataset)
...
### 12. [**UNICEF Dataset**](https://data.unicef.org/)
...
UNICEF’s open datasets published on the IATI Registry: [http://www.iatiregistry.org/publisher/unicef](http://www.iatiregistry.org/publisher/unicef) has been extracted directly from UNICEF’s operating system (VISION) and other data systems, and it reflects inputs made by individual UNICEF offices.
...
[UNICEF’s AID TRANSPARENCY PORTAL](http://open.unicef.org/) : You can far more easily access the datasets if you use this portal. It also includes details for each country that UNICEF works in.

[Publisher d-portal](http://d-portal.org/ctrack.html?publisher=41122) : It is, at the moment, in BETA. With this, portal, you can explore IATI data.
...
[Publisher’s data platform](http://open.unicef.org/) : On this platform, you can easily access statistics, charts, and metrics on data accessed via the IATI Registry. If you click on the headers, you can also sort many of the tables that you see on the platform. You will also find many of the datasets in the platforms in machine-readable JSON format.
...
The LODUM team has co-initiated [LinkedUniversities.org](http://linkeduniversities.org/) and [LinkedScience.org](http://linkedscience.org/).

You can use [SPARQL editor](http://data.uni-muenster.de/php/sparql/) or [SPARQL package](https://cran.r-project.org/web/packages/SPARQL/SPARQL.pdf) of R to analyze data.
