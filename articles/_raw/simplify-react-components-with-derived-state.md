...
2. [What Is a Derived State?](#heading-what-is-a-derived-state)
    
3. [How to Derive State From Existing Data](#heading-how-to-derive-state-from-existing-data)
    
    * [How to Derive State From Props or Other State](#heading-how-to-derive-state-from-props-or-other-state)
        
    * [How to Derive State From a URL](#heading-how-to-derive-state-from-a-url)
        
    * [How to Derive State From External Data](#heading-how-to-derive-state-from-external-data)
        
4. [How to Prevent Recalculation of a Derived State](#heading-how-to-prevent-recalculation-of-a-derived-state)
    
5. [When to Use useState](#heading-when-to-use-usestate)
    
    * [Controlled Input](#heading-controlled-input)
        
    * [Independent State Changes](#heading-independent-state-changes)
...
If you don’t have a React development setup, you can head over to the [derived-state repo](https://github.com/Olaleye-Blessing/freecodecamp-derived-states). The repo has been set up with [React Router](https://reactrouter.com/) and [React Query](https://tanstack.com/query/latest/docs/framework/react/overview). Run the commands below to set it up:
...
Note: All the code in this article is run in [non-StrictMode](https://react.dev/reference/react/StrictMode).
...
You can read more here about [how to use `useMemo` in React](https://www.freecodecamp.org/news/how-to-work-with-usememo-in-react/).
...
Because we are tracking the input value with `useState`, we can easily validate the `username` and change the border’s color. freeCodeCamp has an [article that explains what controlled inputs are.](https://www.freecodecamp.org/news/what-are-controlled-and-uncontrolled-components-in-react/)
