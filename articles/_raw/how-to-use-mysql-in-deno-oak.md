---
title: How to Use MySQL With Deno and Oak
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
I recently wrote about how to make a **[Todo API in Deno + Oak (without using a database)](https://www.freecodecamp.org/news/create-a-todo-api-in-deno-written-by-a-guy-coming-from-node/)**. You can find the repo under **[chapter_1:oak](https://github.com/adeelibr/deno-playground/tree/master/chapter_1:oak)** on GitHub. 

This tutorial picks up where the other left off, and I'll go over how to integrate MySQL into a Deno and Oak project.

If at any time you want to see the entire source code used in this tutorial, it's available at [**chapter_2:mysql**](https://github.com/adeelibr/deno-playground/tree/master/chapter_2:mysql). Feel free to give it a star on GitHub if you like it.

I'm assuming that you already completed the last tutorial mentioned above. If not, check it out [here](https://www.freecodecamp.org/news/create-a-todo-api-in-deno-written-by-a-guy-coming-from-node/) and come back when you're finished.
...
I wrote a small guide for Mac OS users on setting up MySQL because I struggled with it as well. Check it out [here](https://github.com/adeelibr/deno-playground/blob/master/guidelines/setting-up-mysql-mac-os-catalina.md).

If you are on a Windows machine you can use the same tools or you can also use [XAMPP](https://www.apachefriends.org/index.html) to have a MySQL instance running in your dashboard.

Once you have a MySQL instance running we can begin our tutorial.

## Let's Begin

Assuming that you're coming from this article, [**Todo API in Deno + Oak (without using a database)**](https://www.freecodecamp.org/news/create-a-todo-api-in-deno-written-by-a-guy-coming-from-node/), we will do the following:
...
One last thing – here is the entire commit difference that was made in Chapter 1 to add MySQL to the project ([source code that shows the new additions made from chapter 1](https://github.com/adeelibr/deno-playground/pull/1/commits/5b63b51ebcadededcfec452fe6877a0bd0f1f83f)).
...
Make sure that your `username` has no `password`, as it will conflict with connecting to Deno's MySQL library. If you don't know on how to do that, [read this tutorial](https://github.com/adeelibr/deno-playground/blob/master/guidelines/setting-up-mysql-mac-os-catalina.md#set-your-mysql-password-to-empty) I wrote.
...
Also, check out the Deno MySQL library's docs on [db creation](https://deno.land/x/mysql/#create-database) and on [table creation](https://deno.land/x/mysql/#create-table).
...
If you want to learn more about optional properties in TypeScript, head over to their docs [here](https://www.typescriptlang.org/docs/handbook/interfaces.html#optional-properties).
...
_This is how my console looks when I start the server_
...
Let's test our API out. I am using [Postman](https://www.postman.com/) here, but you can use your favorite API client.

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-04-at-23.31.07.png)
_running [GET] localhost:8080/todos =&gt; Will return all todos_
...
If you want to read more on interfaces, TypeScript has an excellent document on it which you can find [here](https://www.typescriptlang.org/docs/handbook/interfaces.html).
...
Go to [Postman](https://www.postman.com/) and run the API route for this controller:

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-04-at-23.55.02.png)
_running [POST] localhost:8080/todos =&gt; Will add a new new todo item_

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-04-at-23.57.06.png)
_running [POST] localhost:8080/todos =&gt; Will return all todos, notice how the new added item is being returned as well_
...
_running [POST] localhost:8080/todos =&gt; Will return all todos_

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-07-at-17.11.03.png)
_running [GET] localhost:8080/todos/:id =&gt; will return the todo for that id if found_
...
_running [GET] localhost:8080/todos/&lt;unknown-id&gt; =&gt; returns status 404 with not found error message_
...
_running [PUT] localhost:8080/todos/:id =&gt; will update content of that todo by given id_

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-07-at-17.43.13.png)
_running [GET] localhost:8080/todos/ =&gt; will return all todos, see how the todo you updated is also showing there._
...
_running [DELETE] localhost:8080/todos/:id =&gt; will delete a todo by ID_

![Image](https://www.freecodecamp.org/news/content/images/2020/06/Screenshot-2020-06-07-at-18.23.44.png)
_running [GET] localhost:8080/todos/ =&gt; will return all todos, see how todo with "id" is no longer here_

With this we are done with our Deno + Oak + MySQL tutorial.

The entire source code is available here: [https://github.com/adeelibr/deno-playground](https://github.com/adeelibr/deno-playground). If you find an issue, just let me know. Or feel free to make a pull request and I'll give you credit in the repository.

If you found this tutorial helpful, please share it. And as always, I am available on [Twitter under @adeelibr](https://twitter.com/adeelibr). I would love to hear your thoughts on it.
