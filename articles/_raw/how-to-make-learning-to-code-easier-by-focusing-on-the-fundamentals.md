...
co_authors: []
series: null
date: '2025-01-02T15:25:40.254Z'
originalURL: https://freecodecamp.org/news/how-to-make-learning-to-code-easier-by-focusing-on-the-fundamentals
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1735830905235/898a0c35-3f2a-4a05-86e8-866bb99eda42.jpeg
tags:
- name: coding
  slug: coding
...
- name: Beginner Developers
  slug: beginners
seo_title: null
seo_desc: 'It’s the beginning of the year again, and perhaps you’re still struggling
  to learn that programming language. We’ve all been there. Let me share a story from
  my own journey.

  In 2016, I thought I wasn’t cut out for programming. After months of trying ...'
---
...
1. [Why Programming Feels Hard – Hint: It’s Not About Talent](#heading-why-programming-feels-hard-hint-its-not-about-talent)
    
2. [The Prerequisites You Actually Need](#heading-the-prerequisites-you-actually-need)
    
3. [Data Structures: Taking User Input](#heading-data-structures-taking-user-input)
    
4. [Algorithms: Performing Computations](#heading-algorithms-performing-computations)
    
5. [Programming Languages: Displaying the Output](#heading-programming-languages-displaying-the-output)
    
6. [Additional Skills](#heading-additional-skills)
    
7. [How to Build the Right Foundations: Practice, Practice, Practice](#heading-how-to-build-the-right-foundations-practice-practice-practice)
    
8. [Final Thoughts](#heading-final-thoughts)
...
* [Google’s Data Structures Learning Guide](https://developers.google.com/learn)
    
* [freeCodeCamp’s Data Structures and Algorithms Course](https://www.freecodecamp.org/learn)
...
* Names that come **before Jake** alphabetically:
    
    ```plaintext
    Anna, Emily
    ```
    
* Names that come **after Jake** alphabetically:
...
And if you want to dive deeper, [here’s a free 48-hour course on the freeCodeCamp YouTube channel](https://www.freecodecamp.org/news/learn-data-structures-and-algorithms-2/) on Data Structures and Algorithms.
...
* [Python.org](http://Python.org) [Tutorials](https://docs.python.org/3/tutorial/)
...
* [freeCodeCamp Debugging Guide](https://www.freecodecamp.org/news/debugging-tips/)
    
* [Book on Learning Git and GitHub](https://www.freecodecamp.org/news/gitting-things-done-book/)
...
**Example Practice**:  
Pick a small problem every day to practice applying data structures and algorithms. Use platforms like [LeetCode](https://leetcode.com/) or [HackerRank](https://www.hackerrank.com/) for daily challenges that fit your skill level. Here’s an example of a coding challenge you might find on these platforms:
...
**Example Practice**:  
Join a hackathon or participate in a competitive coding challenge like [Google Code Jam](https://codingcompetitions.withgoogle.com/) or [Codeforces](https://codeforces.com/). These challenges will push your problem-solving skills to the limit and help you learn new algorithms and techniques.
