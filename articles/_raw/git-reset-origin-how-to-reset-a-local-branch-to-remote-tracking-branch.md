---
title: Git Reset Origin – How to Reset a Local Branch to Remote Tracking Branch
subtitle: ''
...
## What is A Branch in Git? Git Branches in a Nutshell for Beginners <a name="intro"></a>
...
You can create a new branch and make the changes you want. If you are happy with the changes, you can add them to the main branch by *merging* them. If you are not, you can delete that branch without messing with the main code in the project.
...
### Local VS Remote VS Remote Tracking Branches in Git - What's the Difference? <a name="difference"></a>
...
## How to Reset A Local Git Branch to Remote? <a name="reset"></a>
...
### Save the Current State of your Local Branch <a name="save"></a>
...
### Do A `git checkout` <a name="checkout"></a>
...
### Reset Local Repository <a name="reset-local"></a>
...
### Clean Up Any Untracked Changes <a name="clean"></a>
