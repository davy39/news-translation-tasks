...
* [Passing Slices by Value and Expecting Structural Changes](#heading-passing-slices-by-value-and-expecting-structural-changes)
    
* [Slice Header Sharing and Unintended Mutations](#heading-slice-header-sharing-and-unintended-mutations)
    
* [Memory Leaks with Large Slice References](#heading-memory-leaks-with-large-slice-references)
    
* [Incorrect Loop Variable Usage with Slices of Pointers](#heading-incorrect-loop-variable-usage-with-slices-of-pointers)
    
* [Modifying Slice During Range Iteration](#heading-modifying-slice-during-range-iteration)
    
* [Nil Slice vs Empty Slice Confusion](#heading-nil-slice-vs-empty-slice-confusion)
    
* [Slice Bounds and Panic Errors](#heading-slice-bounds-and-panic-errors)
