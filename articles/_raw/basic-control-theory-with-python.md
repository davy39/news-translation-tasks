...
* [Rocket Systems and Cake Baking: A Fun Comparison](#heading-rocket-systems-and-cake-baking-a-fun-comparison)
* [Rocket Control Made Simple: Understanding PID Controllers](#heading-rocket-control-made-simple-understanding-pid-controllers)
* [Code example: Designing a simple PID controller](#heading-code-example-designing-a-simple-pid-controller)
* [Conclusion: Non-linear control systems](#heading-conclusion-non-linear-control-systems)
...
_Photo by [Brent Keane on Pexels](https://www.pexels.com/photo/white-icing-cover-cake-1702373/)_
...
_Example of control system diagram ([source](https://edtech.engineering.utoronto.ca/object/control-systems-diagrams))_
...
_Photo by [Shiva Smyth on Pexels](https://www.pexels.com/photo/closeup-photography-of-stacked-stones-1051449/)_
...
* **Bode plot:** Displays system _gain_ and _phase margins_
...
_Photo by [Pixabay](https://www.pexels.com/photo/space-rocket-launching-73871/)_
...
* [matplotlib](https://matplotlib.org/): A plotting library for creating various types of visualizations
* [Control](https://python-control.readthedocs.io/en/0.10.0/): A library for analyzing and designing control systems
...
_Define the Transfer Function of the Rocket System_
...
<body>
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="card-title" style="text-align: center;">Rocket transfer function
          </h5>
        </div>
    </div>
</body>
...
_Design a PID controller with new parameters_
...
_Applying the PID controller to the rocket transfer function_
...
After completing the design of this PID control system, we can use tools like [Simulink](https://www.mathworks.com/products/simulink.html) to find the necessary values for many components.
...
_Photo by Peter de Vink: https://www.pexels.com/photo/photo-of-full-moon-975012/_
