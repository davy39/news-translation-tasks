...
_The animations viewer lets you individually control the curve for each property_

![Image](https://cdn-media-1.freecodecamp.org/images/QlDJcZSMNccentbE9d6fIjvmjAyiMo2rT4Ky)
_CSS animation controller_
...
To add styles for those pseudo states, add a new selector (with the `+` icon) and add `:<sta`te> to the end of the selector string.
