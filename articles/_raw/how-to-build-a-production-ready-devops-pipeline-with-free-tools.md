...
3. [How to Set Up Your Source Control and Project Structure](#heading-how-to-set-up-your-source-control-and-project-structure)
    
4. [How to Build Your CI Pipeline with GitHub Actions](#heading-how-to-build-your-ci-pipeline-with-github-actions)
    
5. [How to Optimize Docker Builds for CI](#heading-how-to-optimize-docker-builds-for-ci)
    
6. [Infrastructure as Code Using Terraform and Free Cloud Providers](#heading-infrastructure-as-code-using-terraform-and-free-cloud-providers)
    
7. [How to Set Up Container Orchestration on Minimal Resources](#heading-how-to-set-up-container-orchestration-on-minimal-resources)
    
8. [How to Create a Free Deployment Pipeline](#heading-how-to-create-a-free-deployment-pipeline)
    
9. [How to Build a Comprehensive Monitoring System](#heading-how-to-build-a-comprehensive-monitoring-system)
    
10. [How to Implement Security Testing and Scanning](#heading-how-to-implement-security-testing-and-scanning)
    
11. [Performance Optimization and Scaling](#heading-performance-optimization-and-scaling)
    
12. [Putting it All Together](#heading-complete-cicd-pipeline-example)
...
| Node.js & npm | Sample app & builds | [**Install Node.js**](https://nodejs.org/) |
| Terraform | Infrastructure as Code | [**Install Terraform**](https://www.terraform.io/downloads) |
| kubectl | Kubernetes CLI | [**Install kubectl**](https://kubernetes.io/docs/tasks/tools/) |
| k3d | Lightweight Kubernetes | [**Install k3d**](https://k3d.io/) |
| Trivy | Container security scanning | [**Install Trivy**](https://aquasecurity.github.io/trivy/v0.18.3/) |
| OWASP ZAP | Web security scanning | [**Install ZAP**](https://www.zaproxy.org/download/) |

**Optional but Helpful:**

* [**VS Code**](https://code.visualstudio.com/) or any good code editor
...
🛠 **Tip**: Use semantic commit messages and consider adopting [**Conventional Commits**](https://www.conventionalcommits.org/) for clarity in versioning and changelogs.
...
Before code ever hits GitHub, you can catch issues locally with Git hooks. Using a tool like [**Husky**](https://typicode.github.io/husky/) or [**pre-commit**](https://pre-commit.com/), you can:
...
Most applications need a database, but you don't have to pay for one when you're getting started. Platforms like [Railway](https://railway.app/) offer free tiers that are perfect for development and small projects.
...
This pipeline is scalable and secure, and it’s perfect for small projects. As your app grows, you might want to consider paid plans for more resources (for example, AWS larger instances, Grafana unlimited metrics). You can check [AWS Free Tier](https://aws.amazon.com/free/), [Terraform Docs](https://developer.hashicorp.com/terraform/docs), and [Grafana Docs](https://grafana.com/docs/) for more learning.

**PS:** I’d love to see what you build. Share your pipeline on [FreeCodeCamp’s forum](https://forum.freecodecamp.org/) or tag me on X [@Emidowojo](https://x.com/Emidowojo) with #DevOpsOnABudget, and tell me about the challenges you faced. You can also connect with me on [LinkedIn](https://www.linkedin.com/in/emidowojo/) if you’d like to stay in touch. If you made it to the end of this lengthy article, thanks for reading!
