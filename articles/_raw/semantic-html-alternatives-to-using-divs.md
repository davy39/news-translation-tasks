...
That’s exactly how we can use the

<aside> element in our HTML. We are making a notation that’s related to the content, but that we want to keep separate. We can use it in a sidebar as well.<p></p>
<h3>The <code> element</code></h3><code>
<pre><code class="language-html"><p>
  You can use this for a piece of code such as:
  <code class="gray-code">const muppetFrog =
