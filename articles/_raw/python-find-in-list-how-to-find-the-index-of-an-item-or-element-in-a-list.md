...
1. [An overview of lists in Python](#intro)
    1. [How indexing works](#index-intro)
2. [Use the `index()` method to find the index of an item](#index)
    1.[Use optional parameters with the `index()` method](#params)
3. [Get the indices of all occurrences of an item in a list](#all)
    1. [Use a `for-loop` to get indices of all occurrences of an item in a list](#for)
    2. [Use list comprehension and the `enumerate()` function to get indices of all occurrences of an item in a list](#enumerate)


## What are Lists in Python? <a name="intro"></a>
...
### An Overview of Indexing in Python <a name="index-intro"></a>
...
## Find the Index of an Item using the List `index()` Method in Python <a name="index"></a>
...
### How to Use the Optional Parameters with the `index()` Method <a name="params"></a>
...
## How to Get the Indices of All Occurrences of an Item in A List <a name="all"></a>

### Use a `for-loop` to Get the Indices of All Occurrences of an Item in A List <a name="for"></a>
...
### Use List Comprehension and the `enumerate()` Function to Get the Indices of All Occurrences of an Item in A List <a name="enumerate"></a>
