---
title: How to build a random quote generator with JavaScript and HTML, for absolute
  beginners
subtitle: ''
author: freeCodeCamp
co_authors: []
...
_Create a blank folder on your desktop_

![Image](https://www.freecodecamp.org/news/content/images/2019/06/image-129.png)
_Drag the folder into Sublime Text. Now it shows up on the sidebar menu._
...
_Your files should now look like this._
...
Now, we will have to link our JavaScript file to our HTML document so that our JavaScript code will be able interact with the HTML document. We’ll also add text within the **<title>** tags, add an **<h1>** element, create a **<div>**element with an **id** name of “quoteDisplay”, and also a **<button>** element with an **onclick** attribute with “newQuote()” passed into it.
...
_Contents between &lt;title&gt; tags will show up on the projects tab when opened in a browser._
...
_Link to the javascript.js file_
...
_The &lt;h1&gt; tag will display large text_

Then, we created a **<div>** element with an **id** attribute set to “quoteDisplay”. A **<div>** element works as a divider for HTML documents. **<div>** elements help organize content within a web page. The **id** attribute works as an identifier so that JavaScript can easily grab and manipulate it. In this case, we will use JavaScript to grab the element with the **id** “quoteDisplay” to place quotes within the **<div>** element.

  


![Image](https://cdn-media-1.freecodecamp.org/images/1*t4TyiuXnNPoc3VCyYIADiA.png)
_Quotes will be displayed within this &lt;div&gt; element via our JavaScript file_
...
_Our &lt;button&gt; element will produce this button_
...
_Calling Math.floor() with Math.random() passes as a parameter_
...
_A randomly generated decimal multiplied by 20, then rounded down to the nearest whole number_
...
_randomNumber will always generate a valid array index number for our quotes array_
...
_Placing the quote into the HTML quoteDisplay element_

Remember how I mentioned that we use HTML ID’s to allow JavaScript to easily grab and manipulate HTML elements? Well, that’s what we’re doing now to the HTML **quoteDisplay** ID we created earlier.

![Image](https://cdn-media-1.freecodecamp.org/images/1*CfRX7oTE08Jmu5FBI6NHyQ.png)
_Grabbing the HTML element with id of quoteDisplay_
...
_Passing in our random quote as the inner value of the quoteDisplay element_
...
_Your javascript.js file should look similar to this_
