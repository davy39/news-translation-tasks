...
* [Tools You'll Be Using to Build this Agent](#heading-tools-youll-be-using-to-build-this-agent)
    
* [Understanding AI Agents](#heading-understanding-ai-agents)
    
    * [What are AI Agents? How many types are there?](#heading-what-are-ai-agents-how-many-types-are-there)
        
    * [How AI Agents is unique compared to other AI tools?](#heading-how-ai-agents-is-unique-compared-to-other-ai-tools)
        
* [How to Set Up Your Environment](#heading-how-to-set-up-your-environment)
    
    * [1\. Create a Project Directory](#heading-1-create-a-project-directory)
        
    * [2\. Create a Virtual Environment](#heading-2-create-a-virtual-environment)
        
    * [3\. Install Dependencies](#heading-3-install-dependencies)
        
    * [4\. Get Your Gemini API Key](#heading-4-get-your-gemini-api-key)
        
    * [5\. Add Your Key to the .env File](#heading-5-add-your-key-to-the-env-file)
        
* [How to Build the Real-Time Agent Logic](#heading-how-to-build-the-real-time-agent-logic)
    
    * [Create the Gemini Client (with web search)](#heading-create-the-gemini-client-with-web-search)
        
    * [Create the Flask Backend and Frontend](#heading-create-the-flask-backend-and-frontend)
        
* [How to Test the AI Agent](#heading-how-to-test-the-ai-agent)
...
* `python-dotenv`: load GEMINI\_API\_KEY from .env
...
Go to [Google AI Studio](https://aistudio.google.com/) and create a new account (if you don’t have one already).

![Google AI Studio Landing Page](https://cdn.hashnode.com/res/hashnode/image/upload/v1756829119333/fd2f68f8-2d15-491e-9b9d-a5563f3d926b.png align="center")

Next, get yourself a new API key by clicking the **Create API Key** from the [API Keys](https://platform.openai.com/api-keys) section.

![Google AI Studio API Keys dashboard](https://cdn.hashnode.com/res/hashnode/image/upload/v1756829166748/a79ec404-2267-42f3-8185-a88903f5bcaf.png align="center")
...
If everything is set up, you’ll see the Flask app start on [`http://127.0.0.1:5000`](http://127.0.0.1:5000) or [`http://localhost:5000`](http://localhost:5000).
...
If you found this tutorial helpful and want to discuss AI development or software development, feel free to connect with me on [X/Twitter](https://x.com/itsTarun24), [LinkedIn](https://www.linkedin.com/in/tarunsingh24), or check out my portfolio at [Blog](http://tarunportfolio.vercel.app/blog). I regularly share insights about AI, development, technical writing, and so on, and would love to see what you build with this foundation.
