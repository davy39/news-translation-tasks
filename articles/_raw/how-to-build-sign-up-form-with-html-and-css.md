---
title: How to Build a Sign Up Form with Floating Labels and Transitions Using Plain
  HTML and CSS
subtitle: ''
...
We are going to define the markup for our sign up form. But before that, we have to set up our HTML boilerplate and correctly link to our stylesheet from the `head` tag. You can easily do this with the [Emmet plugin](https://emmet.io/) by typing `!` then tab in your IDE/Code editor.
...
You can get all the code from this tutorial from this [GitHub repository](https://github.com/KingsleyUbah/Sign-Up-CSS).

I recently created a newsletter where I provide practical tips and resources on learning web development. Subscribe to my [newsletter](https://www.getrevue.co/profile/ubahthebuilder) and get tips right in your inbox.
