...
So I started digging the web and found a brilliant ( I thought at that time) solution for my needs — [GasBuddy](https://gasbuddy.com/). It’s an app that shows up-to-date fuel prices at the local gas stations. I was on heaven that day imagining saving hundreds per month on gas.
...
_Why do the top automakers ignore the modern tech and UX?_
...
_Apple Maps in 2015 — nothing but basic info._
...
_Foursquare and Yelp. Based on research, drivers don’t use them to find a gas station._
...
_Fuelzee, TransportApp, Spritradar — apps with no soul._
...
_Frequent travelers aren’t happy._
...
_Petro-Canada, Esso and Shell. The Top Tier approach._
...
_Apart from a recent minor redesign, nothing has changed since 2015._
...
_GasBuddy list view 2015/2017. “Improvements” include more buttons, less readable text and colossal ad banners._
...
_Users complain about ads, but GasBuddy keeps pushing more of them._
...
_A typical UI for an average mileage tracker._
...
_Activity and profile screens_
