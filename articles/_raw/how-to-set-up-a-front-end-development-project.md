...
You can also [watch this article as a video](https://www.youtube.com/watch?v=BiBjuphZQxA) on YouTube. Let's dive in.

## Table of Contents

1. [How to Choose a Code Editor](#heading-how-to-choose-a-code-editor)
    
2. [How to Auto-format Your Code in VS Code](#heading-how-to-auto-format-your-code-in-vs-code)
    
3. [Why Do You Need Node for a Front-End Project?](#heading-why-do-you-need-node-for-a-front-end-project)
    
4. [How to Run Your Project](#heading-how-to-run-your-project)
    
5. [How to Add Libraries to Your JavaScript Project](#heading-how-to-add-libraries-to-your-javascript-project)
    
6. [How to Get Coding Tips While You Code](#heading-how-to-get-coding-tips-while-you-code)
    
7. [Initialize a Project with Vite](#heading-initialize-a-project-with-vite)
...
If you don’t have a personal preference, I highly recommend [VS Code](https://vscode.dev/). Lately, it has become the de facto standard editor for web development.

[![VS Code is by far the most used editor](https://cdn.hashnode.com/res/hashnode/image/upload/v1738945424232/9f41d802-e672-4cd7-ada3-5e8d54000446.png align="center")](https://survey.stackoverflow.co/2024/technology#1-integrated-development-environment)
...
![Prettier formats the code based on best practices](https://cdn.hashnode.com/res/hashnode/image/upload/v1738948709710/c64a427d-b868-4704-87db-338ebf079c67.png align="center")
...
![To install Prettier, go to the Extensions panel, search for Prettier, and install it](https://cdn.hashnode.com/res/hashnode/image/upload/v1738955063143/7e8378e5-cf70-4527-9951-b822a745f4bf.png align="center")
...
![Right-click within a file and select Format Document to format it](https://cdn.hashnode.com/res/hashnode/image/upload/v1738955102891/2e55eaa7-ec2a-4aca-ad79-b1df82d31e5c.png align="center")
...
![The first time, you need to select the default formatter](https://cdn.hashnode.com/res/hashnode/image/upload/v1738955119781/d0ef8bc3-54d0-4428-9731-c8857171f3e7.png align="center")
...
![Set the Format On Save option in Settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1738955201893/fd3fbec6-5265-4c9b-adab-c1a9d524a635.png align="center")
...
![Adding a custom Prettier configuration](https://cdn.hashnode.com/res/hashnode/image/upload/v1738955259640/d430386f-de2a-49f3-b252-aee4a9bc1089.png align="center")
...
There are many more options, of course. If you want to dig deeper, check out [Prettier's documentation](https://prettier.io/docs/en/configuration.html)[.](https://prettier.io/docs/en/configuration.html)
...
![You can run JavaScript as part of a website in your browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949060189/11f39633-76a1-4c38-92ef-88846ffdeb8f.png align="center")
...
![You can run JavaScript on its own with Node](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949071655/68552f47-63ba-4cfc-9ba0-abb9218a4857.png align="center")
...
![Node can run JavaScript files on their own](https://cdn.hashnode.com/res/hashnode/image/upload/v1738947073105/9b56af05-e925-4cd1-9475-b3e49898dd39.png align="center")
...
![In the browser, JavaScript can access and modify your HTML elements](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949133299/b1c6d0a6-ba11-4659-a51e-b72e4bbfde68.png align="center")
...
![With Node, JavaScript can access and modify your File system](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949113586/e8702a9c-91bf-4096-8768-cf06e4e41082.png align="center")
...
To install Node, go to [nodejs.org](http://nodejs.org) and install it. If you are unsure if you already have Node, you can also go to your terminal and run **node -v** to check. If you get a version number, you have Node.

![The website of Node.js](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949153110/c9e63db3-d52b-4122-a31c-6b871ed2e4b5.png align="center")
...
![A bundler creates a package that you can run in the browser](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949223269/97bc1d15-4ab6-4204-88d6-257fa471f95d.png align="center")
...
The most used bundler is still [webpack](https://webpack.js.org/), one of the earliest bundlers in the field. But the one that seems to have taken over the throne and gained more and more popularity is [Vite](https://vite.dev/). Here's a chart from the latest edition of the State of JavaScript survey.

[![The sentiment towards WebPack and Vite](https://cdn.hashnode.com/res/hashnode/image/upload/v1738947476843/195adbd5-5aba-427e-9b00-c507542235d2.png align="center")](https://2024.stateofjs.com/en-US/libraries/#all_tools_experience)
...
If you haven't checked out the [State of JavaScript](https://stateofjs.com/en-US) survey before, I highly recommend going through it. It gives you an excellent overview of the latest trends with JavaScript. You can learn which tools and libraries people love to use and which they will abandon soon. If you feel overwhelmed by all the changes in the JavaScript ecosystem, the results of this survey can be a great guide.
...
Now, we can add libraries to our package with the npm install command. In a [previous article](https://www.freecodecamp.org/news/render-3d-objects-in-browser-drawing-a-box-with-threejs/), we used Three.js to render 3D boxes in the browser.

So, as an example, let's install [Three.js](https://threejs.org/). Go to your terminal again, make sure you are in the correct folder, and run the following command:
...
![How to pick a library to use](https://cdn.hashnode.com/res/hashnode/image/upload/v1738949563130/ce677d97-20c4-48ed-a168-b99eb01c84d4.png align="center")
...
![The package.json file after initializing the project and installing Three.js](https://cdn.hashnode.com/res/hashnode/image/upload/v1738952468171/7a54e0bb-d88d-428b-911c-cf7a71676562.png align="center")
...
![Using Three.js in a sample project](https://cdn.hashnode.com/res/hashnode/image/upload/v1738952825715/9828ea05-e75a-4fdf-b1a3-39bd3aa8e380.png align="center")
...
If you want to learn more about building 3D games with Three.js, check out my [earlier article](https://www.freecodecamp.org/news/three-js-tutorial/) on building a minimalistic car in the browser.
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1738953388793/c081f406-f964-4c4c-95ef-83cdc8e403df.png align="center")
...
![To install ESLint go to the Extensions panel, search for ESLint, and install it](https://cdn.hashnode.com/res/hashnode/image/upload/v1738953594259/a6f02e96-069d-4463-8322-86a23c523df3.png align="center")
...
![Installing ESLint](https://cdn.hashnode.com/res/hashnode/image/upload/v1738953735596/a69f62ac-b5b4-459e-8e78-6956442adfe4.png align="center")
...
ESLint also became part of our node\_modules folder, and there are many more packages here now. This is because a dependency can have other dependencies, and the dependencies of the dependencies will also be part of the node\_modules folder.
...
![Turning off ESLint rules in the config](https://cdn.hashnode.com/res/hashnode/image/upload/v1738953834462/387e36f3-81ee-461c-ae02-3ca614c7b765.png align="center")
...
![Creating a project with Vite](https://cdn.hashnode.com/res/hashnode/image/upload/v1738953943915/884e22b0-f096-4338-a392-588b032834f4.png align="center")
...
![Vite can create a sample application with an HTML, CSS, and JavaScript file](https://cdn.hashnode.com/res/hashnode/image/upload/v1738954107608/0234f409-6f78-4039-b5d1-133c8cd09530.png align="center")
...
![Vite can also create a React project for you](https://cdn.hashnode.com/res/hashnode/image/upload/v1738954174340/26c5a9a5-b983-4ed7-8e43-fbab4400e08b.png align="center")
