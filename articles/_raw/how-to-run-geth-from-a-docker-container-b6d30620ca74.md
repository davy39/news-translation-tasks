---
title: How to run GETH from a Docker container
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
The [**GoEthereum**](https://geth.ethereum.org/) website lists the following available images with descriptions.
...
Open a **_terminal_** on Linux or MacOS, or **_PowerShell_** command prompt from Windows. In the CLI prompt, type the following command:
...
_Running GETH from a Docker Container_
...
For full code source, visit: [https://github.com/Play3rZer0/GETHDocker.git](https://github.com/Play3rZer0/GETHDocker.git)
