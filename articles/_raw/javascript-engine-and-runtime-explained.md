---
title: JavaScript Engine and Runtime Explained
subtitle: ''
author: Sahil
co_authors: []
series: null
...
* [How the JavaScript Engine Works](#heading-how-the-javascript-engine-works)
* [Compilation vs Interpretation](#heading-compilation-vs-interpretation)
* [What is a JavaScript Runtime](#heading-what-is-a-javascript-runtime)?
...
_JavaScript Engine consists of a call stack and a heap_
...
_Source code gets compiled to machine code and then gets executed while running the program_
...
_Source code gets converted into machine code and gets executed at the same time line by line_
...
_Source code gets compiled to machine code and gets executed immediately_
...
You can play around and generate your own [AST here](https://astexplorer.net/).
...
_JavaScript engine and web APIs in JavaScript runtime_
...
_JavaScript Engine, Web APIs and callback queue in JavaScript runtime_
...
_click event is inside the callback queue_
...
_click event now goes into the call stack_
