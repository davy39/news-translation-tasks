...
In this tutorial, we’ll build a Flutter application that demonstrates how to perform CRUD (Create, Read, Update, Delete) operations using [Hive](https://pub.dev/packages/hive) for local data storage.
...
2. [Step 1: Project Setup](#heading-step-1-project-setup)
    
3. [Step 2: Project Folder Structure](#heading-step-2-project-folder-structure)
    
4. [Step 3: Implementing the Application](#heading-step-3-implementing-the-application)
    
    * [1\. main.dart](#heading-1-maindart)
        
    * [2\. item.dart (Model)](#heading-2-itemdart-model)
        
    * [3\. controller.dart (Hive Controller)](#heading-3-controllerdart-hive-controller)
        
        * [Imports](#heading-imports)
            
        * [Class Definition and Constructor](#heading-class-definition-and-constructor)
            
        * [Hive Box Reference](#heading-hive-box-reference)
            
        * [Fetching Data](#heading-fetching-data)
            
        * [Creating an Item](#heading-creating-an-item)
            
        * [Editing an Item](#heading-editing-an-item)
            
        * [Deleting an Item](#heading-deleting-an-item)
            
        * [Clearing All Items](#heading-clearing-all-items)
            
        * [After Action Helper](#heading-after-action-helper)
    ...
    * [8\. are\_you\_sure.dart (Confirmation Dialog)](#heading-8-areyousuredart-confirmation-dialog)
        
    * [9\. single\_list\_tile.dart (List Item Widget)](#heading-9-singlelisttiledart-list-item-widget)
        
    * [10\. main\_screen.dart (UI + State Management)](#heading-10-mainscreendart-ui-state-management)
        
5. [Screenshots](#heading-screenshots)
...
![screenshot of a populated list ](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246520284/6d8ab811-24f4-4482-82f3-a1ab37eff384.png align="center")

![screenshot of adding a new item](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246525459/80ac292a-271d-4adf-b2bb-7dfbdb57170d.png align="center")

![screenshot of a dialog asking to confirm if you want to delete an item in iOS](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246531588/5e88c1ca-1ae0-4655-be16-e6646ef5e97d.png align="center")

![screenshot of a confirmation dialog box of deletion in Android](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246535449/aa2f7469-bbab-4c5d-bf8d-25ce9ba01743.png align="center")

![screenshot of dialog box of clearing items ](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246539025/233ddf98-62c8-4c0f-89b0-344be26dfabe.png align="center")

![screenshot of a toast notification](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246543769/13c5ecba-0916-4083-ab00-e756543f7643.png align="center")

![screenshot of an empty state.](https://cdn.hashnode.com/res/hashnode/image/upload/v1703246547869/33aae852-e656-43a6-b41b-887cedd81e47.png align="center")
...
You can explore Hive further in the [Hive Package Documentation](https://pub.dev/packages/hive) if you want to learn more.
