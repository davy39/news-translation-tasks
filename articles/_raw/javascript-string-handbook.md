...
1. **[What are Strings in JavaScript](#heading-what-are-strings-in-javascript)**
2. **[Basic String Operations](#heading-basic-string-operations)**  
– [Single and double quotes](#heading-single-and-double-quotes) 
3. **[Template Literals](#heading-template-literals)**  
– [Basic usage](#heading-basic-usage)  
– [Multiline strings](#heading-multiline-strings)  
– [Expression evaluation](#heading-expression-evaluation)  
– [Tagged templates](#heading-tagged-templates)  
– [Use cases](#heading-use-cases)
4. **[The String Constructor](#heading-the-string-constructor)**  
– [Using the Strings Constructor](#heading-using-the-string-constructor)  
– [String objects vs. string primitives](#heading-string-objects-vs-string-primitives)  
– [Converting string objects to primitives](#heading-converting-string-objects-to-primitives)  
– [Rare use cases](#heading-rare-use-cases)
5. **[The String.fromCharCode Method](#heading-the-stringfromcharcode-method)**  
– [Basic usage](#heading-basic-usage)  
– [Creating Strings from Unicode Values](#heading-creating-strings-from-unicode-values)  
– [Use cases](#heading-use-cases)
6. **[Concatenation](#heading-concatenation)**  
– [Using the + operator](#heading-using-the-operator)  
– [Using the concat method](#heading-using-the-concat-method)  
– [Concatenating Variables and Strings](#heading-concatenating-variables-and-strings)  
– [Combining `String.fromCharCode` with Concatenation](#heading-combining-stringfromcharcode-with-concatenation)
7. **[Characteristics of Strings](#heading-characteristics-of-strings)**  
– [Immutability](#heading-immutability)  
– [Sequence of characters](#heading-sequence-of-characters)
8. **[Case Manipulation Methods](#heading-case-manipulation-methods)**  
– [toUpperCase()](#heading-touppercase)   
– [toLowerCase()](#heading-tolowercase)
9. **[Trimming whitespaces with trim(), trimStart(), and trimEnd()](#heading-trimming-whitespaces-with-trim-trimstart-and-trimend)**  
– [trim()](#heading-trim)  
– [trimStart()](#heading-trimstart)  
– [trimEnd()](https://www.freecodecamp.org/news/p/e2ef5e41-04ae-40a6-b5a5-8915616f1bd3/trimend-)  
– [Use Cases](#heading-use-cases)
10. **[String Searching](#heading-string-searching)**  
– [indexOf() and lastIndexOf()](#heading-indexof-and-lastindexof)  
– [includes() method for substring presence](#heading-the-includes-method-for-substring-presence)  
– [startsWith() and endsWith() methods](#heading-startswith-and-endswith)
11. **[Substring extraction with slice() and substring()](#heading-substring-extraction-with-slice-and-substring)**  
– [slice()](#slice-)  
– [substring()](#substring-)
12. **[Modifying Strings](#heading-modifying-strings)**  
– [Replacing substrings with replace() method](#heading-replacing-substrings-with-replace)  
– [Splitting strings with split()](#heading-splitting-strings-with-split)  
– [Joining arrays into a string with join()](#heading-joining-arrays-into-a-string-with-join)
13. **[String Comparison](#heading-string-comparison)**  
– [Equality checks with === and ==](#heading-equality-checks-with-and)  
– [Locale-sensitive string comparison using localeCompare()](#heading-locale-sensitive-string-comparison)  
– [Comparing Strings Using `localeCompare()`](#heading-comparing-strings-using-localecompare)
14. **[Regular Expressions and Strings](#heading-regular-expressions-and-strings)**  
– [Using RegExp for string matching and manipulation](#heading-using-regexp-for-string-matching-and-manipulation)  
– [String methods with regular expressions: match(), search(), replace()](#heading-string-methods-with-regular-expressions-match-search-replace)
15. **[Unicode and Strings](#heading-unicode-and-strings)**  
– [Strings and Unicode in JavaScript](#heading-strings-and-unicode-in-javascript)  
– [Creating Unicode strings](#heading-creating-unicode-strings)  
– [Unicode Code Points](#heading-unicode-code-points)  
– [Code Point Iteration](#heading-code-point-iteration)
16. **[Common String Pitfalls](#heading-common-string-pitfalls)**  
– [String vs. number coercion](#heading-string-vs-number-coercion)  
– [Unexpected Behavior with Whitespace](#heading-unexpected-behavior-with-whitespace)  
– [Dealing with special characters](#heading-dealing-with-special-characters)
17. **[Case Studies and Examples](#Case Studies and Examples)**  
– [User input validation](#heading-user-input-validation)  
– [Formatting names](#heading-formatting-names)
