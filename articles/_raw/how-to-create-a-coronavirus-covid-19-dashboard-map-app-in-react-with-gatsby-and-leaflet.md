---
title: How to create a Coronavirus (COVID-19) Dashboard & Map App in React with Gatsby
  and Leaflet
subtitle: ''
author: Colby Fayock
co_authors: []
...
**Update:** The original NovelCOVID API v1 endpoint has been deprecated. Please update and use the following instead: [https://corona.lmao.ninja/v2/countries](https://corona.lmao.ninja/v2/countries)

_Author’s Note: This is meant to be a demo and proof of concept for putting together an impactful mapping application using real life data. For complete and accurate analysis, please make sure to use tools like [Johns Hopkins University dashboard](https://www.arcgis.com/apps/opsdashboard/index.html#/bda7594740fd40299423467b48e9ecf6). Stay home and be safe! ❤️_
...
* [Step 1: Cleaning up some unneeded code](#heading-step-1-cleaning-up-some-unneeded-code)
* [Step 2: Fetching the Coronavirus data](#heading-step-2-fetching-the-coronavirus-data)
* [Step 3: Transform the Coronavirus data into a geographic data format](#heading-step-3-transform-the-coronavirus-data-into-a-geographic-data-format)
* [Step 4: Adding the Coronavirus data to the map](#heading-step-4-adding-the-coronavirus-data-to-the-map)
* [What else can we do?](#heading-what-else-can-we-do)
* [Be safe and stay informed](#heading-be-safe-and-stay-informed)
...
_Coronavirus map dashboard demo_
...
_Logging the Coronavirus location data to the browser console_
...
**Update:** The previous commit includes a link to the original NovelCOVID v1 API endpoint which has now been deprecated. Please use this instead: [https://corona.lmao.ninja/v2/countries](https://corona.lmao.ninja/v2/countries).
...
_Previewing Coronavirus location data on geojson.io_
...
_Map with Coronavirus location data_
...
_Map with Coronavirus location data centered with a tooltip_
...
_Creating a new basemap in Mapbox Studio_
...
_Johns Hopkins University Coronavirus Map Dashboard - March 29, 2020_
