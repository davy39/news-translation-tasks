---
title: Event Delegation in JavaScript –Explained with an Example
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
Event Delegation is a pattern based upon the concept of [Event Bubbling](https://www.freecodecamp.org/news/event-bubbling-in-javascript/). It is an event-handling pattern that allows you to handle events at a higher level in the DOM tree other than the level where the event was first received.

There's a [video version of this topic](https://www.youtube.com/watch?v=aZ3JWv0ofuA) if you prefer that.
...
If you want to learn about event bubbling in more detail, you can [read my article on it here](https://www.freecodecamp.org/news/event-bubbling-in-javascript/).
...
Event delegation is possible because of event propagation in the DOM, where the event a child element receives is also passed to the child's parent and ancestors. Again, you can [read more about event bubbling here](https://www.freecodecamp.org/news/event-bubbling-in-javascript/).
