---
title: The Most Asked TypeScript Questions on StackOverflow – Handbook for Beginners
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
In this article, I’ll explore the seven most _stackoverflowed_ TypeScript questions.
...
1. [What is the difference between Interfaces vs Types in TypeScript?](#heading-1-what-is-the-difference-between-interfaces-vs-types-in-typescript)
...
_[PDF or Epub version of this cheatsheet available](https://www.ohansemmanuel.com/cheatsheet/top-7-stack-overflowed-typescript-questions)_
...
_Interfaces vs Types in Typescript_
...
_Duplicate identifier 'Human' error_
...
_A class can only implement an object type or intersection of object types with statically known members._
...
_What is the bang operator in TypeScript?_
...
_Error: values other than null and undefined not assignable_
...
_Foo! excludes null and undefined from the type of Foo_

You essentially say to the TypeScript compiler, _I am sure `Foo` will NOT be `null` or `undefined`_.
...
_The result of calling concat with null_
...
_Typescript error: Object is possibly null_
...
_Emitted javascript code same as Javascript_
...
_The Typescript error spotting the wrong property access "ciil"_
...
_The files after installation_
...
_Type declaration files in the TypeScript directory_
...
_The Math object in the declaration file_
...
_Set a new property on the window object?_
...
_The property does not exist on Window error_
...
_The default Window interface declaration_
...
_A wrong assignment to the newly defined property caught_
...
The accepted answer in the referenced stack overflow post for example says _the callback parameter's type must be_ a _"function that accepts a number and returns type any_._"_
...
We saw the solution to this in the _what is `d.ts`_ section_._
...
_Dynamically assigning properties to objects in Typescript_
...
_Typescript error when adding a new property dynamically_
...
_Exploring the literal object type_
...
_Using the Record utility type_
...
_Build strongly typed Polymorphic React components book_
