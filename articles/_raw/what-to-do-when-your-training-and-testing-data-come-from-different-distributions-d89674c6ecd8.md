...
* **Train, dev (development), and test sets:** Note that the dev set is also called the validation or the hold-on set. [This post](https://towardsdatascience.com/train-validation-and-test-sets-72cb40cba9e7) is a good short introduction to the topic.
* **Bias (underfitting) and variance (overfitting) errors:** [This](https://www.quora.com/What-is-the-best-way-to-explain-the-bias-variance-trade-off-in-layman’s-terms) is a great simple explanation of these errors.
* **How the train/dev/test split is correctly made:** You may refer to [this post](https://medium.freecodecamp.org/how-to-strategically-accomplish-your-machine-learning-models-performance-goals-44dddc11697e) that I have written before for a short background on this topic.
...
_Left: Dog (Volpino Italiano breed), Right: Arctic fox._
...
_Images of dogs (left and right) and a fox (center)._
...
_Image from the train set before and after blurring._
