...
* [API with NodeJS, Express, MongoDB and TypeScript](#heading-api-with-nodejs-express-mongodb-and-typescript)
* [Setting up](#heading-setting-up)
* [Create a Todo Type](#heading-create-a-todo-type)
* [Create a Todo Model](#heading-create-a-todo-model)
* [Create API controllers](#heading-create-api-controllers)
* [Get, Add, Update and Delete Todos](#heading-get-add-update-and-delete-todos)
* [Create API routes](#heading-create-api-routes)
* [Create a Server](#heading-create-a-server)
* [Client-side with React and TypeScript](#heading-client-side-with-react-and-typescript)
* [Setting up](#heading-setting-up)
* [Create a Todo Type](#heading-create-a-todo-type)
* [Fetch data from the API](#heading-fetch-data-from-the-api)
* [Create the components](#heading-create-the-components)
* [Add Todo Form](#heading-add-todo-form)
* [Display a Todo](#heading-display-a-todo)
* [Fetch and Display data](#heading-fetch-and-display-data)
...
If you're new to this, you can start with [A Practical Guide to TypeScript](https://www.ibrahima-ndaw.com/blog/a-practical-guide-to-typescript/) or [How to build an API from scratch with Node JS, Express, and MongoDB](https://www.ibrahima-ndaw.com/blog/graphql-api-express-mongodb/) to get most out of this tutorial. Otherwise, let's get started.
...
You can get the credentials by creating a new cluster on [MongoDB Atlas](https://www.mongodb.com/cloud/atlas).
...
![Image of working todo app](https://www.freecodecamp.org/news/content/images/2021/10/todo-image.png)

Great! With that final touch, we have now finished building a Todo App using TypeScript, React, NodeJs, Express, and MongoDB.

You can find the [Source Code here](https://github.com/ibrahima92/fullstack-typescript-mern-todo).
