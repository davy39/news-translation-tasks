---
title: Everything You Need to Know About CSS Variables [Full Handbook]
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
_Creating Component Variations using CSS variables_
...
_Site-wide theme styles using CSS variables_
...
_The color of the boxes are dynamically updated_
...
Note: The article assumes you have a good grasp of CSS. If you don’t know CSS very well, or want to learn to create jaw-dropping UIs, I recommend taking my [Advanced CSS Course](https://bit.ly/learn_css) (paid course that include 85 lessons). This article is an excerpt from the course. </Shameless plug> ?
...
_CSS Variables are also called “Custom Properties”_
...
_Local and Globally scoped variables_
...
_Remember to use the var function_
...
_The declaration is thrown away as a syntax error for having an invalid property name_
...
_They behave like normal properties_
...
_Useful bit for responsive design_
...
_The case is differrent when you write the declaration yourself_
...
_Without CSS Variables VS with CSS Variables_
...
_From: [the advanced guide to CSS](http://bit.ly/learn_css" rel="noopener" target="_blank" title=")_
