---
title: How to Handle Complex Use Cases in Your OpenAPI Specifications – API Documentation
  Guide
subtitle: ''
...
This structured document is called an [OpenAPI specification](https://www.openapis.org/) (OpenAPI Spec or OAS).
...
* [Setting the Foundation](#heading-setting-the-foundation)
    
* [Use Case 1: Duplicate Endpoints](#heading-use-case-1-duplicate-endpoints)
    
* [Use Case 2: How to Document Multiple HTTP Methods](#heading-use-case-2-how-to-document-multiple-http-methods)
    
* [API Documentation Tips](#heading-api-documentation-tips)
    
    * [Use Markdown in OpenAPI](#heading-use-markdown-in-openapi)
        
    * [Use the operationId Field](#heading-use-the-operationid-field)
        
    * [Use $ref for Reusable Components](#heading-use-ref-for-reusable-components)
...
1. [**A basic knowledge of APIs and API documentation**](https://www.freecodecamp.org/news/how-apis-work/): Familiarity with API terminology and structure (for example, endpoints, methods, request/response structure) is essential to understand how an OpenAPI Specification (OAS) document functions.
    
2. [**Familiarity with OpenAPI Specification**](https://spec.openapis.org/oas/latest.html): Basic understanding of OAS, including its purpose, structure, and so on.
    
3. **Access to Swagger or other OpenAPI documentation tools**: You need tools like the [Swagger Editor](https://editor-next.swagger.io/) or [RapiDoc](https://rapidocweb.com/), which will allow you to test and view the OpenAPI files visually.
...
When you encounter such scenarios and want to document the API reference using an OpenAPI spec, you won't be able to replicate it exactly how it is in the [Postman](https://postman.com/) collection (or any other development environment).
...
Here's a visual representation of this OAS file using the [Swagger editor](https://editor-next.swagger.io/):
...
When deployed to supported documentation platforms like [RapiDoc](https://rapidocweb.com/) or [ReadMe](https://readme.com/), this will render beautifully with all your Markdown styling intact.
