...
That's it! You have now implemented a real-world example of using the `withLogger` Higher-Order Component in a React project. Here is the full [GitHub code](https://github.com/gatwirival/React-HOCs-Demo) 
