...
* [What Are Containers?](#heading-what-are-containers)
    
* [What is Docker?](#heading-what-is-docker)
    
* [Why Docker?](#heading-why-docker)
    
* [Docker Architecture](#heading-docker-architecture)
    
* [Docker’s Container Runtime: containerd](#heading-dockers-container-runtime-containerd)
    
* [How to Create a Simple Container Using Docker](#heading-how-to-create-a-simple-container-using-docker)
...
![Docker Architecture](https://docs.docker.com/get-started/images/docker-architecture.webp align="left")
