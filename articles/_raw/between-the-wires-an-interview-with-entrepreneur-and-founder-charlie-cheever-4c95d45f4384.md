...
_I interviewed Charlie Cheever, who is the founder of [expo.io](https://expo.io/). Expo’s mission is to let web developers build truly native apps that work across both iOS and Android by writing them once in just JavaScript. It’s [open source](https://blog.expo.io/open-sourcing-the-exponent-client-9b37634c13d7), [free](https://blog.expo.io/exponent-is-free-as-in-and-as-in-1d6d948a60dc) and uses React Native._

_Previously, Charlie co-founded [Quora](https://www.quora.com/), and worked at Facebook on the platform team._
