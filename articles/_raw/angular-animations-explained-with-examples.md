...
* `‘someValue’ => void` : host component of bound data is _leaving_ the DOM
* `void => ‘someValue’` : host component of bound data is _entering_ the DOM
...
* [How to use animation with Angular 6](https://www.freecodecamp.org/news/how-to-use-animation-with-angular-6-675b19bc3496/)
