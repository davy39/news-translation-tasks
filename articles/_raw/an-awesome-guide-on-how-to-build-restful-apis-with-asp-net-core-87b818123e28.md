...
_[CC-BY-ND 2.0](https://www.flickr.com/photos/smitty/2245445147" rel="noopener" target="_blank" title="">wtf — code quality measurement</a> by <a href="https://www.flickr.com/photos/smitty/" rel="noopener" target="_blank" title="">smitty42</a> is licensed under <a href="https://creativecommons.org/licenses/by-nd/2.0/" rel="noopener" target="_blank" title=")_
...
_This is the response data you should see_
...
_Screen showing options to test endpoints_
...
_Screen just before sending a request_
...
_As you see, our validation logic works!_
...
_Finally, the result we expected to have_
...
_Adding a new category to update it later_
...
_The category data was updated successfully_
...
_That’s the result of a GET request now_
...
_Easy way to change the name in all files_
...
_As you see, the API deleted the existing category with no problems_
...
_Now we receive only one category as a result_
