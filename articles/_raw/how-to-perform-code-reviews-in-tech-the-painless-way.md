...
* [What is a Code Review?](#heading-what-is-a-code-review)
    
* [What is the Purpose of a Code Review?](#heading-what-is-the-purpose-of-a-code-review)
    
* [Why is Doing Code Reviews Hard?](#heading-why-is-doing-code-reviews-hard)
    
* [Can AI Replace Code Reviews?](#heading-can-ai-replace-code-reviews)
    
* [What to Focus on During a Code Review](#heading-what-to-focus-on-during-a-code-review)
    
* [Code Review Best Practices And Process](#heading-code-review-best-practices-and-process)
    
* [What is CodeRabbit?](#heading-what-is-coderabbit)
    
    * [How Does CodeRabbit Help?](#heading-how-does-coderabbit-help)
        
    * [A GitHub Repo to Test](#heading-a-github-repo-to-test)
        
    * [Additional Examples](#heading-additional-examples)
...
This tutorial uses free, open-source tools. You’ll need to have a [GitHub account](https://github.com/tyaga001) to help you make your code reviews more pleasant and valuable.

## **What is a Code Review?**

The term “[code review](https://en.wikipedia.org/wiki/Code_review)” can refer to various activities, from simply reading code over your teammate’s shoulder to a 10-person meeting where you dissect code line by line. I use the term to refer to a formal and written process, but not so heavyweight as a series of in-person code inspection meetings.
...
![Human vs Automated Code Style Review Process - showing why formatting checks should be automated](https://cdn.hashnode.com/res/hashnode/image/upload/v1731490662335/8b0e9e27-c31b-409f-9c9e-fd1a33195d9b.png align="center")
...
> [**CodeRabbit**](https://www.coderabbit.ai/) is an AI-powered code reviewer that delivers context-aware feedback on pull requests within minutes, reducing the time and effort needed for manual code reviews. It provides a fresh perspective and catches issues that are often missed, enhancing the overall review quality. – from the CodeRabbit docs

![what is CodeRabbit - home page](https://cdn.hashnode.com/res/hashnode/image/upload/v1731326629130/933c46f2-a24c-4e08-a470-8449e96387aa.png align="center")
...
![Pull Request Summary](https://cdn.hashnode.com/res/hashnode/image/upload/v1732879970322/c671b932-25b1-474c-8cae-c393cb1706b8.png align="center")
...
![Smart Code Reviews](https://cdn.hashnode.com/res/hashnode/image/upload/v1732880687958/8d0e1ce5-cb23-4c62-b9ba-823f3a59845e.png align="center")
...
![chat with coderabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1732880617364/9e246445-1d43-45f1-b4af-62d9f013d76a.png align="center")
...
![sequence diagrams by coderabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1732880539024/412d6c15-d691-4b65-b335-2e04b04a55e1.png align="center")

![Code reviews done by CodeRabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1731322941721/9e7c5e9a-ac02-458b-9de3-4cf92232786d.png align="center")
...
![how many projects are already using coderabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1731323088015/12db3391-bad0-45a7-908d-2c34391a7803.png align="left")
...
I read through [the CodeRabbit docs](https://docs.coderabbit.ai/) and was very impressed.
...
* Sign up at [coderabbit.ai](http://coderabbit.ai) using your GitHub account.
...
As an example **GitHub** **repo** to test, we’ll use [devtoolsacademy](https://www.devtoolsacademy.com/): my blog on everything about awesome developer tools.

First, visit the [CodeRabbit login page](https://app.coderabbit.ai/login) and login via GitHub.

![login - coderabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1732880133507/959c0521-eddf-4026-bf33-64b415f4d9b3.png align="center")

Next, add CodeRabbit to some of your public GitHub repositories.

![how-to-add-a-public-repo-to-use-coderabbit](https://cdn.hashnode.com/res/hashnode/image/upload/v1731327118318/7329afd5-af9c-4e54-9aba-6720cd00b8ca.png align="center")
...
* [sartography/spiff-arena#1233 (comment)](https://github.com/sartography/spiff-arena/pull/1233#discussion_r1529013218)
    
* [kmesiab/equilibria#1 (comment](https://github.com/sartography/spiff-arena/pull/1233#discussion_r1529013218)[)](https://github.com/kmesiab/equilibria/pull/1#discussion_r1505474270)
    
* [kamiazya/web-csv-toolbox#60](https://github.com/kmesiab/equilibria/pull/1#discussion_r1505474270) [(comment)](https://github.com/kamiazya/web-csv-toolbox/pull/60#discussion_r1453463448)
    
* [openreplay/openreplay#1858 (comme](https://github.com/kamiazya/web-csv-toolbox/pull/60#discussion_r1453463448)[nt)](https://github.com/openreplay/openreplay/pull/1858#discussion_r1467629285)
    
* [ls1intum/Artemis#8037 (comm](https://github.com/openreplay/openreplay/pull/1858#discussion_r1467629285)[ent)](https://github.com/ls1intum/Artemis/pull/8037#discussion_r1494109998)
...
<div data-node-type="callout-text">check all the open source examples of code reviews done by <a target="_self" rel="noopener noreferrer nofollow" href="https://github.com/search?q=coderabbitai&amp;type=pullrequests" style="pointer-events: none">CodeRabbit</a>.</div>
</div>
...
In this article I talked about basic intro to CodeRabbit, because that was my use case with my [blog](https://www.devtoolsacademy.com/).

For more advanced functionality, check out the official CodeRabbit [docs](https://docs.coderabbit.ai/) or read their [blog](https://www.coderabbit.ai/blog).
...
* [How I Built a Video Conferencing App with Stream and Next.js](https://www.freecodecamp.org/news/how-i-built-a-custom-video-conferencing-app-with-stream-and-nextjs/#heading-next-steps)
    
* [How to Implement Fine-Grained Authorization in Java](https://www.freecodecamp.org/news/fine-grained-authorization-in-java-and-springboot/)
    

Follow me on [Twitter](https://x.com/theankurtyagi) to stay updated on my open source projects.
