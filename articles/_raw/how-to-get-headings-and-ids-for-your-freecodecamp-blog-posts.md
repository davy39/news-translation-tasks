...
I recently published [quite a large post](https://www.freecodecamp.org/news/build-your-developer-portfolio-from-scratch-with-sveltekit-and-graphcms/) here on freeCodeCamp and needed to add a table of contents to the post.
...
* [JavaScript to the rescue!](#heading-javascript-to-the-rescue)
* [Get the element properties](#heading-get-the-element-properties)
* [Get the element id and `innerText`](#heading-get-the-element-id-and-innertext)
* [Filter on the `localName`](#heading-filter-on-the-localname)
