---
title: What is Unit Testing? How to Perform Unit Tests in Rust
subtitle: ''
author: freeCodeCamp
co_authors: []
series: null
...
Unit testing is such an integral part of the development workflow that some companies' whole development culture is centered around what's called [**Test-Driven Development** (or TDD)](https://www.freecodecamp.org/news/test-driven-development-tutorial-how-to-test-javascript-and-reactjs-app/). 
...
In this tutorial, you'll learn unit testing in the Rust programming language. That said, you should know at least the [basics of programming in Rust](https://www.freecodecamp.org/news/rust-in-replit/) although you don't need advanced knowledge of it.
...
![Image](https://www.freecodecamp.org/news/content/images/2022/07/1-2.JPG)
_src/lib.rs file of a Rust Library Project_
...
![Image](https://www.freecodecamp.org/news/content/images/2022/07/2-1.JPG)
_cargo test - results_
...
You'll also see the results of the **Doc-tests** below. Since we don't have any doc tests here, you'll see `running 0 tests`. You can ignore this for now and just focus on the unit tests. But if you want to learn more, you can check [Rust's official documentation](https://doc.rust-lang.org/rust-by-example/testing/doc_testing.html).
...
If you need more assertion macros (for example, comparison assertions that support `>`, `<`, `>=`, `<=`), you can install external crates like this one: [claim](https://crates.io/crates/claim). You can check [claim's documentation here](https://docs.rs/claim/latest/claim/) for more info.
...
![Image](https://www.freecodecamp.org/news/content/images/2022/07/4.JPG)
_failing test by cargo_
...
![Image](https://www.freecodecamp.org/news/content/images/2022/07/5.JPG)
_The output of a test case expecting and actually catching a failing behavior_
