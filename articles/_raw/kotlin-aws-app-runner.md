...
If you don't have Docker, then the official [Docker documentation](https://docs.docker.com/engine/install/) will help you set it up in a few minutes. 
...
If you are not interested in the Ktor implementation, then you can simply clone [this GitHub repository](https://github.com/codersee-blog/ktor-app-runner-skeleton) and proceed to the _How to Build the Docker Image_ step. 

If you are using the IntelliJ IDEA Ultimate Edition, then you can create a Ktor project using the app. Otherwise, you can use the [Ktor Project Generator](https://start.ktor.io/) tool and download project to your local machine.
...
The above result indicates that everything is setup correctly. Nevertheless, if we would like to install or update the CLI, then AWS ships with a really good article on that in their [official documentation](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html). 
...
![Image shows search results for users query in AWS Management Console](https://www.freecodecamp.org/news/content/images/2022/04/1-1.png)

On the next page, let's click the **Add users** button: 

![Image shows empty list of Users in AWS IAM Console](https://www.freecodecamp.org/news/content/images/2022/04/2-1.png)

Then we'll specify the preferred **User name** along with the **Access key** – **Programmatic access** credential type: 

![Image shows user name and AWS access type options for new user](https://www.freecodecamp.org/news/content/images/2022/04/3-1.png)
...
![Image shows permissions and permissions boundary settings for new user](https://www.freecodecamp.org/news/content/images/2022/04/4-2.png)
...
![Image shows new group name with seleced policy- AdministratorAccess](https://www.freecodecamp.org/news/content/images/2022/04/5-2.png)

After the group is created, let's hit the Next button once again: 

![Image shows existing groups and selected admin-group](https://www.freecodecamp.org/news/content/images/2022/04/6-2.png)
...
![Image shows add tags (optional) form](https://www.freecodecamp.org/news/content/images/2022/04/7-2.png)

Finally, we will be redirected to the **Review** page, where we can validate our previous steps:

![Image presents Review new user details](https://www.freecodecamp.org/news/content/images/2022/04/8-1.png)

As you can see, everything looks good, so let's click **Create user**:

![Image shows created user ](https://www.freecodecamp.org/news/content/images/2022/04/9-1.png)
...
![Image shows search results for 'container reqistry' query](https://www.freecodecamp.org/news/content/images/2022/04/10-1.png)
...
![Image shows create repository general settings](https://www.freecodecamp.org/news/content/images/2022/04/11-1.png)

 For the rest of settings, let's leave the default values, just like below: 

![Image shows Image scan and encryption settings](https://www.freecodecamp.org/news/content/images/2022/04/12.png)
...
![Image presents private repositories with one item- my-ktor-registry on the list](https://www.freecodecamp.org/news/content/images/2022/04/13.png)
...
![Image shows my-ktor-registry images with one item- latest on the list](https://www.freecodecamp.org/news/content/images/2022/04/14.png)
...
![Image presents search results for app runner query](https://www.freecodecamp.org/news/content/images/2022/04/15.png)
...
![Image presents source  and deployment settings for new deployment](https://www.freecodecamp.org/news/content/images/2022/04/16.png)
...
![Image presents selected image reposiotory and image tag](https://www.freecodecamp.org/news/content/images/2022/04/17.png)

Let's click continue and for the Deployment settings let's choose **Manual** and **Create new service role:** 

![Image shows deployment trigger, ECR Access role and Service role name](https://www.freecodecamp.org/news/content/images/2022/04/18.png)
...
_Image presents Service name, cpu, memory, environment variables, port and additional configuration settings_
...
![Image shows auto scaling settings with custom configuration set ](https://www.freecodecamp.org/news/content/images/2022/04/20.png)

Next, let's create a new configuration called **my-configuration**: 

![Image shows add custom auto scaling configuration modal](https://www.freecodecamp.org/news/content/images/2022/04/21.png)
...
![Image presents started AWS App Runner deployment process](https://www.freecodecamp.org/news/content/images/2022/04/22.png)

![Image presents deployment logs event called Create service](https://www.freecodecamp.org/news/content/images/2022/04/23.png)
...
If you enjoyed this material, then you might want to check my [other articles](https://codersee.com/articles/). On my blog, I cover plenty of topics related to Kotlin, Ktor, and Spring Boot. 

If you would like to ask me about anything, please reach out to me at _contact[at]codersee[dot]com_.
