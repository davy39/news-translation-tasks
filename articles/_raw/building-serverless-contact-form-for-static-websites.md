...
*Photo by* [*Unsplash*](https://unsplash.com/photos/AtvuPUenaeI?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
...
[\_python-ses-dynamodb-contactform - Serverless Framework SES and DynamoDB Contact Form\_github.com](https://github.com/faizanbashir/python-ses-dynamodb-contactform)
...
Treat yourself with a Cappuccino, Latte or . You just implemented a cool way to keep your website on static hosting with handling your forms, thanks to Serverless.
