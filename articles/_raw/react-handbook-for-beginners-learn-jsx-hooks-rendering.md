...
1. [What You Should Already Know](#heading-what-you-should-already-know)
    
2. [What Exactly Is React?](#heading-what-exactly-is-react)
    
    * [Why the “React” name?](#heading-why-the-react-name)
        
    * [Is React a framework?](#heading-is-react-a-framework)
        
    * [Is React only for web development?](#heading-is-react-only-for-web-development)
        
    * [What’s the primary goal of React?](#heading-whats-the-primary-goal-of-react)
        
3. [How to Add a React Component to a Website](#heading-how-to-add-a-react-component-to-a-website)
    
    * [Create a new project directory](#heading-create-a-new-project-directory)
        
    * [Create a DOM container](#heading-create-a-dom-container)
        
    * [Import React, Babel, and your component](#heading-import-react-babel-and-your-component)
        
    * [Create your component](#heading-create-your-component)
        
    * [Configure a local server](#heading-configure-a-local-server)
        
4. [What Is JSX?](#heading-what-is-jsx)
    
    * [Can React work without JSX?](#heading-can-react-work-without-jsx)
        
    * [Example 1: Create a React element with JSX](#heading-example-1-create-a-react-element-with-jsx)
        
    * [Example 2: Create a React element with regular JavaScript](#heading-example-2-create-a-react-element-with-regular-javascript)
        
5. [What Is React.createElement()?](#heading-what-is-reactcreateelement)
    
6. [How to Use JSX](#heading-how-to-use-jsx)
    
    * [Use JSX like any JavaScript expression](#heading-use-jsx-like-any-javascript-expression)
        
    * [Wrap multi-line JSX in parentheses](#heading-wrap-multi-line-jsx-in-parentheses)
        
    * [Wrap expressions in curly braces](#heading-wrap-expressions-in-curly-braces)
        
    * [Use camelCase to name attributes](#heading-use-camelcase-to-name-attributes)
        
    * [Close empty JSX tags properly](#heading-close-empty-jsx-tags-properly)
        
    * [A React component can return only a single element](#heading-a-react-component-can-return-only-a-single-element)
...
8. [What Is a React Component?](#heading-what-is-a-react-component)
    ...
    * [Syntax of a React component](#heading-syntax-of-a-react-component)
        
    * [Example of a React component](#heading-example-of-a-react-component)
        
    * [React components best practices](#heading-react-components-best-practices)
        
9. [How to Render Lists of Elements from an Array](#heading-how-to-render-lists-of-elements-from-an-array)
    
    * [Each React element in an array needs a unique key](#heading-each-react-element-in-an-array-needs-a-unique-key)
        
    * [How to add unique keys to each React element in an array](#heading-how-to-add-unique-keys-to-each-react-element-in-an-array)
        
    * [Essential things to know about assigning keys](#heading-essential-things-to-know-about-assigning-keys)
        
10. [How to Handle Events in React](#heading-how-to-handle-events-in-react)
    
    * [Types of event handlers](#heading-types-of-event-handlers)
        
    * [Example: Inline event handler](#heading-example-inline-event-handler)
        
    * [Example: Referenced event handler](#heading-example-referenced-event-handler)
        
11. [What Is React State?](#heading-what-is-react-state)
    
    * [Syntax of React state](#heading-syntax-of-react-state)
        
    * [Example of React state](#heading-example-of-react-state)
        
    * [React trigger vs render vs commit vs paint](#heading-react-trigger-vs-render-vs-commit-vs-paint)
        
    * [What does it mean to trigger a render in React?](#heading-what-does-it-mean-to-trigger-a-render-in-react)
        
    * [What does it mean to render React components?](#heading-what-does-it-mean-to-render-react-components)
        
    * [What does it mean to commit a React UI to the browser’s DOM?](#heading-what-does-it-mean-to-commit-a-react-ui-to-the-browsers-dom)
        
    * [What does it mean to paint the DOM nodes on the screen?](#heading-what-does-it-mean-to-paint-the-dom-nodes-on-the-screen)
        
12. [What Is the React Ref Hook?](#heading-what-is-the-react-ref-hook)
    
    * [Syntax of the React ref Hook](#heading-syntax-of-the-react-ref-hook)
        
    * [Example of the React ref Hook](#heading-example-of-the-react-ref-hook)
        
    * [React ref Hook best practices](#heading-react-ref-hook-best-ractices)
        
13. [Variables vs Refs vs States in React](#heading-variables-vs-refs-vs-states-in-react)
    
    * [How do variables work in React?](#heading-how-do-variables-work-in-react)
        
    * [How do refs work in React?](#heading-how-do-refs-work-in-react)
        
    * [How do states work in React?](#heading-how-do-states-work-in-react)
        
    * [Tips on using variables, refs, and states in React](#heading-tips-on-using-variables-refs-and-states-in-react)
        
14. [What Is the useEffect Hook?](#heading-what-is-the-useeffect-hook)
    
    * [Syntax of the useEffect Hook](#heading-syntax-of-the-useeffect-hook)
        
    * [Example of the useEffect Hook](#heading-example-of-the-useeffect-hook)
        
    * [useEffect Hook’s best practices](#heading-useeffect-hooks-best-practices)
        
15. [How to Style React Components](#heading-how-to-style-react-components)
    
    * [How to use CSS style sheets to style React elements](#heading-how-to-use-css-style-sheets-to-style-react-elements)
        
    * [How to use the inline style attribute to style React elements](#heading-how-to-use-the-inline-style-attribute-to-style-react-elements)
        
    * [How to use CSS Modules to style React elements](#heading-how-to-use-css-modules-to-style-react-elements)
        
    * [How to use a CSS-in-JS library to style React elements](#heading-how-to-use-a-css-in-js-library-to-style-react-elements)
        
16. [Overview](#heading-overview)
    
    * [Dive deeper into React](#heading-dive-deeper-into-react)
...
![An Illustration of React Components. The YouTube video player page is illustrated as a combination of independent components.](https://cdn.hashnode.com/res/hashnode/image/upload/v1760577491945/1b0f8c61-b42e-4e3c-afdc-5804fdfa0d42.webp align="center")
...
![React explained: The super flexible JavaScript library for modern frontend and full-stack app development](https://cdn.hashnode.com/res/hashnode/image/upload/v1760577104799/4592a7d2-e75b-4ae6-b1f4-65cfd8e94033.webp align="center")
...
* The setup above is recommended for learning React only. Don’t use it for public projects (production environment). You can learn how to set up React for production in my [Code React Sweetly book](https://www.amazon.com/dp/B0FRC4R8T3?tag=codesweetly00-20).
...
HTML files containing [ES modules](https://codesweetly.com/javascript-modules-tutorial/) work only through `http://` and `https://` URLs, not locally via a `file://` URL.
...
* Close the server using <kbd>Ctrl</kbd> + <kbd>C</kbd> on Windows or <kbd>Cmd</kbd> + <kbd>C</kbd> on Mac.
...
You can use JSX like any other JavaScript expression because, at [execution time](https://codesweetly.com/web-tech-terms-e/#execution-time), JSX transpiles into regular JavaScript.
...
Wrapping your JSX code in parentheses is best when it spans across multiple lines. Doing so will make your code readable and avoid the [pitfalls of automatic semicolon insertion](https://stackoverflow.com/questions/2846283/what-are-the-rules-for-javascripts-automatic-semicolon-insertion-asi).
...
React uses [camelCase](https://codesweetly.com/naming-convention-explained/#what-is-camelcase) for JSX attribute keys rather than the lowercase HTML attribute naming convention. This is because, under the hood, JSX compiles into plain JavaScript and, therefore, uses the JavaScript Web APIs.
...
**Tip:** React allows using a [fragment](https://react.dev/reference/react/Fragment) (empty tag) to group elements. Here’s an example:
...
![React component syntax](https://cdn.hashnode.com/res/hashnode/image/upload/v1760626118056/8fb5818f-b39a-42c7-9399-1acc476604ee.webp align="center")
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/jlj9lg?file=%2Fsrc%2Findex.js)
...
Suppose you want to create a list of React elements from an array of data. You can use the JavaScript [`map()`](https://codesweetly.com/javascript-map-method/) method.
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/dcwwqr?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/pj62c3?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/yxp4sz?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/n56z6x?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/frcspn?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/n9m7w2?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/v7yflr?file=%2Fsrc%2Findex.js)
...
Never generate keys on the fly (while [rendering](https://codesweetly.com/web-tech-terms-r/#react-render) your components). Instead, create them in your data outside your components. Otherwise, React will recreate the elements on every rendering cycle because the `key`’s value will always be different.
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/lhwknv?file=%2Fsrc%2Findex.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/7tx7l5?file=%2Fsrc%2Fcomponents%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/msfszz?file=%2Fsrc%2Fcomponents%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/9mlsl7?file=%2Fsrc%2FAboutCompany.js)
...
![React Component's Lifecyle](https://cdn.hashnode.com/res/hashnode/image/upload/v1760637870319/ed8ae7a7-67c1-468a-ba5f-dbbafed8deb0.webp align="center")
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/95nvmr?file=%2Fsrc%2Fcomponents%2FDonationUI.js)

### What does it mean to render React components?

The rendering step is when React [invokes (calls)](https://codesweetly.com/invoke-vs-call/) the component you’ve triggered with either the `createRoot` method or a set function. Rendering causes React to invoke a component to produce the UI you want to display on the screen. The component React will render depends on the moment the trigger event occurred:
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/mgsxyq?file=%2Fsrc%2FApp.js)
...
A [variable](https://codesweetly.com/javascript-variable/)’s value does not persist during re-rendering. Its value resets at the beginning of a new rendering.
...
[**Try Editing It**](https://codesweetly.com/variables-vs-refs-vs-states-in-react/try-it-sdk-vitejs-vite-u6yjihmv)
...
A ref’s value persists during re-rendering, but modifying it doesn’t cause React to re-render the component. In other words, a ref is a plain [JavaScript object](https://codesweetly.com/javascript-properties-object/) whose value React remembers while re-rendering your component. But React doesn’t track changes to the ref’s value. So, its modifications don’t trigger a new rendering.
...
[**Try Editing It**](https://codesweetly.com/variables-vs-refs-vs-states-in-react/try-it-sdk-vitejs-vite-xyjh2fev)
...
[**Try Editing It**](https://codesweetly.com/variables-vs-refs-vs-states-in-react/try-it-sdk-vitejs-vite-gklkzfps)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/mq5xzp?file=%2Fsrc%2FApp.js)
...
The snippet above uses two sets of curly braces because in JSX (as I mentioned above), you wrap [JavaScript expressions](https://codesweetly.com/javascript-statement/#what-is-a-javascript-expression-statement) inside curly braces: for instance, `<div>{myNameVariable}</div>`.
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/84cmjf?file=%2Fsrc%2FApp.js)

The React snippet above instructs the computer to apply an inline style to the `div` element.

You can see that we wrote `fontWeight` in [camelCase](https://codesweetly.com/naming-convention-explained/#what-is-camelcase). This is because, under the hood, JSX compiles into plain JavaScript. So it uses the JavaScript Web APIs attribute naming convention.
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/2llmwy?file=%2Fsrc%2FApp.js)
...
As defined on the official [documentation](https://github.com/css-modules/css-modules), a CSS Module is a CSS file in which all class names and animation names are scoped locally by default.
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/3t3nwt?file=%2Fsrc%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/45lkpf?file=%2Fsrc%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/w6h74d?file=%2Fsrc%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/j6yl9z?file=%2Fsrc%2FApp.js)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/3lqshk?file=%2Fsrc%2Fstyles.module.css)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/x4zfyn?file=%2Fsrc%2Fstyles.module.css)
...
[**Try it on CodeSandbox**](https://codesandbox.io/p/sandbox/t4ttkx?file=%2Fsrc%2FApp.js)
...
This handbook has given you a peek inside my [Code React Sweetly book](https://www.amazon.com/dp/B0FRC4R8T3?tag=codesweetly00-20). Whether you’re just starting or want to sharpen your fundamentals, the book walks you through everything from essential concepts to deploying real apps using JavaScript and TypeScript. It is practical, beginner-friendly, and designed to help you code React sweetly!

[![A Beginner’s Guide to React: Learn JSX, Hooks, and Real-World App Development](https://cdn.hashnode.com/res/hashnode/image/upload/v1760698961658/f3f297da-1cd2-4777-b440-19b94daaa26f.jpeg align="center")](https://www.amazon.com/dp/B0FRC4R8T3?tag=codesweetly00-20)
