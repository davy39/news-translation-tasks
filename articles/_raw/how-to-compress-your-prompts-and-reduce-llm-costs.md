...
subtitle: Microsoft just solved the hidden cost problem in AI with LLMLingua, making
  large language models faster, cheaper, and smarter.
...
* [The Problem Hidden in Plain Sight](#heading-the-problem-hidden-in-plain-sight)
    
* [What LLMLingua Does Differently](#heading-what-llmlingua-does-differently)
    
* [Working with LLMLingua](#heading-working-with-llmlingua)
    
* [Handling Long Contexts with LongLLMLingua](#heading-handling-long-contexts-with-longllmlingua)
    
* [LLMLingua-2: Faster and Smarter](#heading-llmlingua-2-faster-and-smarter)
    
* [Structured Prompt Compression](#heading-structured-prompt-compression)
    
* [SecurityLingua: Compression as a Defense](#heading-securitylingua-compression-as-a-defense)
    
* [Integration with the Ecosystem](#heading-integration-with-the-ecosystem)
    
* [Why LLM Lingua Matters](#heading-why-llm-lingua-matters)
