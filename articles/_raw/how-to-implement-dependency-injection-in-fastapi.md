...
* [Dependencies and Dependency Injection in FastAPI](#heading-dependencies-and-dependency-injection-in-fastapi)
    
* [Getting Started: Environment Setup](#heading-getting-started-environment-setup)
    
* [Types of Dependencies in FastAPI](#heading-types-of-dependencies-in-fastapi)
    
    * [How to Use Function Dependencies in FastAPI](#heading-how-to-use-function-dependencies-in-fastapi)
        
    * [How to Use Class Dependencies in FastAPI](#heading-how-to-use-class-dependencies-in-fastapi)
        
* [Dependency Scope](#heading-dependency-scope)
    
    * [Path Operation Level](#heading-path-operation-level)
        
    * [Router Level](#heading-router-level)
        
    * [Application Level](#heading-application-level)
        
* [Common Use Cases for Dependency Injection](#heading-common-use-cases-for-dependency-injection)
...
![uvicorn output in terminal](https://cdn.hashnode.com/res/hashnode/image/upload/v1762651145390/479b187c-f455-4617-aa7f-e075bf668ee5.jpeg align="center")
...
![payload for get_user endpoint](https://cdn.hashnode.com/res/hashnode/image/upload/v1762651845087/9495107e-1ab8-4349-a701-04e5de461fb6.jpeg align="center")
...
![unauthorized error output in FastAPI docs](https://cdn.hashnode.com/res/hashnode/image/upload/v1762652045213/c8dc8bb1-e2c4-456f-92f5-911dddae73eb.jpeg align="center")
...
The `__init`\_\_ method receives the parameters from the request (`name` and `password`) and stores them as instance attributes. These can then be accessed in the `__call__` method, which contains the dependency logic.
...
![class dependency output](https://cdn.hashnode.com/res/hashnode/image/upload/v1762655384549/ac5ab413-0f75-4711-8166-4c99bcca9d7c.jpeg align="center")
...
![path decorator dependency output](https://cdn.hashnode.com/res/hashnode/image/upload/v1762656537394/06fc80cf-a8b2-44d2-8955-ec914be699ba.jpeg align="center")
...
![logging dependency output in console](https://cdn.hashnode.com/res/hashnode/image/upload/v1762673203094/d1c43e1b-0cc2-46e5-ae54-ee4849d1af66.jpeg align="center")
...
![Server response for API request to home page](https://cdn.hashnode.com/res/hashnode/image/upload/v1762673465276/28d90221-4feb-4467-8c6c-8557dd54de03.jpeg align="center")
...
6. **Pagination & Filtering:** Injecting common parameters like page\_size and limit standardize data retrieval patterns across endpoints. 
