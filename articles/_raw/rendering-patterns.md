...
* [What's a rendering pattern?](#heading-whats-a-rendering-pattern)
    
* [Different rendering pattern options](#heading-different-rendering-pattern-options)
    
    * [Static websites](#heading-static-websites)
        
    * [Single page applications (SPAs) with client side rendering (CSR)](#heading-single-page-applications-spas-with-client-side-rendering-csr)
        
    * [Server side rendering (SSR)](#heading-server-side-rendering-ssr)
        
    * [Static site generation (SSG)](#heading-static-site-generation-ssg)
        
    * [Incremental static regeneration (ISR)](#heading-incremental-static-regeneration-isr)
        
    * [The concept of hydration](#heading-the-concept-of-hydration)
        
    * [Islands](#heading-islands)
        
    * [Streaming SSR](#heading-streaming-ssr)
        
* [Comparing the different patterns](#heading-comparing-the-different-patterns)
...
Static websites are typically created using static site generators, such as [Jekyll](https://jekyllrb.com/), [Hugo](https://gohugo.io/), or [Gatsby.js](https://www.gatsbyjs.com/). These generators compile templates, markdown files, or other data sources into a set of static files that are then deployed to a web server or [content delivery network (CDN)](https://www.youtube.com/watch?v=RI9np1LWzqw).
...
In SSG, a static site generator tool like Jekyll, Hugo, or Gatsby.js is used to compile the website's content from data sources such as markdown files, JSON files, or [CMS](https://www.youtube.com/watch?v=nrbpOmNC_mM) data, and generate a set of static files that can be served directly to the browser without any server-side processing.
