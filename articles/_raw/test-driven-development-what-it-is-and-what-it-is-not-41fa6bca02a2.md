...
If you feel this way, I think you might not understand what TDD really is. (OK, the previous sentence was to catch your attention). There is a very good book on TDD, [Test Driven Development: By Example, by Kent Beck](https://www.amazon.com/Test-Driven-Development-Kent-Beck/dp/0321146530), if you want to check it out and learn more.
...
[Uncle Bob](https://en.wikipedia.org/wiki/Robert_C._Martin) describes TDD with three rules:
