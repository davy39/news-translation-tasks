...
[**Pandoc**](https://pandoc.org/) is a powerful tool that allows you to convert documentation between formats seamlessly.
...
* [Why Automate Documentation Conversion](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#Why-Automate-Documentation-Conversion)?
    
* [How to Automate Pandoc using Shell Scripts](#heading-how-to-automate-pandoc-using-shell-scripts)
    
* [Basic Shell Script for Pandoc Conversion](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#basic-shell-script-for-pandoc-conversion)
    
* [Customizing the Script for Several Files](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#customizing-the-script-for-several-files)
    
* [Automating with Makefiles](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#automating-with-makefiles)
    
* [A Makefile for Pandoc Conversions](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#a-makefile-for-pandoc-conversions)
    
* [Defining Dependencies in Makefiles](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#defining-dependencies-in-makefiles)
    
* [Why Use Makefiles for Pandoc Automation?](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#why-use-makefiles-for-pandoc-automation)
    
* [How to Integrate Pandoc with CI/CD Pipelines](#heading-how-to-integrate-pandoc-with-ci-cd-pipelines)
    
* [Example: Setting Up Pandoc with GitHub Actions](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#example-setting-up-pandoc-with-github-actions)
    
* [Triggering on Documentation Updates](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#triggering-on-documentation-updates)
    
* [Adapting for GitLab CI or Jenkins](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#adapting-for-gitlab-ci-or-jenkins)
    
* [Advanced Automation Techniques](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#advanced-automation-techniques)
    
* [Automating with Cron Jobs](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#automating-with-cron-jobs)
    
* [Ensuring Consistency with Docker](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#ensuring-consistency-with-docker)
    
* [Combining Tools for Efficiency](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#combining-tools-for-efficiency)
    
* [Conclusion](https://freecodecamp.org/news/how-to-automate-documentation-conversion-with-pandoc-in-cicd-pipelines#conclusion)
...
By using [shell scripts](https://medium.com/@jadhav.swatissj99/introduction-to-shell-scripting-automate-your-workflow-efficiently-d9415537e990), you can streamline the process of running [PanDoc commands](https://pandoc.org/getting-started.html#step-6-converting-a-file), saving time and reducing the risk of errors associated with manual command execution.
...
A [Makefile](https://opensource.com/article/18/8/what-how-makefile) is a special file that defines rules and commands for automating tasks in a project.
...
* The `html` target runs a PanDoc command to convert [`input.md`](http://input.md) into `output.html`.
    
* The `pdf` target runs a PanDoc command to convert [`input.md`](http://input.md) into `output.pdf`.
...
As modern development practices increasingly rely on [Continuous Integration and Continuous Deployment (CI/CD)](https://www.redhat.com/en/topics/devops/what-is-ci-cd#:~:text=CI%2FCD%2C%20which%20stands%20for,a%20shared%20source%20code%20repository.), automating routine tasks such as documentation generation becomes essential.

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1729626428543/8194dc35-8a1a-4d91-b4b0-8b8ce7174eba.jpeg align="center")

Integrating Pandoc into your [CI/CD pipelines](https://www.redhat.com/en/topics/devops/what-cicd-pipeline) allows for seamless documentation conversion and updates, ensuring that your docs are always up-to-date without manual intervention.
...
Whether you’re using [GitHub Actions](https://github.com/features/actions), [GitLab CI](https://about.gitlab.com/topics/ci-cd/), [Jenkins](https://www.jenkins.io/), or another automation tool, integrating Pandoc ensures that documentation gets generated and distributed whenever changes occur.
...
* **Convert Markdown to PDF**: The PanDoc command converts the [`input.md`](http://input.md) file into `output.pdf`.
...
For projects where documentation updates occur frequently, but not always due to code pushes or commits, you can automate the process using [**cron jobs**](https://en.wikipedia.org/wiki/Cron).
...
[Docker](https://www.docker.com/) provides a solution to this by allowing you to package Pandoc and all its dependencies in a container, ensuring that the same setup gets used everywhere.
...
You can use the official [**Pandoc Docker image**](https://hub.docker.com/u/pandoc) to simplify the setup process:
...
* [Connect with me on LinkedIn](https://www.linkedin.com/in/preston-mayieka/). I post regularly, so following me is a great idea.
