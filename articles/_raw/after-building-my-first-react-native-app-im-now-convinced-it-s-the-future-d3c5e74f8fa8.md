...
_Working my way through the Udemy Course_
...
It takes a little getting used to, but before you know it you’ll find yourself accidentally using a `<View>&`lt;/View> tag in `place of a` <div></div> in your next web app.
...
This saves time and I found it easier to get into a [flow state](https://en.wikipedia.org/wiki/Flow_(psychology)) without those pesky build times to disrupt me.

![Image](https://cdn-media-1.freecodecamp.org/images/1*UKfvFMsbyhhEgf6XBZnfvg.gif)
_Hi I’m Taylor. Hot Reloading changed my life. Source: [Facebook](https://facebook.github.io/react-native/blog/2016/03/24/introducing-hot-reloading.html" rel="noopener" target="_blank" title=")_
