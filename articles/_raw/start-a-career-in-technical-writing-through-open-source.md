...
co_authors: []
series: null
date: '2025-06-20T17:03:51.594Z'
originalURL: https://freecodecamp.org/news/start-a-career-in-technical-writing-through-open-source
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1750439011343/ed2c5552-b132-4edd-8d31-5080daac5aff.png
tags:
...
- name: Open Source
  slug: opensource
seo_title: null
seo_desc: 'One of the most common questions I’m asked is, “how can I get started in
  technical writing?” And honestly, I love that question because it means more people
  are beginning to see writing as a valid, valuable way to enter the tech industry.
...
* [Common Misconceptions About Technical Writing](#heading-common-misconceptions-about-technical-writing)
    
* [Who is a Technical Writer?](#heading-who-is-a-technical-writer)
    
* [What is Open Source?](#heading-what-is-open-source)
    
* [Why You Should Build Your Technical Writing Career with Open Source](#heading-why-you-should-build-your-technical-writing-career-with-open-source)
    
* [Your Role in Open Source as a Technical Writer](#heading-your-role-in-open-source-as-a-technical-writer)
    
* [Technical Skills You’ll Need to Get Started](#heading-technical-skills-youll-need-to-get-started)
    
* [How to Build a Technical Writing Portfolio Through Open Source](#heading-how-to-build-a-technical-writing-portfolio-through-open-source)
    
* [After Contributing, What’s next?](#heading-after-contributing-whats-next)
...
Fundamentally, [open source](https://opensource.com/resources/what-open-source) rests on several powerful principles:
...
[Here’s a handbook](https://www.freecodecamp.org/news/learn-git-basics/) that’ll teach you all the Git fundamentals you’ll need in your day-to-day routine.
...
[Here’s a cheat sheet](https://www.freecodecamp.org/news/markdown-cheatsheet/) that’ll teach you markdown basics – it’s geared towards technical writers.
...
You can learn about command line and bash scripting basics in [this detailed tutorial](https://www.freecodecamp.org/news/bash-scripting-tutorial-linux-shell-script-and-command-line-for-beginners/).

[And here’s a handbook](https://www.freecodecamp.org/news/the-linux-commands-handbook/) that covers some of the most commonly used Linux commands you’ll need to know.
...
You can learn how to use VS Code, one of the most popular editors among devs, [in this crash course](https://www.freecodecamp.org/news/learn-visual-studio-code-to-increase-productivity/).
...
![My GitHub profile](https://cdn.hashnode.com/res/hashnode/image/upload/v1750356311009/27fe7266-3dc2-4126-af07-a246f31443ea.png align="center")
...
Some examples of open-source projects that are known to be welcoming to documentation contributors include [Mautic](https://github.com/mautic/low-no-code/issues), [GitHub](https://github.com/github/docs), [Mozilla](https://github.com/search?q=org:mozilla+doc&type=repositories), [Layer5](https://github.com/layer5io/layer5), [Kubernetes](https://github.com/kubernetes/website/issues?q=is:issue%20state:open%20label:kind/documentation), etc.

You can also browse communities like [Hashnode](https://hashnode.com/), [Dev.to](https://dev.to/), or Reddit’s [r/opensource](https://reddit.com/r/opensource) for leads on projects seeking writing support.
...
Get connected with other writers through groups like [Write the Docs](https://www.writethedocs.org/), the [Hackmamba](http://hackmamba.io) community, or even local writing meetups. These communities offer support, resources, and new opportunities.
...
I’d love to hear from you. Feel free to connect or reach out to me on [LinkedIn](https://www.linkedin.com/in/lulunwenyi).
