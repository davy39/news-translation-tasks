---
title: Skewness and Kurtosis – Positively Skewed and Negatively Skewed Distributions
...
_Histogram of height vs population_
...
If you use percentages with smaller numbers I often refer to it as _lying_ with statistics – it's a statement that is technically correct but creates the wrong impression in our minds. 
...
_Probability density curve for our distribution_
...
_Eyeballing the median for skewed curves_
...
We will soon discuss the idea of skewness in greater detail. But at this stage, _generally speaking_, you can identify the direction where your curve is skewed. If the median is to the right of the mean, then it is negatively skewed. And if the mean is to the right of median, then it is positively skewed. 
...
This adjusted moment is what we call _skewness._ It helps us measure the asymmetry in the data. 
...
_Positive skew and negative skew_
...
This is what we call _kurtosis_ or a measure of whether our data has a lot of outliers or very few outliers. This will look like:
...
_Positive and negative kurtosis (Adapted from Analytics Vidhya)_
...
It is pretty straightforward to implement this in Python with [Scipy](https://www.scipy.org/). It has methods to easily measure skewness and kurtosis for a distribution with pre-built methods. 
