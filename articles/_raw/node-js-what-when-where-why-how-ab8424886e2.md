...
_The Unicorn Velociraptor Library provides support for asynchronous I/O based on event loops_
...
_Image from Philip Roberts’ presentation at JSConf EU: [What the heck is the event loop anyway?](https://www.youtube.com/watch?v=8aGhZQkoFbQ" rel="noopener" target="_blank" title=")_
...
_The Event Loop. Image from Bert Belder’s presentation: [Everything You Need to Know About Node.js Event Loop](https://www.youtube.com/watch?v=PNa9OMajw9w" rel="noopener" target="_blank" title=")_
