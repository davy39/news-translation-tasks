...
Whilst following along with this tutorial, you can either pull down the code from the GitHub repo (by visiting this [page](https://github.com/grant-dot-dev/form_accessibility_ux)), or you can use the inline code snippets within the article.
...
* [The Initial Basic Form](#heading-the-initial-basic-form)
    
* [Error Handling With React-Hook-Form](#heading-error-handling-with-react-hook-form)
    
* [Hooking Up The useForm Methods To Our Form](#heading-hooking-up-the-useform-methods-to-our-form)
    
* [Showing Error Messages](#heading-showing-error-messages)
    
* [Adding aria-required](#heading-adding-aria-required)
    
* [Adding fieldset and legend](#heading-adding-fieldset-and-legend)
    
* [Adding Labels and Using htmlFor](#heading-adding-labels-and-using-htmlfor)
    
* [Do Not Rely on Placeholders Only!](#heading-do-not-rely-on-placeholders-only)
    
* [Give Additional Information With aria-describedBy](#heading-give-additional-information-with-aria-describedby)
    
* [Avoid Tooltips for Critical Information](#heading-avoid-tooltips-for-critical-information)
    
* [Tell Me Something Important](#heading-tell-me-something-important)
    
* [Focus States and Colouring](#heading-focus-states-and-colouring)
    
* [Make Buttons Descriptive](#heading-make-buttons-descriptive)
...
![Example of a tooltip showing text that appears when a user hovers over a term.](https://cdn.hashnode.com/res/hashnode/image/upload/v1745685939025/ce427cf1-ef44-4021-b8d3-0095e7a091c6.png align="center")
...
![image of the form with a faint white and blue outline around the focussed input](https://cdn.hashnode.com/res/hashnode/image/upload/v1745687500364/4bfa9c86-d908-4f2b-a674-485a1ed15bc3.png align="center")
...
![image of form with thick red outline around the focussed input](https://cdn.hashnode.com/res/hashnode/image/upload/v1745687470893/c003c194-5f93-491d-a16e-4d983ea557ac.png align="center")
...
![image showing different poor input buttons](https://cdn.hashnode.com/res/hashnode/image/upload/v1745688682031/54a84908-e0fd-4781-ab83-6c34ab360cae.png align="center")
...
![image showing more accessible buttons from above html](https://cdn.hashnode.com/res/hashnode/image/upload/v1745787493605/e5259e87-f8ee-463f-bc57-662779eea698.png align="center")
...
As always, if you’d like to share feedback on the article, discuss it further, or just hear about future articles or content, you can drop me a follow on X (Twitter) via my handle [@grantdotdev](https://x.com/grantdotdev).
