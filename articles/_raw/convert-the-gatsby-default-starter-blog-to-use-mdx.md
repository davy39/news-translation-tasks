...
For this example I'm going to be using the [Gatsby starter blog](https://github.com/gatsbyjs/gatsby-starter-blog) and importing it into CodeSandbox, looking at the docs it says you can do this with the [CodeSandbox import wizard](https://codesandbox.io/s/github) linked, paste the link in there and CodeSandbox will open the representation of the code on GitHub.
