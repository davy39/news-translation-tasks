...
In order to accommodate this diversity, clients and servers must agree upon a set of conventions — a _protocol —_ that dictates all communication between them. This protocol allows a web server to receive the information — _requests —_ sent by an arbitrary client, process them, and respond appropriately.
...
_Headers for a GET request made to medium.com/bookmarks_
