---
title: freeCodeCamp's new coding curriculum is now live with 1,400 coding lessons
  and 6 developer certifications you can earn
subtitle: ''
author: Quincy Larson
co_authors: []
series: null
date: '2018-08-09T11:23:38.000Z'
originalURL: https://freecodecamp.org/news/freecodecamps-new-coding-curriculum-is-now-live-with-1400-coding-lessons-and-6-developer-certifications-you-can-earn
coverImage: https://s3.amazonaws.com/freecodecamp/freecodecamp-news-curriculum-announcement-1.png
tags: []
seo_title: null
seo_desc: 'For the past year, our community has been hard at work on a massive new
  programming curriculum. And now that curriculum is live and out of beta!

  We’ve retooled freeCodeCamp’s curriculum to emphasize fundamental software development
  skills and concept...'
---
...
### A lightning-fast learning platform

We’ve rebuilt our learning platform from the ground up. Our full curriculum is now on the  [learn.freeCodeCamp.org](https://learn.freecodecamp.org) subdomain. It’s a single-page React app with a clean, simple design.
...
Each time you sign in to  [www.freeCodeCamp.org](https://www.freecodecamp.org), you’ll be greeted with a welcome dashboard. This will feature an inspiring quote and statistics about your progress through the freeCodeCamp curriculum.

![A screenshot of the new welcome page with statistics. The quote says 'Once we accept our limits, we go beyond them' - Albert Einstein](https://s3.amazonaws.com/freecodecamp/freecodecamp-news-curriculum-announcement-2.png)
