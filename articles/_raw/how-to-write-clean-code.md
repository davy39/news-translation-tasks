...
* [What does it mean to write "clean code" and why should I care?](#heading-what-does-it-mean-to-write-clean-code-and-why-should-i-care)
    
* [How can I assess whether a codebase is clean or not?](#heading-how-can-i-assess-whether-a-codebase-is-clean-or-not)
    
* [Tips and conventions to write cleaner code](#heading-tips-and-conventions-to-write-cleaner-code)
    
    * [Effectiveness, efficiency and simplicity](#heading-effectiveness-efficiency-and-simplicity)
        
    * [Format and syntax](#heading-format-and-syntax)
    ...
    * [Clear flow of execution](#heading-clear-flow-of-execution)
        
    * [Single responsibility principle](#heading-single-responsibility-principle)
        
    * [Having a "single source of truth"](#heading-having-a-single-source-of-truth)
        
    * [Only expose and consume information you need](#heading-only-expose-and-consume-data-you-need)
        
    * [Modularization](#heading-modularization)
        
    * [Folder structures](#heading-folder-structures)
