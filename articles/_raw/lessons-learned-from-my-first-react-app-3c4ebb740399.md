...
I’m going to share the things I wish I knew, wish I had done, or was glad I did when I made my first React app. It’s a Pomodoro Clock, or a productivity timer. I built it for a [freeCodeCamp](https://www.freecodecamp.org/) project and to practice the React I learned for a [Chingu](https://chingu.io/) cohort.

You can check it out live [here](https://ellereeeee-pomodoro-clock.netlify.com/), and the code is [here](https://github.com/ellereeeee/pomodoro-clock).
...
Thank you Reddit user codethesite for helping me [refactor my handler assignment operators](https://www.reddit.com/r/reactjs/comments/8tinqo/lessons_learned_from_my_first_react_app/e18vqtw/)!
