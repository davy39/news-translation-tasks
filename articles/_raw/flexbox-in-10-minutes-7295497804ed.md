...
_Browser support of Flexbox from [Can I Use…](http://caniuse.com/#search=flex" rel="noopener" target="_blank" title=")_
...
_This article was originally published on Altitude Labs’ [blog](http://altitudelabs.com/blog/) and was written by our software engineer, Felix Yau. [Altitude Labs](http://altitudelabs.com) is a software agency that specializes in personalized, mobile-first React apps._
