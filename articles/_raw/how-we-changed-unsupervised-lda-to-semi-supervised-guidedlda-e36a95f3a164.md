...
_Sample Titles from News Articles._
...
_Words grouped together to form topics_
...
_classify new documents based on previously classified words._
...
_Space and Tech are getting merged together_
...
_That moment in history when we decided to debug LDA…_
...
_Space and Tech topics are getting merged together._
...
_Seeded Words set for Topic ids_
...
_Space and Tech topics are separated after seeding topics._
...
_Default initialization with uniform word topic distribution._
...
_Seeded Initialisation with modified word topic distribution._
