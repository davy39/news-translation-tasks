---
title: La feuille de route du développeur web 2020 – Un guide visuel pour devenir
  développeur Front End, Back End ou DevOps
subtitle: ''
author: Quincy Larson
co_authors: []
series: null
date: '2020-02-01T21:22:00.000Z'
originalURL: https://freecodecamp.org/news/web-developer-roadmap
coverImage: https://cdn-media-2.freecodecamp.org/w1280/5f9c9cdf740569d1a4ca34a6.jpg
tags:
...
seo_title: La feuille de route du développeur web 2020 – Un guide visuel pour devenir
  développeur Front End, Back End ou DevOps
seo_desc: 'There are many ways you can go about picking up the skills you need to
  become a developer.

  There are linear curriculums that teach you a bit of everything - like freeCodeCamp''s
  full stack development curriculum.

  And then there are massive lists of sk...'
---
...
L'une des meilleures listes de compétences est la [Feuille de route du développeur](https://twitter.com/kamranahmedse) de Kamran Ahmed, qu'il met régulièrement à jour.

Ce n'est pas une liste ordinaire de ressources. Kamran a soigneusement cartographié toutes les compétences qu'il juge essentielles pour percer dans différents domaines du développement.

J'ai déjà écrit à propos de sa feuille de route. Et pour célébrer le fait que nous soyons tous à mi-chemin de l'année 2020, je vais partager ici l'intégralité de sa feuille de route - toutes les trois.
...
![Image](https://www.freecodecamp.org/news/content/images/2020/08/intro.png)
...
Cela peut être le terminal sur un Mac, une invite de commande DOS Windows, ou Bash/ZSH. Notez que, quel que soit le système d'exploitation que vous utilisez, vous devriez probablement apprendre Linux. Même si vous ne l'utilisez pas pour votre environnement de laptop/bureau, vous l'utiliserez presque certainement pour les serveurs.

### Structures de données et algorithmes

Le cursus freeCodeCamp couvre ces sujets en profondeur. Vous voudrez probablement apprendre ces concepts en résolvant de nombreux problèmes d'algorithmes sur freeCodeCamp, CodeWars, Project Euler, ou un autre site d'entraînement. Je recommande personnellement de le faire en JavaScript ou en Python, mais si vous êtes prêt à relever un défi et que vous avez beaucoup de temps devant vous, le faire en C ne serait pas une mauvaise idée.

### Une compréhension de la façon dont le web fonctionne : HTTPS et les API

Il y a beaucoup d'autres concepts que vous pouvez apprendre. Je recommande de suivre un bon cours d'introduction en informatique pour commencer. Voici [toutes les conférences du cours CS50 de Harvard sans publicité sur la chaîne YouTube de freeCodeCamp](https://www.youtube.com/playlist?list=PLWKjhJtqVAbmGw5fN5BQlwuug-8bDmabi).
...
* **SOLID - Il s'agit d'un moyen mnémotechnique pour "**Responsabilité unique, Ouvert-fermé, Substitution de Liskov, Ségrégation des interfaces, Inversion des dépendances". Oui - ce n'est pas de la matière pour débutants, mais regardez cela si vous êtes curieux.

## Feuille de route pour le développement web Front End
...
![Image](https://www.freecodecamp.org/news/content/images/2020/08/frontend.png)
...
* Les préprocesseurs CSS. Ceux-ci étaient nécessaires, mais CSS lui-même a ajouté de nombreuses fonctionnalités qui rendaient ces préprocesseurs si utiles. [freeCodeCamp enseigne actuellement Sass](https://www.freecodecamp.org/learn), mais nous sommes en train de l'éliminer progressivement également.
* Architecture CSS : Je ne pense pas que cela soit nécessaire sauf si la conception de systèmes CSS fait partie intégrante de votre travail quotidien.
* Un peu de chipotage : TypeScript est une manière prometteuse de réduire les bugs et de coder avec confiance. Nous l'ajoutons à la [version 7.0 du cursus principal de freeCodeCamp](https://www.freecodecamp.org/forum/t/help-us-build-version-7-0-of-the-freecodecamp-curriculum/263546). Je pense que cela devrait être encore plus mis en avant sur la feuille de route, mais il y est.
...
## Feuille de route pour le développement web Back End
...
![Image](https://www.freecodecamp.org/news/content/images/2020/08/backend.png)
...
Voici le [cours gratuit de 4 heures sur SQL de freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY), qui vous enseignera les bases.

Et si vous voulez approfondir, voici notre [cours gratuit de 8 heures sur la conception de bases de données relationnelles](https://www.youtube.com/watch?v=ztHopE5Wnpc).
...
Voici un guide détaillé sur [quel langage de programmation vous devriez apprendre en premier](https://www.freecodecamp.org/news/how-to-choose-which-programming-language-you-should-learn-in-2019-60abef241012/).
...
![Image](https://www.freecodecamp.org/news/content/images/2020/08/devops.png)
...
Voici une rapide [introduction de 30 minutes au domaine du DevOps](https://www.youtube.com/watch?v=UqMUoINlKnY) qui devrait vous donner une meilleure idée si DevOps est quelque chose qui vous intéresse.
