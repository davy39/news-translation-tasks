...
co_authors: []
series: null
date: '2020-03-03T15:24:38.000Z'
originalURL: https://freecodecamp.org/news/how-to-write-qa-documentation-that-will-work
coverImage: https://www.freecodecamp.org/news/content/images/2020/03/oleg-s-article.png
tags:
- name: documentation
  slug: documentation
- name: QA
...
Les fichiers QA sont créés dans la direction du gestionnaire de bugs pour gérer ces défauts de manière confidentielle. Ils nous servent de feuille de route, assurant un processus QA propre et efficace et facilitant une conversation claire entre les correcteurs et les testeurs. 
...
J'ai écrit cet article pour vous faciliter la vie. Alors le voici, votre guide ultime sur la façon d'écrire une documentation QA logicielle qui fonctionnera.

* [Établir un plan de test et un rapport d'avancement des tests](#heading-etablir-un-plan-de-test-et-un-rapport-davancement-des-tests)
...
## Établir un plan de test et un rapport d'avancement des tests
...
Avant de commencer à mettre en œuvre votre plan de test, prenez le temps de réfléchir à la situation dans son ensemble. Posez-vous les questions suivantes :
...
* **Calendrier et dates restantes** : Établissez un calendrier réaliste pour l'essai. Fixez des délais clairs pour garder le projet sur la bonne voie.
...
* **Dynamique d'équipe** : Assurez-vous que des rôles et des tâches simples sont définis au sein de l'équipe de test. Qui est responsable des cas de test particuliers ? Qui documente les bugs et qui parle aux développeurs ?
...
Le rapport d'avancement des tests est une autre partie de la documentation QA, similaire au plan de test, mais avec des données supplémentaires sur les progrès actuels. Ce document vous permet, à vous et à votre équipe de développement, de surveiller l'avancement du projet et d'identifier tout problème organisationnel.

![Image](https://www.freecodecamp.org/news/content/images/2024/05/test-plan-and-progress-report-1.png)
_Un plan de test et un rapport d'avancement_
...
* **Priorité** : Cela indique la gravité du cas de test en fonction de la fonctionnalité du programme et de son impact sur les performances globales normales de l'application logicielle connue.
...
La déclaration de défauts est un élément important de la documentation QA. Le suivi des problèmes est la déclaration détaillée des problèmes soudains qui surviennent dans un produit logiciel. La documentation minutieuse de ces problèmes jette les bases d'un produit final complexe et sans bug. 
...
* **Priorité** : Chaque journal d'erreurs attribue une priorité de problème qui indique son urgence. Les priorités courantes sont des lettres (A : priorité la plus élevée, Z : priorité la plus élevée), des nombres (1 : priorité la plus élevée, 9 : priorité la plus élevée), ou des termes descriptifs (élevée, moyenne, faible).
...
Ma structure fournit des informations détaillées, afin que vous puissiez donner aux développeurs les moyens de diagnostiquer, d'adresser et d'éliminer efficacement tout bug logiciel. De cette manière, cela conduit à des produits plus conviviaux et plus robustes. 
...
7. Cependant comique que cela puisse paraître, assurez-vous que le problème n'est pas une fonctionnalité – relisez la documentation !
8. Ne manquez aucune information importante dans vos Étapes pour reproduire.

## Soumettre un rapport de défaut

L'élément final et l'un des plus importants de la documentation QA est le rapport de défaut. Vous pouvez comprendre qu'il couvre l'ensemble du cycle de vie d'un problème, de sa découverte initiale à sa fermeture finale. 
...
Mais ce n'est pas toujours aussi simple. Si l'on sait que des bugs sont encore commis dans le système de validation, il n'y a pas lieu de désespérer ! 
...
Mais la documentation QA n'est pas toujours "écrite et ignorée". À un moment donné du cycle de vie du développement logiciel, la documentation QA doit être continuellement mise à jour et améliorée à mesure que les exigences changent, que de nouvelles fonctionnalités sont introduites et que des commentaires sont reçus de la mise en œuvre et de l'utilisation en production.

Il existe également un nombre croissant de styles qui utilisent l'intelligence artificielle et l'apprentissage automatique pour automatiser partiellement la création de documentation QA. 
...
Bien que ces stratégies soient encore nouvelles et pas assez matures pour remplacer les testeurs humains, elles peuvent aider à la croissance et augmenter l'exploration manuelle, surtout pour les constructions grandes et complexes. En faisant de la documentation QA un passe-temps collaboratif et continu, votre équipe peut livrer de meilleurs logiciels plus rapidement et avec moins de défauts.

### Avez-vous besoin d'améliorer la qualité de votre logiciel ?

Mon entreprise KeenEthics fournit des services solides de [développement et d'assurance qualité](https://coventit.com/services/custom-software-development). Au cas où vous auriez besoin d'une estimation pour un projet similaire, n'hésitez pas à [nous contacter](https://coventit.com/contact-us). Si vous avez apprécié l'article, vous devriez continuer avec [Comment l'externalisation IT économise des coûts pour votre entreprise](https://coventit.com/blog/How-IT-Outsourcing-Saves-Costs) et [Éviter les pièges de l'externalisation IT : Conseils pour minimiser les risques](https://coventit.com/blog/risks-of-it-outsourcing).