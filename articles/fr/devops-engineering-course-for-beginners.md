---
title: Cours d'Ingénierie DevOps pour Débutants
subtitle: ''
author: Beau Carnes
co_authors: []
series: null
date: '2021-06-15T21:33:17.000Z'
originalURL: https://freecodecamp.org/news/devops-engineering-course-for-beginners
coverImage: https://www.freecodecamp.org/news/content/images/2021/06/devops.png
tags:
- name: Devops
  slug: devops
- name: youtube
  slug: youtube
seo_title: Cours d'Ingénierie DevOps pour Débutants
seo_desc: 'DevOps is one of the highest-paying roles you can get at a software company.
  And even if you aren''t working as a DevOps, knowing how it works will make you
  a more productive developer.

  We just published a DevOps Engineering course on the freeCodeCamp...'
---

DevOps est l'un des rôles les mieux rémunérés que vous pouvez obtenir dans une entreprise de logiciels. Et même si vous ne travaillez pas en tant que DevOps, savoir comment cela fonctionne vous rendra plus productif en tant que développeur.

Nous venons de publier un cours d'Ingénierie DevOps sur la chaîne YouTube de freeCodeCamp.org. Apprenez tout sur DevOps dans ce cours complet pour débutants avec trois tutoriels techniques.

Colin Chartier a créé ce cours. Il est le cofondateur et PDG de LayerCI.

Vous apprendrez ce qu'est DevOps, l'intégration continue, les stratégies de déploiement continu et la gestion des performances des applications. De nombreuses pratiques DevOps sont couramment utilisées en programmation et en développement web, il est important de comprendre les termes clés et les technologies.

Ce cours fait souvent référence à la stack technologique MERN (MongoDB, Express JS, React JS, Node JS). Vous obtiendrez une série de conférences avec des recommandations technologiques basées sur ces meilleures pratiques. Il y aura plusieurs exemples de programmation intégrés dans ces conférences. Tant que vous connaissez les bases absolues de la programmation et du web, vous n'aurez aucun problème à suivre.

Voici les sections de ce cours :

### Unité 1 - Automatisation de la Revue de Code

* Leçon 1 : Qu'est-ce que DevOps ?
* Leçon 2 - Qu'est-ce que le Développement Piloté par les Tests (TDD) ?
* Leçon 3 - Qu'est-ce que l'Intégration Continue (CI) ? avec TUTORIEL de configuration CI
* Leçon 4 - Qu'est-ce que la couverture de code ?
* Leçon 5 - Bonnes pratiques de linting
* Leçon 6 - Environnements éphémères avec TUTORIEL de configuration

### Unité 2 - Stratégies de Déploiement

* Leçon 7 - Machines Virtuelles (VM) vs. Conteneurs
* Leçon 8 - Déploiements progressifs
* Leçon 9 - Déploiements bleu/vert avec TUTORIEL de configuration de Déploiement Continu
* Leçon 10 - Qu'est-ce que l'autoscaling ?
* Leçon 11 - Qu'est-ce que la découverte de services ?

### Unité 3 - Gestion des Performances des Applications (APM)

* Leçon 12 - Qu'est-ce que l'agrégation de logs ?
* Leçon 13 - Métriques de production vitales

Regardez le cours complet ci-dessous ou [sur la chaîne YouTube de freeCodeCamp.org](https://youtu.be/j5Zsa_eOXeY) (2 heures de visionnage).
...
Ce cours DevOps pour débutants est votre première étape vers un rôle d'ingénieur DevOps. Il est enseigné par le PDG et cofondateur de LayerCI.

L'objectif de ce cours sera que les développeurs réguliers et les praticiens de l'ingénierie apprennent les concepts fondamentaux de DevOps afin qu'ils puissent se diriger vers le rôle d'ingénieur DevOps. Nous parlerons également de DevOps de manière générale dans l'introduction. Mais au-delà de cela, nous parlerons principalement de l'aspect ingénierie des choses.

DevOps est une méthodologie qui aide les équipes d'ingénierie à construire de meilleurs produits en intégrant continuellement les retours des utilisateurs.

Et si vous recherchez DevOps sur Google et que vous regardez des images, vous verrez souvent des images comme celle-ci, ce qui aide vraiment à comprendre comment DevOps est différent de la manière traditionnelle de penser au développement de logiciels. À l'époque, les logiciels étaient développés, un peu comme les choses seraient développées dans une usine. Ainsi, toute entrée serait de la programmation, et ensuite la sortie, vous auriez un produit que vous pourriez mettre sur un CD, et vous le vendriez aux utilisateurs.

Mais depuis l'avènement d'Internet, et des logiciels continuellement mis à jour, il est devenu très facile de lancer des choses et d'obtenir des retours des utilisateurs et de les intégrer dans le produit actuel au lieu de faire une nouvelle version du produit. Ainsi, des sites web comme Facebook, se mettent continuellement à jour au lieu de vous demander d'acheter, vous savez, une nouvelle version de Facebook, contrairement, vous savez, aux vieux jeux, comme certaines villes vous demanderaient d'acheter une nouvelle version de SimCity. Et cette idée est vraiment formalisée par DevOps, les sections sont la planification, où vous prenez un ensemble de fonctionnalités que vous souhaitez construire. Et vous travaillez avec votre équipe pour faire quelques spécifications de ce à quoi ces fonctionnalités pourraient ressembler,

you code them. Donc les développeurs de votre équipe construiront ces fonctionnalités afin qu'elles puissent être publiées. Et bien sûr, elles sont construites. Donc pour un site web, vous pourriez prendre le code source et le regrouper en JavaScript qu'un navigateur d'utilisateur pourrait exécuter. Pour un jeu vidéo, vous pourriez faire des versions pour différentes versions qui s'exécutent sur Linux et des versions qui s'exécutent sur Windows et des versions qui s'exécutent dans le navigateur. Donc vous prenez ces artefacts construits, et vous les testez. Donc les tests sont à la fois automatiques et manuels. Les tests automatiques sont généralement connus sous le nom d'intégration continue. Et les tests manuels sont connus sous le nom d'assurance qualité, QA.

Et puis après qu'il a été testé, et vous savez, les parties prenantes ont toutes donné leurs retours, il est publié. Et les stratégies de déploiement continu, la publication et le déploiement se font automatiquement après qu'un changement est connu pour être bon. Il y a beaucoup d'automatisation qui peut être faite ici. Dans les grandes équipes. Il y a, vous savez, des outils populaires comme Spinnaker de Netflix dont nous parlerons dans les prochaines discussions. Mais l'idée principale est que vous voulez prendre le logiciel, et vous voulez l'envoyer à vos utilisateurs de manière à ce qu'ils ne remarquent pas s'il y a des problèmes. Donc si vous avez un changement d'interface utilisateur expérimental, vous pourriez le montrer à un petit pourcentage d'utilisateurs et obtenir leurs retours avant de le montrer largement. Encore une fois, une entreprise comme Facebook, qui a des milliards d'utilisateurs, même si 1% de leurs utilisateurs se plaignent, ils recevront des centaines de millions d'e-mails, la version est construite et déployée. Donc le déploiement signifie qu'elle est publiée pour vos utilisateurs pour un site web, cela signifierait qu'elle est publiquement accessible sur internet. Pour un CD ROM, vous savez, vous regroupez vos choses sur un CD et vous le distribuez pour une version mobile, vous construiriez l'artefact et vous le soumettriez à l'App Store. Et ensuite l'App Store le réviserait et publierait une nouvelle mise à jour que vos utilisateurs pourraient télécharger.

Et puis vous l'exploitez. L'exploitation consiste principalement à faire des choses comme le dimensionnement, en s'assurant qu'il y a suffisamment de ressources pour la charge, en ajoutant plus de serveurs si nécessaire. en configurant des choses en traitant des problèmes architecturaux, essentiellement, en surveillant. Donc lorsque vos utilisateurs utilisent votre logiciel, et surtout lorsqu'ils soumettent des choses, et commencent des travaux et créent des publications sur vos forums, vous voulez vous assurer que toutes ces publications sont en bonne santé.

Et puis enfin, vous prenez tous ces retours, et vous les mettez en phase de planification. Donc la phase de planification prend tous les retours des utilisateurs, prend toutes les choses que les équipes d'exploitation et de déploiement ont apprises sur le déploiement et le dimensionnement du produit. Et puis utilise cela pour construire de nouvelles fonctionnalités, résoudre des bugs, et faire de nouvelles versions du back-end et de nouvelles versions de l'architecture. Et puis continue simplement dans le cycle. Et c'est ce que les gens veulent dire lorsqu'ils disent, notre entreprise utilise DevOps, ou notre entreprise est tech forward, ou notre entreprise est digitalement transformée. Ils veulent dire qu'au lieu de prendre un ensemble d'exigences et de construire un artefact, qui est ensuite expédié, c'est un cycle continu de prise de retours. Vous savez, dans ces cycles Scrum de deux semaines, généralement, et de production de logiciels que les utilisateurs veulent réellement utiliser et sur lesquels ils ont eu leur mot à dire. L'ingénierie DevOps est une autre partie commune de DevOps. Donc au-delà de la méthodologie, qui est quelque chose dont les leaders techniques et le PDG pourraient se soucier, il y a un sous-domaine de l'ingénierie DevOps, et c'est généralement ce que les ingénieurs veulent dire.

Vous savez, lorsqu'ils disent DevOps, et c'est généralement ce que les offres d'emploi veulent dire lorsqu'ils disent DevOps. Donc si une offre d'emploi demande un ingénieur DevOps, vous savez, ils ne demandent pas quelqu'un qui peut planifier et déployer du code. Ils demandent surtout quelqu'un qui peut construire, tester, publier, déployer et surveiller.

Donc les trois piliers de l'ingénierie DevOps sont l'automatisation des pull requests, l'automatisation des déploiements et la gestion des performances des applications. Et nous entrerons dans les détails de ceux-ci. Mais l'idée est que l'automatisation des pull requests aide les développeurs à construire des choses plus rapidement, et les aide à comprendre si leur changement proposé est bon, plus rapidement. L'automatisation des déploiements vous aide à déployer votre code de manière à ce que les utilisateurs ne se plaignent pas. Encore une fois, Facebook a beaucoup d'automatisation de déploiement, car si ils jetaient simplement leur code dans le vide, chaque fois qu'un développeur faisait un changement, il y aurait des centaines de millions de plaintes. Et la gestion des performances des applications est l'automatisation autour de s'assurer que les choses sont en bonne santé. Donc détecter automatiquement les temps d'arrêt, réveiller automatiquement quelqu'un, si vous savez, le site tombe en panne pendant la nuit, revenir automatiquement en arrière si il y a un problème. Et nous entrerons dans les détails de tous ceux-ci dans les prochaines discussions.

Le premier pilier, que j'ai mentionné, était l'automatisation des pull requests et avait principalement à voir avec le cycle de feedback des développeurs. Donc les développeurs partagent leur travail les uns avec les autres en proposant ces ensembles atomiques de changements appelés pull requests. Et par atomique, je veux dire qu'ils sont complets en eux-mêmes, ils ne nécessitent pas d'autres choses pour fonctionner. Premièrement, c'est comme si un développeur proposait une pull request, ils devraient s'attendre à ce que ce changement soit bon. Et autant qu'ils peuvent en juger, le changement remplit certaines exigences commerciales. Et puis ce qu'ils doivent faire, c'est passer à travers certaines portes. Donc les organisations et l'automatisation des pull requests, leur objectif est de s'assurer que les développeurs peuvent dire très rapidement si leur changement est bon ou non. Par exemple, si vous travaillez sur un site web, et que le développeur propose un changement qui ajoute une faute de frappe, c'est quelque chose qui peut facilement être détecté automatiquement. Et si vous mettez en place une porte de faute de frappe qui dit qu'aucun changement ne peut être intégré s'il contient une faute de frappe, ce serait un moyen facile de s'assurer que les développeurs obtiennent un feedback automatique sur leurs changements. Les gens disent pull requests, vous savez, en 2021, généralement ils veulent dire Git. Donc Git est une technologie initialement popularisée par Linux, et elle aide les développeurs à faire ces sorts de changements et à les partager les uns avec les autres. une pull request est généralement révisée par au moins un autre programmeur et quelque chose appelé une revue de code, où l'autre programmeur vous dira le style de code, dira au programmeur proposant, s'il y a des problèmes architecturaux, des problèmes de mise à l'échelle, des choses subjectives qui ne peuvent pas être facilement automatisées. Mais ce processus de révision peut également être grandement facilité par une pile technologique DevOps. Et l'automatisation DevOps peut aider avec des choses comme les environnements éphémères, et le linting. Et toutes ces autres automatisations dont nous parlerons, après que la revue de code ait été faite. Habituellement, un responsable technique ou un chef de produit en charge de la fonctionnalité proposée, obtiendra des retours. Donc si vous créez un nouveau bouton, sur un site web, vous aimeriez que le designer qui a conçu le bouton, et vous aimeriez que le chef de produit qui a demandé la création du bouton donnent tous deux des retours. Parce que si le bouton est mal formulé, s'il est mal placé, s'il n'est pas réactif sur mobile, ce sont tous des problèmes qui nécessiteraient une autre demande de fusion. Donc ce serait bien si la demande de fusion initiale remplissait toutes les exigences, la première fois qu'elle est proposée. Et donc généralement, les personnes non techniques donneront des retours sur les pull requests si nécessaire.

Donc ce qui peut être automatisé pour un ingénieur DevOps,
