---
title: Comment créer une carte SVG cliquable avec HTML et CSS
subtitle: ''
author: Rufai Mustapha
co_authors: []
series: null
date: '2023-03-09T19:43:56.000Z'
originalURL: https://freecodecamp.org/news/how-to-make-clickable-svg-map-html-css
coverImage: https://www.freecodecamp.org/news/content/images/2023/03/amy-youtube--1-.jpg
tags:
- name: CSS
  slug: css
- name: HTML
...
- name: SVG
  slug: svg
seo_title: null
seo_desc: "Le SVG, ou Scalable Vector Graphics, est un format d'image polyvalent que vous pouvez utiliser dans une large gamme d'applications, de la conception web aux médias imprimés et à la visualisation de données. \nL'évolutivité, la petite taille de fichier et l'accessibilité des images SVG font de ce format..."
---

Le SVG, ou Scalable Vector Graphics (graphiques vectoriels échelonnables), est un format d'image polyvalent que vous pouvez utiliser dans une large gamme d'applications, de la conception web aux médias imprimés et à la visualisation de données.

L'évolutivité, la petite taille de fichier et l'accessibilité des images SVG font de ce format un choix populaire parmi les designers et les développeurs.

Les cartes sont un outil puissant pour la visualisation de données, fournissant une représentation visuelle qui peut aider les spectateurs à comprendre des modèles et des relations qui pourraient ne pas être évidents dans d'autres types de visualisations.

Dans cet article, vous apprendrez comment créer des cartes interactives en utilisant HTML et CSS. Ces cartes resteront légères car nous utiliserons des SVG.

Si vous avez des connaissances de base en HTML et CSS, vous serez capable de comprendre ce tutoriel.
...
* Quels sont les avantages d'une carte SVG ?

II. Comment configurer le fichier HTML

* Comment créer la structure HTML de base
* Comment importer le fichier de carte SVG
* Comment configurer le conteneur `div` pour la carte

III. Comment ajouter de l'interactivité avec CSS

* Comment styliser la carte SVG
* Comment ajouter des effets de survol
* Comment ajouter des effets de clic

IV. Comment ajouter des fonctionnalités

* Comment lier des zones de la carte à des pages web externes

V. Conclusion

* Récapitulatif des étapes pour créer une carte SVG cliquable
* Dernières réflexions et suggestions pour une personnalisation plus poussée

## Qu'est-ce qu'une carte SVG ?

Les cartes SVG sont vectorielles, ce qui signifie que les éléments de la carte sont définis par des équations mathématiques plutôt que par des pixels. Cela vous permet de les agrandir ou de les réduire sans perte de qualité.

## Quels sont les avantages d'une carte SVG ?

Voici quelques avantages de l'utilisation des cartes SVG :

1.  Évolutivité : Les cartes SVG peuvent être redimensionnées sans perte de qualité, ce qui les rend idéales pour le responsive web design ou pour l'impression à différentes tailles.
2.  Personnalisation : Les cartes SVG peuvent être facilement personnalisées pour répondre à des besoins spécifiques, comme changer les couleurs, ajouter des étiquettes ou modifier la taille et la forme des éléments de la carte.
3.  Interactivité : Les cartes SVG peuvent être rendues interactives grâce à l'utilisation de JavaScript et de CSS, permettant aux spectateurs de survoler ou de cliquer sur des éléments spécifiques pour voir des informations plus détaillées.
4.  Accessibilité : Les cartes SVG peuvent être lues par des technologies d'assistance telles que les lecteurs d'écran, ce qui les rend plus accessibles aux personnes handicapées.
5.  Compatibilité multiplateforme : Les cartes SVG peuvent être affichées sur une large gamme d'appareils et de navigateurs, ce qui en fait un choix polyvalent pour les applications web.

### Exemple de cartes SVG concrètes

Stears et la BBC ont utilisé des cartes SVG pour visualiser les données électorales. Les utilisateurs peuvent cliquer sur une région pour voir la répartition des votes exprimés. Voir [ici](https://www.stears.co/elections/2023/president/) pour plus d'informations.

%[

### Que construisons-nous ?

Dans ce tutoriel, nous construisons `Tour Afrique`, une carte interactive de l'Afrique.

Elle possède 2 fonctionnalités :

*   Les utilisateurs peuvent survoler pour voir le nom d'un pays.
*   Les utilisateurs peuvent cliquer sur un pays pour voir plus d'informations sur Wikipédia.

## Comment construire notre carte interactive de l'Afrique

### 1. Obtenir la carte SVG de l'Afrique

Vous pouvez créer une carte SVG à l'aide d'un logiciel de graphisme vectoriel tel que [Adobe Illustrator]( ou Inkscape, ou avec du code en utilisant des bibliothèques telles que D3.js ou Leaflet.

Vous pouvez également télécharger des cartes SVG depuis Wikipédia sous licence Creative Commons. Cliquez [ici](https://upload.wikimedia.org/wikipedia/commons/2/24/West-Africa.svg) pour la carte que nous utiliserons dans ce tutoriel.

### 2. Créer la structure HTML de base

Nous avons besoin d'une structure HTML de base, qui ressemblera à ceci :
...
Ce HTML nous donnera le résultat suivant pour l'instant :
...
### 3. Importer le fichier de carte SVG

Pour importer un fichier de carte SVG dans un document HTML, vous pouvez utiliser la balise `<object>`, `<img>` ou `<svg>`.

Nous le ferons en utilisant la balise `<svg>` :

Tout d'abord, ouvrez votre fichier HTML dans un éditeur de texte. Ensuite, ajoutez la carte SVG téléchargée à la section où vous souhaitez qu'elle apparaisse :
...
<html lang="en">
  ...
  <body>
    <section>
      ...
      >
        ... tous les tracés (paths) des pays sont ici ...
      </svg>
    </section>
  </body>
</html>
  ...
  <body>
    <section>
      ...
      >
        ...
        />
        <g id="g3248">
          <g transform="translate(-111.5439,-93.00714)" id="Skala">
            <path
          ...
          <path
            style="fill: #cccccc; stroke: #000000; stroke-linecap: round"
            inkscape:connector-curvature="0"
...
### 4. Imbriquer chaque tracé (path) dans une balise d'ancrage

Il y a plusieurs balises `path` dans notre SVG. Chacune d'elles décrit un pays. Nous voulons survoler chaque pays pour voir le nom du pays. Et en cliquant sur ce pays, nous devrions être dirigés vers sa page Wikipédia.
...
Dans le code ci-dessus, nous avons imbriqué le `path` dans une balise `anchor` (ancre). La balise `anchor` possède l'attribut `title` qui affiche le nom du pays au survol. De plus, elle possède `href` qui nous permet de visiter la page Wikipédia en cliquant sur ce lien. `target="_blank"` s'assure que le lien s'ouvre dans un nouvel onglet.

Vous remarquerez peut-être le préfixe `xlink` sur les attributs. Cela prend en charge les versions antérieures des navigateurs. Vous pouvez utiliser l'attribut obsolète `xlink:href` comme solution de repli en plus de l'attribut href. Voir plus d'informations [ici](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/xlink:href).

### 5. Comment styliser la carte SVG

Nous pouvons styliser notre carte SVG en utilisant CSS.

Les attributs courants dans les styles de tracé SVG sont `fill`, `stroke` et `stroke-width`. Par exemple, si vous dessinez un tracé rectangulaire, vous pouvez utiliser `fill` pour le rendre bleu.
...
Maintenant, nous pouvons donner différentes couleurs à certains pays. De plus, nous devrions avoir une sorte de retour visuel lors du survol d'un pays.
...
Le bloc de code CSS ci-dessus stylise les éléments sur notre carte. Voici une explication de chaque règle :

*   `#mapsection` : Ceci cible les éléments SVG avec l'ID _mapsection_. Il définit la largeur à 50 %, la hauteur sur auto, et les propriétés de contour pour l'élément.
*   `#mali`, `#Benin`, `#Nigeria`, `#Zimbabwe`, `#Zambia`, et `#Somalia` : Ceux-ci ciblent des éléments `path` spécifiques avec des ID correspondant aux noms de leurs pays. Ils définissent la couleur de remplissage (_fill_) pour chaque pays.
*   `path` : Ceci cible tous les éléments `path` sur la page web. Il définit la couleur de remplissage à #1da1f2.
*   `path:hover` : Ceci cible tous les éléments `path` sur la page web lorsqu'ils sont survolés par la souris. Il définit la couleur de remplissage en violet, la couleur du contour en rouge et l'épaisseur du contour à 3px. Il définit également un effet de transition pour le changement de couleur de remplissage.
  ...
  <body>
    ...
    >
      ...
      <g id="g3248">
        ...
        >
          <path
            style="fill: red; stroke: #000000; stroke-linecap: round"
            inkscape:connector-curvature="0"
            d="m 510.4281,78.56786 c 0,0 2.498,9.674 -4.972,14.979 -3.758,2.669 -16.044,11.679 -16.044,11.679 1.042,5.499 2.328,19.254 -9.604,21.128 -8.201,1.287 -3.903,7.917 1.581,16.909 l 0.349,46.824 c 0,0 -7.297,1.425 -6.78,3.354 1.16,4.329 1.247,7.437 6.713,12.303 3.51,3.123 3.575,8.763 3.272,12.224 -0.349,3.994 4.144,5.712 5.197,5.687 8.208,-0.199 14.685,-4.102 22.46,17.337 l 38.566,1.188 c 4.494,0.951 9.253,7.835 9.253,7.835 l 22.087,-6.275 130.045,64.3 -0.234,-10.444 c 14.377,1.171 16.028,-0.484 16.028,-0.484 l -8.887,-151.927 c -5.223,-7.167 -10.371,-14.193 -4.092,-22.142 0,0 0.042,-8.431 -1.53,-13.213 -1.636,-4.978 2.852,-8.362 2.852,-8.362 -0.07,-6.441 -12.435,-5.952 -18.94,-6.286 -8.537,-0.438 -14.273,-1.608 -12.787,-8.003 0,0 -22.316,-8.013 -30.953,-2.73 -4.589,2.807 -14.265,7.291 -16.026,13.041 -1.185,3.865 -0.124,6.486 2.18,10.412 4.034,6.873 -9.587,30.471 -25.157,11.586 0,0 -20.452,-5.63 -32.004,-8.155 -11.306,-2.471 -19.107,-12.385 -14.415,-18.386 0.459,-0.586 -30.685,-9.596 -30.685,-9.596 -14.384,2.224 -24.915,-1.982 -27.473,-4.783 z"
            id="Libya"
          />
...
Essayez de cliquer sur chaque pays. La balise d'ancrage ouvrira une nouvelle page et affichera plus d'informations.

Cliquez ici pour voir la [démo](https://rufai.github.io/buildingx/TourAfrique/) en direct.

Retrouvez le code complet [ici](https://github.com/rufai/rufai.github.io/tree/master/buildingx/TourAfrique).

## Conclusion

Ce tutoriel a expliqué comment créer une carte SVG cliquable en configurant le fichier HTML, en ajoutant de l'interactivité avec CSS (y compris les effets de survol et de clic), et en ajoutant des fonctionnalités en liant des zones de la carte à des pages web externes. Nous avons également discuté des avantages de l'utilisation des cartes SVG.

### Références

Il existe de nombreuses ressources disponibles pour en savoir plus sur les SVG. Voici quelques ressources que vous pouvez consulter :

1.  MDN Web Docs - SVG : MDN Web Docs est une excellente ressource pour apprendre le développement web, y compris le SVG. La section SVG couvre tout, des concepts de base aux sujets avancés.
2.  SVG sur CSS-Tricks : CSS-Tricks est un blog populaire sur le développement et la conception web. La section SVG couvre un large éventail de sujets, notamment la création de graphiques SVG, l'animation et l'interactivité.
3.  Xutini Tutorials : la façon amusante d'apprendre les compétences numériques web.
4.  SVG Pocket Guide : SVG Pocket Guide est un livre de Joni Trythall qui couvre les bases du SVG, y compris les formes, les tracés, le texte et les filtres. C'est un guide concis, facile à lire et à suivre.
5.  SVG Animations : SVG Animations est un livre de Sarah Drasner qui couvre les bases des animations SVG, y compris comment créer et contrôler des animations à l'aide de CSS et JavaScript.